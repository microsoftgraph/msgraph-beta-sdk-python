...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.groups.microsoft_graph_get_user_owned_objects.get_user_owned_objects_post_request_body')
...
class GetUserOwnedObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/microsoft.graph.getUserOwnedObjects"
