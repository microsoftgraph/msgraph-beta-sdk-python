...
create_upload_session_request_builder = lazy_import('msgraph.generated.groups.item.calendar_view.item.exception_occurrences.item.attachments.microsoft_graph_create_upload_session.create_upload_session_request_builder')
