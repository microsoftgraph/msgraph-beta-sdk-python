...
tentatively_accept_post_request_body = lazy_import('msgraph.generated.groups.item.calendar_view.item.exception_occurrences.item.tentatively_accept.tentatively_accept_post_request_body')
...
class TentativelyAcceptRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/tentativelyAccept"
