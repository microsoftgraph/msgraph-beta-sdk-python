...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.groups.item.calendar_view.item.instances.item.exception_occurrences.item.snooze_reminder.snooze_reminder_post_request_body')
...
class SnoozeReminderRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/snoozeReminder"
