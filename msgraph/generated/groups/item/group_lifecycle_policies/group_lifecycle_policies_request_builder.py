...
microsoft_graph_renew_group_request_builder = lazy_import('msgraph.generated.groups.item.group_lifecycle_policies.microsoft_graph_renew_group.microsoft_graph_renew_group_request_builder')
...
class GroupLifecyclePoliciesRequestBuilder():
    ...
    @property
    def microsoft_graph_renew_group(self) -> microsoft_graph_renew_group_request_builder.MicrosoftGraphRenewGroupRequestBuilder:
        """
        Provides operations to call the renewGroup method.
        """
        return microsoft_graph_renew_group_request_builder.MicrosoftGraphRenewGroupRequestBuilder(self.request_adapter, self.path_parameters)
