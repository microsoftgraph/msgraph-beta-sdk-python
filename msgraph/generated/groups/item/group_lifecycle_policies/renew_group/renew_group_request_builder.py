...
if TYPE_CHECKING:
    ...
    from .renew_group_post_request_body import RenewGroupPostRequestBody
    from .renew_group_response import RenewGroupResponse

class RenewGroupRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def post(self,body: Optional[RenewGroupPostRequestBody] = None, request_configuration: Optional[RenewGroupRequestBuilderPostRequestConfiguration] = None) -> Optional[RenewGroupResponse]:
        """
        ...
        Returns: Optional[RenewGroupResponse]
        ...
        return await self.request_adapter.send_async(request_info, RenewGroupResponse, error_mapping)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> RenewGroupRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RenewGroupRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return RenewGroupRequestBuilder(raw_url, self.request_adapter)
