...
class PostItemRequestBuilder():
    ...
    def create_patch_request_information(self,body: Optional[post.Post] = None, request_configuration: Optional[PostItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
