...
count_request_builder = lazy_import('msgraph.generated.groups.item.threads.item.posts.item.attachments.count.count_request_builder')
create_upload_session_request_builder = lazy_import('msgraph.generated.groups.item.threads.item.posts.item.attachments.create_upload_session.create_upload_session_request_builder')
...
class AttachmentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
