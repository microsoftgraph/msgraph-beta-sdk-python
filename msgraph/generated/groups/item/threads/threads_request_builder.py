...
class ThreadsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[ThreadsRequestBuilderGetRequestConfiguration] = None) -> Optional[ConversationThreadCollectionResponse]:
        """
        Get all the threads of a group. Note: You can also get all the threads of a conversation. This API is supported in the following national cloud deployments.
