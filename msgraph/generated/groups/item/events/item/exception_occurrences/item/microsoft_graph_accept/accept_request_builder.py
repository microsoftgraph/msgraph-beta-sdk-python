...
accept_post_request_body = lazy_import('msgraph.generated.groups.item.events.item.exception_occurrences.item.microsoft_graph_accept.accept_post_request_body')
