...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.groups.item.events.item.instances.microsoft_graph_delta.microsoft_graph_delta_request_builder')
