...
accept_post_request_body = lazy_import('msgraph.generated.groups.item.events.item.instances.item.exception_occurrences.item.accept.accept_post_request_body')
