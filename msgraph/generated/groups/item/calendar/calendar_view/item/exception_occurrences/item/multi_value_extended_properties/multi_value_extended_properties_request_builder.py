...
count_request_builder = lazy_import('msgraph.generated.groups.item.calendar.calendar_view.item.exception_occurrences.item.multi_value_extended_properties.count.count_request_builder')
...
class MultiValueExtendedPropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
