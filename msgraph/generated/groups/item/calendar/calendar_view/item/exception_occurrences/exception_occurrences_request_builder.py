...
delta_request_builder = lazy_import('msgraph.generated.groups.item.calendar.calendar_view.item.exception_occurrences.microsoft_graph_delta.delta_request_builder')
