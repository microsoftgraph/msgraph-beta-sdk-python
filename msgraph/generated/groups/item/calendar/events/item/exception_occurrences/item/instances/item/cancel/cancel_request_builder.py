...
cancel_post_request_body = lazy_import('msgraph.generated.groups.item.calendar.events.item.exception_occurrences.item.instances.item.cancel.cancel_post_request_body')
...
class CancelRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/cancel"
