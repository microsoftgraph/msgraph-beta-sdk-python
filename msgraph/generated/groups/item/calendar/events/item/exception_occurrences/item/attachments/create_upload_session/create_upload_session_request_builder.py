...
create_upload_session_post_request_body = lazy_import('msgraph.generated.groups.item.calendar.events.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_post_request_body')
