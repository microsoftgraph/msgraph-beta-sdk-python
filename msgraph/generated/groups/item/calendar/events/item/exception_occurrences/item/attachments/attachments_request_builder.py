...
create_upload_session_request_builder = lazy_import('msgraph.generated.groups.item.calendar.events.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_request_builder')
