...
delta_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.delta.delta_request_builder')
delta_with_token_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.delta_with_token.delta_with_token_request_builder')
