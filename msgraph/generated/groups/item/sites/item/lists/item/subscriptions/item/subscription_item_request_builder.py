...
reauthorize_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.subscriptions.item.reauthorize.reauthorize_request_builder')
