...
create_link_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.lists.item.items.item.microsoft_graph_create_link.create_link_post_request_body')
