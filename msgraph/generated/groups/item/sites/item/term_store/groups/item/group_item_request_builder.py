...
sets_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.term_store.groups.item.sets.sets_request_builder')
set_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.term_store.groups.item.sets.item.set_item_request_builder')
...
class GroupItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}"
