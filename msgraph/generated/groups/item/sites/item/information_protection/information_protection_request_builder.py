...
microsoft_graph_decrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_decrypt_buffer.microsoft_graph_decrypt_buffer_request_builder')
microsoft_graph_encrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_encrypt_buffer.microsoft_graph_encrypt_buffer_request_builder')
microsoft_graph_sign_digest_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_sign_digest.microsoft_graph_sign_digest_request_builder')
microsoft_graph_verify_signature_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_verify_signature.microsoft_graph_verify_signature_request_builder')
