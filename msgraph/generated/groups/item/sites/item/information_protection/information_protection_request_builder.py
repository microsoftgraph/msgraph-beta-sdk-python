...
decrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.decrypt_buffer.decrypt_buffer_request_builder')
encrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.encrypt_buffer.encrypt_buffer_request_builder')
...
sign_digest_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.sign_digest.sign_digest_request_builder')
...
verify_signature_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.verify_signature.verify_signature_request_builder')
