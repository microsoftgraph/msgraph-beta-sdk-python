...
bitlocker_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.bitlocker.bitlocker_request_builder')
data_loss_prevention_policies_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.data_loss_prevention_policies.data_loss_prevention_policies_request_builder')
data_loss_prevention_policy_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.data_loss_prevention_policies.item.data_loss_prevention_policy_item_request_builder')
decrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_decrypt_buffer.decrypt_buffer_request_builder')
encrypt_buffer_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_encrypt_buffer.encrypt_buffer_request_builder')
sign_digest_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_sign_digest.sign_digest_request_builder')
verify_signature_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.microsoft_graph_verify_signature.verify_signature_request_builder')
policy_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.policy_request_builder')
sensitivity_labels_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.sensitivity_labels.sensitivity_labels_request_builder')
sensitivity_label_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.sensitivity_labels.item.sensitivity_label_item_request_builder')
sensitivity_policy_settings_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.sensitivity_policy_settings.sensitivity_policy_settings_request_builder')
threat_assessment_requests_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.threat_assessment_requests.threat_assessment_requests_request_builder')
threat_assessment_request_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.threat_assessment_requests.item.threat_assessment_request_item_request_builder')
...
class InformationProtectionRequestBuilder():
    ...
    @property
    def microsoft_graph_decrypt_buffer(self) -> decrypt_buffer_request_builder.DecryptBufferRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_encrypt_buffer(self) -> encrypt_buffer_request_builder.EncryptBufferRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_sign_digest(self) -> sign_digest_request_builder.SignDigestRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_verify_signature(self) -> verify_signature_request_builder.VerifySignatureRequestBuilder:
        """
