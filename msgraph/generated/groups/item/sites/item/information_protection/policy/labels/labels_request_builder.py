...
evaluate_application_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_evaluate_application.evaluate_application_request_builder')
evaluate_classification_results_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_evaluate_classification_results.evaluate_classification_results_request_builder')
evaluate_removal_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_evaluate_removal.evaluate_removal_request_builder')
extract_label_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_extract_label.extract_label_request_builder')
...
class LabelsRequestBuilder():
    ...
    @property
    def microsoft_graph_evaluate_application(self) -> evaluate_application_request_builder.EvaluateApplicationRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_evaluate_classification_results(self) -> evaluate_classification_results_request_builder.EvaluateClassificationResultsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_evaluate_removal(self) -> evaluate_removal_request_builder.EvaluateRemovalRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_extract_label(self) -> extract_label_request_builder.ExtractLabelRequestBuilder:
        """
