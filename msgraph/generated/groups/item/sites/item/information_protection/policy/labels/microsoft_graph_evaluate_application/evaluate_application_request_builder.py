...
evaluate_application_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_evaluate_application.evaluate_application_post_request_body')
evaluate_application_response = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.microsoft_graph_evaluate_application.evaluate_application_response')
...
class EvaluateApplicationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels/microsoft.graph.evaluateApplication"
