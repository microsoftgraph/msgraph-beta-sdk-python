...
extract_label_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.extract_label.extract_label_post_request_body')
