...
labels_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.labels_request_builder')
information_protection_label_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.policy.labels.item.information_protection_label_item_request_builder')
