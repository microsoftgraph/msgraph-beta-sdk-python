...
evaluate_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.sensitivity_labels.microsoft_graph_evaluate.evaluate_request_builder')
