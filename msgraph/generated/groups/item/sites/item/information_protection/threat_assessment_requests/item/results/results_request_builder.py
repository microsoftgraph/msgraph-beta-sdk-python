...
count_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.threat_assessment_requests.item.results.count.count_request_builder')
