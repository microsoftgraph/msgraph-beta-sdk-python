...
results_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.threat_assessment_requests.item.results.results_request_builder')
threat_assessment_result_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.threat_assessment_requests.item.results.item.threat_assessment_result_item_request_builder')
...
class ThreatAssessmentRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}"
