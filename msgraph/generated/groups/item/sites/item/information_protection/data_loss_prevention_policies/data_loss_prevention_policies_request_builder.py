...
evaluate_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.information_protection.data_loss_prevention_policies.evaluate.evaluate_request_builder')
