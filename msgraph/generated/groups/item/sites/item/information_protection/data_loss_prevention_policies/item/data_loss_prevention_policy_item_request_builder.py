...
class DataLossPreventionPolicyItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, data_loss_prevention_policy_id: Optional[str] = None) -> None:
        """
        Instantiates a new DataLossPreventionPolicyItemRequestBuilder and sets the default values.
        Args:
            dataLossPreventionPolicyId: key: id of dataLossPreventionPolicy
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicy%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["dataLossPreventionPolicy%2Did"] = dataLossPreventionPolicyId
    ...
    async def get(self,request_configuration: Optional[DataLossPreventionPolicyItemRequestBuilderGetRequestConfiguration] = None) -> Optional[data_loss_prevention_policy.DataLossPreventionPolicy]:
        """
    ...
    async def patch(self,body: Optional[data_loss_prevention_policy.DataLossPreventionPolicy] = None, request_configuration: Optional[DataLossPreventionPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[data_loss_prevention_policy.DataLossPreventionPolicy]:
        """
    ...
    def to_patch_request_information(self,body: Optional[data_loss_prevention_policy.DataLossPreventionPolicy] = None, request_configuration: Optional[DataLossPreventionPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property dataLossPreventionPolicies in groups
        Args:
            body: The request body
