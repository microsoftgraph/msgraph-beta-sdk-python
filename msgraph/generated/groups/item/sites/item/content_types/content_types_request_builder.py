...
microsoft_graph_add_copy_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.content_types.microsoft_graph_add_copy.microsoft_graph_add_copy_request_builder')
microsoft_graph_add_copy_from_content_type_hub_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.content_types.microsoft_graph_add_copy_from_content_type_hub.microsoft_graph_add_copy_from_content_type_hub_request_builder')
microsoft_graph_get_compatible_hub_content_types_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.content_types.microsoft_graph_get_compatible_hub_content_types.microsoft_graph_get_compatible_hub_content_types_request_builder')
...
class ContentTypesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
