...
count_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.count.count_request_builder')
get_notebook_from_web_url_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.get_notebook_from_web_url.get_notebook_from_web_url_request_builder')
get_recent_notebooks_with_include_personal_notebooks_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.get_recent_notebooks_with_include_personal_notebooks.get_recent_notebooks_with_include_personal_notebooks_request_builder')
