...
copy_to_section_group_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.copy_to_section_group.copy_to_section_group_post_request_body')
...
class CopyToSectionGroupRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/microsoft.graph.copyToSectionGroup"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[copy_to_section_group_post_request_body.CopyToSectionGroupPostRequestBody] = None, request_configuration: Optional[CopyToSectionGroupRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
