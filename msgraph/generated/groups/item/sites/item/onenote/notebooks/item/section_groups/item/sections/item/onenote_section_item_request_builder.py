...
copy_to_notebook_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.copy_to_notebook.copy_to_notebook_request_builder')
copy_to_section_group_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.copy_to_section_group.copy_to_section_group_request_builder')
pages_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.pages.pages_request_builder')
onenote_page_item_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.pages.item.onenote_page_item_request_builder')
parent_notebook_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.parent_notebook.parent_notebook_request_builder')
parent_section_group_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.section_groups.item.sections.item.parent_section_group.parent_section_group_request_builder')
...
class OnenoteSectionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}"
