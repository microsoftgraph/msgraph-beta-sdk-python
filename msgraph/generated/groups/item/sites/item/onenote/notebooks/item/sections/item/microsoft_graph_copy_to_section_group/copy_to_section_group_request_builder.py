...
copy_to_section_group_post_request_body = lazy_import('msgraph.generated.groups.item.sites.item.onenote.notebooks.item.sections.item.microsoft_graph_copy_to_section_group.copy_to_section_group_post_request_body')
...
class CopyToSectionGroupRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/microsoft.graph.copyToSectionGroup"
