...
microsoft_graph_revoke_grants_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.permissions.item.microsoft_graph_revoke_grants.microsoft_graph_revoke_grants_request_builder')
