...
microsoft_graph_get_position_of_web_part_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.canvas_layout.horizontal_sections.item.columns.item.webparts.item.microsoft_graph_get_position_of_web_part.microsoft_graph_get_position_of_web_part_request_builder')
