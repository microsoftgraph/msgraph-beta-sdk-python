...
class LastModifiedByUserRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/lastModifiedByUser{?%24select,%24expand}"
    ...
    @dataclass
    class LastModifiedByUserRequestBuilderGetRequestConfiguration():
        """
