...
get_position_of_web_part_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.web_parts.item.microsoft_graph_get_position_of_web_part.get_position_of_web_part_request_builder')
