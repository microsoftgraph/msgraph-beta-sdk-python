...
microsoft_graph_get_position_of_web_part_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.canvas_layout.vertical_section.webparts.item.microsoft_graph_get_position_of_web_part.microsoft_graph_get_position_of_web_part_request_builder')
...
class WebPartItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_get_position_of_web_part(self) -> microsoft_graph_get_position_of_web_part_request_builder.MicrosoftGraphGetPositionOfWebPartRequestBuilder:
        """
        Provides operations to call the getPositionOfWebPart method.
        """
        return microsoft_graph_get_position_of_web_part_request_builder.MicrosoftGraphGetPositionOfWebPartRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection/webparts/{webPart%2Did}{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[web_part.WebPart] = None, request_configuration: Optional[WebPartItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property webparts in groups
        Args:
            body: The request body
