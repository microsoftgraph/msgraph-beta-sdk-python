...
if TYPE_CHECKING:
    ...
    from .get_position_of_web_part import get_position_of_web_part_request_builder
...
class WebPartItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[WebPartItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
