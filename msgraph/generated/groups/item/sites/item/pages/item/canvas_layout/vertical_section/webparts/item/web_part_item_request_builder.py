...
get_position_of_web_part_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.canvas_layout.vertical_section.webparts.item.get_position_of_web_part.get_position_of_web_part_request_builder')
...
class WebPartItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[WebPartItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[WebPartItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[web_part.WebPart] = None, request_configuration: Optional[WebPartItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
