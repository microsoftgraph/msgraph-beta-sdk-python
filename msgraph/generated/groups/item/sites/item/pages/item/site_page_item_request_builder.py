...
microsoft_graph_get_web_parts_by_position_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.microsoft_graph_get_web_parts_by_position.microsoft_graph_get_web_parts_by_position_request_builder')
microsoft_graph_publish_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.microsoft_graph_publish.microsoft_graph_publish_request_builder')
...
class SitePageItemRequestBuilder():
    ...
    @property
    def microsoft_graph_get_web_parts_by_position(self) -> microsoft_graph_get_web_parts_by_position_request_builder.MicrosoftGraphGetWebPartsByPositionRequestBuilder:
        """
        Provides operations to call the getWebPartsByPosition method.
        """
        return microsoft_graph_get_web_parts_by_position_request_builder.MicrosoftGraphGetWebPartsByPositionRequestBuilder(self.request_adapter, self.path_parameters)
