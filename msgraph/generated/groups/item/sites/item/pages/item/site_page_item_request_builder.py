...
get_web_parts_by_position_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.microsoft_graph_get_web_parts_by_position.get_web_parts_by_position_request_builder')
publish_request_builder = lazy_import('msgraph.generated.groups.item.sites.item.pages.item.microsoft_graph_publish.publish_request_builder')
