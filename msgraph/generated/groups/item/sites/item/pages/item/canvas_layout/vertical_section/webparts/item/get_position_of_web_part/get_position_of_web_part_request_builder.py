...
class GetPositionOfWebPartRequestBuilder():
    ...
    def create_post_request_information(self,request_configuration: Optional[GetPositionOfWebPartRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetPositionOfWebPartRequestBuilderPostRequestConfiguration():
        """
