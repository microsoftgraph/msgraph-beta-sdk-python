...
activities_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.activities.item.item_activity_o_l_d_item_request_builder')
