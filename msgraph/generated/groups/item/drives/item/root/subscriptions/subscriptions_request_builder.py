...
count_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.root.subscriptions.count.count_request_builder')
...
class SubscriptionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
