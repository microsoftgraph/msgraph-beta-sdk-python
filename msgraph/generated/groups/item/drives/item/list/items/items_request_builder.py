...
count_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.items.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.items.delta.delta_request_builder')
delta_with_token_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.items.delta_with_token.delta_with_token_request_builder')
...
class ItemsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[list_item.ListItem] = None, request_configuration: Optional[ItemsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
