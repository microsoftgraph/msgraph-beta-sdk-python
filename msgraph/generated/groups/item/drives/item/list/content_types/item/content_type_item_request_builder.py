...
associate_with_hub_sites_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.associate_with_hub_sites.associate_with_hub_sites_request_builder')
base_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.base.base_request_builder')
base_types_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.base_types.base_types_request_builder')
content_type_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.base_types.item.content_type_item_request_builder')
column_links_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.column_links.column_links_request_builder')
column_link_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.column_links.item.column_link_item_request_builder')
column_positions_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.column_positions.column_positions_request_builder')
column_definition_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.column_positions.item.column_definition_item_request_builder')
columns_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.columns.columns_request_builder')
column_definition_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.columns.item.column_definition_item_request_builder')
copy_to_default_content_location_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.copy_to_default_content_location.copy_to_default_content_location_request_builder')
is_published_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.is_published.is_published_request_builder')
publish_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.publish.publish_request_builder')
unpublish_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.list.content_types.item.unpublish.unpublish_request_builder')
...
class ContentTypeItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}{?%24select,%24expand}"
