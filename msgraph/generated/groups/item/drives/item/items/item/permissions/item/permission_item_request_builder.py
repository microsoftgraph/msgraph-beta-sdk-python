...
revoke_grants_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.permissions.item.revoke_grants.revoke_grants_request_builder')
