...
activities_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.analytics.analytics_request_builder')
assign_sensitivity_label_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.assign_sensitivity_label.assign_sensitivity_label_request_builder')
checkin_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.checkin.checkin_request_builder')
checkout_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.checkout.checkout_request_builder')
children_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.children.children_request_builder')
drive_item_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.children.item.drive_item_item_request_builder')
content_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.content.content_request_builder')
copy_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.copy.copy_request_builder')
create_link_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.create_link.create_link_request_builder')
create_upload_session_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.create_upload_session.create_upload_session_request_builder')
delta_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.delta.delta_request_builder')
delta_with_token_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.delta_with_token.delta_with_token_request_builder')
extract_sensitivity_labels_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.extract_sensitivity_labels.extract_sensitivity_labels_request_builder')
follow_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.follow.follow_request_builder')
get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval.get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval_request_builder')
invite_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.invite.invite_request_builder')
list_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.list_item.list_item_request_builder')
permissions_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.permissions.permissions_request_builder')
permission_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.permissions.item.permission_item_request_builder')
preview_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.preview.preview_request_builder')
restore_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.restore.restore_request_builder')
search_with_q_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.search_with_q.search_with_q_request_builder')
subscriptions_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.subscriptions.subscriptions_request_builder')
subscription_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.subscriptions.item.subscription_item_request_builder')
thumbnails_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.thumbnails.thumbnails_request_builder')
thumbnail_set_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.thumbnails.item.thumbnail_set_item_request_builder')
unfollow_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.unfollow.unfollow_request_builder')
validate_permission_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.validate_permission.validate_permission_request_builder')
versions_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.versions.versions_request_builder')
drive_item_version_item_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.versions.item.drive_item_version_item_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}{?%24select,%24expand}"
