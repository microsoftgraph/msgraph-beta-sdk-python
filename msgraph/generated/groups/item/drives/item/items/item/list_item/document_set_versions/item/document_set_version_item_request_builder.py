...
restore_request_builder = lazy_import('msgraph.generated.groups.item.drives.item.items.item.list_item.document_set_versions.item.restore.restore_request_builder')
...
class DocumentSetVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"
