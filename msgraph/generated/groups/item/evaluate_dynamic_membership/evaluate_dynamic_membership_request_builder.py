...
evaluate_dynamic_membership_post_request_body = lazy_import('msgraph.generated.groups.item.evaluate_dynamic_membership.evaluate_dynamic_membership_post_request_body')
...
class EvaluateDynamicMembershipRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/evaluateDynamicMembership"
