...
copy_to_notebook_post_request_body = lazy_import('msgraph.generated.groups.item.onenote.notebooks.item.sections.item.microsoft_graph_copy_to_notebook.copy_to_notebook_post_request_body')
...
class CopyToNotebookRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/microsoft.graph.copyToNotebook"
