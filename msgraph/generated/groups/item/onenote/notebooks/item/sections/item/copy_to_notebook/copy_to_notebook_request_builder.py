...
copy_to_notebook_post_request_body = lazy_import('msgraph.generated.groups.item.onenote.notebooks.item.sections.item.copy_to_notebook.copy_to_notebook_post_request_body')
