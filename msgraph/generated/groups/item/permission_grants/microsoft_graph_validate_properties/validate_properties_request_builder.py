...
validate_properties_post_request_body = lazy_import('msgraph.generated.groups.item.permission_grants.microsoft_graph_validate_properties.validate_properties_post_request_body')
...
class ValidatePropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/permissionGrants/microsoft.graph.validateProperties"
