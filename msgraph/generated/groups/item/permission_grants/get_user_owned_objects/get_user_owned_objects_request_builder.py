...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.groups.item.permission_grants.get_user_owned_objects.get_user_owned_objects_post_request_body')
