...
delta_request_builder = lazy_import('msgraph.generated.groups.item.team.permission_grants.delta.delta_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.groups.item.team.permission_grants.get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.groups.item.team.permission_grants.get_user_owned_objects.get_user_owned_objects_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.groups.item.team.permission_grants.validate_properties.validate_properties_request_builder')
