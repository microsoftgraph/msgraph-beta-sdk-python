...
clock_in_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.clock_in.clock_in_request_builder')
count_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.count.count_request_builder')
time_card = lazy_import('msgraph.generated.models.time_card')
time_card_collection_response = lazy_import('msgraph.generated.models.time_card_collection_response')
...
class TimeCardsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[TimeCardsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[time_card.TimeCard] = None, request_configuration: Optional[TimeCardsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
