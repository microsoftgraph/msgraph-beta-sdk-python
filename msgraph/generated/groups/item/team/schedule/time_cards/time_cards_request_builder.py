...
clock_in_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.microsoft_graph_clock_in.clock_in_request_builder')
...
class TimeCardsRequestBuilder():
    ...
    @property
    def microsoft_graph_clock_in(self) -> clock_in_request_builder.ClockInRequestBuilder:
        """
