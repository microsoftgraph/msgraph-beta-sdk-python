...
clock_out_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.clock_out.clock_out_request_builder')
confirm_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.confirm.confirm_request_builder')
end_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.end_break.end_break_request_builder')
start_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.start_break.start_break_request_builder')
