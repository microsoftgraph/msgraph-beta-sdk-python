...
clock_out_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_clock_out.clock_out_request_builder')
confirm_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_confirm.confirm_request_builder')
end_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_end_break.end_break_request_builder')
start_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_start_break.start_break_request_builder')
