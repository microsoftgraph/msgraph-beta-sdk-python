...
microsoft_graph_clock_out_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_clock_out.microsoft_graph_clock_out_request_builder')
microsoft_graph_confirm_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_confirm.microsoft_graph_confirm_request_builder')
microsoft_graph_end_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_end_break.microsoft_graph_end_break_request_builder')
microsoft_graph_start_break_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_cards.item.microsoft_graph_start_break.microsoft_graph_start_break_request_builder')
...
class TimeCardItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/schedule/timeCards/{timeCard%2Did}{?%24select,%24expand}"
