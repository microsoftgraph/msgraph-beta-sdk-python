...
count_request_builder = lazy_import('msgraph.generated.groups.item.team.schedule.time_off_reasons.count.count_request_builder')
...
class TimeOffReasonsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
