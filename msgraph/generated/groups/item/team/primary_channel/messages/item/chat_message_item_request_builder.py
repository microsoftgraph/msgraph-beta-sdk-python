...
set_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.primary_channel.messages.item.microsoft_graph_set_reaction.set_reaction_request_builder')
...
unset_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.primary_channel.messages.item.microsoft_graph_unset_reaction.unset_reaction_request_builder')
