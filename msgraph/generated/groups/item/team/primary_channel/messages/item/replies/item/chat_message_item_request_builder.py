...
microsoft_graph_set_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.primary_channel.messages.item.replies.item.microsoft_graph_set_reaction.microsoft_graph_set_reaction_request_builder')
...
microsoft_graph_unset_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.primary_channel.messages.item.replies.item.microsoft_graph_unset_reaction.microsoft_graph_unset_reaction_request_builder')
