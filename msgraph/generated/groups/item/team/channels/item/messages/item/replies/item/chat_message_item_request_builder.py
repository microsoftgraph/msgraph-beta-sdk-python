...
set_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.item.microsoft_graph_set_reaction.set_reaction_request_builder')
soft_delete_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.item.microsoft_graph_soft_delete.soft_delete_request_builder')
undo_soft_delete_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.item.microsoft_graph_undo_soft_delete.undo_soft_delete_request_builder')
unset_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.item.microsoft_graph_unset_reaction.unset_reaction_request_builder')
