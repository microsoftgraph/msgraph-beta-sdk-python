...
hosted_contents_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.hosted_contents.hosted_contents_request_builder')
chat_message_hosted_content_item_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.hosted_contents.item.chat_message_hosted_content_item_request_builder')
microsoft_graph_set_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.microsoft_graph_set_reaction.microsoft_graph_set_reaction_request_builder')
microsoft_graph_soft_delete_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.microsoft_graph_soft_delete.microsoft_graph_soft_delete_request_builder')
microsoft_graph_undo_soft_delete_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.microsoft_graph_undo_soft_delete.microsoft_graph_undo_soft_delete_request_builder')
microsoft_graph_unset_reaction_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.microsoft_graph_unset_reaction.microsoft_graph_unset_reaction_request_builder')
replies_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.replies_request_builder')
chat_message_item_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.messages.item.replies.item.chat_message_item_request_builder')
...
class ChatMessageItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}"
