...
allowed_members_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.shared_with_teams.item.allowed_members.allowed_members_request_builder')
conversation_member_item_request_builder = lazy_import('msgraph.generated.groups.item.team.channels.item.shared_with_teams.item.allowed_members.item.conversation_member_item_request_builder')
...
class SharedWithChannelTeamInfoItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}"
