...
if TYPE_CHECKING:
    from ...models import base_collection_pagination_count_response, privileged_role_assignment_request
...
class MyResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[privileged_role_assignment_request.PrivilegedRoleAssignmentRequest]] = None
