...
class PrivilegedRoleAssignmentRequestsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PrivilegedRoleAssignmentRequestsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[privileged_role_assignment_request.PrivilegedRoleAssignmentRequest] = None, request_configuration: Optional[PrivilegedRoleAssignmentRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
