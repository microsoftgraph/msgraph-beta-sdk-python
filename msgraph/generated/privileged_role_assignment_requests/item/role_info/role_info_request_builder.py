...
self_activate_request_builder = lazy_import('msgraph.generated.privileged_role_assignment_requests.item.role_info.microsoft_graph_self_activate.self_activate_request_builder')
self_deactivate_request_builder = lazy_import('msgraph.generated.privileged_role_assignment_requests.item.role_info.microsoft_graph_self_deactivate.self_deactivate_request_builder')
