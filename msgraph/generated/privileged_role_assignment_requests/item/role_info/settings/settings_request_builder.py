...
if TYPE_CHECKING:
    ...
    from .....models.privileged_role_settings import PrivilegedRoleSettings
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/settings{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[SettingsRequestBuilderGetRequestConfiguration] = None) -> Optional[PrivilegedRoleSettings]:
        """
        Get settings from privilegedRoleAssignmentRequests
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PrivilegedRoleSettings]
        """
        ...
        return await self.request_adapter.send_async(request_info, PrivilegedRoleSettings, error_mapping)
    
    async def patch(self,body: Optional[PrivilegedRoleSettings] = None, request_configuration: Optional[SettingsRequestBuilderPatchRequestConfiguration] = None) -> Optional[PrivilegedRoleSettings]:
        """
    ...
    def to_patch_request_information(self,body: Optional[PrivilegedRoleSettings] = None, request_configuration: Optional[SettingsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property settings in privilegedRoleAssignmentRequests
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
