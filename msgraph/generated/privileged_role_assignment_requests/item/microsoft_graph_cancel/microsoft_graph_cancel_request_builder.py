...
class MicrosoftGraphCancelRequestBuilder():
    ...
    async def post(self,request_configuration: Optional[MicrosoftGraphCancelRequestBuilderPostRequestConfiguration] = None) -> Optional[privileged_role_assignment_request.PrivilegedRoleAssignmentRequest]:
        """
