...
class ExactMatchUploadAgentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, exact_match_upload_agent_id: Optional[str] = None) -> None:
        """
        Instantiates a new ExactMatchUploadAgentItemRequestBuilder and sets the default values.
        Args:
            exactMatchUploadAgentId: key: id of exactMatchUploadAgent
        ...
        url_tpl_params["exactMatchUploadAgent%2Did"] = exactMatchUploadAgentId
    ...
    async def get(self,request_configuration: Optional[ExactMatchUploadAgentItemRequestBuilderGetRequestConfiguration] = None) -> Optional[exact_match_upload_agent.ExactMatchUploadAgent]:
        """
    ...
    async def patch(self,body: Optional[exact_match_upload_agent.ExactMatchUploadAgent] = None, request_configuration: Optional[ExactMatchUploadAgentItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[exact_match_upload_agent.ExactMatchUploadAgent]:
        """
    ...
    def to_patch_request_information(self,body: Optional[exact_match_upload_agent.ExactMatchUploadAgent] = None, request_configuration: Optional[ExactMatchUploadAgentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property exactMatchUploadAgents in dataClassification
        Args:
            body: The request body
