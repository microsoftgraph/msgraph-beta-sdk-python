...
class ExactMatchUploadAgentsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[exact_match_upload_agent.ExactMatchUploadAgent] = None, request_configuration: Optional[ExactMatchUploadAgentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to exactMatchUploadAgents for dataClassification
        Args:
            body: The request body
