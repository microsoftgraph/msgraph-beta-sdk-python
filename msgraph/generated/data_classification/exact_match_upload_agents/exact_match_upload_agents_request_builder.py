...
count_request_builder = lazy_import('msgraph.generated.data_classification.exact_match_upload_agents.count.count_request_builder')
exact_match_upload_agent = lazy_import('msgraph.generated.models.exact_match_upload_agent')
exact_match_upload_agent_collection_response = lazy_import('msgraph.generated.models.exact_match_upload_agent_collection_response')
...
class ExactMatchUploadAgentsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ExactMatchUploadAgentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[exact_match_upload_agent.ExactMatchUploadAgent] = None, request_configuration: Optional[ExactMatchUploadAgentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
