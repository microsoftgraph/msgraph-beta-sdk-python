...
count_request_builder = lazy_import('msgraph.generated.data_classification.classify_text_jobs.count.count_request_builder')
...
class ClassifyTextJobsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ClassifyTextJobsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[job_response_base.JobResponseBase] = None, request_configuration: Optional[ClassifyTextJobsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
