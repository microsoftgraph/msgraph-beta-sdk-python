...
class ClassifyTextJobsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[job_response_base.JobResponseBase] = None, request_configuration: Optional[ClassifyTextJobsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to classifyTextJobs for dataClassification
        Args:
            body: The request body
