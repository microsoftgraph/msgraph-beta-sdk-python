...
microsoft_graph_lookup_request_builder = lazy_import('msgraph.generated.data_classification.exact_match_data_stores.item.microsoft_graph_lookup.microsoft_graph_lookup_request_builder')
...
class ExactMatchDataStoreItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[exact_match_data_store.ExactMatchDataStore] = None, request_configuration: Optional[ExactMatchDataStoreItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property exactMatchDataStores in dataClassification
        Args:
            body: The request body
