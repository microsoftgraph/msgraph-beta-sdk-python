...
class ExactMatchDataStoreItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ExactMatchDataStoreItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ExactMatchDataStoreItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[exact_match_data_store.ExactMatchDataStore] = None, request_configuration: Optional[ExactMatchDataStoreItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
