...
class RenewRequestBuilder():
    ...
    def create_post_request_information(self,request_configuration: Optional[RenewRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action renew
        Args:
    ...
    @dataclass
    class RenewRequestBuilderPostRequestConfiguration():
        """
