...
classify_exact_matches_request_builder = lazy_import('msgraph.generated.data_classification.microsoft_graph_classify_exact_matches.classify_exact_matches_request_builder')
classify_file_request_builder = lazy_import('msgraph.generated.data_classification.microsoft_graph_classify_file.classify_file_request_builder')
...
class DataClassificationRequestBuilder():
    ...
    @property
    def microsoft_graph_classify_exact_matches(self) -> classify_exact_matches_request_builder.ClassifyExactMatchesRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_classify_file(self) -> classify_file_request_builder.ClassifyFileRequestBuilder:
        """
