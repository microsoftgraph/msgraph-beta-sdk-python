...
cancel_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignment_requests.item.microsoft_graph_cancel.cancel_request_builder')
update_request_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignment_requests.item.microsoft_graph_update_request.update_request_request_builder')
...
class GovernanceRoleAssignmentRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, governance_role_assignment_request_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}"
