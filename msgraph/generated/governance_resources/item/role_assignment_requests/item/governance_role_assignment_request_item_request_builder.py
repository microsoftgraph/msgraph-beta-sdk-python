...
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignment_requests.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
microsoft_graph_update_request_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignment_requests.item.microsoft_graph_update_request.microsoft_graph_update_request_request_builder')
