...
resource_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_settings.item.resource.resource_request_builder')
role_definition_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_settings.item.role_definition.role_definition_request_builder')
...
class GovernanceRoleSettingItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleSettings/{governanceRoleSetting%2Did}{?%24select,%24expand}"
