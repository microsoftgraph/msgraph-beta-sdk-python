...
linked_eligible_role_assignment_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignments.item.linked_eligible_role_assignment.linked_eligible_role_assignment_request_builder')
resource_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignments.item.resource.resource_request_builder')
role_definition_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignments.item.role_definition.role_definition_request_builder')
subject_request_builder = lazy_import('msgraph.generated.governance_resources.item.role_assignments.item.subject.subject_request_builder')
...
class GovernanceRoleAssignmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, governance_role_assignment_id: Optional[str] = None) -> None:
        """
        Instantiates a new GovernanceRoleAssignmentItemRequestBuilder and sets the default values.
        Args:
            governanceRoleAssignmentId: key: id of governanceRoleAssignment
        ...
        self.url_template: str = "{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["governanceRoleAssignment%2Did"] = governanceRoleAssignmentId
