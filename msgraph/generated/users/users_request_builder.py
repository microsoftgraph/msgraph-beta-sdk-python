...
get_managed_app_blocked_users_request_builder = lazy_import('msgraph.generated.users.microsoft_graph_get_managed_app_blocked_users.get_managed_app_blocked_users_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.users.microsoft_graph_get_user_owned_objects.get_user_owned_objects_request_builder')
validate_password_request_builder = lazy_import('msgraph.generated.users.microsoft_graph_validate_password.validate_password_request_builder')
...
class UsersRequestBuilder():
    ...
    @property
    def microsoft_graph_get_managed_app_blocked_users(self) -> get_managed_app_blocked_users_request_builder.GetManagedAppBlockedUsersRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_validate_password(self) -> validate_password_request_builder.ValidatePasswordRequestBuilder:
        """
    ...
    def to_post_request_information(self,body: Optional[user.User] = None, request_configuration: Optional[UsersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create a new user.The request body contains the user to create. At a minimum, you must specify the required properties for the user. You can optionally specify any other writable properties. This operation returns by default only a subset of the properties for each user. These default properties are noted in the Properties section. To get properties that are not returned by default, do a GET operation and specify the properties in a `$select` OData query option.
        Args:
            body: The request body
