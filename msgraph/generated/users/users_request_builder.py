...
if TYPE_CHECKING:
    ...
    from .get_managed_app_blocked_users.get_managed_app_blocked_users_request_builder import GetManagedAppBlockedUsersRequestBuilder
    ...
    from .validate_password.validate_password_request_builder import ValidatePasswordRequestBuilder
...
class UsersRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def get_managed_app_blocked_users(self) -> GetManagedAppBlockedUsersRequestBuilder:
        """
        Provides operations to call the getManagedAppBlockedUsers method.
        """
        from .get_managed_app_blocked_users.get_managed_app_blocked_users_request_builder import GetManagedAppBlockedUsersRequestBuilder

        return GetManagedAppBlockedUsersRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def validate_password(self) -> ValidatePasswordRequestBuilder:
        """
        Provides operations to call the validatePassword method.
        """
        from .validate_password.validate_password_request_builder import ValidatePasswordRequestBuilder

        return ValidatePasswordRequestBuilder(self.request_adapter, self.path_parameters)
