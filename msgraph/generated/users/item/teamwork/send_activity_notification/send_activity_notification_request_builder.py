...
class SendActivityNotificationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/teamwork/sendActivityNotification", path_parameters)
    ...
    async def post(self,body: Optional[SendActivityNotificationPostRequestBody] = None, request_configuration: Optional[SendActivityNotificationRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        Send an activity feed notification to a user. For more information, see sending Teams activity notifications. This API is available in the following national cloud deployments.
