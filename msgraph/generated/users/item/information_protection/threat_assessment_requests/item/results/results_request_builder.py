...
threat_assessment_result_collection_response = lazy_import('msgraph.generated.models.threat_assessment_result_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.users.item.information_protection.threat_assessment_requests.item.results.count.count_request_builder')
...
class ResultsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ResultsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[threat_assessment_result.ThreatAssessmentResult] = None, request_configuration: Optional[ResultsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
