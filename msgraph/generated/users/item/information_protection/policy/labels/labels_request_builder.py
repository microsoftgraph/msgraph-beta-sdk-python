...
evaluate_application_request_builder = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.microsoft_graph_evaluate_application.evaluate_application_request_builder')
evaluate_classification_results_request_builder = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.microsoft_graph_evaluate_classification_results.evaluate_classification_results_request_builder')
evaluate_removal_request_builder = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.microsoft_graph_evaluate_removal.evaluate_removal_request_builder')
extract_label_request_builder = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.microsoft_graph_extract_label.extract_label_request_builder')
