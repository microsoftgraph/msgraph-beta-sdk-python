...
extract_label_post_request_body = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.microsoft_graph_extract_label.extract_label_post_request_body')
...
class ExtractLabelRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/microsoft.graph.extractLabel"
