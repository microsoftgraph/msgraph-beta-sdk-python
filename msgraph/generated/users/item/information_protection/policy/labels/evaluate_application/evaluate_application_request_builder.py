...
evaluate_application_post_request_body = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.evaluate_application.evaluate_application_post_request_body')
evaluate_application_response = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.evaluate_application.evaluate_application_response')
...
class EvaluateApplicationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/microsoft.graph.evaluateApplication"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[evaluate_application_post_request_body.EvaluateApplicationPostRequestBody] = None, request_configuration: Optional[EvaluateApplicationRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
