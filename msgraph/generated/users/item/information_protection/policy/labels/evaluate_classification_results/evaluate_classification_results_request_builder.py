...
evaluate_classification_results_post_request_body = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.evaluate_classification_results.evaluate_classification_results_post_request_body')
evaluate_classification_results_response = lazy_import('msgraph.generated.users.item.information_protection.policy.labels.evaluate_classification_results.evaluate_classification_results_response')
...
class EvaluateClassificationResultsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/microsoft.graph.evaluateClassificationResults"
