...
count_request_builder = lazy_import('msgraph.generated.users.item.information_protection.data_loss_prevention_policies.count.count_request_builder')
microsoft_graph_evaluate_request_builder = lazy_import('msgraph.generated.users.item.information_protection.data_loss_prevention_policies.microsoft_graph_evaluate.microsoft_graph_evaluate_request_builder')
...
class DataLossPreventionPoliciesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection/dataLossPreventionPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
