...
decrypt_buffer_request_builder = lazy_import('msgraph.generated.users.item.information_protection.microsoft_graph_decrypt_buffer.decrypt_buffer_request_builder')
encrypt_buffer_request_builder = lazy_import('msgraph.generated.users.item.information_protection.microsoft_graph_encrypt_buffer.encrypt_buffer_request_builder')
sign_digest_request_builder = lazy_import('msgraph.generated.users.item.information_protection.microsoft_graph_sign_digest.sign_digest_request_builder')
verify_signature_request_builder = lazy_import('msgraph.generated.users.item.information_protection.microsoft_graph_verify_signature.verify_signature_request_builder')
...
class InformationProtectionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection{?%24select,%24expand}"
