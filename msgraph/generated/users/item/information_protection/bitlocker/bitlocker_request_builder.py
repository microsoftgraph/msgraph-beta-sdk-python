...
recovery_keys_request_builder = lazy_import('msgraph.generated.users.item.information_protection.bitlocker.recovery_keys.recovery_keys_request_builder')
bitlocker_recovery_key_item_request_builder = lazy_import('msgraph.generated.users.item.information_protection.bitlocker.recovery_keys.item.bitlocker_recovery_key_item_request_builder')
...
class BitlockerRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker{?%24select,%24expand}"
