...
endpoint_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.microsoft_graph_endpoint.endpoint_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.microsoft_graph_service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.microsoft_graph_user.user_request_builder')
