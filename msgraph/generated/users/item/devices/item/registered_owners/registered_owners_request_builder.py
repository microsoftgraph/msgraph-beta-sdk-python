...
graph_endpoint_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.graph_endpoint.graph_endpoint_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.graph_service_principal.graph_service_principal_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.users.item.devices.item.registered_owners.graph_user.graph_user_request_builder')
