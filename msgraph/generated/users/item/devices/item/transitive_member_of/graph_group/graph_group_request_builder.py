...
count_request_builder = lazy_import('msgraph.generated.users.item.devices.item.transitive_member_of.graph_group.count.count_request_builder')
...
class GraphGroupRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
