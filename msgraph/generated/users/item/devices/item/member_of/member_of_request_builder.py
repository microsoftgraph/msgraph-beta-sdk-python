...
count_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.count.count_request_builder')
microsoft_graph_application_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_application.microsoft_graph_application_request_builder')
microsoft_graph_device_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_device.microsoft_graph_device_request_builder')
microsoft_graph_group_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_group.microsoft_graph_group_request_builder')
microsoft_graph_org_contact_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_org_contact.microsoft_graph_org_contact_request_builder')
microsoft_graph_service_principal_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_service_principal.microsoft_graph_service_principal_request_builder')
microsoft_graph_user_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.microsoft_graph_user.microsoft_graph_user_request_builder')
...
class MemberOfRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
