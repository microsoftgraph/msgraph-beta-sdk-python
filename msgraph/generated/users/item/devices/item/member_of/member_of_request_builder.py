...
graph_administrative_unit_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.graph_administrative_unit.graph_administrative_unit_request_builder')
graph_group_request_builder = lazy_import('msgraph.generated.users.item.devices.item.member_of.graph_group.graph_group_request_builder')
