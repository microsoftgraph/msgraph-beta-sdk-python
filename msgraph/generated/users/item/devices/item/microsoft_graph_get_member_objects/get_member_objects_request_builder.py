...
get_member_objects_post_request_body = lazy_import('msgraph.generated.users.item.devices.item.microsoft_graph_get_member_objects.get_member_objects_post_request_body')
get_member_objects_response = lazy_import('msgraph.generated.users.item.devices.item.microsoft_graph_get_member_objects.get_member_objects_response')
