...
create_upload_session_post_request_body = lazy_import('msgraph.generated.users.item.events.item.instances.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_post_request_body')
...
class CreateUploadSessionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/attachments/microsoft.graph.createUploadSession"
