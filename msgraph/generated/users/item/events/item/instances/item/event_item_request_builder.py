...
exception_occurrences_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.exception_occurrences.exception_occurrences_request_builder')
event_item_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.exception_occurrences.item.event_item_request_builder')
...
microsoft_graph_accept_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_accept.microsoft_graph_accept_request_builder')
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
microsoft_graph_decline_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_decline.microsoft_graph_decline_request_builder')
microsoft_graph_dismiss_reminder_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_dismiss_reminder.microsoft_graph_dismiss_reminder_request_builder')
microsoft_graph_forward_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_forward.microsoft_graph_forward_request_builder')
microsoft_graph_snooze_reminder_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_snooze_reminder.microsoft_graph_snooze_reminder_request_builder')
microsoft_graph_tentatively_accept_request_builder = lazy_import('msgraph.generated.users.item.events.item.instances.item.microsoft_graph_tentatively_accept.microsoft_graph_tentatively_accept_request_builder')
