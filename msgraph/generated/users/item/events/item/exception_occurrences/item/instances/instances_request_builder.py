...
count_request_builder = lazy_import('msgraph.generated.users.item.events.item.exception_occurrences.item.instances.count.count_request_builder')
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.users.item.events.item.exception_occurrences.item.instances.microsoft_graph_delta.microsoft_graph_delta_request_builder')
...
class InstancesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
