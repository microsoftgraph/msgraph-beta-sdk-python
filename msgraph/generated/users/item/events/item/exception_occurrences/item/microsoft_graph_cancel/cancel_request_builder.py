...
cancel_post_request_body = lazy_import('msgraph.generated.users.item.events.item.exception_occurrences.item.microsoft_graph_cancel.cancel_post_request_body')
