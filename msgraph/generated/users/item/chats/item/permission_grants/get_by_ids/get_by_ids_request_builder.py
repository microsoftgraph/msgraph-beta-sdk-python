...
get_by_ids_post_request_body = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.get_by_ids.get_by_ids_post_request_body')
get_by_ids_response = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.get_by_ids.get_by_ids_response')
