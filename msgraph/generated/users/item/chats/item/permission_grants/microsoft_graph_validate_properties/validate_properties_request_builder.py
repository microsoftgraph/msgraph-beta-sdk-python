...
validate_properties_post_request_body = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.microsoft_graph_validate_properties.validate_properties_post_request_body')
