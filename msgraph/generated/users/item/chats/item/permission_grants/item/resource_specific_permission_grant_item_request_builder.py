...
check_member_groups_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.check_member_groups.check_member_groups_request_builder')
check_member_objects_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.check_member_objects.check_member_objects_request_builder')
get_member_groups_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.get_member_groups.get_member_groups_request_builder')
get_member_objects_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.get_member_objects.get_member_objects_request_builder')
restore_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.restore.restore_request_builder')
