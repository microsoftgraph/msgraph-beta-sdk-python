...
set_reaction_request_builder = lazy_import('msgraph.generated.users.item.chats.item.messages.item.replies.item.set_reaction.set_reaction_request_builder')
...
unset_reaction_request_builder = lazy_import('msgraph.generated.users.item.chats.item.messages.item.replies.item.unset_reaction.unset_reaction_request_builder')
