...
operations_request_builder = lazy_import('msgraph.generated.users.item.chats.item.operations.operations_request_builder')
teams_async_operation_item_request_builder = lazy_import('msgraph.generated.users.item.chats.item.operations.item.teams_async_operation_item_request_builder')
permission_grants_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.permission_grants_request_builder')
resource_specific_permission_grant_item_request_builder = lazy_import('msgraph.generated.users.item.chats.item.permission_grants.item.resource_specific_permission_grant_item_request_builder')
