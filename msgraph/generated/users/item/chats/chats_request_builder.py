...
all_messages_request_builder = lazy_import('msgraph.generated.users.item.chats.all_messages.all_messages_request_builder')
count_request_builder = lazy_import('msgraph.generated.users.item.chats.count.count_request_builder')
get_all_messages_request_builder = lazy_import('msgraph.generated.users.item.chats.get_all_messages.get_all_messages_request_builder')
...
class ChatsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/chats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ChatsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[chat.Chat] = None, request_configuration: Optional[ChatsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
