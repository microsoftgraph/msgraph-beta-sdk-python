...
find_rooms_with_room_list_response = lazy_import('msgraph.generated.users.item.microsoft_graph_find_rooms_with_room_list.find_rooms_with_room_list_response')
...
class FindRoomsWithRoomListRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, room_list: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/microsoft.graph.findRooms(RoomList='{RoomList}'){?%24top,%24skip,%24search,%24filter,%24count}"
