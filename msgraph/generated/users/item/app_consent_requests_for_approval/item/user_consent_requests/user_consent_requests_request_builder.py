...
count_request_builder = lazy_import('msgraph.generated.users.item.app_consent_requests_for_approval.item.user_consent_requests.count.count_request_builder')
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.users.item.app_consent_requests_for_approval.item.user_consent_requests.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
class UserConsentRequestsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval/{appConsentRequest%2Did}/userConsentRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[user_consent_request.UserConsentRequest] = None, request_configuration: Optional[UserConsentRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userConsentRequests for users
        Args:
            body: The request body
