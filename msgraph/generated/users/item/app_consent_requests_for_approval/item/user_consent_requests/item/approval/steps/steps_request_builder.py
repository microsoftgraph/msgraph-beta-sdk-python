...
count_request_builder = lazy_import('msgraph.generated.users.item.app_consent_requests_for_approval.item.user_consent_requests.item.approval.steps.count.count_request_builder')
