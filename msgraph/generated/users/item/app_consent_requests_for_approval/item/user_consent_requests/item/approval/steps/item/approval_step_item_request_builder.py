...
class ApprovalStepItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, approval_step_id: Optional[str] = None) -> None:
        """
        Instantiates a new ApprovalStepItemRequestBuilder and sets the default values.
        Args:
            approvalStepId: key: id of approvalStep
        ...
        url_tpl_params["approvalStep%2Did"] = approvalStepId
