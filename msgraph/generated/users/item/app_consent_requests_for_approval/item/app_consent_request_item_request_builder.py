...
user_consent_requests_request_builder = lazy_import('msgraph.generated.users.item.app_consent_requests_for_approval.item.user_consent_requests.user_consent_requests_request_builder')
user_consent_request_item_request_builder = lazy_import('msgraph.generated.users.item.app_consent_requests_for_approval.item.user_consent_requests.item.user_consent_request_item_request_builder')
