...
activate_device_esim_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.activate_device_esim.activate_device_esim_request_builder')
...
create_device_log_collection_request_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.create_device_log_collection_request.create_device_log_collection_request_request_builder')
create_remote_help_session_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.create_remote_help_session.create_remote_help_session_request_builder')
...
deprovision_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.deprovision.deprovision_request_builder')
...
disable_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.disable.disable_request_builder')
...
enable_lost_mode_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.enable_lost_mode.enable_lost_mode_request_builder')
end_remote_help_session_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.end_remote_help_session.end_remote_help_session_request_builder')
enroll_now_action_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.enroll_now_action.enroll_now_action_request_builder')
get_cloud_pc_remote_action_results_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.get_cloud_pc_remote_action_results.get_cloud_pc_remote_action_results_request_builder')
get_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.get_cloud_pc_review_status.get_cloud_pc_review_status_request_builder')
get_file_vault_key_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.get_file_vault_key.get_file_vault_key_request_builder')
get_non_compliant_settings_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.get_non_compliant_settings.get_non_compliant_settings_request_builder')
get_oem_warranty_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.get_oem_warranty.get_oem_warranty_request_builder')
initiate_mobile_device_management_key_recovery_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.initiate_mobile_device_management_key_recovery.initiate_mobile_device_management_key_recovery_request_builder')
initiate_on_demand_proactive_remediation_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.initiate_on_demand_proactive_remediation.initiate_on_demand_proactive_remediation_request_builder')
...
override_compliance_state_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.override_compliance_state.override_compliance_state_request_builder')
play_lost_mode_sound_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.play_lost_mode_sound.play_lost_mode_sound_request_builder')
...
reenable_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.reenable.reenable_request_builder')
...
remove_device_firmware_configuration_interface_management_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.remove_device_firmware_configuration_interface_management.remove_device_firmware_configuration_interface_management_request_builder')
reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.reprovision_cloud_pc.reprovision_cloud_pc_request_builder')
...
request_remote_help_session_access_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.request_remote_help_session_access.request_remote_help_session_access_request_builder')
...
resize_cloud_pc_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.resize_cloud_pc.resize_cloud_pc_request_builder')
restore_cloud_pc_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.restore_cloud_pc.restore_cloud_pc_request_builder')
retire_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.retire.retire_request_builder')
retrieve_remote_help_session_with_session_key_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.retrieve_remote_help_session_with_session_key.retrieve_remote_help_session_with_session_key_request_builder')
...
set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.set_cloud_pc_review_status.set_cloud_pc_review_status_request_builder')
set_device_name_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.set_device_name.set_device_name_request_builder')
...
trigger_configuration_manager_action_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.trigger_configuration_manager_action.trigger_configuration_manager_action_request_builder')
