...
@dataclass
class TriggerConfigurationManagerActionPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    configuration_manager_action: Optional[ConfigurationManagerAction] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "configurationManagerAction": lambda n : setattr(self, 'configuration_manager_action', n.get_object_value(ConfigurationManagerAction)),
        }
        return fields
