...
if TYPE_CHECKING:
    ...
    from .override_compliance_state_post_request_body import OverrideComplianceStatePostRequestBody

class OverrideComplianceStateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/overrideComplianceState", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> OverrideComplianceStateRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: OverrideComplianceStateRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return OverrideComplianceStateRequestBuilder(raw_url, self.request_adapter)
