...
get_file_vault_key_response = lazy_import('msgraph.generated.users.item.managed_devices.item.microsoft_graph_get_file_vault_key.get_file_vault_key_response')
