...
create_download_url_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.log_collection_requests.item.microsoft_graph_create_download_url.create_download_url_request_builder')
