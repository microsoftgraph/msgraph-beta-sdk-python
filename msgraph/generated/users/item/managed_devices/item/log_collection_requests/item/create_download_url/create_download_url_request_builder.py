...
create_download_url_response = lazy_import('msgraph.generated.users.item.managed_devices.item.log_collection_requests.item.create_download_url.create_download_url_response')
