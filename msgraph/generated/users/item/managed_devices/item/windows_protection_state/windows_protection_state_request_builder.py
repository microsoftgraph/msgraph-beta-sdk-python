...
detected_malware_state_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.windows_protection_state.detected_malware_state.detected_malware_state_request_builder')
windows_device_malware_state_item_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.windows_protection_state.detected_malware_state.item.windows_device_malware_state_item_request_builder')
...
class WindowsProtectionStateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/windowsProtectionState{?%24select,%24expand}"
