...
get_file_vault_key_response = lazy_import('msgraph.generated.users.item.managed_devices.item.get_file_vault_key.get_file_vault_key_response')

class GetFileVaultKeyRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.getFileVaultKey()"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[GetFileVaultKeyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetFileVaultKeyRequestBuilderGetRequestConfiguration():
        """
