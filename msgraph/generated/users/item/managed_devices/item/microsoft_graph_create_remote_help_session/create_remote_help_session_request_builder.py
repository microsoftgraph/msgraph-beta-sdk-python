...
create_remote_help_session_post_request_body = lazy_import('msgraph.generated.users.item.managed_devices.item.microsoft_graph_create_remote_help_session.create_remote_help_session_post_request_body')
...
class CreateRemoteHelpSessionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.createRemoteHelpSession"
