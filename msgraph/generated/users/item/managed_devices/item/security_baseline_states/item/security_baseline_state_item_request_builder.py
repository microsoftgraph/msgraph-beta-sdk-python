...
setting_states_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.security_baseline_states.item.setting_states.setting_states_request_builder')
security_baseline_setting_state_item_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.item.security_baseline_states.item.setting_states.item.security_baseline_setting_state_item_request_builder')
...
class SecurityBaselineStateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, security_baseline_state_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}{?%24select,%24expand}"
