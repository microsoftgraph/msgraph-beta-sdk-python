...
bulk_reprovision_cloud_pc_post_request_body = lazy_import('msgraph.generated.users.item.managed_devices.bulk_reprovision_cloud_pc.bulk_reprovision_cloud_pc_post_request_body')

class BulkReprovisionCloudPcRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/managedDevices/microsoft.graph.bulkReprovisionCloudPc"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[bulk_reprovision_cloud_pc_post_request_body.BulkReprovisionCloudPcPostRequestBody] = None, request_configuration: Optional[BulkReprovisionCloudPcRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
