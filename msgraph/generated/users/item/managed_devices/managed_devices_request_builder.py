...
app_diagnostics_with_upn_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.app_diagnostics_with_upn.app_diagnostics_with_upn_request_builder')
bulk_reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.bulk_reprovision_cloud_pc.bulk_reprovision_cloud_pc_request_builder')
bulk_restore_cloud_pc_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.bulk_restore_cloud_pc.bulk_restore_cloud_pc_request_builder')
bulk_set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.bulk_set_cloud_pc_review_status.bulk_set_cloud_pc_review_status_request_builder')
count_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.count.count_request_builder')
download_app_diagnostics_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.download_app_diagnostics.download_app_diagnostics_request_builder')
execute_action_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.execute_action.execute_action_request_builder')
move_devices_to_o_u_request_builder = lazy_import('msgraph.generated.users.item.managed_devices.move_devices_to_o_u.move_devices_to_o_u_request_builder')
