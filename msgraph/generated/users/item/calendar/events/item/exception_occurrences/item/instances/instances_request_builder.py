...
delta_request_builder = lazy_import('msgraph.generated.users.item.calendar.events.item.exception_occurrences.item.instances.microsoft_graph_delta.delta_request_builder')
