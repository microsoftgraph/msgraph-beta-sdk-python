...
accept_post_request_body = lazy_import('msgraph.generated.users.item.calendar.events.item.exception_occurrences.item.instances.item.accept.accept_post_request_body')
