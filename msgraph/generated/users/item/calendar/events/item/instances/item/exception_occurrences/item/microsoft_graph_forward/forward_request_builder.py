...
forward_post_request_body = lazy_import('msgraph.generated.users.item.calendar.events.item.instances.item.exception_occurrences.item.microsoft_graph_forward.forward_post_request_body')
