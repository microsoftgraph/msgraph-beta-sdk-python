...
exception_occurrences_request_builder = lazy_import('msgraph.generated.users.item.calendar.events.item.instances.item.exception_occurrences.exception_occurrences_request_builder')
event_item_request_builder = lazy_import('msgraph.generated.users.item.calendar.events.item.instances.item.exception_occurrences.item.event_item_request_builder')
