...
delta_request_builder = lazy_import('msgraph.generated.users.item.calendar.events.item.instances.item.exception_occurrences.microsoft_graph_delta.delta_request_builder')
