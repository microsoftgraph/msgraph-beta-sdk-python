...
accept_post_request_body = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.instances.item.exception_occurrences.item.accept.accept_post_request_body')
