...
accept_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_accept.accept_request_builder')
cancel_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_cancel.cancel_request_builder')
decline_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_decline.decline_request_builder')
dismiss_reminder_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_dismiss_reminder.dismiss_reminder_request_builder')
forward_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_forward.forward_request_builder')
snooze_reminder_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_snooze_reminder.snooze_reminder_request_builder')
tentatively_accept_request_builder = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.microsoft_graph_tentatively_accept.tentatively_accept_request_builder')
