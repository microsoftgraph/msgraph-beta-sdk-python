...
decline_post_request_body = lazy_import('msgraph.generated.users.item.calendar.calendar_view.item.exception_occurrences.item.decline.decline_post_request_body')
...
class DeclineRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/decline"
