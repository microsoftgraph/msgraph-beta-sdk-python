...
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
class PendingAccessReviewInstancesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[access_review_instance.AccessReviewInstance] = None, request_configuration: Optional[PendingAccessReviewInstancesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to pendingAccessReviewInstances for users
        Args:
            body: The request body
