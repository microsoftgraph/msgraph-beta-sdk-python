...
class ApplyDecisionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/applyDecisions", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ApplyDecisionsRequestBuilder:
        ...
        return ApplyDecisionsRequestBuilder(raw_url, self.request_adapter)
