...
count_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.stages.item.decisions.count.count_request_builder')
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.stages.item.decisions.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
microsoft_graph_record_all_decisions_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.stages.item.decisions.microsoft_graph_record_all_decisions.microsoft_graph_record_all_decisions_request_builder')
...
class DecisionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
