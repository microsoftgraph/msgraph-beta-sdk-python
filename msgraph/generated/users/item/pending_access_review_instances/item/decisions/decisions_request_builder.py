...
filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.decisions.microsoft_graph_filter_by_current_user_with_on.filter_by_current_user_with_on_request_builder')
record_all_decisions_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.decisions.microsoft_graph_record_all_decisions.record_all_decisions_request_builder')
