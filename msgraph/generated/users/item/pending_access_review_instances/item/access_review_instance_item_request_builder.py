...
microsoft_graph_accept_recommendations_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_accept_recommendations.microsoft_graph_accept_recommendations_request_builder')
microsoft_graph_apply_decisions_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_apply_decisions.microsoft_graph_apply_decisions_request_builder')
microsoft_graph_batch_record_decisions_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_batch_record_decisions.microsoft_graph_batch_record_decisions_request_builder')
microsoft_graph_reset_decisions_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_reset_decisions.microsoft_graph_reset_decisions_request_builder')
microsoft_graph_send_reminder_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_send_reminder.microsoft_graph_send_reminder_request_builder')
microsoft_graph_stop_request_builder = lazy_import('msgraph.generated.users.item.pending_access_review_instances.item.microsoft_graph_stop.microsoft_graph_stop_request_builder')
