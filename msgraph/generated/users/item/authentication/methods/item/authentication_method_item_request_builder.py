...
disable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.microsoft_graph_disable_sms_sign_in.disable_sms_sign_in_request_builder')
enable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.microsoft_graph_enable_sms_sign_in.enable_sms_sign_in_request_builder')
