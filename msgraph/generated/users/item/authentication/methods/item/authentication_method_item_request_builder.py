...
microsoft_graph_disable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.microsoft_graph_disable_sms_sign_in.microsoft_graph_disable_sms_sign_in_request_builder')
microsoft_graph_enable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.microsoft_graph_enable_sms_sign_in.microsoft_graph_enable_sms_sign_in_request_builder')
...
class AuthenticationMethodItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_disable_sms_sign_in(self) -> microsoft_graph_disable_sms_sign_in_request_builder.MicrosoftGraphDisableSmsSignInRequestBuilder:
        """
        Provides operations to call the disableSmsSignIn method.
        """
        return microsoft_graph_disable_sms_sign_in_request_builder.MicrosoftGraphDisableSmsSignInRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_enable_sms_sign_in(self) -> microsoft_graph_enable_sms_sign_in_request_builder.MicrosoftGraphEnableSmsSignInRequestBuilder:
        """
        Provides operations to call the enableSmsSignIn method.
        """
        return microsoft_graph_enable_sms_sign_in_request_builder.MicrosoftGraphEnableSmsSignInRequestBuilder(self.request_adapter, self.path_parameters)
