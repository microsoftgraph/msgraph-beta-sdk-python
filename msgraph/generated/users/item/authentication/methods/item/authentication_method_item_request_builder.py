...
disable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.disable_sms_sign_in.disable_sms_sign_in_request_builder')
enable_sms_sign_in_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.enable_sms_sign_in.enable_sms_sign_in_request_builder')
reset_password_request_builder = lazy_import('msgraph.generated.users.item.authentication.methods.item.reset_password.reset_password_request_builder')
