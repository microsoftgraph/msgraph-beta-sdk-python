...
class EmailAuthenticationMethodItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, email_authentication_method_id: Optional[str] = None) -> None:
        """
        Instantiates a new EmailAuthenticationMethodItemRequestBuilder and sets the default values.
        Args:
            emailAuthenticationMethodId: key: id of emailAuthenticationMethod
        ...
        url_tpl_params["emailAuthenticationMethod%2Did"] = emailAuthenticationMethodId
