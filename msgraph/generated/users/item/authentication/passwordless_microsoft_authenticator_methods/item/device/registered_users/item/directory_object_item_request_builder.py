...
endpoint_request_builder = lazy_import('msgraph.generated.users.item.authentication.passwordless_microsoft_authenticator_methods.item.device.registered_users.item.endpoint.endpoint_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.authentication.passwordless_microsoft_authenticator_methods.item.device.registered_users.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.users.item.authentication.passwordless_microsoft_authenticator_methods.item.device.registered_users.item.user.user_request_builder')
...
class DirectoryObjectItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}{?%24select,%24expand}"
