...
check_member_objects_post_request_body = lazy_import('msgraph.generated.users.item.authentication.passwordless_microsoft_authenticator_methods.item.device.check_member_objects.check_member_objects_post_request_body')
check_member_objects_response = lazy_import('msgraph.generated.users.item.authentication.passwordless_microsoft_authenticator_methods.item.device.check_member_objects.check_member_objects_response')
...
class CheckMemberObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/microsoft.graph.checkMemberObjects"
