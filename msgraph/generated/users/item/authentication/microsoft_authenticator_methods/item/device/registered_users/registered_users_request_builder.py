...
count_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.registered_users.count.count_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.registered_users.endpoint.endpoint_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.registered_users.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.registered_users.user.user_request_builder')
...
class RegisteredUsersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
