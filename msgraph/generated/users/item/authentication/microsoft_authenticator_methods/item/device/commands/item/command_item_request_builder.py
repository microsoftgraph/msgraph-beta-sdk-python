...
responsepayload_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.commands.item.responsepayload.responsepayload_request_builder')
...
class CommandItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/commands/{command%2Did}{?%24select,%24expand}"
