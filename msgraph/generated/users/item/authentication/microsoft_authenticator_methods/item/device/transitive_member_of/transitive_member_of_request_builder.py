...
application_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.application.application_request_builder')
count_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.count.count_request_builder')
device_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.org_contact.org_contact_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.users.item.authentication.microsoft_authenticator_methods.item.device.transitive_member_of.user.user_request_builder')
...
class TransitiveMemberOfRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[TransitiveMemberOfRequestBuilderGetRequestConfiguration] = None) -> Optional[directory_object_collection_response.DirectoryObjectCollectionResponse]:
        """
