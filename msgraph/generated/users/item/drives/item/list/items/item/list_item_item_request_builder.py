...
activities_request_builder = lazy_import('msgraph.generated.users.item.drives.item.list.items.item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.users.item.drives.item.list.items.item.activities.item.item_activity_o_l_d_item_request_builder')
...
create_link_request_builder = lazy_import('msgraph.generated.users.item.drives.item.list.items.item.create_link.create_link_request_builder')
