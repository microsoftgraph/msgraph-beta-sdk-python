...
add_copy_from_content_type_hub_post_request_body = lazy_import('msgraph.generated.users.item.drives.item.list.content_types.add_copy_from_content_type_hub.add_copy_from_content_type_hub_post_request_body')
...
class AddCopyFromContentTypeHubRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/microsoft.graph.addCopyFromContentTypeHub"
