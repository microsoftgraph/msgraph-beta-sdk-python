...
create_link_post_request_body = lazy_import('msgraph.generated.users.item.drives.item.root.list_item.create_link.create_link_post_request_body')
...
class CreateLinkRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/microsoft.graph.createLink"
