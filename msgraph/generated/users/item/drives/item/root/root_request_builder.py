...
activities_request_builder = lazy_import('msgraph.generated.users.item.drives.item.root.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.users.item.drives.item.root.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.users.item.drives.item.root.analytics.analytics_request_builder')
assign_sensitivity_label_request_builder = lazy_import('msgraph.generated.users.item.drives.item.root.assign_sensitivity_label.assign_sensitivity_label_request_builder')
...
extract_sensitivity_labels_request_builder = lazy_import('msgraph.generated.users.item.drives.item.root.extract_sensitivity_labels.extract_sensitivity_labels_request_builder')
