...
revoke_grants_request_builder = lazy_import('msgraph.generated.users.item.drives.item.items.item.permissions.item.revoke_grants.revoke_grants_request_builder')
