...
count_request_builder = lazy_import('msgraph.generated.users.item.messages.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.users.item.messages.delta.delta_request_builder')
