...
reply_post_request_body = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_reply.reply_post_request_body')
...
class ReplyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/microsoft.graph.reply"
