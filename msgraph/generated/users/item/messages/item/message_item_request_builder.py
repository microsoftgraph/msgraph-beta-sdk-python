...
copy_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_copy.copy_request_builder')
create_forward_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_create_forward.create_forward_request_builder')
create_reply_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_create_reply.create_reply_request_builder')
create_reply_all_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_create_reply_all.create_reply_all_request_builder')
forward_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_forward.forward_request_builder')
move_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_move.move_request_builder')
reply_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_reply.reply_request_builder')
reply_all_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_reply_all.reply_all_request_builder')
send_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_send.send_request_builder')
unsubscribe_request_builder = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_unsubscribe.unsubscribe_request_builder')
