...
create_forward_post_request_body = lazy_import('msgraph.generated.users.item.messages.item.microsoft_graph_create_forward.create_forward_post_request_body')
