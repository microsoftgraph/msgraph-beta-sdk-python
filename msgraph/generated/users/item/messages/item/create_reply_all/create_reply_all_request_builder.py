...
create_reply_all_post_request_body = lazy_import('msgraph.generated.users.item.messages.item.create_reply_all.create_reply_all_post_request_body')
...
class CreateReplyAllRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/microsoft.graph.createReplyAll"
