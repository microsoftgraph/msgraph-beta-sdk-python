...
assign_post_request_body = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.microsoft_graph_assign.assign_post_request_body')
