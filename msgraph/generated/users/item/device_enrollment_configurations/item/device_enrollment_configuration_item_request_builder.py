...
assign_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.assign.assign_request_builder')
...
set_priority_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.set_priority.set_priority_request_builder')
