...
assign_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.microsoft_graph_assign.assign_request_builder')
set_priority_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.microsoft_graph_set_priority.set_priority_request_builder')
