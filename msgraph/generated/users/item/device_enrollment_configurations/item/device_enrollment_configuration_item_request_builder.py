...
assignments_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.assignments.assignments_request_builder')
enrollment_configuration_assignment_item_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.assignments.item.enrollment_configuration_assignment_item_request_builder')
microsoft_graph_assign_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.microsoft_graph_assign.microsoft_graph_assign_request_builder')
microsoft_graph_set_priority_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.item.microsoft_graph_set_priority.microsoft_graph_set_priority_request_builder')
...
class DeviceEnrollmentConfigurationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24select,%24expand}"
