...
count_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.count.count_request_builder')
microsoft_graph_create_enrollment_notification_configuration_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.microsoft_graph_create_enrollment_notification_configuration.microsoft_graph_create_enrollment_notification_configuration_request_builder')
microsoft_graph_has_payload_links_request_builder = lazy_import('msgraph.generated.users.item.device_enrollment_configurations.microsoft_graph_has_payload_links.microsoft_graph_has_payload_links_request_builder')
...
class DeviceEnrollmentConfigurationsRequestBuilder():
    ...
    @property
    def microsoft_graph_create_enrollment_notification_configuration(self) -> microsoft_graph_create_enrollment_notification_configuration_request_builder.MicrosoftGraphCreateEnrollmentNotificationConfigurationRequestBuilder:
        """
        Provides operations to call the createEnrollmentNotificationConfiguration method.
        """
        return microsoft_graph_create_enrollment_notification_configuration_request_builder.MicrosoftGraphCreateEnrollmentNotificationConfigurationRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
