...
information_protection_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.information_protection_request_builder')
...
class SecurityRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/security{?%24select,%24expand}"
