...
evaluate_application_post_request_body = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_application.evaluate_application_post_request_body')
evaluate_application_response = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_application.evaluate_application_response')
