...
evaluate_classification_results_post_request_body = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_classification_results.evaluate_classification_results_post_request_body')
evaluate_classification_results_response = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_classification_results.evaluate_classification_results_response')
...
class EvaluateClassificationResultsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateClassificationResults"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[evaluate_classification_results_post_request_body.EvaluateClassificationResultsPostRequestBody] = None, request_configuration: Optional[EvaluateClassificationResultsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
