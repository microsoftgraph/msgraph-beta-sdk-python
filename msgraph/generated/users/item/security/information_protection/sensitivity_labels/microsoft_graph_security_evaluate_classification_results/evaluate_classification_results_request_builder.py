...
evaluate_classification_results_post_request_body = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_classification_results.evaluate_classification_results_post_request_body')
evaluate_classification_results_response = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_classification_results.evaluate_classification_results_response')
