...
evaluate_application_post_request_body = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_application.evaluate_application_post_request_body')
evaluate_application_response = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_application.evaluate_application_response')
...
class EvaluateApplicationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateApplication"
