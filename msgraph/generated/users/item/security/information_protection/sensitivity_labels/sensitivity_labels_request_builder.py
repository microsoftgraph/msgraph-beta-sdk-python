...
microsoft_graph_security_evaluate_application_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_application.microsoft_graph_security_evaluate_application_request_builder')
microsoft_graph_security_evaluate_classification_results_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_classification_results.microsoft_graph_security_evaluate_classification_results_request_builder')
microsoft_graph_security_evaluate_removal_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_removal.microsoft_graph_security_evaluate_removal_request_builder')
microsoft_graph_security_extract_content_label_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_extract_content_label.microsoft_graph_security_extract_content_label_request_builder')
