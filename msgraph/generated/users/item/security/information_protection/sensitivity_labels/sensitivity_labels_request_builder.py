...
evaluate_application_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_application.evaluate_application_request_builder')
evaluate_classification_results_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_classification_results.evaluate_classification_results_request_builder')
evaluate_removal_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.evaluate_removal.evaluate_removal_request_builder')
extract_content_label_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.extract_content_label.extract_content_label_request_builder')
...
class SensitivityLabelsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SensitivityLabelsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[sensitivity_label.SensitivityLabel] = None, request_configuration: Optional[SensitivityLabelsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
