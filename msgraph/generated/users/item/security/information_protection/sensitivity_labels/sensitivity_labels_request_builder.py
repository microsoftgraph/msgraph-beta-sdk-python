...
count_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.count.count_request_builder')
evaluate_application_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_application.evaluate_application_request_builder')
evaluate_classification_results_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_classification_results.evaluate_classification_results_request_builder')
evaluate_removal_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_removal.evaluate_removal_request_builder')
extract_content_label_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.microsoft_graph_security_extract_content_label.extract_content_label_request_builder')
...
class SensitivityLabelsRequestBuilder():
    ...
    @property
    def microsoft_graph_security_evaluate_application(self) -> evaluate_application_request_builder.EvaluateApplicationRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_security_evaluate_classification_results(self) -> evaluate_classification_results_request_builder.EvaluateClassificationResultsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_security_evaluate_removal(self) -> evaluate_removal_request_builder.EvaluateRemovalRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_security_extract_content_label(self) -> extract_content_label_request_builder.ExtractContentLabelRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[sensitivity_label.SensitivityLabel] = None, request_configuration: Optional[SensitivityLabelsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to sensitivityLabels for users
        Args:
            body: The request body
    ...
    @dataclass
    class SensitivityLabelsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
