...
if TYPE_CHECKING:
    ...
    from ......models.security.sensitivity_label_collection_response import SensitivityLabelCollectionResponse
...
class SensitivityLabelsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SensitivityLabelsRequestBuilder:
        ...
        return SensitivityLabelsRequestBuilder(raw_url, self.request_adapter)
    ...
    @property
    def microsoft_graph_security_evaluate_application(self) -> MicrosoftGraphSecurityEvaluateApplicationRequestBuilder:
        """
    ...
    def microsoft_graph_security_evaluate_removal(self) -> MicrosoftGraphSecurityEvaluateRemovalRequestBuilder:
        ...
        return MicrosoftGraphSecurityEvaluateRemovalRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_security_extract_content_label(self) -> MicrosoftGraphSecurityExtractContentLabelRequestBuilder:
        """
        Provides operations to call the extractContentLabel method.
        """
        from .microsoft_graph_security_extract_content_label.microsoft_graph_security_extract_content_label_request_builder import MicrosoftGraphSecurityExtractContentLabelRequestBuilder

        return MicrosoftGraphSecurityExtractContentLabelRequestBuilder(self.request_adapter, self.path_parameters)
