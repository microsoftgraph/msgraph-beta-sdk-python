...
security_evaluate_application_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.security_evaluate_application.security_evaluate_application_request_builder')
security_evaluate_classification_results_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.security_evaluate_classification_results.security_evaluate_classification_results_request_builder')
security_evaluate_removal_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.security_evaluate_removal.security_evaluate_removal_request_builder')
security_extract_content_label_request_builder = lazy_import('msgraph.generated.users.item.security.information_protection.sensitivity_labels.security_extract_content_label.security_extract_content_label_request_builder')
