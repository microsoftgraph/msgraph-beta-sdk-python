...
class MicrosoftGraphSecurityEvaluateRemovalRequestBuilder():
    ...
    async def post(self,body: Optional[EvaluateRemovalPostRequestBody] = None, request_configuration: Optional[MicrosoftGraphSecurityEvaluateRemovalRequestBuilderPostRequestConfiguration] = None) -> Optional[EvaluateRemovalResponse]:
        """
