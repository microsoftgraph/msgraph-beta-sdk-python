...
forward_post_request_body = lazy_import('msgraph.generated.users.item.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_forward.forward_post_request_body')
