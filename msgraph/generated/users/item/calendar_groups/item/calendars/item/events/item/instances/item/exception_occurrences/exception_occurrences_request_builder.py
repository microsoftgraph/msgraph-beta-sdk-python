...
delta_request_builder = lazy_import('msgraph.generated.users.item.calendar_groups.item.calendars.item.events.item.instances.item.exception_occurrences.microsoft_graph_delta.delta_request_builder')
