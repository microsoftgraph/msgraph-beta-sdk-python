...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.users.item.calendar_groups.item.calendars.item.events.item.exception_occurrences.item.instances.item.snooze_reminder.snooze_reminder_post_request_body')
