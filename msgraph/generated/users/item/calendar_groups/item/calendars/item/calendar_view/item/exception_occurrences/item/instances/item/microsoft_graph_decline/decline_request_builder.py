...
decline_post_request_body = lazy_import('msgraph.generated.users.item.calendar_groups.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.item.microsoft_graph_decline.decline_post_request_body')
