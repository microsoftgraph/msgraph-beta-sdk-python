...
if TYPE_CHECKING:
    ...
    from .....models.person_name_collection_response import PersonNameCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.person_name_item_request_builder import PersonNameItemRequestBuilder
...
class NamesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/profile/names{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_person_name_id(self,person_name_id: str) -> PersonNameItemRequestBuilder:
        """
        Provides operations to manage the names property of the microsoft.graph.profile entity.
        param person_name_id: The unique identifier of personName
        ...
        return PersonNameItemRequestBuilder(self.request_adapter, url_tpl_params)
