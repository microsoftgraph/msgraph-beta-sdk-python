...
class ItemPublicationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, item_publication_id: Optional[str] = None) -> None:
        """
        Instantiates a new ItemPublicationItemRequestBuilder and sets the default values.
        Args:
            itemPublicationId: key: id of itemPublication
        ...
        url_tpl_params["itemPublication%2Did"] = itemPublicationId
