...
class LanguageProficiencyItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, language_proficiency_id: Optional[str] = None) -> None:
        """
        Instantiates a new LanguageProficiencyItemRequestBuilder and sets the default values.
        Args:
            languageProficiencyId: key: id of languageProficiency
        ...
        url_tpl_params["languageProficiency%2Did"] = languageProficiencyId
