...
class ItemAddressItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, item_address_id: Optional[str] = None) -> None:
        """
        Instantiates a new ItemAddressItemRequestBuilder and sets the default values.
        Args:
            itemAddressId: key: id of itemAddress
        ...
        url_tpl_params["itemAddress%2Did"] = itemAddressId
