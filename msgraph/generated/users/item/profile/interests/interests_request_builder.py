...
class InterestsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/profile/interests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[InterestsRequestBuilderGetRequestConfiguration] = None) -> Optional[PersonInterestCollectionResponse]:
        """
        Retrieve a list of personInterest objects from a user's profile. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[PersonInterest] = None, request_configuration: Optional[InterestsRequestBuilderPostRequestConfiguration] = None) -> Optional[PersonInterest]:
        """
        Create a new personInterest. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> InterestsRequestBuilder:
        """
