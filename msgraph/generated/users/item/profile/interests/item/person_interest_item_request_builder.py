...
class PersonInterestItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, person_interest_id: Optional[str] = None) -> None:
        """
        Instantiates a new PersonInterestItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            personInterestId: key: id of personInterest
        ...
        url_tpl_params["personInterest%2Did"] = personInterestId
