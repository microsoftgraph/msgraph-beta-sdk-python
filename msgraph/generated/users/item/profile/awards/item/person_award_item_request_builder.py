...
class PersonAwardItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/profile/awards/{personAward%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[PersonAwardItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PersonAwardItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[person_award.PersonAward] = None, request_configuration: Optional[PersonAwardItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PersonAwardItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    class PersonAwardItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[PersonAwardItemRequestBuilder.PersonAwardItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class PersonAwardItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
