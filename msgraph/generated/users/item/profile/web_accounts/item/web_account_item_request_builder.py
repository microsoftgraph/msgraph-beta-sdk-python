...
class WebAccountItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, web_account_id: Optional[str] = None) -> None:
        """
        Instantiates a new WebAccountItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            webAccountId: key: id of webAccount
        """
        ...
        url_tpl_params["webAccount%2Did"] = webAccountId
