...
class ItemPatentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, item_patent_id: Optional[str] = None) -> None:
        """
        Instantiates a new ItemPatentItemRequestBuilder and sets the default values.
        Args:
            itemPatentId: key: id of itemPatent
        ...
        url_tpl_params["itemPatent%2Did"] = itemPatentId
