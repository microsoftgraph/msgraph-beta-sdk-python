...
class WebsitesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/profile/websites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[WebsitesRequestBuilderGetRequestConfiguration] = None) -> Optional[PersonWebsiteCollectionResponse]:
        """
        Retrieve a list of personWebsite objects from a user's profile. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[PersonWebsite] = None, request_configuration: Optional[WebsitesRequestBuilderPostRequestConfiguration] = None) -> Optional[PersonWebsite]:
        """
        Create a new personWebsite object in a user's profile. This API is supported in the following national cloud deployments.
    ...
    @dataclass
    class WebsitesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class WebsitesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
