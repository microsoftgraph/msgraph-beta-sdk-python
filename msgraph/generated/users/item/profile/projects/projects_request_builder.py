...
class ProjectsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/profile/projects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_project_participation_id(self,project_participation_id: str) -> ProjectParticipationItemRequestBuilder:
        """
        Provides operations to manage the projects property of the microsoft.graph.profile entity.
        param project_participation_id: The unique identifier of projectParticipation
    ...
    async def get(self,request_configuration: Optional[ProjectsRequestBuilderGetRequestConfiguration] = None) -> Optional[ProjectParticipationCollectionResponse]:
        """
        Retrieve a list of projectParticipation objects from a user's profile. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[ProjectParticipation] = None, request_configuration: Optional[ProjectsRequestBuilderPostRequestConfiguration] = None) -> Optional[ProjectParticipation]:
        """
        Use this API to create a new projectParticipation object in a user's profile. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ProjectsRequestBuilder:
        """
    ...
    @dataclass
    class ProjectsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ProjectsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
