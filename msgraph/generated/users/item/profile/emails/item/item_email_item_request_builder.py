...
class ItemEmailItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, item_email_id: Optional[str] = None) -> None:
        """
        Instantiates a new ItemEmailItemRequestBuilder and sets the default values.
        Args:
            itemEmailId: key: id of itemEmail
        ...
        url_tpl_params["itemEmail%2Did"] = itemEmailId
