...
class WorkPositionItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, work_position_id: Optional[str] = None) -> None:
        """
        Instantiates a new WorkPositionItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            workPositionId: key: id of workPosition
        """
        ...
        url_tpl_params["workPosition%2Did"] = workPositionId
