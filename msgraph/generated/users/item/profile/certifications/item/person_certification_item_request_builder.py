...
class PersonCertificationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, person_certification_id: Optional[str] = None) -> None:
        """
        Instantiates a new PersonCertificationItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            personCertificationId: key: id of personCertification
        ...
        url_tpl_params["personCertification%2Did"] = personCertificationId
