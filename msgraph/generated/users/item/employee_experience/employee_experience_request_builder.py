...
if TYPE_CHECKING:
    from ....models import employee_experience_user
...
class EmployeeExperienceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/employeeExperience{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[EmployeeExperienceRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[EmployeeExperienceRequestBuilderGetRequestConfiguration] = None) -> Optional[employee_experience_user.EmployeeExperienceUser]:
        """
        ...
        return await self.request_adapter.send_async(request_info, employee_experience_user.EmployeeExperienceUser, error_mapping)
    
    async def patch(self,body: Optional[employee_experience_user.EmployeeExperienceUser] = None, request_configuration: Optional[EmployeeExperienceRequestBuilderPatchRequestConfiguration] = None) -> Optional[employee_experience_user.EmployeeExperienceUser]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[EmployeeExperienceRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property employeeExperience for users
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[employee_experience_user.EmployeeExperienceUser] = None, request_configuration: Optional[EmployeeExperienceRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property employeeExperience in users
        Args:
            body: The request body
    ...
    @dataclass
    class EmployeeExperienceRequestBuilderDeleteRequestConfiguration():
        """
