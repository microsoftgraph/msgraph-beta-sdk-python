...
set_user_preferred_presence_post_request_body = lazy_import('msgraph.generated.users.item.presence.set_user_preferred_presence.set_user_preferred_presence_post_request_body')
...
class SetUserPreferredPresenceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/presence/microsoft.graph.setUserPreferredPresence"
