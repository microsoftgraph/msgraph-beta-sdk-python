...
class NotificationsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[notification.Notification] = None, request_configuration: Optional[NotificationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to notifications for users
        Args:
            body: The request body
