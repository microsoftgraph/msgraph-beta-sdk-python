...
from .....models import windows_information_protection_device_registration
...
class WindowsInformationProtectionDeviceRegistrationItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsInformationProtectionDeviceRegistrationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
