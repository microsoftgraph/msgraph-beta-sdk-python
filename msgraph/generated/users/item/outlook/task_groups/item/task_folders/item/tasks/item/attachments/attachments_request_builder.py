...
create_upload_session_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.attachments.create_upload_session.create_upload_session_request_builder')
