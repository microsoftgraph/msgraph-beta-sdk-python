...
complete_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.microsoft_graph_complete.complete_request_builder')
