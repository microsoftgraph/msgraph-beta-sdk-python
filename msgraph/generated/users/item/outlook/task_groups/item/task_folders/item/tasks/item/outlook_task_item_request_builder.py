...
attachments_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.attachments.item.attachment_item_request_builder')
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
multi_value_extended_properties_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_groups.item.task_folders.item.tasks.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
...
class OutlookTaskItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}{?%24select}"
