...
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.users.item.outlook.task_folders.item.tasks.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
...
class OutlookTaskItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}{?%24select}"
