...
class OutlookTaskFolderItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, outlook_task_folder_id: Optional[str] = None) -> None:
        """
        Instantiates a new OutlookTaskFolderItemRequestBuilder and sets the default values.
        Args:
            outlookTaskFolderId: key: id of outlookTaskFolder
        ...
        url_tpl_params["outlookTaskFolder%2Did"] = outlookTaskFolderId
