...
class TaskFoldersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/outlook/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[TaskFoldersRequestBuilderGetRequestConfiguration] = None) -> Optional[OutlookTaskFolderCollectionResponse]:
        """
        Get all the Outlook task folders in the user's mailbox. This API is supported in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[OutlookTaskFolderCollectionResponse]
        Find more info here: https://learn.microsoft.com/graph/api/outlookuser-list-taskfolders?view=graph-rest-1.0
        """
    ...
    async def post(self,body: Optional[OutlookTaskFolder] = None, request_configuration: Optional[TaskFoldersRequestBuilderPostRequestConfiguration] = None) -> Optional[OutlookTaskFolder]:
        """
        Create a task folder in the default task group (My Tasks) of the user's mailbox. This API is supported in the following national cloud deployments.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[OutlookTaskFolder]
        Find more info here: https://learn.microsoft.com/graph/api/outlookuser-post-taskfolders?view=graph-rest-1.0
        """
        if not body:
