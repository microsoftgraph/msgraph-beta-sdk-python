...
attachments_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.attachments.item.attachment_item_request_builder')
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
multi_value_extended_properties_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.users.item.outlook.tasks.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
