...
count_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.count.count_request_builder')
microsoft_graph_application_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_application.microsoft_graph_application_request_builder')
microsoft_graph_group_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_group.microsoft_graph_group_request_builder')
microsoft_graph_service_principal_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_service_principal.microsoft_graph_service_principal_request_builder')
...
class OwnedObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
