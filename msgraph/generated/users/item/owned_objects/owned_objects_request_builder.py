...
application_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.application.application_request_builder')
count_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.count.count_request_builder')
group_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.group.group_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.service_principal.service_principal_request_builder')
