...
graph_application_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.graph_application.graph_application_request_builder')
graph_group_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.graph_group.graph_group_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.graph_service_principal.graph_service_principal_request_builder')
