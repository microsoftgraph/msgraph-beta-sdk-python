...
application_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_application.application_request_builder')
group_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_group.group_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.users.item.owned_objects.microsoft_graph_service_principal.service_principal_request_builder')
