...
steps_request_builder = lazy_import('msgraph.generated.users.item.approvals.item.steps.steps_request_builder')
approval_step_item_request_builder = lazy_import('msgraph.generated.users.item.approvals.item.steps.item.approval_step_item_request_builder')
