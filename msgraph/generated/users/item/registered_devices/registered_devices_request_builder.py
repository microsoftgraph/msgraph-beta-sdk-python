...
microsoft_graph_device_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.microsoft_graph_device.microsoft_graph_device_request_builder')
microsoft_graph_endpoint_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.microsoft_graph_endpoint.microsoft_graph_endpoint_request_builder')
...
class RegisteredDevicesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RegisteredDevicesRequestBuilderGetRequestConfiguration] = None) -> Optional[directory_object_collection_response.DirectoryObjectCollectionResponse]:
        """
