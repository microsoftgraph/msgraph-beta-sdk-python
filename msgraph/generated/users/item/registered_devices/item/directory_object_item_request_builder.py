...
device_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.device.device_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.endpoint.endpoint_request_builder')
