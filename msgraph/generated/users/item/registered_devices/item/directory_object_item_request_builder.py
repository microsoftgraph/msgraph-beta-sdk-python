...
graph_device_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.graph_device.graph_device_request_builder')
graph_endpoint_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.graph_endpoint.graph_endpoint_request_builder')
