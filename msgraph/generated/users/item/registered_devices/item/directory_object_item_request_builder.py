...
device_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.microsoft_graph_device.device_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.users.item.registered_devices.item.microsoft_graph_endpoint.endpoint_request_builder')
