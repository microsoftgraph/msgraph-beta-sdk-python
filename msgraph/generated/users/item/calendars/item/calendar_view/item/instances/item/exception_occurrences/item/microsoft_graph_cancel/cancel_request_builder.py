...
cancel_post_request_body = lazy_import('msgraph.generated.users.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_cancel.cancel_post_request_body')
...
class CancelRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.cancel"
