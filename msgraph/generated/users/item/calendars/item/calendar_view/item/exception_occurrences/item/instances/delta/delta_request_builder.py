...
delta_response = lazy_import('msgraph.generated.users.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.delta.delta_response')
...
class DeltaRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
