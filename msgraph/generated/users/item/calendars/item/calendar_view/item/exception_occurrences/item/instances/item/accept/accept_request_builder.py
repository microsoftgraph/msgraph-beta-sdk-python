...
accept_post_request_body = lazy_import('msgraph.generated.users.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.item.accept.accept_post_request_body')
...
class AcceptRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/accept"
