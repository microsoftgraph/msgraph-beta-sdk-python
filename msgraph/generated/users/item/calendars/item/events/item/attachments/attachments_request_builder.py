...
create_upload_session_request_builder = lazy_import('msgraph.generated.users.item.calendars.item.events.item.attachments.create_upload_session.create_upload_session_request_builder')
