...
invalidate_all_refresh_tokens_response = lazy_import('msgraph.generated.users.item.microsoft_graph_invalidate_all_refresh_tokens.invalidate_all_refresh_tokens_response')
...
class InvalidateAllRefreshTokensRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/microsoft.graph.invalidateAllRefreshTokens"
