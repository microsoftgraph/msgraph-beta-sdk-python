...
class PowerOnRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/powerOn"
    ...
    @dataclass
    class PowerOnRequestBuilderPostRequestConfiguration():
        """
