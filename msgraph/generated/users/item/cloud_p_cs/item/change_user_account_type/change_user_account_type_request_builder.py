...
if TYPE_CHECKING:
    ...
    from .change_user_account_type_post_request_body import ChangeUserAccountTypePostRequestBody

class ChangeUserAccountTypeRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/changeUserAccountType", path_parameters)
    ...
    async def post(self,body: Optional[ChangeUserAccountTypePostRequestBody] = None, request_configuration: Optional[ChangeUserAccountTypeRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        Change the account type of the user on a specific Cloud PC. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ChangeUserAccountTypeRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ChangeUserAccountTypeRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class ChangeUserAccountTypeRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
