...
class RestoreRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RestorePostRequestBody] = None, request_configuration: Optional[RestoreRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        Restore a specific Cloud PC. Use this API to trigger a remote action that restores a Cloud PC device to a previous state. This API is supported in the following national cloud deployments.
