...
change_user_account_type_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_change_user_account_type.change_user_account_type_request_builder')
end_grace_period_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_end_grace_period.end_grace_period_request_builder')
get_cloud_pc_connectivity_history_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_cloud_pc_connectivity_history.get_cloud_pc_connectivity_history_request_builder')
get_cloud_pc_launch_info_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_cloud_pc_launch_info.get_cloud_pc_launch_info_request_builder')
get_shift_work_cloud_pc_access_state_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_shift_work_cloud_pc_access_state.get_shift_work_cloud_pc_access_state_request_builder')
get_supported_cloud_pc_remote_actions_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_supported_cloud_pc_remote_actions.get_supported_cloud_pc_remote_actions_request_builder')
reboot_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_reboot.reboot_request_builder')
rename_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_rename.rename_request_builder')
reprovision_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_reprovision.reprovision_request_builder')
restore_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_restore.restore_request_builder')
retry_partner_agent_installation_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_retry_partner_agent_installation.retry_partner_agent_installation_request_builder')
troubleshoot_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_troubleshoot.troubleshoot_request_builder')
