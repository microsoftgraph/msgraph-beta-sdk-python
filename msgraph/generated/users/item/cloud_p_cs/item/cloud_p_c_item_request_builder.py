...
microsoft_graph_change_user_account_type_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_change_user_account_type.microsoft_graph_change_user_account_type_request_builder')
microsoft_graph_end_grace_period_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_end_grace_period.microsoft_graph_end_grace_period_request_builder')
microsoft_graph_get_cloud_pc_connectivity_history_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_cloud_pc_connectivity_history.microsoft_graph_get_cloud_pc_connectivity_history_request_builder')
microsoft_graph_get_cloud_pc_launch_info_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_cloud_pc_launch_info.microsoft_graph_get_cloud_pc_launch_info_request_builder')
microsoft_graph_get_shift_work_cloud_pc_access_state_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_shift_work_cloud_pc_access_state.microsoft_graph_get_shift_work_cloud_pc_access_state_request_builder')
microsoft_graph_get_supported_cloud_pc_remote_actions_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_get_supported_cloud_pc_remote_actions.microsoft_graph_get_supported_cloud_pc_remote_actions_request_builder')
microsoft_graph_reboot_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_reboot.microsoft_graph_reboot_request_builder')
microsoft_graph_rename_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_rename.microsoft_graph_rename_request_builder')
microsoft_graph_reprovision_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_reprovision.microsoft_graph_reprovision_request_builder')
microsoft_graph_restore_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_restore.microsoft_graph_restore_request_builder')
microsoft_graph_retry_partner_agent_installation_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_retry_partner_agent_installation.microsoft_graph_retry_partner_agent_installation_request_builder')
microsoft_graph_troubleshoot_request_builder = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_troubleshoot.microsoft_graph_troubleshoot_request_builder')
...
class CloudPCItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}{?%24select,%24expand}"
