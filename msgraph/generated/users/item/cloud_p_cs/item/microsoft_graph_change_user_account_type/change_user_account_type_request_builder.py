...
change_user_account_type_post_request_body = lazy_import('msgraph.generated.users.item.cloud_p_cs.item.microsoft_graph_change_user_account_type.change_user_account_type_post_request_body')
