...
class FavoritePlansRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/planner/favoritePlans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> FavoritePlansRequestBuilder:
        ...
        Returns: FavoritePlansRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return FavoritePlansRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class FavoritePlansRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
