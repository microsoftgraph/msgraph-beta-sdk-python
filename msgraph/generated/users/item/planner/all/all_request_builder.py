...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.users.item.planner.all.microsoft_graph_delta.microsoft_graph_delta_request_builder')
