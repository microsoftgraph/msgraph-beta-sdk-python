...
all_request_builder = lazy_import('msgraph.generated.users.item.planner.all.all_request_builder')
planner_delta_item_request_builder = lazy_import('msgraph.generated.users.item.planner.all.item.planner_delta_item_request_builder')
favorite_plans_request_builder = lazy_import('msgraph.generated.users.item.planner.favorite_plans.favorite_plans_request_builder')
planner_plan_item_request_builder = lazy_import('msgraph.generated.users.item.planner.favorite_plans.item.planner_plan_item_request_builder')
plans_request_builder = lazy_import('msgraph.generated.users.item.planner.plans.plans_request_builder')
planner_plan_item_request_builder = lazy_import('msgraph.generated.users.item.planner.plans.item.planner_plan_item_request_builder')
recent_plans_request_builder = lazy_import('msgraph.generated.users.item.planner.recent_plans.recent_plans_request_builder')
planner_plan_item_request_builder = lazy_import('msgraph.generated.users.item.planner.recent_plans.item.planner_plan_item_request_builder')
roster_plans_request_builder = lazy_import('msgraph.generated.users.item.planner.roster_plans.roster_plans_request_builder')
planner_plan_item_request_builder = lazy_import('msgraph.generated.users.item.planner.roster_plans.item.planner_plan_item_request_builder')
tasks_request_builder = lazy_import('msgraph.generated.users.item.planner.tasks.tasks_request_builder')
planner_task_item_request_builder = lazy_import('msgraph.generated.users.item.planner.tasks.item.planner_task_item_request_builder')
...
class PlannerRequestBuilder():
    ...
    def create_patch_request_information(self,body: Optional[planner_user.PlannerUser] = None, request_configuration: Optional[PlannerRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
