...
count_request_builder = lazy_import('msgraph.generated.users.item.calendar_view.item.instances.item.exception_occurrences.item.single_value_extended_properties.count.count_request_builder')
...
class SingleValueExtendedPropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
