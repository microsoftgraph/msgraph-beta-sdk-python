...
accept_post_request_body = lazy_import('msgraph.generated.users.item.calendar_view.item.instances.item.exception_occurrences.item.accept.accept_post_request_body')
...
class AcceptRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/microsoft.graph.accept"
