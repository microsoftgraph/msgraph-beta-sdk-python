...
tentatively_accept_post_request_body = lazy_import('msgraph.generated.users.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_tentatively_accept.tentatively_accept_post_request_body')
