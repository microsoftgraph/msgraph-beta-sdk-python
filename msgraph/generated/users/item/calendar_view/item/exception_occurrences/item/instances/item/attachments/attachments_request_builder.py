...
create_upload_session_request_builder = lazy_import('msgraph.generated.users.item.calendar_view.item.exception_occurrences.item.instances.item.attachments.create_upload_session.create_upload_session_request_builder')
