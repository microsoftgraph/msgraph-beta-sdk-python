...
create_upload_session_post_request_body = lazy_import('msgraph.generated.users.item.calendar_view.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_post_request_body')
