...
user_configurations_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.child_folders.item.user_configurations.user_configurations_request_builder')
user_configuration_item_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.child_folders.item.user_configurations.item.user_configuration_item_request_builder')
