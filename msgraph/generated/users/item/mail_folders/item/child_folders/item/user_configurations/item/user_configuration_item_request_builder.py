...
from .........models import user_configuration
...
class UserConfigurationItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserConfigurationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
