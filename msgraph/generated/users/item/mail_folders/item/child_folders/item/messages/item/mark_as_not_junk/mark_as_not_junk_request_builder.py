...
class MarkAsNotJunkRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/markAsNotJunk", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MarkAsNotJunkRequestBuilder:
        ...
        return MarkAsNotJunkRequestBuilder(raw_url, self.request_adapter)
