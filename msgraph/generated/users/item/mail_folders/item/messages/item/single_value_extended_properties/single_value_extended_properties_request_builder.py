...
count_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.messages.item.single_value_extended_properties.count.count_request_builder')
