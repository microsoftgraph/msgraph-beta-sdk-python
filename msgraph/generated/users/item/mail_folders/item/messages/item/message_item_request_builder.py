...
unsubscribe_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.messages.item.microsoft_graph_unsubscribe.unsubscribe_request_builder')
