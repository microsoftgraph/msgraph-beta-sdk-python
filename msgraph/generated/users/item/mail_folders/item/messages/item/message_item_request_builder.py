...
mentions_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.messages.item.mentions.mentions_request_builder')
mention_item_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.messages.item.mentions.item.mention_item_request_builder')
...
microsoft_graph_unsubscribe_request_builder = lazy_import('msgraph.generated.users.item.mail_folders.item.messages.item.microsoft_graph_unsubscribe.microsoft_graph_unsubscribe_request_builder')
