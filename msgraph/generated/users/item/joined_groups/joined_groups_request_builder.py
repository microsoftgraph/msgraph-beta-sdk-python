...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.users.item.joined_groups.microsoft_graph_delta.microsoft_graph_delta_request_builder')
microsoft_graph_evaluate_dynamic_membership_request_builder = lazy_import('msgraph.generated.users.item.joined_groups.microsoft_graph_evaluate_dynamic_membership.microsoft_graph_evaluate_dynamic_membership_request_builder')
microsoft_graph_get_by_ids_request_builder = lazy_import('msgraph.generated.users.item.joined_groups.microsoft_graph_get_by_ids.microsoft_graph_get_by_ids_request_builder')
microsoft_graph_get_user_owned_objects_request_builder = lazy_import('msgraph.generated.users.item.joined_groups.microsoft_graph_get_user_owned_objects.microsoft_graph_get_user_owned_objects_request_builder')
microsoft_graph_validate_properties_request_builder = lazy_import('msgraph.generated.users.item.joined_groups.microsoft_graph_validate_properties.microsoft_graph_validate_properties_request_builder')
