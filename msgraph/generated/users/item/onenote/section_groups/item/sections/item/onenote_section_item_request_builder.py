...
parent_section_group_request_builder = lazy_import('msgraph.generated.users.item.onenote.section_groups.item.sections.item.parent_section_group.parent_section_group_request_builder')
