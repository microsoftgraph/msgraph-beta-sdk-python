...
copy_notebook_request_builder = lazy_import('msgraph.generated.users.item.onenote.notebooks.item.copy_notebook.copy_notebook_request_builder')
...
onenote_section_item_request_builder = lazy_import('msgraph.generated.users.item.onenote.notebooks.item.sections.item.onenote_section_item_request_builder')
