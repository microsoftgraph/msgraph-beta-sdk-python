...
content_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.content.content_request_builder')
copy_to_section_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.copy_to_section.copy_to_section_request_builder')
onenote_patch_content_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.onenote_patch_content.onenote_patch_content_request_builder')
parent_notebook_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.parent_notebook.parent_notebook_request_builder')
parent_section_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.parent_section.parent_section_request_builder')
preview_request_builder = lazy_import('msgraph.generated.users.item.onenote.sections.item.pages.item.preview.preview_request_builder')
...
class OnenotePageItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24select,%24expand}"
