...
copy_to_section_group_post_request_body = lazy_import('msgraph.generated.users.item.onenote.sections.item.copy_to_section_group.copy_to_section_group_post_request_body')
