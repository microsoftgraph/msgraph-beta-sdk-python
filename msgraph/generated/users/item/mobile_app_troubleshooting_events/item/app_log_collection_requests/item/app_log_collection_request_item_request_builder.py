...
create_download_url_request_builder = lazy_import('msgraph.generated.users.item.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.create_download_url.create_download_url_request_builder')
