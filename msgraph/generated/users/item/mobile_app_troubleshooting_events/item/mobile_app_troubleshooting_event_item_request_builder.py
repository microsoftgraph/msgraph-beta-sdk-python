...
app_log_collection_requests_request_builder = lazy_import('msgraph.generated.users.item.mobile_app_troubleshooting_events.item.app_log_collection_requests.app_log_collection_requests_request_builder')
app_log_collection_request_item_request_builder = lazy_import('msgraph.generated.users.item.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.app_log_collection_request_item_request_builder')
