...
count_request_builder = lazy_import('msgraph.generated.users.item.mobile_app_troubleshooting_events.count.count_request_builder')
...
class MobileAppTroubleshootingEventsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/users/{user%2Did}/mobileAppTroubleshootingEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
