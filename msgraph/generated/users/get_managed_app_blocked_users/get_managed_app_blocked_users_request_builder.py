...
get_managed_app_blocked_users_response = lazy_import('msgraph.generated.users.get_managed_app_blocked_users.get_managed_app_blocked_users_response')

class GetManagedAppBlockedUsersRequestBuilder():
    """
    ...
    def create_get_request_information(self,request_configuration: Optional[GetManagedAppBlockedUsersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class GetManagedAppBlockedUsersRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[GetManagedAppBlockedUsersRequestBuilder.GetManagedAppBlockedUsersRequestBuilderGetQueryParameters] = None
