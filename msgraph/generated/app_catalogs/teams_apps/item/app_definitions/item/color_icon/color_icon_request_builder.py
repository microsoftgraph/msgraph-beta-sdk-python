...
class ColorIconRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ColorIconRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[teams_app_icon.TeamsAppIcon] = None, request_configuration: Optional[ColorIconRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property colorIcon in appCatalogs
        Args:
            body: The request body
