...
class HostedContentRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[HostedContentRequestBuilderGetRequestConfiguration] = None) -> Optional[teamwork_hosted_content.TeamworkHostedContent]:
        """
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, teamwork_hosted_content.TeamworkHostedContent, error_mapping)
    
    async def patch(self,body: Optional[teamwork_hosted_content.TeamworkHostedContent] = None, request_configuration: Optional[HostedContentRequestBuilderPatchRequestConfiguration] = None) -> Optional[teamwork_hosted_content.TeamworkHostedContent]:
        """
