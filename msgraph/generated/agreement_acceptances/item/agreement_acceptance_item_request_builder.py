...
class AgreementAcceptanceItemRequestBuilder():
    """
    ...
    def create_delete_request_information(self,request_configuration: Optional[AgreementAcceptanceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AgreementAcceptanceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[agreement_acceptance.AgreementAcceptance] = None, request_configuration: Optional[AgreementAcceptanceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AgreementAcceptanceItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class AgreementAcceptanceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
