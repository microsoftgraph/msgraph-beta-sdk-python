...
class WorkforceIntegrationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, workforce_integration_id: Optional[str] = None) -> None:
        """
        Instantiates a new WorkforceIntegrationItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            workforceIntegrationId: key: id of workforceIntegration
        """
        ...
        url_tpl_params["workforceIntegration%2Did"] = workforceIntegrationId
    ...
    async def get(self,request_configuration: Optional[WorkforceIntegrationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[workforce_integration.WorkforceIntegration]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, workforce_integration.WorkforceIntegration, error_mapping)
