...
get_all_messages_response = lazy_import('msgraph.generated.teamwork.deleted_teams.item.channels.microsoft_graph_get_all_messages.get_all_messages_response')
...
class GetAllMessagesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/microsoft.graph.getAllMessages(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
