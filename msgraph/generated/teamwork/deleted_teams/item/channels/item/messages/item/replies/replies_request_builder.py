...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.teamwork.deleted_teams.item.channels.item.messages.item.replies.microsoft_graph_delta.microsoft_graph_delta_request_builder')
