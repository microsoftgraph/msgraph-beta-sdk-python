...
add_post_request_body = lazy_import('msgraph.generated.teamwork.deleted_teams.item.channels.item.members.microsoft_graph_add.add_post_request_body')
add_response = lazy_import('msgraph.generated.teamwork.deleted_teams.item.channels.item.members.microsoft_graph_add.add_response')
