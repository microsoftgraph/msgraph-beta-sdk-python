...
class DeletedTeamItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeletedTeamItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeletedTeamItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[deleted_team.DeletedTeam] = None, request_configuration: Optional[DeletedTeamItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
