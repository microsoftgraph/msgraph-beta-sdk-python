...
count_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.count.count_request_builder')
...
class DefinitionsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[team_template_definition.TeamTemplateDefinition] = None, request_configuration: Optional[DefinitionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
