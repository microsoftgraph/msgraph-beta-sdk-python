...
microsoft_graph_set_reaction_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.messages.item.microsoft_graph_set_reaction.microsoft_graph_set_reaction_request_builder')
microsoft_graph_soft_delete_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.messages.item.microsoft_graph_soft_delete.microsoft_graph_soft_delete_request_builder')
microsoft_graph_undo_soft_delete_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.messages.item.microsoft_graph_undo_soft_delete.microsoft_graph_undo_soft_delete_request_builder')
microsoft_graph_unset_reaction_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.messages.item.microsoft_graph_unset_reaction.microsoft_graph_unset_reaction_request_builder')
...
class ChatMessageItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}"
