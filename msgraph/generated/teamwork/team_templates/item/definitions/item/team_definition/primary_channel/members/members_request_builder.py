...
count_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.members.count.count_request_builder')
microsoft_graph_add_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.primary_channel.members.microsoft_graph_add.microsoft_graph_add_request_builder')
...
class MembersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
