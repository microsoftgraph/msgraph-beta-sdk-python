...
check_member_groups_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.permission_grants.item.microsoft_graph_check_member_groups.check_member_groups_request_builder')
check_member_objects_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.permission_grants.item.microsoft_graph_check_member_objects.check_member_objects_request_builder')
get_member_groups_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.permission_grants.item.microsoft_graph_get_member_groups.get_member_groups_request_builder')
get_member_objects_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.permission_grants.item.microsoft_graph_get_member_objects.get_member_objects_request_builder')
restore_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.permission_grants.item.microsoft_graph_restore.restore_request_builder')
