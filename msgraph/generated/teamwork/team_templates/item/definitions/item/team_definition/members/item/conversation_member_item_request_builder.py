...
class ConversationMemberItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/members/{conversationMember%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[ConversationMemberItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
        Remove a conversationMember from a team. This API is supported in the following national cloud deployments.
    ...
    async def get(self,request_configuration: Optional[ConversationMemberItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ConversationMember]:
        """
        Get a conversationMember from a team. This API is supported in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[ConversationMember] = None, request_configuration: Optional[ConversationMemberItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ConversationMember]:
        """
        Update the role of a conversationMember in a team. This API is supported in the following national cloud deployments.
