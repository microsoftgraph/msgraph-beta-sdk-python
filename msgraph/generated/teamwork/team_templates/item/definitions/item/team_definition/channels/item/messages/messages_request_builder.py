...
delta_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.messages.microsoft_graph_delta.delta_request_builder')
