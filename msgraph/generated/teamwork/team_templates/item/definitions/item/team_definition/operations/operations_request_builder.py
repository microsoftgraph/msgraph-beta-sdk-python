...
teams_async_operation_collection_response = lazy_import('msgraph.generated.models.teams_async_operation_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.operations.count.count_request_builder')
...
class OperationsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[teams_async_operation.TeamsAsyncOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
