...
if TYPE_CHECKING:
    from ........models import teams_async_operation, teams_async_operation_collection_response
    from ........models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import teams_async_operation_item_request_builder
...
class OperationsRequestBuilder():
    ...
    def by_teams_async_operation_id(self,teams_async_operation_id: str) -> teams_async_operation_item_request_builder.TeamsAsyncOperationItemRequestBuilder:
        """
        Provides operations to manage the operations property of the microsoft.graph.team entity.
        Args:
        ...
        if teams_async_operation_id is None:
            raise Exception("teams_async_operation_id cannot be undefined")
        from .item import teams_async_operation_item_request_builder
    ...
    async def get(self,request_configuration: Optional[OperationsRequestBuilderGetRequestConfiguration] = None) -> Optional[teams_async_operation_collection_response.TeamsAsyncOperationCollectionResponse]:
        ...
        from ........models import teams_async_operation_collection_response
    ...
    def to_post_request_information(self,body: Optional[teams_async_operation.TeamsAsyncOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to operations for teamwork
        Args:
            body: The request body
