...
add_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.members.microsoft_graph_add.add_request_builder')
