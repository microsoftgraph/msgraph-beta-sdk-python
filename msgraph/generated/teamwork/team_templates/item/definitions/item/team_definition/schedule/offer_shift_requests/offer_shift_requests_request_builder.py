...
class OfferShiftRequestsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[offer_shift_request.OfferShiftRequest] = None, request_configuration: Optional[OfferShiftRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to offerShiftRequests for teamwork
        Args:
            body: The request body
