...
class TimeOffReasonItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, time_off_reason_id: Optional[str] = None) -> None:
        """
        Instantiates a new TimeOffReasonItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            timeOffReasonId: key: id of timeOffReason
        """
        ...
        self.url_template: str = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeOffReasons/{timeOffReason%2Did}{?%24select}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["timeOffReason%2Did"] = timeOffReasonId
    ...
    async def delete(self,request_configuration: Optional[TimeOffReasonItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
        Delete navigation property timeOffReasons for teamwork
        Args:
    ...
    async def patch(self,body: Optional[time_off_reason.TimeOffReason] = None, request_configuration: Optional[TimeOffReasonItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[time_off_reason.TimeOffReason]:
        """
        Update the navigation property timeOffReasons in teamwork
        Args:
    ...
    @dataclass
    class TimeOffReasonItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
