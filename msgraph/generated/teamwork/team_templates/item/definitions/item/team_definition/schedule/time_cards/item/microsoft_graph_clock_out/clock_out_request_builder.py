...
clock_out_post_request_body = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.schedule.time_cards.item.microsoft_graph_clock_out.clock_out_post_request_body')
...
class ClockOutRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/microsoft.graph.clockOut"
