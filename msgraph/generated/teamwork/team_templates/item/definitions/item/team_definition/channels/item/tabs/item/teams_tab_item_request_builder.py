...
teams_app_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.tabs.item.teams_app.teams_app_request_builder')
