...
microsoft_graph_complete_migration_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.microsoft_graph_complete_migration.microsoft_graph_complete_migration_request_builder')
microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name.microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name_request_builder')
microsoft_graph_provision_email_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.microsoft_graph_provision_email.microsoft_graph_provision_email_request_builder')
microsoft_graph_remove_email_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.microsoft_graph_remove_email.microsoft_graph_remove_email_request_builder')
