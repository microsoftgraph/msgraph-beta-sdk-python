...
upgrade_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.installed_apps.item.upgrade.upgrade_request_builder')
