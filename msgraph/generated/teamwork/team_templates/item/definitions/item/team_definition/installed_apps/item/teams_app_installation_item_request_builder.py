...
microsoft_graph_upgrade_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.installed_apps.item.microsoft_graph_upgrade.microsoft_graph_upgrade_request_builder')
teams_app_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.installed_apps.item.teams_app.teams_app_request_builder')
teams_app_definition_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.installed_apps.item.teams_app_definition.teams_app_definition_request_builder')
