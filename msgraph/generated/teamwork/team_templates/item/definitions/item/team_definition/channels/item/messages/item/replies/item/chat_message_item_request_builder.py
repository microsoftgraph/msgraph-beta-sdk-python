...
set_reaction_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.messages.item.replies.item.set_reaction.set_reaction_request_builder')
soft_delete_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.messages.item.replies.item.soft_delete.soft_delete_request_builder')
undo_soft_delete_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.messages.item.replies.item.undo_soft_delete.undo_soft_delete_request_builder')
unset_reaction_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.item.messages.item.replies.item.unset_reaction.unset_reaction_request_builder')
