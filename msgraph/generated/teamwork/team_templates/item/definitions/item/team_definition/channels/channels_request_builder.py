...
all_messages_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.microsoft_graph_all_messages.all_messages_request_builder')
get_all_messages_request_builder = lazy_import('msgraph.generated.teamwork.team_templates.item.definitions.item.team_definition.channels.microsoft_graph_get_all_messages.get_all_messages_request_builder')
