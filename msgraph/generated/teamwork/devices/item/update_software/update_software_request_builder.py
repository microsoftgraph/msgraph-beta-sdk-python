...
if TYPE_CHECKING:
    ...
    from .update_software_post_request_body import UpdateSoftwarePostRequestBody

class UpdateSoftwareRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UpdateSoftwareRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UpdateSoftwareRequestBuilder
        """
        if not raw_url:
