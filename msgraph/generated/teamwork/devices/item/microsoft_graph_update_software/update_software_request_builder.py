...
update_software_post_request_body = lazy_import('msgraph.generated.teamwork.devices.item.microsoft_graph_update_software.update_software_post_request_body')

class UpdateSoftwareRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/microsoft.graph.updateSoftware"
    ...
    @dataclass
    class UpdateSoftwareRequestBuilderPostRequestConfiguration():
        """
