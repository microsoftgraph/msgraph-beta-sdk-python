...
get_by_ids_request_builder = lazy_import('msgraph.generated.directory_setting_templates.microsoft_graph_get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.directory_setting_templates.microsoft_graph_get_user_owned_objects.get_user_owned_objects_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.directory_setting_templates.microsoft_graph_validate_properties.validate_properties_request_builder')
...
class DirectorySettingTemplatesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[directory_setting_template.DirectorySettingTemplate] = None, request_configuration: Optional[DirectorySettingTemplatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to directorySettingTemplates
        Args:
            body: The request body
