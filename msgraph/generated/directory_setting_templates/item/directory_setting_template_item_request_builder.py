...
check_member_groups_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.check_member_groups.check_member_groups_request_builder')
check_member_objects_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.check_member_objects.check_member_objects_request_builder')
get_member_groups_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.get_member_groups.get_member_groups_request_builder')
get_member_objects_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.get_member_objects.get_member_objects_request_builder')
restore_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.restore.restore_request_builder')
...
class DirectorySettingTemplateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directorySettingTemplates/{directorySettingTemplate%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[DirectorySettingTemplateItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DirectorySettingTemplateItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[directory_setting_template.DirectorySettingTemplate] = None, request_configuration: Optional[DirectorySettingTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class DirectorySettingTemplateItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    class DirectorySettingTemplateItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[DirectorySettingTemplateItemRequestBuilder.DirectorySettingTemplateItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class DirectorySettingTemplateItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
