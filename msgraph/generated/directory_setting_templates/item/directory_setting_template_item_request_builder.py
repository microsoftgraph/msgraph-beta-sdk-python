...
microsoft_graph_check_member_groups_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.microsoft_graph_check_member_groups.microsoft_graph_check_member_groups_request_builder')
microsoft_graph_check_member_objects_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.microsoft_graph_check_member_objects.microsoft_graph_check_member_objects_request_builder')
microsoft_graph_get_member_groups_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.microsoft_graph_get_member_groups.microsoft_graph_get_member_groups_request_builder')
microsoft_graph_get_member_objects_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.microsoft_graph_get_member_objects.microsoft_graph_get_member_objects_request_builder')
microsoft_graph_restore_request_builder = lazy_import('msgraph.generated.directory_setting_templates.item.microsoft_graph_restore.microsoft_graph_restore_request_builder')
