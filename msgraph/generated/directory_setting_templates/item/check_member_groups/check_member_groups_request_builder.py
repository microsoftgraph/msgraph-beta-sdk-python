...
check_member_groups_post_request_body = lazy_import('msgraph.generated.directory_setting_templates.item.check_member_groups.check_member_groups_post_request_body')
check_member_groups_response = lazy_import('msgraph.generated.directory_setting_templates.item.check_member_groups.check_member_groups_response')
