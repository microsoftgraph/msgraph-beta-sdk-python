...
program_request_builder = lazy_import('msgraph.generated.programs.item.controls.item.program.program_request_builder')

class ProgramControlItemRequestBuilder():
    """
    ...
    def program(self) -> program_request_builder.ProgramRequestBuilder:
        ...
        """
        return program_request_builder.ProgramRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/programs/{program%2Did}/controls/{programControl%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[ProgramControlItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ProgramControlItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[program_control.ProgramControl] = None, request_configuration: Optional[ProgramControlItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ProgramControlItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ProgramControlItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
