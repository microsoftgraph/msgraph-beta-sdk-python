...
class ProgramControlItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, program_control_id: Optional[str] = None) -> None:
        """
        Instantiates a new ProgramControlItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            programControlId: key: id of programControl
        ...
        url_tpl_params["programControl%2Did"] = programControlId
    ...
    def to_patch_request_information(self,body: Optional[program_control.ProgramControl] = None, request_configuration: Optional[ProgramControlItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property controls in programs
        Args:
            body: The request body
