...
class DirectorySettingItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DirectorySettingItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[directory_setting.DirectorySetting] = None, request_configuration: Optional[DirectorySettingItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the properties of a specific directory setting object.
        Args:
            body: The request body
