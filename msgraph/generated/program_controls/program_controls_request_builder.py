...
class ProgramControlsRequestBuilder():
    ...
    def by_program_control_id(self,program_control_id: str) -> program_control_item_request_builder.ProgramControlItemRequestBuilder:
        """
        Provides operations to manage the collection of programControl entities.
        Args:
            program_control_id: Unique identifier of the item
        Returns: program_control_item_request_builder.ProgramControlItemRequestBuilder
        """
        if program_control_id is None:
            raise Exception("program_control_id cannot be undefined")
        from .item import program_control_item_request_builder
    ...
    async def get(self,request_configuration: Optional[ProgramControlsRequestBuilderGetRequestConfiguration] = None) -> Optional[program_control_collection_response.ProgramControlCollectionResponse]:
        """
        ...
        from ..models import program_control_collection_response
    ...
    async def post(self,body: Optional[program_control.ProgramControl] = None, request_configuration: Optional[ProgramControlsRequestBuilderPostRequestConfiguration] = None) -> Optional[program_control.ProgramControl]:
        """
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ..models import program_control
    ...
    def to_post_request_information(self,body: Optional[program_control.ProgramControl] = None, request_configuration: Optional[ProgramControlsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        In the Azure AD access reviews feature, create a new programControl object.  This links an access review to a program. Prior to making this request, the caller must have previously
        Args:
            body: The request body
