...
class ProgramControlItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, program_control_id1: Optional[str] = None) -> None:
        """
        Instantiates a new ProgramControlItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            programControlId1: key: id of programControl
        ...
        self.url_template: str = "{+baseurl}/programControls/{programControl%2Did}/program/controls/{programControl%2Did1}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["programControl%2Did1"] = programControlId1
