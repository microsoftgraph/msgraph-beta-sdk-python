...
program_request_builder = lazy_import('msgraph.generated.program_controls.item.program.program_request_builder')
...
class ProgramControlItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/programControls/{programControl%2Did}{?%24select,%24expand}"
