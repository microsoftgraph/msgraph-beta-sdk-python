...
microsoft_graph_application_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_application.microsoft_graph_application_request_builder')
microsoft_graph_device_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_device.microsoft_graph_device_request_builder')
microsoft_graph_group_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_group.microsoft_graph_group_request_builder')
microsoft_graph_org_contact_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_org_contact.microsoft_graph_org_contact_request_builder')
microsoft_graph_service_principal_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_service_principal.microsoft_graph_service_principal_request_builder')
microsoft_graph_user_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_user.microsoft_graph_user_request_builder')
...
class DirectoryObjectItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/{directoryObject%2Did}{?%24select,%24expand}"
