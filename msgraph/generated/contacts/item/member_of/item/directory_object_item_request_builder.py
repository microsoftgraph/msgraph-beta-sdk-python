...
application_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_application.application_request_builder')
device_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_org_contact.org_contact_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.contacts.item.member_of.item.microsoft_graph_user.user_request_builder')
