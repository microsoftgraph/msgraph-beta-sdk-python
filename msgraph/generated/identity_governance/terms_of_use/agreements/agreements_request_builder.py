...
count_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.count.count_request_builder')
agreement = lazy_import('msgraph.generated.models.agreement')
agreement_collection_response = lazy_import('msgraph.generated.models.agreement_collection_response')
...
class AgreementsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/termsOfUse/agreements{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AgreementsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[agreement.Agreement] = None, request_configuration: Optional[AgreementsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
