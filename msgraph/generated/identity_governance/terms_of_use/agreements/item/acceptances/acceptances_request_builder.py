...
count_request_builder = lazy_import('msgraph.generated.identity_governance.terms_of_use.agreements.item.acceptances.count.count_request_builder')
agreement_acceptance = lazy_import('msgraph.generated.models.agreement_acceptance')
agreement_acceptance_collection_response = lazy_import('msgraph.generated.models.agreement_acceptance_collection_response')
...
class AcceptancesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AcceptancesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[agreement_acceptance.AgreementAcceptance] = None, request_configuration: Optional[AcceptancesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AcceptancesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
