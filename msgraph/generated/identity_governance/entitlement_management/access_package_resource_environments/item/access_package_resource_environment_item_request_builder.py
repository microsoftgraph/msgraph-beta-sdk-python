...
class AccessPackageResourceEnvironmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_resource_environment_id: Optional[str] = None) -> None:
        """
        Instantiates a new AccessPackageResourceEnvironmentItemRequestBuilder and sets the default values.
        Args:
            accessPackageResourceEnvironmentId: key: id of accessPackageResourceEnvironment
        ...
        url_tpl_params["accessPackageResourceEnvironment%2Did"] = accessPackageResourceEnvironmentId
    ...
    async def get(self,request_configuration: Optional[AccessPackageResourceEnvironmentItemRequestBuilderGetRequestConfiguration] = None) -> Optional[access_package_resource_environment.AccessPackageResourceEnvironment]:
        """
    ...
    async def patch(self,body: Optional[access_package_resource_environment.AccessPackageResourceEnvironment] = None, request_configuration: Optional[AccessPackageResourceEnvironmentItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[access_package_resource_environment.AccessPackageResourceEnvironment]:
        """
    ...
    def to_patch_request_information(self,body: Optional[access_package_resource_environment.AccessPackageResourceEnvironment] = None, request_configuration: Optional[AccessPackageResourceEnvironmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property accessPackageResourceEnvironments in identityGovernance
        Args:
            body: The request body
