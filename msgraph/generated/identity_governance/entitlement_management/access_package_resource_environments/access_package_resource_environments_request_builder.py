...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_resource_environments.count.count_request_builder')
access_package_resource_environment = lazy_import('msgraph.generated.models.access_package_resource_environment')
access_package_resource_environment_collection_response = lazy_import('msgraph.generated.models.access_package_resource_environment_collection_response')
...
class AccessPackageResourceEnvironmentsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AccessPackageResourceEnvironmentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[access_package_resource_environment.AccessPackageResourceEnvironment] = None, request_configuration: Optional[AccessPackageResourceEnvironmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
