...
class AccessPackageResourceEnvironmentsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[access_package_resource_environment.AccessPackageResourceEnvironment] = None, request_configuration: Optional[AccessPackageResourceEnvironmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to accessPackageResourceEnvironments for identityGovernance
        Args:
            body: The request body
