...
class AccessPackageCatalogRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[AccessPackageCatalogRequestBuilderGetRequestConfiguration] = None) -> Optional[access_package_catalog.AccessPackageCatalog]:
        """
