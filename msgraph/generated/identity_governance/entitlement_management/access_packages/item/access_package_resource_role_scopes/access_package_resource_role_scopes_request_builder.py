...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_resource_role_scopes.count.count_request_builder')
access_package_resource_role_scope = lazy_import('msgraph.generated.models.access_package_resource_role_scope')
access_package_resource_role_scope_collection_response = lazy_import('msgraph.generated.models.access_package_resource_role_scope_collection_response')
...
class AccessPackageResourceRoleScopesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageResourceRoleScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AccessPackageResourceRoleScopesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[access_package_resource_role_scope.AccessPackageResourceRoleScope] = None, request_configuration: Optional[AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AccessPackageResourceRoleScopesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class AccessPackageResourceRoleScopesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
