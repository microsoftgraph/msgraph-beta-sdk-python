...
access_package_assignment_policies_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_assignment_policies.access_package_assignment_policies_request_builder')
access_package_assignment_policy_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_assignment_policies.item.access_package_assignment_policy_item_request_builder')
access_package_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_catalog.access_package_catalog_request_builder')
access_package_resource_role_scopes_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_resource_role_scopes.access_package_resource_role_scopes_request_builder')
access_package_resource_role_scope_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.access_package_resource_role_scopes.item.access_package_resource_role_scope_item_request_builder')
...
microsoft_graph_move_to_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_packages.item.microsoft_graph_move_to_catalog.microsoft_graph_move_to_catalog_request_builder')
