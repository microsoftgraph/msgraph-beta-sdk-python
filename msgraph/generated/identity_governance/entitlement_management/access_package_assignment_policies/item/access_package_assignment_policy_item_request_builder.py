...
access_package_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.access_package.access_package_request_builder')
access_package_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.access_package_catalog.access_package_catalog_request_builder')
custom_extension_handlers_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.custom_extension_handlers.custom_extension_handlers_request_builder')
custom_extension_handler_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.custom_extension_handlers.item.custom_extension_handler_item_request_builder')
custom_extension_stage_settings_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.custom_extension_stage_settings.custom_extension_stage_settings_request_builder')
custom_extension_stage_setting_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_policies.item.custom_extension_stage_settings.item.custom_extension_stage_setting_item_request_builder')
