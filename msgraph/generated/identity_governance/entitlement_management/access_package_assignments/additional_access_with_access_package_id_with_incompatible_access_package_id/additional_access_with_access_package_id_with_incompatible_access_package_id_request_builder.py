...
additional_access_with_access_package_id_with_incompatible_access_package_id_response = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.additional_access_with_access_package_id_with_incompatible_access_package_id.additional_access_with_access_package_id_with_incompatible_access_package_id_response')
...
class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_id: Optional[str] = None, incompatible_access_package_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/additionalAccess(accessPackageId='{accessPackageId}',incompatibleAccessPackageId='{incompatibleAccessPackageId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
