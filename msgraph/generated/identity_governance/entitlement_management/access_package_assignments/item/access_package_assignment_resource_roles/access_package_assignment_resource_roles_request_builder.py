...
microsoft_graph_my_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_resource_roles.microsoft_graph_my.microsoft_graph_my_request_builder')
...
class AccessPackageAssignmentResourceRolesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[access_package_assignment_resource_role.AccessPackageAssignmentResourceRole] = None, request_configuration: Optional[AccessPackageAssignmentResourceRolesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to accessPackageAssignmentResourceRoles for identityGovernance
        Args:
            body: The request body
