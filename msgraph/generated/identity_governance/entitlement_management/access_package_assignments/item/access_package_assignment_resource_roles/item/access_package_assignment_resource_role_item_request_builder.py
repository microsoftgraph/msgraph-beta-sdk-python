...
class AccessPackageAssignmentResourceRoleItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_assignment_resource_role_id: Optional[str] = None) -> None:
        """
        Instantiates a new AccessPackageAssignmentResourceRoleItemRequestBuilder and sets the default values.
        Args:
            accessPackageAssignmentResourceRoleId: key: id of accessPackageAssignmentResourceRole
        ...
        url_tpl_params["accessPackageAssignmentResourceRole%2Did"] = accessPackageAssignmentResourceRoleId
