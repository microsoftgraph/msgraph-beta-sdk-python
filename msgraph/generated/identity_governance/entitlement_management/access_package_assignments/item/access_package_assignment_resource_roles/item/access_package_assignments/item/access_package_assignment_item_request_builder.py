...
class AccessPackageAssignmentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_assignment_id1: Optional[str] = None) -> None:
        """
        Instantiates a new AccessPackageAssignmentItemRequestBuilder and sets the default values.
        Args:
            accessPackageAssignmentId1: key: id of accessPackageAssignment
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole%2Did}/accessPackageAssignments/{accessPackageAssignment%2Did1}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["accessPackageAssignment%2Did1"] = accessPackageAssignmentId1
