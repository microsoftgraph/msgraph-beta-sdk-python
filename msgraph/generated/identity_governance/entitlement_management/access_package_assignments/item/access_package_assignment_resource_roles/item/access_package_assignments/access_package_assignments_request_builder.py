...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_resource_roles.item.access_package_assignments.count.count_request_builder')
...
class AccessPackageAssignmentsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AccessPackageAssignmentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
