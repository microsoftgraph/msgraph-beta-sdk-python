...
class AccessPackageAssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole%2Did}/accessPackageAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_access_package_assignment_id1(self,access_package_assignment_id1: str) -> AccessPackageAssignmentItemRequestBuilder:
        """
        Provides operations to manage the accessPackageAssignments property of the microsoft.graph.accessPackageAssignmentResourceRole entity.
        param access_package_assignment_id1: The unique identifier of accessPackageAssignment
        Returns: AccessPackageAssignmentItemRequestBuilder
        """
        if not access_package_assignment_id1:
            raise TypeError("access_package_assignment_id1 cannot be null.")
        from .item.access_package_assignment_item_request_builder import AccessPackageAssignmentItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["accessPackageAssignment%2Did1"] = access_package_assignment_id1
