...
reprocess_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.microsoft_graph_reprocess.reprocess_request_builder')
