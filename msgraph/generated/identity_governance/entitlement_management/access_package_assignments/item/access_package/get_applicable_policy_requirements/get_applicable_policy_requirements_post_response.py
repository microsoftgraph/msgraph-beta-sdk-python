...
@dataclass
class GetApplicablePolicyRequirementsPostResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[AccessPackageAssignmentRequestRequirements]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetApplicablePolicyRequirementsPostResponse:
        """
