...
class AccessPackageRequestBuilder():
    ...
    def access_packages_incompatible_with_by_id(self,id: str) -> Optional[access_package_item_request_builder.AccessPackageItemRequestBuilder]:
        """
        Provides operations to manage the accessPackagesIncompatibleWith property of the microsoft.graph.accessPackage entity.
        Args:
            id: Unique identifier of the item
    ...
    def incompatible_access_packages_by_id(self,id: str) -> Optional[access_package_item_request_builder.AccessPackageItemRequestBuilder]:
        """
