...
get_applicable_policy_requirements_response = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.microsoft_graph_get_applicable_policy_requirements.get_applicable_policy_requirements_response')
