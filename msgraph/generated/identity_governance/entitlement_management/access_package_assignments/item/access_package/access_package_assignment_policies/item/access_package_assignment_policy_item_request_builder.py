...
access_package_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.access_package.access_package_request_builder')
access_package_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.access_package_catalog.access_package_catalog_request_builder')
custom_extension_handlers_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.custom_extension_handlers.custom_extension_handlers_request_builder')
custom_extension_handler_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.custom_extension_handlers.item.custom_extension_handler_item_request_builder')
custom_extension_stage_settings_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.custom_extension_stage_settings.custom_extension_stage_settings_request_builder')
custom_extension_stage_setting_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.custom_extension_stage_settings.item.custom_extension_stage_setting_item_request_builder')
...
class AccessPackageAssignmentPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy%2Did}{?%24select,%24expand}"
