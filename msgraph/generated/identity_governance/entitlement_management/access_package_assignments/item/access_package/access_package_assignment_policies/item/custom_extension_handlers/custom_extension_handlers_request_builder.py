...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.access_package_assignment_policies.item.custom_extension_handlers.count.count_request_builder')
custom_extension_handler = lazy_import('msgraph.generated.models.custom_extension_handler')
custom_extension_handler_collection_response = lazy_import('msgraph.generated.models.custom_extension_handler_collection_response')
...
class CustomExtensionHandlersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy%2Did}/customExtensionHandlers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[CustomExtensionHandlersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[custom_extension_handler.CustomExtensionHandler] = None, request_configuration: Optional[CustomExtensionHandlersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
