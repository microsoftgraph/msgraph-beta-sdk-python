...
class AccessPackagesIncompatibleWithRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackagesIncompatibleWith{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration] = None) -> Optional[AccessPackageCollectionResponse]:
        """
        Retrieve a list of the accessPackage objects that have marked a specified accessPackage as incompatible. This API is supported in the following national cloud deployments.
    ...
    def to_get_request_information(self,request_configuration: Optional[AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Retrieve a list of the accessPackage objects that have marked a specified accessPackage as incompatible. This API is supported in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AccessPackagesIncompatibleWithRequestBuilder:
        """
    ...
    @dataclass
    class AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
