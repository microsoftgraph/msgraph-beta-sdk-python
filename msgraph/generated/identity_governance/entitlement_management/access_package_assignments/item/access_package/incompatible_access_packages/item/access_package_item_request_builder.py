...
ref_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package.incompatible_access_packages.item.ref.ref_request_builder')
