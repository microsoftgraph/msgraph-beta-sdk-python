...
filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.microsoft_graph_filter_by_current_user_with_on.filter_by_current_user_with_on_request_builder')
