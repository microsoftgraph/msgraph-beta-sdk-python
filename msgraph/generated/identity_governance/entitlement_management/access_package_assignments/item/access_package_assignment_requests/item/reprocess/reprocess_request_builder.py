...
class ReprocessRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentRequests/{accessPackageAssignmentRequest%2Did}/reprocess", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ReprocessRequestBuilder:
        """
        ...
        return ReprocessRequestBuilder(raw_url, self.request_adapter)
