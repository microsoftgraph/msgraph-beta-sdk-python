...
access_package_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.access_package.access_package_request_builder')
access_package_assignment_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.access_package_assignment.access_package_assignment_request_builder')
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
microsoft_graph_reprocess_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.microsoft_graph_reprocess.microsoft_graph_reprocess_request_builder')
...
class AccessPackageAssignmentRequestItemRequestBuilder():
    ...
    @property
    def microsoft_graph_reprocess(self) -> microsoft_graph_reprocess_request_builder.MicrosoftGraphReprocessRequestBuilder:
        """
        Provides operations to call the reprocess method.
        """
        return microsoft_graph_reprocess_request_builder.MicrosoftGraphReprocessRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentRequests/{accessPackageAssignmentRequest%2Did}{?%24select,%24expand}"
