...
cancel_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.microsoft_graph_cancel.cancel_request_builder')
reprocess_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_requests.item.microsoft_graph_reprocess.reprocess_request_builder')
