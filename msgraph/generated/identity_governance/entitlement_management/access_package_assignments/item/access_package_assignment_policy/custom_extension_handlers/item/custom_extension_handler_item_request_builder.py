...
custom_extension_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.item.access_package_assignment_policy.custom_extension_handlers.item.custom_extension.custom_extension_request_builder')
