...
class AccessPackageAssignmentPolicyRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[AccessPackageAssignmentPolicyRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[AccessPackageAssignmentPolicyRequestBuilderGetRequestConfiguration] = None) -> Optional[access_package_assignment_policy.AccessPackageAssignmentPolicy]:
        """
    ...
    def to_patch_request_information(self,body: Optional[access_package_assignment_policy.AccessPackageAssignmentPolicy] = None, request_configuration: Optional[AccessPackageAssignmentPolicyRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property accessPackageAssignmentPolicy in identityGovernance
        Args:
            body: The request body
