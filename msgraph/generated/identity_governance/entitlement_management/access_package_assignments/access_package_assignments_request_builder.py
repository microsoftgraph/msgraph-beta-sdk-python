...
microsoft_graph_additional_access_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.microsoft_graph_additional_access.microsoft_graph_additional_access_request_builder')
microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id.microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder')
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignments.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
class AccessPackageAssignmentsRequestBuilder():
    ...
    @property
    def microsoft_graph_additional_access(self) -> microsoft_graph_additional_access_request_builder.MicrosoftGraphAdditionalAccessRequestBuilder:
        """
        Provides operations to call the additionalAccess method.
        """
        return microsoft_graph_additional_access_request_builder.MicrosoftGraphAdditionalAccessRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id(self,access_package_id: Optional[str] = None, incompatible_access_package_id: Optional[str] = None) -> microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder.MicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder:
        """
        Provides operations to call the additionalAccess method.
        Args:
        ...
        Returns: microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder.MicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder
        """
        ...
        return microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder.MicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder(self.request_adapter, self.path_parameters, accessPackageId, incompatibleAccessPackageId)
    ...
    def to_post_request_information(self,body: Optional[access_package_assignment.AccessPackageAssignment] = None, request_configuration: Optional[AccessPackageAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to accessPackageAssignments for identityGovernance
        Args:
            body: The request body
    ...
    class AccessPackageAssignmentsRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[AccessPackageAssignmentsRequestBuilder.AccessPackageAssignmentsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class AccessPackageAssignmentsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
