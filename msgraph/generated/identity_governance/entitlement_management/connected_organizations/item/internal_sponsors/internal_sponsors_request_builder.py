...
microsoft_graph_get_user_owned_objects_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.connected_organizations.item.internal_sponsors.microsoft_graph_get_user_owned_objects.microsoft_graph_get_user_owned_objects_request_builder')
