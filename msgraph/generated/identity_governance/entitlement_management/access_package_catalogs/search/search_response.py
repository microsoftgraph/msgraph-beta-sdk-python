...
if TYPE_CHECKING:
    from .....models import access_package_catalog, base_collection_pagination_count_response

from .....models import base_collection_pagination_count_response

@dataclass
class SearchResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[access_package_catalog.AccessPackageCatalog]] = None
