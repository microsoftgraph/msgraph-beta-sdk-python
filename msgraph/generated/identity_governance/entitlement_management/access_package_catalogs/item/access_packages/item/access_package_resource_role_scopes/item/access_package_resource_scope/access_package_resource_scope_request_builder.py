...
class AccessPackageResourceScopeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[AccessPackageResourceScopeRequestBuilderGetRequestConfiguration] = None) -> Optional[access_package_resource_scope.AccessPackageResourceScope]:
        """
    ...
    async def patch(self,body: Optional[access_package_resource_scope.AccessPackageResourceScope] = None, request_configuration: Optional[AccessPackageResourceScopeRequestBuilderPatchRequestConfiguration] = None) -> Optional[access_package_resource_scope.AccessPackageResourceScope]:
        """
