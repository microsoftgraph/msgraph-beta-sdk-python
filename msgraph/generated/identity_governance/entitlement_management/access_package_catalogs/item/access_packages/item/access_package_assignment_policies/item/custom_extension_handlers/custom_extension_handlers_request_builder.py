...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.access_package_assignment_policies.item.custom_extension_handlers.count.count_request_builder')
