...
access_package_assignment_policies_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.access_package_assignment_policies.access_package_assignment_policies_request_builder')
access_package_assignment_policy_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.access_package_assignment_policies.item.access_package_assignment_policy_item_request_builder')
access_package_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.access_package_catalog.access_package_catalog_request_builder')
access_package_resource_role_scopes_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.access_package_resource_role_scopes.access_package_resource_role_scopes_request_builder')
...
microsoft_graph_get_applicable_policy_requirements_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.microsoft_graph_get_applicable_policy_requirements.microsoft_graph_get_applicable_policy_requirements_request_builder')
microsoft_graph_move_to_catalog_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_packages.item.microsoft_graph_move_to_catalog.microsoft_graph_move_to_catalog_request_builder')
...
class AccessPackageItemRequestBuilder():
    ...
    @property
    def microsoft_graph_get_applicable_policy_requirements(self) -> microsoft_graph_get_applicable_policy_requirements_request_builder.MicrosoftGraphGetApplicablePolicyRequirementsRequestBuilder:
        """
        Provides operations to call the getApplicablePolicyRequirements method.
        """
        return microsoft_graph_get_applicable_policy_requirements_request_builder.MicrosoftGraphGetApplicablePolicyRequirementsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_move_to_catalog(self) -> microsoft_graph_move_to_catalog_request_builder.MicrosoftGraphMoveToCatalogRequestBuilder:
        """
        Provides operations to call the moveToCatalog method.
        """
        return microsoft_graph_move_to_catalog_request_builder.MicrosoftGraphMoveToCatalogRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def incompatible_access_packages_by_id(self,id: str) -> AccessPackageItemRequestBuilder:
        """
        Gets an item from the msgraph.generated.identityGovernance.entitlementManagement.accessPackageCatalogs.item.accessPackages.item.incompatibleAccessPackages.item collection
        Args:
            id: Unique identifier of the item
        Returns: AccessPackageItemRequestBuilder
        """
    ...
    def incompatible_groups_by_id(self,id: str) -> group_item_request_builder.GroupItemRequestBuilder:
        """
        Gets an item from the msgraph.generated.identityGovernance.entitlementManagement.accessPackageCatalogs.item.accessPackages.item.incompatibleGroups.item collection
        Args:
            id: Unique identifier of the item
