...
class AccessPackageItemRequestBuilder():
    ...
    def access_package_assignment_policies_by_id(self,id: str) -> Optional[access_package_assignment_policy_item_request_builder.AccessPackageAssignmentPolicyItemRequestBuilder]:
        """
        Provides operations to manage the accessPackageAssignmentPolicies property of the microsoft.graph.accessPackage entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[access_package_assignment_policy_item_request_builder.AccessPackageAssignmentPolicyItemRequestBuilder]
        """
        if id is None:
    ...
    def access_package_resource_role_scopes_by_id(self,id: str) -> Optional[access_package_resource_role_scope_item_request_builder.AccessPackageResourceRoleScopeItemRequestBuilder]:
        """
        Provides operations to manage the accessPackageResourceRoleScopes property of the microsoft.graph.accessPackage entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[access_package_resource_role_scope_item_request_builder.AccessPackageResourceRoleScopeItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def access_packages_incompatible_with_by_id(self,id: str) -> Optional[AccessPackageItemRequestBuilder]:
        """
        Provides operations to manage the accessPackagesIncompatibleWith property of the microsoft.graph.accessPackage entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[AccessPackageItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def incompatible_access_packages_by_id(self,id: str) -> Optional[AccessPackageItemRequestBuilder]:
        """
    ...
    def incompatible_groups_by_id(self,id: str) -> Optional[group_item_request_builder.GroupItemRequestBuilder]:
        """
