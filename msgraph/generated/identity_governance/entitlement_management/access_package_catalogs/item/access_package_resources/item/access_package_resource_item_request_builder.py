...
class AccessPackageResourceItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[access_package_resource.AccessPackageResource] = None, request_configuration: Optional[AccessPackageResourceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property accessPackageResources in identityGovernance
        Args:
            body: The request body
