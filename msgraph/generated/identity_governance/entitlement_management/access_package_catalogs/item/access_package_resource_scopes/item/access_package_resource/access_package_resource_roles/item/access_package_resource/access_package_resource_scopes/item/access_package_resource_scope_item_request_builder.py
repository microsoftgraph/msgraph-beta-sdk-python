...
class AccessPackageResourceScopeItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_resource_scope_id1: Optional[str] = None) -> None:
        """
        Instantiates a new AccessPackageResourceScopeItemRequestBuilder and sets the default values.
        Args:
            accessPackageResourceScopeId1: key: id of accessPackageResourceScope
        ...
        url_tpl_params["accessPackageResourceScope%2Did1"] = accessPackageResourceScopeId1
