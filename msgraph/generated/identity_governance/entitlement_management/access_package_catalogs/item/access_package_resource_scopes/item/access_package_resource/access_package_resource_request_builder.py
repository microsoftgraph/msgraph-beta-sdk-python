...
access_package_resource_roles_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_package_resource_scopes.item.access_package_resource.access_package_resource_roles.access_package_resource_roles_request_builder')
access_package_resource_role_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_package_resource_scopes.item.access_package_resource.access_package_resource_roles.item.access_package_resource_role_item_request_builder')
access_package_resource_scopes_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_package_resource_scopes.item.access_package_resource.access_package_resource_scopes.access_package_resource_scopes_request_builder')
access_package_resource_scope_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_catalogs.item.access_package_resource_scopes.item.access_package_resource.access_package_resource_scopes.item.access_package_resource_scope_item_request_builder')
...
class AccessPackageResourceRequestBuilder():
    ...
    def access_package_resource_scopes_by_id(self,id: str) -> access_package_resource_scope_item_request_builder.AccessPackageResourceScopeItemRequestBuilder:
        ...
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["accessPackageResourceScope%2Did1"] = id
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog%2Did}/accessPackageResourceScopes/{accessPackageResourceScope%2Did}/accessPackageResource{?%24select,%24expand}"
