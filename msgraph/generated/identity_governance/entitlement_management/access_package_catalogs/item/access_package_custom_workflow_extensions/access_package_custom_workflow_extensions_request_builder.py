...
class AccessPackageCustomWorkflowExtensionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AccessPackageCustomWorkflowExtensionsRequestBuilder:
        """
        ...
        return AccessPackageCustomWorkflowExtensionsRequestBuilder(raw_url, self.request_adapter)
