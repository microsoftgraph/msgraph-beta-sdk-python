...
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_assignment_approvals.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
class AccessPackageAssignmentApprovalsRequestBuilder():
    ...
    async def post(self,body: Optional[approval.Approval] = None, request_configuration: Optional[AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration] = None) -> Optional[approval.Approval]:
        """
