...
access_package_resource_environment_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_resources.item.access_package_resource_roles.item.access_package_resource.access_package_resource_environment.access_package_resource_environment_request_builder')
access_package_resource_scopes_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_resources.item.access_package_resource_roles.item.access_package_resource.access_package_resource_scopes.access_package_resource_scopes_request_builder')
access_package_resource_scope_item_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_resources.item.access_package_resource_roles.item.access_package_resource.access_package_resource_scopes.item.access_package_resource_scope_item_request_builder')
...
class AccessPackageResourceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResources/{accessPackageResource%2Did}/accessPackageResourceRoles/{accessPackageResourceRole%2Did}/accessPackageResource{?%24select,%24expand}"
