...
class AccessPackageResourceRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, access_package_resource_request_id: Optional[str] = None) -> None:
        """
        Instantiates a new AccessPackageResourceRequestItemRequestBuilder and sets the default values.
        Args:
            accessPackageResourceRequestId: key: id of accessPackageResourceRequest
        ...
        url_tpl_params["accessPackageResourceRequest%2Did"] = accessPackageResourceRequestId
    ...
    async def get(self,request_configuration: Optional[AccessPackageResourceRequestItemRequestBuilderGetRequestConfiguration] = None) -> Optional[access_package_resource_request.AccessPackageResourceRequest]:
        """
    ...
    async def patch(self,body: Optional[access_package_resource_request.AccessPackageResourceRequest] = None, request_configuration: Optional[AccessPackageResourceRequestItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[access_package_resource_request.AccessPackageResourceRequest]:
        """
    ...
    def to_patch_request_information(self,body: Optional[access_package_resource_request.AccessPackageResourceRequest] = None, request_configuration: Optional[AccessPackageResourceRequestItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property accessPackageResourceRequests in identityGovernance
        Args:
            body: The request body
