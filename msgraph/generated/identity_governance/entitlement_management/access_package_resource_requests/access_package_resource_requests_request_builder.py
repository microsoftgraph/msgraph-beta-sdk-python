...
count_request_builder = lazy_import('msgraph.generated.identity_governance.entitlement_management.access_package_resource_requests.count.count_request_builder')
access_package_resource_request = lazy_import('msgraph.generated.models.access_package_resource_request')
access_package_resource_request_collection_response = lazy_import('msgraph.generated.models.access_package_resource_request_collection_response')
...
class AccessPackageResourceRequestsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AccessPackageResourceRequestsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[access_package_resource_request.AccessPackageResourceRequest] = None, request_configuration: Optional[AccessPackageResourceRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class AccessPackageResourceRequestsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
