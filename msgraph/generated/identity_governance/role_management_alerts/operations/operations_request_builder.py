...
if TYPE_CHECKING:
    ...
    from .item import long_running_operation_item_request_builder
...
class OperationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/roleManagementAlerts/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_long_running_operation_id(self,long_running_operation_id: str) -> long_running_operation_item_request_builder.LongRunningOperationItemRequestBuilder:
        """
        Provides operations to manage the operations property of the microsoft.graph.roleManagementAlert entity.
        Args:
            long_running_operation_id: Unique identifier of the item
        Returns: long_running_operation_item_request_builder.LongRunningOperationItemRequestBuilder
        """
        if long_running_operation_id is None:
            raise Exception("long_running_operation_id cannot be undefined")
        from .item import long_running_operation_item_request_builder
    ...
    async def get(self,request_configuration: Optional[OperationsRequestBuilderGetRequestConfiguration] = None) -> Optional[long_running_operation_collection_response.LongRunningOperationCollectionResponse]:
        ...
        from ....models import long_running_operation_collection_response

        return await self.request_adapter.send_async(request_info, long_running_operation_collection_response.LongRunningOperationCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[long_running_operation.LongRunningOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> Optional[long_running_operation.LongRunningOperation]:
        """
