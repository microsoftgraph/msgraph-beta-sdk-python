...
remediate_request_builder = lazy_import('msgraph.generated.identity_governance.role_management_alerts.alerts.item.alert_incidents.item.remediate.remediate_request_builder')
...
class UnifiedRoleManagementAlertIncidentItemRequestBuilder():
    ...
    @dataclass
    class UnifiedRoleManagementAlertIncidentItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
