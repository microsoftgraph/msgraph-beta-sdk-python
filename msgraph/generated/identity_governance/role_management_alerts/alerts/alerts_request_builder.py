...
count_request_builder = lazy_import('msgraph.generated.identity_governance.role_management_alerts.alerts.count.count_request_builder')
refresh_request_builder = lazy_import('msgraph.generated.identity_governance.role_management_alerts.alerts.refresh.refresh_request_builder')
unified_role_management_alert = lazy_import('msgraph.generated.models.unified_role_management_alert')
unified_role_management_alert_collection_response = lazy_import('msgraph.generated.models.unified_role_management_alert_collection_response')
