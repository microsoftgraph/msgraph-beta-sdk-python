...
steps_request_builder = lazy_import('msgraph.generated.identity_governance.app_consent.app_consent_requests.item.user_consent_requests.item.approval.steps.steps_request_builder')
approval_step_item_request_builder = lazy_import('msgraph.generated.identity_governance.app_consent.app_consent_requests.item.user_consent_requests.item.approval.steps.item.approval_step_item_request_builder')
