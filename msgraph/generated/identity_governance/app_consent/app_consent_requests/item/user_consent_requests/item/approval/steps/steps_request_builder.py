...
count_request_builder = lazy_import('msgraph.generated.identity_governance.app_consent.app_consent_requests.item.user_consent_requests.item.approval.steps.count.count_request_builder')
approval_step = lazy_import('msgraph.generated.models.approval_step')
approval_step_collection_response = lazy_import('msgraph.generated.models.approval_step_collection_response')
...
class StepsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[StepsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[approval_step.ApprovalStep] = None, request_configuration: Optional[StepsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
