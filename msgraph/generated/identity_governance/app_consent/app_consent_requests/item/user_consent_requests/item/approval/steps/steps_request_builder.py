...
class StepsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[approval_step.ApprovalStep] = None, request_configuration: Optional[StepsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to steps for identityGovernance
        Args:
            body: The request body
