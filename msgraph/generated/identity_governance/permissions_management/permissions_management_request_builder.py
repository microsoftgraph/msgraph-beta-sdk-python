...
if TYPE_CHECKING:
    ...
    from ...models.permissions_management import PermissionsManagement
    from .permissions_request_changes.permissions_request_changes_request_builder import PermissionsRequestChangesRequestBuilder
    from .scheduled_permissions_requests.scheduled_permissions_requests_request_builder import ScheduledPermissionsRequestsRequestBuilder

class PermissionsManagementRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/permissionsManagement{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PermissionsManagementRequestBuilderGetRequestConfiguration] = None) -> Optional[PermissionsManagement]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PermissionsManagement]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PermissionsManagementRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PermissionsManagementRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return PermissionsManagementRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def permissions_request_changes(self) -> PermissionsRequestChangesRequestBuilder:
        """
        Provides operations to manage the permissionsRequestChanges property of the microsoft.graph.permissionsManagement entity.
        """
        from .permissions_request_changes.permissions_request_changes_request_builder import PermissionsRequestChangesRequestBuilder

        return PermissionsRequestChangesRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def scheduled_permissions_requests(self) -> ScheduledPermissionsRequestsRequestBuilder:
        """
