...
class GovernanceInsightItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[GovernanceInsightItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[governance_insight.GovernanceInsight] = None, request_configuration: Optional[GovernanceInsightItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property insights in identityGovernance
        Args:
            body: The request body
