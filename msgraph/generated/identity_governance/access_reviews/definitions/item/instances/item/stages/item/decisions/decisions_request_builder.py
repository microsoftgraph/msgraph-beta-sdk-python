...
microsoft_graph_record_all_decisions_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.definitions.item.instances.item.stages.item.decisions.microsoft_graph_record_all_decisions.microsoft_graph_record_all_decisions_request_builder')
