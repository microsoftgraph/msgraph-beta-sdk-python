...
insights_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.definitions.item.instances.item.decisions.item.insights.insights_request_builder')
governance_insight_item_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.definitions.item.instances.item.decisions.item.insights.item.governance_insight_item_request_builder')
instance_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.definitions.item.instances.item.decisions.item.instance.instance_request_builder')
