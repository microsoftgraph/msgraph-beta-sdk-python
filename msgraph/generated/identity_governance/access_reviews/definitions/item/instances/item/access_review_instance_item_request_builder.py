...
definition_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.definitions.item.instances.item.definition.definition_request_builder')
