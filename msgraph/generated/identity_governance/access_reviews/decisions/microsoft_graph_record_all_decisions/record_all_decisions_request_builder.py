...
record_all_decisions_post_request_body = lazy_import('msgraph.generated.identity_governance.access_reviews.decisions.microsoft_graph_record_all_decisions.record_all_decisions_post_request_body')
...
class RecordAllDecisionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/accessReviews/decisions/microsoft.graph.recordAllDecisions"
