...
count_request_builder = lazy_import('msgraph.generated.identity_governance.access_reviews.decisions.item.insights.count.count_request_builder')
governance_insight = lazy_import('msgraph.generated.models.governance_insight')
governance_insight_collection_response = lazy_import('msgraph.generated.models.governance_insight_collection_response')
...
class InsightsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[governance_insight.GovernanceInsight] = None, request_configuration: Optional[InsightsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
