...
from ....models.identity_governance import lifecycle_management_settings
...
class SettingsRequestBuilder():
    ...
    def create_patch_request_information(self,body: Optional[lifecycle_management_settings.LifecycleManagementSettings] = None, request_configuration: Optional[SettingsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
