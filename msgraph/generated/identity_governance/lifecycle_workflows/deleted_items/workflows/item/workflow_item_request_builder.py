...
activate_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.microsoft_graph_identity_governance_activate.activate_request_builder')
create_new_version_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.microsoft_graph_identity_governance_create_new_version.create_new_version_request_builder')
restore_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.microsoft_graph_identity_governance_restore.restore_request_builder')
...
class WorkflowItemRequestBuilder():
    ...
    @property
    def microsoft_graph_identity_governance_activate(self) -> activate_request_builder.ActivateRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_identity_governance_create_new_version(self) -> create_new_version_request_builder.CreateNewVersionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_identity_governance_restore(self) -> restore_request_builder.RestoreRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, workflow_id: Optional[str] = None) -> None:
        """
        Instantiates a new WorkflowItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            workflowId: key: id of workflow
        """
        ...
        url_tpl_params["workflow%2Did"] = workflowId
