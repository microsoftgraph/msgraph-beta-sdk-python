...
activate_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.activate.activate_request_builder')
create_new_version_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.create_new_version.create_new_version_request_builder')
execution_scope_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.execution_scope.execution_scope_request_builder')
user_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.execution_scope.item.user_item_request_builder')
restore_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.restore.restore_request_builder')
runs_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.runs.runs_request_builder')
run_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.runs.item.run_item_request_builder')
task_reports_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.task_reports.task_reports_request_builder')
task_report_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.task_reports.item.task_report_item_request_builder')
user_processing_results_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.user_processing_results.user_processing_results_request_builder')
user_processing_result_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.user_processing_results.item.user_processing_result_item_request_builder')
versions_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.versions.versions_request_builder')
workflow_version_version_number_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.versions.item.workflow_version_version_number_item_request_builder')
...
class WorkflowItemRequestBuilder():
    ...
    def execution_scope_by_id(self,id: str) -> Optional[user_item_request_builder.UserItemRequestBuilder]:
        """
        Provides operations to manage the executionScope property of the microsoft.graph.identityGovernance.workflow entity.
        Args:
    ...
    def runs_by_id(self,id: str) -> Optional[run_item_request_builder.RunItemRequestBuilder]:
        """
        Provides operations to manage the runs property of the microsoft.graph.identityGovernance.workflow entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[run_item_request_builder.RunItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def task_reports_by_id(self,id: str) -> Optional[task_report_item_request_builder.TaskReportItemRequestBuilder]:
        """
        Provides operations to manage the taskReports property of the microsoft.graph.identityGovernance.workflow entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[task_report_item_request_builder.TaskReportItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def versions_by_id(self,id: str) -> Optional[workflow_version_version_number_item_request_builder.WorkflowVersionVersionNumberItemRequestBuilder]:
        """
        Provides operations to manage the versions property of the microsoft.graph.identityGovernance.workflow entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[workflow_version_version_number_item_request_builder.WorkflowVersionVersionNumberItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
