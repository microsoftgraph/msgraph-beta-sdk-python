...
identity_governance_activate_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.identity_governance_activate.identity_governance_activate_request_builder')
identity_governance_create_new_version_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.identity_governance_create_new_version.identity_governance_create_new_version_request_builder')
identity_governance_restore_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.identity_governance_restore.identity_governance_restore_request_builder')
