...
microsoft_graph_identity_governance_resume_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.runs.item.user_processing_results.item.task_processing_results.item.microsoft_graph_identity_governance_resume.microsoft_graph_identity_governance_resume_request_builder')
