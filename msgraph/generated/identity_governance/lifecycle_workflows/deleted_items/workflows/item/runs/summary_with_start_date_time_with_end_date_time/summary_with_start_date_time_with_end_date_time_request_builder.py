...
class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[SummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration] = None) -> Optional[run_summary.RunSummary]:
        """
