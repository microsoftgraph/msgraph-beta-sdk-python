...
resume_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.runs.item.task_processing_results.item.microsoft_graph_identity_governance_resume.resume_request_builder')
