...
create_new_version_post_request_body = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.identity_governance_create_new_version.create_new_version_post_request_body')
...
class IdentityGovernanceCreateNewVersionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new IdentityGovernanceCreateNewVersionRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/identityGovernance.createNewVersion"
    ...
    @dataclass
    class IdentityGovernanceCreateNewVersionRequestBuilderPostRequestConfiguration():
        """
