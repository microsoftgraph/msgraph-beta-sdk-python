...
if TYPE_CHECKING:
    from ........models.identity_governance import task_report_summary
...
class IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, end_date_time: Optional[datetime] = None, start_date_time: Optional[datetime] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/taskReports/identityGovernance.summary(startDateTime={startDateTime},endDateTime={endDateTime})"
    ...
    async def get(self,request_configuration: Optional[IdentityGovernanceSummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration] = None) -> Optional[task_report_summary.TaskReportSummary]:
        """
