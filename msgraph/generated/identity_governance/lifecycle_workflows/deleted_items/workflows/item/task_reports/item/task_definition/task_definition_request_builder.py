...
class TaskDefinitionRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[TaskDefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[task_definition.TaskDefinition]:
        """
        ...
        return await self.request_adapter.send_async(request_info, task_definition.TaskDefinition, error_mapping)
