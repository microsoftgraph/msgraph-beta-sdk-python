...
class VersionsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[workflow_version.WorkflowVersion] = None, request_configuration: Optional[VersionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to versions for identityGovernance
        Args:
            body: The request body
