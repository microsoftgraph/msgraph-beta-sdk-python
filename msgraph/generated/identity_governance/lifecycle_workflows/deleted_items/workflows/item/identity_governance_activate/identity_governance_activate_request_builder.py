...
activate_post_request_body = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.deleted_items.workflows.item.identity_governance_activate.activate_post_request_body')
...
class IdentityGovernanceActivateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/identityGovernance.activate"
    ...
    @dataclass
    class IdentityGovernanceActivateRequestBuilderPostRequestConfiguration():
        """
