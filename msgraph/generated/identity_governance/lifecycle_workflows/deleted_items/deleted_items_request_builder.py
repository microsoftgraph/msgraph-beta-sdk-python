...
class DeletedItemsRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeletedItemsRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[deleted_item_container.DeletedItemContainer] = None, request_configuration: Optional[DeletedItemsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def patch(self,body: Optional[deleted_item_container.DeletedItemContainer] = None, request_configuration: Optional[DeletedItemsRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[deleted_item_container.DeletedItemContainer]:
        """
        Update the navigation property deletedItems in identityGovernance
        Args:
            body: The request body
