...
class DeletedItemsRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[deleted_item_container.DeletedItemContainer] = None, request_configuration: Optional[DeletedItemsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deletedItems in identityGovernance
        Args:
            body: The request body
