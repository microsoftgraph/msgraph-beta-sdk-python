...
class TaskDefinitionItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, task_definition_id: Optional[str] = None) -> None:
        """
        Instantiates a new TaskDefinitionItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            taskDefinitionId: key: id of taskDefinition
        """
        ...
        url_tpl_params["taskDefinition%2Did"] = taskDefinitionId
