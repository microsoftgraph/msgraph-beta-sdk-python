...
class CustomTaskExtensionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, custom_task_extension_id: Optional[str] = None) -> None:
        """
        Instantiates a new CustomTaskExtensionItemRequestBuilder and sets the default values.
        Args:
            customTaskExtensionId: key: id of customTaskExtension
        ...
        url_tpl_params["customTaskExtension%2Did"] = customTaskExtensionId
