...
class CustomTaskExtensionItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CustomTaskExtensionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CustomTaskExtensionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[custom_task_extension.CustomTaskExtension] = None, request_configuration: Optional[CustomTaskExtensionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def delete(self,request_configuration: Optional[CustomTaskExtensionItemRequestBuilderDeleteRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Delete navigation property customTaskExtensions for identityGovernance
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def get(self,request_configuration: Optional[CustomTaskExtensionItemRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[custom_task_extension.CustomTaskExtension]:
        """
        The customTaskExtension instance.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, custom_task_extension.CustomTaskExtension, response_handler, error_mapping)
    
    async def patch(self,body: Optional[custom_task_extension.CustomTaskExtension] = None, request_configuration: Optional[CustomTaskExtensionItemRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[custom_task_extension.CustomTaskExtension]:
        """
        Update the navigation property customTaskExtensions in identityGovernance
        Args:
            body: The request body
