...
class UserProcessingResultItemRequestBuilder():
    ...
    def to_delete_request_information(self,request_configuration: Optional[UserProcessingResultItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property userProcessingResults for identityGovernance
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[user_processing_result.UserProcessingResult] = None, request_configuration: Optional[UserProcessingResultItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userProcessingResults in identityGovernance
        Args:
            body: The request body
