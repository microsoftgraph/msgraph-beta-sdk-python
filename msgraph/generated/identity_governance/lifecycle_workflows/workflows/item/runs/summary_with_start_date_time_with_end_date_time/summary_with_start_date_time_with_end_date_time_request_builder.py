...
class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[SummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[run_summary.RunSummary]:
        """
        Invoke function summary
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        return await self.request_adapter.send_async(request_info, run_summary.RunSummary, response_handler, error_mapping)
