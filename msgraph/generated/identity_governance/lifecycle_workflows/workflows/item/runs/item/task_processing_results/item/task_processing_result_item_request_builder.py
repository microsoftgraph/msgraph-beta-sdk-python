...
microsoft_graph_identity_governance_resume_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflows.item.runs.item.task_processing_results.item.microsoft_graph_identity_governance_resume.microsoft_graph_identity_governance_resume_request_builder')
subject_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflows.item.runs.item.task_processing_results.item.subject.subject_request_builder')
task_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflows.item.runs.item.task_processing_results.item.task.task_request_builder')
