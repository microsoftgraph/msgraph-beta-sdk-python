...
class SummaryWithStartDateTimeWithEndDateTimeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[SummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration] = None) -> Optional[user_summary.UserSummary]:
        """
