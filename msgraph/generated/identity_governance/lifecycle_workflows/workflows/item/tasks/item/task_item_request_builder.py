...
class TaskItemRequestBuilder():
    ...
    async def patch(self,body: Optional[task.Task] = None, request_configuration: Optional[TaskItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[task.Task]:
        """
