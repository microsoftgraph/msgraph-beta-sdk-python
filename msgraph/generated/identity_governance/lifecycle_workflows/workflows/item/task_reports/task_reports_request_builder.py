...
class TaskReportsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[task_report.TaskReport] = None, request_configuration: Optional[TaskReportsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to taskReports for identityGovernance
        Args:
            body: The request body
