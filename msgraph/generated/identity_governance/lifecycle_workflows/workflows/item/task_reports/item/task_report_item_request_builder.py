...
class TaskReportItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, task_report_id: Optional[str] = None) -> None:
        """
        Instantiates a new TaskReportItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            taskReportId: key: id of taskReport
        """
        ...
        url_tpl_params["taskReport%2Did"] = taskReportId
