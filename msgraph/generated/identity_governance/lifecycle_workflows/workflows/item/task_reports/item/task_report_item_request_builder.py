...
class TaskReportItemRequestBuilder():
    ...
    def to_delete_request_information(self,request_configuration: Optional[TaskReportItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property taskReports for identityGovernance
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[task_report.TaskReport] = None, request_configuration: Optional[TaskReportItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property taskReports in identityGovernance
        Args:
            body: The request body
