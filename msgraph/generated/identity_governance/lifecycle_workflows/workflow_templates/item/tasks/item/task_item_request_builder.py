...
task_processing_results_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_processing_results.task_processing_results_request_builder')
task_processing_result_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_processing_results.item.task_processing_result_item_request_builder')
...
class TaskItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TaskItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TaskItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[task.Task] = None, request_configuration: Optional[TaskItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
