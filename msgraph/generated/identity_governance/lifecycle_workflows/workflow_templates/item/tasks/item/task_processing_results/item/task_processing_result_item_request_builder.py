...
resume_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_processing_results.item.resume.resume_request_builder')
subject_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_processing_results.item.subject.subject_request_builder')
task_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_processing_results.item.task.task_request_builder')
...
class TaskProcessingResultItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TaskProcessingResultItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TaskProcessingResultItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[task_processing_result.TaskProcessingResult] = None, request_configuration: Optional[TaskProcessingResultItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def delete(self,request_configuration: Optional[TaskProcessingResultItemRequestBuilderDeleteRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Delete navigation property taskProcessingResults for identityGovernance
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[task_processing_result.TaskProcessingResult] = None, request_configuration: Optional[TaskProcessingResultItemRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[task_processing_result.TaskProcessingResult]:
        """
        Update the navigation property taskProcessingResults in identityGovernance
        Args:
            body: The request body
    ...
    @dataclass
    class TaskProcessingResultItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class TaskProcessingResultItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
