...
class TaskProcessingResultItemRequestBuilder():
    ...
    def to_delete_request_information(self,request_configuration: Optional[TaskProcessingResultItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property taskProcessingResults for identityGovernance
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[task_processing_result.TaskProcessingResult] = None, request_configuration: Optional[TaskProcessingResultItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property taskProcessingResults in identityGovernance
        Args:
            body: The request body
