...
tasks_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.tasks_request_builder')
task_item_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.item.tasks.item.task_item_request_builder')
...
class WorkflowTemplateItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[WorkflowTemplateItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[WorkflowTemplateItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[workflow_template.WorkflowTemplate] = None, request_configuration: Optional[WorkflowTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
