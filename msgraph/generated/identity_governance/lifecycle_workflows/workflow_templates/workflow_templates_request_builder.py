...
count_request_builder = lazy_import('msgraph.generated.identity_governance.lifecycle_workflows.workflow_templates.count.count_request_builder')
workflow_template = lazy_import('msgraph.generated.models.identity_governance.workflow_template')
workflow_template_collection_response = lazy_import('msgraph.generated.models.identity_governance.workflow_template_collection_response')
...
class WorkflowTemplatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WorkflowTemplatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[workflow_template.WorkflowTemplate] = None, request_configuration: Optional[WorkflowTemplatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def post(self,body: Optional[workflow_template.WorkflowTemplate] = None, request_configuration: Optional[WorkflowTemplatesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[workflow_template.WorkflowTemplate]:
        """
        Create new navigation property to workflowTemplates for identityGovernance
        Args:
            body: The request body
    ...
    @dataclass
    class WorkflowTemplatesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
