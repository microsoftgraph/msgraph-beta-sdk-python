...
class WorkflowTemplatesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[workflow_template.WorkflowTemplate] = None, request_configuration: Optional[WorkflowTemplatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to workflowTemplates for identityGovernance
        Args:
            body: The request body
