...
if TYPE_CHECKING:
    from ...models import privileged_access_root
...
class PrivilegedAccessRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PrivilegedAccessRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[privileged_access_root.PrivilegedAccessRoot] = None, request_configuration: Optional[PrivilegedAccessRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property privilegedAccess in identityGovernance
        Args:
            body: The request body
