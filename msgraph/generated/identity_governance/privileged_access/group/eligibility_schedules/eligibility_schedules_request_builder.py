...
if TYPE_CHECKING:
    from .....models import privileged_access_group_eligibility_schedule, privileged_access_group_eligibility_schedule_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .filter_by_current_user_with_on import filter_by_current_user_with_on_request_builder
    from .item import privileged_access_group_eligibility_schedule_item_request_builder
...
class EligibilitySchedulesRequestBuilder():
    ...
    def by_privileged_access_group_eligibility_schedule_id(self,privileged_access_group_eligibility_schedule_id: str) -> privileged_access_group_eligibility_schedule_item_request_builder.PrivilegedAccessGroupEligibilityScheduleItemRequestBuilder:
        """
        Provides operations to manage the eligibilitySchedules property of the microsoft.graph.privilegedAccessGroup entity.
        Args:
            privileged_access_group_eligibility_schedule_id: Unique identifier of the item
        ...
        if privileged_access_group_eligibility_schedule_id is None:
            raise Exception("privileged_access_group_eligibility_schedule_id cannot be undefined")
        from .item import privileged_access_group_eligibility_schedule_item_request_builder
    ...
    async def get(self,request_configuration: Optional[EligibilitySchedulesRequestBuilderGetRequestConfiguration] = None) -> Optional[privileged_access_group_eligibility_schedule_collection_response.PrivilegedAccessGroupEligibilityScheduleCollectionResponse]:
        ...
        from .....models import privileged_access_group_eligibility_schedule_collection_response

        return await self.request_adapter.send_async(request_info, privileged_access_group_eligibility_schedule_collection_response.PrivilegedAccessGroupEligibilityScheduleCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[privileged_access_group_eligibility_schedule.PrivilegedAccessGroupEligibilitySchedule] = None, request_configuration: Optional[EligibilitySchedulesRequestBuilderPostRequestConfiguration] = None) -> Optional[privileged_access_group_eligibility_schedule.PrivilegedAccessGroupEligibilitySchedule]:
        """
