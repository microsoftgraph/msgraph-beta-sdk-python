...
group_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedules.item.group.group_request_builder')
principal_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedules.item.principal.principal_request_builder')
...
class PrivilegedAccessGroupEligibilityScheduleItemRequestBuilder():
    """
    ...
    def to_patch_request_information(self,body: Optional[privileged_access_group_eligibility_schedule.PrivilegedAccessGroupEligibilitySchedule] = None, request_configuration: Optional[PrivilegedAccessGroupEligibilityScheduleItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property eligibilitySchedules in identityGovernance
        Args:
            body: The request body
    ...
    @dataclass
    class PrivilegedAccessGroupEligibilityScheduleItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PrivilegedAccessGroupEligibilityScheduleItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
