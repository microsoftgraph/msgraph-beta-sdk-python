...
if TYPE_CHECKING:
    from ......models import privileged_access_group_eligibility_schedule
...
class PrivilegedAccessGroupEligibilityScheduleItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PrivilegedAccessGroupEligibilityScheduleItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
