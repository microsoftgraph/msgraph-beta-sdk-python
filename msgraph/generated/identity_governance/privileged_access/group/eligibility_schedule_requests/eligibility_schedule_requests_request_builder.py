...
if TYPE_CHECKING:
    from .....models import privileged_access_group_eligibility_schedule_request, privileged_access_group_eligibility_schedule_request_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .filter_by_current_user_with_on import filter_by_current_user_with_on_request_builder
    from .item import privileged_access_group_eligibility_schedule_request_item_request_builder

class EligibilityScheduleRequestsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_privileged_access_group_eligibility_schedule_request_id(self,privileged_access_group_eligibility_schedule_request_id: str) -> privileged_access_group_eligibility_schedule_request_item_request_builder.PrivilegedAccessGroupEligibilityScheduleRequestItemRequestBuilder:
        """
        Provides operations to manage the eligibilityScheduleRequests property of the microsoft.graph.privilegedAccessGroup entity.
        Args:
            privileged_access_group_eligibility_schedule_request_id: Unique identifier of the item
        ...
        if privileged_access_group_eligibility_schedule_request_id is None:
            raise Exception("privileged_access_group_eligibility_schedule_request_id cannot be undefined")
        from .item import privileged_access_group_eligibility_schedule_request_item_request_builder
    ...
    async def get(self,request_configuration: Optional[EligibilityScheduleRequestsRequestBuilderGetRequestConfiguration] = None) -> Optional[privileged_access_group_eligibility_schedule_request_collection_response.PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse]:
        ...
        from .....models import privileged_access_group_eligibility_schedule_request_collection_response

        return await self.request_adapter.send_async(request_info, privileged_access_group_eligibility_schedule_request_collection_response.PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse, error_mapping)
    ...
    async def post(self,body: Optional[privileged_access_group_eligibility_schedule_request.PrivilegedAccessGroupEligibilityScheduleRequest] = None, request_configuration: Optional[EligibilityScheduleRequestsRequestBuilderPostRequestConfiguration] = None) -> Optional[privileged_access_group_eligibility_schedule_request.PrivilegedAccessGroupEligibilityScheduleRequest]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from .....models import privileged_access_group_eligibility_schedule_request

        return await self.request_adapter.send_async(request_info, privileged_access_group_eligibility_schedule_request.PrivilegedAccessGroupEligibilityScheduleRequest, error_mapping)
    ...
    @dataclass
    class EligibilityScheduleRequestsRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[EligibilityScheduleRequestsRequestBuilder.EligibilityScheduleRequestsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class EligibilityScheduleRequestsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
