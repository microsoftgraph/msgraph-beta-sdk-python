...
count_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedule_requests.count.count_request_builder')
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedule_requests.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
privileged_access_group_eligibility_schedule_request_collection_response = lazy_import('msgraph.generated.models.privileged_access_group_eligibility_schedule_request_collection_response')
