...
if TYPE_CHECKING:
    from ......models import base_collection_pagination_count_response, privileged_access_group_assignment_schedule_instance
...
class FilterByCurrentUserWithOnResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[privileged_access_group_assignment_schedule_instance.PrivilegedAccessGroupAssignmentScheduleInstance]] = None
