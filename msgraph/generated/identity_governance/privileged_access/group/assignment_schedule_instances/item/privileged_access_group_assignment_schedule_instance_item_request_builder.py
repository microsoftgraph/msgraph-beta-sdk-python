...
if TYPE_CHECKING:
    from ......models import privileged_access_group_assignment_schedule_instance
...
class PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
