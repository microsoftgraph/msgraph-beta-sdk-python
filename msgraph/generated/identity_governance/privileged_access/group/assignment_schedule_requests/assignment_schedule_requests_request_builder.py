...
if TYPE_CHECKING:
    from .....models import privileged_access_group_assignment_schedule_request, privileged_access_group_assignment_schedule_request_collection_response
...
class AssignmentScheduleRequestsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[AssignmentScheduleRequestsRequestBuilderGetRequestConfiguration] = None) -> Optional[privileged_access_group_assignment_schedule_request_collection_response.PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse]:
        ...
        from .....models import privileged_access_group_assignment_schedule_request_collection_response
