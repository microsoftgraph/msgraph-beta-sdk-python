...
class PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, privileged_access_group_assignment_schedule_id: Optional[str] = None) -> None:
        """
        Instantiates a new PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            privilegedAccessGroupAssignmentScheduleId: key: id of privilegedAccessGroupAssignmentSchedule
        ...
        url_tpl_params["privilegedAccessGroupAssignmentSchedule%2Did"] = privilegedAccessGroupAssignmentScheduleId
    ...
    async def get(self,request_configuration: Optional[PrivilegedAccessGroupAssignmentScheduleItemRequestBuilderGetRequestConfiguration] = None) -> Optional[privileged_access_group_assignment_schedule.PrivilegedAccessGroupAssignmentSchedule]:
        """
