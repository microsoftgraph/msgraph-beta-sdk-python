...
filter_by_current_user_with_on_response = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedule_instances.filter_by_current_user_with_on.filter_by_current_user_with_on_response')
