...
if TYPE_CHECKING:
    from .....models import privileged_access_group_eligibility_schedule_instance, privileged_access_group_eligibility_schedule_instance_collection_response
...
class EligibilityScheduleInstancesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[EligibilityScheduleInstancesRequestBuilderGetRequestConfiguration] = None) -> Optional[privileged_access_group_eligibility_schedule_instance_collection_response.PrivilegedAccessGroupEligibilityScheduleInstanceCollectionResponse]:
        ...
        from .....models import privileged_access_group_eligibility_schedule_instance_collection_response
