...
count_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedule_instances.count.count_request_builder')
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.identity_governance.privileged_access.group.eligibility_schedule_instances.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
privileged_access_group_eligibility_schedule_instance_collection_response = lazy_import('msgraph.generated.models.privileged_access_group_eligibility_schedule_instance_collection_response')
...
class EligibilityScheduleInstancesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilityScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[privileged_access_group_eligibility_schedule_instance.PrivilegedAccessGroupEligibilityScheduleInstance] = None, request_configuration: Optional[EligibilityScheduleInstancesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to eligibilityScheduleInstances for identityGovernance
        Args:
            body: The request body
    ...
    @dataclass
    class EligibilityScheduleInstancesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class EligibilityScheduleInstancesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
