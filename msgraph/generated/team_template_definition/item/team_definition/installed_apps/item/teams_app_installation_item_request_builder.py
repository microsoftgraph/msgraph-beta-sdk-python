...
upgrade_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.installed_apps.item.microsoft_graph_upgrade.upgrade_request_builder')
