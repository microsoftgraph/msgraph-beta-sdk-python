...
get_by_ids_post_request_body = lazy_import('msgraph.generated.team_template_definition.item.team_definition.permission_grants.get_by_ids.get_by_ids_post_request_body')
get_by_ids_response = lazy_import('msgraph.generated.team_template_definition.item.team_definition.permission_grants.get_by_ids.get_by_ids_response')
...
class GetByIdsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/permissionGrants/microsoft.graph.getByIds"
