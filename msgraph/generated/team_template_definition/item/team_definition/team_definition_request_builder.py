...
microsoft_graph_archive_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_archive.microsoft_graph_archive_request_builder')
microsoft_graph_clone_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_clone.microsoft_graph_clone_request_builder')
microsoft_graph_complete_migration_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_complete_migration.microsoft_graph_complete_migration_request_builder')
microsoft_graph_send_activity_notification_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_send_activity_notification.microsoft_graph_send_activity_notification_request_builder')
microsoft_graph_unarchive_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_unarchive.microsoft_graph_unarchive_request_builder')
