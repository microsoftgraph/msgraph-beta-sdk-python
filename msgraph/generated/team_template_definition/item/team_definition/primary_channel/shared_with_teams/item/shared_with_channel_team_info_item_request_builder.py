...
allowed_members_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.primary_channel.shared_with_teams.item.allowed_members.allowed_members_request_builder')
conversation_member_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.primary_channel.shared_with_teams.item.allowed_members.item.conversation_member_item_request_builder')
...
class SharedWithChannelTeamInfoItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}"
    ...
    async def patch(self,body: Optional[shared_with_channel_team_info.SharedWithChannelTeamInfo] = None, request_configuration: Optional[SharedWithChannelTeamInfoItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[shared_with_channel_team_info.SharedWithChannelTeamInfo]:
        """
    ...
    def to_patch_request_information(self,body: Optional[shared_with_channel_team_info.SharedWithChannelTeamInfo] = None, request_configuration: Optional[SharedWithChannelTeamInfoItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property sharedWithTeams in teamTemplateDefinition
        Args:
            body: The request body
