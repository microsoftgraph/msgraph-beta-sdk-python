...
delta_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.primary_channel.messages.microsoft_graph_delta.delta_request_builder')
