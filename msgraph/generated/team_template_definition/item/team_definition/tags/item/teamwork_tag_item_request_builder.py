...
class TeamworkTagItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, teamwork_tag_id: Optional[str] = None) -> None:
        """
        Instantiates a new TeamworkTagItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            teamworkTagId: key: id of teamworkTag
        """
        ...
        url_tpl_params["teamworkTag%2Did"] = teamworkTagId
