...
clone_post_request_body = lazy_import('msgraph.generated.team_template_definition.item.team_definition.microsoft_graph_clone.clone_post_request_body')
...
class CloneRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/microsoft.graph.clone"
