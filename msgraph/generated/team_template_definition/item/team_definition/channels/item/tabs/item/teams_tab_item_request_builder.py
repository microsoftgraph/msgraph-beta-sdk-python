...
teams_app_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.channels.item.tabs.item.teams_app.teams_app_request_builder')
...
class TeamsTabItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}"
