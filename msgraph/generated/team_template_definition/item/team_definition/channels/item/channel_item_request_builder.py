...
complete_migration_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.channels.item.complete_migration.complete_migration_request_builder')
...
provision_email_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.channels.item.provision_email.provision_email_request_builder')
remove_email_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.channels.item.remove_email.remove_email_request_builder')
