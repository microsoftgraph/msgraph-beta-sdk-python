...
add_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.channels.item.members.microsoft_graph_add.add_request_builder')
