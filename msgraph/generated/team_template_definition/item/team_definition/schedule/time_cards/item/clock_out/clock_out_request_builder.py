...
class ClockOutRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/clockOut", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ClockOutRequestBuilder:
        ...
        return ClockOutRequestBuilder(raw_url, self.request_adapter)
