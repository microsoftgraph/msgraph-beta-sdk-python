...
class ConfirmRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}/confirm", path_parameters)
    
    async def post(self,request_configuration: Optional[ConfirmRequestBuilderPostRequestConfiguration] = None) -> Optional[TimeCard]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ConfirmRequestBuilder:
        ...
        return ConfirmRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ConfirmRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
