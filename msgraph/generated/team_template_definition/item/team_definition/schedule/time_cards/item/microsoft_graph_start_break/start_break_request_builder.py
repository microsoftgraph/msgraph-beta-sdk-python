...
start_break_post_request_body = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_start_break.start_break_post_request_body')
