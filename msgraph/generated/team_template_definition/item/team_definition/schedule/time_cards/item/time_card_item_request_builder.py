...
clock_out_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_clock_out.clock_out_request_builder')
confirm_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_confirm.confirm_request_builder')
end_break_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_end_break.end_break_request_builder')
start_break_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_start_break.start_break_request_builder')
...
class TimeCardItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_clock_out(self) -> clock_out_request_builder.ClockOutRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_confirm(self) -> confirm_request_builder.ConfirmRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_end_break(self) -> end_break_request_builder.EndBreakRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_start_break(self) -> start_break_request_builder.StartBreakRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, time_card_id: Optional[str] = None) -> None:
        """
        Instantiates a new TimeCardItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            timeCardId: key: id of timeCard
        """
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards/{timeCard%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["timeCard%2Did"] = timeCardId
