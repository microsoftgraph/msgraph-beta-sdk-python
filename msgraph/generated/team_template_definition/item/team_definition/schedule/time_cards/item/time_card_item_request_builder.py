...
microsoft_graph_clock_out_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_clock_out.microsoft_graph_clock_out_request_builder')
microsoft_graph_confirm_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_confirm.microsoft_graph_confirm_request_builder')
microsoft_graph_end_break_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_end_break.microsoft_graph_end_break_request_builder')
microsoft_graph_start_break_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.microsoft_graph_start_break.microsoft_graph_start_break_request_builder')
