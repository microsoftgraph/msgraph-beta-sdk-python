...
offer_shift_requests_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.offer_shift_requests.offer_shift_requests_request_builder')
offer_shift_request_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.offer_shift_requests.item.offer_shift_request_item_request_builder')
open_shift_change_requests_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.open_shift_change_requests.open_shift_change_requests_request_builder')
open_shift_change_request_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.open_shift_change_requests.item.open_shift_change_request_item_request_builder')
open_shifts_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.open_shifts.open_shifts_request_builder')
open_shift_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.open_shifts.item.open_shift_item_request_builder')
scheduling_groups_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.scheduling_groups.scheduling_groups_request_builder')
scheduling_group_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.scheduling_groups.item.scheduling_group_item_request_builder')
share_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.share.share_request_builder')
shifts_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.shifts.shifts_request_builder')
shift_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.shifts.item.shift_item_request_builder')
swap_shifts_change_requests_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.swap_shifts_change_requests.swap_shifts_change_requests_request_builder')
swap_shifts_change_request_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.swap_shifts_change_requests.item.swap_shifts_change_request_item_request_builder')
time_cards_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.time_cards_request_builder')
time_card_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_cards.item.time_card_item_request_builder')
time_off_reasons_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_off_reasons.time_off_reasons_request_builder')
time_off_reason_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_off_reasons.item.time_off_reason_item_request_builder')
time_off_requests_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_off_requests.time_off_requests_request_builder')
time_off_request_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.time_off_requests.item.time_off_request_item_request_builder')
times_off_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.times_off.times_off_request_builder')
time_off_item_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.schedule.times_off.item.time_off_item_request_builder')
...
class ScheduleRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule{?%24select,%24expand}"
    ...
    def time_cards_by_id(self,id: str) -> Optional[time_card_item_request_builder.TimeCardItemRequestBuilder]:
        """
        Provides operations to manage the timeCards property of the microsoft.graph.schedule entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[time_card_item_request_builder.TimeCardItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
