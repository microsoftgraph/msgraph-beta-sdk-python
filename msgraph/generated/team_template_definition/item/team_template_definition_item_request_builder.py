...
team_definition_request_builder = lazy_import('msgraph.generated.team_template_definition.item.team_definition.team_definition_request_builder')

class TeamTemplateDefinitionItemRequestBuilder():
    """
    Provides operations to manage the collection of teamTemplateDefinition entities.
    """
    @property
    def team_definition(self) -> team_definition_request_builder.TeamDefinitionRequestBuilder:
        """
        Provides operations to manage the teamDefinition property of the microsoft.graph.teamTemplateDefinition entity.
        """
        return team_definition_request_builder.TeamDefinitionRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[TeamTemplateDefinitionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TeamTemplateDefinitionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[team_template_definition.TeamTemplateDefinition] = None, request_configuration: Optional[TeamTemplateDefinitionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class TeamTemplateDefinitionItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class TeamTemplateDefinitionItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
