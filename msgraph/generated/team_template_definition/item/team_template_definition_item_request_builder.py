...
class TeamTemplateDefinitionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, team_template_definition_id: Optional[str] = None) -> None:
        """
        Instantiates a new TeamTemplateDefinitionItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            teamTemplateDefinitionId: key: id of teamTemplateDefinition
        """
        ...
        url_tpl_params["teamTemplateDefinition%2Did"] = teamTemplateDefinitionId
