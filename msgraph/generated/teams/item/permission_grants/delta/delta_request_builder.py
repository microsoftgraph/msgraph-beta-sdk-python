...
delta_response = lazy_import('msgraph.generated.teams.item.permission_grants.delta.delta_response')
...
class DeltaRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teams/{team%2Did}/permissionGrants/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
