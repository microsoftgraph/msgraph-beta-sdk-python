...
microsoft_graph_check_member_groups_request_builder = lazy_import('msgraph.generated.teams.item.permission_grants.item.microsoft_graph_check_member_groups.microsoft_graph_check_member_groups_request_builder')
microsoft_graph_check_member_objects_request_builder = lazy_import('msgraph.generated.teams.item.permission_grants.item.microsoft_graph_check_member_objects.microsoft_graph_check_member_objects_request_builder')
microsoft_graph_get_member_groups_request_builder = lazy_import('msgraph.generated.teams.item.permission_grants.item.microsoft_graph_get_member_groups.microsoft_graph_get_member_groups_request_builder')
microsoft_graph_get_member_objects_request_builder = lazy_import('msgraph.generated.teams.item.permission_grants.item.microsoft_graph_get_member_objects.microsoft_graph_get_member_objects_request_builder')
microsoft_graph_restore_request_builder = lazy_import('msgraph.generated.teams.item.permission_grants.item.microsoft_graph_restore.microsoft_graph_restore_request_builder')
...
class ResourceSpecificPermissionGrantItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teams/{team%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}"
