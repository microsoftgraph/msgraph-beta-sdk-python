...
microsoft_graph_set_reaction_request_builder = lazy_import('msgraph.generated.teams.item.channels.item.messages.item.microsoft_graph_set_reaction.microsoft_graph_set_reaction_request_builder')
...
microsoft_graph_unset_reaction_request_builder = lazy_import('msgraph.generated.teams.item.channels.item.messages.item.microsoft_graph_unset_reaction.microsoft_graph_unset_reaction_request_builder')
