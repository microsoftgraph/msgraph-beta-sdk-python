...
set_reaction_request_builder = lazy_import('msgraph.generated.teams.item.channels.item.messages.item.set_reaction.set_reaction_request_builder')
...
unset_reaction_request_builder = lazy_import('msgraph.generated.teams.item.channels.item.messages.item.unset_reaction.unset_reaction_request_builder')
