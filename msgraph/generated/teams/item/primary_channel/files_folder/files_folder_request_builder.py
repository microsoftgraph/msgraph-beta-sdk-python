...
content_request_builder = lazy_import('msgraph.generated.teams.item.primary_channel.files_folder.content.content_request_builder')
...
class FilesFolderRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teams/{team%2Did}/primaryChannel/filesFolder{?%24select,%24expand}"
