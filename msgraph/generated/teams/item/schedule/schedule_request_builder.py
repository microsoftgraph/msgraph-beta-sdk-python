...
open_shift_change_request_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.open_shift_change_requests.item.open_shift_change_request_item_request_builder')
open_shifts_request_builder = lazy_import('msgraph.generated.teams.item.schedule.open_shifts.open_shifts_request_builder')
...
swap_shifts_change_request_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.swap_shifts_change_requests.item.swap_shifts_change_request_item_request_builder')
time_cards_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_cards.time_cards_request_builder')
time_card_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_cards.item.time_card_item_request_builder')
time_off_reasons_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_off_reasons.time_off_reasons_request_builder')
time_off_reason_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_off_reasons.item.time_off_reason_item_request_builder')
time_off_requests_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_off_requests.time_off_requests_request_builder')
time_off_request_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.time_off_requests.item.time_off_request_item_request_builder')
times_off_request_builder = lazy_import('msgraph.generated.teams.item.schedule.times_off.times_off_request_builder')
time_off_item_request_builder = lazy_import('msgraph.generated.teams.item.schedule.times_off.item.time_off_item_request_builder')
