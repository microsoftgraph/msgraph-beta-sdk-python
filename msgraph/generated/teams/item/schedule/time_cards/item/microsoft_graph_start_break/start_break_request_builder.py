...
start_break_post_request_body = lazy_import('msgraph.generated.teams.item.schedule.time_cards.item.microsoft_graph_start_break.start_break_post_request_body')
...
class StartBreakRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teams/{team%2Did}/schedule/timeCards/{timeCard%2Did}/microsoft.graph.startBreak"
