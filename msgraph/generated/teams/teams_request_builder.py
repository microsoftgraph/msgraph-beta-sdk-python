...
microsoft_graph_all_messages_request_builder = lazy_import('msgraph.generated.teams.microsoft_graph_all_messages.microsoft_graph_all_messages_request_builder')
microsoft_graph_get_all_messages_request_builder = lazy_import('msgraph.generated.teams.microsoft_graph_get_all_messages.microsoft_graph_get_all_messages_request_builder')
...
class TeamsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/teams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
