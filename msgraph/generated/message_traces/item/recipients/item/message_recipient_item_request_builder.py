...
class MessageRecipientItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, message_recipient_id: Optional[str] = None) -> None:
        """
        Instantiates a new MessageRecipientItemRequestBuilder and sets the default values.
        Args:
            messageRecipientId: key: id of messageRecipient
        ...
        url_tpl_params["messageRecipient%2Did"] = messageRecipientId
