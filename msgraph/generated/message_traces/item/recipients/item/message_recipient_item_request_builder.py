...
events_request_builder = lazy_import('msgraph.generated.message_traces.item.recipients.item.events.events_request_builder')
message_event_item_request_builder = lazy_import('msgraph.generated.message_traces.item.recipients.item.events.item.message_event_item_request_builder')
...
class MessageRecipientItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/messageTraces/{messageTrace%2Did}/recipients/{messageRecipient%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[MessageRecipientItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MessageRecipientItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[message_recipient.MessageRecipient] = None, request_configuration: Optional[MessageRecipientItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class MessageRecipientItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class MessageRecipientItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
