...
reauthorize_request_builder = lazy_import('msgraph.generated.drive.list.subscriptions.item.reauthorize.reauthorize_request_builder')
...
class SubscriptionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drive/list/subscriptions/{subscription%2Did}{?%24select,%24expand}"
