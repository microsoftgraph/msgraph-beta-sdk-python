...
drive_item_request_builder = lazy_import('msgraph.generated.drive.list.items.item.activities.item.drive_item.drive_item_request_builder')
list_item_request_builder = lazy_import('msgraph.generated.drive.list.items.item.activities.item.list_item.list_item_request_builder')
...
class ItemActivityOLDItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drive/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
    ...
    def create_delete_request_information(self,request_configuration: Optional[ItemActivityOLDItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property activities for drive
        Args:
