...
activities_request_builder = lazy_import('msgraph.generated.drive.items.item.list_item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.drive.items.item.list_item.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.drive.items.item.list_item.analytics.analytics_request_builder')
create_link_request_builder = lazy_import('msgraph.generated.drive.items.item.list_item.create_link.create_link_request_builder')
