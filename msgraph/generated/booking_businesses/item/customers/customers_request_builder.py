...
count_request_builder = lazy_import('msgraph.generated.booking_businesses.item.customers.count.count_request_builder')
booking_customer = lazy_import('msgraph.generated.models.booking_customer')
booking_customer_collection_response = lazy_import('msgraph.generated.models.booking_customer_collection_response')
...
class CustomersRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CustomersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[booking_customer.BookingCustomer] = None, request_configuration: Optional[CustomersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
