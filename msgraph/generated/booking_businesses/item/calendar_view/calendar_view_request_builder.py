...
count_request_builder = lazy_import('msgraph.generated.booking_businesses.item.calendar_view.count.count_request_builder')
booking_appointment = lazy_import('msgraph.generated.models.booking_appointment')
booking_appointment_collection_response = lazy_import('msgraph.generated.models.booking_appointment_collection_response')
...
class CalendarViewRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[booking_appointment.BookingAppointment] = None, request_configuration: Optional[CalendarViewRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[CalendarViewRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[booking_appointment_collection_response.BookingAppointmentCollectionResponse]:
        """
        The set of appointments of this business in a specified date range. Read-only. Nullable.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def post(self,body: Optional[booking_appointment.BookingAppointment] = None, request_configuration: Optional[CalendarViewRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[booking_appointment.BookingAppointment]:
        """
        Create new navigation property to calendarView for bookingBusinesses
        Args:
            body: The request body
