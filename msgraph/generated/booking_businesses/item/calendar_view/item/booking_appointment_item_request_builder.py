...
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.booking_businesses.item.calendar_view.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
...
class BookingAppointmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView/{bookingAppointment%2Did}{?start*,end*,%24select,%24expand}"
