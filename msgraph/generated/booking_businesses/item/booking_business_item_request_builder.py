...
class BookingBusinessItemRequestBuilder():
    ...
    def customers_by_id(self,id: str) -> Optional[booking_customer_item_request_builder.BookingCustomerItemRequestBuilder]:
        """
        Provides operations to manage the customers property of the microsoft.graph.bookingBusiness entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[booking_customer_item_request_builder.BookingCustomerItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def staff_members_by_id(self,id: str) -> Optional[booking_staff_member_item_request_builder.BookingStaffMemberItemRequestBuilder]:
        """
        Provides operations to manage the staffMembers property of the microsoft.graph.bookingBusiness entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[booking_staff_member_item_request_builder.BookingStaffMemberItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
