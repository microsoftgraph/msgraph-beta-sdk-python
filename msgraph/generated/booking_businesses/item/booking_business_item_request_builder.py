...
get_staff_availability_request_builder = lazy_import('msgraph.generated.booking_businesses.item.microsoft_graph_get_staff_availability.get_staff_availability_request_builder')
publish_request_builder = lazy_import('msgraph.generated.booking_businesses.item.microsoft_graph_publish.publish_request_builder')
unpublish_request_builder = lazy_import('msgraph.generated.booking_businesses.item.microsoft_graph_unpublish.unpublish_request_builder')
...
class BookingBusinessItemRequestBuilder():
    ...
    def customers_by_id(self,id: str) -> booking_customer_item_request_builder.BookingCustomerItemRequestBuilder:
        """
        Provides operations to manage the customers property of the microsoft.graph.bookingBusiness entity.
        Args:
            id: Unique identifier of the item
        ...
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["bookingCustomer%2Did"] = id
    ...
    def staff_members_by_id(self,id: str) -> booking_staff_member_item_request_builder.BookingStaffMemberItemRequestBuilder:
        """
        Provides operations to manage the staffMembers property of the microsoft.graph.bookingBusiness entity.
        Args:
            id: Unique identifier of the item
        ...
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["bookingStaffMember%2Did"] = id
