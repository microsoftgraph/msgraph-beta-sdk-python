...
class BookingServiceItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, booking_service_id: Optional[str] = None) -> None:
        """
        Instantiates a new BookingServiceItemRequestBuilder and sets the default values.
        Args:
            bookingServiceId: key: id of bookingService
        ...
        url_tpl_params["bookingService%2Did"] = bookingServiceId
