...
count_request_builder = lazy_import('msgraph.generated.booking_businesses.item.custom_questions.count.count_request_builder')
booking_custom_question = lazy_import('msgraph.generated.models.booking_custom_question')
booking_custom_question_collection_response = lazy_import('msgraph.generated.models.booking_custom_question_collection_response')
...
class CustomQuestionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/customQuestions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[booking_custom_question.BookingCustomQuestion] = None, request_configuration: Optional[CustomQuestionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
