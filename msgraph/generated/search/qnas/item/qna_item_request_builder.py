...
class QnaItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, qna_id: Optional[str] = None) -> None:
        """
    ...
    async def patch(self,body: Optional[qna.Qna] = None, request_configuration: Optional[QnaItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[qna.Qna]:
        """
