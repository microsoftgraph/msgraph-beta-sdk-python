...
class QnasRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/search/qnas{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[QnasRequestBuilderGetRequestConfiguration] = None) -> Optional[QnaCollectionResponse]:
        """
        Get a list of the qna objects and their properties. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[Qna] = None, request_configuration: Optional[QnasRequestBuilderPostRequestConfiguration] = None) -> Optional[Qna]:
        """
        Create a new qna object. This API is supported in the following national cloud deployments.
    ...
    def to_post_request_information(self,body: Optional[Qna] = None, request_configuration: Optional[QnasRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create a new qna object. This API is supported in the following national cloud deployments.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class QnasRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class QnasRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
