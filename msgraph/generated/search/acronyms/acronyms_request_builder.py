...
acronym_collection_response = lazy_import('msgraph.generated.models.search.acronym_collection_response')
count_request_builder = lazy_import('msgraph.generated.search.acronyms.count.count_request_builder')
...
class AcronymsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AcronymsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[acronym.Acronym] = None, request_configuration: Optional[AcronymsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
