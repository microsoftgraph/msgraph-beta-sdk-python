...
class BookmarkItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, bookmark_id: Optional[str] = None) -> None:
        """
        Instantiates a new BookmarkItemRequestBuilder and sets the default values.
        Args:
            bookmarkId: key: id of bookmark
        ...
        url_tpl_params["bookmark%2Did"] = bookmarkId
