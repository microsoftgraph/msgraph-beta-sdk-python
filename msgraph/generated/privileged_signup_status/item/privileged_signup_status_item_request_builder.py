...
class PrivilegedSignupStatusItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[PrivilegedSignupStatusItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PrivilegedSignupStatusItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[privileged_signup_status.PrivilegedSignupStatus] = None, request_configuration: Optional[PrivilegedSignupStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
