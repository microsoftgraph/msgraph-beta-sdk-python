...
@dataclass
class CompleteSetupPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "tenantSetupInfo": lambda n : setattr(self, 'tenant_setup_info', n.get_object_value(TenantSetupInfo)),
        }
        return fields
