...
can_sign_up_request_builder = lazy_import('msgraph.generated.privileged_signup_status.microsoft_graph_can_sign_up.can_sign_up_request_builder')
complete_setup_request_builder = lazy_import('msgraph.generated.privileged_signup_status.microsoft_graph_complete_setup.complete_setup_request_builder')
is_signed_up_request_builder = lazy_import('msgraph.generated.privileged_signup_status.microsoft_graph_is_signed_up.is_signed_up_request_builder')
sign_up_request_builder = lazy_import('msgraph.generated.privileged_signup_status.microsoft_graph_sign_up.sign_up_request_builder')
...
class PrivilegedSignupStatusRequestBuilder():
    ...
    @property
    def microsoft_graph_can_sign_up(self) -> can_sign_up_request_builder.CanSignUpRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_complete_setup(self) -> complete_setup_request_builder.CompleteSetupRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_is_signed_up(self) -> is_signed_up_request_builder.IsSignedUpRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_sign_up(self) -> sign_up_request_builder.SignUpRequestBuilder:
        """
