...
from . import android_required_password_complexity, android_work_profile_cross_profile_data_sharing_type, android_work_profile_default_app_permission_policy_type, android_work_profile_required_password_type, device_configuration
...
class AndroidWorkProfileGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "work_profile_allow_app_installs_from_unknown_sources": lambda n : setattr(self, 'work_profile_allow_app_installs_from_unknown_sources', n.get_bool_value()),
    ...
    def work_profile_allow_app_installs_from_unknown_sources(self,value: Optional[bool] = None) -> None:
        ...
        Args:
            value: Value to set for the workProfileAllowAppInstallsFromUnknownSources property.
        """
