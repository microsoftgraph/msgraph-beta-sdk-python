...
if TYPE_CHECKING:
    from .identity_governance import rule_based_subject_set
...
class SubjectSet(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SubjectSet:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.identityGovernance.ruleBasedSubjectSet":
                from .identity_governance import rule_based_subject_set

                return rule_based_subject_set.RuleBasedSubjectSet()
        return SubjectSet()
