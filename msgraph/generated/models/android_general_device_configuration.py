...
class AndroidGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    ...
    def date_and_time_block_changes(self,value: Optional[bool] = None) -> None:
        ...
        Args:
            value: Value to set for the dateAndTimeBlockChanges property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "date_and_time_block_changes": lambda n : setattr(self, 'date_and_time_block_changes', n.get_bool_value()),
