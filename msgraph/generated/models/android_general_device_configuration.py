...
if TYPE_CHECKING:
    from . import android_required_password_complexity, android_required_password_type, app_list_item, app_list_type, device_configuration, web_browser_cookie_settings
...
class AndroidGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    def __init__(self,) -> None:
        ...
        self._date_and_time_block_changes: Optional[bool] = None
    ...
    @property
    def date_and_time_block_changes(self,) -> Optional[bool]:
        """
        ...
        Returns: Optional[bool]
        """
        return self._date_and_time_block_changes
    
    @date_and_time_block_changes.setter
    def date_and_time_block_changes(self,value: Optional[bool] = None) -> None:
        """
        ...
        Args:
            value: Value to set for the date_and_time_block_changes property.
        """
        self._date_and_time_block_changes = value
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "dateAndTimeBlockChanges": lambda n : setattr(self, 'date_and_time_block_changes', n.get_bool_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("dateAndTimeBlockChanges", self.date_and_time_block_changes)
