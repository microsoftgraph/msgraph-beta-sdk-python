...
if TYPE_CHECKING:
    from . import android_eap_type, android_work_profile_certificate_profile_base, android_work_profile_trusted_root_certificate, android_work_profile_wi_fi_configuration, non_eap_authentication_method_for_eap_ttls_type, non_eap_authentication_method_for_peap, wi_fi_authentication_method, wi_fi_proxy_setting
...
class AndroidWorkProfileEnterpriseWiFiConfiguration(android_work_profile_wi_fi_configuration.AndroidWorkProfileWiFiConfiguration):
    odata_type = "#microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration"
    ...
    eap_type: Optional[android_eap_type.AndroidEapType] = None
    # Identity Certificate for client authentication when EAP Type is configured to EAP-TLS, EAP-TTLS (with Certificate Authentication), or PEAP (with Certificate Authentication). This is the certificate presented by client to the Wi-Fi endpoint. The authentication server sitting behind the Wi-Fi endpoint must accept this certificate to successfully establish a Wi-Fi connection.
    identity_certificate_for_client_authentication: Optional[android_work_profile_certificate_profile_base.AndroidWorkProfileCertificateProfileBase] = None
    ...
    inner_authentication_protocol_for_peap: Optional[non_eap_authentication_method_for_peap.NonEapAuthenticationMethodForPeap] = None
    ...
    proxy_settings: Optional[wi_fi_proxy_setting.WiFiProxySetting] = None
    ...
    root_certificate_for_server_validation: Optional[android_work_profile_trusted_root_certificate.AndroidWorkProfileTrustedRootCertificate] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "identityCertificateForClientAuthentication": lambda n : setattr(self, 'identity_certificate_for_client_authentication', n.get_object_value(android_work_profile_certificate_profile_base.AndroidWorkProfileCertificateProfileBase)),
            ...
            "rootCertificateForServerValidation": lambda n : setattr(self, 'root_certificate_for_server_validation', n.get_object_value(android_work_profile_trusted_root_certificate.AndroidWorkProfileTrustedRootCertificate)),
