...
from . import integer_range, print_color_mode, print_duplex_mode, print_finishing, print_margin, print_multipage_layout, print_orientation, print_quality, print_scaling, printer_feed_direction, printer_feed_orientation
...
class PrinterDocumentConfiguration(AdditionalDataHolder, Parsable):
    ...
    def __init__(self,) -> None:
        ...
        self._feed_direction: Optional[printer_feed_direction.PrinterFeedDirection] = None
    ...
    @property
    def feed_direction(self,) -> Optional[printer_feed_direction.PrinterFeedDirection]:
        """
        Gets the feedDirection property value. The feedDirection property
        Returns: Optional[printer_feed_direction.PrinterFeedDirection]
        """
        return self._feed_direction
    
    @feed_direction.setter
    def feed_direction(self,value: Optional[printer_feed_direction.PrinterFeedDirection] = None) -> None:
        """
