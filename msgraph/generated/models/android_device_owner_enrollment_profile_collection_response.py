...
class AndroidDeviceOwnerEnrollmentProfileCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        """
        Instantiates a new AndroidDeviceOwnerEnrollmentProfileCollectionResponse and sets the default values.
        """
        super().__init__()
        # The value property
        self._value: Optional[List[android_device_owner_enrollment_profile.AndroidDeviceOwnerEnrollmentProfile]] = None
    ...
    @property
    def value(self,) -> Optional[List[android_device_owner_enrollment_profile.AndroidDeviceOwnerEnrollmentProfile]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[android_device_owner_enrollment_profile.AndroidDeviceOwnerEnrollmentProfile]] = None) -> None:
        """
