...
class DeviceCompliancePolicyState(entity.Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "setting_states": lambda n : setattr(self, 'setting_states', n.get_collection_of_object_values(device_compliance_policy_setting_state.DeviceCompliancePolicySettingState)),
