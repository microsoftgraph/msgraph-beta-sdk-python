...
class AndroidForWorkAppConfigurationSchemaItem(AdditionalDataHolder, Parsable):
    ...
    data_type: Optional[android_for_work_app_configuration_schema_item_data_type.AndroidForWorkAppConfigurationSchemaItemDataType] = None
    ...
    selections: Optional[List[key_value_pair.KeyValuePair]] = None
