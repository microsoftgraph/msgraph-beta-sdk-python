...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, user_experience_analytics_metric_history
...
class UserExperienceAnalyticsMetricHistoryCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[user_experience_analytics_metric_history.UserExperienceAnalyticsMetricHistory]] = None
