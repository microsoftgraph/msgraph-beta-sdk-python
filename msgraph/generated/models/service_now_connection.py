...
class ServiceNowConnection(entity.Entity):
    ...
    authentication_method: Optional[service_now_authentication_method.ServiceNowAuthenticationMethod] = None
    ...
    last_queried_date_time: Optional[datetime] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # Status of ServiceNow Connection
    service_now_connection_status: Optional[service_now_connection_status.ServiceNowConnectionStatus] = None
