...
class WindowsFeatureUpdateProfile(entity.Entity):
    ...
    assignments: Optional[List[windows_feature_update_profile_assignment.WindowsFeatureUpdateProfileAssignment]] = None
    ...
    rollout_settings: Optional[windows_update_rollout_settings.WindowsUpdateRolloutSettings] = None
