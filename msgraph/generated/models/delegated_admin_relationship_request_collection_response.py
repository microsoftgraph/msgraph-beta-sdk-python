...
from . import base_collection_pagination_count_response, delegated_admin_relationship_request

class DelegatedAdminRelationshipRequestCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DelegatedAdminRelationshipRequestCollectionResponse:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(delegated_admin_relationship_request.DelegatedAdminRelationshipRequest)),
        }
