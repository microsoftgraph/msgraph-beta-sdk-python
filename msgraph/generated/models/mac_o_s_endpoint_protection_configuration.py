...
class MacOSEndpointProtectionConfiguration(device_configuration.DeviceConfiguration):
    ...
    advanced_threat_protection_automatic_sample_submission: Optional[enablement.Enablement] = None
    # Possible values of a property
    advanced_threat_protection_cloud_delivered: Optional[enablement.Enablement] = None
    # Possible values of a property
    advanced_threat_protection_diagnostic_data_collection: Optional[enablement.Enablement] = None
    ...
    # Possible values of a property
    advanced_threat_protection_real_time: Optional[enablement.Enablement] = None
    ...
    file_vault_selected_recovery_key_types: Optional[mac_o_s_file_vault_recovery_key_types.MacOSFileVaultRecoveryKeyTypes] = None
    ...
    firewall_applications: Optional[List[mac_o_s_firewall_application.MacOSFirewallApplication]] = None
    ...
    gatekeeper_allowed_app_source: Optional[mac_o_s_gatekeeper_app_sources.MacOSGatekeeperAppSources] = None
