...
class Domain(entity.Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "sharedEmailDomainInvitations": lambda n : setattr(self, 'shared_email_domain_invitations', n.get_collection_of_object_values(shared_email_domain_invitation.SharedEmailDomainInvitation)),
    ...
    def shared_email_domain_invitations(self,value: Optional[List[shared_email_domain_invitation.SharedEmailDomainInvitation]] = None) -> None:
        ...
        Args:
            value: Value to set for the shared_email_domain_invitations property.
        """
