...
class Domain(entity.Entity):
    ...
    def __init__(self,) -> None:
        ...
        self._shared_email_domain_invitations: Optional[List[shared_email_domain_invitation.SharedEmailDomainInvitation]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "shared_email_domain_invitations": lambda n : setattr(self, 'shared_email_domain_invitations', n.get_collection_of_object_values(shared_email_domain_invitation.SharedEmailDomainInvitation)),
    ...
    @property
    def shared_email_domain_invitations(self,) -> Optional[List[shared_email_domain_invitation.SharedEmailDomainInvitation]]:
        """
        Gets the sharedEmailDomainInvitations property value. The sharedEmailDomainInvitations property
        Returns: Optional[List[shared_email_domain_invitation.SharedEmailDomainInvitation]]
        """
        return self._shared_email_domain_invitations
    
    @shared_email_domain_invitations.setter
    def shared_email_domain_invitations(self,value: Optional[List[shared_email_domain_invitation.SharedEmailDomainInvitation]] = None) -> None:
        """
        Sets the sharedEmailDomainInvitations property value. The sharedEmailDomainInvitations property
        Args:
            value: Value to set for the sharedEmailDomainInvitations property.
        """
        self._shared_email_domain_invitations = value
