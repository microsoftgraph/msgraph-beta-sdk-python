...
class ListItemVersionCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[list_item_version.ListItemVersion]] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ListItemVersionCollectionResponse:
        ...
        return ListItemVersionCollectionResponse()
    ...
    @property
    def value(self,) -> Optional[List[list_item_version.ListItemVersion]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[list_item_version.ListItemVersion]] = None) -> None:
        """
