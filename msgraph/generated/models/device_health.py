...
class DeviceHealth(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeviceHealth:
        """
    ...
    @property
    def last_connection_time(self,) -> Optional[datetime]:
        """
    ...
    def last_connection_time(self,value: Optional[datetime] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("lastConnectionTime", self.last_connection_time)
