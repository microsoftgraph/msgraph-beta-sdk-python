...
class GroupPolicyPresentationValueLongDecimal(group_policy_presentation_value.GroupPolicyPresentationValue):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GroupPolicyPresentationValueLongDecimal:
        """
