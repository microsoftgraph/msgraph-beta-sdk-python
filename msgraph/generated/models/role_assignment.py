...
if TYPE_CHECKING:
    from . import device_and_app_management_role_assignment, entity, role_assignment_scope_type, role_definition
...
class RoleAssignment(entity.Entity):
    ...
    # List of ids of role scope member security groups.  These are IDs from Azure Active Directory.
    scope_members: Optional[List[str]] = None
    # Specifies the type of scope for a Role Assignment.
    scope_type: Optional[role_assignment_scope_type.RoleAssignmentScopeType] = None
