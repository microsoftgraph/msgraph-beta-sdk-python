...
class RoleManagement(AdditionalDataHolder, Parsable):
    ...
    cloud_p_c: Optional[rbac_application_multiple.RbacApplicationMultiple] = None
    # The RbacApplication for Device Management
    device_management: Optional[rbac_application_multiple.RbacApplicationMultiple] = None
    # The directory property
    directory: Optional[rbac_application.RbacApplication] = None
    # The enterpriseApps property
    enterprise_apps: Optional[List[rbac_application.RbacApplication]] = None
    # The RbacApplication for Entitlement Management
    entitlement_management: Optional[rbac_application.RbacApplication] = None
    # The exchange property
    exchange: Optional[unified_rbac_application.UnifiedRbacApplication] = None
