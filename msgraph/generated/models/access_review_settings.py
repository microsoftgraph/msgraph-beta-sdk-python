...
class AccessReviewSettings(AdditionalDataHolder, Parsable):
    ...
    auto_review_settings: Optional[auto_review_settings.AutoReviewSettings] = None
    ...
    recurrence_settings: Optional[access_review_recurrence_settings.AccessReviewRecurrenceSettings] = None
