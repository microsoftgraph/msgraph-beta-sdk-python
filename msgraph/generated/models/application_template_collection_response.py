...
from . import application_template, base_collection_pagination_count_response
...
class ApplicationTemplateCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ApplicationTemplateCollectionResponse:
        """
        ...
        return ApplicationTemplateCollectionResponse()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(application_template.ApplicationTemplate)),
        }
