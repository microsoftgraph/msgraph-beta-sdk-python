...
class MacOSGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    ...
    privacy_access_controls: Optional[List[mac_o_s_privacy_access_control_item.MacOSPrivacyAccessControlItem]] = None
    ...
    update_delay_policy: Optional[mac_o_s_software_update_delay_policy.MacOSSoftwareUpdateDelayPolicy] = None
