...
class DeviceManagementSettingDefinition(entity.Entity):
    ...
    dependencies: Optional[List[device_management_setting_dependency.DeviceManagementSettingDependency]] = None
    ...
    value_type: Optional[device_manangement_intent_value_type.DeviceManangementIntentValueType] = None
