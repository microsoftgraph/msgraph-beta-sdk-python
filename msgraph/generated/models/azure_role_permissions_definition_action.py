...
class AzureRolePermissionsDefinitionAction(AzurePermissionsDefinitionAction):
    ...
    OdataType: Optional[str] = "#microsoft.graph.azureRolePermissionsDefinitionAction"
    # The roles property
    roles: Optional[List[PermissionsDefinitionAzureRole]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AzureRolePermissionsDefinitionAction:
        """
