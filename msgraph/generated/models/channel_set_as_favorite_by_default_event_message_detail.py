...
class ChannelSetAsFavoriteByDefaultEventMessageDetail(event_message_detail.EventMessageDetail):
    @property
    ...
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.channelSetAsFavoriteByDefaultEventMessageDetail"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ChannelSetAsFavoriteByDefaultEventMessageDetail:
        """
