...
class MobileAppTroubleshootingEvent(device_management_troubleshooting_event.DeviceManagementTroubleshootingEvent):
    ...
    app_log_collection_requests: Optional[List[app_log_collection_request.AppLogCollectionRequest]] = None
    # Intune application identifier.
    application_id: Optional[str] = None
    # Device identifier created or collected by Intune.
    device_id: Optional[str] = None
    # Intune Mobile Application Troubleshooting History Item
    history: Optional[List[mobile_app_troubleshooting_history_item.MobileAppTroubleshootingHistoryItem]] = None
    # Device identifier created or collected by Intune.
