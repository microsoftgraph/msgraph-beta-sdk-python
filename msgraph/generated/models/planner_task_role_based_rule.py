...
class PlannerTaskRoleBasedRule(AdditionalDataHolder, Parsable):
    ...
    property_rule: Optional[planner_task_property_rule.PlannerTaskPropertyRule] = None
    # The role these rules apply to.
    role: Optional[planner_task_configuration_role_base.PlannerTaskConfigurationRoleBase] = None
