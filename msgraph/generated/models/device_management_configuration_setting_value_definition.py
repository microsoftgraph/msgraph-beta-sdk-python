...
class DeviceManagementConfigurationSettingValueDefinition(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        """
        Instantiates a new deviceManagementConfigurationSettingValueDefinition and sets the default values.
        """
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeviceManagementConfigurationSettingValueDefinition:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.deviceManagementConfigurationIntegerSettingValueDefinition":
            ...
            if mapping_value == "#microsoft.graph.deviceManagementConfigurationStringSettingValueDefinition":
