...
class SubjectRightsRequest(entity.Entity):
    ...
    approvers: Optional[List[user.User]] = None
    ...
    collaborators: Optional[List[user.User]] = None
    ...
    mailboxlocations: Optional[subject_rights_request_mailbox_location.SubjectRightsRequestMailboxLocation] = None
    ...
    sitelocations: Optional[subject_rights_request_site_location.SubjectRightsRequestSiteLocation] = None
