...
class GroupPolicyDefinition(entity.Entity):
    ...
    category: Optional[group_policy_category.GroupPolicyCategory] = None
    # The localized full category path for the policy.
    category_path: Optional[str] = None
    # Group Policy Definition Class Type.
    class_type: Optional[group_policy_definition_class_type.GroupPolicyDefinitionClassType] = None
    # The group policy file associated with the definition.
    definition_file: Optional[group_policy_definition_file.GroupPolicyDefinitionFile] = None
    ...
    presentations: Optional[List[group_policy_presentation.GroupPolicyPresentation]] = None
