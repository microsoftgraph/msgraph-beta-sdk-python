...
class OfficeSuiteApp(mobile_app.MobileApp):
    ...
    excluded_apps: Optional[excluded_apps.ExcludedApps] = None
    # The Enum to specify the level of display for the Installation Progress Setup UI on the Device.
    install_progress_display_level: Optional[office_suite_install_progress_display_level.OfficeSuiteInstallProgressDisplayLevel] = None
    ...
    office_platform_architecture: Optional[windows_architecture.WindowsArchitecture] = None
    # Describes the OfficeSuiteApp file format types that can be selected.
    office_suite_app_default_file_format: Optional[office_suite_default_file_format_type.OfficeSuiteDefaultFileFormatType] = None
    # The Product Ids that represent the Office365 Suite SKU.
    product_ids: Optional[List[office_product_id.OfficeProductId]] = None
    ...
    update_channel: Optional[office_update_channel.OfficeUpdateChannel] = None
