...
class Office365ActiveUserDetail(entity.Entity):
    ...
    exchange_last_activity_date: Optional[date] = None
    # The last date when the user was assigned an Exchange license.
    exchange_license_assign_date: Optional[date] = None
    ...
    one_drive_last_activity_date: Optional[date] = None
    # The last date when the user was assigned a OneDrive license.
    one_drive_license_assign_date: Optional[date] = None
    ...
    teams_last_activity_date: Optional[date] = None
    # The last date when the user was assigned a Teams license.
    teams_license_assign_date: Optional[date] = None
    ...
    yammer_last_activity_date: Optional[date] = None
    # The last date when the user was assigned a Yammer license.
    yammer_license_assign_date: Optional[date] = None
