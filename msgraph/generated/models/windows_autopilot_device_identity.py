...
class WindowsAutopilotDeviceIdentity(entity.Entity):
    ...
    deployment_profile: Optional[windows_autopilot_deployment_profile.WindowsAutopilotDeploymentProfile] = None
    # Profile set time of the Windows autopilot device.
    deployment_profile_assigned_date_time: Optional[datetime] = None
    # The deploymentProfileAssignmentDetailedStatus property
    deployment_profile_assignment_detailed_status: Optional[windows_autopilot_profile_assignment_detailed_status.WindowsAutopilotProfileAssignmentDetailedStatus] = None
    # The deploymentProfileAssignmentStatus property
    deployment_profile_assignment_status: Optional[windows_autopilot_profile_assignment_status.WindowsAutopilotProfileAssignmentStatus] = None
    ...
    intended_deployment_profile: Optional[windows_autopilot_deployment_profile.WindowsAutopilotDeploymentProfile] = None
    ...
    remediation_state: Optional[windows_autopilot_device_remediation_state.WindowsAutopilotDeviceRemediationState] = None
    # RemediationState set time of Autopilot device.
    remediation_state_last_modified_date_time: Optional[datetime] = None
    # Resource Name.
