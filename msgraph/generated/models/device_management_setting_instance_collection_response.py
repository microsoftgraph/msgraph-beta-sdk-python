...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, device_management_setting_instance

from . import base_collection_pagination_count_response

class DeviceManagementSettingInstanceCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        """
        Instantiates a new DeviceManagementSettingInstanceCollectionResponse and sets the default values.
        """
        super().__init__()
        # The value property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeviceManagementSettingInstanceCollectionResponse:
        """
        ...
        return DeviceManagementSettingInstanceCollectionResponse()
