...
class AndroidForWorkCertificateProfileBase(device_configuration.DeviceConfiguration):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "rootCertificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(android_for_work_trusted_root_certificate.AndroidForWorkTrustedRootCertificate)),
