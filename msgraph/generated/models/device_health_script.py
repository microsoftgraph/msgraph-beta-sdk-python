...
if TYPE_CHECKING:
    from . import device_health_script_assignment, device_health_script_device_state, device_health_script_parameter, device_health_script_run_summary, entity, run_as_account_type
...
class DeviceHealthScript(entity.Entity):
    ...
    def detection_script_parameters(self,value: Optional[List[device_health_script_parameter.DeviceHealthScriptParameter]] = None) -> None:
        ...
        Args:
            value: Value to set for the detection_script_parameters property.
        """
    ...
    def highest_available_version(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the highest_available_version property.
        """
    ...
    def is_global_script(self,value: Optional[bool] = None) -> None:
        ...
        Args:
            value: Value to set for the is_global_script property.
        """
    ...
    def remediation_script_content(self,value: Optional[bytes] = None) -> None:
        ...
        Args:
            value: Value to set for the remediation_script_content property.
        """
    ...
    def remediation_script_parameters(self,value: Optional[List[device_health_script_parameter.DeviceHealthScriptParameter]] = None) -> None:
        ...
        Args:
            value: Value to set for the remediation_script_parameters property.
        """
