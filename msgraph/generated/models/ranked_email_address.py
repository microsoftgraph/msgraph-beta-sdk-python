...
class RankedEmailAddress(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> RankedEmailAddress:
        """
    ...
    @rank.setter
    def rank(self,value: Optional[float] = None) -> None:
        """
