...
class VoiceAuthenticationMethodConfiguration(authentication_method_configuration.AuthenticationMethodConfiguration):
    def __init__(self,) -> None:
        ...
        self._include_targets: Optional[List[voice_authentication_method_target.VoiceAuthenticationMethodTarget]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "include_targets": lambda n : setattr(self, 'include_targets', n.get_collection_of_object_values(voice_authentication_method_target.VoiceAuthenticationMethodTarget)),
    ...
    @property
    def include_targets(self,) -> Optional[List[voice_authentication_method_target.VoiceAuthenticationMethodTarget]]:
        """
    ...
    def include_targets(self,value: Optional[List[voice_authentication_method_target.VoiceAuthenticationMethodTarget]] = None) -> None:
        """
    ...
    def is_office_phone_allowed(self,value: Optional[bool] = None) -> None:
        ...
        Args:
            value: Value to set for the isOfficePhoneAllowed property.
        """
