...
class PrivilegeManagementElevation(entity.Entity):
    ...
    elevation_type: Optional[privilege_management_elevation_type.PrivilegeManagementElevationType] = None
    ...
    user_type: Optional[privilege_management_end_user_type.PrivilegeManagementEndUserType] = None
