...
class Calendar(entity.Entity):
    ...
    def calendar_group_id(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the calendarGroupId property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "calendar_group_id": lambda n : setattr(self, 'calendar_group_id', n.get_str_value()),
            ...
            "is_shared_with_me": lambda n : setattr(self, 'is_shared_with_me', n.get_bool_value()),
    ...
    def is_shared_with_me(self,value: Optional[bool] = None) -> None:
        ...
        Args:
            value: Value to set for the isSharedWithMe property.
        """
