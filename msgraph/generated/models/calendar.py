...
class Calendar(entity.Entity):
    ...
    allowed_online_meeting_providers: Optional[List[online_meeting_provider_type.OnlineMeetingProviderType]] = None
    ...
    calendar_permissions: Optional[List[calendar_permission.CalendarPermission]] = None
    ...
    color: Optional[calendar_color.CalendarColor] = None
    # The default online meeting provider for meetings sent from this calendar. Possible values are: unknown, skypeForBusiness, skypeForConsumer, teamsForBusiness.
    default_online_meeting_provider: Optional[online_meeting_provider_type.OnlineMeetingProviderType] = None
    ...
    owner: Optional[email_address.EmailAddress] = None
