...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, property_
...
class PropertyCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        """
        Instantiates a new PropertyCollectionResponse and sets the default values.
        """
        super().__init__()
        # The value property
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> PropertyCollectionResponse:
        ...
        Returns: PropertyCollectionResponse
        """
        if parse_node is None:
            raise Exception("parse_node cannot be undefined")
        return PropertyCollectionResponse()
