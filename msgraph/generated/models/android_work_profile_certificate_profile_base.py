...
if TYPE_CHECKING:
    from . import android_work_profile_pkcs_certificate_profile, android_work_profile_scep_certificate_profile, android_work_profile_trusted_root_certificate, certificate_validity_period_scale, device_configuration, extended_key_usage, subject_alternative_name_type, subject_name_format

from . import device_configuration

@dataclass
class AndroidWorkProfileCertificateProfileBase(device_configuration.DeviceConfiguration):
    odata_type = "#microsoft.graph.androidWorkProfileCertificateProfileBase"
    ...
    root_certificate: Optional[android_work_profile_trusted_root_certificate.AndroidWorkProfileTrustedRootCertificate] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "rootCertificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(android_work_profile_trusted_root_certificate.AndroidWorkProfileTrustedRootCertificate)),
