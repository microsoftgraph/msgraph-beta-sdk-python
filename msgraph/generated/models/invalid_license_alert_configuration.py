...
class InvalidLicenseAlertConfiguration(unified_role_management_alert_configuration.UnifiedRoleManagementAlertConfiguration):
    def __init__(self,) -> None:
        """
        Instantiates a new InvalidLicenseAlertConfiguration and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.invalidLicenseAlertConfiguration"
