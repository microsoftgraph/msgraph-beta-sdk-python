...
case_action = lazy_import('msgraph.generated.models.ediscovery.case_action')
case_operation_status = lazy_import('msgraph.generated.models.ediscovery.case_operation_status')
