...
class TagCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[tag.Tag]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> TagCollectionResponse:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(tag.Tag)),
        }
    ...
    @property
    def value(self,) -> Optional[List[tag.Tag]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[tag.Tag]] = None) -> None:
        """
