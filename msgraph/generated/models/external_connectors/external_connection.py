...
class ExternalConnection(entity.Entity):
    ...
    compliance_settings: Optional[compliance_settings.ComplianceSettings] = None
    ...
    enabled_content_experiences: Optional[content_experience_type.ContentExperienceType] = None
    # The groups property
    ...
    # The quota property
    quota: Optional[connection_quota.ConnectionQuota] = None
    # The schema property
