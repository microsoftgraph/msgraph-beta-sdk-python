...
@dataclass
class PasswordValidationInformation(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "validationResults": lambda n : setattr(self, 'validation_results', n.get_collection_of_object_values(ValidationResult)),
        }
        return fields
