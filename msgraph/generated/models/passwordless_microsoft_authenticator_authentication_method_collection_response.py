...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, passwordless_microsoft_authenticator_authentication_method
...
class PasswordlessMicrosoftAuthenticatorAuthenticationMethodCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[passwordless_microsoft_authenticator_authentication_method.PasswordlessMicrosoftAuthenticatorAuthenticationMethod]] = None
