...
class SingleResourceGcpPermissionsDefinition(PermissionsDefinition):
    ...
    OdataType: Optional[str] = "#microsoft.graph.singleResourceGcpPermissionsDefinition"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SingleResourceGcpPermissionsDefinition:
        """
