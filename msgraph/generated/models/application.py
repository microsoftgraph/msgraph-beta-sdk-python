...
class Application(directory_object.DirectoryObject):
    ...
    authentication_behaviors: Optional[authentication_behaviors.AuthenticationBehaviors] = None
    ...
    connector_group: Optional[connector_group.ConnectorGroup] = None
    ...
    on_premises_publishing: Optional[on_premises_publishing.OnPremisesPublishing] = None
    ...
    service_principal_lock_configuration: Optional[service_principal_lock_configuration.ServicePrincipalLockConfiguration] = None
    ...
    windows: Optional[windows_application.WindowsApplication] = None
