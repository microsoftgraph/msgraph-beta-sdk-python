...
class AndroidFotaDeploymentAssignment(AdditionalDataHolder, Parsable):
    ...
    assignment_target: Optional[device_and_app_management_assignment_target.DeviceAndAppManagementAssignmentTarget] = None
    ...
    target: Optional[android_fota_deployment_assignment_target.AndroidFotaDeploymentAssignmentTarget] = None
