...
class UserExperienceAnalyticsCloudIdentityDevicesSummary(AdditionalDataHolder, Parsable):
    ...
    def __init__(self,) -> None:
        ...
        self._device_without_cloud_identity_count: Optional[int] = None
    ...
    @property
    def device_without_cloud_identity_count(self,) -> Optional[int]:
        """
        Gets the deviceWithoutCloudIdentityCount property value. The count of devices that are not cloud identity.
        Returns: Optional[int]
        """
        return self._device_without_cloud_identity_count
    
    @device_without_cloud_identity_count.setter
    def device_without_cloud_identity_count(self,value: Optional[int] = None) -> None:
        """
