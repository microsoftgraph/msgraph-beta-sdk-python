...
class MobileAppIntentAndStateDetail(AdditionalDataHolder, Parsable):
    ...
    mobile_app_intent: Optional[mobile_app_intent.MobileAppIntent] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The supported platforms for the app.
    supported_device_types: Optional[List[mobile_app_supported_device_type.MobileAppSupportedDeviceType]] = None
