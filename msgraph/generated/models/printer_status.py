...
class PrinterStatus(AdditionalDataHolder, Parsable):
    ...
    processing_state: Optional[printer_processing_state.PrinterProcessingState] = None
    # The processingStateDescription property
    processing_state_description: Optional[str] = None
    # The processingStateReasons property
    processing_state_reasons: Optional[List[printer_processing_state_reason.PrinterProcessingStateReason]] = None
    # The state property
