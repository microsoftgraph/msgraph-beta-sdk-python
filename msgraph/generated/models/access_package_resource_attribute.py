...
class AccessPackageResourceAttribute(AdditionalDataHolder, Parsable):
    ...
    attribute_destination: Optional[access_package_resource_attribute_destination.AccessPackageResourceAttributeDestination] = None
    ...
    attribute_source: Optional[access_package_resource_attribute_source.AccessPackageResourceAttributeSource] = None
