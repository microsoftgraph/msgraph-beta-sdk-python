...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, device_management_resource_access_profile_assignment

from . import base_collection_pagination_count_response

class DeviceManagementResourceAccessProfileAssignmentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
