...
class DeviceManagementAutopilotEvent(entity.Entity):
    ...
    account_setup_duration: Optional[timedelta] = None
    # Deployment states for Autopilot devices
    account_setup_status: Optional[windows_autopilot_deployment_state.WindowsAutopilotDeploymentState] = None
    # Autopilot deployment duration including enrollment.
    deployment_duration: Optional[timedelta] = None
    # Deployment end time.
    deployment_end_date_time: Optional[datetime] = None
    # Deployment start time.
    deployment_start_date_time: Optional[datetime] = None
    # Deployment states for Autopilot devices
    deployment_state: Optional[windows_autopilot_deployment_state.WindowsAutopilotDeploymentState] = None
    # Total deployment duration from enrollment to Desktop screen.
    deployment_total_duration: Optional[timedelta] = None
    # Device id associated with the object
    device_id: Optional[str] = None
    # Time spent in device enrollment.
    device_preparation_duration: Optional[timedelta] = None
    # Device registration date.
    device_registered_date_time: Optional[datetime] = None
    # Device serial number.
    device_serial_number: Optional[str] = None
    # Time spent in device ESP.
    device_setup_duration: Optional[timedelta] = None
    # Deployment states for Autopilot devices
    device_setup_status: Optional[windows_autopilot_deployment_state.WindowsAutopilotDeploymentState] = None
    # Enrollment failure details.
    enrollment_failure_details: Optional[str] = None
    # Device enrollment start date.
    enrollment_start_date_time: Optional[datetime] = None
    # The enrollmentState property
    enrollment_state: Optional[enrollment_state.EnrollmentState] = None
    # The enrollmentType property
    enrollment_type: Optional[windows_autopilot_enrollment_type.WindowsAutopilotEnrollmentType] = None
    ...
    policy_status_details: Optional[List[device_management_autopilot_policy_status_detail.DeviceManagementAutopilotPolicyStatusDetail]] = None
