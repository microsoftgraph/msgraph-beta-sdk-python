...
class SelfServiceSignUpAuthenticationFlowConfiguration(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SelfServiceSignUpAuthenticationFlowConfiguration:
        """
