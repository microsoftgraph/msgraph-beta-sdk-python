...
class MacOSExtensionsConfiguration(device_configuration.DeviceConfiguration):
    ...
    kernel_extensions_allowed: Optional[List[mac_o_s_kernel_extension.MacOSKernelExtension]] = None
    # Gets or sets a list of allowed macOS system extensions. This collection can contain a maximum of 500 elements.
    system_extensions_allowed: Optional[List[mac_o_s_system_extension.MacOSSystemExtension]] = None
    ...
    system_extensions_allowed_types: Optional[List[mac_o_s_system_extension_type_mapping.MacOSSystemExtensionTypeMapping]] = None
