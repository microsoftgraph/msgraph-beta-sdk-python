...
if TYPE_CHECKING:
    from . import authentication_event_listener, on_authentication_method_load_start_handler

from . import authentication_event_listener

class OnAuthenticationMethodLoadStartListener(authentication_event_listener.AuthenticationEventListener):
    def __init__(self,) -> None:
        """
        Instantiates a new OnAuthenticationMethodLoadStartListener and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.onAuthenticationMethodLoadStartListener"
        ...
        self._handler: Optional[on_authentication_method_load_start_handler.OnAuthenticationMethodLoadStartHandler] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> OnAuthenticationMethodLoadStartListener:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "handler": lambda n : setattr(self, 'handler', n.get_object_value(on_authentication_method_load_start_handler.OnAuthenticationMethodLoadStartHandler)),
        }
    ...
    @property
    def handler(self,) -> Optional[on_authentication_method_load_start_handler.OnAuthenticationMethodLoadStartHandler]:
        """
    ...
    @handler.setter
    def handler(self,value: Optional[on_authentication_method_load_start_handler.OnAuthenticationMethodLoadStartHandler] = None) -> None:
        """
