...
class Contact(outlook_item.OutlookItem):
    ...
    email_addresses: Optional[List[typed_email_address.TypedEmailAddress]] = None
    ...
    postal_addresses: Optional[List[physical_address.PhysicalAddress]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "emailAddresses": lambda n : setattr(self, 'email_addresses', n.get_collection_of_object_values(typed_email_address.TypedEmailAddress)),
            ...
            "postalAddresses": lambda n : setattr(self, 'postal_addresses', n.get_collection_of_object_values(physical_address.PhysicalAddress)),
