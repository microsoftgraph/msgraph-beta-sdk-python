...
class EducationSynchronizationCustomizations(education_synchronization_customizations_base.EducationSynchronizationCustomizationsBase):
    ...
    school: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
    # Customizations for Section entities.
    section: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
    # Customizations for Student entities.
    student: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
    # Customizations for Student Enrollments.
    student_enrollment: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
    # Customizations for Teacher entities.
    teacher: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
    # Customizations for Teacher Rosters.
    teacher_roster: Optional[education_synchronization_customization.EducationSynchronizationCustomization] = None
