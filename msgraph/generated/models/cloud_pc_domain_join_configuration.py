...
if TYPE_CHECKING:
    from . import cloud_pc_domain_join_type, cloud_pc_region_group
...
class CloudPcDomainJoinConfiguration(AdditionalDataHolder, Parsable):
    ...
    region_group: Optional[cloud_pc_region_group.CloudPcRegionGroup] = None
    ...
    type: Optional[cloud_pc_domain_join_type.CloudPcDomainJoinType] = None
