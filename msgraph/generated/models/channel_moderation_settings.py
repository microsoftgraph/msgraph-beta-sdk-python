...
class ChannelModerationSettings(AdditionalDataHolder, Parsable):
    ...
    reply_restriction: Optional[reply_restriction.ReplyRestriction] = None
    ...
    user_new_message_restriction: Optional[user_new_message_restriction.UserNewMessageRestriction] = None
