...
class AccessReview(entity.Entity):
    ...
    decisions: Optional[List[access_review_decision.AccessReviewDecision]] = None
    ...
    my_decisions: Optional[List[access_review_decision.AccessReviewDecision]] = None
    ...
    reviewed_entity: Optional[identity.Identity] = None
    ...
    reviewers: Optional[List[access_review_reviewer.AccessReviewReviewer]] = None
    # The settings of an accessReview, see type definition below.
    settings: Optional[access_review_settings.AccessReviewSettings] = None
