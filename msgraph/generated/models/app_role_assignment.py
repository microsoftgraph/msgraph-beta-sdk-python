...
class AppRoleAssignment(entity.Entity):
    """
    ...
    def creation_timestamp(self,value: Optional[datetime] = None) -> None:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "creation_timestamp": lambda n : setattr(self, 'creation_timestamp', n.get_datetime_value()),
