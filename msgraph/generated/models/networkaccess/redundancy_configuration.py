...
if TYPE_CHECKING:
    from . import redundancy_tier

@dataclass
class RedundancyConfiguration(AdditionalDataHolder, Parsable):
    ...
    redundancy_tier: Optional[redundancy_tier.RedundancyTier] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "redundancyTier": lambda n : setattr(self, 'redundancy_tier', n.get_enum_value(redundancy_tier.RedundancyTier)),
