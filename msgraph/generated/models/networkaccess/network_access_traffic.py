...
if TYPE_CHECKING:
    from . import device_category, headers, networking_protocol, traffic_type
...
class NetworkAccessTraffic(AdditionalDataHolder, Parsable):
    ...
    headers: Optional[headers.Headers] = None
    # The networkProtocol property
    network_protocol: Optional[networking_protocol.NetworkingProtocol] = None
    ...
    transport_protocol: Optional[networking_protocol.NetworkingProtocol] = None
    # The userId property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "deviceCategory": lambda n : setattr(self, 'device_category', n.get_enum_value(device_category.DeviceCategory)),
            ...
            "headers": lambda n : setattr(self, 'headers', n.get_object_value(headers.Headers)),
            "networkProtocol": lambda n : setattr(self, 'network_protocol', n.get_enum_value(networking_protocol.NetworkingProtocol)),
            ...
            "transportProtocol": lambda n : setattr(self, 'transport_protocol', n.get_enum_value(networking_protocol.NetworkingProtocol)),
