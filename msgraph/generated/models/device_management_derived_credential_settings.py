...
if TYPE_CHECKING:
    from . import device_management_derived_credential_issuer, device_management_derived_credential_notification_type, entity
...
class DeviceManagementDerivedCredentialSettings(entity.Entity):
    ...
    issuer: Optional[device_management_derived_credential_issuer.DeviceManagementDerivedCredentialIssuer] = None
    # Supported values for the notification type to use.
    notification_type: Optional[device_management_derived_credential_notification_type.DeviceManagementDerivedCredentialNotificationType] = None
