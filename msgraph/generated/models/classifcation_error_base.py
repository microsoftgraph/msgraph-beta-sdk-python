...
from . import classification_inner_error
...
class ClassifcationErrorBase(AdditionalDataHolder, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "inner_error": lambda n : setattr(self, 'inner_error', n.get_object_value(classification_inner_error.ClassificationInnerError)),
