...
if TYPE_CHECKING:
    from . import application_enforced_restrictions_session_control, cloud_app_security_session_control, persistent_browser_session_control, secure_sign_in_session_control, sign_in_frequency_session_control
...
class ConditionalAccessSessionControl(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ConditionalAccessSessionControl:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.secureSignInSessionControl":
                from . import secure_sign_in_session_control

                return secure_sign_in_session_control.SecureSignInSessionControl()
