...
class VerifiableCredentialVerified(verifiable_credential_requirement_status.VerifiableCredentialRequirementStatus):
    def __init__(self,) -> None:
        """
        Instantiates a new VerifiableCredentialVerified and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.verifiableCredentialVerified"
