...
class GroupPolicyUploadedDefinitionFile(group_policy_definition_file.GroupPolicyDefinitionFile):
    ...
    group_policy_operations: Optional[List[group_policy_operation.GroupPolicyOperation]] = None
    ...
    status: Optional[group_policy_uploaded_definition_file_status.GroupPolicyUploadedDefinitionFileStatus] = None
