...
class CatalogEntryCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[catalog_entry.CatalogEntry]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(catalog_entry.CatalogEntry)),
        }
    ...
    @property
    def value(self,) -> Optional[List[catalog_entry.CatalogEntry]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[catalog_entry.CatalogEntry]] = None) -> None:
        """
