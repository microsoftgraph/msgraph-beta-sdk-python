...
class ComplianceChangeRule(AdditionalDataHolder, Parsable):
    ...
    def __init__(self,) -> None:
        ...
        # The lastEvaluatedDateTime property
    ...
    def last_evaluated_date_time(self,) -> Optional[datetime]:
        """
        Gets the lastEvaluatedDateTime property value. The lastEvaluatedDateTime property
        Returns: Optional[datetime]
        """
    ...
    def last_evaluated_date_time(self,value: Optional[datetime] = None) -> None:
        """
        Sets the lastEvaluatedDateTime property value. The lastEvaluatedDateTime property
        Args:
