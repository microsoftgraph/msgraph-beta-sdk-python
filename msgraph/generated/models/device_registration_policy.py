...
class DeviceRegistrationPolicy(entity.Entity):
    ...
    azure_a_d_join: Optional[azure_ad_join_policy.AzureAdJoinPolicy] = None
    ...
    azure_a_d_registration: Optional[azure_a_d_registration_policy.AzureADRegistrationPolicy] = None
    ...
    local_admin_password: Optional[local_admin_password_settings.LocalAdminPasswordSettings] = None
    # The multiFactorAuthConfiguration property
    multi_factor_auth_configuration: Optional[multi_factor_auth_configuration.MultiFactorAuthConfiguration] = None
