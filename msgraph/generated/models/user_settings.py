...
class UserSettings(entity.Entity):
    ...
    contact_merge_suggestions: Optional[contact_merge_suggestions.ContactMergeSuggestions] = None
    ...
    item_insights: Optional[user_insights_settings.UserInsightsSettings] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The user's preferences for languages, regional locale and date/time formatting.
    regional_and_language_settings: Optional[regional_and_language_settings.RegionalAndLanguageSettings] = None
