...
if TYPE_CHECKING:
    from . import authentication_methods_policy_migration_state, authentication_method_configuration, entity, registration_enforcement, report_suspicious_activity_settings, system_credential_preferences
...
class AuthenticationMethodsPolicy(entity.Entity):
    ...
    report_suspicious_activity_settings: Optional[report_suspicious_activity_settings.ReportSuspiciousActivitySettings] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "reportSuspiciousActivitySettings": lambda n : setattr(self, 'report_suspicious_activity_settings', n.get_object_value(report_suspicious_activity_settings.ReportSuspiciousActivitySettings)),
