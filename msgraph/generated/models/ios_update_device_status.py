...
if TYPE_CHECKING:
    from . import compliance_status, entity, ios_updates_install_status
...
class IosUpdateDeviceStatus(entity.Entity):
    ...
    install_status: Optional[ios_updates_install_status.IosUpdatesInstallStatus] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "platform": lambda n : setattr(self, 'platform', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("platform", self.platform)
