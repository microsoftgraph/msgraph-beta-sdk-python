...
class PlannerPlanConfiguration(entity.Entity):
    ...
    buckets: Optional[List[planner_plan_configuration_bucket_definition.PlannerPlanConfigurationBucketDefinition]] = None
    ...
    localizations: Optional[List[planner_plan_configuration_localization.PlannerPlanConfigurationLocalization]] = None
