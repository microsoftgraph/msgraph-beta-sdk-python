...
class AzureADWindowsAutopilotDeploymentProfile(windows_autopilot_deployment_profile.WindowsAutopilotDeploymentProfile):
    def __init__(self,) -> None:
        """
        Instantiates a new AzureADWindowsAutopilotDeploymentProfile and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.azureADWindowsAutopilotDeploymentProfile"
