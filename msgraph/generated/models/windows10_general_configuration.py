...
class Windows10GeneralConfiguration(device_configuration.DeviceConfiguration):
    ...
    activate_apps_with_voice: Optional[enablement.Enablement] = None
    ...
    # Possible values of a property
    authentication_web_sign_in: Optional[enablement.Enablement] = None
    ...
    cellular_data: Optional[configuration_usage.ConfigurationUsage] = None
    ...
    defender_potentially_unwanted_app_action: Optional[defender_potentially_unwanted_app_action.DefenderPotentiallyUnwantedAppAction] = None
    # Possible values of Defender PUA Protection
    defender_potentially_unwanted_app_action_setting: Optional[defender_protection_type.DefenderProtectionType] = None
    ...
    edge_favorites_bar_visibility: Optional[visibility_setting.VisibilitySetting] = None
    ...
    edge_home_button_configuration: Optional[edge_home_button_configuration.EdgeHomeButtonConfiguration] = None
    ...
    edge_kiosk_mode_restriction: Optional[edge_kiosk_mode_restriction_type.EdgeKioskModeRestrictionType] = None
    ...
    edge_opens_with: Optional[edge_open_options.EdgeOpenOptions] = None
    ...
    edge_show_message_when_opening_internet_explorer_sites: Optional[internet_explorer_message_setting.InternetExplorerMessageSetting] = None
    ...
    edge_telemetry_for_microsoft365_analytics: Optional[edge_telemetry_mode.EdgeTelemetryMode] = None
    ...
    experience_do_not_sync_browser_settings: Optional[browser_sync_setting.BrowserSyncSetting] = None
    # Possible values of a property
    find_my_files: Optional[enablement.Enablement] = None
    # Indicates whether or not to block DVR and broadcasting.
    game_dvr_blocked: Optional[bool] = None
    # Values for the InkWorkspaceAccess setting.
    ink_workspace_access: Optional[ink_access_setting.InkAccessSetting] = None
    # State Management Setting.
    ink_workspace_access_state: Optional[state_management_setting.StateManagementSetting] = None
    ...
    # Possible values of a property
    lock_screen_activate_apps_with_voice: Optional[enablement.Enablement] = None
    ...
    microsoft_account_sign_in_assistant_settings: Optional[sign_in_assistant_options.SignInAssistantOptions] = None
    ...
    # Power action types
    power_button_action_on_battery: Optional[power_action_type.PowerActionType] = None
    # Power action types
    power_button_action_plugged_in: Optional[power_action_type.PowerActionType] = None
    # Possible values of a property
    power_hybrid_sleep_on_battery: Optional[enablement.Enablement] = None
    # Possible values of a property
    power_hybrid_sleep_plugged_in: Optional[enablement.Enablement] = None
    # Power action types
    power_lid_close_action_on_battery: Optional[power_action_type.PowerActionType] = None
    # Power action types
    power_lid_close_action_plugged_in: Optional[power_action_type.PowerActionType] = None
    # Power action types
    power_sleep_button_action_on_battery: Optional[power_action_type.PowerActionType] = None
    # Power action types
    power_sleep_button_action_plugged_in: Optional[power_action_type.PowerActionType] = None
    ...
    privacy_access_controls: Optional[List[windows_privacy_data_access_control_item.WindowsPrivacyDataAccessControlItem]] = None
    # State Management Setting.
    ...
    smart_screen_app_install_control: Optional[app_install_control_type.AppInstallControlType] = None
    ...
    windows10_apps_force_update_schedule: Optional[windows10_apps_force_update_schedule.Windows10AppsForceUpdateSchedule] = None
