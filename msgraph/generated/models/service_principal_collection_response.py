...
from . import base_collection_pagination_count_response, service_principal
...
class ServicePrincipalCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[service_principal.ServicePrincipal]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ServicePrincipalCollectionResponse:
        """
    ...
    @property
    def value(self,) -> Optional[List[service_principal.ServicePrincipal]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[service_principal.ServicePrincipal]] = None) -> None:
        """
