...
too_many_global_admins_assigned_to_tenant_alert_configuration = lazy_import('msgraph.generated.models.too_many_global_admins_assigned_to_tenant_alert_configuration')
