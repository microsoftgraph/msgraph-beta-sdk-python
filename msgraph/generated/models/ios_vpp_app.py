...
class IosVppApp(mobile_app.MobileApp):
    ...
    assigned_licenses: Optional[List[ios_vpp_app_assigned_license.IosVppAppAssignedLicense]] = None
    # The Identity Name.
    ...
    revoke_license_action_results: Optional[List[ios_vpp_app_revoke_licenses_action_result.IosVppAppRevokeLicensesActionResult]] = None
