...
class IosVppApp(MobileApp):
    ...
    assigned_licenses: Optional[List[IosVppAppAssignedLicense]] = None
    # The Identity Name.
    ...
    revoke_license_action_results: Optional[List[IosVppAppRevokeLicensesActionResult]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "revokeLicenseActionResults": lambda n : setattr(self, 'revoke_license_action_results', n.get_collection_of_object_values(IosVppAppRevokeLicensesActionResult)),
