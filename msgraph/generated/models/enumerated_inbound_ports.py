...
class EnumeratedInboundPorts(InboundPorts):
    ...
    OdataType: Optional[str] = "#microsoft.graph.enumeratedInboundPorts"
    # The ports property
    ports: Optional[List[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EnumeratedInboundPorts:
        """
