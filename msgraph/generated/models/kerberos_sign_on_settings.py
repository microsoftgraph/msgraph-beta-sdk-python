...
if TYPE_CHECKING:
    from . import kerberos_sign_on_mapping_attribute_type
...
class KerberosSignOnSettings(AdditionalDataHolder, Parsable):
    ...
    kerberos_sign_on_mapping_attribute_type: Optional[kerberos_sign_on_mapping_attribute_type.KerberosSignOnMappingAttributeType] = None
