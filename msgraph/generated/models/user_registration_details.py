...
if TYPE_CHECKING:
    from . import default_mfa_method_type, entity, sign_in_user_type, user_default_authentication_method
...
class UserRegistrationDetails(entity.Entity):
    ...
    user_preferred_method_for_secondary_authentication: Optional[user_default_authentication_method.UserDefaultAuthenticationMethod] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "userPreferredMethodForSecondaryAuthentication": lambda n : setattr(self, 'user_preferred_method_for_secondary_authentication', n.get_enum_value(user_default_authentication_method.UserDefaultAuthenticationMethod)),
