...
class SharedPCConfiguration(device_configuration.DeviceConfiguration):
    ...
    fast_first_sign_in: Optional[enablement.Enablement] = None
    ...
    # Possible values of a property
    local_storage: Optional[enablement.Enablement] = None
    # Specifies the daily start time of maintenance hour.
    maintenance_start_time: Optional[time] = None
    # Possible values of a property
    set_account_manager: Optional[enablement.Enablement] = None
    # Possible values of a property
    set_edu_policies: Optional[enablement.Enablement] = None
    # Possible values of a property
    set_power_policies: Optional[enablement.Enablement] = None
    # Possible values of a property
    sign_in_on_resume: Optional[enablement.Enablement] = None
