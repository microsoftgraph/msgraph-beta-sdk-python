...
class IntuneBrandingProfile(entity.Entity):
    ...
    assignments: Optional[List[intune_branding_profile_assignment.IntuneBrandingProfileAssignment]] = None
    ...
    theme_color_logo: Optional[mime_content.MimeContent] = None
