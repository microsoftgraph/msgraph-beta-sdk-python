...
class AuthenticationAttributeCollectionPage(AdditionalDataHolder, Parsable):
    ...
    custom_strings_file_id: Optional[str] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # A collection of displays of the attribute collection page.
    views: Optional[List[authentication_attribute_collection_page_view_configuration.AuthenticationAttributeCollectionPageViewConfiguration]] = None
