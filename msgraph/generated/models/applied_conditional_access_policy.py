...
class AppliedConditionalAccessPolicy(AdditionalDataHolder, Parsable):
    ...
    authentication_strength: Optional[authentication_strength.AuthenticationStrength] = None
    ...
    conditions_not_satisfied: Optional[List[conditional_access_conditions.ConditionalAccessConditions]] = None
    ...
    conditions_satisfied: Optional[List[conditional_access_conditions.ConditionalAccessConditions]] = None
    ...
    exclude_rules_satisfied: Optional[List[conditional_access_rule_satisfied.ConditionalAccessRuleSatisfied]] = None
    ...
    include_rules_satisfied: Optional[List[conditional_access_rule_satisfied.ConditionalAccessRuleSatisfied]] = None
