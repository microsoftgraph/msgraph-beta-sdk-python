...
from . import android_device_owner_trusted_root_certificate, certificate_validity_period_scale, device_configuration, extended_key_usage, subject_alternative_name_type, subject_name_format
...
class AndroidDeviceOwnerCertificateProfileBase(device_configuration.DeviceConfiguration):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "root_certificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(android_device_owner_trusted_root_certificate.AndroidDeviceOwnerTrustedRootCertificate)),
