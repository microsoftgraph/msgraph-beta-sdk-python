...
class DeviceGeoLocation(AdditionalDataHolder, Parsable):
    ...
    def __init__(self,) -> None:
        ...
        # Time at which location was recorded, relative to UTC
        self._last_collected_date_time_utc: Optional[datetime] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "last_collected_date_time_utc": lambda n : setattr(self, 'last_collected_date_time_utc', n.get_datetime_value()),
    ...
    @property
    def last_collected_date_time_utc(self,) -> Optional[datetime]:
        """
        Gets the lastCollectedDateTimeUtc property value. Time at which location was recorded, relative to UTC
        Returns: Optional[datetime]
        """
        return self._last_collected_date_time_utc
    
    @last_collected_date_time_utc.setter
    def last_collected_date_time_utc(self,value: Optional[datetime] = None) -> None:
        """
        Sets the lastCollectedDateTimeUtc property value. Time at which location was recorded, relative to UTC
        Args:
            value: Value to set for the lastCollectedDateTimeUtc property.
        """
        self._last_collected_date_time_utc = value
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("lastCollectedDateTimeUtc", self.last_collected_date_time_utc)
