...
class ShareAction(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        ...
        self._recipients: Optional[List[identity_set.IdentitySet]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "recipients": lambda n : setattr(self, 'recipients', n.get_collection_of_object_values(identity_set.IdentitySet)),
        }
        return fields
    ...
    @property
    def recipients(self,) -> Optional[List[identity_set.IdentitySet]]:
        """
    ...
    @recipients.setter
    def recipients(self,value: Optional[List[identity_set.IdentitySet]] = None) -> None:
        """
