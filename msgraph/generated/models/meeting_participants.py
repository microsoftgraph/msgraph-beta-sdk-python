...
class MeetingParticipants(AdditionalDataHolder, Parsable):
    ...
    contributors: Optional[List[meeting_participant_info.MeetingParticipantInfo]] = None
    ...
    producers: Optional[List[meeting_participant_info.MeetingParticipantInfo]] = None
