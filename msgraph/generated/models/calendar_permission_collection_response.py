...
class CalendarPermissionCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[calendar_permission.CalendarPermission]] = None
    ...
    @property
    def value(self,) -> Optional[List[calendar_permission.CalendarPermission]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[calendar_permission.CalendarPermission]] = None) -> None:
        """
