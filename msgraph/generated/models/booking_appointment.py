...
class BookingAppointment(entity.Entity):
    ...
    customer_location: Optional[location.Location] = None
    # The customer's name.
    ...
    invoice_date: Optional[date_time_time_zone.DateTimeTimeZone] = None
    # The ID of the invoice.
    invoice_id: Optional[str] = None
    # The invoiceStatus property
    invoice_status: Optional[booking_invoice_status.BookingInvoiceStatus] = None
