...
class VerificationResult(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> VerificationResult:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("signatureValid", self.signature_valid)
        writer.write_additional_data_value(self.additional_data)
    
    @property
    def signature_valid(self,) -> Optional[bool]:
        """
        Gets the signatureValid property value. The signatureValid property
        Returns: Optional[bool]
        """
        return self._signature_valid
    
    @signature_valid.setter
    def signature_valid(self,value: Optional[bool] = None) -> None:
        """
