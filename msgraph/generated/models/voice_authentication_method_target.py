...
class VoiceAuthenticationMethodTarget(authentication_method_target.AuthenticationMethodTarget):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> VoiceAuthenticationMethodTarget:
        """
