...
if TYPE_CHECKING:
    from . import device_configuration, secure_assessment_account_type
...
class Windows10SecureAssessmentConfiguration(device_configuration.DeviceConfiguration):
    ...
    configuration_account_type: Optional[secure_assessment_account_type.SecureAssessmentAccountType] = None
