...
@dataclass
class ConfigurationManagerAction(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    action: Optional[ConfigurationManagerActionType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "action": lambda n : setattr(self, 'action', n.get_enum_value(ConfigurationManagerActionType)),
