...
class MacOSDeviceFeaturesConfiguration(apple_device_features_configuration_base.AppleDeviceFeaturesConfigurationBase):
    ...
    app_associated_domains: Optional[List[mac_o_s_associated_domains_item.MacOSAssociatedDomainsItem]] = None
    ...
    associated_domains: Optional[List[key_value_pair.KeyValuePair]] = None
    ...
    auto_launch_items: Optional[List[mac_o_s_launch_item.MacOSLaunchItem]] = None
    ...
    content_caching_client_listen_ranges: Optional[List[ip_range.IpRange]] = None
    # Determines which clients a content cache will serve.
    content_caching_client_policy: Optional[mac_o_s_content_caching_client_policy.MacOSContentCachingClientPolicy] = None
    ...
    content_caching_parent_selection_policy: Optional[mac_o_s_content_caching_parent_selection_policy.MacOSContentCachingParentSelectionPolicy] = None
    ...
    content_caching_peer_filter_ranges: Optional[List[ip_range.IpRange]] = None
    ...
    content_caching_peer_listen_ranges: Optional[List[ip_range.IpRange]] = None
    # Determines which content caches other content caches will peer with.
    content_caching_peer_policy: Optional[mac_o_s_content_caching_peer_policy.MacOSContentCachingPeerPolicy] = None
    ...
    content_caching_public_ranges: Optional[List[ip_range.IpRange]] = None
    ...
    content_caching_type: Optional[mac_o_s_content_caching_type.MacOSContentCachingType] = None
    ...
    mac_o_s_single_sign_on_extension: Optional[mac_o_s_single_sign_on_extension.MacOSSingleSignOnExtension] = None
    ...
    single_sign_on_extension_pkinit_certificate: Optional[mac_o_s_certificate_profile_base.MacOSCertificateProfileBase] = None
