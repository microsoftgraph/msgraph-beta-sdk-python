...
class BitLockerRecoveryOptions(AdditionalDataHolder, Parsable):
    ...
    recovery_information_to_store: Optional[bit_locker_recovery_information_type.BitLockerRecoveryInformationType] = None
    # Possible values of the ConfigurationUsage list.
    recovery_key_usage: Optional[configuration_usage.ConfigurationUsage] = None
    # Possible values of the ConfigurationUsage list.
    recovery_password_usage: Optional[configuration_usage.ConfigurationUsage] = None
