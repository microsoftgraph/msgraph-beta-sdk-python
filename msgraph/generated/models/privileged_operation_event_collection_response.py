...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, privileged_operation_event
...
class PrivilegedOperationEventCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[privileged_operation_event.PrivilegedOperationEvent]] = None
