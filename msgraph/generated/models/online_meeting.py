...
if TYPE_CHECKING:
    ...
    from .virtual_appointment import VirtualAppointment
...
class OnlineMeeting(Entity):
    ...
    virtual_appointment: Optional[VirtualAppointment] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "virtualAppointment": lambda n : setattr(self, 'virtual_appointment', n.get_object_value(VirtualAppointment)),
