...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, restricted_apps_violation
...
class RestrictedAppsViolationCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[restricted_apps_violation.RestrictedAppsViolation]] = None
