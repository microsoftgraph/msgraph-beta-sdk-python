...
if TYPE_CHECKING:
    from . import access_review_error, access_review_instance_decision_item, access_review_reviewer, access_review_reviewer_scope, access_review_schedule_definition, access_review_scope, access_review_stage, entity
...
class AccessReviewInstance(entity.Entity):
    def __init__(self,) -> None:
        ...
        self._definition: Optional[access_review_schedule_definition.AccessReviewScheduleDefinition] = None
        ...
        self._errors: Optional[List[access_review_error.AccessReviewError]] = None
    ...
    @property
    def definition(self,) -> Optional[access_review_schedule_definition.AccessReviewScheduleDefinition]:
        """
    ...
    @definition.setter
    def definition(self,value: Optional[access_review_schedule_definition.AccessReviewScheduleDefinition] = None) -> None:
        """
    ...
    @property
    def errors(self,) -> Optional[List[access_review_error.AccessReviewError]]:
        """
        Gets the errors property value. Collection of errors in an access review instance lifecycle. Read-only.
        Returns: Optional[List[access_review_error.AccessReviewError]]
        """
        return self._errors
    
    @errors.setter
    def errors(self,value: Optional[List[access_review_error.AccessReviewError]] = None) -> None:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "definition": lambda n : setattr(self, 'definition', n.get_object_value(access_review_schedule_definition.AccessReviewScheduleDefinition)),
            "endDateTime": lambda n : setattr(self, 'end_date_time', n.get_datetime_value()),
            "errors": lambda n : setattr(self, 'errors', n.get_collection_of_object_values(access_review_error.AccessReviewError)),
