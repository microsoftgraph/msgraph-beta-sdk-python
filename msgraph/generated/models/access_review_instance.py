...
class AccessReviewInstance(entity.Entity):
    ...
    definition: Optional[access_review_schedule_definition.AccessReviewScheduleDefinition] = None
    ...
    errors: Optional[List[access_review_error.AccessReviewError]] = None
