...
class OnPremisesPublishing(AdditionalDataHolder, Parsable):
    ...
    external_authentication_type: Optional[external_authentication_type.ExternalAuthenticationType] = None
    ...
    on_premises_application_segments: Optional[List[on_premises_application_segment.OnPremisesApplicationSegment]] = None
    ...
    segments_configuration: Optional[segment_configuration.SegmentConfiguration] = None
    # Represents the single sign-on configuration for the on-premises application.
    single_sign_on_settings: Optional[on_premises_publishing_single_sign_on.OnPremisesPublishingSingleSignOn] = None
    ...
    verified_custom_domain_certificates_metadata: Optional[verified_custom_domain_certificates_metadata.VerifiedCustomDomainCertificatesMetadata] = None
    # The associated key credential for the custom domain used.
    verified_custom_domain_key_credential: Optional[key_credential.KeyCredential] = None
    # The associated password credential for the custom domain used.
    verified_custom_domain_password_credential: Optional[password_credential.PasswordCredential] = None
