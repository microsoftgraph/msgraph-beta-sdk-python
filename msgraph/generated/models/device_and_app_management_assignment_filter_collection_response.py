...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, device_and_app_management_assignment_filter
...
class DeviceAndAppManagementAssignmentFilterCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[device_and_app_management_assignment_filter.DeviceAndAppManagementAssignmentFilter]] = None
