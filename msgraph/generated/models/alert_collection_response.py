...
from . import alert, base_collection_pagination_count_response

class AlertCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AlertCollectionResponse:
        ...
        return AlertCollectionResponse()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(alert.Alert)),
        }
