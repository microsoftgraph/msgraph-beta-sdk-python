...
class DepEnrollmentProfile(enrollment_profile.EnrollmentProfile):
    ...
    i_tunes_pairing_mode: Optional[i_tunes_pairing_mode.ITunesPairingMode] = None
    ...
    management_certificates: Optional[List[management_certificate_with_thumbprint.ManagementCertificateWithThumbprint]] = None
