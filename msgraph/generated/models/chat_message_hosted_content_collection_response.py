...
from . import base_collection_pagination_count_response, chat_message_hosted_content
...
class ChatMessageHostedContentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(chat_message_hosted_content.ChatMessageHostedContent)),
        }
