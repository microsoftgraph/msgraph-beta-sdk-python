...
class DeviceManagementAutopilotPolicyStatusDetail(entity.Entity):
    ...
    compliance_status: Optional[device_management_autopilot_policy_compliance_status.DeviceManagementAutopilotPolicyComplianceStatus] = None
    ...
    policy_type: Optional[device_management_autopilot_policy_type.DeviceManagementAutopilotPolicyType] = None
