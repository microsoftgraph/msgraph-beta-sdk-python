...
class Windows10VpnConfiguration(windows_vpn_configuration.WindowsVpnConfiguration):
    ...
    associated_apps: Optional[List[windows10_associated_apps.Windows10AssociatedApps]] = None
    # Windows 10 VPN connection types.
    authentication_method: Optional[windows10_vpn_authentication_method.Windows10VpnAuthenticationMethod] = None
    # VPN connection types.
    connection_type: Optional[windows10_vpn_connection_type.Windows10VpnConnectionType] = None
    # Cryptography Suite security settings for IKEv2 VPN in Windows10 and above
    cryptography_suite: Optional[cryptography_suite.CryptographySuite] = None
    # DNS rules. This collection can contain a maximum of 1000 elements.
    dns_rules: Optional[List[vpn_dns_rule.VpnDnsRule]] = None
    ...
    identity_certificate: Optional[windows_certificate_profile_base.WindowsCertificateProfileBase] = None
    ...
    profile_target: Optional[windows10_vpn_profile_target.Windows10VpnProfileTarget] = None
    # Proxy Server.
    proxy_server: Optional[windows10_vpn_proxy_server.Windows10VpnProxyServer] = None
    ...
    routes: Optional[List[vpn_route.VpnRoute]] = None
    # Single sign-on Extended Key Usage (EKU).
    single_sign_on_eku: Optional[extended_key_usage.ExtendedKeyUsage] = None
    ...
    traffic_rules: Optional[List[vpn_traffic_rule.VpnTrafficRule]] = None
