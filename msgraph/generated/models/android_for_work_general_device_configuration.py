...
class AndroidForWorkGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    odata_type = "#microsoft.graph.androidForWorkGeneralDeviceConfiguration"
    ...
    password_required_type: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType] = None
    ...
    required_password_complexity: Optional[android_required_password_complexity.AndroidRequiredPasswordComplexity] = None
    ...
    work_profile_account_use: Optional[android_work_profile_account_use.AndroidWorkProfileAccountUse] = None
    ...
    work_profile_data_sharing_type: Optional[android_for_work_cross_profile_data_sharing_type.AndroidForWorkCrossProfileDataSharingType] = None
    # Android For Work default app permission policy type.
    work_profile_default_app_permission_policy: Optional[android_for_work_default_app_permission_policy_type.AndroidForWorkDefaultAppPermissionPolicyType] = None
    ...
    # Android For Work required password type.
    work_profile_password_required_type: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType] = None
    ...
    # The password complexity types that can be set on Android. One of: NONE, LOW, MEDIUM, HIGH. This is an API targeted to Android 11+.
    work_profile_required_password_complexity: Optional[android_required_password_complexity.AndroidRequiredPasswordComplexity] = None
