...
class AndroidForWorkGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    def __init__(self,) -> None:
        ...
        self._password_required_type: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType] = None
        ...
        self._work_profile_data_sharing_type: Optional[android_for_work_cross_profile_data_sharing_type.AndroidForWorkCrossProfileDataSharingType] = None
        # Android For Work default app permission policy type.
        self._work_profile_default_app_permission_policy: Optional[android_for_work_default_app_permission_policy_type.AndroidForWorkDefaultAppPermissionPolicyType] = None
    ...
    @property
    def password_required_type(self,) -> Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType]:
        """
        Gets the passwordRequiredType property value. Android For Work required password type.
        Returns: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType]
        """
        return self._password_required_type
    
    @password_required_type.setter
    def password_required_type(self,value: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType] = None) -> None:
        """
    ...
    @property
    def work_profile_data_sharing_type(self,) -> Optional[android_for_work_cross_profile_data_sharing_type.AndroidForWorkCrossProfileDataSharingType]:
        """
        Gets the workProfileDataSharingType property value. Android For Work cross profile data sharing type.
        Returns: Optional[android_for_work_cross_profile_data_sharing_type.AndroidForWorkCrossProfileDataSharingType]
        """
        return self._work_profile_data_sharing_type
    
    @work_profile_data_sharing_type.setter
    def work_profile_data_sharing_type(self,value: Optional[android_for_work_cross_profile_data_sharing_type.AndroidForWorkCrossProfileDataSharingType] = None) -> None:
        """
    ...
    @property
    def work_profile_default_app_permission_policy(self,) -> Optional[android_for_work_default_app_permission_policy_type.AndroidForWorkDefaultAppPermissionPolicyType]:
        """
        Gets the workProfileDefaultAppPermissionPolicy property value. Android For Work default app permission policy type.
        Returns: Optional[android_for_work_default_app_permission_policy_type.AndroidForWorkDefaultAppPermissionPolicyType]
        """
        return self._work_profile_default_app_permission_policy
    
    @work_profile_default_app_permission_policy.setter
    def work_profile_default_app_permission_policy(self,value: Optional[android_for_work_default_app_permission_policy_type.AndroidForWorkDefaultAppPermissionPolicyType] = None) -> None:
        """
    ...
    @property
    def work_profile_password_required_type(self,) -> Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType]:
        """
    ...
    def work_profile_password_required_type(self,value: Optional[android_for_work_required_password_type.AndroidForWorkRequiredPasswordType] = None) -> None:
        """
