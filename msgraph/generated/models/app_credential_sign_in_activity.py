...
if TYPE_CHECKING:
    from . import application_key_origin, application_key_type, application_key_usage, entity, sign_in_activity

from . import entity

@dataclass
class AppCredentialSignInActivity(entity.Entity):
    ...
    credential_origin: Optional[application_key_origin.ApplicationKeyOrigin] = None
    ...
    key_type: Optional[application_key_type.ApplicationKeyType] = None
    # Specifies what the key was used for. The possible values are: sign, verify, unknownFutureValue.
    key_usage: Optional[application_key_usage.ApplicationKeyUsage] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AppCredentialSignInActivity:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "credentialOrigin": lambda n : setattr(self, 'credential_origin', n.get_enum_value(application_key_origin.ApplicationKeyOrigin)),
            "expirationDateTime": lambda n : setattr(self, 'expiration_date_time', n.get_datetime_value()),
            "keyId": lambda n : setattr(self, 'key_id', n.get_str_value()),
            "keyType": lambda n : setattr(self, 'key_type', n.get_enum_value(application_key_type.ApplicationKeyType)),
            "keyUsage": lambda n : setattr(self, 'key_usage', n.get_enum_value(application_key_usage.ApplicationKeyUsage)),
