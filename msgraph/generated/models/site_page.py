...
class SitePage(base_item.BaseItem):
    ...
    canvas_layout: Optional[canvas_layout.CanvasLayout] = None
    ...
    page_layout: Optional[page_layout_type.PageLayoutType] = None
    # Indicates the promotion kind of the sitePage. The possible values are: microsoftReserved, page, newsPost, unknownFutureValue.
    promotion_kind: Optional[page_promotion_type.PagePromotionType] = None
    # The publishing status and the MM.mm version of the page.
    publishing_state: Optional[publication_facet.PublicationFacet] = None
    # Reactions information for the page.
    reactions: Optional[reactions_facet.ReactionsFacet] = None
    ...
    title_area: Optional[title_area.TitleArea] = None
    # Collection of webparts on the SharePoint page
    web_parts: Optional[List[web_part.WebPart]] = None
