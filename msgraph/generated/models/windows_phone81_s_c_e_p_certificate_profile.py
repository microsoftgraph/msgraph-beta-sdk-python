...
class WindowsPhone81SCEPCertificateProfile(windows_phone81_certificate_profile_base.WindowsPhone81CertificateProfileBase):
    ...
    root_certificate: Optional[windows_phone81_trusted_root_certificate.WindowsPhone81TrustedRootCertificate] = None
    # SCEP Server Url(s).
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "rootCertificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(windows_phone81_trusted_root_certificate.WindowsPhone81TrustedRootCertificate)),
