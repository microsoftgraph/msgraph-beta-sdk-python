...
class WindowsAutopilotDeploymentProfilePolicySetItem(policy_set_item.PolicySetItem):
    def __init__(self,) -> None:
        """
        Instantiates a new WindowsAutopilotDeploymentProfilePolicySetItem and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.windowsAutopilotDeploymentProfilePolicySetItem"
