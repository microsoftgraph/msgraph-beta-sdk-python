...
class HardwareInformation(AdditionalDataHolder, Parsable):
    ...
    device_guard_local_system_authority_credential_guard_state: Optional[device_guard_local_system_authority_credential_guard_state.DeviceGuardLocalSystemAuthorityCredentialGuardState] = None
    # The deviceGuardVirtualizationBasedSecurityHardwareRequirementState property
    device_guard_virtualization_based_security_hardware_requirement_state: Optional[device_guard_virtualization_based_security_hardware_requirement_state.DeviceGuardVirtualizationBasedSecurityHardwareRequirementState] = None
    # The deviceGuardVirtualizationBasedSecurityState property
    device_guard_virtualization_based_security_state: Optional[device_guard_virtualization_based_security_state.DeviceGuardVirtualizationBasedSecurityState] = None
    ...
    device_licensing_status: Optional[device_licensing_status.DeviceLicensingStatus] = None
    # eSIM identifier
    ...
    shared_device_cached_users: Optional[List[shared_apple_device_user.SharedAppleDeviceUser]] = None
    # SubnetAddress
