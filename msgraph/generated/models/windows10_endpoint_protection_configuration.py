...
class Windows10EndpointProtectionConfiguration(device_configuration.DeviceConfiguration):
    ...
    application_guard_enabled_options: Optional[application_guard_enabled_options.ApplicationGuardEnabledOptions] = None
    ...
    bit_locker_fixed_drive_policy: Optional[bit_locker_fixed_drive_policy.BitLockerFixedDrivePolicy] = None
    # BitLocker recovery password rotation type
    bit_locker_recovery_password_rotation: Optional[bit_locker_recovery_password_rotation_type.BitLockerRecoveryPasswordRotationType] = None
    ...
    bit_locker_system_drive_policy: Optional[bit_locker_system_drive_policy.BitLockerSystemDrivePolicy] = None
    # List of folder paths to be added to the list of protected folders
    defender_additional_guarded_folders: Optional[List[str]] = None
    # Possible values of Defender PUA Protection
    defender_adobe_reader_launch_child_process: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender PUA Protection
    defender_advanced_ransomeware_protection_type: Optional[defender_protection_type.DefenderProtectionType] = None
    ...
    defender_block_persistence_through_wmi_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    ...
    # Possible values of Defender PUA Protection
    defender_email_content_execution: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_email_content_execution_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    ...
    defender_guard_my_folders_type: Optional[folder_protection_type.FolderProtectionType] = None
    # List of paths to exe that are allowed to access protected folders
    defender_guarded_folders_allowed_app_paths: Optional[List[str]] = None
    # Possible values of Defender PUA Protection
    defender_network_protection_type: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender PUA Protection
    defender_office_apps_executable_content_creation_or_launch: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_office_apps_executable_content_creation_or_launch_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Possible values of Defender PUA Protection
    defender_office_apps_launch_child_process: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_office_apps_launch_child_process_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Possible values of Defender PUA Protection
    defender_office_apps_other_process_injection: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_office_apps_other_process_injection_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Possible values of Defender PUA Protection
    defender_office_communication_apps_launch_child_process: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender PUA Protection
    defender_office_macro_code_allow_win32_imports: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_office_macro_code_allow_win32_imports_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Added in Windows 10, version 1607. Specifies the level of detection for potentially unwanted applications (PUAs). Windows Defender alerts you when potentially unwanted software is being downloaded or attempts to install itself on your computer. Possible values are: userDefined, enable, auditMode, warn, notConfigured.
    defender_potentially_unwanted_app_action: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender PUA Protection
    defender_prevent_credential_stealing_type: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender PUA Protection
    defender_process_creation: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_process_creation_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    ...
    defender_scan_direction: Optional[defender_realtime_scan_direction.DefenderRealtimeScanDirection] = None
    ...
    defender_scheduled_scan_day: Optional[weekly_schedule.WeeklySchedule] = None
    # Selects the time of day that the Windows Defender scan should run.
    defender_scheduled_scan_time: Optional[time] = None
    # Possible values of Defender PUA Protection
    defender_script_downloaded_payload_execution: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_script_downloaded_payload_execution_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Possible values of Defender PUA Protection
    defender_script_obfuscated_macro_code: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_script_obfuscated_macro_code_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    ...
    defender_security_center_i_t_contact_display: Optional[defender_security_center_i_t_contact_display_type.DefenderSecurityCenterITContactDisplayType] = None
    # Possible values for defenderSecurityCenterNotificationsFromApp
    defender_security_center_notifications_from_app: Optional[defender_security_center_notifications_from_app_type.DefenderSecurityCenterNotificationsFromAppType] = None
    ...
    defender_submit_samples_consent_type: Optional[defender_submit_samples_consent_type.DefenderSubmitSamplesConsentType] = None
    # Possible values of Defender PUA Protection
    defender_untrusted_executable: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_untrusted_executable_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    # Possible values of Defender PUA Protection
    defender_untrusted_u_s_b_process: Optional[defender_protection_type.DefenderProtectionType] = None
    # Possible values of Defender Attack Surface Reduction Rules
    defender_untrusted_u_s_b_process_type: Optional[defender_attack_surface_type.DefenderAttackSurfaceType] = None
    ...
    device_guard_launch_system_guard: Optional[enablement.Enablement] = None
    # Possible values of Credential Guard settings.
    device_guard_local_system_authority_credential_guard_settings: Optional[device_guard_local_system_authority_credential_guard_type.DeviceGuardLocalSystemAuthorityCredentialGuardType] = None
    # Possible values of Secure Boot with DMA
    device_guard_secure_boot_with_d_m_a: Optional[secure_boot_with_d_m_a_type.SecureBootWithDMAType] = None
    # Possible values of the DmaGuardDeviceEnumerationPolicy.
    dma_guard_device_enumeration_policy: Optional[dma_guard_device_enumeration_policy_type.DmaGuardDeviceEnumerationPolicyType] = None
    ...
    firewall_rules: Optional[List[windows_firewall_rule.WindowsFirewallRule]] = None
    # Possible values for LanManagerAuthenticationLevel
    lan_manager_authentication_level: Optional[lan_manager_authentication_level.LanManagerAuthenticationLevel] = None
    ...
    local_security_options_administrator_elevation_prompt_behavior: Optional[local_security_options_administrator_elevation_prompt_behavior_type.LocalSecurityOptionsAdministratorElevationPromptBehaviorType] = None
    ...
    local_security_options_format_and_eject_of_removable_media_allowed_user: Optional[local_security_options_format_and_eject_of_removable_media_allowed_user_type.LocalSecurityOptionsFormatAndEjectOfRemovableMediaAllowedUserType] = None
    ...
    local_security_options_information_displayed_on_lock_screen: Optional[local_security_options_information_displayed_on_lock_screen_type.LocalSecurityOptionsInformationDisplayedOnLockScreenType] = None
    # Possible values for LocalSecurityOptionsInformationShownOnLockScreenType
    local_security_options_information_shown_on_lock_screen: Optional[local_security_options_information_shown_on_lock_screen_type.LocalSecurityOptionsInformationShownOnLockScreenType] = None
    ...
    local_security_options_minimum_session_security_for_ntlm_ssp_based_clients: Optional[local_security_options_minimum_session_security.LocalSecurityOptionsMinimumSessionSecurity] = None
    # Possible values for LocalSecurityOptionsMinimumSessionSecurity
    local_security_options_minimum_session_security_for_ntlm_ssp_based_servers: Optional[local_security_options_minimum_session_security.LocalSecurityOptionsMinimumSessionSecurity] = None
    ...
    local_security_options_smart_card_removal_behavior: Optional[local_security_options_smart_card_removal_behavior_type.LocalSecurityOptionsSmartCardRemovalBehaviorType] = None
    # Possible values for LocalSecurityOptionsStandardUserElevationPromptBehavior
    local_security_options_standard_user_elevation_prompt_behavior: Optional[local_security_options_standard_user_elevation_prompt_behavior_type.LocalSecurityOptionsStandardUserElevationPromptBehaviorType] = None
    ...
    user_rights_access_credential_manager_as_trusted_caller: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_act_as_part_of_the_operating_system: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_allow_access_from_network: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_backup_data: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_block_access_from_network: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_change_system_time: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    # This security setting determines whether users can create global objects that are available to all sessions. Users who can create global objects could affect processes that run under other users' sessions, which could lead to application failure or data corruption. Only states NotConfigured and Allowed are supported
    user_rights_create_global_objects: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_create_page_file: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_create_permanent_shared_objects: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_create_symbolic_links: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_create_token: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_debug_programs: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_delegation: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    # This user right determines which users cannot log on to the computer. States NotConfigured, Blocked are supported
    user_rights_deny_local_log_on: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_generate_security_audits: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_impersonate_client: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_increase_scheduling_priority: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_load_unload_drivers: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    # This user right determines which users can log on to the computer. States NotConfigured, Allowed are supported
    user_rights_local_log_on: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_lock_memory: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_manage_auditing_and_security_logs: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_manage_volumes: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_modify_firmware_environment: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_modify_object_labels: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_profile_single_process: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_remote_desktop_services_log_on: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_remote_shutdown: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    # This user right determines which users can bypass file, directory, registry, and other persistent objects permissions when restoring backed up files and directories, and determines which users can set any valid security principal as the owner of an object. Only states NotConfigured and Allowed are supported.
    user_rights_restore_data: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    ...
    user_rights_take_ownership: Optional[device_management_user_rights_setting.DeviceManagementUserRightsSetting] = None
    # Defender TamperProtection setting options
    windows_defender_tamper_protection: Optional[windows_defender_tamper_protection_options.WindowsDefenderTamperProtectionOptions] = None
    # Possible values of xbox service start type
    xbox_services_accessory_management_service_startup_mode: Optional[service_start_type.ServiceStartType] = None
    ...
    # Possible values of xbox service start type
    xbox_services_live_auth_manager_service_startup_mode: Optional[service_start_type.ServiceStartType] = None
    # Possible values of xbox service start type
    xbox_services_live_game_save_service_startup_mode: Optional[service_start_type.ServiceStartType] = None
    # Possible values of xbox service start type
    xbox_services_live_networking_service_startup_mode: Optional[service_start_type.ServiceStartType] = None
