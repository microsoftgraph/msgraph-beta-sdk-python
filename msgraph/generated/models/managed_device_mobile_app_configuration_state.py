...
class ManagedDeviceMobileAppConfigurationState(entity.Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "settingStates": lambda n : setattr(self, 'setting_states', n.get_collection_of_object_values(managed_device_mobile_app_configuration_setting_state.ManagedDeviceMobileAppConfigurationSettingState)),
