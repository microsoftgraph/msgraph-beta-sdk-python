...
class Entity(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> Entity:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.cloudPcBulkAction":
            ...
            if mapping_value == "#microsoft.graph.networkaccess.networkAccessRoot":
                from .networkaccess import network_access_root
            ...
            if mapping_value == "#microsoft.graph.userExperienceAnalyticsAnomalyCorrelationGroupOverview":
