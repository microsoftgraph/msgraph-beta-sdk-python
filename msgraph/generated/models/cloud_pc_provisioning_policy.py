...
class CloudPcProvisioningPolicy(entity.Entity):
    ...
    assignments: Optional[List[cloud_pc_provisioning_policy_assignment.CloudPcProvisioningPolicyAssignment]] = None
    ...
    domain_join_configuration: Optional[cloud_pc_domain_join_configuration.CloudPcDomainJoinConfiguration] = None
    # The domainJoinConfigurations property
    domain_join_configurations: Optional[List[cloud_pc_domain_join_configuration.CloudPcDomainJoinConfiguration]] = None
    ...
    image_type: Optional[cloud_pc_provisioning_policy_image_type.CloudPcProvisioningPolicyImageType] = None
    ...
    microsoft_managed_desktop: Optional[microsoft_managed_desktop.MicrosoftManagedDesktop] = None
