...
class MediaContentRatingIreland(AdditionalDataHolder, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "movie_rating": lambda n : setattr(self, 'movie_rating', n.get_enum_value(rating_ireland_movies_type.RatingIrelandMoviesType)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "tv_rating": lambda n : setattr(self, 'tv_rating', n.get_enum_value(rating_ireland_television_type.RatingIrelandTelevisionType)),
        }
        return fields
