...
class SignIn(entity.Entity):
    ...
    applied_event_listeners: Optional[List[applied_authentication_event_listener.AppliedAuthenticationEventListener]] = None
    # Provides details about the app and device used during an Azure AD authentication step.
    authentication_app_device_details: Optional[authentication_app_device_details.AuthenticationAppDeviceDetails] = None
    # Provides details of the Azure AD policies applied to a user and client authentication app during an authentication step.
    authentication_app_policy_evaluation_details: Optional[List[authentication_app_policy_details.AuthenticationAppPolicyDetails]] = None
    # Contains a collection of values that represent the conditional access authentication contexts applied to the sign-in.
    authentication_context_class_references: Optional[List[authentication_context.AuthenticationContext]] = None
    # The result of the authentication attempt and additional details on the authentication method.
    authentication_details: Optional[List[authentication_detail.AuthenticationDetail]] = None
    ...
    authentication_processing_details: Optional[List[key_value.KeyValue]] = None
    ...
    authentication_protocol: Optional[protocol_type.ProtocolType] = None
    ...
    authentication_requirement_policies: Optional[List[authentication_requirement_policy.AuthenticationRequirementPolicy]] = None
    ...
    client_credential_type: Optional[client_credential_type.ClientCredentialType] = None
    ...
    cross_tenant_access_type: Optional[sign_in_access_type.SignInAccessType] = None
    ...
    incoming_token_type: Optional[incoming_token_type.IncomingTokenType] = None
    ...
    managed_service_identity: Optional[managed_identity.ManagedIdentity] = None
    # The mfaDetail property
    mfa_detail: Optional[mfa_detail.MfaDetail] = None
    # The network location details including the type of network used and its names.
    network_location_details: Optional[List[network_location_detail.NetworkLocationDetail]] = None
    ...
    private_link_details: Optional[private_link_details.PrivateLinkDetails] = None
    ...
    session_lifetime_policies: Optional[List[session_lifetime_policy.SessionLifetimePolicy]] = None
    ...
    sign_in_identifier_type: Optional[sign_in_identifier_type.SignInIdentifierType] = None
    ...
    token_issuer_type: Optional[token_issuer_type.TokenIssuerType] = None
