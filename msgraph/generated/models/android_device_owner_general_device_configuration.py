...
class AndroidDeviceOwnerGeneralDeviceConfiguration(device_configuration.DeviceConfiguration):
    ...
    apps_auto_update_policy: Optional[android_device_owner_app_auto_update_policy_type.AndroidDeviceOwnerAppAutoUpdatePolicyType] = None
    ...
    apps_default_permission_policy: Optional[android_device_owner_default_app_permission_policy_type.AndroidDeviceOwnerDefaultAppPermissionPolicyType] = None
    ...
    azure_ad_shared_device_data_clear_apps: Optional[List[app_list_item.AppListItem]] = None
    ...
    cross_profile_policies_allow_data_sharing: Optional[android_device_owner_cross_profile_data_sharing.AndroidDeviceOwnerCrossProfileDataSharing] = None
    ...
    detailed_help_text: Optional[android_device_owner_user_facing_message.AndroidDeviceOwnerUserFacingMessage] = None
    ...
    device_owner_lock_screen_message: Optional[android_device_owner_user_facing_message.AndroidDeviceOwnerUserFacingMessage] = None
    # Android Device Owner Enrollment Profile types.
    enrollment_profile: Optional[android_device_owner_enrollment_profile_type.AndroidDeviceOwnerEnrollmentProfileType] = None
    ...
    global_proxy: Optional[android_device_owner_global_proxy.AndroidDeviceOwnerGlobalProxy] = None
    ...
    kiosk_customization_status_bar: Optional[android_device_owner_kiosk_customization_status_bar.AndroidDeviceOwnerKioskCustomizationStatusBar] = None
    ...
    kiosk_customization_system_navigation: Optional[android_device_owner_kiosk_customization_system_navigation.AndroidDeviceOwnerKioskCustomizationSystemNavigation] = None
    ...
    kiosk_mode_app_positions: Optional[List[android_device_owner_kiosk_mode_app_position_item.AndroidDeviceOwnerKioskModeAppPositionItem]] = None
    ...
    kiosk_mode_folder_icon: Optional[android_device_owner_kiosk_mode_folder_icon.AndroidDeviceOwnerKioskModeFolderIcon] = None
    ...
    kiosk_mode_icon_size: Optional[android_device_owner_kiosk_mode_icon_size.AndroidDeviceOwnerKioskModeIconSize] = None
    ...
    kiosk_mode_managed_folders: Optional[List[android_device_owner_kiosk_mode_managed_folder.AndroidDeviceOwnerKioskModeManagedFolder]] = None
    ...
    kiosk_mode_managed_home_screen_pin_complexity: Optional[kiosk_mode_managed_home_screen_pin_complexity.KioskModeManagedHomeScreenPinComplexity] = None
    ...
    kiosk_mode_screen_orientation: Optional[android_device_owner_kiosk_mode_screen_orientation.AndroidDeviceOwnerKioskModeScreenOrientation] = None
    ...
    kiosk_mode_use_managed_home_screen_app: Optional[kiosk_mode_type.KioskModeType] = None
    ...
    kiosk_mode_virtual_home_button_type: Optional[android_device_owner_virtual_home_button_type.AndroidDeviceOwnerVirtualHomeButtonType] = None
    ...
    microsoft_launcher_dock_presence_configuration: Optional[microsoft_launcher_dock_presence.MicrosoftLauncherDockPresence] = None
    ...
    microsoft_launcher_search_bar_placement_configuration: Optional[microsoft_launcher_search_bar_placement.MicrosoftLauncherSearchBarPlacement] = None
    ...
    password_block_keyguard_features: Optional[List[android_keyguard_feature.AndroidKeyguardFeature]] = None
    ...
    password_require_unlock: Optional[android_device_owner_required_password_unlock.AndroidDeviceOwnerRequiredPasswordUnlock] = None
    ...
    personal_profile_personal_applications: Optional[List[app_list_item.AppListItem]] = None
    ...
    personal_profile_play_store_mode: Optional[personal_profile_personal_play_store_mode.PersonalProfilePersonalPlayStoreMode] = None
    ...
    play_store_mode: Optional[android_device_owner_play_store_mode.AndroidDeviceOwnerPlayStoreMode] = None
    ...
    short_help_text: Optional[android_device_owner_user_facing_message.AndroidDeviceOwnerUserFacingMessage] = None
    ...
    stay_on_modes: Optional[List[android_device_owner_battery_plugged_mode.AndroidDeviceOwnerBatteryPluggedMode]] = None
    ...
    system_update_freeze_periods: Optional[List[android_device_owner_system_update_freeze_period.AndroidDeviceOwnerSystemUpdateFreezePeriod]] = None
    # The type of system update configuration. Possible values are: deviceDefault, postpone, windowed, automatic.
    system_update_install_type: Optional[android_device_owner_system_update_install_type.AndroidDeviceOwnerSystemUpdateInstallType] = None
    ...
    work_profile_password_require_unlock: Optional[android_device_owner_required_password_unlock.AndroidDeviceOwnerRequiredPasswordUnlock] = None
    ...
    work_profile_password_required_type: Optional[android_device_owner_required_password_type.AndroidDeviceOwnerRequiredPasswordType] = None
