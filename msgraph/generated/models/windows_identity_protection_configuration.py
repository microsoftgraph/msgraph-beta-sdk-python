...
class WindowsIdentityProtectionConfiguration(device_configuration.DeviceConfiguration):
    ...
    pin_lowercase_characters_usage: Optional[configuration_usage.ConfigurationUsage] = None
    ...
    # Possible values of the ConfigurationUsage list.
    pin_special_characters_usage: Optional[configuration_usage.ConfigurationUsage] = None
    # Possible values of the ConfigurationUsage list.
    pin_uppercase_characters_usage: Optional[configuration_usage.ConfigurationUsage] = None
