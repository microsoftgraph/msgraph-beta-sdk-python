...
class CloudPcSnapshot(entity.Entity):
    ...
    last_restored_date_time: Optional[datetime] = None
    ...
    snapshot_type: Optional[cloud_pc_snapshot_type.CloudPcSnapshotType] = None
    # The status of the Cloud PC snapshot. The possible values are: ready, unknownFutureValue.
    status: Optional[cloud_pc_snapshot_status.CloudPcSnapshotStatus] = None
