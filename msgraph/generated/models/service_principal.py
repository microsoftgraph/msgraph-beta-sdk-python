...
class ServicePrincipal(directory_object.DirectoryObject):
    ...
    def error_url(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the error_url property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "passwordSingleSignOnSettings": lambda n : setattr(self, 'password_single_sign_on_settings', n.get_object_value(password_single_sign_on_settings.PasswordSingleSignOnSettings)),
            ...
            "publishedPermissionScopes": lambda n : setattr(self, 'published_permission_scopes', n.get_collection_of_object_values(permission_scope.PermissionScope)),
    ...
    def password_single_sign_on_settings(self,value: Optional[password_single_sign_on_settings.PasswordSingleSignOnSettings] = None) -> None:
        ...
        Args:
            value: Value to set for the password_single_sign_on_settings property.
        """
    ...
    def published_permission_scopes(self,value: Optional[List[permission_scope.PermissionScope]] = None) -> None:
        ...
        Args:
            value: Value to set for the published_permission_scopes property.
        """
