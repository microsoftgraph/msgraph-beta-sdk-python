...
class ServicePrincipal(directory_object.DirectoryObject):
    ...
    @property
    def error_url(self,) -> Optional[str]:
        """
    ...
    @error_url.setter
    def error_url(self,value: Optional[str] = None) -> None:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "error_url": lambda n : setattr(self, 'error_url', n.get_str_value()),
            ...
            "password_single_sign_on_settings": lambda n : setattr(self, 'password_single_sign_on_settings', n.get_object_value(password_single_sign_on_settings.PasswordSingleSignOnSettings)),
            "preferred_single_sign_on_mode": lambda n : setattr(self, 'preferred_single_sign_on_mode', n.get_str_value()),
            "preferred_token_signing_key_end_date_time": lambda n : setattr(self, 'preferred_token_signing_key_end_date_time', n.get_datetime_value()),
            "preferred_token_signing_key_thumbprint": lambda n : setattr(self, 'preferred_token_signing_key_thumbprint', n.get_str_value()),
            "published_permission_scopes": lambda n : setattr(self, 'published_permission_scopes', n.get_collection_of_object_values(permission_scope.PermissionScope)),
    ...
    @property
    def password_single_sign_on_settings(self,) -> Optional[password_single_sign_on_settings.PasswordSingleSignOnSettings]:
        """
        ...
        Returns: Optional[password_single_sign_on_settings.PasswordSingleSignOnSettings]
        """
        return self._password_single_sign_on_settings
    
    @password_single_sign_on_settings.setter
    def password_single_sign_on_settings(self,value: Optional[password_single_sign_on_settings.PasswordSingleSignOnSettings] = None) -> None:
        """
        ...
        """
        self._password_single_sign_on_settings = value
    ...
    def preferred_token_signing_key_end_date_time(self,value: Optional[datetime] = None) -> None:
        ...
        """
        self._preferred_token_signing_key_end_date_time = value
    ...
    @property
    def published_permission_scopes(self,) -> Optional[List[permission_scope.PermissionScope]]:
        """
        ...
        """
        return self._published_permission_scopes
    
    @published_permission_scopes.setter
    def published_permission_scopes(self,value: Optional[List[permission_scope.PermissionScope]] = None) -> None:
        """
        ...
        """
        self._published_permission_scopes = value
