...
class ServicePrincipal(directory_object.DirectoryObject):
    ...
    password_single_sign_on_settings: Optional[password_single_sign_on_settings.PasswordSingleSignOnSettings] = None
    ...
    preferred_token_signing_key_end_date_time: Optional[datetime] = None
    ...
    published_permission_scopes: Optional[List[permission_scope.PermissionScope]] = None
