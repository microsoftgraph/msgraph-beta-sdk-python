...
class UserPFXCertificate(entity.Entity):
    ...
    intended_purpose: Optional[user_pfx_intended_purpose.UserPfxIntendedPurpose] = None
    ...
    padding_scheme: Optional[user_pfx_padding_scheme.UserPfxPaddingScheme] = None
