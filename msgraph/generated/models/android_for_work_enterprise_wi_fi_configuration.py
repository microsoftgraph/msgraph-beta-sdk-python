...
class AndroidForWorkEnterpriseWiFiConfiguration(android_for_work_wi_fi_configuration.AndroidForWorkWiFiConfiguration):
    ...
    identity_certificate_for_client_authentication: Optional[android_for_work_certificate_profile_base.AndroidForWorkCertificateProfileBase] = None
    ...
    root_certificate_for_server_validation: Optional[android_for_work_trusted_root_certificate.AndroidForWorkTrustedRootCertificate] = None
