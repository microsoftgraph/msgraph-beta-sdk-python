...
class Group(directory_object.DirectoryObject):
    ...
    access_type: Optional[group_access_type.GroupAccessType] = None
    ...
    membership_rule_processing_status: Optional[membership_rule_processing_status.MembershipRuleProcessingStatus] = None
    ...
    settings: Optional[List[directory_setting.DirectorySetting]] = None
    ...
    writeback_configuration: Optional[group_writeback_configuration.GroupWritebackConfiguration] = None
