...
class Group(directory_object.DirectoryObject):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "access_type": lambda n : setattr(self, 'access_type', n.get_enum_value(group_access_type.GroupAccessType)),
            ...
            "membership_rule_processing_status": lambda n : setattr(self, 'membership_rule_processing_status', n.get_object_value(membership_rule_processing_status.MembershipRuleProcessingStatus)),
            ...
            "resource_behavior_options": lambda n : setattr(self, 'resource_behavior_options', n.get_collection_of_primitive_values(str)),
            "resource_provisioning_options": lambda n : setattr(self, 'resource_provisioning_options', n.get_collection_of_primitive_values(str)),
            ...
            "unseen_conversations_count": lambda n : setattr(self, 'unseen_conversations_count', n.get_int_value()),
            "unseen_count": lambda n : setattr(self, 'unseen_count', n.get_int_value()),
            "unseen_messages_count": lambda n : setattr(self, 'unseen_messages_count', n.get_int_value()),
            "visibility": lambda n : setattr(self, 'visibility', n.get_str_value()),
            "writeback_configuration": lambda n : setattr(self, 'writeback_configuration', n.get_object_value(group_writeback_configuration.GroupWritebackConfiguration)),
        }
    ...
    def membership_rule_processing_status(self,value: Optional[membership_rule_processing_status.MembershipRuleProcessingStatus] = None) -> None:
        ...
        Args:
            value: Value to set for the membershipRuleProcessingStatus property.
        """
    ...
    def organization_id(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the organizationId property.
        """
    ...
    def resource_behavior_options(self,value: Optional[List[str]] = None) -> None:
        ...
        Args:
            value: Value to set for the resourceBehaviorOptions property.
        """
    ...
    def resource_provisioning_options(self,value: Optional[List[str]] = None) -> None:
        ...
        Args:
            value: Value to set for the resourceProvisioningOptions property.
        """
    ...
    def unseen_conversations_count(self,value: Optional[int] = None) -> None:
        ...
        Args:
            value: Value to set for the unseenConversationsCount property.
        """
    ...
    def unseen_messages_count(self,value: Optional[int] = None) -> None:
        ...
        Args:
            value: Value to set for the unseenMessagesCount property.
        """
    ...
    def writeback_configuration(self,value: Optional[group_writeback_configuration.GroupWritebackConfiguration] = None) -> None:
        ...
        Args:
            value: Value to set for the writebackConfiguration property.
        """
