...
class UserExperienceAnalyticsDeviceScope(entity.Entity):
    ...
    operator: Optional[device_scope_operator.DeviceScopeOperator] = None
    ...
    parameter: Optional[device_scope_parameter.DeviceScopeParameter] = None
    ...
    status: Optional[device_scope_status.DeviceScopeStatus] = None
