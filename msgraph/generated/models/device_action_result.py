...
class DeviceActionResult(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeviceActionResult:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.activateDeviceEsimActionResult":
                from . import activate_device_esim_action_result

                return activate_device_esim_action_result.ActivateDeviceEsimActionResult()
            if mapping_value == "#microsoft.graph.configurationManagerActionResult":
            ...
            if mapping_value == "#microsoft.graph.revokeAppleVppLicensesActionResult":
            ...
            if mapping_value == "#microsoft.graph.rotateBitLockerKeysDeviceActionResult":
