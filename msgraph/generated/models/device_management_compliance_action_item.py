...
device_management_compliance_action_type = lazy_import('msgraph.generated.models.device_management_compliance_action_type')
entity = lazy_import('msgraph.generated.models.entity')

class DeviceManagementComplianceActionItem(entity.Entity):
    """
    Scheduled Action for Rule
    """
    @property
    def action_type(self,) -> Optional[device_management_compliance_action_type.DeviceManagementComplianceActionType]:
        """
        Gets the actionType property value. Scheduled Action Type Enum
        Returns: Optional[device_management_compliance_action_type.DeviceManagementComplianceActionType]
        """
        return self._action_type
    
    @action_type.setter
    def action_type(self,value: Optional[device_management_compliance_action_type.DeviceManagementComplianceActionType] = None) -> None:
        """
    ...
    def __init__(self,) -> None:
        ...
        self._action_type: Optional[device_management_compliance_action_type.DeviceManagementComplianceActionType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "action_type": lambda n : setattr(self, 'action_type', n.get_enum_value(device_management_compliance_action_type.DeviceManagementComplianceActionType)),
