...
class PrinterCapabilities(AdditionalDataHolder, BackedModel, Parsable):
    ...
    supported_copies_per_job: Optional[IntegerRange] = None
    ...
    supported_duplex_configurations: Optional[List[PrintDuplexConfiguration]] = None
    # The supportedFinishings property
    supported_finishings: Optional[List[PrintFinishing]] = None
    ...
    supported_media_types: Optional[List[PrintMediaType]] = None
    # The supportedOrientations property
    supported_orientations: Optional[List[PrintOrientation]] = None
    # The supportedOutputBins property
    supported_output_bins: Optional[List[str]] = None
    # The supportedPagesPerSheet property
    supported_pages_per_sheet: Optional[IntegerRange] = None
    # The supportedPresentationDirections property
    supported_presentation_directions: Optional[List[PrintPresentationDirection]] = None
    # The supportedPrintQualities property
    supported_print_qualities: Optional[List[PrintQuality]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "supportedDuplexConfigurations": lambda n : setattr(self, 'supported_duplex_configurations', n.get_collection_of_enum_values(PrintDuplexConfiguration)),
            "supportedFinishings": lambda n : setattr(self, 'supported_finishings', n.get_collection_of_enum_values(PrintFinishing)),
            ...
            "supportedMediaTypes": lambda n : setattr(self, 'supported_media_types', n.get_collection_of_enum_values(PrintMediaType)),
            "supportedOrientations": lambda n : setattr(self, 'supported_orientations', n.get_collection_of_enum_values(PrintOrientation)),
            "supportedOutputBins": lambda n : setattr(self, 'supported_output_bins', n.get_collection_of_primitive_values(str)),
            "supportedPagesPerSheet": lambda n : setattr(self, 'supported_pages_per_sheet', n.get_object_value(IntegerRange)),
            "supportedPresentationDirections": lambda n : setattr(self, 'supported_presentation_directions', n.get_collection_of_enum_values(PrintPresentationDirection)),
            "supportedPrintQualities": lambda n : setattr(self, 'supported_print_qualities', n.get_collection_of_enum_values(PrintQuality)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_enum_values("feedDirections", self.feed_directions)
        ...
        writer.write_collection_of_enum_values("supportedColorConfigurations", self.supported_color_configurations)
        ...
        writer.write_collection_of_enum_values("supportedDuplexConfigurations", self.supported_duplex_configurations)
        writer.write_collection_of_enum_values("supportedFinishings", self.supported_finishings)
        ...
        writer.write_collection_of_enum_values("supportedMediaTypes", self.supported_media_types)
        writer.write_collection_of_enum_values("supportedOrientations", self.supported_orientations)
        ...
        writer.write_collection_of_enum_values("supportedPresentationDirections", self.supported_presentation_directions)
        writer.write_collection_of_enum_values("supportedPrintQualities", self.supported_print_qualities)
