...
from . import on_token_issuance_start_handler
...
class OnTokenIssuanceStartCustomExtensionHandler(on_token_issuance_start_handler.OnTokenIssuanceStartHandler):
    ...
    custom_extension: Optional[on_token_issuance_start_custom_extension.OnTokenIssuanceStartCustomExtension] = None
