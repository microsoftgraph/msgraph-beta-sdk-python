...
class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus(entity.Entity):
    ...
    deployment_status: Optional[windows_defender_application_control_supplemental_policy_statuses.WindowsDefenderApplicationControlSupplementalPolicyStatuses] = None
    # Device ID.
    ...
    policy: Optional[windows_defender_application_control_supplemental_policy.WindowsDefenderApplicationControlSupplementalPolicy] = None
