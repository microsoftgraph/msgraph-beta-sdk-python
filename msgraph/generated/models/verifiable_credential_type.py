...
class VerifiableCredentialType(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._issuers: Optional[List[str]] = None
    ...
    def credential_type(self,value: Optional[str] = None) -> None:
        """
        Sets the credentialType property value. The type of credential issued, for example, BusinessCardCredential.
        Args:
            value: Value to set for the credential_type property.
        """
    ...
    @property
    def issuers(self,) -> Optional[List[str]]:
        """
    ...
    @issuers.setter
    def issuers(self,value: Optional[List[str]] = None) -> None:
        """
        ...
        Args:
            value: Value to set for the issuers property.
        """
        self._issuers = value
