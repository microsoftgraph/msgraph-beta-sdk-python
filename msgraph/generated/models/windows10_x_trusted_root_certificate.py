...
if TYPE_CHECKING:
    from . import certificate_destination_store, device_management_resource_access_profile_base

from . import device_management_resource_access_profile_base

class Windows10XTrustedRootCertificate(device_management_resource_access_profile_base.DeviceManagementResourceAccessProfileBase):
    def __init__(self,) -> None:
        """
        Instantiates a new Windows10XTrustedRootCertificate and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.windows10XTrustedRootCertificate"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> Windows10XTrustedRootCertificate:
        """
