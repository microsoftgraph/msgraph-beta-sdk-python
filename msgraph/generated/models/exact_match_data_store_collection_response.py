...
class ExactMatchDataStoreCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[exact_match_data_store.ExactMatchDataStore]] = None
    ...
    @property
    def value(self,) -> Optional[List[exact_match_data_store.ExactMatchDataStore]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[exact_match_data_store.ExactMatchDataStore]] = None) -> None:
        """
