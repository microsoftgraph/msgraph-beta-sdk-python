...
class AppleUserInitiatedEnrollmentProfileCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[apple_user_initiated_enrollment_profile.AppleUserInitiatedEnrollmentProfile]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AppleUserInitiatedEnrollmentProfileCollectionResponse:
        """
    ...
    @property
    def value(self,) -> Optional[List[apple_user_initiated_enrollment_profile.AppleUserInitiatedEnrollmentProfile]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[apple_user_initiated_enrollment_profile.AppleUserInitiatedEnrollmentProfile]] = None) -> None:
        """
