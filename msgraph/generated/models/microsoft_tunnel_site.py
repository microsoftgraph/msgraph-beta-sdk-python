...
class MicrosoftTunnelSite(entity.Entity):
    ...
    microsoft_tunnel_configuration: Optional[microsoft_tunnel_configuration.MicrosoftTunnelConfiguration] = None
    # A list of MicrosoftTunnelServers that are registered to this MicrosoftTunnelSite
    microsoft_tunnel_servers: Optional[List[microsoft_tunnel_server.MicrosoftTunnelServer]] = None
    ...
    upgrade_window_end_time: Optional[time] = None
    # The site's upgrade window start time of day
    upgrade_window_start_time: Optional[time] = None
