...
class GovernancePolicy(AdditionalDataHolder, Parsable):
    ...
    decision_maker_criteria: Optional[List[governance_criteria.GovernanceCriteria]] = None
    # The notificationPolicy property
    notification_policy: Optional[governance_notification_policy.GovernanceNotificationPolicy] = None
