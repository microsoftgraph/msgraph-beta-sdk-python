...
class MicrosoftAuthenticatorAuthenticationMethodConfiguration(authentication_method_configuration.AuthenticationMethodConfiguration):
    ...
    def is_software_oath_enabled(self,) -> Optional[bool]:
        """
        Gets the isSoftwareOathEnabled property value. true if users can use the OTP code generated by the Microsoft Authenticator app, false otherwise.
    ...
    def is_software_oath_enabled(self,value: Optional[bool] = None) -> None:
        """
        Sets the isSoftwareOathEnabled property value. true if users can use the OTP code generated by the Microsoft Authenticator app, false otherwise.
        Args:
