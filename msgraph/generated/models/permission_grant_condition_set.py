...
class PermissionGrantConditionSet(entity.Entity):
    ...
    def certified_client_applications_only(self,) -> Optional[bool]:
        ...
        """
        return self._certified_client_applications_only
    
    @certified_client_applications_only.setter
    def certified_client_applications_only(self,value: Optional[bool] = None) -> None:
        """
        ...
        Args:
            value: Value to set for the certifiedClientApplicationsOnly property.
        """
        self._certified_client_applications_only = value
    ...
    def __init__(self,) -> None:
        ...
        self._certified_client_applications_only: Optional[bool] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "certified_client_applications_only": lambda n : setattr(self, 'certified_client_applications_only', n.get_bool_value()),
