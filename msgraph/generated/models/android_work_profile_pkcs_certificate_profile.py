...
if TYPE_CHECKING:
    from . import android_work_profile_certificate_profile_base, certificate_store, custom_subject_alternative_name, managed_device_certificate_state

from . import android_work_profile_certificate_profile_base

class AndroidWorkProfilePkcsCertificateProfile(android_work_profile_certificate_profile_base.AndroidWorkProfileCertificateProfileBase):
    def __init__(self,) -> None:
        """
        Instantiates a new AndroidWorkProfilePkcsCertificateProfile and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.androidWorkProfilePkcsCertificateProfile"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AndroidWorkProfilePkcsCertificateProfile:
        """
