...
class WindowsWiredNetworkConfiguration(device_configuration.DeviceConfiguration):
    ...
    authentication_method: Optional[wired_network_authentication_method.WiredNetworkAuthenticationMethod] = None
    ...
    authentication_type: Optional[wired_network_authentication_type.WiredNetworkAuthenticationType] = None
    ...
    identity_certificate_for_client_authentication: Optional[windows_certificate_profile_base.WindowsCertificateProfileBase] = None
    ...
    inner_authentication_protocol_for_e_a_p_t_t_l_s: Optional[non_eap_authentication_method_for_eap_ttls_type.NonEapAuthenticationMethodForEapTtlsType] = None
    ...
    root_certificate_for_client_validation: Optional[windows81_trusted_root_certificate.Windows81TrustedRootCertificate] = None
    # Specify root certificates for server validation. This collection can contain a maximum of 500 elements.
    root_certificates_for_server_validation: Optional[List[windows81_trusted_root_certificate.Windows81TrustedRootCertificate]] = None
    ...
    secondary_authentication_method: Optional[wired_network_authentication_method.WiredNetworkAuthenticationMethod] = None
    # Specify secondary identity certificate for client authentication.
    secondary_identity_certificate_for_client_authentication: Optional[windows_certificate_profile_base.WindowsCertificateProfileBase] = None
    # Specify secondary root certificate for client validation.
    secondary_root_certificate_for_client_validation: Optional[windows81_trusted_root_certificate.Windows81TrustedRootCertificate] = None
