...
class VpnOnDemandRule(AdditionalDataHolder, Parsable):
    ...
    action: Optional[vpn_on_demand_rule_connection_action.VpnOnDemandRuleConnectionAction] = None
    # DNS Search Domains.
    ...
    domain_action: Optional[vpn_on_demand_rule_connection_domain_action.VpnOnDemandRuleConnectionDomainAction] = None
    # Domains (Only applicable when Action is evaluate connection).
    domains: Optional[List[str]] = None
    # VPN On-Demand Rule Connection network interface type.
    interface_type_match: Optional[vpn_on_demand_rule_interface_type_match.VpnOnDemandRuleInterfaceTypeMatch] = None
