...
class ApplicationTemplate(entity.Entity):
    ...
    informational_urls: Optional[informational_urls.InformationalUrls] = None
    ...
    supported_claim_configuration: Optional[supported_claim_configuration.SupportedClaimConfiguration] = None
