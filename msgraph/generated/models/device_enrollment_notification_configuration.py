...
class DeviceEnrollmentNotificationConfiguration(device_enrollment_configuration.DeviceEnrollmentConfiguration):
    ...
    branding_options: Optional[enrollment_notification_branding_options.EnrollmentNotificationBrandingOptions] = None
    ...
    template_type: Optional[enrollment_notification_template_type.EnrollmentNotificationTemplateType] = None
