...
class MicrosoftTrainingAssignmentMapping(TrainingSetting):
    ...
    OdataType: Optional[str] = "#microsoft.graph.microsoftTrainingAssignmentMapping"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> MicrosoftTrainingAssignmentMapping:
        """
