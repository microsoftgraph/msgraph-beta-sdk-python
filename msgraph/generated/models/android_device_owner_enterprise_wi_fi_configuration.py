...
class AndroidDeviceOwnerEnterpriseWiFiConfiguration(android_device_owner_wi_fi_configuration.AndroidDeviceOwnerWiFiConfiguration):
    odata_type = "#microsoft.graph.androidDeviceOwnerEnterpriseWiFiConfiguration"
    ...
    identity_certificate_for_client_authentication: Optional[android_device_owner_certificate_profile_base.AndroidDeviceOwnerCertificateProfileBase] = None
    ...
    root_certificate_for_server_validation: Optional[android_device_owner_trusted_root_certificate.AndroidDeviceOwnerTrustedRootCertificate] = None
