...
if TYPE_CHECKING:
    from . import device_custom_attribute_value_type, device_management_script_assignment, device_management_script_device_state, device_management_script_group_assignment, device_management_script_run_summary, device_management_script_user_state, entity, run_as_account_type
...
class DeviceCustomAttributeShellScript(entity.Entity):
    ...
    custom_attribute_type: Optional[device_custom_attribute_value_type.DeviceCustomAttributeValueType] = None
