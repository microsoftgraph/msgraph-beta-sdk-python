...
class ProfileCardPropertyCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[profile_card_property.ProfileCardProperty]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ProfileCardPropertyCollectionResponse:
        """
        ...
        return ProfileCardPropertyCollectionResponse()
    ...
    @property
    def value(self,) -> Optional[List[profile_card_property.ProfileCardProperty]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[profile_card_property.ProfileCardProperty]] = None) -> None:
        """
