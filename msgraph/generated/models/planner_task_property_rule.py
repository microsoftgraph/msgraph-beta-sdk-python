...
class PlannerTaskPropertyRule(planner_property_rule.PlannerPropertyRule):
    ...
    applied_categories: Optional[planner_field_rules.PlannerFieldRules] = None
    ...
    assignments: Optional[planner_field_rules.PlannerFieldRules] = None
    ...
    check_lists: Optional[planner_field_rules.PlannerFieldRules] = None
    ...
    references: Optional[planner_field_rules.PlannerFieldRules] = None
