...
class AndroidEnterpriseWiFiConfiguration(android_wi_fi_configuration.AndroidWiFiConfiguration):
    odata_type = "#microsoft.graph.androidEnterpriseWiFiConfiguration"
    ...
    identity_certificate_for_client_authentication: Optional[android_certificate_profile_base.AndroidCertificateProfileBase] = None
    ...
    root_certificate_for_server_validation: Optional[android_trusted_root_certificate.AndroidTrustedRootCertificate] = None
