...
class SalesQuoteCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[sales_quote.SalesQuote]] = None
    ...
    @property
    def value(self,) -> Optional[List[sales_quote.SalesQuote]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[sales_quote.SalesQuote]] = None) -> None:
        """
