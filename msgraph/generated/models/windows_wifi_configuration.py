...
class WindowsWifiConfiguration(device_configuration.DeviceConfiguration):
    ...
    metered_connection_limit: Optional[metered_connection_limit_type.MeteredConnectionLimitType] = None
    ...
    proxy_setting: Optional[wi_fi_proxy_setting.WiFiProxySetting] = None
    ...
    wifi_security_type: Optional[wi_fi_security_type.WiFiSecurityType] = None
