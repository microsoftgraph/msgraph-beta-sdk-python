...
class WindowsFirewallRule(AdditionalDataHolder, Parsable):
    ...
    action: Optional[state_management_setting.StateManagementSetting] = None
    # The description of the rule.
    description: Optional[str] = None
    # The display name of the rule. Does not need to be unique.
    display_name: Optional[str] = None
    # State Management Setting.
    edge_traversal: Optional[state_management_setting.StateManagementSetting] = None
    # The full file path of an app that's affected by the firewall rule.
    file_path: Optional[str] = None
    # Flags representing firewall rule interface types.
    interface_types: Optional[windows_firewall_rule_interface_types.WindowsFirewallRuleInterfaceTypes] = None
    ...
    profile_types: Optional[windows_firewall_rule_network_profile_types.WindowsFirewallRuleNetworkProfileTypes] = None
    ...
    traffic_direction: Optional[windows_firewall_rule_traffic_direction_type.WindowsFirewallRuleTrafficDirectionType] = None
