...
class MacOSSoftwareUpdateCategorySummary(entity.Entity):
    ...
    update_category: Optional[mac_o_s_software_update_category.MacOSSoftwareUpdateCategory] = None
    # Summary of the update states.
    update_state_summaries: Optional[List[mac_o_s_software_update_state_summary.MacOSSoftwareUpdateStateSummary]] = None
    # The user ID.
