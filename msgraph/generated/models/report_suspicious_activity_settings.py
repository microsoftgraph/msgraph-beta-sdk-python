...
if TYPE_CHECKING:
    from . import advanced_config_state, include_target

@dataclass
class ReportSuspiciousActivitySettings(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # The includeTarget property
    include_target: Optional[include_target.IncludeTarget] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "includeTarget": lambda n : setattr(self, 'include_target', n.get_object_value(include_target.IncludeTarget)),
