...
class OnUserCreateStartListener(authentication_event_listener.AuthenticationEventListener):
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.onUserCreateStartListener"
        ...
        self._handler: Optional[on_user_create_start_handler.OnUserCreateStartHandler] = None
    ...
    @property
    def handler(self,) -> Optional[on_user_create_start_handler.OnUserCreateStartHandler]:
        """
    ...
    @handler.setter
    def handler(self,value: Optional[on_user_create_start_handler.OnUserCreateStartHandler] = None) -> None:
        """
