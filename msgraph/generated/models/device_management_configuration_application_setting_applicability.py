...
class DeviceManagementConfigurationApplicationSettingApplicability(device_management_configuration_setting_applicability.DeviceManagementConfigurationSettingApplicability):
    def __init__(self,) -> None:
        """
        Instantiates a new DeviceManagementConfigurationApplicationSettingApplicability and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.deviceManagementConfigurationApplicationSettingApplicability"
