...
class DepOnboardingSetting(entity.Entity):
    ...
    default_ios_enrollment_profile: Optional[dep_i_o_s_enrollment_profile.DepIOSEnrollmentProfile] = None
    # Default MacOs Enrollment Profile
    default_mac_os_enrollment_profile: Optional[dep_mac_o_s_enrollment_profile.DepMacOSEnrollmentProfile] = None
    # The enrollment profiles.
    enrollment_profiles: Optional[List[enrollment_profile.EnrollmentProfile]] = None
    ...
    last_sync_triggered_date_time: Optional[datetime] = None
    ...
    token_type: Optional[dep_token_type.DepTokenType] = None
