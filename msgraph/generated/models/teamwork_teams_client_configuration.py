...
class TeamworkTeamsClientConfiguration(AdditionalDataHolder, Parsable):
    ...
    account_configuration: Optional[teamwork_account_configuration.TeamworkAccountConfiguration] = None
    # The configuration of Microsoft Teams client features for a device.
    features_configuration: Optional[teamwork_features_configuration.TeamworkFeaturesConfiguration] = None
