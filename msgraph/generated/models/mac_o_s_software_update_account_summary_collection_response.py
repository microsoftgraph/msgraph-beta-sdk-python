...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, mac_o_s_software_update_account_summary
...
class MacOSSoftwareUpdateAccountSummaryCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(mac_o_s_software_update_account_summary.MacOSSoftwareUpdateAccountSummary)),
        }
