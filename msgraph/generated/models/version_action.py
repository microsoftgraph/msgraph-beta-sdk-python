...
class VersionAction(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> VersionAction:
        """
    ...
    @new_version.setter
    def new_version(self,value: Optional[str] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("newVersion", self.new_version)
