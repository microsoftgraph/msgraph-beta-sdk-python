...
class GovernanceCriteria(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        """
        Instantiates a new governanceCriteria and sets the default values.
        """
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GovernanceCriteria:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.groupMembershipGovernanceCriteria":
            ...
            if mapping_value == "#microsoft.graph.roleMembershipGovernanceCriteria":
            ...
            if mapping_value == "#microsoft.graph.userGovernanceCriteria":
