...
class CloudPcAuditActor(AdditionalDataHolder, Parsable):
    ...
    # The type property
    type: Optional[cloud_pc_audit_actor_type.CloudPcAuditActorType] = None
    # Azure AD user ID.
    ...
    user_role_scope_tags: Optional[List[cloud_pc_user_role_scope_tag_info.CloudPcUserRoleScopeTagInfo]] = None
