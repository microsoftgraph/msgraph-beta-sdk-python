...
class MobileApp(entity.Entity):
    ...
    install_summary: Optional[mobile_app_install_summary.MobileAppInstallSummary] = None
    ...
    # The list of installation states for this mobile app.
    user_statuses: Optional[List[user_app_install_status.UserAppInstallStatus]] = None
