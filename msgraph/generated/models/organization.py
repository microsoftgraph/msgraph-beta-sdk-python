...
class Organization(directory_object.DirectoryObject):
    ...
    certificate_connector_setting: Optional[certificate_connector_setting.CertificateConnectorSetting] = None
    ...
    directory_size_quota: Optional[directory_size_quota.DirectorySizeQuota] = None
    ...
    on_premises_last_password_sync_date_time: Optional[datetime] = None
    ...
    partner_information: Optional[partner_information.PartnerInformation] = None
    ...
    settings: Optional[organization_settings.OrganizationSettings] = None
