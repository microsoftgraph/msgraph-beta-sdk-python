...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, microsoft_tunnel_configuration
...
class MicrosoftTunnelConfigurationCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[microsoft_tunnel_configuration.MicrosoftTunnelConfiguration]] = None
