...
class AzurePermissionsDefinitionAction(PermissionsDefinitionAction):
    ...
    OdataType: Optional[str] = "#microsoft.graph.azurePermissionsDefinitionAction"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AzurePermissionsDefinitionAction:
        """
