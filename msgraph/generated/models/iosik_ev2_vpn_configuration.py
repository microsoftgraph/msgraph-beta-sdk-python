...
class IosikEv2VpnConfiguration(ios_vpn_configuration.IosVpnConfiguration):
    ...
    always_on_configuration: Optional[apple_vpn_always_on_configuration.AppleVpnAlwaysOnConfiguration] = None
    # Child Security Association Parameters
    child_security_association_parameters: Optional[ios_vpn_security_association_parameters.IosVpnSecurityAssociationParameters] = None
    # The type of VPN client authentication type
    client_authentication_type: Optional[vpn_client_authentication_type.VpnClientAuthenticationType] = None
    # Determine how often to check if a peer connection is still active. . Possible values are: medium, none, low, high.
    dead_peer_detection_rate: Optional[vpn_dead_peer_detection_rate.VpnDeadPeerDetectionRate] = None
    # Disable MOBIKE
    ...
    local_identifier: Optional[vpn_local_identifier.VpnLocalIdentifier] = None
    ...
    security_association_parameters: Optional[ios_vpn_security_association_parameters.IosVpnSecurityAssociationParameters] = None
    ...
    server_certificate_type: Optional[vpn_server_certificate_type.VpnServerCertificateType] = None
