...
@dataclass
class CustomExtensionOverwriteConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> CustomExtensionOverwriteConfiguration:
        """
