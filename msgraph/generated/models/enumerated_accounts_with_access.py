...
class EnumeratedAccountsWithAccess(AccountsWithAccess):
    ...
    OdataType: Optional[str] = "#microsoft.graph.enumeratedAccountsWithAccess"
    # The accounts property
    accounts: Optional[List[AuthorizationSystem]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EnumeratedAccountsWithAccess:
        """
