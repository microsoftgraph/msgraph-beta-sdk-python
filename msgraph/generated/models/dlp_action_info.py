...
if TYPE_CHECKING:
    ...
    from .device_restriction_action import DeviceRestrictionAction
...
class DlpActionInfo(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DlpActionInfo:
        ...
        try:
            ...
            mapping_value = None
        if mapping_value and mapping_value.casefold() == "#microsoft.graph.blockAccessAction".casefold():
            from .block_access_action import BlockAccessAction

            return BlockAccessAction()
        if mapping_value and mapping_value.casefold() == "#microsoft.graph.deviceRestrictionAction".casefold():
            from .device_restriction_action import DeviceRestrictionAction
