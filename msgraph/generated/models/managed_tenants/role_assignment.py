...
if TYPE_CHECKING:
    from . import delegated_privilege_status, role_definition
...
class RoleAssignment(AdditionalDataHolder, Parsable):
    ...
    assignment_type: Optional[delegated_privilege_status.DelegatedPrivilegeStatus] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The collection of roles assigned.
    roles: Optional[List[role_definition.RoleDefinition]] = None
