...
if TYPE_CHECKING:
    from . import conditional_access_policy_coverage
...
class ConditionalAccessPolicyCoverageCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(conditional_access_policy_coverage.ConditionalAccessPolicyCoverage)),
        }
