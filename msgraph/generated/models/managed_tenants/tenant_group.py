...
class TenantGroup(entity.Entity):
    ...
    management_actions: Optional[List[management_action_info.ManagementActionInfo]] = None
    # The collection of management intents associated with the tenant group. Optional. Read-only.
    management_intents: Optional[List[management_intent_info.ManagementIntentInfo]] = None
