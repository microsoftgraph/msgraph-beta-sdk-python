...
class WindowsProtectionState(entity.Entity):
    ...
    device_property_refresh_date_time: Optional[datetime] = None
    ...
    last_full_scan_date_time: Optional[datetime] = None
    ...
    last_quick_scan_date_time: Optional[datetime] = None
    # The version anti-malware version used to perform the last full scan. Optional. Read-only.
