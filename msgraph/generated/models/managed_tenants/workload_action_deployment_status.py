...
class WorkloadActionDeploymentStatus(AdditionalDataHolder, Parsable):
    ...
    error: Optional[generic_error.GenericError] = None
    ...
    last_deployment_date_time: Optional[datetime] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The status property
    status: Optional[workload_action_status.WorkloadActionStatus] = None
