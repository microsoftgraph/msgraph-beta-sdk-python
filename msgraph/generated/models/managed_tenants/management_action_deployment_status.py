...
class ManagementActionDeploymentStatus(AdditionalDataHolder, Parsable):
    ...
    # The status property
    status: Optional[management_action_status.ManagementActionStatus] = None
    # The collection of workload action deployment statues for the given management action. Optional.
    workload_action_deployment_statuses: Optional[List[workload_action_deployment_status.WorkloadActionDeploymentStatus]] = None
