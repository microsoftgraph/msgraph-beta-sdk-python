...
class AccessReviewInstanceDecisionItem(entity.Entity):
    ...
    insights: Optional[List[governance_insight.GovernanceInsight]] = None
    ...
    instance: Optional[access_review_instance.AccessReviewInstance] = None
    ...
    principal_resource_membership: Optional[decision_item_principal_resource_membership.DecisionItemPrincipalResourceMembership] = None
    ...
    target: Optional[access_review_instance_decision_item_target.AccessReviewInstanceDecisionItemTarget] = None
