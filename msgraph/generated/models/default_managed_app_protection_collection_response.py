...
class DefaultManagedAppProtectionCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[default_managed_app_protection.DefaultManagedAppProtection]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(default_managed_app_protection.DefaultManagedAppProtection)),
        }
    ...
    @property
    def value(self,) -> Optional[List[default_managed_app_protection.DefaultManagedAppProtection]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[default_managed_app_protection.DefaultManagedAppProtection]] = None) -> None:
        """
