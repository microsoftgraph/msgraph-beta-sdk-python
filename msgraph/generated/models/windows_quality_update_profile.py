...
class WindowsQualityUpdateProfile(entity.Entity):
    ...
    assignments: Optional[List[windows_quality_update_profile_assignment.WindowsQualityUpdateProfileAssignment]] = None
    ...
    expedited_update_settings: Optional[expedited_windows_quality_update_settings.ExpeditedWindowsQualityUpdateSettings] = None
