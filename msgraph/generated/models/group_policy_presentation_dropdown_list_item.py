...
class GroupPolicyPresentationDropdownListItem(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GroupPolicyPresentationDropdownListItem:
        """
    ...
    def display_name(self,) -> Optional[str]:
        """
        Gets the displayName property value. Localized display name for the drop-down list item.
