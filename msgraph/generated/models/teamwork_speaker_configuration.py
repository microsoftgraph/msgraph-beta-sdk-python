...
class TeamworkSpeakerConfiguration(AdditionalDataHolder, Parsable):
    ...
    default_communication_speaker: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    # The defaultSpeaker property
    default_speaker: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    ...
    speakers: Optional[List[teamwork_peripheral.TeamworkPeripheral]] = None
