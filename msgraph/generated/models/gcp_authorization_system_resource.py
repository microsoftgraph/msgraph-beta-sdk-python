...
class GcpAuthorizationSystemResource(AuthorizationSystemResource):
    ...
    OdataType: Optional[str] = "#microsoft.graph.gcpAuthorizationSystemResource"
    # The service property
    service: Optional[AuthorizationSystemTypeService] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GcpAuthorizationSystemResource:
        """
