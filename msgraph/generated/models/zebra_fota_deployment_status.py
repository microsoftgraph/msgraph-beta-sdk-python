...
class ZebraFotaDeploymentStatus(AdditionalDataHolder, Parsable):
    ...
    complete_or_canceled_date_time: Optional[datetime] = None
    ...
    error_code: Optional[zebra_fota_error_code.ZebraFotaErrorCode] = None
    ...
    state: Optional[zebra_fota_deployment_state.ZebraFotaDeploymentState] = None
