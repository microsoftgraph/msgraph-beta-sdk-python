...
class TeamsAppDefinition(entity.Entity):
    ...
    allowed_installation_scopes: Optional[teams_app_installation_scopes.TeamsAppInstallationScopes] = None
    # Authorization requirements specified in the Teams app manifest.
    authorization: Optional[teams_app_authorization.TeamsAppAuthorization] = None
    ...
    color_icon: Optional[teams_app_icon.TeamsAppIcon] = None
    ...
    outline_icon: Optional[teams_app_icon.TeamsAppIcon] = None
