...
class CompanySubscription(entity.Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "ocpSubscriptionId": lambda n : setattr(self, 'ocp_subscription_id', n.get_str_value()),
            "serviceStatus": lambda n : setattr(self, 'service_status', n.get_collection_of_object_values(service_plan_info.ServicePlanInfo)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("ocpSubscriptionId", self.ocp_subscription_id)
