...
if TYPE_CHECKING:
    from . import currency, customer, payment_term, postal_address_type, sales_invoice_line, shipment_method

@dataclass
class SalesInvoice(AdditionalDataHolder, Parsable):
    ...
    shipping_postal_address: Optional[postal_address_type.PostalAddressType] = None
    # The status property
