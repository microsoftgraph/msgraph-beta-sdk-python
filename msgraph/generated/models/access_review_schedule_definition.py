...
class AccessReviewScheduleDefinition(entity.Entity):
    ...
    def backup_reviewers(self,value: Optional[List[access_review_reviewer_scope.AccessReviewReviewerScope]] = None) -> None:
        ...
        Args:
            value: Value to set for the backupReviewers property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "backup_reviewers": lambda n : setattr(self, 'backup_reviewers', n.get_collection_of_object_values(access_review_reviewer_scope.AccessReviewReviewerScope)),
