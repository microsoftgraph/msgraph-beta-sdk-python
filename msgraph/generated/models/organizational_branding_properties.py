...
if TYPE_CHECKING:
    from . import content_customization, entity, login_page_layout_configuration, login_page_text_visibility_settings, organizational_branding, organizational_branding_localization
...
class OrganizationalBrandingProperties(entity.Entity):
    ...
    content_customization: Optional[content_customization.ContentCustomization] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "contentCustomization": lambda n : setattr(self, 'content_customization', n.get_object_value(content_customization.ContentCustomization)),
