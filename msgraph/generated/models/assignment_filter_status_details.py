...
class AssignmentFilterStatusDetails(AdditionalDataHolder, Parsable):
    ...
    device_properties: Optional[List[key_value_pair.KeyValuePair]] = None
    # Evaluation result summaries for each filter associated to device and payload
    evalution_summaries: Optional[List[assignment_filter_evaluation_summary.AssignmentFilterEvaluationSummary]] = None
