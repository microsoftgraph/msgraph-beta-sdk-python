...
class DeviceConfigurationSettingState(AdditionalDataHolder, Parsable):
    ...
    def __init__(self,) -> None:
        ...
        # SettingInstanceId
        self._setting_instance_id: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "setting_instance_id": lambda n : setattr(self, 'setting_instance_id', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("settingInstanceId", self.setting_instance_id)
    ...
    @property
    def setting_instance_id(self,) -> Optional[str]:
        """
        Gets the settingInstanceId property value. SettingInstanceId
        Returns: Optional[str]
        """
        return self._setting_instance_id
    
    @setting_instance_id.setter
    def setting_instance_id(self,value: Optional[str] = None) -> None:
        """
        Sets the settingInstanceId property value. SettingInstanceId
        Args:
            value: Value to set for the settingInstanceId property.
        """
        self._setting_instance_id = value
