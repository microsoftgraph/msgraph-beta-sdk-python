...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, ios_lob_app_provisioning_configuration_assignment
...
class IosLobAppProvisioningConfigurationAssignmentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[ios_lob_app_provisioning_configuration_assignment.IosLobAppProvisioningConfigurationAssignment]] = None
