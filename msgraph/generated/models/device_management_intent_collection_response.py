...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, device_management_intent

from . import base_collection_pagination_count_response

class DeviceManagementIntentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeviceManagementIntentCollectionResponse:
        """
