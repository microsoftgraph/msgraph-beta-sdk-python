...
if TYPE_CHECKING:
    from . import authentication_event_listener, on_interactive_auth_flow_start_handler

from . import authentication_event_listener

class OnInteractiveAuthFlowStartListener(authentication_event_listener.AuthenticationEventListener):
    def __init__(self,) -> None:
        """
        Instantiates a new OnInteractiveAuthFlowStartListener and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.onInteractiveAuthFlowStartListener"
        ...
        self._handler: Optional[on_interactive_auth_flow_start_handler.OnInteractiveAuthFlowStartHandler] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> OnInteractiveAuthFlowStartListener:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "handler": lambda n : setattr(self, 'handler', n.get_object_value(on_interactive_auth_flow_start_handler.OnInteractiveAuthFlowStartHandler)),
        }
    ...
    @property
    def handler(self,) -> Optional[on_interactive_auth_flow_start_handler.OnInteractiveAuthFlowStartHandler]:
        """
    ...
    @handler.setter
    def handler(self,value: Optional[on_interactive_auth_flow_start_handler.OnInteractiveAuthFlowStartHandler] = None) -> None:
        """
