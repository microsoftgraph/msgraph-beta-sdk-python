...
class Team(entity.Entity):
    ...
    discovery_settings: Optional[team_discovery_settings.TeamDiscoverySettings] = None
    ...
    owners: Optional[List[user.User]] = None
    ...
    template_definition: Optional[team_template_definition.TeamTemplateDefinition] = None
