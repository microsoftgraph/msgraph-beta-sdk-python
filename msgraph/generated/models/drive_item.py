...
class DriveItem(base_item.BaseItem):
    ...
    def __init__(self,) -> None:
        ...
        self._media: Optional[media.Media] = None
        ...
        self._source: Optional[drive_item_source.DriveItemSource] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "media": lambda n : setattr(self, 'media', n.get_object_value(media.Media)),
            ...
            "source": lambda n : setattr(self, 'source', n.get_object_value(drive_item_source.DriveItemSource)),
    ...
    @property
    def media(self,) -> Optional[media.Media]:
        """
        ...
        Returns: Optional[media.Media]
        """
        return self._media
    
    @media.setter
    def media(self,value: Optional[media.Media] = None) -> None:
        """
    ...
    @property
    def source(self,) -> Optional[drive_item_source.DriveItemSource]:
        """
        ...
        Returns: Optional[drive_item_source.DriveItemSource]
        """
        return self._source
    
    @source.setter
    def source(self,value: Optional[drive_item_source.DriveItemSource] = None) -> None:
        """
