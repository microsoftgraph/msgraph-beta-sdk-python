...
class DriveItem(base_item.BaseItem):
    ...
    activities: Optional[List[item_activity_o_l_d.ItemActivityOLD]] = None
    ...
    media: Optional[media.Media] = None
    ...
    retention_label: Optional[item_retention_label.ItemRetentionLabel] = None
    ...
    source: Optional[drive_item_source.DriveItemSource] = None
