...
class AppleVpnAlwaysOnConfiguration(AdditionalDataHolder, Parsable):
    ...
    air_print_exception_action: Optional[vpn_service_exception_action.VpnServiceExceptionAction] = None
    ...
    allowed_captive_network_plugins: Optional[specified_captive_network_plugins.SpecifiedCaptiveNetworkPlugins] = None
    ...
    cellular_exception_action: Optional[vpn_service_exception_action.VpnServiceExceptionAction] = None
    ...
    tunnel_configuration: Optional[vpn_tunnel_configuration_type.VpnTunnelConfigurationType] = None
    ...
    voicemail_exception_action: Optional[vpn_service_exception_action.VpnServiceExceptionAction] = None
