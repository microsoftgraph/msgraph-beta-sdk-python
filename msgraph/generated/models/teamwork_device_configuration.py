...
class TeamworkDeviceConfiguration(entity.Entity):
    ...
    camera_configuration: Optional[teamwork_camera_configuration.TeamworkCameraConfiguration] = None
    ...
    display_configuration: Optional[teamwork_display_configuration.TeamworkDisplayConfiguration] = None
    # The hardware configuration. Applicable only for Teams Rooms-enabled devices.
    hardware_configuration: Optional[teamwork_hardware_configuration.TeamworkHardwareConfiguration] = None
    ...
    microphone_configuration: Optional[teamwork_microphone_configuration.TeamworkMicrophoneConfiguration] = None
    ...
    software_versions: Optional[teamwork_device_software_versions.TeamworkDeviceSoftwareVersions] = None
    # The speaker configuration. Applicable only for Teams Rooms-enabled devices.
    speaker_configuration: Optional[teamwork_speaker_configuration.TeamworkSpeakerConfiguration] = None
    # The system configuration. Not applicable for Teams Rooms-enabled devices.
    system_configuration: Optional[teamwork_system_configuration.TeamworkSystemConfiguration] = None
    # The Teams client configuration. Applicable only for Teams Rooms-enabled devices.
    teams_client_configuration: Optional[teamwork_teams_client_configuration.TeamworkTeamsClientConfiguration] = None
