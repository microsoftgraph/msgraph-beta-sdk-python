...
class WindowsDeliveryOptimizationConfiguration(device_configuration.DeviceConfiguration):
    ...
    bandwidth_mode: Optional[delivery_optimization_bandwidth.DeliveryOptimizationBandwidth] = None
    ...
    delivery_optimization_mode: Optional[windows_delivery_optimization_mode.WindowsDeliveryOptimizationMode] = None
    ...
    group_id_source: Optional[delivery_optimization_group_id_source.DeliveryOptimizationGroupIdSource] = None
    ...
    maximum_cache_size: Optional[delivery_optimization_max_cache_size.DeliveryOptimizationMaxCacheSize] = None
    ...
    restrict_peer_selection_by: Optional[delivery_optimization_restrict_peer_selection_by_options.DeliveryOptimizationRestrictPeerSelectionByOptions] = None
    # Possible values of a property
    vpn_peer_caching: Optional[enablement.Enablement] = None
