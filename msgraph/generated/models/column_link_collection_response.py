...
class ColumnLinkCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[column_link.ColumnLink]] = None
    ...
    @property
    def value(self,) -> Optional[List[column_link.ColumnLink]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[column_link.ColumnLink]] = None) -> None:
        """
