...
class WindowsPhone81ImportedPFXCertificateProfile(windows_certificate_profile_base.WindowsCertificateProfileBase):
    def __init__(self,) -> None:
        """
        Instantiates a new WindowsPhone81ImportedPFXCertificateProfile and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.windowsPhone81ImportedPFXCertificateProfile"
        # PFX Import Options.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> WindowsPhone81ImportedPFXCertificateProfile:
        """
