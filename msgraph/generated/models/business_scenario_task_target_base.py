...
if TYPE_CHECKING:
    from . import business_scenario_group_target, planner_task_target_kind
...
class BusinessScenarioTaskTargetBase(AdditionalDataHolder, Parsable):
    ...
    task_target_kind: Optional[planner_task_target_kind.PlannerTaskTargetKind] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> BusinessScenarioTaskTargetBase:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.businessScenarioGroupTarget":
                from . import business_scenario_group_target

                return business_scenario_group_target.BusinessScenarioGroupTarget()
