...
class ManagedDeviceMobileAppConfigurationPolicySetItem(policy_set_item.PolicySetItem):
    def __init__(self,) -> None:
        """
        Instantiates a new ManagedDeviceMobileAppConfigurationPolicySetItem and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.managedDeviceMobileAppConfigurationPolicySetItem"
