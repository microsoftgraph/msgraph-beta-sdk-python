...
class TrustedCertificateAuthorityAsEntityBase(directory_object.DirectoryObject):
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.trustedCertificateAuthorityAsEntityBase"
        # The trustedCertificateAuthorities property
        self._trusted_certificate_authorities: Optional[List[certificate_authority_as_entity.CertificateAuthorityAsEntity]] = None
    ...
    @property
    def trusted_certificate_authorities(self,) -> Optional[List[certificate_authority_as_entity.CertificateAuthorityAsEntity]]:
        """
        ...
        """
        return self._trusted_certificate_authorities
    
    @trusted_certificate_authorities.setter
    def trusted_certificate_authorities(self,value: Optional[List[certificate_authority_as_entity.CertificateAuthorityAsEntity]] = None) -> None:
        """
        Sets the trustedCertificateAuthorities property value. The trustedCertificateAuthorities property
        Args:
            value: Value to set for the trusted_certificate_authorities property.
        """
        self._trusted_certificate_authorities = value
