...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, user_registration_details
...
class UserRegistrationDetailsCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[user_registration_details.UserRegistrationDetails]] = None
