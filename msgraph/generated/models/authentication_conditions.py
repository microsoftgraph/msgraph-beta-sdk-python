...
authentication_conditions_applications = lazy_import('msgraph.generated.models.authentication_conditions_applications')

class AuthenticationConditions(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new authenticationConditions and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AuthenticationConditions:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "applications": lambda n : setattr(self, 'applications', n.get_object_value(authentication_conditions_applications.AuthenticationConditionsApplications)),
