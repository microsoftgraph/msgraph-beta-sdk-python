...
class AuthenticationAttributeCollectionInputConfiguration(AdditionalDataHolder, Parsable):
    ...
    input_type: Optional[authentication_attribute_collection_input_type.AuthenticationAttributeCollectionInputType] = None
    ...
    options: Optional[List[authentication_attribute_collection_option_configuration.AuthenticationAttributeCollectionOptionConfiguration]] = None
