...
class SoftDeleteResponseAction(ResponseAction):
    odata_type = "#microsoft.graph.security.softDeleteResponseAction"
    # The identifier property
    identifier: Optional[EmailEntityIdentifier] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SoftDeleteResponseAction:
        """
