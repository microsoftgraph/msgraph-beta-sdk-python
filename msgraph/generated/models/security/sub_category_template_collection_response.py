...
class SubCategoryTemplateCollectionResponse(BaseCollectionPaginationCountResponse):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SubCategoryTemplateCollectionResponse:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(SubCategoryTemplate)),
        }
