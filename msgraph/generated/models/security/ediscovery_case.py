...
class EdiscoveryCase(Case):
    ...
    OdataType: Optional[str] = "#microsoft.graph.security.ediscoveryCase"
    ...
    legal_holds: Optional[List[EdiscoveryHoldPolicy]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "legalHolds": lambda n : setattr(self, 'legal_holds', n.get_collection_of_object_values(EdiscoveryHoldPolicy)),
