...
if TYPE_CHECKING:
    from . import retention_duration

from . import retention_duration

class RetentionDurationForever(retention_duration.RetentionDuration):
    def __init__(self,) -> None:
        """
        Instantiates a new RetentionDurationForever and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.security.retentionDurationForever"
