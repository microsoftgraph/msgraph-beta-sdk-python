...
class EdiscoveryHoldOperation(case_operation.CaseOperation):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> EdiscoveryHoldOperation:
        """
