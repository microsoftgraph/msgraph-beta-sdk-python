...
class AssignmentFilterValidationResult(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        ...
        self._is_valid_rule: Optional[bool] = None
        # The OdataType property
        self._odata_type: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AssignmentFilterValidationResult:
        """
    ...
    @property
    def is_valid_rule(self,) -> Optional[bool]:
        """
        Gets the isValidRule property value. Indicator to valid or invalid rule.
        Returns: Optional[bool]
        """
        return self._is_valid_rule
    
    @is_valid_rule.setter
    def is_valid_rule(self,value: Optional[bool] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("isValidRule", self.is_valid_rule)
