...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, custom_access_package_workflow_extension
...
class CustomAccessPackageWorkflowExtensionCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[custom_access_package_workflow_extension.CustomAccessPackageWorkflowExtension]] = None
