...
class NoEntitlementsDataCollection(EntitlementsDataCollectionInfo):
    ...
    OdataType: Optional[str] = "#microsoft.graph.noEntitlementsDataCollection"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> NoEntitlementsDataCollection:
        """
