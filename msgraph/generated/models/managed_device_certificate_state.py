...
class ManagedDeviceCertificateState(entity.Entity):
    ...
    certificate_expiration_date_time: Optional[datetime] = None
    # Issuance date
    certificate_issuance_date_time: Optional[datetime] = None
    # Certificate Issuance State Options.
    certificate_issuance_state: Optional[certificate_issuance_states.CertificateIssuanceStates] = None
    # Issuer
    certificate_issuer: Optional[str] = None
    # Key length
    certificate_key_length: Optional[int] = None
    # Key Storage Provider (KSP) Import Options.
    certificate_key_storage_provider: Optional[key_storage_provider_option.KeyStorageProviderOption] = None
    # Key Usage Options.
    certificate_key_usage: Optional[key_usages.KeyUsages] = None
    # Last certificate issuance state change
    certificate_last_issuance_state_changed_date_time: Optional[datetime] = None
    # Certificate profile display name
    certificate_profile_display_name: Optional[str] = None
    # Certificate Revocation Status.
    certificate_revoke_status: Optional[certificate_revocation_status.CertificateRevocationStatus] = None
    # Serial number
    certificate_serial_number: Optional[str] = None
    # Subject Alternative Name Options.
    certificate_subject_alternative_name_format: Optional[subject_alternative_name_type.SubjectAlternativeNameType] = None
    ...
    certificate_subject_name_format: Optional[subject_name_format.SubjectNameFormat] = None
    ...
    certificate_validity_period_units: Optional[certificate_validity_period_scale.CertificateValidityPeriodScale] = None
    # Device display name
    device_display_name: Optional[str] = None
    # Supported platform types.
    device_platform: Optional[device_platform_type.DevicePlatformType] = None
    # Last certificate issuance state change
    last_certificate_state_change_date_time: Optional[datetime] = None
