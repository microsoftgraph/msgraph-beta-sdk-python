...
class ManagedDeviceCertificateState(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "certificateKeyUsage": lambda n : setattr(self, 'certificate_key_usage', n.get_enum_value(KeyUsages)),
            ...
            "certificateSubjectAlternativeNameFormat": lambda n : setattr(self, 'certificate_subject_alternative_name_format', n.get_enum_value(SubjectAlternativeNameType)),
