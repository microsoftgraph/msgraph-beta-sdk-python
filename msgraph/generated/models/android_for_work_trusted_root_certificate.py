...
class AndroidForWorkTrustedRootCertificate(device_configuration.DeviceConfiguration):
    @property
    ...
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.androidForWorkTrustedRootCertificate"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AndroidForWorkTrustedRootCertificate:
        """
