...
class ManagedDevice(entity.Entity):
    ...
    assignment_filter_evaluation_status_details: Optional[List[assignment_filter_evaluation_status_details.AssignmentFilterEvaluationStatusDetails]] = None
    ...
    # Chassis type.
    chassis_type: Optional[chassis_type.ChassisType] = None
    ...
    chrome_o_s_device_info: Optional[List[chrome_o_s_device_property.ChromeOSDeviceProperty]] = None
    # The cloudPcRemoteActionResults property
    cloud_pc_remote_action_results: Optional[List[cloud_pc_remote_action_result.CloudPcRemoteActionResult]] = None
    ...
    configuration_manager_client_health_state: Optional[configuration_manager_client_health_state.ConfigurationManagerClientHealthState] = None
    # Configuration manager client information, valid only for devices managed, duel-managed or tri-managed by ConfigMgr Agent
    configuration_manager_client_information: Optional[configuration_manager_client_information.ConfigurationManagerClientInformation] = None
    ...
    device_health_script_states: Optional[List[device_health_script_policy_state.DeviceHealthScriptPolicyState]] = None
    ...
    hardware_information: Optional[hardware_information.HardwareInformation] = None
    ...
    join_type: Optional[join_type.JoinType] = None
    ...
    log_collection_requests: Optional[List[device_log_collection_response.DeviceLogCollectionResponse]] = None
    # State of lost mode, indicating if lost mode is enabled or disabled
    lost_mode_state: Optional[lost_mode_state.LostModeState] = None
    # Managed device mobile app configuration states for this device.
    managed_device_mobile_app_configuration_states: Optional[List[managed_device_mobile_app_configuration_state.ManagedDeviceMobileAppConfigurationState]] = None
    ...
    management_features: Optional[managed_device_management_features.ManagedDeviceManagementFeatures] = None
    ...
    prefer_mdm_over_group_policy_applied_date_time: Optional[datetime] = None
    # Processor architecture
    processor_architecture: Optional[managed_device_architecture.ManagedDeviceArchitecture] = None
    ...
    security_baseline_states: Optional[List[security_baseline_state.SecurityBaselineState]] = None
    ...
    users_logged_on: Optional[List[logged_on_user.LoggedOnUser]] = None
    ...
    windows_protection_state: Optional[windows_protection_state.WindowsProtectionState] = None
