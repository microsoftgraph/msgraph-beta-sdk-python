...
class AccessPackageAssignmentRequestWorkflowExtension(custom_callout_extension.CustomCalloutExtension):
    def __init__(self,) -> None:
        """
        Instantiates a new AccessPackageAssignmentRequestWorkflowExtension and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.accessPackageAssignmentRequestWorkflowExtension"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AccessPackageAssignmentRequestWorkflowExtension:
        """
