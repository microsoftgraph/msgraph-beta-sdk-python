...
class AndroidManagedStoreAppConfigurationSchema(entity.Entity):
    ...
    nested_schema_items: Optional[List[android_managed_store_app_configuration_schema_item.AndroidManagedStoreAppConfigurationSchemaItem]] = None
    ...
    schema_items: Optional[List[android_managed_store_app_configuration_schema_item.AndroidManagedStoreAppConfigurationSchemaItem]] = None
