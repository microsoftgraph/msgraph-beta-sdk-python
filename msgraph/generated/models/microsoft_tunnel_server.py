...
class MicrosoftTunnelServer(entity.Entity):
    ...
    last_checkin_date_time: Optional[datetime] = None
    ...
    tunnel_server_health_status: Optional[microsoft_tunnel_server_health_status.MicrosoftTunnelServerHealthStatus] = None
