...
class CloudPcBulkReprovision(CloudPcBulkAction):
    ...
    OdataType: Optional[str] = "#microsoft.graph.cloudPcBulkReprovision"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> CloudPcBulkReprovision:
        """
