...
class CloudPcOnPremisesConnectionHealthCheck(AdditionalDataHolder, Parsable):
    ...
    error_type: Optional[cloud_pc_on_premises_connection_health_check_error_type.CloudPcOnPremisesConnectionHealthCheckErrorType] = None
    ...
    # The status property
    status: Optional[cloud_pc_on_premises_connection_status.CloudPcOnPremisesConnectionStatus] = None
