...
class CloudPcOnPremisesConnection(entity.Entity):
    ...
    health_check_status: Optional[cloud_pc_on_premises_connection_status.CloudPcOnPremisesConnectionStatus] = None
    ...
    health_check_status_details: Optional[cloud_pc_on_premises_connection_status_details.CloudPcOnPremisesConnectionStatusDetails] = None
    ...
    managed_by: Optional[cloud_pc_management_service.CloudPcManagementService] = None
    ...
    type: Optional[cloud_pc_on_premises_connection_type.CloudPcOnPremisesConnectionType] = None
