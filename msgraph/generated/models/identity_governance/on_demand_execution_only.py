...
class OnDemandExecutionOnly(workflow_execution_conditions.WorkflowExecutionConditions):
    def __init__(self,) -> None:
        """
        Instantiates a new OnDemandExecutionOnly and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.identityGovernance.onDemandExecutionOnly"
