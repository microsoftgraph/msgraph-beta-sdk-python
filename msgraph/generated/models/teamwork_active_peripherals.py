...
class TeamworkActivePeripherals(AdditionalDataHolder, Parsable):
    ...
    communication_speaker: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    # The contentCamera property
    content_camera: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    # The microphone property
    microphone: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The roomCamera property
    room_camera: Optional[teamwork_peripheral.TeamworkPeripheral] = None
    # The speaker property
    speaker: Optional[teamwork_peripheral.TeamworkPeripheral] = None
