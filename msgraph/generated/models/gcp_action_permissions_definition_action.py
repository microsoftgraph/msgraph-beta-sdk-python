...
class GcpActionPermissionsDefinitionAction(GcpPermissionsDefinitionAction):
    ...
    OdataType: Optional[str] = "#microsoft.graph.gcpActionPermissionsDefinitionAction"
    # The actions property
    actions: Optional[List[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GcpActionPermissionsDefinitionAction:
        """
