...
class ExpressionEvaluationDetails(AdditionalDataHolder, Parsable):
    ...
    expression_evaluation_details: Optional[List[expression_evaluation_details.ExpressionEvaluationDetails]] = None
    ...
    property_to_evaluate: Optional[property_to_evaluate.PropertyToEvaluate] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "expressionEvaluationDetails": lambda n : setattr(self, 'expression_evaluation_details', n.get_collection_of_object_values(expression_evaluation_details.ExpressionEvaluationDetails)),
