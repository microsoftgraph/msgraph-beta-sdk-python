...
class MacOSPrivacyAccessControlItem(AdditionalDataHolder, Parsable):
    ...
    accessibility: Optional[enablement.Enablement] = None
    # Possible values of a property
    address_book: Optional[enablement.Enablement] = None
    ...
    apple_events_allowed_receivers: Optional[List[mac_o_s_apple_event_receiver.MacOSAppleEventReceiver]] = None
    ...
    # Possible values of a property
    calendar: Optional[enablement.Enablement] = None
    ...
    # Possible values of a property
    file_provider_presence: Optional[enablement.Enablement] = None
    # The bundle ID or path of the app, process, or executable.
    identifier: Optional[str] = None
    # Process identifier types for MacOS Privacy Preferences
    identifier_type: Optional[mac_o_s_process_identifier_type.MacOSProcessIdentifierType] = None
    # Possible values of a property
    media_library: Optional[enablement.Enablement] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # Possible values of a property
    photos: Optional[enablement.Enablement] = None
    # Possible values of a property
    post_event: Optional[enablement.Enablement] = None
    # Possible values of a property
    reminders: Optional[enablement.Enablement] = None
    # Possible values of a property
    speech_recognition: Optional[enablement.Enablement] = None
    ...
    # Possible values of a property
    system_policy_all_files: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_desktop_folder: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_documents_folder: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_downloads_folder: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_network_volumes: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_removable_volumes: Optional[enablement.Enablement] = None
    # Possible values of a property
    system_policy_system_admin_files: Optional[enablement.Enablement] = None
