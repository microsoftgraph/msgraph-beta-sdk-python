...
class VirtualEventRegistrationQuestionAnswer(AdditionalDataHolder, Parsable):
    def __init__(self,) -> None:
        ...
        self._multi_choice_values: Optional[List[str]] = None
    ...
    def boolean_value(self,value: Optional[bool] = None) -> None:
        """
        Sets the booleanValue property value. The booleanValue property
        Args:
            value: Value to set for the boolean_value property.
        """
    ...
    @property
    def multi_choice_values(self,) -> Optional[List[str]]:
        """
        Gets the multiChoiceValues property value. The multiChoiceValues property
        Returns: Optional[List[str]]
        """
        return self._multi_choice_values
    
    @multi_choice_values.setter
    def multi_choice_values(self,value: Optional[List[str]] = None) -> None:
        """
        Sets the multiChoiceValues property value. The multiChoiceValues property
        Args:
            value: Value to set for the multi_choice_values property.
        """
        self._multi_choice_values = value
