...
class BookingBusiness(booking_named_entity.BookingNamedEntity):
    odata_type = "#microsoft.graph.bookingBusiness"
    ...
    customers: Optional[List[booking_customer.BookingCustomer]] = None
    ...
    staff_members: Optional[List[booking_staff_member.BookingStaffMember]] = None
