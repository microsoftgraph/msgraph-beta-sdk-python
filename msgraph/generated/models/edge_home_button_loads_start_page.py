...
class EdgeHomeButtonLoadsStartPage(edge_home_button_configuration.EdgeHomeButtonConfiguration):
    def __init__(self,) -> None:
        """
        Instantiates a new EdgeHomeButtonLoadsStartPage and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.edgeHomeButtonLoadsStartPage"
