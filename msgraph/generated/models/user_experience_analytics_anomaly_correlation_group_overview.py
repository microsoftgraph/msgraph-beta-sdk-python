...
if TYPE_CHECKING:
    from . import entity, user_experience_analytics_anomaly_correlation_group_feature, user_experience_analytics_anomaly_correlation_group_prevalence

from . import entity

@dataclass
class UserExperienceAnalyticsAnomalyCorrelationGroupOverview(entity.Entity):
    """
    ...
    correlation_group_features: Optional[List[user_experience_analytics_anomaly_correlation_group_feature.UserExperienceAnalyticsAnomalyCorrelationGroupFeature]] = None
    ...
    correlation_group_prevalence: Optional[user_experience_analytics_anomaly_correlation_group_prevalence.UserExperienceAnalyticsAnomalyCorrelationGroupPrevalence] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> UserExperienceAnalyticsAnomalyCorrelationGroupOverview:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "correlationGroupFeatures": lambda n : setattr(self, 'correlation_group_features', n.get_collection_of_object_values(user_experience_analytics_anomaly_correlation_group_feature.UserExperienceAnalyticsAnomalyCorrelationGroupFeature)),
            "correlationGroupId": lambda n : setattr(self, 'correlation_group_id', n.get_str_value()),
            "correlationGroupPrevalence": lambda n : setattr(self, 'correlation_group_prevalence', n.get_enum_value(user_experience_analytics_anomaly_correlation_group_prevalence.UserExperienceAnalyticsAnomalyCorrelationGroupPrevalence)),
