...
class KeyBooleanValuePair(key_typed_value_pair.KeyTypedValuePair):
    def __init__(self,) -> None:
        """
        Instantiates a new KeyBooleanValuePair and sets the default values.
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.keyBooleanValuePair"
        # The Boolean value of the key-value pair.
        self._value: Optional[bool] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> KeyBooleanValuePair:
        """
