...
class BitLockerSystemDrivePolicy(AdditionalDataHolder, Parsable):
    ...
    startup_authentication_tpm_key_usage: Optional[configuration_usage.ConfigurationUsage] = None
    # Possible values of the ConfigurationUsage list.
    startup_authentication_tpm_pin_and_key_usage: Optional[configuration_usage.ConfigurationUsage] = None
    # Possible values of the ConfigurationUsage list.
    startup_authentication_tpm_pin_usage: Optional[configuration_usage.ConfigurationUsage] = None
    # Possible values of the ConfigurationUsage list.
    startup_authentication_tpm_usage: Optional[configuration_usage.ConfigurationUsage] = None
