...
class GroupPolicyConfigurationAssignment(entity.Entity):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GroupPolicyConfigurationAssignment:
        """
