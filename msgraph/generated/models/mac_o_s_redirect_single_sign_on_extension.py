...
class MacOSRedirectSingleSignOnExtension(mac_o_s_single_sign_on_extension.MacOSSingleSignOnExtension):
    @property
    ...
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.macOSRedirectSingleSignOnExtension"
