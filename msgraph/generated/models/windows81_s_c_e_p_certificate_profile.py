...
class Windows81SCEPCertificateProfile(windows81_certificate_profile_base.Windows81CertificateProfileBase):
    ...
    def __init__(self,) -> None:
        ...
        """
        super().__init__()
        self.odata_type = "#microsoft.graph.windows81SCEPCertificateProfile"
        ...
        self._root_certificate: Optional[windows81_trusted_root_certificate.Windows81TrustedRootCertificate] = None
        # SCEP Server Url(s).
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "root_certificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(windows81_trusted_root_certificate.Windows81TrustedRootCertificate)),
    ...
    @property
    def root_certificate(self,) -> Optional[windows81_trusted_root_certificate.Windows81TrustedRootCertificate]:
        """
    ...
    def root_certificate(self,value: Optional[windows81_trusted_root_certificate.Windows81TrustedRootCertificate] = None) -> None:
        """
