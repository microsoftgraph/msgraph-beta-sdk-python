...
class WindowsUpdateForBusinessConfiguration(device_configuration.DeviceConfiguration):
    ...
    def device_update_states(self,value: Optional[List[windows_update_state.WindowsUpdateState]] = None) -> None:
        ...
        Args:
            value: Value to set for the device_update_states property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "deviceUpdateStates": lambda n : setattr(self, 'device_update_states', n.get_collection_of_object_values(windows_update_state.WindowsUpdateState)),
