...
class AndroidCompliancePolicy(device_compliance_policy.DeviceCompliancePolicy):
    ...
    advanced_threat_protection_required_security_level: Optional[device_threat_protection_level.DeviceThreatProtectionLevel] = None
    # Condition statement id.
    condition_statement_id: Optional[str] = None
    ...
    restricted_apps: Optional[List[app_list_item.AppListItem]] = None
