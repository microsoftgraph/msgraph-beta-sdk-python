...
from . import android_required_password_complexity, android_required_password_type, app_list_item, device_compliance_policy, device_threat_protection_level
...
class AndroidCompliancePolicy(device_compliance_policy.DeviceCompliancePolicy):
    ...
    @property
    def condition_statement_id(self,) -> Optional[str]:
        """
        Gets the conditionStatementId property value. Condition statement id.
        Returns: Optional[str]
        """
        return self._condition_statement_id
    
    @condition_statement_id.setter
    def condition_statement_id(self,value: Optional[str] = None) -> None:
        """
        Sets the conditionStatementId property value. Condition statement id.
        Args:
            value: Value to set for the conditionStatementId property.
        """
        self._condition_statement_id = value
    ...
    def __init__(self,) -> None:
        ...
        self._condition_statement_id: Optional[str] = None
        ...
        self._security_block_device_administrator_managed_devices: Optional[bool] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "condition_statement_id": lambda n : setattr(self, 'condition_statement_id', n.get_str_value()),
            ...
            "restricted_apps": lambda n : setattr(self, 'restricted_apps', n.get_collection_of_object_values(app_list_item.AppListItem)),
            "security_block_device_administrator_managed_devices": lambda n : setattr(self, 'security_block_device_administrator_managed_devices', n.get_bool_value()),
    ...
    @property
    def security_block_device_administrator_managed_devices(self,) -> Optional[bool]:
        """
        Gets the securityBlockDeviceAdministratorManagedDevices property value. Block device administrator managed devices.
        Returns: Optional[bool]
        """
        return self._security_block_device_administrator_managed_devices
    
    @security_block_device_administrator_managed_devices.setter
    def security_block_device_administrator_managed_devices(self,value: Optional[bool] = None) -> None:
        """
        Sets the securityBlockDeviceAdministratorManagedDevices property value. Block device administrator managed devices.
        Args:
            value: Value to set for the securityBlockDeviceAdministratorManagedDevices property.
        """
        self._security_block_device_administrator_managed_devices = value
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("securityBlockDeviceAdministratorManagedDevices", self.security_block_device_administrator_managed_devices)
