...
class UnifiedRoleAssignmentScheduleRequest(request.Request):
    odata_type = "#microsoft.graph.unifiedRoleAssignmentScheduleRequest"
    ...
    target_schedule: Optional[unified_role_assignment_schedule.UnifiedRoleAssignmentSchedule] = None
