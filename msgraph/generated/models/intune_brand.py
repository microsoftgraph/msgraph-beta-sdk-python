...
class IntuneBrand(AdditionalDataHolder, Parsable):
    ...
    company_portal_blocked_actions: Optional[List[company_portal_blocked_action.CompanyPortalBlockedAction]] = None
    ...
    enrollment_availability: Optional[enrollment_availability_options.EnrollmentAvailabilityOptions] = None
    ...
    landing_page_customized_image: Optional[mime_content.MimeContent] = None
