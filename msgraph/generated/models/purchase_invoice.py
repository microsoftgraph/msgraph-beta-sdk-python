...
if TYPE_CHECKING:
    from . import currency, postal_address_type, purchase_invoice_line, vendor

@dataclass
class PurchaseInvoice(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: Dict[str, Any] = field(default_factory=dict)

    # The buyFromAddress property
    buy_from_address: Optional[postal_address_type.PostalAddressType] = None
    ...
    pay_to_address: Optional[postal_address_type.PostalAddressType] = None
    ...
    ship_to_address: Optional[postal_address_type.PostalAddressType] = None
    ...
    # The vendor property
    vendor: Optional[vendor.Vendor] = None
