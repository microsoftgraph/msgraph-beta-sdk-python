...
class WindowsProtectionState(entity.Entity):
    ...
    # Device malware list
    detected_malware_state: Optional[List[windows_device_malware_state.WindowsDeviceMalwareState]] = None
    ...
    device_state: Optional[windows_device_health_state.WindowsDeviceHealthState] = None
    ...
    product_status: Optional[windows_defender_product_status.WindowsDefenderProductStatus] = None
