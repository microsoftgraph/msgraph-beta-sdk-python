...
class DeviceManagementUserRightsSetting(AdditionalDataHolder, Parsable):
    ...
    local_users_or_groups: Optional[List[device_management_user_rights_local_user_or_group.DeviceManagementUserRightsLocalUserOrGroup]] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # State Management Setting.
    state: Optional[state_management_setting.StateManagementSetting] = None
