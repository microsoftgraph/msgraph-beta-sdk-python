...
if TYPE_CHECKING:
    from . import base_collection_pagination_count_response, intune_branding_profile_assignment
...
class IntuneBrandingProfileAssignmentCollectionResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[intune_branding_profile_assignment.IntuneBrandingProfileAssignment]] = None
