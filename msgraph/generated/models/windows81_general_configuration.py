...
class Windows81GeneralConfiguration(device_configuration.DeviceConfiguration):
    ...
    minimum_auto_install_classification: Optional[update_classification.UpdateClassification] = None
    ...
    # Possible values for automatic update classification.
    updates_minimum_auto_install_classification: Optional[update_classification.UpdateClassification] = None
