...
from . import access_review_instance, agreement_acceptance, app_consent_request, app_role_assignment, approval, assigned_license, assigned_plan, authentication, authorization_info, calendar, calendar_group, chat, cloud_p_c, contact, contact_folder, custom_security_attribute_value, device, device_enrollment_configuration, device_key, device_management_troubleshooting_event, directory_object, drive, employee_org_data, event, extension, group, inference_classification, information_protection, item_insights, license_assignment_state, license_details, mail_folder, mailbox_settings, managed_app_registration, managed_device, message, mobile_app_intent_and_state, mobile_app_troubleshooting_event, notification, o_auth2_permission_grant, object_identity, on_premises_extension_attributes, on_premises_provisioning_error, onenote, online_meeting, outlook_user, password_profile, person, planner_user, presence, profile, profile_photo, provisioned_plan, scoped_role_membership, service_principal, sign_in_activity, site, team, todo, usage_right, user_activity, user_analytics, user_print, user_settings, user_teamwork, windows_information_protection_device_registration
...
class User(directory_object.DirectoryObject):
    ...
    def app_role_assigned_resources(self,value: Optional[List[service_principal.ServicePrincipal]] = None) -> None:
        ...
        Args:
            value: Value to set for the appRoleAssignedResources property.
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "app_consent_requests_for_approval": lambda n : setattr(self, 'app_consent_requests_for_approval', n.get_collection_of_object_values(app_consent_request.AppConsentRequest)),
            "app_role_assigned_resources": lambda n : setattr(self, 'app_role_assigned_resources', n.get_collection_of_object_values(service_principal.ServicePrincipal)),
            ...
            "custom_security_attributes": lambda n : setattr(self, 'custom_security_attributes', n.get_object_value(custom_security_attribute_value.CustomSecurityAttributeValue)),
            ...
            "device_keys": lambda n : setattr(self, 'device_keys', n.get_collection_of_object_values(device_key.DeviceKey)),
            ...
            "external_user_state_change_date_time": lambda n : setattr(self, 'external_user_state_change_date_time', n.get_str_value()),
            ...
            "info_catalogs": lambda n : setattr(self, 'info_catalogs', n.get_collection_of_primitive_values(str)),
            ...
            "joined_groups": lambda n : setattr(self, 'joined_groups', n.get_collection_of_object_values(group.Group)),
            ...
            "mobile_app_intent_and_states": lambda n : setattr(self, 'mobile_app_intent_and_states', n.get_collection_of_object_values(mobile_app_intent_and_state.MobileAppIntentAndState)),
            ...
            "pending_access_review_instances": lambda n : setattr(self, 'pending_access_review_instances', n.get_collection_of_object_values(access_review_instance.AccessReviewInstance)),
            ...
            "sign_in_activity": lambda n : setattr(self, 'sign_in_activity', n.get_object_value(sign_in_activity.SignInActivity)),
