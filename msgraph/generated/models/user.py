...
class User(directory_object.DirectoryObject):
    ...
    analytics: Optional[user_analytics.UserAnalytics] = None
    # The appConsentRequestsForApproval property
    app_consent_requests_for_approval: Optional[List[app_consent_request.AppConsentRequest]] = None
    # The appRoleAssignedResources property
    app_role_assigned_resources: Optional[List[service_principal.ServicePrincipal]] = None
    # Represents the app roles a user has been granted for an application. Supports $expand.
    app_role_assignments: Optional[List[app_role_assignment.AppRoleAssignment]] = None
    # The approvals property
    approvals: Optional[List[approval.Approval]] = None
    ...
    custom_security_attributes: Optional[custom_security_attribute_value.CustomSecurityAttributeValue] = None
    ...
    device_keys: Optional[List[device_key.DeviceKey]] = None
    ...
    devices: Optional[List[device.Device]] = None
    ...
    employee_experience: Optional[employee_experience_user.EmployeeExperienceUser] = None
    ...
    insights: Optional[item_insights.ItemInsights] = None
    ...
    joined_groups: Optional[List[group.Group]] = None
    ...
    # The list of troubleshooting events for this user.
    mobile_app_intent_and_states: Optional[List[mobile_app_intent_and_state.MobileAppIntentAndState]] = None
    ...
    notifications: Optional[List[notification.Notification]] = None
    ...
    pending_access_review_instances: Optional[List[access_review_instance.AccessReviewInstance]] = None
    ...
    # The print property
    print: Optional[user_print.UserPrint] = None
    ...
    security: Optional[security.Security] = None
    ...
    service_provisioning_errors: Optional[List[service_provisioning_error.ServiceProvisioningError]] = None
    ...
    transitive_reports: Optional[List[directory_object.DirectoryObject]] = None
    ...
    usage_rights: Optional[List[usage_right.UsageRight]] = None
