...
class User(DirectoryObject):
    ...
    app_consent_requests_for_approval: Optional[List[AppConsentRequest]] = None
    # The appRoleAssignedResources property
    app_role_assigned_resources: Optional[List[ServicePrincipal]] = None
    ...
    device_keys: Optional[List[DeviceKey]] = None
    ...
    joined_groups: Optional[List[Group]] = None
    ...
    pending_access_review_instances: Optional[List[AccessReviewInstance]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "appConsentRequestsForApproval": lambda n : setattr(self, 'app_consent_requests_for_approval', n.get_collection_of_object_values(AppConsentRequest)),
            "appRoleAssignedResources": lambda n : setattr(self, 'app_role_assigned_resources', n.get_collection_of_object_values(ServicePrincipal)),
            "appRoleAssignments": lambda n : setattr(self, 'app_role_assignments', n.get_collection_of_object_values(AppRoleAssignment)),
            "approvals": lambda n : setattr(self, 'approvals', n.get_collection_of_object_values(Approval)),
            ...
            "deviceKeys": lambda n : setattr(self, 'device_keys', n.get_collection_of_object_values(DeviceKey)),
            ...
            "joinedGroups": lambda n : setattr(self, 'joined_groups', n.get_collection_of_object_values(Group)),
            ...
            "mobileAppIntentAndStates": lambda n : setattr(self, 'mobile_app_intent_and_states', n.get_collection_of_object_values(MobileAppIntentAndState)),
            ...
            "notifications": lambda n : setattr(self, 'notifications', n.get_collection_of_object_values(Notification)),
            ...
            "pendingAccessReviewInstances": lambda n : setattr(self, 'pending_access_review_instances', n.get_collection_of_object_values(AccessReviewInstance)),
            ...
            "security": lambda n : setattr(self, 'security', n.get_object_value(Security)),
            ...
            "transitiveReports": lambda n : setattr(self, 'transitive_reports', n.get_collection_of_object_values(DirectoryObject)),
            ...
            "virtualEvents": lambda n : setattr(self, 'virtual_events', n.get_object_value(UserVirtualEventsRoot)),
