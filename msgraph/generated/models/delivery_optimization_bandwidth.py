...
class DeliveryOptimizationBandwidth(AdditionalDataHolder, Parsable):
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DeliveryOptimizationBandwidth:
        ...
        if mapping_value_node:
            ...
            if mapping_value == "#microsoft.graph.deliveryOptimizationBandwidthAbsolute":
            ...
            if mapping_value == "#microsoft.graph.deliveryOptimizationBandwidthHoursWithPercentage":
            ...
            if mapping_value == "#microsoft.graph.deliveryOptimizationBandwidthPercentage":
