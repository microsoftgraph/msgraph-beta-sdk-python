...
class RiskDetection(entity.Entity):
    ...
    @property
    def risk_type(self,) -> Optional[risk_event_type.RiskEventType]:
        """
        Gets the riskType property value. The riskType property
        Returns: Optional[risk_event_type.RiskEventType]
        """
        return self._risk_type
    
    @risk_type.setter
    def risk_type(self,value: Optional[risk_event_type.RiskEventType] = None) -> None:
        """
