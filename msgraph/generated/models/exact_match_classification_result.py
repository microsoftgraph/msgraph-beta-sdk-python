...
class ExactMatchClassificationResult(AdditionalDataHolder, Parsable):
    ...
    classification: Optional[List[exact_match_detected_sensitive_content.ExactMatchDetectedSensitiveContent]] = None
    # The errors property
    errors: Optional[List[classification_error.ClassificationError]] = None
