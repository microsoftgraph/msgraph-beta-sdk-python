...
if TYPE_CHECKING:
    from . import currency, payment_method, payment_term, picture, postal_address_type, shipment_method
...
class Customer(AdditionalDataHolder, Parsable):
    ...
    shipment_method: Optional[shipment_method.ShipmentMethod] = None
    ...
    tax_area_id: Optional[UUID] = None
