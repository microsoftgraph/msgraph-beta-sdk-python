...
class Customer(entity.Entity):
    def __init__(self,) -> None:
        ...
        self._tax_area_id: Optional[UUID] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "taxAreaDisplayName": lambda n : setattr(self, 'tax_area_display_name', n.get_str_value()),
            "taxAreaId": lambda n : setattr(self, 'tax_area_id', n.get_uuid_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_uuid_value("taxAreaId", self.tax_area_id)
    ...
    def tax_area_display_name(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the tax_area_display_name property.
        """
        self._tax_area_display_name = value
    
    @property
    def tax_area_id(self,) -> Optional[UUID]:
        """
    ...
    @tax_area_id.setter
    def tax_area_id(self,value: Optional[UUID] = None) -> None:
        """
        Sets the taxAreaId property value. The taxAreaId property
        Args:
            value: Value to set for the tax_area_id property.
        """
