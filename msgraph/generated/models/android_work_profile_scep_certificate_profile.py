...
if TYPE_CHECKING:
    from . import android_work_profile_certificate_profile_base, certificate_store, custom_subject_alternative_name, hash_algorithms, key_size, key_usages, managed_device_certificate_state
...
class AndroidWorkProfileScepCertificateProfile(android_work_profile_certificate_profile_base.AndroidWorkProfileCertificateProfileBase):
    odata_type = "#microsoft.graph.androidWorkProfileScepCertificateProfile"
