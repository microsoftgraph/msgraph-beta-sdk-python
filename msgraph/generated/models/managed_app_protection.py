...
class ManagedAppProtection(managed_app_policy.ManagedAppPolicy):
    ...
    allowed_data_ingestion_locations: Optional[List[managed_app_data_ingestion_location.ManagedAppDataIngestionLocation]] = None
    # Data storage locations where a user may store managed data.
    ...
    app_action_if_device_compliance_required: Optional[managed_app_remediation_action.ManagedAppRemediationAction] = None
    # An admin initiated action to be applied on a managed app.
    app_action_if_maximum_pin_retries_exceeded: Optional[managed_app_remediation_action.ManagedAppRemediationAction] = None
    ...
    dialer_restriction_level: Optional[managed_app_phone_number_redirect_level.ManagedAppPhoneNumberRedirectLevel] = None
    ...
    grace_period_to_block_apps_during_off_clock_hours: Optional[timedelta] = None
    ...
    mobile_threat_defense_partner_priority: Optional[mobile_threat_defense_partner_priority.MobileThreatDefensePartnerPriority] = None
    # An admin initiated action to be applied on a managed app.
    ...
    notification_restriction: Optional[managed_app_notification_restriction.ManagedAppNotificationRestriction] = None
    ...
    pin_required_instead_of_biometric_timeout: Optional[timedelta] = None
