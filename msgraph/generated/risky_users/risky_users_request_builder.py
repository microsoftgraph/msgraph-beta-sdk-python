...
count_request_builder = lazy_import('msgraph.generated.risky_users.count.count_request_builder')
microsoft_graph_confirm_compromised_request_builder = lazy_import('msgraph.generated.risky_users.microsoft_graph_confirm_compromised.microsoft_graph_confirm_compromised_request_builder')
microsoft_graph_dismiss_request_builder = lazy_import('msgraph.generated.risky_users.microsoft_graph_dismiss.microsoft_graph_dismiss_request_builder')
...
class RiskyUsersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/riskyUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[risky_user.RiskyUser] = None, request_configuration: Optional[RiskyUsersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to riskyUsers
        Args:
            body: The request body
