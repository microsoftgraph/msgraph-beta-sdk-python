...
confirm_compromised_post_request_body = lazy_import('msgraph.generated.risky_users.confirm_compromised.confirm_compromised_post_request_body')
...
class ConfirmCompromisedRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/riskyUsers/confirmCompromised"
