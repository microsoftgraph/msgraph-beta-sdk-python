...
token_issuance_policy_collection_response = lazy_import('msgraph.generated.models.token_issuance_policy_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.policies.token_issuance_policies.count.count_request_builder')
...
class TokenIssuancePoliciesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/tokenIssuancePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[token_issuance_policy.TokenIssuancePolicy] = None, request_configuration: Optional[TokenIssuancePoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def post(self,body: Optional[token_issuance_policy.TokenIssuancePolicy] = None, request_configuration: Optional[TokenIssuancePoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[token_issuance_policy.TokenIssuancePolicy]:
        """
        Create a new tokenIssuancePolicy object.
        Args:
            body: The request body
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
            responseHandler: Response handler to use in place of the default response handling provided by the core service
        Returns: Optional[token_issuance_policy.TokenIssuancePolicy]
        """
        if body is None:
            raise Exception("body cannot be undefined")
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, token_issuance_policy.TokenIssuancePolicy, response_handler, error_mapping)
