...
class FederatedTokenValidationPolicyRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/federatedTokenValidationPolicy{?%24select,%24expand}"
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class FederatedTokenValidationPolicyRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
