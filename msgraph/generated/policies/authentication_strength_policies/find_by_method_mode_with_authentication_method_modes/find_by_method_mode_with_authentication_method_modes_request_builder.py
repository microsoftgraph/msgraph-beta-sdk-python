...
if TYPE_CHECKING:
    ...
    from .find_by_method_mode_with_authentication_method_modes_response import FindByMethodModeWithAuthenticationMethodModesResponse
...
class FindByMethodModeWithAuthenticationMethodModesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[FindByMethodModeWithAuthenticationMethodModesRequestBuilderGetRequestConfiguration] = None) -> Optional[FindByMethodModeWithAuthenticationMethodModesResponse]:
        ...
        Returns: Optional[FindByMethodModeWithAuthenticationMethodModesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, FindByMethodModeWithAuthenticationMethodModesResponse, error_mapping)
