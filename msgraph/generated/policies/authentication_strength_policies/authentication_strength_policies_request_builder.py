...
microsoft_graph_find_by_method_mode_with_authentication_method_modes_request_builder = lazy_import('msgraph.generated.policies.authentication_strength_policies.microsoft_graph_find_by_method_mode_with_authentication_method_modes.microsoft_graph_find_by_method_mode_with_authentication_method_modes_request_builder')
...
class AuthenticationStrengthPoliciesRequestBuilder():
    ...
    def microsoft_graph_find_by_method_mode_with_authentication_method_modes(self,authentication_method_modes: Optional[str] = None) -> microsoft_graph_find_by_method_mode_with_authentication_method_modes_request_builder.MicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilder:
        """
        ...
        Returns: microsoft_graph_find_by_method_mode_with_authentication_method_modes_request_builder.MicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilder
        """
        if authentication_method_modes is None:
            raise Exception("authentication_method_modes cannot be undefined")
        return microsoft_graph_find_by_method_mode_with_authentication_method_modes_request_builder.MicrosoftGraphFindByMethodModeWithAuthenticationMethodModesRequestBuilder(self.request_adapter, self.path_parameters, authenticationMethodModes)
