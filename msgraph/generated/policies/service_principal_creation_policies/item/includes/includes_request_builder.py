...
class IncludesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[IncludesRequestBuilderGetRequestConfiguration] = None) -> Optional[service_principal_creation_condition_set_collection_response.ServicePrincipalCreationConditionSetCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[service_principal_creation_condition_set.ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[IncludesRequestBuilderPostRequestConfiguration] = None) -> Optional[service_principal_creation_condition_set.ServicePrincipalCreationConditionSet]:
        """
