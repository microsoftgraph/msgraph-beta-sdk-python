...
class ServicePrincipalCreationConditionSetItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ServicePrincipalCreationConditionSetItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ServicePrincipalCreationConditionSetItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[service_principal_creation_condition_set.ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[ServicePrincipalCreationConditionSetItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
