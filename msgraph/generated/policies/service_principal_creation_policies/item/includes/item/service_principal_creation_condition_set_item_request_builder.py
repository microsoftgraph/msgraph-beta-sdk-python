...
class ServicePrincipalCreationConditionSetItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, service_principal_creation_condition_set_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            servicePrincipalCreationConditionSetId: key: id of servicePrincipalCreationConditionSet
        """
        ...
        url_tpl_params["servicePrincipalCreationConditionSet%2Did"] = servicePrincipalCreationConditionSetId
    ...
    def to_patch_request_information(self,body: Optional[service_principal_creation_condition_set.ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[ServicePrincipalCreationConditionSetItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property includes in policies
        Args:
            body: The request body
