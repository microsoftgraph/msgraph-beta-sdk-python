...
class ServicePrincipalCreationPolicyItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[service_principal_creation_policy.ServicePrincipalCreationPolicy] = None, request_configuration: Optional[ServicePrincipalCreationPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property servicePrincipalCreationPolicies in policies
        Args:
            body: The request body
