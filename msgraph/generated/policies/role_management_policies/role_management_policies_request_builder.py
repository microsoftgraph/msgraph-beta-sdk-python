...
class RoleManagementPoliciesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RoleManagementPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[unified_role_management_policy_collection_response.UnifiedRoleManagementPolicyCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, unified_role_management_policy_collection_response.UnifiedRoleManagementPolicyCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[unified_role_management_policy.UnifiedRoleManagementPolicy] = None, request_configuration: Optional[RoleManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> Optional[unified_role_management_policy.UnifiedRoleManagementPolicy]:
        """
