...
app_management_policy_collection_response = lazy_import('msgraph.generated.models.app_management_policy_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.policies.app_management_policies.count.count_request_builder')
...
class AppManagementPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AppManagementPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[app_management_policy.AppManagementPolicy] = None, request_configuration: Optional[AppManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def post(self,body: Optional[app_management_policy.AppManagementPolicy] = None, request_configuration: Optional[AppManagementPoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[app_management_policy.AppManagementPolicy]:
        """
        Create an appManagementPolicy object.
        Args:
            body: The request body
