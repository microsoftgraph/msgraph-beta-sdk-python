...
class MobileAppManagementPoliciesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[mobility_management_policy.MobilityManagementPolicy] = None, request_configuration: Optional[MobileAppManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to mobileAppManagementPolicies for policies
        Args:
            body: The request body
