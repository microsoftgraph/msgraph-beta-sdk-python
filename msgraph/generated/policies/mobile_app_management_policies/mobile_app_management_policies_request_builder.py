...
class MobileAppManagementPoliciesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/policies/mobileAppManagementPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[MobileAppManagementPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[MobilityManagementPolicyCollectionResponse]:
        """
        Get a list of the mobilityManagementPolicy objects and their properties. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[MobilityManagementPolicy] = None, request_configuration: Optional[MobileAppManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> Optional[MobilityManagementPolicy]:
        """
    ...
    def to_post_request_information(self,body: Optional[MobilityManagementPolicy] = None, request_configuration: Optional[MobileAppManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to mobileAppManagementPolicies for policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MobileAppManagementPoliciesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MobileAppManagementPoliciesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return MobileAppManagementPoliciesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class MobileAppManagementPoliciesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[MobileAppManagementPoliciesRequestBuilder.MobileAppManagementPoliciesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class MobileAppManagementPoliciesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
