...
ref_request_builder = lazy_import('msgraph.generated.policies.mobile_app_management_policies.item.included_groups.item.ref.ref_request_builder')
...
class GroupItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}"
