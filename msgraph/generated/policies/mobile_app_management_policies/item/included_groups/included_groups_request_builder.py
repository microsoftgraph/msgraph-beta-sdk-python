...
count_request_builder = lazy_import('msgraph.generated.policies.mobile_app_management_policies.item.included_groups.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.policies.mobile_app_management_policies.item.included_groups.ref.ref_request_builder')
...
class IncludedGroupsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
