...
if TYPE_CHECKING:
    from ......models import cross_tenant_identity_sync_policy_partner
    from ......models.o_data_errors import o_data_error

class IdentitySynchronizationRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}/identitySynchronization{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[IdentitySynchronizationRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[IdentitySynchronizationRequestBuilderGetRequestConfiguration] = None) -> Optional[cross_tenant_identity_sync_policy_partner.CrossTenantIdentitySyncPolicyPartner]:
        ...
        return await self.request_adapter.send_async(request_info, cross_tenant_identity_sync_policy_partner.CrossTenantIdentitySyncPolicyPartner, error_mapping)
    ...
    @dataclass
    class IdentitySynchronizationRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class IdentitySynchronizationRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
