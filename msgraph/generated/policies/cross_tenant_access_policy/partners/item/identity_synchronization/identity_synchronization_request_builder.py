...
class IdentitySynchronizationRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class IdentitySynchronizationRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class IdentitySynchronizationRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
