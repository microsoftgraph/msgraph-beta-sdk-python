...
class DeviceRegistrationPolicyRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
