...
class B2cAuthenticationMethodsPolicyRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[B2cAuthenticationMethodsPolicyRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[B2cAuthenticationMethodsPolicyRequestBuilderGetRequestConfiguration] = None) -> Optional[b2c_authentication_methods_policy.B2cAuthenticationMethodsPolicy]:
        ...
        return await self.request_adapter.send_async(request_info, b2c_authentication_methods_policy.B2cAuthenticationMethodsPolicy, error_mapping)
