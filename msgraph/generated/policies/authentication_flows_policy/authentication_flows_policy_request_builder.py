...
if TYPE_CHECKING:
    from ...models.authentication_flows_policy import AuthenticationFlowsPolicy
    from ...models.o_data_errors.o_data_error import ODataError

class AuthenticationFlowsPolicyRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/policies/authenticationFlowsPolicy{?%24select,%24expand}", path_parameters)
    ...
    async def patch(self,body: Optional[AuthenticationFlowsPolicy] = None, request_configuration: Optional[AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration] = None) -> Optional[AuthenticationFlowsPolicy]:
        """
        Update the Boolean selfServiceSignUp property of an authenticationFlowsPolicy object. The properties id, type, and description cannot be modified. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AuthenticationFlowsPolicyRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AuthenticationFlowsPolicyRequestBuilder
        """
        if not raw_url:
