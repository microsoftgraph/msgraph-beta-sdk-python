...
count_request_builder = lazy_import('msgraph.generated.policies.mobile_device_management_policies.count.count_request_builder')
...
class MobileDeviceManagementPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MobileDeviceManagementPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mobility_management_policy.MobilityManagementPolicy] = None, request_configuration: Optional[MobileDeviceManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[MobileDeviceManagementPoliciesRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mobility_management_policy_collection_response.MobilityManagementPolicyCollectionResponse]:
        """
        Get a list of the mobilityManagementPolicy objects and their properties.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def post(self,body: Optional[mobility_management_policy.MobilityManagementPolicy] = None, request_configuration: Optional[MobileDeviceManagementPoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mobility_management_policy.MobilityManagementPolicy]:
        """
        Create new navigation property to mobileDeviceManagementPolicies for policies
        Args:
            body: The request body
    ...
    class MobileDeviceManagementPoliciesRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[MobileDeviceManagementPoliciesRequestBuilder.MobileDeviceManagementPoliciesRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class MobileDeviceManagementPoliciesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
