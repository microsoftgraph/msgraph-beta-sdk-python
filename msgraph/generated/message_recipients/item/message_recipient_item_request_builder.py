...
events_request_builder = lazy_import('msgraph.generated.message_recipients.item.events.events_request_builder')
message_event_item_request_builder = lazy_import('msgraph.generated.message_recipients.item.events.item.message_event_item_request_builder')
...
class MessageRecipientItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/messageRecipients/{messageRecipient%2Did}{?%24select,%24expand}"
