...
count_request_builder = lazy_import('msgraph.generated.approval_workflow_providers.count.count_request_builder')
approval_workflow_provider = lazy_import('msgraph.generated.models.approval_workflow_provider')
approval_workflow_provider_collection_response = lazy_import('msgraph.generated.models.approval_workflow_provider_collection_response')
...
class ApprovalWorkflowProvidersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/approvalWorkflowProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ApprovalWorkflowProvidersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[approval_workflow_provider.ApprovalWorkflowProvider] = None, request_configuration: Optional[ApprovalWorkflowProvidersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
