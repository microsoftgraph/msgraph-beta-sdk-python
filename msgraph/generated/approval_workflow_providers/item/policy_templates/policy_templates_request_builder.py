...
count_request_builder = lazy_import('msgraph.generated.approval_workflow_providers.item.policy_templates.count.count_request_builder')
governance_policy_template = lazy_import('msgraph.generated.models.governance_policy_template')
governance_policy_template_collection_response = lazy_import('msgraph.generated.models.governance_policy_template_collection_response')
...
class PolicyTemplatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PolicyTemplatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[governance_policy_template.GovernancePolicyTemplate] = None, request_configuration: Optional[PolicyTemplatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
