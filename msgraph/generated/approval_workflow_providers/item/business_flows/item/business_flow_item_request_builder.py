...
microsoft_graph_record_decisions_request_builder = lazy_import('msgraph.generated.approval_workflow_providers.item.business_flows.item.microsoft_graph_record_decisions.microsoft_graph_record_decisions_request_builder')
...
class BusinessFlowItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/approvalWorkflowProviders/{approvalWorkflowProvider%2Did}/businessFlows/{businessFlow%2Did}{?%24select,%24expand}"
