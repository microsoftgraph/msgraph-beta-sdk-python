...
class BusinessFlowsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[business_flow.BusinessFlow] = None, request_configuration: Optional[BusinessFlowsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to businessFlows for approvalWorkflowProviders
        Args:
            body: The request body
