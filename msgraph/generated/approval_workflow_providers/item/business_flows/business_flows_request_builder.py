...
count_request_builder = lazy_import('msgraph.generated.approval_workflow_providers.item.business_flows.count.count_request_builder')
business_flow = lazy_import('msgraph.generated.models.business_flow')
business_flow_collection_response = lazy_import('msgraph.generated.models.business_flow_collection_response')
...
class BusinessFlowsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[BusinessFlowsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[business_flow.BusinessFlow] = None, request_configuration: Optional[BusinessFlowsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
