...
from_term_request_builder = lazy_import('msgraph.generated.term_store.sets.item.terms.item.children.item.relations.item.from_term.from_term_request_builder')
set_request_builder = lazy_import('msgraph.generated.term_store.sets.item.terms.item.children.item.relations.item.set.set_request_builder')
to_term_request_builder = lazy_import('msgraph.generated.term_store.sets.item.terms.item.children.item.relations.item.to_term.to_term_request_builder')
...
class RelationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24select,%24expand}"
