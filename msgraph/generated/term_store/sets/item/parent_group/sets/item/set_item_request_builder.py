...
children_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.children.children_request_builder')
term_item_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.children.item.term_item_request_builder')
relations_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.relations.relations_request_builder')
relation_item_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.relations.item.relation_item_request_builder')
terms_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.terms.terms_request_builder')
term_item_request_builder = lazy_import('msgraph.generated.term_store.sets.item.parent_group.sets.item.terms.item.term_item_request_builder')
...
class SetItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}{?%24select,%24expand}"
