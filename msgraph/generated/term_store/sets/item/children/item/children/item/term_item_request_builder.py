...
relations_request_builder = lazy_import('msgraph.generated.term_store.sets.item.children.item.children.item.relations.relations_request_builder')
relation_item_request_builder = lazy_import('msgraph.generated.term_store.sets.item.children.item.children.item.relations.item.relation_item_request_builder')
set_request_builder = lazy_import('msgraph.generated.term_store.sets.item.children.item.children.item.set.set_request_builder')
...
class TermItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/termStore/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}"
