...
sets_request_builder = lazy_import('msgraph.generated.term_store.groups.item.sets.sets_request_builder')
set_item_request_builder = lazy_import('msgraph.generated.term_store.groups.item.sets.item.set_item_request_builder')
...
class GroupItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/termStore/groups/{group%2Did}{?%24select,%24expand}"
    ...
    def create_delete_request_information(self,request_configuration: Optional[GroupItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property groups for termStore
        Args:
