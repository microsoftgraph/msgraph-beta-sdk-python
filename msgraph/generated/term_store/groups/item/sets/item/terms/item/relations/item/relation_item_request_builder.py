...
from_term_request_builder = lazy_import('msgraph.generated.term_store.groups.item.sets.item.terms.item.relations.item.from_term.from_term_request_builder')
set_request_builder = lazy_import('msgraph.generated.term_store.groups.item.sets.item.terms.item.relations.item.set.set_request_builder')
to_term_request_builder = lazy_import('msgraph.generated.term_store.groups.item.sets.item.terms.item.relations.item.to_term.to_term_request_builder')
...
class RelationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}"
