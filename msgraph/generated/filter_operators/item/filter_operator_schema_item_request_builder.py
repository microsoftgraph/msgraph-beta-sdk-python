...
class FilterOperatorSchemaItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, filter_operator_schema_id: Optional[str] = None) -> None:
        """
        Instantiates a new FilterOperatorSchemaItemRequestBuilder and sets the default values.
        Args:
            filterOperatorSchemaId: key: id of filterOperatorSchema
        ...
        url_tpl_params["filterOperatorSchema%2Did"] = filterOperatorSchemaId
