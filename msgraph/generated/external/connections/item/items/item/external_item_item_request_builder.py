...
add_activities_request_builder = lazy_import('msgraph.generated.external.connections.item.items.item.microsoft_graph_external_connectors_add_activities.add_activities_request_builder')
...
class ExternalItemItemRequestBuilder():
    ...
    @property
    def microsoft_graph_external_connectors_add_activities(self) -> add_activities_request_builder.AddActivitiesRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, external_item_id: Optional[str] = None) -> None:
        """
        Instantiates a new ExternalItemItemRequestBuilder and sets the default values.
        Args:
            externalItemId: key: id of externalItem
        ...
        url_tpl_params["externalItem%2Did"] = externalItemId
