...
activities_request_builder = lazy_import('msgraph.generated.external.connections.item.items.item.activities.activities_request_builder')
external_activity_item_request_builder = lazy_import('msgraph.generated.external.connections.item.items.item.activities.item.external_activity_item_request_builder')
add_activities_request_builder = lazy_import('msgraph.generated.external.connections.item.items.item.add_activities.add_activities_request_builder')
...
class ExternalItemItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[ExternalItemItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ExternalItemItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[external_item.ExternalItem] = None, request_configuration: Optional[ExternalItemItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class ExternalItemItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[ExternalItemItemRequestBuilder.ExternalItemItemRequestBuilderGetQueryParameters] = None
