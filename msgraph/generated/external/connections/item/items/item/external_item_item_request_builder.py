...
microsoft_graph_external_connectors_add_activities_request_builder = lazy_import('msgraph.generated.external.connections.item.items.item.microsoft_graph_external_connectors_add_activities.microsoft_graph_external_connectors_add_activities_request_builder')
