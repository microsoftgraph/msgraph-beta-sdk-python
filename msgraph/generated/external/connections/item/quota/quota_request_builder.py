...
class QuotaRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[QuotaRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[connection_quota.ConnectionQuota] = None, request_configuration: Optional[QuotaRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property quota in external
        Args:
            body: The request body
