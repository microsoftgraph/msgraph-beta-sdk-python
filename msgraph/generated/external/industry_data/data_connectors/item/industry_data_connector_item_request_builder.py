...
industry_data_validate_request_builder = lazy_import('msgraph.generated.external.industry_data.data_connectors.item.industry_data_validate.industry_data_validate_request_builder')
source_system_request_builder = lazy_import('msgraph.generated.external.industry_data.data_connectors.item.source_system.source_system_request_builder')
...
class IndustryDataConnectorItemRequestBuilder():
    ...
    def source_system(self) -> source_system_request_builder.SourceSystemRequestBuilder:
        ...
        """
        return source_system_request_builder.SourceSystemRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[IndustryDataConnectorItemRequestBuilderGetRequestConfiguration] = None) -> Optional[industry_data_connector.IndustryDataConnector]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, industry_data_connector.IndustryDataConnector, error_mapping)
    ...
    @dataclass
    class IndustryDataConnectorItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class IndustryDataConnectorItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class IndustryDataConnectorItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
