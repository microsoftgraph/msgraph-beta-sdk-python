...
class IndustryDataValidateRequestBuilder():
    """
    Provides operations to call the validate method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new IndustryDataValidateRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}/industryData.validate"
    ...
    @dataclass
    class IndustryDataValidateRequestBuilderPostRequestConfiguration():
        """
