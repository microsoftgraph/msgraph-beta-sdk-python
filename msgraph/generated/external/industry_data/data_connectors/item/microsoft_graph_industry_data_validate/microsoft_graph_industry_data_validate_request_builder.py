...
class MicrosoftGraphIndustryDataValidateRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/dataConnectors/{industryDataConnector%2Did}/microsoft.graph.industryData.validate"
    ...
    @dataclass
    class MicrosoftGraphIndustryDataValidateRequestBuilderPostRequestConfiguration():
        """
