...
count_request_builder = lazy_import('msgraph.generated.external.industry_data.data_connectors.count.count_request_builder')
industry_data_connector = lazy_import('msgraph.generated.models.industry_data.industry_data_connector')
industry_data_connector_collection_response = lazy_import('msgraph.generated.models.industry_data.industry_data_connector_collection_response')
...
class DataConnectorsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/dataConnectors{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[DataConnectorsRequestBuilderGetRequestConfiguration] = None) -> Optional[industry_data_connector_collection_response.IndustryDataConnectorCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, industry_data_connector_collection_response.IndustryDataConnectorCollectionResponse, error_mapping)
    ...
    @dataclass
    class DataConnectorsRequestBuilderGetRequestConfiguration():
        """
