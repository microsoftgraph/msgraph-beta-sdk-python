...
if TYPE_CHECKING:
    from .....models.industry_data.year_time_period_definition import YearTimePeriodDefinition
    from .....models.o_data_errors.o_data_error import ODataError

class YearTimePeriodDefinitionItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/years/{yearTimePeriodDefinition%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[YearTimePeriodDefinitionItemRequestBuilderGetRequestConfiguration] = None) -> Optional[YearTimePeriodDefinition]:
        ...
        return await self.request_adapter.send_async(request_info, YearTimePeriodDefinition, error_mapping)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> YearTimePeriodDefinitionItemRequestBuilder:
        """
    ...
    @dataclass
    class YearTimePeriodDefinitionItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class YearTimePeriodDefinitionItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class YearTimePeriodDefinitionItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
