...
if TYPE_CHECKING:
    from .....models.industry_data import source_system_definition
    from .....models.o_data_errors import o_data_error

class SourceSystemDefinitionItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/sourceSystems/{sourceSystemDefinition%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[SourceSystemDefinitionItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[SourceSystemDefinitionItemRequestBuilderGetRequestConfiguration] = None) -> Optional[source_system_definition.SourceSystemDefinition]:
        ...
        return await self.request_adapter.send_async(request_info, source_system_definition.SourceSystemDefinition, error_mapping)
    ...
    @dataclass
    class SourceSystemDefinitionItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class SourceSystemDefinitionItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
