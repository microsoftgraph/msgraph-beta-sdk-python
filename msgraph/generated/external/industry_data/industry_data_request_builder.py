...
data_connectors_request_builder = lazy_import('msgraph.generated.external.industry_data.data_connectors.data_connectors_request_builder')
industry_data_connector_item_request_builder = lazy_import('msgraph.generated.external.industry_data.data_connectors.item.industry_data_connector_item_request_builder')
inbound_flows_request_builder = lazy_import('msgraph.generated.external.industry_data.inbound_flows.inbound_flows_request_builder')
inbound_flow_item_request_builder = lazy_import('msgraph.generated.external.industry_data.inbound_flows.item.inbound_flow_item_request_builder')
operations_request_builder = lazy_import('msgraph.generated.external.industry_data.operations.operations_request_builder')
long_running_operation_item_request_builder = lazy_import('msgraph.generated.external.industry_data.operations.item.long_running_operation_item_request_builder')
reference_definitions_request_builder = lazy_import('msgraph.generated.external.industry_data.reference_definitions.reference_definitions_request_builder')
reference_definition_item_request_builder = lazy_import('msgraph.generated.external.industry_data.reference_definitions.item.reference_definition_item_request_builder')
role_groups_request_builder = lazy_import('msgraph.generated.external.industry_data.role_groups.role_groups_request_builder')
role_group_item_request_builder = lazy_import('msgraph.generated.external.industry_data.role_groups.item.role_group_item_request_builder')
runs_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.runs_request_builder')
industry_data_run_item_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.item.industry_data_run_item_request_builder')
source_systems_request_builder = lazy_import('msgraph.generated.external.industry_data.source_systems.source_systems_request_builder')
source_system_definition_item_request_builder = lazy_import('msgraph.generated.external.industry_data.source_systems.item.source_system_definition_item_request_builder')
years_request_builder = lazy_import('msgraph.generated.external.industry_data.years.years_request_builder')
year_time_period_definition_item_request_builder = lazy_import('msgraph.generated.external.industry_data.years.item.year_time_period_definition_item_request_builder')
