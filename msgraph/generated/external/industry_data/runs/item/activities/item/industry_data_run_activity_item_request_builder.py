...
class IndustryDataRunActivityItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}{?%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> IndustryDataRunActivityItemRequestBuilder:
        """
        ...
        return IndustryDataRunActivityItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class IndustryDataRunActivityItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[IndustryDataRunActivityItemRequestBuilder.IndustryDataRunActivityItemRequestBuilderGetQueryParameters] = None
