...
activities_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.item.activities.activities_request_builder')
industry_data_run_activity_item_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.item.activities.item.industry_data_run_activity_item_request_builder')
industry_data_get_statistics_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.item.industry_data_get_statistics.industry_data_get_statistics_request_builder')
industry_data_run = lazy_import('msgraph.generated.models.industry_data.industry_data_run')
