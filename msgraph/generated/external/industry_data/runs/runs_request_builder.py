...
count_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.count.count_request_builder')
industry_data_get_statistics_request_builder = lazy_import('msgraph.generated.external.industry_data.runs.industry_data_get_statistics.industry_data_get_statistics_request_builder')
industry_data_run_collection_response = lazy_import('msgraph.generated.models.industry_data.industry_data_run_collection_response')
...
class RunsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/external/industryData/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[RunsRequestBuilderGetRequestConfiguration] = None) -> Optional[industry_data_run_collection_response.IndustryDataRunCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, industry_data_run_collection_response.IndustryDataRunCollectionResponse, error_mapping)
