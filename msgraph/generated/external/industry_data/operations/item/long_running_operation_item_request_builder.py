...
class LongRunningOperationItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/operations/{longRunningOperation%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[LongRunningOperationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[LongRunningOperation]:
        """
        Read the properties and relationships of a fileValidateOperation object. This API is available in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LongRunningOperation]
        Find more info here: https://learn.microsoft.com/graph/api/industrydata-filevalidateoperation-get?view=graph-rest-1.0
        """
