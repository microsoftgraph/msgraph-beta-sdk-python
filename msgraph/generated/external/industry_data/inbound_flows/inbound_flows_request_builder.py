...
count_request_builder = lazy_import('msgraph.generated.external.industry_data.inbound_flows.count.count_request_builder')
inbound_flow = lazy_import('msgraph.generated.models.industry_data.inbound_flow')
inbound_flow_collection_response = lazy_import('msgraph.generated.models.industry_data.inbound_flow_collection_response')
...
class InboundFlowsRequestBuilder():
    ...
    @dataclass
    class InboundFlowsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class InboundFlowsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
