...
class GetYammerActivityUserDetailWithPeriodRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[GetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getYammerActivityUserDetail
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
