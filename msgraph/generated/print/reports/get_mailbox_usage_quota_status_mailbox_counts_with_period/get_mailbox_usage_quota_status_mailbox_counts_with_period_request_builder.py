...
class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getMailboxUsageQuotaStatusMailboxCounts
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
