...
get_office365_active_user_detail_with_period_response = lazy_import('msgraph.generated.print.reports.microsoft_graph_get_office365_active_user_detail_with_period.get_office365_active_user_detail_with_period_response')
...
class GetOffice365ActiveUserDetailWithPeriodRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/microsoft.graph.getOffice365ActiveUserDetail(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
