...
class GetM365AppUserDetailWithDateRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, date: Optional[Date] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/microsoft.graph.getM365AppUserDetail(date={date})"
    ...
    def create_get_request_information(self,request_configuration: Optional[GetM365AppUserDetailWithDateRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetM365AppUserDetailWithDateRequestBuilderGetRequestConfiguration():
        """
