...
class MicrosoftGraphManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[MicrosoftGraphManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilderGetRequestConfiguration] = None) -> Optional[report.Report]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[MicrosoftGraphManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function managedDeviceEnrollmentFailureDetails
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
