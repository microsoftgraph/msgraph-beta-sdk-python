...
class GetSharePointSiteUsagePagesWithPeriodRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[GetSharePointSiteUsagePagesWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getSharePointSiteUsagePages
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
