...
class GetMailboxUsageStorageWithPeriodRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/microsoft.graph.getMailboxUsageStorage(period='{period}')"
    ...
    async def get(self,request_configuration: Optional[GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getMailboxUsageStorage
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
