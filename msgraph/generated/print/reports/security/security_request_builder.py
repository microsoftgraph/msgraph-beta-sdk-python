...
microsoft_graph_get_attack_simulation_repeat_offenders_request_builder = lazy_import('msgraph.generated.print.reports.security.microsoft_graph_get_attack_simulation_repeat_offenders.microsoft_graph_get_attack_simulation_repeat_offenders_request_builder')
microsoft_graph_get_attack_simulation_simulation_user_coverage_request_builder = lazy_import('msgraph.generated.print.reports.security.microsoft_graph_get_attack_simulation_simulation_user_coverage.microsoft_graph_get_attack_simulation_simulation_user_coverage_request_builder')
microsoft_graph_get_attack_simulation_training_user_coverage_request_builder = lazy_import('msgraph.generated.print.reports.security.microsoft_graph_get_attack_simulation_training_user_coverage.microsoft_graph_get_attack_simulation_training_user_coverage_request_builder')
...
class SecurityRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/security{?%24select,%24expand}"
