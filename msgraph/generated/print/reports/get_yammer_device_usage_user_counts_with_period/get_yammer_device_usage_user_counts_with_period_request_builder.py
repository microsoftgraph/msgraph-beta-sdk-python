...
class GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[GetYammerDeviceUsageUserCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getYammerDeviceUsageUserCounts
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
