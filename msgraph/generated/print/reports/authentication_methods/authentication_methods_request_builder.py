...
microsoft_graph_users_registered_by_feature_request_builder = lazy_import('msgraph.generated.print.reports.authentication_methods.microsoft_graph_users_registered_by_feature.microsoft_graph_users_registered_by_feature_request_builder')
microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder = lazy_import('msgraph.generated.print.reports.authentication_methods.microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles.microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder')
microsoft_graph_users_registered_by_method_request_builder = lazy_import('msgraph.generated.print.reports.authentication_methods.microsoft_graph_users_registered_by_method.microsoft_graph_users_registered_by_method_request_builder')
microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder = lazy_import('msgraph.generated.print.reports.authentication_methods.microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles.microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder')
...
class AuthenticationMethodsRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_users_registered_by_feature(self) -> microsoft_graph_users_registered_by_feature_request_builder.MicrosoftGraphUsersRegisteredByFeatureRequestBuilder:
        """
        Provides operations to call the usersRegisteredByFeature method.
        """
        return microsoft_graph_users_registered_by_feature_request_builder.MicrosoftGraphUsersRegisteredByFeatureRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_users_registered_by_method(self) -> microsoft_graph_users_registered_by_method_request_builder.MicrosoftGraphUsersRegisteredByMethodRequestBuilder:
        """
        Provides operations to call the usersRegisteredByMethod method.
        """
        return microsoft_graph_users_registered_by_method_request_builder.MicrosoftGraphUsersRegisteredByMethodRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles(self,included_user_roles: Optional[str] = None, included_user_types: Optional[str] = None) -> microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder:
        """
        Provides operations to call the usersRegisteredByFeature method.
        Args:
            includedUserRoles: Usage: includedUserRoles='{includedUserRoles}'
            includedUserTypes: Usage: includedUserTypes='{includedUserTypes}'
        Returns: microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder
        """
        ...
        return microsoft_graph_users_registered_by_feature_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByFeatureWithIncludedUserTypesWithIncludedUserRolesRequestBuilder(self.request_adapter, self.path_parameters, includedUserRoles, includedUserTypes)
    
    def microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles(self,included_user_roles: Optional[str] = None, included_user_types: Optional[str] = None) -> microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder:
        """
        Provides operations to call the usersRegisteredByMethod method.
        Args:
            includedUserRoles: Usage: includedUserRoles='{includedUserRoles}'
            includedUserTypes: Usage: includedUserTypes='{includedUserTypes}'
        Returns: microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder
        """
        if included_user_roles is None:
            raise Exception("included_user_roles cannot be undefined")
        if included_user_types is None:
            raise Exception("included_user_types cannot be undefined")
        return microsoft_graph_users_registered_by_method_with_included_user_types_with_included_user_roles_request_builder.MicrosoftGraphUsersRegisteredByMethodWithIncludedUserTypesWithIncludedUserRolesRequestBuilder(self.request_adapter, self.path_parameters, includedUserRoles, includedUserTypes)
