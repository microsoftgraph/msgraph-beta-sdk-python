...
class UserRegistrationDetailsItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user_registration_details_id: Optional[str] = None) -> None:
        """
        Instantiates a new UserRegistrationDetailsItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            userRegistrationDetailsId: key: id of userRegistrationDetails
        """
        ...
        url_tpl_params["userRegistrationDetails%2Did"] = userRegistrationDetailsId
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[UserRegistrationDetailsItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def patch(self,body: Optional[user_registration_details.UserRegistrationDetails] = None, request_configuration: Optional[UserRegistrationDetailsItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[user_registration_details.UserRegistrationDetails]:
        """
