...
count_request_builder = lazy_import('msgraph.generated.print.reports.authentication_methods.user_registration_details.count.count_request_builder')
...
class UserRegistrationDetailsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/authenticationMethods/userRegistrationDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
