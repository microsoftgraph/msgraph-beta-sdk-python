...
class GetM365AppUserDetailWithPeriodRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/reports/microsoft.graph.getM365AppUserDetail(period='{period}')"
    ...
    def create_get_request_information(self,request_configuration: Optional[GetM365AppUserDetailWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[GetM365AppUserDetailWithPeriodRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke function getM365AppUserDetail
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
