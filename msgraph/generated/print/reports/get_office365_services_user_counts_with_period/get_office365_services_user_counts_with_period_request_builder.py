...
get_office365_services_user_counts_with_period_response = lazy_import('msgraph.generated.print.reports.get_office365_services_user_counts_with_period.get_office365_services_user_counts_with_period_response')

class GetOffice365ServicesUserCountsWithPeriodRequestBuilder():
    """
    ...
    def create_get_request_information(self,request_configuration: Optional[GetOffice365ServicesUserCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetOffice365ServicesUserCountsWithPeriodRequestBuilderGetRequestConfiguration():
        """
