...
class PrintOperationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PrintOperationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[PrintOperationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get operations from print
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    class PrintOperationItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[PrintOperationItemRequestBuilder.PrintOperationItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class PrintOperationItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
