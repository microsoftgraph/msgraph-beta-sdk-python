...
if TYPE_CHECKING:
    ...
    from .create_post_request_body import CreatePostRequestBody
...
class CreateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/printers/create", path_parameters)
    ...
    async def post(self,body: Optional[CreatePostRequestBody] = None, request_configuration: Optional[CreateRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        Create (register) a printer with the Universal Print service. This is a long-running operation and as such, it returns a printerCreateOperation that can be used to track and verify the registration of the printer. This API is available in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CreateRequestBuilder:
        """
    ...
    @dataclass
    class CreateRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
