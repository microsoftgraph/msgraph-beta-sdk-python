...
ref_request_builder = lazy_import('msgraph.generated.print.printer_shares.item.allowed_groups.item.ref.ref_request_builder')
...
class GroupItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedGroups/{group%2Did}"
