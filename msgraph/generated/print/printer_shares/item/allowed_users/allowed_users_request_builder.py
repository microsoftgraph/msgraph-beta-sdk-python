...
count_request_builder = lazy_import('msgraph.generated.print.printer_shares.item.allowed_users.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.print.printer_shares.item.allowed_users.ref.ref_request_builder')
...
class AllowedUsersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
