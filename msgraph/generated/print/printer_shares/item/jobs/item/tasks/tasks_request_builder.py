...
class TasksRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[TasksRequestBuilderGetRequestConfiguration] = None) -> Optional[print_task_collection_response.PrintTaskCollectionResponse]:
        ...
        Returns: Optional[print_task_collection_response.PrintTaskCollectionResponse]
        """
        ...
        from .......models import print_task_collection_response

        return await self.request_adapter.send_async(request_info, print_task_collection_response.PrintTaskCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[print_task.PrintTask] = None, request_configuration: Optional[TasksRequestBuilderPostRequestConfiguration] = None) -> Optional[print_task.PrintTask]:
        """
    ...
    def to_post_request_information(self,body: Optional[print_task.PrintTask] = None, request_configuration: Optional[TasksRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tasks for print
        Args:
            body: The request body
