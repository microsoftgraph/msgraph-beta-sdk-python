...
class StartPrintJobRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/startPrintJob"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,request_configuration: Optional[StartPrintJobRequestBuilderPostRequestConfiguration] = None) -> Optional[print_job_status.PrintJobStatus]:
        """
    ...
    @dataclass
    class StartPrintJobRequestBuilderPostRequestConfiguration():
        """
