...
class CancelPrintJobRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/cancelPrintJob", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CancelPrintJobRequestBuilder:
        ...
        return CancelPrintJobRequestBuilder(raw_url, self.request_adapter)
