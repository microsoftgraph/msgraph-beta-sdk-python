...
class CancelPrintJobRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/cancelPrintJob"
    ...
    @dataclass
    class CancelPrintJobRequestBuilderPostRequestConfiguration():
        """
