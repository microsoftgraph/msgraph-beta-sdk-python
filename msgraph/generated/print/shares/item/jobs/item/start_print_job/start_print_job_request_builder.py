...
class StartPrintJobRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/startPrintJob", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> StartPrintJobRequestBuilder:
        ...
        return StartPrintJobRequestBuilder(raw_url, self.request_adapter)
