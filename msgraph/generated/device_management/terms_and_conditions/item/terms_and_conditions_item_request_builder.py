...
class TermsAndConditionsItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, terms_and_conditions_id: Optional[str] = None) -> None:
        """
        Instantiates a new TermsAndConditionsItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            termsAndConditionsId: key: id of termsAndConditions
        """
        ...
        url_tpl_params["termsAndConditions%2Did"] = termsAndConditionsId
