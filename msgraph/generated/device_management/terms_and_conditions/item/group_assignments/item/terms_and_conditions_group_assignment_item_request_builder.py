...
terms_and_conditions_request_builder = lazy_import('msgraph.generated.device_management.terms_and_conditions.item.group_assignments.item.terms_and_conditions.terms_and_conditions_request_builder')
...
class TermsAndConditionsGroupAssignmentItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, terms_and_conditions_group_assignment_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            termsAndConditionsGroupAssignmentId: key: id of termsAndConditionsGroupAssignment
        """
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments/{termsAndConditionsGroupAssignment%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["termsAndConditionsGroupAssignment%2Did"] = termsAndConditionsGroupAssignmentId
    ...
    def to_patch_request_information(self,body: Optional[terms_and_conditions_group_assignment.TermsAndConditionsGroupAssignment] = None, request_configuration: Optional[TermsAndConditionsGroupAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property groupAssignments in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class TermsAndConditionsGroupAssignmentItemRequestBuilderDeleteRequestConfiguration():
        """
