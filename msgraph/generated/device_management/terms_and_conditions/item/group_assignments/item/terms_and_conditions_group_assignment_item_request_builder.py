...
class TermsAndConditionsGroupAssignmentItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TermsAndConditionsGroupAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TermsAndConditionsGroupAssignmentItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[terms_and_conditions_group_assignment.TermsAndConditionsGroupAssignment] = None, request_configuration: Optional[TermsAndConditionsGroupAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
