...
count_request_builder = lazy_import('msgraph.generated.device_management.terms_and_conditions.item.group_assignments.count.count_request_builder')
terms_and_conditions_group_assignment = lazy_import('msgraph.generated.models.terms_and_conditions_group_assignment')
terms_and_conditions_group_assignment_collection_response = lazy_import('msgraph.generated.models.terms_and_conditions_group_assignment_collection_response')
...
class GroupAssignmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[terms_and_conditions_group_assignment.TermsAndConditionsGroupAssignment] = None, request_configuration: Optional[GroupAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
