...
cancel_request_builder = lazy_import('msgraph.generated.device_management.zebra_fota_deployments.item.microsoft_graph_cancel.cancel_request_builder')
...
class ZebraFotaDeploymentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, zebra_fota_deployment_id: Optional[str] = None) -> None:
        """
        Instantiates a new ZebraFotaDeploymentItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            zebraFotaDeploymentId: key: id of zebraFotaDeployment
        """
        ...
        url_tpl_params["zebraFotaDeployment%2Did"] = zebraFotaDeploymentId
    ...
    def to_patch_request_information(self,body: Optional[zebra_fota_deployment.ZebraFotaDeployment] = None, request_configuration: Optional[ZebraFotaDeploymentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property zebraFotaDeployments in deviceManagement
        Args:
            body: The request body
