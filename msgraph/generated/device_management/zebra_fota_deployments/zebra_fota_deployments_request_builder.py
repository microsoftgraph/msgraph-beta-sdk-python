...
count_request_builder = lazy_import('msgraph.generated.device_management.zebra_fota_deployments.count.count_request_builder')
zebra_fota_deployment = lazy_import('msgraph.generated.models.zebra_fota_deployment')
zebra_fota_deployment_collection_response = lazy_import('msgraph.generated.models.zebra_fota_deployment_collection_response')
...
class ZebraFotaDeploymentsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ZebraFotaDeploymentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[zebra_fota_deployment.ZebraFotaDeployment] = None, request_configuration: Optional[ZebraFotaDeploymentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
