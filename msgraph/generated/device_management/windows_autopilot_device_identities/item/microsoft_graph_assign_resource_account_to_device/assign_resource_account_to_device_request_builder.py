...
assign_resource_account_to_device_post_request_body = lazy_import('msgraph.generated.device_management.windows_autopilot_device_identities.item.microsoft_graph_assign_resource_account_to_device.assign_resource_account_to_device_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class AssignResourceAccountToDeviceRequestBuilder():
    """
    ...
    @dataclass
    class AssignResourceAccountToDeviceRequestBuilderPostRequestConfiguration():
        """
