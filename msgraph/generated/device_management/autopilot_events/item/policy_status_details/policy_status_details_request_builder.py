...
count_request_builder = lazy_import('msgraph.generated.device_management.autopilot_events.item.policy_status_details.count.count_request_builder')
...
device_management_autopilot_policy_status_detail_collection_response = lazy_import('msgraph.generated.models.device_management_autopilot_policy_status_detail_collection_response')
...
class PolicyStatusDetailsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PolicyStatusDetailsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_autopilot_policy_status_detail.DeviceManagementAutopilotPolicyStatusDetail] = None, request_configuration: Optional[PolicyStatusDetailsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
