...
if TYPE_CHECKING:
    from .....models import device_management_autopilot_policy_status_detail, device_management_autopilot_policy_status_detail_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import device_management_autopilot_policy_status_detail_item_request_builder
...
class PolicyStatusDetailsRequestBuilder():
    ...
    def by_device_management_autopilot_policy_status_detail_id(self,device_management_autopilot_policy_status_detail_id: str) -> device_management_autopilot_policy_status_detail_item_request_builder.DeviceManagementAutopilotPolicyStatusDetailItemRequestBuilder:
        """
        Provides operations to manage the policyStatusDetails property of the microsoft.graph.deviceManagementAutopilotEvent entity.
        Args:
        ...
        if device_management_autopilot_policy_status_detail_id is None:
            raise Exception("device_management_autopilot_policy_status_detail_id cannot be undefined")
        from .item import device_management_autopilot_policy_status_detail_item_request_builder
    ...
    async def get(self,request_configuration: Optional[PolicyStatusDetailsRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_autopilot_policy_status_detail_collection_response.DeviceManagementAutopilotPolicyStatusDetailCollectionResponse]:
        ...
        from .....models import device_management_autopilot_policy_status_detail_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_management_autopilot_policy_status_detail.DeviceManagementAutopilotPolicyStatusDetail] = None, request_configuration: Optional[PolicyStatusDetailsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to policyStatusDetails for deviceManagement
        Args:
            body: The request body
