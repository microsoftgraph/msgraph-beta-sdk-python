...
set_android_device_owner_fully_managed_enrollment_state_post_request_body = lazy_import('msgraph.generated.device_management.android_managed_store_account_enterprise_settings.microsoft_graph_set_android_device_owner_fully_managed_enrollment_state.set_android_device_owner_fully_managed_enrollment_state_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class MicrosoftGraphSetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder():
    """
    Provides operations to call the setAndroidDeviceOwnerFullyManagedEnrollmentState method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new MicrosoftGraphSetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilder and sets the default values.
        Args:
    ...
    @dataclass
    class MicrosoftGraphSetAndroidDeviceOwnerFullyManagedEnrollmentStateRequestBuilderPostRequestConfiguration():
        """
