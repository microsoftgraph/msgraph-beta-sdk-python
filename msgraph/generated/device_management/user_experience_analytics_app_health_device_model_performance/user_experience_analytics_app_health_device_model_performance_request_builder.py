...
if TYPE_CHECKING:
    from ...models import user_experience_analytics_app_health_device_model_performance, user_experience_analytics_app_health_device_model_performance_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import user_experience_analytics_app_health_device_model_performance_item_request_builder
...
class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_user_experience_analytics_app_health_device_model_performance_id(self,user_experience_analytics_app_health_device_model_performance_id: str) -> user_experience_analytics_app_health_device_model_performance_item_request_builder.UserExperienceAnalyticsAppHealthDeviceModelPerformanceItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsAppHealthDeviceModelPerformance property of the microsoft.graph.deviceManagement entity.
        Args:
        ...
        if user_experience_analytics_app_health_device_model_performance_id is None:
            raise Exception("user_experience_analytics_app_health_device_model_performance_id cannot be undefined")
        from .item import user_experience_analytics_app_health_device_model_performance_item_request_builder
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_app_health_device_model_performance_collection_response.UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse]:
        ...
        from ...models import user_experience_analytics_app_health_device_model_performance_collection_response
    ...
    async def post(self,body: Optional[user_experience_analytics_app_health_device_model_performance.UserExperienceAnalyticsAppHealthDeviceModelPerformance] = None, request_configuration: Optional[UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderPostRequestConfiguration] = None) -> Optional[user_experience_analytics_app_health_device_model_performance.UserExperienceAnalyticsAppHealthDeviceModelPerformance]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ...models import user_experience_analytics_app_health_device_model_performance
    ...
    def to_post_request_information(self,body: Optional[user_experience_analytics_app_health_device_model_performance.UserExperienceAnalyticsAppHealthDeviceModelPerformance] = None, request_configuration: Optional[UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsAppHealthDeviceModelPerformance for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
