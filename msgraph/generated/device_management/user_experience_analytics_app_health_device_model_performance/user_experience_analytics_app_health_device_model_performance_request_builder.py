...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_app_health_device_model_performance.count.count_request_builder')
...
user_experience_analytics_app_health_device_model_performance_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_app_health_device_model_performance_collection_response')
...
class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
