...
scoped_for_resource_with_resource_response = lazy_import('msgraph.generated.device_management.scoped_for_resource_with_resource.scoped_for_resource_with_resource_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class ScopedForResourceWithResourceRequestBuilder():
    """
    ...
    def create_get_request_information(self,request_configuration: Optional[ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration():
        """
