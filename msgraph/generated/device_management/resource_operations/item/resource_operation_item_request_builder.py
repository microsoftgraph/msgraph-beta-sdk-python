...
from ....models import resource_operation
from ....models.o_data_errors import o_data_error
from .get_scopes_for_user_with_userid import get_scopes_for_user_with_userid_request_builder
...
class ResourceOperationItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ResourceOperationItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ResourceOperationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[resource_operation.ResourceOperation] = None, request_configuration: Optional[ResourceOperationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def get_scopes_for_user_with_userid(self,userid: Optional[str] = None) -> get_scopes_for_user_with_userid_request_builder.GetScopesForUserWithUseridRequestBuilder:
        ...
        Returns: get_scopes_for_user_with_userid_request_builder.GetScopesForUserWithUseridRequestBuilder
        """
        if userid is None:
