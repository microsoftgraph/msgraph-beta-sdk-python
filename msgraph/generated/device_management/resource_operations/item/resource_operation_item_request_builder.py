...
microsoft_graph_get_scopes_for_user_with_userid_request_builder = lazy_import('msgraph.generated.device_management.resource_operations.item.microsoft_graph_get_scopes_for_user_with_userid.microsoft_graph_get_scopes_for_user_with_userid_request_builder')
resource_operation = lazy_import('msgraph.generated.models.resource_operation')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class ResourceOperationItemRequestBuilder():
    """
    ...
    def microsoft_graph_get_scopes_for_user_with_userid(self,userid: Optional[str] = None) -> microsoft_graph_get_scopes_for_user_with_userid_request_builder.MicrosoftGraphGetScopesForUserWithUseridRequestBuilder:
        """
        Provides operations to call the getScopesForUser method.
        Args:
            userid: Usage: userid='{userid}'
        Returns: microsoft_graph_get_scopes_for_user_with_userid_request_builder.MicrosoftGraphGetScopesForUserWithUseridRequestBuilder
        """
        if userid is None:
            raise Exception("userid cannot be undefined")
        return microsoft_graph_get_scopes_for_user_with_userid_request_builder.MicrosoftGraphGetScopesForUserWithUseridRequestBuilder(self.request_adapter, self.path_parameters, userid)
    ...
    def to_patch_request_information(self,body: Optional[resource_operation.ResourceOperation] = None, request_configuration: Optional[ResourceOperationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property resourceOperations in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class ResourceOperationItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ResourceOperationItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
