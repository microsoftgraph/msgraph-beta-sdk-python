...
get_scopes_for_user_with_userid_response = lazy_import('msgraph.generated.device_management.resource_operations.item.get_scopes_for_user_with_userid.get_scopes_for_user_with_userid_response')
...
class GetScopesForUserWithUseridRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetScopesForUserWithUseridRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
