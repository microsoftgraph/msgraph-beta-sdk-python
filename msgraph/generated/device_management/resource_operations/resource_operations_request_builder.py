...
if TYPE_CHECKING:
    ...
    from ...models.resource_operation_collection_response import ResourceOperationCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.resource_operation_item_request_builder import ResourceOperationItemRequestBuilder

class ResourceOperationsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/resourceOperations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_resource_operation_id(self,resource_operation_id: str) -> ResourceOperationItemRequestBuilder:
        """
        Provides operations to manage the resourceOperations property of the microsoft.graph.deviceManagement entity.
        param resource_operation_id: The unique identifier of resourceOperation
        Returns: ResourceOperationItemRequestBuilder
        """
        if not resource_operation_id:
            raise TypeError("resource_operation_id cannot be null.")
        from .item.resource_operation_item_request_builder import ResourceOperationItemRequestBuilder
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ResourceOperationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ResourceOperationsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ResourceOperationsRequestBuilder(self.request_adapter, raw_url)
