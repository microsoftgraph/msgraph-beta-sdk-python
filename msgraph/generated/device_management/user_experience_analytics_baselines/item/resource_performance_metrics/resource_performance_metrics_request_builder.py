...
class ResourcePerformanceMetricsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ResourcePerformanceMetricsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory]:
        """
