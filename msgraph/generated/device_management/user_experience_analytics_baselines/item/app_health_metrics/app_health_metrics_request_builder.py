...
class AppHealthMetricsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[AppHealthMetricsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory]:
        """
