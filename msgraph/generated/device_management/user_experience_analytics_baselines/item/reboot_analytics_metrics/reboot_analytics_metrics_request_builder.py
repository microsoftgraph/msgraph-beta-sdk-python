...
class RebootAnalyticsMetricsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RebootAnalyticsMetricsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory]:
        """
