...
class DeviceBootPerformanceMetricsRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[DeviceBootPerformanceMetricsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The user experience analytics device boot performance metrics.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
