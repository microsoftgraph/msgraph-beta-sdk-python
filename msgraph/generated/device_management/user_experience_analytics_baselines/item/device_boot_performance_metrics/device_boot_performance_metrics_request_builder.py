...
class DeviceBootPerformanceMetricsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[DeviceBootPerformanceMetricsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory]:
        """
