...
class UserExperienceAnalyticsBaselineItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user_experience_analytics_baseline_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            userExperienceAnalyticsBaselineId: key: id of userExperienceAnalyticsBaseline
        """
        ...
        url_tpl_params["userExperienceAnalyticsBaseline%2Did"] = userExperienceAnalyticsBaselineId
