...
class WorkFromAnywhereMetricsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[WorkFromAnywhereMetricsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory]:
        """
