...
from ......models import device_compliance_setting_state
from ......models.o_data_errors import o_data_error

class DeviceComplianceSettingStateItemRequestBuilder():
    """
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceComplianceSettingStateItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceComplianceSettingStateItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Not yet documented
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def create_patch_request_information(self,body: Optional[device_compliance_setting_state.DeviceComplianceSettingState] = None, request_configuration: Optional[DeviceComplianceSettingStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class DeviceComplianceSettingStateItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
