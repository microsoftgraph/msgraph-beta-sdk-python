...
class GroupPolicyUploadedDefinitionFileItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[GroupPolicyUploadedDefinitionFileItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[GroupPolicyUploadedDefinitionFileItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[group_policy_uploaded_definition_file.GroupPolicyUploadedDefinitionFile] = None, request_configuration: Optional[GroupPolicyUploadedDefinitionFileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
