...
add_language_files_request_builder = lazy_import('msgraph.generated.device_management.group_policy_uploaded_definition_files.item.microsoft_graph_add_language_files.add_language_files_request_builder')
remove_request_builder = lazy_import('msgraph.generated.device_management.group_policy_uploaded_definition_files.item.microsoft_graph_remove.remove_request_builder')
remove_language_files_request_builder = lazy_import('msgraph.generated.device_management.group_policy_uploaded_definition_files.item.microsoft_graph_remove_language_files.remove_language_files_request_builder')
update_language_files_request_builder = lazy_import('msgraph.generated.device_management.group_policy_uploaded_definition_files.item.microsoft_graph_update_language_files.update_language_files_request_builder')
upload_new_version_request_builder = lazy_import('msgraph.generated.device_management.group_policy_uploaded_definition_files.item.microsoft_graph_upload_new_version.upload_new_version_request_builder')
...
class GroupPolicyUploadedDefinitionFileItemRequestBuilder():
    ...
    @property
    def microsoft_graph_add_language_files(self) -> add_language_files_request_builder.AddLanguageFilesRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_remove_language_files(self) -> remove_language_files_request_builder.RemoveLanguageFilesRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_update_language_files(self) -> update_language_files_request_builder.UpdateLanguageFilesRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_upload_new_version(self) -> upload_new_version_request_builder.UploadNewVersionRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_uploaded_definition_file_id: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyUploadedDefinitionFileItemRequestBuilder and sets the default values.
        Args:
            groupPolicyUploadedDefinitionFileId: key: id of groupPolicyUploadedDefinitionFile
        ...
        url_tpl_params["groupPolicyUploadedDefinitionFile%2Did"] = groupPolicyUploadedDefinitionFileId
