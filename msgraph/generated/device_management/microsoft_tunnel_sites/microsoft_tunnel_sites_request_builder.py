...
count_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.count.count_request_builder')
microsoft_tunnel_site = lazy_import('msgraph.generated.models.microsoft_tunnel_site')
microsoft_tunnel_site_collection_response = lazy_import('msgraph.generated.models.microsoft_tunnel_site_collection_response')
...
class MicrosoftTunnelSitesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MicrosoftTunnelSitesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[microsoft_tunnel_site.MicrosoftTunnelSite] = None, request_configuration: Optional[MicrosoftTunnelSitesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
