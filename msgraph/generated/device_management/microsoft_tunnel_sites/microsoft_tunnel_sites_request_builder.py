...
if TYPE_CHECKING:
    ...
    from ...models.microsoft_tunnel_site_collection_response import MicrosoftTunnelSiteCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.microsoft_tunnel_site_item_request_builder import MicrosoftTunnelSiteItemRequestBuilder

class MicrosoftTunnelSitesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/microsoftTunnelSites{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_microsoft_tunnel_site_id(self,microsoft_tunnel_site_id: str) -> MicrosoftTunnelSiteItemRequestBuilder:
        """
        Provides operations to manage the microsoftTunnelSites property of the microsoft.graph.deviceManagement entity.
        param microsoft_tunnel_site_id: The unique identifier of microsoftTunnelSite
    ...
    async def get(self,request_configuration: Optional[MicrosoftTunnelSitesRequestBuilderGetRequestConfiguration] = None) -> Optional[MicrosoftTunnelSiteCollectionResponse]:
        ...
        Returns: Optional[MicrosoftTunnelSiteCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftTunnelSitesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftTunnelSitesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftTunnelSitesRequestBuilder(raw_url, self.request_adapter)
