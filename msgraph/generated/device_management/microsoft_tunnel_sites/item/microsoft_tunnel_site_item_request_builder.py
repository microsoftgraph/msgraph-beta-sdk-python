...
class MicrosoftTunnelSiteItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[microsoft_tunnel_site.MicrosoftTunnelSite] = None, request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
