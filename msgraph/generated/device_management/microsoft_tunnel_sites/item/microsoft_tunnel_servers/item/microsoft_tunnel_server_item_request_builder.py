...
create_server_log_collection_request_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_create_server_log_collection_request.create_server_log_collection_request_request_builder')
generate_server_log_collection_request_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_generate_server_log_collection_request.generate_server_log_collection_request_request_builder')
get_health_metrics_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_get_health_metrics.get_health_metrics_request_builder')
get_health_metric_time_series_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_get_health_metric_time_series.get_health_metric_time_series_request_builder')
...
class MicrosoftTunnelServerItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_create_server_log_collection_request(self) -> create_server_log_collection_request_request_builder.CreateServerLogCollectionRequestRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_generate_server_log_collection_request(self) -> generate_server_log_collection_request_request_builder.GenerateServerLogCollectionRequestRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, microsoft_tunnel_server_id: Optional[str] = None) -> None:
        """
        Instantiates a new MicrosoftTunnelServerItemRequestBuilder and sets the default values.
        Args:
            microsoftTunnelServerId: key: id of microsoftTunnelServer
        ...
        url_tpl_params["microsoftTunnelServer%2Did"] = microsoftTunnelServerId
