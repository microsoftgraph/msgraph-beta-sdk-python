...
microsoft_graph_create_server_log_collection_request_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_create_server_log_collection_request.microsoft_graph_create_server_log_collection_request_request_builder')
microsoft_graph_generate_server_log_collection_request_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_generate_server_log_collection_request.microsoft_graph_generate_server_log_collection_request_request_builder')
microsoft_graph_get_health_metrics_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_get_health_metrics.microsoft_graph_get_health_metrics_request_builder')
microsoft_graph_get_health_metric_time_series_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.microsoft_graph_get_health_metric_time_series.microsoft_graph_get_health_metric_time_series_request_builder')
...
class MicrosoftTunnelServerItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_create_server_log_collection_request(self) -> microsoft_graph_create_server_log_collection_request_request_builder.MicrosoftGraphCreateServerLogCollectionRequestRequestBuilder:
        """
        Provides operations to call the createServerLogCollectionRequest method.
        """
        return microsoft_graph_create_server_log_collection_request_request_builder.MicrosoftGraphCreateServerLogCollectionRequestRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_generate_server_log_collection_request(self) -> microsoft_graph_generate_server_log_collection_request_request_builder.MicrosoftGraphGenerateServerLogCollectionRequestRequestBuilder:
        """
        Provides operations to call the generateServerLogCollectionRequest method.
        """
        return microsoft_graph_generate_server_log_collection_request_request_builder.MicrosoftGraphGenerateServerLogCollectionRequestRequestBuilder(self.request_adapter, self.path_parameters)
