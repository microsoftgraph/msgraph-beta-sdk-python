...
generate_server_log_collection_request_post_request_body = lazy_import('msgraph.generated.device_management.microsoft_tunnel_sites.item.microsoft_tunnel_servers.item.generate_server_log_collection_request.generate_server_log_collection_request_post_request_body')
...
class GenerateServerLogCollectionRequestRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[generate_server_log_collection_request_post_request_body.GenerateServerLogCollectionRequestPostRequestBody] = None, request_configuration: Optional[GenerateServerLogCollectionRequestRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
