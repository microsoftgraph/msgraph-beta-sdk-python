...
get_expiring_vpp_token_count_with_expiring_before_date_time_response = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.get_expiring_vpp_token_count_with_expiring_before_date_time.get_expiring_vpp_token_count_with_expiring_before_date_time_response')
...
class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, expiring_before_date_time: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/depOnboardingSettings/microsoft.graph.getExpiringVppTokenCount(expiringBeforeDateTime='{expiringBeforeDateTime}')"
