...
class DepOnboardingSettingsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DepOnboardingSettingsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[dep_onboarding_setting.DepOnboardingSetting] = None, request_configuration: Optional[DepOnboardingSettingsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
