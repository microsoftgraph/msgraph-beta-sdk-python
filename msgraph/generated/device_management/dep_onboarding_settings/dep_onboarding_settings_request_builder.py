...
get_expiring_vpp_token_count_with_expiring_before_date_time_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.microsoft_graph_get_expiring_vpp_token_count_with_expiring_before_date_time.get_expiring_vpp_token_count_with_expiring_before_date_time_request_builder')
...
class DepOnboardingSettingsRequestBuilder():
    ...
    def microsoft_graph_get_expiring_vpp_token_count_with_expiring_before_date_time(self,expiring_before_date_time: Optional[str] = None) -> get_expiring_vpp_token_count_with_expiring_before_date_time_request_builder.GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder:
        """
