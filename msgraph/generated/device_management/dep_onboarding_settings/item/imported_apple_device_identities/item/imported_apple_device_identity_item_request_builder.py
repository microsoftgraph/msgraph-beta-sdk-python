...
class ImportedAppleDeviceIdentityItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, imported_apple_device_identity_id: Optional[str] = None) -> None:
        """
        Instantiates a new ImportedAppleDeviceIdentityItemRequestBuilder and sets the default values.
        Args:
            importedAppleDeviceIdentityId: key: id of importedAppleDeviceIdentity
        ...
        url_tpl_params["importedAppleDeviceIdentity%2Did"] = importedAppleDeviceIdentityId
    ...
    async def get(self,request_configuration: Optional[ImportedAppleDeviceIdentityItemRequestBuilderGetRequestConfiguration] = None) -> Optional[imported_apple_device_identity.ImportedAppleDeviceIdentity]:
        """
    ...
    async def patch(self,body: Optional[imported_apple_device_identity.ImportedAppleDeviceIdentity] = None, request_configuration: Optional[ImportedAppleDeviceIdentityItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[imported_apple_device_identity.ImportedAppleDeviceIdentity]:
        """
    ...
    def to_patch_request_information(self,body: Optional[imported_apple_device_identity.ImportedAppleDeviceIdentity] = None, request_configuration: Optional[ImportedAppleDeviceIdentityItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property importedAppleDeviceIdentities in deviceManagement
        Args:
            body: The request body
