...
import_apple_device_identity_list_post_request_body = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.imported_apple_device_identities.microsoft_graph_import_apple_device_identity_list.import_apple_device_identity_list_post_request_body')
import_apple_device_identity_list_response = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.imported_apple_device_identities.microsoft_graph_import_apple_device_identity_list.import_apple_device_identity_list_response')
...
class ImportAppleDeviceIdentityListRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/importedAppleDeviceIdentities/microsoft.graph.importAppleDeviceIdentityList"
