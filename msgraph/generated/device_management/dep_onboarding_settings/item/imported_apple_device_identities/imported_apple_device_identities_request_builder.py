...
import_apple_device_identity_list_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.imported_apple_device_identities.microsoft_graph_import_apple_device_identity_list.import_apple_device_identity_list_request_builder')
...
class ImportedAppleDeviceIdentitiesRequestBuilder():
    ...
    @property
    def microsoft_graph_import_apple_device_identity_list(self) -> import_apple_device_identity_list_request_builder.ImportAppleDeviceIdentityListRequestBuilder:
        """
