...
count_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.imported_apple_device_identities.count.count_request_builder')
import_apple_device_identity_list_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.imported_apple_device_identities.import_apple_device_identity_list.import_apple_device_identity_list_request_builder')
imported_apple_device_identity = lazy_import('msgraph.generated.models.imported_apple_device_identity')
imported_apple_device_identity_collection_response = lazy_import('msgraph.generated.models.imported_apple_device_identity_collection_response')
...
class ImportedAppleDeviceIdentitiesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ImportedAppleDeviceIdentitiesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[imported_apple_device_identity.ImportedAppleDeviceIdentity] = None, request_configuration: Optional[ImportedAppleDeviceIdentitiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ImportedAppleDeviceIdentitiesRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[ImportedAppleDeviceIdentitiesRequestBuilder.ImportedAppleDeviceIdentitiesRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ImportedAppleDeviceIdentitiesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
