...
microsoft_graph_generate_encryption_public_key_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_generate_encryption_public_key.microsoft_graph_generate_encryption_public_key_request_builder')
microsoft_graph_get_encryption_public_key_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_get_encryption_public_key.microsoft_graph_get_encryption_public_key_request_builder')
microsoft_graph_share_for_school_data_sync_service_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_share_for_school_data_sync_service.microsoft_graph_share_for_school_data_sync_service_request_builder')
microsoft_graph_sync_with_apple_device_enrollment_program_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_sync_with_apple_device_enrollment_program.microsoft_graph_sync_with_apple_device_enrollment_program_request_builder')
microsoft_graph_unshare_for_school_data_sync_service_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_unshare_for_school_data_sync_service.microsoft_graph_unshare_for_school_data_sync_service_request_builder')
microsoft_graph_upload_dep_token_request_builder = lazy_import('msgraph.generated.device_management.dep_onboarding_settings.item.microsoft_graph_upload_dep_token.microsoft_graph_upload_dep_token_request_builder')
...
class DepOnboardingSettingItemRequestBuilder():
    ...
    @property
    def microsoft_graph_generate_encryption_public_key(self) -> microsoft_graph_generate_encryption_public_key_request_builder.MicrosoftGraphGenerateEncryptionPublicKeyRequestBuilder:
        """
        Provides operations to call the generateEncryptionPublicKey method.
        """
        return microsoft_graph_generate_encryption_public_key_request_builder.MicrosoftGraphGenerateEncryptionPublicKeyRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_get_encryption_public_key(self) -> microsoft_graph_get_encryption_public_key_request_builder.MicrosoftGraphGetEncryptionPublicKeyRequestBuilder:
        """
        Provides operations to call the getEncryptionPublicKey method.
        """
        return microsoft_graph_get_encryption_public_key_request_builder.MicrosoftGraphGetEncryptionPublicKeyRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_share_for_school_data_sync_service(self) -> microsoft_graph_share_for_school_data_sync_service_request_builder.MicrosoftGraphShareForSchoolDataSyncServiceRequestBuilder:
        """
        Provides operations to call the shareForSchoolDataSyncService method.
        """
        return microsoft_graph_share_for_school_data_sync_service_request_builder.MicrosoftGraphShareForSchoolDataSyncServiceRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_sync_with_apple_device_enrollment_program(self) -> microsoft_graph_sync_with_apple_device_enrollment_program_request_builder.MicrosoftGraphSyncWithAppleDeviceEnrollmentProgramRequestBuilder:
        """
        Provides operations to call the syncWithAppleDeviceEnrollmentProgram method.
        """
        return microsoft_graph_sync_with_apple_device_enrollment_program_request_builder.MicrosoftGraphSyncWithAppleDeviceEnrollmentProgramRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_unshare_for_school_data_sync_service(self) -> microsoft_graph_unshare_for_school_data_sync_service_request_builder.MicrosoftGraphUnshareForSchoolDataSyncServiceRequestBuilder:
        """
        Provides operations to call the unshareForSchoolDataSyncService method.
        """
        return microsoft_graph_unshare_for_school_data_sync_service_request_builder.MicrosoftGraphUnshareForSchoolDataSyncServiceRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_upload_dep_token(self) -> microsoft_graph_upload_dep_token_request_builder.MicrosoftGraphUploadDepTokenRequestBuilder:
        """
        Provides operations to call the uploadDepToken method.
        """
        return microsoft_graph_upload_dep_token_request_builder.MicrosoftGraphUploadDepTokenRequestBuilder(self.request_adapter, self.path_parameters)
