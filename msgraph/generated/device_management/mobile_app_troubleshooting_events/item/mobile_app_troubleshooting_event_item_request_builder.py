...
app_log_collection_requests_request_builder = lazy_import('msgraph.generated.device_management.mobile_app_troubleshooting_events.item.app_log_collection_requests.app_log_collection_requests_request_builder')
app_log_collection_request_item_request_builder = lazy_import('msgraph.generated.device_management.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.app_log_collection_request_item_request_builder')
...
class MobileAppTroubleshootingEventItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[MobileAppTroubleshootingEventItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MobileAppTroubleshootingEventItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[mobile_app_troubleshooting_event.MobileAppTroubleshootingEvent] = None, request_configuration: Optional[MobileAppTroubleshootingEventItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class MobileAppTroubleshootingEventItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class MobileAppTroubleshootingEventItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class MobileAppTroubleshootingEventItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
