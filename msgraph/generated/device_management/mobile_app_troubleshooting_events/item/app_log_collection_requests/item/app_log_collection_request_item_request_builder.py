...
microsoft_graph_create_download_url_request_builder = lazy_import('msgraph.generated.device_management.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.microsoft_graph_create_download_url.microsoft_graph_create_download_url_request_builder')
