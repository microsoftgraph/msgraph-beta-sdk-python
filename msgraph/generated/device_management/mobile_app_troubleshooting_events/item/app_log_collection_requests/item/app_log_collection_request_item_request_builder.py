...
create_download_url_request_builder = lazy_import('msgraph.generated.device_management.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.microsoft_graph_create_download_url.create_download_url_request_builder')
...
class AppLogCollectionRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, app_log_collection_request_id: Optional[str] = None) -> None:
        """
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["appLogCollectionRequest%2Did"] = appLogCollectionRequestId
    ...
    def to_patch_request_information(self,body: Optional[app_log_collection_request.AppLogCollectionRequest] = None, request_configuration: Optional[AppLogCollectionRequestItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property appLogCollectionRequests in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class AppLogCollectionRequestItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
