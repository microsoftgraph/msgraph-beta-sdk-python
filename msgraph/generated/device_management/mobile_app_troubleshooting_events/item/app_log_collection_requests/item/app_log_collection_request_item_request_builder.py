...
create_download_url_request_builder = lazy_import('msgraph.generated.device_management.mobile_app_troubleshooting_events.item.app_log_collection_requests.item.create_download_url.create_download_url_request_builder')
...
class AppLogCollectionRequestItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AppLogCollectionRequestItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AppLogCollectionRequestItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[app_log_collection_request.AppLogCollectionRequest] = None, request_configuration: Optional[AppLogCollectionRequestItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
