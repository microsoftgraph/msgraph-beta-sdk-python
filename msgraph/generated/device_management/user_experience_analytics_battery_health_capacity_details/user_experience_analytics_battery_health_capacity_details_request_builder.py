...
class UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_battery_health_capacity_details.UserExperienceAnalyticsBatteryHealthCapacityDetails]:
        """
    ...
    def to_patch_request_information(self,body: Optional[user_experience_analytics_battery_health_capacity_details.UserExperienceAnalyticsBatteryHealthCapacityDetails] = None, request_configuration: Optional[UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsBatteryHealthCapacityDetails in deviceManagement
        Args:
            body: The request body
