...
class DeviceManagementConfigurationPolicyTemplateItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DeviceManagementConfigurationPolicyTemplateItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
