...
class DeviceManagementConfigurationPolicyTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DeviceManagementConfigurationPolicyTemplateItemRequestBuilder:
        """
        ...
        return DeviceManagementConfigurationPolicyTemplateItemRequestBuilder(raw_url, self.request_adapter)
