...
class GroupPolicyMigrationReportsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GroupPolicyMigrationReportsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[group_policy_migration_report.GroupPolicyMigrationReport] = None, request_configuration: Optional[GroupPolicyMigrationReportsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
