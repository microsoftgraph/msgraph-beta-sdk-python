...
create_migration_report_request_builder = lazy_import('msgraph.generated.device_management.group_policy_migration_reports.microsoft_graph_create_migration_report.create_migration_report_request_builder')
...
class GroupPolicyMigrationReportsRequestBuilder():
    ...
    @property
    def microsoft_graph_create_migration_report(self) -> create_migration_report_request_builder.CreateMigrationReportRequestBuilder:
        """
