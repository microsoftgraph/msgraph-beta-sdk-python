...
if TYPE_CHECKING:
    from ...models import group_policy_migration_report, group_policy_migration_report_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .create_migration_report import create_migration_report_request_builder
    from .item import group_policy_migration_report_item_request_builder
...
class GroupPolicyMigrationReportsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/groupPolicyMigrationReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_group_policy_migration_report_id(self,group_policy_migration_report_id: str) -> group_policy_migration_report_item_request_builder.GroupPolicyMigrationReportItemRequestBuilder:
        """
        Provides operations to manage the groupPolicyMigrationReports property of the microsoft.graph.deviceManagement entity.
        Args:
            group_policy_migration_report_id: Unique identifier of the item
        ...
        if group_policy_migration_report_id is None:
            raise Exception("group_policy_migration_report_id cannot be undefined")
        from .item import group_policy_migration_report_item_request_builder
    ...
    async def get(self,request_configuration: Optional[GroupPolicyMigrationReportsRequestBuilderGetRequestConfiguration] = None) -> Optional[group_policy_migration_report_collection_response.GroupPolicyMigrationReportCollectionResponse]:
        ...
        from ...models import group_policy_migration_report_collection_response
    ...
    def to_post_request_information(self,body: Optional[group_policy_migration_report.GroupPolicyMigrationReport] = None, request_configuration: Optional[GroupPolicyMigrationReportsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to groupPolicyMigrationReports for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class GroupPolicyMigrationReportsRequestBuilderGetRequestConfiguration():
        """
