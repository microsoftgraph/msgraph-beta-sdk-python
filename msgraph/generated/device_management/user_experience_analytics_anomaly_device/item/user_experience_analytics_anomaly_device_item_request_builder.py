...
class UserExperienceAnalyticsAnomalyDeviceItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user_experience_analytics_anomaly_device_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            userExperienceAnalyticsAnomalyDeviceId: key: id of userExperienceAnalyticsAnomalyDevice
        """
        ...
        url_tpl_params["userExperienceAnalyticsAnomalyDevice%2Did"] = userExperienceAnalyticsAnomalyDeviceId
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsAnomalyDeviceItemRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_anomaly_device.UserExperienceAnalyticsAnomalyDevice]:
        """
    ...
    def to_patch_request_information(self,body: Optional[user_experience_analytics_anomaly_device.UserExperienceAnalyticsAnomalyDevice] = None, request_configuration: Optional[UserExperienceAnalyticsAnomalyDeviceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsAnomalyDevice in deviceManagement
        Args:
            body: The request body
