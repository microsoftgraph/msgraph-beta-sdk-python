...
if TYPE_CHECKING:
    from ....models import user_experience_analytics_anomaly_device
...
class UserExperienceAnalyticsAnomalyDeviceItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[UserExperienceAnalyticsAnomalyDeviceItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
