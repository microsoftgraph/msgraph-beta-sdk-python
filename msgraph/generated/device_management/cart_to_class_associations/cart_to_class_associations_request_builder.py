...
count_request_builder = lazy_import('msgraph.generated.device_management.cart_to_class_associations.count.count_request_builder')
cart_to_class_association = lazy_import('msgraph.generated.models.cart_to_class_association')
cart_to_class_association_collection_response = lazy_import('msgraph.generated.models.cart_to_class_association_collection_response')
...
class CartToClassAssociationsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CartToClassAssociationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[cart_to_class_association.CartToClassAssociation] = None, request_configuration: Optional[CartToClassAssociationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
