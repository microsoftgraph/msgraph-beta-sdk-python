...
if TYPE_CHECKING:
    from ...models import cart_to_class_association, cart_to_class_association_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import cart_to_class_association_item_request_builder
...
class CartToClassAssociationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/cartToClassAssociations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_cart_to_class_association_id(self,cart_to_class_association_id: str) -> cart_to_class_association_item_request_builder.CartToClassAssociationItemRequestBuilder:
        """
        Provides operations to manage the cartToClassAssociations property of the microsoft.graph.deviceManagement entity.
        Args:
            cart_to_class_association_id: Unique identifier of the item
        ...
        if cart_to_class_association_id is None:
            raise Exception("cart_to_class_association_id cannot be undefined")
        from .item import cart_to_class_association_item_request_builder
    ...
    async def get(self,request_configuration: Optional[CartToClassAssociationsRequestBuilderGetRequestConfiguration] = None) -> Optional[cart_to_class_association_collection_response.CartToClassAssociationCollectionResponse]:
        ...
        from ...models import cart_to_class_association_collection_response
    ...
    def to_post_request_information(self,body: Optional[cart_to_class_association.CartToClassAssociation] = None, request_configuration: Optional[CartToClassAssociationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cartToClassAssociations for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class CartToClassAssociationsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class CartToClassAssociationsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
