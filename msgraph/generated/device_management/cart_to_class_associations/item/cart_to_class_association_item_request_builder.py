...
class CartToClassAssociationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[CartToClassAssociationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[cart_to_class_association.CartToClassAssociation] = None, request_configuration: Optional[CartToClassAssociationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property cartToClassAssociations in deviceManagement
        Args:
            body: The request body
