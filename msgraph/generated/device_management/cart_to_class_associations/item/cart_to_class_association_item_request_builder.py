...
class CartToClassAssociationItemRequestBuilder():
    """
    ...
    @dataclass
    class CartToClassAssociationItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class CartToClassAssociationItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
