...
class AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, advanced_threat_protection_onboarding_device_setting_state_id: Optional[str] = None) -> None:
        """
        Instantiates a new AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilder and sets the default values.
        Args:
            advancedThreatProtectionOnboardingDeviceSettingStateId: key: id of advancedThreatProtectionOnboardingDeviceSettingState
        ...
        url_tpl_params["advancedThreatProtectionOnboardingDeviceSettingState%2Did"] = advancedThreatProtectionOnboardingDeviceSettingStateId
    ...
    async def get(self,request_configuration: Optional[AdvancedThreatProtectionOnboardingDeviceSettingStateItemRequestBuilderGetRequestConfiguration] = None) -> Optional[advanced_threat_protection_onboarding_device_setting_state.AdvancedThreatProtectionOnboardingDeviceSettingState]:
        """
        Not yet documented
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
