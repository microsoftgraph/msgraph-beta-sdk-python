...
class AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetRequestConfiguration] = None) -> Optional[advanced_threat_protection_onboarding_device_setting_state_collection_response.AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse]:
        ...
        from ....models import advanced_threat_protection_onboarding_device_setting_state_collection_response
    ...
    async def post(self,body: Optional[advanced_threat_protection_onboarding_device_setting_state.AdvancedThreatProtectionOnboardingDeviceSettingState] = None, request_configuration: Optional[AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderPostRequestConfiguration] = None) -> Optional[advanced_threat_protection_onboarding_device_setting_state.AdvancedThreatProtectionOnboardingDeviceSettingState]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ....models import advanced_threat_protection_onboarding_device_setting_state
