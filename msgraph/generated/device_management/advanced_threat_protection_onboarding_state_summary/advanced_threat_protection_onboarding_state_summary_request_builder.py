...
advanced_threat_protection_onboarding_device_setting_states_request_builder = lazy_import('msgraph.generated.device_management.advanced_threat_protection_onboarding_state_summary.advanced_threat_protection_onboarding_device_setting_states.advanced_threat_protection_onboarding_device_setting_states_request_builder')
advanced_threat_protection_onboarding_device_setting_state_item_request_builder = lazy_import('msgraph.generated.device_management.advanced_threat_protection_onboarding_state_summary.advanced_threat_protection_onboarding_device_setting_states.item.advanced_threat_protection_onboarding_device_setting_state_item_request_builder')
...
class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[advanced_threat_protection_onboarding_state_summary.AdvancedThreatProtectionOnboardingStateSummary] = None, request_configuration: Optional[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
