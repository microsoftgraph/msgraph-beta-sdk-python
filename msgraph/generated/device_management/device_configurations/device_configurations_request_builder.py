...
get_ios_available_update_versions_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.microsoft_graph_get_ios_available_update_versions.get_ios_available_update_versions_request_builder')
get_targeted_users_and_devices_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.microsoft_graph_get_targeted_users_and_devices.get_targeted_users_and_devices_request_builder')
has_payload_links_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.microsoft_graph_has_payload_links.has_payload_links_request_builder')
...
class DeviceConfigurationsRequestBuilder():
    ...
    @property
    def microsoft_graph_get_ios_available_update_versions(self) -> get_ios_available_update_versions_request_builder.GetIosAvailableUpdateVersionsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_targeted_users_and_devices(self) -> get_targeted_users_and_devices_request_builder.GetTargetedUsersAndDevicesRequestBuilder:
        """
