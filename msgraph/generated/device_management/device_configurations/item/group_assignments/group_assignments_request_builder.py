...
count_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.item.group_assignments.count.count_request_builder')
device_configuration_group_assignment = lazy_import('msgraph.generated.models.device_configuration_group_assignment')
device_configuration_group_assignment_collection_response = lazy_import('msgraph.generated.models.device_configuration_group_assignment_collection_response')
...
class GroupAssignmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[device_configuration_group_assignment.DeviceConfigurationGroupAssignment] = None, request_configuration: Optional[GroupAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
