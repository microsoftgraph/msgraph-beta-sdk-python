...
microsoft_graph_assigned_access_multi_mode_profiles_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.item.microsoft_graph_assigned_access_multi_mode_profiles.microsoft_graph_assigned_access_multi_mode_profiles_request_builder')
...
microsoft_graph_windows_privacy_access_controls_request_builder = lazy_import('msgraph.generated.device_management.device_configurations.item.microsoft_graph_windows_privacy_access_controls.microsoft_graph_windows_privacy_access_controls_request_builder')
...
class DeviceConfigurationItemRequestBuilder():
    ...
    @property
    def microsoft_graph_assigned_access_multi_mode_profiles(self) -> microsoft_graph_assigned_access_multi_mode_profiles_request_builder.MicrosoftGraphAssignedAccessMultiModeProfilesRequestBuilder:
        """
        Provides operations to call the assignedAccessMultiModeProfiles method.
        """
        return microsoft_graph_assigned_access_multi_mode_profiles_request_builder.MicrosoftGraphAssignedAccessMultiModeProfilesRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_windows_privacy_access_controls(self) -> microsoft_graph_windows_privacy_access_controls_request_builder.MicrosoftGraphWindowsPrivacyAccessControlsRequestBuilder:
        """
        Provides operations to call the windowsPrivacyAccessControls method.
        """
        return microsoft_graph_windows_privacy_access_controls_request_builder.MicrosoftGraphWindowsPrivacyAccessControlsRequestBuilder(self.request_adapter, self.path_parameters)
