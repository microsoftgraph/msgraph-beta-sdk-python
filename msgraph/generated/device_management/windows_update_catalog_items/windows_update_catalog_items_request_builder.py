...
count_request_builder = lazy_import('msgraph.generated.device_management.windows_update_catalog_items.count.count_request_builder')
windows_update_catalog_item = lazy_import('msgraph.generated.models.windows_update_catalog_item')
windows_update_catalog_item_collection_response = lazy_import('msgraph.generated.models.windows_update_catalog_item_collection_response')
...
class WindowsUpdateCatalogItemsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsUpdateCatalogItemsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[windows_update_catalog_item.WindowsUpdateCatalogItem] = None, request_configuration: Optional[WindowsUpdateCatalogItemsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
