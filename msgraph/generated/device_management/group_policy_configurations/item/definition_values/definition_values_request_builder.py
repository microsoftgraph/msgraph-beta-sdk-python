...
if TYPE_CHECKING:
    ...
    from .....models.group_policy_definition_value_collection_response import GroupPolicyDefinitionValueCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.group_policy_definition_value_item_request_builder import GroupPolicyDefinitionValueItemRequestBuilder

class DefinitionValuesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}/definitionValues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_group_policy_definition_value_id(self,group_policy_definition_value_id: str) -> GroupPolicyDefinitionValueItemRequestBuilder:
        """
        Provides operations to manage the definitionValues property of the microsoft.graph.groupPolicyConfiguration entity.
        param group_policy_definition_value_id: The unique identifier of groupPolicyDefinitionValue
    ...
    async def get(self,request_configuration: Optional[DefinitionValuesRequestBuilderGetRequestConfiguration] = None) -> Optional[GroupPolicyDefinitionValueCollectionResponse]:
        ...
        Returns: Optional[GroupPolicyDefinitionValueCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DefinitionValuesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DefinitionValuesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return DefinitionValuesRequestBuilder(self.request_adapter, raw_url)
