...
class GroupPolicyPresentationValueItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_presentation_value_id: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyPresentationValueItemRequestBuilder and sets the default values.
        Args:
            groupPolicyPresentationValueId: key: id of groupPolicyPresentationValue
        ...
        url_tpl_params["groupPolicyPresentationValue%2Did"] = groupPolicyPresentationValueId
