...
class UpdateDefinitionValuesPostRequestBody(AdditionalDataHolder, Parsable):
    ...
    # The added property
    added: Optional[List[group_policy_definition_value.GroupPolicyDefinitionValue]] = None
    # The deletedIds property
    deleted_ids: Optional[List[str]] = None
    # The updated property
    updated: Optional[List[group_policy_definition_value.GroupPolicyDefinitionValue]] = None
