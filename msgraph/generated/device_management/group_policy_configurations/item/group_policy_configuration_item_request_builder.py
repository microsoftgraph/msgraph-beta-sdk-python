...
class GroupPolicyConfigurationItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[GroupPolicyConfigurationItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[GroupPolicyConfigurationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[group_policy_configuration.GroupPolicyConfiguration] = None, request_configuration: Optional[GroupPolicyConfigurationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
