...
if TYPE_CHECKING:
    from ...models import user_experience_analytics_device_without_cloud_identity, user_experience_analytics_device_without_cloud_identity_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import user_experience_analytics_device_without_cloud_identity_item_request_builder

class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsDevicesWithoutCloudIdentity{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_user_experience_analytics_device_without_cloud_identity_id(self,user_experience_analytics_device_without_cloud_identity_id: str) -> user_experience_analytics_device_without_cloud_identity_item_request_builder.UserExperienceAnalyticsDeviceWithoutCloudIdentityItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsDevicesWithoutCloudIdentity property of the microsoft.graph.deviceManagement entity.
        Args:
            user_experience_analytics_device_without_cloud_identity_id: Unique identifier of the item
        ...
        if user_experience_analytics_device_without_cloud_identity_id is None:
            raise Exception("user_experience_analytics_device_without_cloud_identity_id cannot be undefined")
        from .item import user_experience_analytics_device_without_cloud_identity_item_request_builder
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_device_without_cloud_identity_collection_response.UserExperienceAnalyticsDeviceWithoutCloudIdentityCollectionResponse]:
        ...
        from ...models import user_experience_analytics_device_without_cloud_identity_collection_response
    ...
    async def post(self,body: Optional[user_experience_analytics_device_without_cloud_identity.UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration] = None) -> Optional[user_experience_analytics_device_without_cloud_identity.UserExperienceAnalyticsDeviceWithoutCloudIdentity]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ...models import user_experience_analytics_device_without_cloud_identity
    ...
    def to_post_request_information(self,body: Optional[user_experience_analytics_device_without_cloud_identity.UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsDevicesWithoutCloudIdentity for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
