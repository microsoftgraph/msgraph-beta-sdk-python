...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_devices_without_cloud_identity.count.count_request_builder')
...
user_experience_analytics_device_without_cloud_identity_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_device_without_cloud_identity_collection_response')
...
class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
