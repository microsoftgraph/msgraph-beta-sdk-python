...
class ManagedDeviceEncryptionStatesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[managed_device_encryption_state.ManagedDeviceEncryptionState] = None, request_configuration: Optional[ManagedDeviceEncryptionStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedDeviceEncryptionStates for deviceManagement
        Args:
            body: The request body
