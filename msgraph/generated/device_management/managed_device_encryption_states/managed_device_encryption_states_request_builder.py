...
count_request_builder = lazy_import('msgraph.generated.device_management.managed_device_encryption_states.count.count_request_builder')
managed_device_encryption_state = lazy_import('msgraph.generated.models.managed_device_encryption_state')
managed_device_encryption_state_collection_response = lazy_import('msgraph.generated.models.managed_device_encryption_state_collection_response')
...
class ManagedDeviceEncryptionStatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagedDeviceEncryptionStatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[managed_device_encryption_state.ManagedDeviceEncryptionState] = None, request_configuration: Optional[ManagedDeviceEncryptionStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
