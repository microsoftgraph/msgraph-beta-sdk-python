...
class GetAssignmentFiltersStatusDetailsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/microsoft.graph.getAssignmentFiltersStatusDetails"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[get_assignment_filters_status_details_post_request_body.GetAssignmentFiltersStatusDetailsPostRequestBody] = None, request_configuration: Optional[GetAssignmentFiltersStatusDetailsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
