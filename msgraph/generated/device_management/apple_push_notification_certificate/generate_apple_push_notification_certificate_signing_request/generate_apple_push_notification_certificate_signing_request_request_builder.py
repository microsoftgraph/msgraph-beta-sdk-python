...
if TYPE_CHECKING:
    from . import generate_apple_push_notification_certificate_signing_request_response
...
class GenerateApplePushNotificationCertificateSigningRequestRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/applePushNotificationCertificate/generateApplePushNotificationCertificateSigningRequest"
