...
class RestrictedAppsViolationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, restricted_apps_violation_id: Optional[str] = None) -> None:
        """
        Instantiates a new RestrictedAppsViolationItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            restrictedAppsViolationId: key: id of restrictedAppsViolation
        """
        ...
        url_tpl_params["restrictedAppsViolation%2Did"] = restrictedAppsViolationId
    ...
    async def get(self,request_configuration: Optional[RestrictedAppsViolationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[restricted_apps_violation.RestrictedAppsViolation]:
        """
    ...
    async def patch(self,body: Optional[restricted_apps_violation.RestrictedAppsViolation] = None, request_configuration: Optional[RestrictedAppsViolationItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[restricted_apps_violation.RestrictedAppsViolation]:
        """
    ...
    def to_patch_request_information(self,body: Optional[restricted_apps_violation.RestrictedAppsViolation] = None, request_configuration: Optional[RestrictedAppsViolationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceConfigurationRestrictedAppsViolations in deviceManagement
        Args:
            body: The request body
