...
count_request_builder = lazy_import('msgraph.generated.device_management.device_configuration_restricted_apps_violations.count.count_request_builder')
restricted_apps_violation = lazy_import('msgraph.generated.models.restricted_apps_violation')
restricted_apps_violation_collection_response = lazy_import('msgraph.generated.models.restricted_apps_violation_collection_response')
...
class DeviceConfigurationRestrictedAppsViolationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/deviceConfigurationRestrictedAppsViolations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[DeviceConfigurationRestrictedAppsViolationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[restricted_apps_violation.RestrictedAppsViolation] = None, request_configuration: Optional[DeviceConfigurationRestrictedAppsViolationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class DeviceConfigurationRestrictedAppsViolationsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
