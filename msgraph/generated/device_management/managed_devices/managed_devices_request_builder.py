...
microsoft_graph_app_diagnostics_with_upn_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_app_diagnostics_with_upn.microsoft_graph_app_diagnostics_with_upn_request_builder')
microsoft_graph_bulk_reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_bulk_reprovision_cloud_pc.microsoft_graph_bulk_reprovision_cloud_pc_request_builder')
microsoft_graph_bulk_restore_cloud_pc_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_bulk_restore_cloud_pc.microsoft_graph_bulk_restore_cloud_pc_request_builder')
microsoft_graph_bulk_set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_bulk_set_cloud_pc_review_status.microsoft_graph_bulk_set_cloud_pc_review_status_request_builder')
microsoft_graph_download_app_diagnostics_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_download_app_diagnostics.microsoft_graph_download_app_diagnostics_request_builder')
microsoft_graph_execute_action_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_execute_action.microsoft_graph_execute_action_request_builder')
microsoft_graph_move_devices_to_o_u_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.microsoft_graph_move_devices_to_o_u.microsoft_graph_move_devices_to_o_u_request_builder')
