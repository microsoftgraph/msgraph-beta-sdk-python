...
count_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.item.security_baseline_states.count.count_request_builder')
security_baseline_state = lazy_import('msgraph.generated.models.security_baseline_state')
security_baseline_state_collection_response = lazy_import('msgraph.generated.models.security_baseline_state_collection_response')
...
class SecurityBaselineStatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SecurityBaselineStatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[security_baseline_state.SecurityBaselineState] = None, request_configuration: Optional[SecurityBaselineStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
