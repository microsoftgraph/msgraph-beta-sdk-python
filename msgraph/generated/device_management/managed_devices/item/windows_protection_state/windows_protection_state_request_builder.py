...
detected_malware_state_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.item.windows_protection_state.detected_malware_state.detected_malware_state_request_builder')
windows_device_malware_state_item_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.item.windows_protection_state.detected_malware_state.item.windows_device_malware_state_item_request_builder')
