...
count_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.item.log_collection_requests.count.count_request_builder')
device_log_collection_response = lazy_import('msgraph.generated.models.device_log_collection_response')
device_log_collection_response_collection_response = lazy_import('msgraph.generated.models.device_log_collection_response_collection_response')
...
class LogCollectionRequestsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[LogCollectionRequestsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_log_collection_response.DeviceLogCollectionResponse] = None, request_configuration: Optional[LogCollectionRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
