...
create_download_url_request_builder = lazy_import('msgraph.generated.device_management.managed_devices.item.log_collection_requests.item.microsoft_graph_create_download_url.create_download_url_request_builder')
...
class DeviceLogCollectionResponseItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_log_collection_response_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceLogCollectionResponseItemRequestBuilder and sets the default values.
        Args:
            deviceLogCollectionResponseId: key: id of deviceLogCollectionResponse
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["deviceLogCollectionResponse%2Did"] = deviceLogCollectionResponseId
    ...
    def to_patch_request_information(self,body: Optional[device_log_collection_response.DeviceLogCollectionResponse] = None, request_configuration: Optional[DeviceLogCollectionResponseItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property logCollectionRequests in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class DeviceLogCollectionResponseItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DeviceLogCollectionResponseItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
