...
restore_cloud_pc_post_request_body = lazy_import('msgraph.generated.device_management.managed_devices.item.restore_cloud_pc.restore_cloud_pc_post_request_body')
...
class RestoreCloudPcRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/restoreCloudPc"
