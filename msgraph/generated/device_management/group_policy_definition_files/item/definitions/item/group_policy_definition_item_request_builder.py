...
class GroupPolicyDefinitionItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_definition_id: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyDefinitionItemRequestBuilder and sets the default values.
        Args:
            groupPolicyDefinitionId: key: id of groupPolicyDefinition
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/groupPolicyDefinitionFiles/{groupPolicyDefinitionFile%2Did}/definitions/{groupPolicyDefinition%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["groupPolicyDefinition%2Did"] = groupPolicyDefinitionId
