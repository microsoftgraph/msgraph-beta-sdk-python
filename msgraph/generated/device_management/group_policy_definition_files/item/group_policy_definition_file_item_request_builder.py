...
class GroupPolicyDefinitionFileItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_definition_file_id: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyDefinitionFileItemRequestBuilder and sets the default values.
        Args:
            groupPolicyDefinitionFileId: key: id of groupPolicyDefinitionFile
        ...
        url_tpl_params["groupPolicyDefinitionFile%2Did"] = groupPolicyDefinitionFileId
    ...
    def to_patch_request_information(self,body: Optional[group_policy_definition_file.GroupPolicyDefinitionFile] = None, request_configuration: Optional[GroupPolicyDefinitionFileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property groupPolicyDefinitionFiles in deviceManagement
        Args:
            body: The request body
