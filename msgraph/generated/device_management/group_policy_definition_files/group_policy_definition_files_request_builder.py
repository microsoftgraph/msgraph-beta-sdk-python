...
count_request_builder = lazy_import('msgraph.generated.device_management.group_policy_definition_files.count.count_request_builder')
group_policy_definition_file = lazy_import('msgraph.generated.models.group_policy_definition_file')
group_policy_definition_file_collection_response = lazy_import('msgraph.generated.models.group_policy_definition_file_collection_response')
...
class GroupPolicyDefinitionFilesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GroupPolicyDefinitionFilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[group_policy_definition_file.GroupPolicyDefinitionFile] = None, request_configuration: Optional[GroupPolicyDefinitionFilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[GroupPolicyDefinitionFilesRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[group_policy_definition_file_collection_response.GroupPolicyDefinitionFileCollectionResponse]:
        """
        The available group policy definition files for this account.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        return await self.request_adapter.send_async(request_info, group_policy_definition_file_collection_response.GroupPolicyDefinitionFileCollectionResponse, response_handler, error_mapping)
    
    async def post(self,body: Optional[group_policy_definition_file.GroupPolicyDefinitionFile] = None, request_configuration: Optional[GroupPolicyDefinitionFilesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[group_policy_definition_file.GroupPolicyDefinitionFile]:
        """
        Create new navigation property to groupPolicyDefinitionFiles for deviceManagement
        Args:
            body: The request body
