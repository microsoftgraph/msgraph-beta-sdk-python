...
microsoft_graph_enable_request_builder = lazy_import('msgraph.generated.device_management.tenant_attach_r_b_a_c.microsoft_graph_enable.microsoft_graph_enable_request_builder')
microsoft_graph_get_state_request_builder = lazy_import('msgraph.generated.device_management.tenant_attach_r_b_a_c.microsoft_graph_get_state.microsoft_graph_get_state_request_builder')
...
class TenantAttachRBACRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/tenantAttachRBAC{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[tenant_attach_r_b_a_c.TenantAttachRBAC] = None, request_configuration: Optional[TenantAttachRBACRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property tenantAttachRBAC in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class TenantAttachRBACRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class TenantAttachRBACRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
