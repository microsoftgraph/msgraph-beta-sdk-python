...
enable_request_builder = lazy_import('msgraph.generated.device_management.tenant_attach_r_b_a_c.enable.enable_request_builder')
get_state_request_builder = lazy_import('msgraph.generated.device_management.tenant_attach_r_b_a_c.get_state.get_state_request_builder')
...
class TenantAttachRBACRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TenantAttachRBACRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TenantAttachRBACRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[tenant_attach_r_b_a_c.TenantAttachRBAC] = None, request_configuration: Optional[TenantAttachRBACRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
