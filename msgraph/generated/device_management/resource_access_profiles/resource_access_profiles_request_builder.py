...
query_by_platform_type_request_builder = lazy_import('msgraph.generated.device_management.resource_access_profiles.query_by_platform_type.query_by_platform_type_request_builder')
...
class ResourceAccessProfilesRequestBuilder():
    ...
    def query_by_platform_type(self) -> query_by_platform_type_request_builder.QueryByPlatformTypeRequestBuilder:
        ...
        """
        return query_by_platform_type_request_builder.QueryByPlatformTypeRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def create_get_request_information(self,request_configuration: Optional[ResourceAccessProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_resource_access_profile_base.DeviceManagementResourceAccessProfileBase] = None, request_configuration: Optional[ResourceAccessProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
