...
count_request_builder = lazy_import('msgraph.generated.device_management.resource_access_profiles.count.count_request_builder')
microsoft_graph_query_by_platform_type_request_builder = lazy_import('msgraph.generated.device_management.resource_access_profiles.microsoft_graph_query_by_platform_type.microsoft_graph_query_by_platform_type_request_builder')
...
device_management_resource_access_profile_base_collection_response = lazy_import('msgraph.generated.models.device_management_resource_access_profile_base_collection_response')
...
class ResourceAccessProfilesRequestBuilder():
    ...
    @property
    def microsoft_graph_query_by_platform_type(self) -> microsoft_graph_query_by_platform_type_request_builder.MicrosoftGraphQueryByPlatformTypeRequestBuilder:
        """
        Provides operations to call the queryByPlatformType method.
        """
        return microsoft_graph_query_by_platform_type_request_builder.MicrosoftGraphQueryByPlatformTypeRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def to_post_request_information(self,body: Optional[device_management_resource_access_profile_base.DeviceManagementResourceAccessProfileBase] = None, request_configuration: Optional[ResourceAccessProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to resourceAccessProfiles for deviceManagement
        Args:
            body: The request body
