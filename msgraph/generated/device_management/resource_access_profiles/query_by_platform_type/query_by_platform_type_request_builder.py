...
class QueryByPlatformTypeRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[query_by_platform_type_post_request_body.QueryByPlatformTypePostRequestBody] = None, request_configuration: Optional[QueryByPlatformTypeRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
