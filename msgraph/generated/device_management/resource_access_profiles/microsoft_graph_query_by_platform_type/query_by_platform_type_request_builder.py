...
query_by_platform_type_post_request_body = lazy_import('msgraph.generated.device_management.resource_access_profiles.microsoft_graph_query_by_platform_type.query_by_platform_type_post_request_body')
query_by_platform_type_response = lazy_import('msgraph.generated.device_management.resource_access_profiles.microsoft_graph_query_by_platform_type.query_by_platform_type_response')
...
class QueryByPlatformTypeRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/resourceAccessProfiles/microsoft.graph.queryByPlatformType"
    ...
    @dataclass
    class QueryByPlatformTypeRequestBuilderPostRequestConfiguration():
        """
