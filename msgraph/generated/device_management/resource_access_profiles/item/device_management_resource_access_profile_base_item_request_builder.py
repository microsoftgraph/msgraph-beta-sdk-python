...
assign_request_builder = lazy_import('msgraph.generated.device_management.resource_access_profiles.item.microsoft_graph_assign.assign_request_builder')
...
class DeviceManagementResourceAccessProfileBaseItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_resource_access_profile_base_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["deviceManagementResourceAccessProfileBase%2Did"] = deviceManagementResourceAccessProfileBaseId
