...
if TYPE_CHECKING:
    from .....models import base_collection_pagination_count_response, device_management_resource_access_profile_assignment
...
class AssignResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[device_management_resource_access_profile_assignment.DeviceManagementResourceAccessProfileAssignment]] = None
