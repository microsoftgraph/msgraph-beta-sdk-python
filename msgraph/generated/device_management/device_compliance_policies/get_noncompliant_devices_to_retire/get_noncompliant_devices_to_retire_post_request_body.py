...
class GetNoncompliantDevicesToRetirePostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getNoncompliantDevicesToRetirePostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetNoncompliantDevicesToRetirePostRequestBody:
        """
        ...
        return GetNoncompliantDevicesToRetirePostRequestBody()
