...
get_devices_scheduled_to_retire_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_get_devices_scheduled_to_retire.get_devices_scheduled_to_retire_request_builder')
get_noncompliant_devices_to_retire_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_get_noncompliant_devices_to_retire.get_noncompliant_devices_to_retire_request_builder')
has_payload_links_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_has_payload_links.has_payload_links_request_builder')
refresh_device_compliance_report_summarization_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_refresh_device_compliance_report_summarization.refresh_device_compliance_report_summarization_request_builder')
set_scheduled_retire_state_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_set_scheduled_retire_state.set_scheduled_retire_state_request_builder')
validate_compliance_script_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.microsoft_graph_validate_compliance_script.validate_compliance_script_request_builder')
...
class DeviceCompliancePoliciesRequestBuilder():
    ...
    @property
    def microsoft_graph_get_devices_scheduled_to_retire(self) -> get_devices_scheduled_to_retire_request_builder.GetDevicesScheduledToRetireRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_noncompliant_devices_to_retire(self) -> get_noncompliant_devices_to_retire_request_builder.GetNoncompliantDevicesToRetireRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_refresh_device_compliance_report_summarization(self) -> refresh_device_compliance_report_summarization_request_builder.RefreshDeviceComplianceReportSummarizationRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_set_scheduled_retire_state(self) -> set_scheduled_retire_state_request_builder.SetScheduledRetireStateRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_validate_compliance_script(self) -> validate_compliance_script_request_builder.ValidateComplianceScriptRequestBuilder:
        """
