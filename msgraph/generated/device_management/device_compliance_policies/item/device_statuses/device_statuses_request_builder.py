...
count_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_policies.item.device_statuses.count.count_request_builder')
device_compliance_device_status = lazy_import('msgraph.generated.models.device_compliance_device_status')
device_compliance_device_status_collection_response = lazy_import('msgraph.generated.models.device_compliance_device_status_collection_response')
...
class DeviceStatusesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[device_compliance_device_status.DeviceComplianceDeviceStatus] = None, request_configuration: Optional[DeviceStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
