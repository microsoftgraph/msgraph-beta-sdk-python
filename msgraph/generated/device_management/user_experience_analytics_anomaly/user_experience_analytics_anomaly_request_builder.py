...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_anomaly.count.count_request_builder')
user_experience_analytics_anomaly = lazy_import('msgraph.generated.models.user_experience_analytics_anomaly')
user_experience_analytics_anomaly_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_anomaly_collection_response')
...
class UserExperienceAnalyticsAnomalyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomaly{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsAnomalyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_experience_analytics_anomaly.UserExperienceAnalyticsAnomaly] = None, request_configuration: Optional[UserExperienceAnalyticsAnomalyRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsAnomalyRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
