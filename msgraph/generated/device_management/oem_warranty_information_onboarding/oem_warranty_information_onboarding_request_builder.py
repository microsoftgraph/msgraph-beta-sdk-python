...
count_request_builder = lazy_import('msgraph.generated.device_management.oem_warranty_information_onboarding.count.count_request_builder')
oem_warranty_information_onboarding = lazy_import('msgraph.generated.models.oem_warranty_information_onboarding')
oem_warranty_information_onboarding_collection_response = lazy_import('msgraph.generated.models.oem_warranty_information_onboarding_collection_response')
...
class OemWarrantyInformationOnboardingRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/oemWarrantyInformationOnboarding{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[OemWarrantyInformationOnboardingRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[oem_warranty_information_onboarding.OemWarrantyInformationOnboarding] = None, request_configuration: Optional[OemWarrantyInformationOnboardingRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class OemWarrantyInformationOnboardingRequestBuilderGetQueryParameters():
        """
        List of OEM Warranty Statuses
        """
    ...
    class OemWarrantyInformationOnboardingRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[OemWarrantyInformationOnboardingRequestBuilder.OemWarrantyInformationOnboardingRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class OemWarrantyInformationOnboardingRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
