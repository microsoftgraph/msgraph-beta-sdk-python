...
class OemWarrantyInformationOnboardingRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[oem_warranty_information_onboarding.OemWarrantyInformationOnboarding] = None, request_configuration: Optional[OemWarrantyInformationOnboardingRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to oemWarrantyInformationOnboarding for deviceManagement
        Args:
            body: The request body
