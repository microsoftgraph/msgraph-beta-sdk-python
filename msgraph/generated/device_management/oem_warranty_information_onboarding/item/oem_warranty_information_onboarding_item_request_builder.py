...
disable_request_builder = lazy_import('msgraph.generated.device_management.oem_warranty_information_onboarding.item.microsoft_graph_disable.disable_request_builder')
enable_request_builder = lazy_import('msgraph.generated.device_management.oem_warranty_information_onboarding.item.microsoft_graph_enable.enable_request_builder')
...
class OemWarrantyInformationOnboardingItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, oem_warranty_information_onboarding_id: Optional[str] = None) -> None:
        """
        Instantiates a new OemWarrantyInformationOnboardingItemRequestBuilder and sets the default values.
        Args:
            oemWarrantyInformationOnboardingId: key: id of oemWarrantyInformationOnboarding
        ...
        url_tpl_params["oemWarrantyInformationOnboarding%2Did"] = oemWarrantyInformationOnboardingId
