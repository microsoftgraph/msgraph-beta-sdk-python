...
class OemWarrantyInformationOnboardingItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[OemWarrantyInformationOnboardingItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[OemWarrantyInformationOnboardingItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[oem_warranty_information_onboarding.OemWarrantyInformationOnboarding] = None, request_configuration: Optional[OemWarrantyInformationOnboardingItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
