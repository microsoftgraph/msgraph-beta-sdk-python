...
count_request_builder = lazy_import('msgraph.generated.device_management.group_policy_definitions.item.next_version_definition.presentations.count.count_request_builder')
