...
count_request_builder = lazy_import('msgraph.generated.device_management.group_policy_definitions.item.next_version_definition.previous_version_definition.presentations.count.count_request_builder')
group_policy_presentation = lazy_import('msgraph.generated.models.group_policy_presentation')
group_policy_presentation_collection_response = lazy_import('msgraph.generated.models.group_policy_presentation_collection_response')
...
class PresentationsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PresentationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[group_policy_presentation.GroupPolicyPresentation] = None, request_configuration: Optional[PresentationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
