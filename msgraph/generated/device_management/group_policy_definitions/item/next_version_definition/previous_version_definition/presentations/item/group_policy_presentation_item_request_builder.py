...
class GroupPolicyPresentationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_presentation_id: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyPresentationItemRequestBuilder and sets the default values.
        Args:
            groupPolicyPresentationId: key: id of groupPolicyPresentation
        ...
        url_tpl_params["groupPolicyPresentation%2Did"] = groupPolicyPresentationId
    ...
    async def get(self,request_configuration: Optional[GroupPolicyPresentationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[group_policy_presentation.GroupPolicyPresentation]:
        """
