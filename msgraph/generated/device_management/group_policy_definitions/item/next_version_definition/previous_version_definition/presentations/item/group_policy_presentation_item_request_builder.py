...
class GroupPolicyPresentationItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[group_policy_presentation.GroupPolicyPresentation] = None, request_configuration: Optional[GroupPolicyPresentationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property presentations in deviceManagement
        Args:
            body: The request body
