...
class DefinitionRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[DefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[group_policy_definition.GroupPolicyDefinition]:
        """
