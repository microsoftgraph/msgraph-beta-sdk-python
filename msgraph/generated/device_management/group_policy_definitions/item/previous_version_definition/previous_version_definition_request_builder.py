...
class PreviousVersionDefinitionRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PreviousVersionDefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[GroupPolicyDefinition]:
        """
    ...
    async def patch(self,body: Optional[GroupPolicyDefinition] = None, request_configuration: Optional[PreviousVersionDefinitionRequestBuilderPatchRequestConfiguration] = None) -> Optional[GroupPolicyDefinition]:
        """
    ...
    def to_patch_request_information(self,body: Optional[GroupPolicyDefinition] = None, request_configuration: Optional[PreviousVersionDefinitionRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property previousVersionDefinition in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PreviousVersionDefinitionRequestBuilder:
        """
        ...
        return PreviousVersionDefinitionRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class PreviousVersionDefinitionRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PreviousVersionDefinitionRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PreviousVersionDefinitionRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
