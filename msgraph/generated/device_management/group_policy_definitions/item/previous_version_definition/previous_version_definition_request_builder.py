...
class PreviousVersionDefinitionRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[PreviousVersionDefinitionRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Definition of the previous version of this definition
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[group_policy_definition.GroupPolicyDefinition] = None, request_configuration: Optional[PreviousVersionDefinitionRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property previousVersionDefinition in deviceManagement
        Args:
            body: The request body
