...
class UserExperienceAnalyticsDeviceScopeRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[UserExperienceAnalyticsDeviceScopeRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsDeviceScopeRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[user_experience_analytics_device_scope.UserExperienceAnalyticsDeviceScope] = None, request_configuration: Optional[UserExperienceAnalyticsDeviceScopeRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
