...
microsoft_graph_trigger_device_scope_action_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_device_scope.microsoft_graph_trigger_device_scope_action.microsoft_graph_trigger_device_scope_action_request_builder')
...
class UserExperienceAnalyticsDeviceScopeRequestBuilder():
    """
    ...
    """
    @property
    def microsoft_graph_trigger_device_scope_action(self) -> microsoft_graph_trigger_device_scope_action_request_builder.MicrosoftGraphTriggerDeviceScopeActionRequestBuilder:
        """
        Provides operations to call the triggerDeviceScopeAction method.
        """
        return microsoft_graph_trigger_device_scope_action_request_builder.MicrosoftGraphTriggerDeviceScopeActionRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceScope{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[user_experience_analytics_device_scope.UserExperienceAnalyticsDeviceScope] = None, request_configuration: Optional[UserExperienceAnalyticsDeviceScopeRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsDeviceScope in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class UserExperienceAnalyticsDeviceScopeRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsDeviceScopeRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
