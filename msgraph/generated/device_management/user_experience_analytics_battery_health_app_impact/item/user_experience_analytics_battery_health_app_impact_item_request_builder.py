...
class UserExperienceAnalyticsBatteryHealthAppImpactItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthAppImpactItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthAppImpactItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
