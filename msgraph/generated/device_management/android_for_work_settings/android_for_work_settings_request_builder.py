...
if TYPE_CHECKING:
    from ...models.android_for_work_settings import AndroidForWorkSettings
...
class AndroidForWorkSettingsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/androidForWorkSettings{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AndroidForWorkSettingsRequestBuilderGetRequestConfiguration] = None) -> Optional[AndroidForWorkSettings]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[AndroidForWorkSettings]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AndroidForWorkSettingsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AndroidForWorkSettingsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return AndroidForWorkSettingsRequestBuilder(raw_url, self.request_adapter)
