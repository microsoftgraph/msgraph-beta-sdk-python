...
get_global_script_highest_available_version_response = lazy_import('msgraph.generated.device_management.device_health_scripts.item.get_global_script_highest_available_version.get_global_script_highest_available_version_response')
...
class GetGlobalScriptHighestAvailableVersionRequestBuilder():
    ...
    def create_post_request_information(self,request_configuration: Optional[GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
