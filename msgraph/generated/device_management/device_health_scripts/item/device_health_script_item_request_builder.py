...
assign_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.item.microsoft_graph_assign.assign_request_builder')
get_global_script_highest_available_version_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.item.microsoft_graph_get_global_script_highest_available_version.get_global_script_highest_available_version_request_builder')
get_remediation_history_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.item.microsoft_graph_get_remediation_history.get_remediation_history_request_builder')
update_global_script_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.item.microsoft_graph_update_global_script.update_global_script_request_builder')
...
class DeviceHealthScriptItemRequestBuilder():
    ...
    @property
    def microsoft_graph_get_global_script_highest_available_version(self) -> get_global_script_highest_available_version_request_builder.GetGlobalScriptHighestAvailableVersionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_remediation_history(self) -> get_remediation_history_request_builder.GetRemediationHistoryRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_update_global_script(self) -> update_global_script_request_builder.UpdateGlobalScriptRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_health_script_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceHealthScriptItemRequestBuilder and sets the default values.
        Args:
            deviceHealthScriptId: key: id of deviceHealthScript
        ...
        url_tpl_params["deviceHealthScript%2Did"] = deviceHealthScriptId
