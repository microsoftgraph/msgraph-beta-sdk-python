...
class DeviceHealthScriptItemRequestBuilder():
    ...
    def assignments_by_id(self,id: str) -> Optional[device_health_script_assignment_item_request_builder.DeviceHealthScriptAssignmentItemRequestBuilder]:
        """
        Provides operations to manage the assignments property of the microsoft.graph.deviceHealthScript entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[device_health_script_assignment_item_request_builder.DeviceHealthScriptAssignmentItemRequestBuilder]
        """
        if id is None:
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceHealthScriptItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceHealthScriptItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_health_script.DeviceHealthScript] = None, request_configuration: Optional[DeviceHealthScriptItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def device_run_states_by_id(self,id: str) -> Optional[device_health_script_device_state_item_request_builder.DeviceHealthScriptDeviceStateItemRequestBuilder]:
        """
        Provides operations to manage the deviceRunStates property of the microsoft.graph.deviceHealthScript entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[device_health_script_device_state_item_request_builder.DeviceHealthScriptDeviceStateItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
