...
class AreGlobalScriptsAvailableRequestBuilder(BaseRequestBuilder):
    """
    ...
    @dataclass
    class AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
