...
class GetRemediationSummaryRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetRemediationSummaryRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
