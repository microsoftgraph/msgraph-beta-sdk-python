...
microsoft_graph_are_global_scripts_available_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.microsoft_graph_are_global_scripts_available.microsoft_graph_are_global_scripts_available_request_builder')
microsoft_graph_enable_global_scripts_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.microsoft_graph_enable_global_scripts.microsoft_graph_enable_global_scripts_request_builder')
microsoft_graph_get_remediation_summary_request_builder = lazy_import('msgraph.generated.device_management.device_health_scripts.microsoft_graph_get_remediation_summary.microsoft_graph_get_remediation_summary_request_builder')
...
class DeviceHealthScriptsRequestBuilder():
    ...
    @property
    def microsoft_graph_are_global_scripts_available(self) -> microsoft_graph_are_global_scripts_available_request_builder.MicrosoftGraphAreGlobalScriptsAvailableRequestBuilder:
        """
        Provides operations to call the areGlobalScriptsAvailable method.
        """
        return microsoft_graph_are_global_scripts_available_request_builder.MicrosoftGraphAreGlobalScriptsAvailableRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_enable_global_scripts(self) -> microsoft_graph_enable_global_scripts_request_builder.MicrosoftGraphEnableGlobalScriptsRequestBuilder:
        """
        Provides operations to call the enableGlobalScripts method.
        """
        return microsoft_graph_enable_global_scripts_request_builder.MicrosoftGraphEnableGlobalScriptsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_get_remediation_summary(self) -> microsoft_graph_get_remediation_summary_request_builder.MicrosoftGraphGetRemediationSummaryRequestBuilder:
        """
        Provides operations to call the getRemediationSummary method.
        """
        return microsoft_graph_get_remediation_summary_request_builder.MicrosoftGraphGetRemediationSummaryRequestBuilder(self.request_adapter, self.path_parameters)
