...
class DeviceManagementExchangeOnPremisesPolicyItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DeviceManagementExchangeOnPremisesPolicyItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_exchange_on_premises_policy.DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[DeviceManagementExchangeOnPremisesPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property exchangeOnPremisesPolicies in deviceManagement
        Args:
            body: The request body
