...
if TYPE_CHECKING:
    from ...models import device_management_exchange_on_premises_policy, device_management_exchange_on_premises_policy_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import device_management_exchange_on_premises_policy_item_request_builder
...
class ExchangeOnPremisesPoliciesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/exchangeOnPremisesPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_device_management_exchange_on_premises_policy_id(self,device_management_exchange_on_premises_policy_id: str) -> device_management_exchange_on_premises_policy_item_request_builder.DeviceManagementExchangeOnPremisesPolicyItemRequestBuilder:
        """
        Provides operations to manage the exchangeOnPremisesPolicies property of the microsoft.graph.deviceManagement entity.
        Args:
            device_management_exchange_on_premises_policy_id: Unique identifier of the item
        ...
        """
        if device_management_exchange_on_premises_policy_id is None:
            raise Exception("device_management_exchange_on_premises_policy_id cannot be undefined")
        from .item import device_management_exchange_on_premises_policy_item_request_builder
    ...
    async def get(self,request_configuration: Optional[ExchangeOnPremisesPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_exchange_on_premises_policy_collection_response.DeviceManagementExchangeOnPremisesPolicyCollectionResponse]:
        ...
        from ...models import device_management_exchange_on_premises_policy_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_management_exchange_on_premises_policy.DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[ExchangeOnPremisesPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to exchangeOnPremisesPolicies for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class ExchangeOnPremisesPoliciesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class ExchangeOnPremisesPoliciesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
