...
if TYPE_CHECKING:
    ...
    from ...models.device_management_exchange_on_premises_policy_collection_response import DeviceManagementExchangeOnPremisesPolicyCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.device_management_exchange_on_premises_policy_item_request_builder import DeviceManagementExchangeOnPremisesPolicyItemRequestBuilder

class ExchangeOnPremisesPoliciesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/exchangeOnPremisesPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_device_management_exchange_on_premises_policy_id(self,device_management_exchange_on_premises_policy_id: str) -> DeviceManagementExchangeOnPremisesPolicyItemRequestBuilder:
        """
        Provides operations to manage the exchangeOnPremisesPolicies property of the microsoft.graph.deviceManagement entity.
        param device_management_exchange_on_premises_policy_id: The unique identifier of deviceManagementExchangeOnPremisesPolicy
    ...
    async def get(self,request_configuration: Optional[ExchangeOnPremisesPoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[DeviceManagementExchangeOnPremisesPolicyCollectionResponse]:
        ...
        Returns: Optional[DeviceManagementExchangeOnPremisesPolicyCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ExchangeOnPremisesPoliciesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ExchangeOnPremisesPoliciesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ExchangeOnPremisesPoliciesRequestBuilder(self.request_adapter, raw_url)
