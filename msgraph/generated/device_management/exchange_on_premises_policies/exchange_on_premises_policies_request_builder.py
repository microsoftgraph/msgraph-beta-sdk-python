...
count_request_builder = lazy_import('msgraph.generated.device_management.exchange_on_premises_policies.count.count_request_builder')
...
device_management_exchange_on_premises_policy_collection_response = lazy_import('msgraph.generated.models.device_management_exchange_on_premises_policy_collection_response')
...
class ExchangeOnPremisesPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ExchangeOnPremisesPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_exchange_on_premises_policy.DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[ExchangeOnPremisesPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
