...
class AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemaItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[android_managed_store_app_configuration_schema.AndroidManagedStoreAppConfigurationSchema] = None, request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemaItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property androidManagedStoreAppConfigurationSchemas in deviceManagement
        Args:
            body: The request body
