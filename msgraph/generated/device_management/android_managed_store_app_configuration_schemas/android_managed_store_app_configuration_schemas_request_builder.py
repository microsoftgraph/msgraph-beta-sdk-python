...
if TYPE_CHECKING:
    from ...models import android_managed_store_app_configuration_schema, android_managed_store_app_configuration_schema_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import android_managed_store_app_configuration_schema_item_request_builder

class AndroidManagedStoreAppConfigurationSchemasRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/androidManagedStoreAppConfigurationSchemas{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_android_managed_store_app_configuration_schema_id(self,android_managed_store_app_configuration_schema_id: str) -> android_managed_store_app_configuration_schema_item_request_builder.AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder:
        """
        Provides operations to manage the androidManagedStoreAppConfigurationSchemas property of the microsoft.graph.deviceManagement entity.
        Args:
            android_managed_store_app_configuration_schema_id: Unique identifier of the item
        ...
        """
        if android_managed_store_app_configuration_schema_id is None:
            raise Exception("android_managed_store_app_configuration_schema_id cannot be undefined")
        from .item import android_managed_store_app_configuration_schema_item_request_builder
    ...
    async def get(self,request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderGetRequestConfiguration] = None) -> Optional[android_managed_store_app_configuration_schema_collection_response.AndroidManagedStoreAppConfigurationSchemaCollectionResponse]:
        ...
        from ...models import android_managed_store_app_configuration_schema_collection_response
    ...
    async def post(self,body: Optional[android_managed_store_app_configuration_schema.AndroidManagedStoreAppConfigurationSchema] = None, request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderPostRequestConfiguration] = None) -> Optional[android_managed_store_app_configuration_schema.AndroidManagedStoreAppConfigurationSchema]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ...models import android_managed_store_app_configuration_schema
    ...
    def to_post_request_information(self,body: Optional[android_managed_store_app_configuration_schema.AndroidManagedStoreAppConfigurationSchema] = None, request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to androidManagedStoreAppConfigurationSchemas for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class AndroidManagedStoreAppConfigurationSchemasRequestBuilderGetQueryParameters():
        """
        Android Enterprise app configuration schema entities.
        """
    ...
    @dataclass
    class AndroidManagedStoreAppConfigurationSchemasRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class AndroidManagedStoreAppConfigurationSchemasRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
