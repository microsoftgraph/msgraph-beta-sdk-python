...
if TYPE_CHECKING:
    ...
    from ...models.android_managed_store_app_configuration_schema_collection_response import AndroidManagedStoreAppConfigurationSchemaCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.android_managed_store_app_configuration_schema_item_request_builder import AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder

class AndroidManagedStoreAppConfigurationSchemasRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/androidManagedStoreAppConfigurationSchemas{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_android_managed_store_app_configuration_schema_id(self,android_managed_store_app_configuration_schema_id: str) -> AndroidManagedStoreAppConfigurationSchemaItemRequestBuilder:
        """
        Provides operations to manage the androidManagedStoreAppConfigurationSchemas property of the microsoft.graph.deviceManagement entity.
        param android_managed_store_app_configuration_schema_id: The unique identifier of androidManagedStoreAppConfigurationSchema
    ...
    async def get(self,request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderGetRequestConfiguration] = None) -> Optional[AndroidManagedStoreAppConfigurationSchemaCollectionResponse]:
        ...
        Returns: Optional[AndroidManagedStoreAppConfigurationSchemaCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AndroidManagedStoreAppConfigurationSchemasRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AndroidManagedStoreAppConfigurationSchemasRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return AndroidManagedStoreAppConfigurationSchemasRequestBuilder(self.request_adapter, raw_url)
