...
count_request_builder = lazy_import('msgraph.generated.device_management.android_managed_store_app_configuration_schemas.count.count_request_builder')
...
android_managed_store_app_configuration_schema_collection_response = lazy_import('msgraph.generated.models.android_managed_store_app_configuration_schema_collection_response')
...
class AndroidManagedStoreAppConfigurationSchemasRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[android_managed_store_app_configuration_schema.AndroidManagedStoreAppConfigurationSchema] = None, request_configuration: Optional[AndroidManagedStoreAppConfigurationSchemasRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
