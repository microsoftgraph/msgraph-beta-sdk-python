...
microsoft_graph_import_device_identity_list_request_builder = lazy_import('msgraph.generated.device_management.imported_device_identities.microsoft_graph_import_device_identity_list.microsoft_graph_import_device_identity_list_request_builder')
microsoft_graph_search_existing_identities_request_builder = lazy_import('msgraph.generated.device_management.imported_device_identities.microsoft_graph_search_existing_identities.microsoft_graph_search_existing_identities_request_builder')
...
class ImportedDeviceIdentitiesRequestBuilder():
    ...
    @property
    def microsoft_graph_import_device_identity_list(self) -> microsoft_graph_import_device_identity_list_request_builder.MicrosoftGraphImportDeviceIdentityListRequestBuilder:
        """
        Provides operations to call the importDeviceIdentityList method.
        """
        return microsoft_graph_import_device_identity_list_request_builder.MicrosoftGraphImportDeviceIdentityListRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_search_existing_identities(self) -> microsoft_graph_search_existing_identities_request_builder.MicrosoftGraphSearchExistingIdentitiesRequestBuilder:
        """
        Provides operations to call the searchExistingIdentities method.
        """
        return microsoft_graph_search_existing_identities_request_builder.MicrosoftGraphSearchExistingIdentitiesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/importedDeviceIdentities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[imported_device_identity.ImportedDeviceIdentity] = None, request_configuration: Optional[ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to importedDeviceIdentities for deviceManagement
        Args:
            body: The request body
    ...
    class ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[ImportedDeviceIdentitiesRequestBuilder.ImportedDeviceIdentitiesRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
