...
from ...models import imported_device_identity, imported_device_identity_collection_response
...
class ImportedDeviceIdentitiesRequestBuilder():
    ...
    def search_existing_identities(self) -> search_existing_identities_request_builder.SearchExistingIdentitiesRequestBuilder:
        ...
        """
        return search_existing_identities_request_builder.SearchExistingIdentitiesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def create_get_request_information(self,request_configuration: Optional[ImportedDeviceIdentitiesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[imported_device_identity.ImportedDeviceIdentity] = None, request_configuration: Optional[ImportedDeviceIdentitiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
