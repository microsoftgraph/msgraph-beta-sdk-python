...
class ImportedDeviceIdentityItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, imported_device_identity_id: Optional[str] = None) -> None:
        """
        Instantiates a new ImportedDeviceIdentityItemRequestBuilder and sets the default values.
        Args:
            importedDeviceIdentityId: key: id of importedDeviceIdentity
        ...
        url_tpl_params["importedDeviceIdentity%2Did"] = importedDeviceIdentityId
    ...
    def to_patch_request_information(self,body: Optional[imported_device_identity.ImportedDeviceIdentity] = None, request_configuration: Optional[ImportedDeviceIdentityItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property importedDeviceIdentities in deviceManagement
        Args:
            body: The request body
