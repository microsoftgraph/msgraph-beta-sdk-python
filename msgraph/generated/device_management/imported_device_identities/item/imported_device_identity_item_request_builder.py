...
class ImportedDeviceIdentityItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ImportedDeviceIdentityItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ImportedDeviceIdentityItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[imported_device_identity.ImportedDeviceIdentity] = None, request_configuration: Optional[ImportedDeviceIdentityItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
