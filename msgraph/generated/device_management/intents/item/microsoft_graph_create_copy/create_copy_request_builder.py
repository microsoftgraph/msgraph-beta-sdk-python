...
create_copy_post_request_body = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_create_copy.create_copy_post_request_body')
...
class CreateCopyRequestBuilder():
    ...
    async def post(self,body: Optional[create_copy_post_request_body.CreateCopyPostRequestBody] = None, request_configuration: Optional[CreateCopyRequestBuilderPostRequestConfiguration] = None) -> Optional[device_management_intent.DeviceManagementIntent]:
        """
