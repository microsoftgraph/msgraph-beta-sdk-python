...
assign_request_builder = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_assign.assign_request_builder')
compare_with_template_id_request_builder = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_compare_with_template_id.compare_with_template_id_request_builder')
create_copy_request_builder = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_create_copy.create_copy_request_builder')
migrate_to_template_request_builder = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_migrate_to_template.migrate_to_template_request_builder')
update_settings_request_builder = lazy_import('msgraph.generated.device_management.intents.item.microsoft_graph_update_settings.update_settings_request_builder')
...
class DeviceManagementIntentItemRequestBuilder():
    ...
    @property
    def microsoft_graph_migrate_to_template(self) -> migrate_to_template_request_builder.MigrateToTemplateRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_update_settings(self) -> update_settings_request_builder.UpdateSettingsRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_intent_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementIntentItemRequestBuilder and sets the default values.
        Args:
            deviceManagementIntentId: key: id of deviceManagementIntent
        ...
        url_tpl_params["deviceManagementIntent%2Did"] = deviceManagementIntentId
    ...
    def microsoft_graph_compare_with_template_id(self,template_id: Optional[str] = None) -> compare_with_template_id_request_builder.CompareWithTemplateIdRequestBuilder:
        """
