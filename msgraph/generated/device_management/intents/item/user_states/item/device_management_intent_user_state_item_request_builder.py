...
class DeviceManagementIntentUserStateItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DeviceManagementIntentUserStateItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_intent_user_state.DeviceManagementIntentUserState] = None, request_configuration: Optional[DeviceManagementIntentUserStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userStates in deviceManagement
        Args:
            body: The request body
