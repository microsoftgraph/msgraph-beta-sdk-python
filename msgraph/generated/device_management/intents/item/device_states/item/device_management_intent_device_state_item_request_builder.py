...
class DeviceManagementIntentDeviceStateItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_intent_device_state_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementIntentDeviceStateItemRequestBuilder and sets the default values.
        Args:
            deviceManagementIntentDeviceStateId: key: id of deviceManagementIntentDeviceState
        ...
        url_tpl_params["deviceManagementIntentDeviceState%2Did"] = deviceManagementIntentDeviceStateId
    ...
    async def get(self,request_configuration: Optional[DeviceManagementIntentDeviceStateItemRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_intent_device_state.DeviceManagementIntentDeviceState]:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_intent_device_state.DeviceManagementIntentDeviceState] = None, request_configuration: Optional[DeviceManagementIntentDeviceStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceStates in deviceManagement
        Args:
            body: The request body
