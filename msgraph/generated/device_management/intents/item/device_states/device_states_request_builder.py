...
count_request_builder = lazy_import('msgraph.generated.device_management.intents.item.device_states.count.count_request_builder')
device_management_intent_device_state = lazy_import('msgraph.generated.models.device_management_intent_device_state')
device_management_intent_device_state_collection_response = lazy_import('msgraph.generated.models.device_management_intent_device_state_collection_response')
...
class DeviceStatesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[device_management_intent_device_state.DeviceManagementIntentDeviceState] = None, request_configuration: Optional[DeviceStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
