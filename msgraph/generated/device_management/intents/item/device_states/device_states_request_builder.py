...
if TYPE_CHECKING:
    from .....models import device_management_intent_device_state, device_management_intent_device_state_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import device_management_intent_device_state_item_request_builder
...
class DeviceStatesRequestBuilder():
    ...
    def by_device_management_intent_device_state_id(self,device_management_intent_device_state_id: str) -> device_management_intent_device_state_item_request_builder.DeviceManagementIntentDeviceStateItemRequestBuilder:
        """
        Provides operations to manage the deviceStates property of the microsoft.graph.deviceManagementIntent entity.
        Args:
        ...
        if device_management_intent_device_state_id is None:
            raise Exception("device_management_intent_device_state_id cannot be undefined")
        from .item import device_management_intent_device_state_item_request_builder
    ...
    async def get(self,request_configuration: Optional[DeviceStatesRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_intent_device_state_collection_response.DeviceManagementIntentDeviceStateCollectionResponse]:
        ...
        from .....models import device_management_intent_device_state_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_management_intent_device_state.DeviceManagementIntentDeviceState] = None, request_configuration: Optional[DeviceStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceStates for deviceManagement
        Args:
            body: The request body
