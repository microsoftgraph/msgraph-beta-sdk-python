...
count_request_builder = lazy_import('msgraph.generated.device_management.intents.item.categories.count.count_request_builder')
device_management_intent_setting_category = lazy_import('msgraph.generated.models.device_management_intent_setting_category')
device_management_intent_setting_category_collection_response = lazy_import('msgraph.generated.models.device_management_intent_setting_category_collection_response')
...
class CategoriesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[device_management_intent_setting_category.DeviceManagementIntentSettingCategory] = None, request_configuration: Optional[CategoriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
