...
settings_request_builder = lazy_import('msgraph.generated.device_management.intents.item.categories.item.settings.settings_request_builder')
device_management_setting_instance_item_request_builder = lazy_import('msgraph.generated.device_management.intents.item.categories.item.settings.item.device_management_setting_instance_item_request_builder')
...
class DeviceManagementIntentSettingCategoryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_intent_setting_category_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementIntentSettingCategoryItemRequestBuilder and sets the default values.
        Args:
            deviceManagementIntentSettingCategoryId: key: id of deviceManagementIntentSettingCategory
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/categories/{deviceManagementIntentSettingCategory%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["deviceManagementIntentSettingCategory%2Did"] = deviceManagementIntentSettingCategoryId
    ...
    def to_patch_request_information(self,body: Optional[device_management_intent_setting_category.DeviceManagementIntentSettingCategory] = None, request_configuration: Optional[DeviceManagementIntentSettingCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property categories in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class DeviceManagementIntentSettingCategoryItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DeviceManagementIntentSettingCategoryItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
