...
class DeviceManagementIntentSettingCategoryItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceManagementIntentSettingCategoryItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceManagementIntentSettingCategoryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_management_intent_setting_category.DeviceManagementIntentSettingCategory] = None, request_configuration: Optional[DeviceManagementIntentSettingCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
