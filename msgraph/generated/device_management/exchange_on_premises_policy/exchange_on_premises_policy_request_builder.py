...
class ExchangeOnPremisesPolicyRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_exchange_on_premises_policy.DeviceManagementExchangeOnPremisesPolicy]:
        """
