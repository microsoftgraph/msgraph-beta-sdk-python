...
create_copy_post_request_body = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.create_copy.create_copy_post_request_body')
...
class CreateCopyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/reusablePolicySettings/{deviceManagementReusablePolicySetting%2Did}/referencingConfigurationPolicies/{deviceManagementConfigurationPolicy%2Did}/createCopy"
