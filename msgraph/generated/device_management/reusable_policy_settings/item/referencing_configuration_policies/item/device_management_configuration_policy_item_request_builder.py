...
microsoft_graph_assign_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_assign.microsoft_graph_assign_request_builder')
microsoft_graph_create_copy_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_create_copy.microsoft_graph_create_copy_request_builder')
microsoft_graph_reorder_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_reorder.microsoft_graph_reorder_request_builder')
...
class DeviceManagementConfigurationPolicyItemRequestBuilder():
    ...
    @property
    def microsoft_graph_reorder(self) -> microsoft_graph_reorder_request_builder.MicrosoftGraphReorderRequestBuilder:
        """
        Provides operations to call the reorder method.
        """
        return microsoft_graph_reorder_request_builder.MicrosoftGraphReorderRequestBuilder(self.request_adapter, self.path_parameters)
