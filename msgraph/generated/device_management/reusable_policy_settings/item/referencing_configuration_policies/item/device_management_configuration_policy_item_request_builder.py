...
assign_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_assign.assign_request_builder')
create_copy_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_create_copy.create_copy_request_builder')
reorder_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.referencing_configuration_policies.item.microsoft_graph_reorder.reorder_request_builder')
