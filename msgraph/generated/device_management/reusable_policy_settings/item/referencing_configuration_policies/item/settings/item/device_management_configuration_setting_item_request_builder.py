...
class DeviceManagementConfigurationSettingItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_configuration_setting_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementConfigurationSettingItemRequestBuilder and sets the default values.
        Args:
            deviceManagementConfigurationSettingId: key: id of deviceManagementConfigurationSetting
        ...
        url_tpl_params["deviceManagementConfigurationSetting%2Did"] = deviceManagementConfigurationSettingId
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[DeviceManagementConfigurationSettingItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[DeviceManagementConfigurationSettingItemRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_configuration_setting.DeviceManagementConfigurationSetting]:
        """
        Policy settings
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[DeviceManagementConfigurationSettingItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Policy settings
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[device_management_configuration_setting.DeviceManagementConfigurationSetting] = None, request_configuration: Optional[DeviceManagementConfigurationSettingItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property settings in deviceManagement
        Args:
            body: The request body
