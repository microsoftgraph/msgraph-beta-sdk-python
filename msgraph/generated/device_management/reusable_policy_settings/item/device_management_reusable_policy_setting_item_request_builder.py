...
class DeviceManagementReusablePolicySettingItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceManagementReusablePolicySettingItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceManagementReusablePolicySettingItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_management_reusable_policy_setting.DeviceManagementReusablePolicySetting] = None, request_configuration: Optional[DeviceManagementReusablePolicySettingItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
