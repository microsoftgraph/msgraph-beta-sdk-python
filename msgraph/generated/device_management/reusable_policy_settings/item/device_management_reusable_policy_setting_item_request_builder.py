...
microsoft_graph_clone_request_builder = lazy_import('msgraph.generated.device_management.reusable_policy_settings.item.microsoft_graph_clone.microsoft_graph_clone_request_builder')
...
class DeviceManagementReusablePolicySettingItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[device_management_reusable_policy_setting.DeviceManagementReusablePolicySetting] = None, request_configuration: Optional[DeviceManagementReusablePolicySettingItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property reusablePolicySettings in deviceManagement
        Args:
            body: The request body
