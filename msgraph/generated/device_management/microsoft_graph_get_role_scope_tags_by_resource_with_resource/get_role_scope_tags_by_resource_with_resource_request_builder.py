...
class GetRoleScopeTagsByResourceWithResourceRequestBuilder():
    """
    ...
    @dataclass
    class GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[GetRoleScopeTagsByResourceWithResourceRequestBuilder.GetRoleScopeTagsByResourceWithResourceRequestBuilderGetQueryParameters] = None
