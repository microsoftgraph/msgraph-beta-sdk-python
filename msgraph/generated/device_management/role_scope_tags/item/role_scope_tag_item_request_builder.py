...
class RoleScopeTagItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[RoleScopeTagItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[RoleScopeTagItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The Role Scope Tags.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def create_patch_request_information(self,body: Optional[role_scope_tag.RoleScopeTag] = None, request_configuration: Optional[RoleScopeTagItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
