...
count_request_builder = lazy_import('msgraph.generated.device_management.role_scope_tags.item.assignments.count.count_request_builder')
role_scope_tag_auto_assignment = lazy_import('msgraph.generated.models.role_scope_tag_auto_assignment')
role_scope_tag_auto_assignment_collection_response = lazy_import('msgraph.generated.models.role_scope_tag_auto_assignment_collection_response')
...
class AssignmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[role_scope_tag_auto_assignment.RoleScopeTagAutoAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
