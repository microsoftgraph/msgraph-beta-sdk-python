...
if TYPE_CHECKING:
    from .....models import role_scope_tag_auto_assignment, role_scope_tag_auto_assignment_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import role_scope_tag_auto_assignment_item_request_builder
...
class AssignmentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_role_scope_tag_auto_assignment_id(self,role_scope_tag_auto_assignment_id: str) -> role_scope_tag_auto_assignment_item_request_builder.RoleScopeTagAutoAssignmentItemRequestBuilder:
        """
        Provides operations to manage the assignments property of the microsoft.graph.roleScopeTag entity.
        Args:
            role_scope_tag_auto_assignment_id: Unique identifier of the item
        Returns: role_scope_tag_auto_assignment_item_request_builder.RoleScopeTagAutoAssignmentItemRequestBuilder
        """
        if role_scope_tag_auto_assignment_id is None:
            raise Exception("role_scope_tag_auto_assignment_id cannot be undefined")
        from .item import role_scope_tag_auto_assignment_item_request_builder
    ...
    async def get(self,request_configuration: Optional[AssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[role_scope_tag_auto_assignment_collection_response.RoleScopeTagAutoAssignmentCollectionResponse]:
        ...
        from .....models import role_scope_tag_auto_assignment_collection_response
    ...
    def to_post_request_information(self,body: Optional[role_scope_tag_auto_assignment.RoleScopeTagAutoAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to assignments for deviceManagement
        Args:
            body: The request body
