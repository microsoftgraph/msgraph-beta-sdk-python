...
class RoleScopeTagAutoAssignmentItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/roleScopeTags/{roleScopeTag%2Did}/assignments/{roleScopeTagAutoAssignment%2Did}{?%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> RoleScopeTagAutoAssignmentItemRequestBuilder:
        ...
        return RoleScopeTagAutoAssignmentItemRequestBuilder(raw_url, self.request_adapter)
