...
class RoleScopeTagsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[role_scope_tag.RoleScopeTag] = None, request_configuration: Optional[RoleScopeTagsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
