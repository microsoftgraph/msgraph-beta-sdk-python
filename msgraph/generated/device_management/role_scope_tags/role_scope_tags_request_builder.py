...
microsoft_graph_get_role_scope_tags_by_id_request_builder = lazy_import('msgraph.generated.device_management.role_scope_tags.microsoft_graph_get_role_scope_tags_by_id.microsoft_graph_get_role_scope_tags_by_id_request_builder')
microsoft_graph_has_custom_role_scope_tag_request_builder = lazy_import('msgraph.generated.device_management.role_scope_tags.microsoft_graph_has_custom_role_scope_tag.microsoft_graph_has_custom_role_scope_tag_request_builder')
...
class RoleScopeTagsRequestBuilder():
    ...
    @property
    def microsoft_graph_get_role_scope_tags_by_id(self) -> microsoft_graph_get_role_scope_tags_by_id_request_builder.MicrosoftGraphGetRoleScopeTagsByIdRequestBuilder:
        """
        Provides operations to call the getRoleScopeTagsById method.
        """
        return microsoft_graph_get_role_scope_tags_by_id_request_builder.MicrosoftGraphGetRoleScopeTagsByIdRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_has_custom_role_scope_tag(self) -> microsoft_graph_has_custom_role_scope_tag_request_builder.MicrosoftGraphHasCustomRoleScopeTagRequestBuilder:
        """
        Provides operations to call the hasCustomRoleScopeTag method.
        """
        return microsoft_graph_has_custom_role_scope_tag_request_builder.MicrosoftGraphHasCustomRoleScopeTagRequestBuilder(self.request_adapter, self.path_parameters)
