...
execute_action_post_request_body = lazy_import('msgraph.generated.device_management.windows_driver_update_profiles.item.microsoft_graph_execute_action.execute_action_post_request_body')
bulk_driver_action_result = lazy_import('msgraph.generated.models.bulk_driver_action_result')
...
class ExecuteActionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/{windowsDriverUpdateProfile%2Did}/microsoft.graph.executeAction"
