...
class WindowsDriverUpdateProfileAssignmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[WindowsDriverUpdateProfileAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[windows_driver_update_profile_assignment.WindowsDriverUpdateProfileAssignment] = None, request_configuration: Optional[WindowsDriverUpdateProfileAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceManagement
        Args:
            body: The request body
