...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_device_timeline_events.count.count_request_builder')
...
user_experience_analytics_device_timeline_events_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_device_timeline_events_collection_response')
...
class UserExperienceAnalyticsDeviceTimelineEventsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceTimelineEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[user_experience_analytics_device_timeline_events.UserExperienceAnalyticsDeviceTimelineEvents] = None, request_configuration: Optional[UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsDeviceTimelineEvents for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[UserExperienceAnalyticsDeviceTimelineEventsRequestBuilder.UserExperienceAnalyticsDeviceTimelineEventsRequestBuilderGetQueryParameters] = None
