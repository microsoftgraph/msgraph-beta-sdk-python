...
class GroupPolicyCategoryItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_policy_category_id1: Optional[str] = None) -> None:
        """
        Instantiates a new GroupPolicyCategoryItemRequestBuilder and sets the default values.
        Args:
            groupPolicyCategoryId1: key: id of groupPolicyCategory
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/groupPolicyCategories/{groupPolicyCategory%2Did}/children/{groupPolicyCategory%2Did1}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["groupPolicyCategory%2Did1"] = groupPolicyCategoryId1
