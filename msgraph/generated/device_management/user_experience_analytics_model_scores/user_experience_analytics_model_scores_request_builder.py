...
if TYPE_CHECKING:
    ...
    from ...models.user_experience_analytics_model_scores_collection_response import UserExperienceAnalyticsModelScoresCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.user_experience_analytics_model_scores_item_request_builder import UserExperienceAnalyticsModelScoresItemRequestBuilder
...
class UserExperienceAnalyticsModelScoresRequestBuilder():
    ...
    def by_user_experience_analytics_model_scores_id(self,user_experience_analytics_model_scores_id: str) -> UserExperienceAnalyticsModelScoresItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsModelScores property of the microsoft.graph.deviceManagement entity.
        Args:
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration] = None) -> Optional[UserExperienceAnalyticsModelScoresCollectionResponse]:
        ...
        Returns: Optional[UserExperienceAnalyticsModelScoresCollectionResponse]
        """
