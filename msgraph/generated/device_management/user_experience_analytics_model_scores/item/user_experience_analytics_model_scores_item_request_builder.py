...
class UserExperienceAnalyticsModelScoresItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[UserExperienceAnalyticsModelScoresItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsModelScoresItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[user_experience_analytics_model_scores.UserExperienceAnalyticsModelScores] = None, request_configuration: Optional[UserExperienceAnalyticsModelScoresItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsModelScoresItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsModelScoresItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
