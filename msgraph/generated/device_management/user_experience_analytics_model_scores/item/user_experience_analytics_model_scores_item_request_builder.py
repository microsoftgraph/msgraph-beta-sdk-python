...
class UserExperienceAnalyticsModelScoresItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[UserExperienceAnalyticsModelScoresItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[user_experience_analytics_model_scores.UserExperienceAnalyticsModelScores] = None, request_configuration: Optional[UserExperienceAnalyticsModelScoresItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsModelScores in deviceManagement
        Args:
            body: The request body
