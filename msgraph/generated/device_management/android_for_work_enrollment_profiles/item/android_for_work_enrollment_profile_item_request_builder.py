...
class AndroidForWorkEnrollmentProfileItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/androidForWorkEnrollmentProfiles/{androidForWorkEnrollmentProfile%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderGetRequestConfiguration] = None) -> Optional[AndroidForWorkEnrollmentProfile]:
        """
    ...
    async def patch(self,body: Optional[AndroidForWorkEnrollmentProfile] = None, request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[AndroidForWorkEnrollmentProfile]:
        """
    ...
    def to_patch_request_information(self,body: Optional[AndroidForWorkEnrollmentProfile] = None, request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property androidForWorkEnrollmentProfiles in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AndroidForWorkEnrollmentProfileItemRequestBuilder:
        """
    ...
    @dataclass
    class AndroidForWorkEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AndroidForWorkEnrollmentProfileItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AndroidForWorkEnrollmentProfileItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
