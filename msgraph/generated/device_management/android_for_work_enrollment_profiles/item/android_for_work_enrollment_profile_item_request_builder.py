...
class AndroidForWorkEnrollmentProfileItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[android_for_work_enrollment_profile.AndroidForWorkEnrollmentProfile] = None, request_configuration: Optional[AndroidForWorkEnrollmentProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
