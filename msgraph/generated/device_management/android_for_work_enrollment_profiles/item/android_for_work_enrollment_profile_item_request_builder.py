...
create_token_request_builder = lazy_import('msgraph.generated.device_management.android_for_work_enrollment_profiles.item.microsoft_graph_create_token.create_token_request_builder')
revoke_token_request_builder = lazy_import('msgraph.generated.device_management.android_for_work_enrollment_profiles.item.microsoft_graph_revoke_token.revoke_token_request_builder')
...
class AndroidForWorkEnrollmentProfileItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, android_for_work_enrollment_profile_id: Optional[str] = None) -> None:
        """
        Instantiates a new AndroidForWorkEnrollmentProfileItemRequestBuilder and sets the default values.
        Args:
            androidForWorkEnrollmentProfileId: key: id of androidForWorkEnrollmentProfile
        ...
        url_tpl_params["androidForWorkEnrollmentProfile%2Did"] = androidForWorkEnrollmentProfileId
