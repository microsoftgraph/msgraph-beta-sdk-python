...
microsoft_graph_create_token_request_builder = lazy_import('msgraph.generated.device_management.android_for_work_enrollment_profiles.item.microsoft_graph_create_token.microsoft_graph_create_token_request_builder')
microsoft_graph_revoke_token_request_builder = lazy_import('msgraph.generated.device_management.android_for_work_enrollment_profiles.item.microsoft_graph_revoke_token.microsoft_graph_revoke_token_request_builder')
