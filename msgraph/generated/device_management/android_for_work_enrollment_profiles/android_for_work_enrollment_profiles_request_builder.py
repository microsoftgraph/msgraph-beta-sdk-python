...
count_request_builder = lazy_import('msgraph.generated.device_management.android_for_work_enrollment_profiles.count.count_request_builder')
android_for_work_enrollment_profile = lazy_import('msgraph.generated.models.android_for_work_enrollment_profile')
android_for_work_enrollment_profile_collection_response = lazy_import('msgraph.generated.models.android_for_work_enrollment_profile_collection_response')
...
class AndroidForWorkEnrollmentProfilesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AndroidForWorkEnrollmentProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[android_for_work_enrollment_profile.AndroidForWorkEnrollmentProfile] = None, request_configuration: Optional[AndroidForWorkEnrollmentProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
