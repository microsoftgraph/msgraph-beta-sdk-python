...
if TYPE_CHECKING:
    from ...models import device_management_setting_category, device_management_setting_category_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import device_management_setting_category_item_request_builder
...
class CategoriesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_device_management_setting_category_id(self,device_management_setting_category_id: str) -> device_management_setting_category_item_request_builder.DeviceManagementSettingCategoryItemRequestBuilder:
        """
        Provides operations to manage the categories property of the microsoft.graph.deviceManagement entity.
        Args:
            device_management_setting_category_id: Unique identifier of the item
        Returns: device_management_setting_category_item_request_builder.DeviceManagementSettingCategoryItemRequestBuilder
        """
        if device_management_setting_category_id is None:
            raise Exception("device_management_setting_category_id cannot be undefined")
        from .item import device_management_setting_category_item_request_builder
    ...
    async def get(self,request_configuration: Optional[CategoriesRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_setting_category_collection_response.DeviceManagementSettingCategoryCollectionResponse]:
        ...
        from ...models import device_management_setting_category_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_management_setting_category.DeviceManagementSettingCategory] = None, request_configuration: Optional[CategoriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to categories for deviceManagement
        Args:
            body: The request body
