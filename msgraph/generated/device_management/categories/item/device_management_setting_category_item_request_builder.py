...
class DeviceManagementSettingCategoryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_setting_category_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementSettingCategoryItemRequestBuilder and sets the default values.
        Args:
            deviceManagementSettingCategoryId: key: id of deviceManagementSettingCategory
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/categories/{deviceManagementSettingCategory%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["deviceManagementSettingCategory%2Did"] = deviceManagementSettingCategoryId
    ...
    async def get(self,request_configuration: Optional[DeviceManagementSettingCategoryItemRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_setting_category.DeviceManagementSettingCategory]:
        """
    ...
    async def patch(self,body: Optional[device_management_setting_category.DeviceManagementSettingCategory] = None, request_configuration: Optional[DeviceManagementSettingCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[device_management_setting_category.DeviceManagementSettingCategory]:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_setting_category.DeviceManagementSettingCategory] = None, request_configuration: Optional[DeviceManagementSettingCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property categories in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class DeviceManagementSettingCategoryItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
