...
class CloudPCConnectivityIssuesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[cloud_p_c_connectivity_issue.CloudPCConnectivityIssue] = None, request_configuration: Optional[CloudPCConnectivityIssuesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cloudPCConnectivityIssues for deviceManagement
        Args:
            body: The request body
