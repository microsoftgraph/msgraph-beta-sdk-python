...
count_request_builder = lazy_import('msgraph.generated.device_management.cloud_p_c_connectivity_issues.count.count_request_builder')
cloud_p_c_connectivity_issue = lazy_import('msgraph.generated.models.cloud_p_c_connectivity_issue')
cloud_p_c_connectivity_issue_collection_response = lazy_import('msgraph.generated.models.cloud_p_c_connectivity_issue_collection_response')
...
class CloudPCConnectivityIssuesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/cloudPCConnectivityIssues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[CloudPCConnectivityIssuesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[cloud_p_c_connectivity_issue.CloudPCConnectivityIssue] = None, request_configuration: Optional[CloudPCConnectivityIssuesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class CloudPCConnectivityIssuesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class CloudPCConnectivityIssuesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
