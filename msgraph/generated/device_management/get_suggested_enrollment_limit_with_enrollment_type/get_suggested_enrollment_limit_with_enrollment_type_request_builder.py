...
class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration] = None) -> Optional[suggested_enrollment_limit.SuggestedEnrollmentLimit]:
        """
