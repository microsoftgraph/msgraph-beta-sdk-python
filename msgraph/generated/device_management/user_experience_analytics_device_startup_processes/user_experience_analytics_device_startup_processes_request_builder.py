...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_device_startup_processes.count.count_request_builder')
...
user_experience_analytics_device_startup_process_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_device_startup_process_collection_response')
...
class UserExperienceAnalyticsDeviceStartupProcessesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsDeviceStartupProcessesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_experience_analytics_device_startup_process.UserExperienceAnalyticsDeviceStartupProcess] = None, request_configuration: Optional[UserExperienceAnalyticsDeviceStartupProcessesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
