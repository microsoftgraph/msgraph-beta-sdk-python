...
microsoft_graph_get_policy_summary_with_policy_id_request_builder = lazy_import('msgraph.generated.device_management.config_manager_collections.microsoft_graph_get_policy_summary_with_policy_id.microsoft_graph_get_policy_summary_with_policy_id_request_builder')
...
class ConfigManagerCollectionsRequestBuilder():
    ...
    def microsoft_graph_get_policy_summary_with_policy_id(self,policy_id: Optional[str] = None) -> microsoft_graph_get_policy_summary_with_policy_id_request_builder.MicrosoftGraphGetPolicySummaryWithPolicyIdRequestBuilder:
        """
        Provides operations to call the getPolicySummary method.
        Args:
            policyId: Usage: policyId='{policyId}'
        Returns: microsoft_graph_get_policy_summary_with_policy_id_request_builder.MicrosoftGraphGetPolicySummaryWithPolicyIdRequestBuilder
        """
        if policy_id is None:
            raise Exception("policy_id cannot be undefined")
        return microsoft_graph_get_policy_summary_with_policy_id_request_builder.MicrosoftGraphGetPolicySummaryWithPolicyIdRequestBuilder(self.request_adapter, self.path_parameters, policyId)
