...
class DataSharingConsentItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DataSharingConsentItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DataSharingConsentItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[data_sharing_consent.DataSharingConsent] = None, request_configuration: Optional[DataSharingConsentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
