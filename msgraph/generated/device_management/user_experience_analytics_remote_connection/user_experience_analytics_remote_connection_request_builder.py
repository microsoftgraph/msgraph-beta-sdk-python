...
summarize_device_remote_connection_with_summarize_by_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_remote_connection.microsoft_graph_summarize_device_remote_connection_with_summarize_by.summarize_device_remote_connection_with_summarize_by_request_builder')
...
class UserExperienceAnalyticsRemoteConnectionRequestBuilder():
    ...
    def microsoft_graph_summarize_device_remote_connection_with_summarize_by(self,summarize_by: Optional[str] = None) -> summarize_device_remote_connection_with_summarize_by_request_builder.SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder:
        """
        Provides operations to call the summarizeDeviceRemoteConnection method.
        Args:
            summarizeBy: Usage: summarizeBy='{summarizeBy}'
        Returns: summarize_device_remote_connection_with_summarize_by_request_builder.SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder
        """
        if summarize_by is None:
            raise Exception("summarize_by cannot be undefined")
        return summarize_device_remote_connection_with_summarize_by_request_builder.SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder(self.request_adapter, self.path_parameters, summarizeBy)
