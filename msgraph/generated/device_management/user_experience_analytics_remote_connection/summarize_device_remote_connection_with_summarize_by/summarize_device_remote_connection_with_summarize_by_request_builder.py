...
if TYPE_CHECKING:
    ...
    from .summarize_device_remote_connection_with_summarize_by_response import SummarizeDeviceRemoteConnectionWithSummarizeByResponse
...
class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration] = None) -> Optional[SummarizeDeviceRemoteConnectionWithSummarizeByResponse]:
        ...
        Returns: Optional[SummarizeDeviceRemoteConnectionWithSummarizeByResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, SummarizeDeviceRemoteConnectionWithSummarizeByResponse, error_mapping)
