...
if TYPE_CHECKING:
    from ...models import user_experience_analytics_battery_health_device_runtime_history, user_experience_analytics_battery_health_device_runtime_history_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import user_experience_analytics_battery_health_device_runtime_history_item_request_builder
...
class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsBatteryHealthDeviceRuntimeHistory{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_user_experience_analytics_battery_health_device_runtime_history_id(self,user_experience_analytics_battery_health_device_runtime_history_id: str) -> user_experience_analytics_battery_health_device_runtime_history_item_request_builder.UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsBatteryHealthDeviceRuntimeHistory property of the microsoft.graph.deviceManagement entity.
        Args:
            user_experience_analytics_battery_health_device_runtime_history_id: Unique identifier of the item
        ...
        if user_experience_analytics_battery_health_device_runtime_history_id is None:
            raise Exception("user_experience_analytics_battery_health_device_runtime_history_id cannot be undefined")
        from .item import user_experience_analytics_battery_health_device_runtime_history_item_request_builder
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_battery_health_device_runtime_history_collection_response.UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryCollectionResponse]:
        ...
        from ...models import user_experience_analytics_battery_health_device_runtime_history_collection_response
