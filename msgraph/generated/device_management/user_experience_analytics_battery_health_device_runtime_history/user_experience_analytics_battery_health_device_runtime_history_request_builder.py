...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_battery_health_device_runtime_history.count.count_request_builder')
...
user_experience_analytics_battery_health_device_runtime_history_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_battery_health_device_runtime_history_collection_response')
...
class UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthDeviceRuntimeHistoryRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
