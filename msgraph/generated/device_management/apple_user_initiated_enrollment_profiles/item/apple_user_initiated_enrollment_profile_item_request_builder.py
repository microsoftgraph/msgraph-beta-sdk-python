...
class AppleUserInitiatedEnrollmentProfileItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[AppleUserInitiatedEnrollmentProfileItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[AppleUserInitiatedEnrollmentProfileItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[apple_user_initiated_enrollment_profile.AppleUserInitiatedEnrollmentProfile] = None, request_configuration: Optional[AppleUserInitiatedEnrollmentProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
