...
class MacOSSoftwareUpdateCategorySummaryItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[MacOSSoftwareUpdateCategorySummaryItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MacOSSoftwareUpdateCategorySummaryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[mac_o_s_software_update_category_summary.MacOSSoftwareUpdateCategorySummary] = None, request_configuration: Optional[MacOSSoftwareUpdateCategorySummaryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
