...
count_request_builder = lazy_import('msgraph.generated.device_management.mac_o_s_software_update_account_summaries.item.category_summaries.count.count_request_builder')
mac_o_s_software_update_category_summary = lazy_import('msgraph.generated.models.mac_o_s_software_update_category_summary')
mac_o_s_software_update_category_summary_collection_response = lazy_import('msgraph.generated.models.mac_o_s_software_update_category_summary_collection_response')
...
class CategorySummariesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CategorySummariesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mac_o_s_software_update_category_summary.MacOSSoftwareUpdateCategorySummary] = None, request_configuration: Optional[CategorySummariesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
