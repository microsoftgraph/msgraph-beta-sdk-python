...
category_summaries_request_builder = lazy_import('msgraph.generated.device_management.mac_o_s_software_update_account_summaries.item.category_summaries.category_summaries_request_builder')
mac_o_s_software_update_category_summary_item_request_builder = lazy_import('msgraph.generated.device_management.mac_o_s_software_update_account_summaries.item.category_summaries.item.mac_o_s_software_update_category_summary_item_request_builder')
...
class MacOSSoftwareUpdateAccountSummaryItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[MacOSSoftwareUpdateAccountSummaryItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MacOSSoftwareUpdateAccountSummaryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[mac_o_s_software_update_account_summary.MacOSSoftwareUpdateAccountSummary] = None, request_configuration: Optional[MacOSSoftwareUpdateAccountSummaryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def delete(self,request_configuration: Optional[MacOSSoftwareUpdateAccountSummaryItemRequestBuilderDeleteRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Delete navigation property macOSSoftwareUpdateAccountSummaries for deviceManagement
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def get(self,request_configuration: Optional[MacOSSoftwareUpdateAccountSummaryItemRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mac_o_s_software_update_account_summary.MacOSSoftwareUpdateAccountSummary]:
        """
        The MacOS software update account summaries for this account.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
