...
class MacOSSoftwareUpdateAccountSummaryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, mac_o_s_software_update_account_summary_id: Optional[str] = None) -> None:
        """
        Instantiates a new MacOSSoftwareUpdateAccountSummaryItemRequestBuilder and sets the default values.
        Args:
            macOSSoftwareUpdateAccountSummaryId: key: id of macOSSoftwareUpdateAccountSummary
        ...
        url_tpl_params["macOSSoftwareUpdateAccountSummary%2Did"] = macOSSoftwareUpdateAccountSummaryId
