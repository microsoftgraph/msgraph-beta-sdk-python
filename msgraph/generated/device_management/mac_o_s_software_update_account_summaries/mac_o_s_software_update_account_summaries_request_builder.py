...
count_request_builder = lazy_import('msgraph.generated.device_management.mac_o_s_software_update_account_summaries.count.count_request_builder')
mac_o_s_software_update_account_summary = lazy_import('msgraph.generated.models.mac_o_s_software_update_account_summary')
mac_o_s_software_update_account_summary_collection_response = lazy_import('msgraph.generated.models.mac_o_s_software_update_account_summary_collection_response')
...
class MacOSSoftwareUpdateAccountSummariesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MacOSSoftwareUpdateAccountSummariesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mac_o_s_software_update_account_summary.MacOSSoftwareUpdateAccountSummary] = None, request_configuration: Optional[MacOSSoftwareUpdateAccountSummariesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
