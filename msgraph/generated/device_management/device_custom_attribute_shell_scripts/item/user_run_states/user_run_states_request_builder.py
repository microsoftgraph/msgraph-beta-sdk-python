...
count_request_builder = lazy_import('msgraph.generated.device_management.device_custom_attribute_shell_scripts.item.user_run_states.count.count_request_builder')
device_management_script_user_state = lazy_import('msgraph.generated.models.device_management_script_user_state')
device_management_script_user_state_collection_response = lazy_import('msgraph.generated.models.device_management_script_user_state_collection_response')
...
class UserRunStatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserRunStatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_script_user_state.DeviceManagementScriptUserState] = None, request_configuration: Optional[UserRunStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
