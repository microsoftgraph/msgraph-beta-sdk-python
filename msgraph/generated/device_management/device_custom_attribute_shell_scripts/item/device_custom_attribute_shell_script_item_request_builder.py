...
class DeviceCustomAttributeShellScriptItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceCustomAttributeShellScriptItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceCustomAttributeShellScriptItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_custom_attribute_shell_script.DeviceCustomAttributeShellScript] = None, request_configuration: Optional[DeviceCustomAttributeShellScriptItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
