...
assign_request_builder = lazy_import('msgraph.generated.device_management.device_custom_attribute_shell_scripts.item.microsoft_graph_assign.assign_request_builder')
...
class DeviceCustomAttributeShellScriptItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_custom_attribute_shell_script_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceCustomAttributeShellScriptItemRequestBuilder and sets the default values.
        Args:
            deviceCustomAttributeShellScriptId: key: id of deviceCustomAttributeShellScript
        ...
        url_tpl_params["deviceCustomAttributeShellScript%2Did"] = deviceCustomAttributeShellScriptId
