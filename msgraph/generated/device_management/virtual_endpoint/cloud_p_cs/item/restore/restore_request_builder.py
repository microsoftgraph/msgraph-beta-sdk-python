...
restore_post_request_body = lazy_import('msgraph.generated.device_management.virtual_endpoint.cloud_p_cs.item.restore.restore_post_request_body')
...
class RestoreRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/restore"
