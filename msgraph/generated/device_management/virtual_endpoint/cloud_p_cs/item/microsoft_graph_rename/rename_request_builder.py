...
rename_post_request_body = lazy_import('msgraph.generated.device_management.virtual_endpoint.cloud_p_cs.item.microsoft_graph_rename.rename_post_request_body')
