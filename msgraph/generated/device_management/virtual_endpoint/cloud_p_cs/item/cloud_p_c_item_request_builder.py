...
start_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.cloud_p_cs.item.start.start_request_builder')
stop_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.cloud_p_cs.item.stop.stop_request_builder')
