...
get_supported_cloud_pc_remote_actions_response = lazy_import('msgraph.generated.device_management.virtual_endpoint.cloud_p_cs.item.get_supported_cloud_pc_remote_actions.get_supported_cloud_pc_remote_actions_response')
...
class GetSupportedCloudPcRemoteActionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/microsoft.graph.getSupportedCloudPcRemoteActions(){?%24top,%24skip,%24search,%24filter,%24count}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[GetSupportedCloudPcRemoteActionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
