...
get_audit_activity_types_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.audit_events.microsoft_graph_get_audit_activity_types.get_audit_activity_types_request_builder')
...
class AuditEventsRequestBuilder():
    ...
    @property
    def microsoft_graph_get_audit_activity_types(self) -> get_audit_activity_types_request_builder.GetAuditActivityTypesRequestBuilder:
        """
