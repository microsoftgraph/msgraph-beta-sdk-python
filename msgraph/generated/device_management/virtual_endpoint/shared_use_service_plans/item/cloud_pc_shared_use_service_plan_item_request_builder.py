...
class CloudPcSharedUseServicePlanItemRequestBuilder():
    """
    Provides operations to manage the sharedUseServicePlans property of the microsoft.graph.virtualEndpoint entity.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_shared_use_service_plan_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcSharedUseServicePlanItemRequestBuilder and sets the default values.
        Args:
            cloudPcSharedUseServicePlanId: key: id of cloudPcSharedUseServicePlan
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/sharedUseServicePlans/{cloudPcSharedUseServicePlan%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["cloudPcSharedUseServicePlan%2Did"] = cloudPcSharedUseServicePlanId
