...
class CloudPcExternalPartnerSettingItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_external_partner_setting_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcExternalPartnerSettingItemRequestBuilder and sets the default values.
        Args:
            cloudPcExternalPartnerSettingId: key: id of cloudPcExternalPartnerSetting
        ...
        url_tpl_params["cloudPcExternalPartnerSetting%2Did"] = cloudPcExternalPartnerSettingId
