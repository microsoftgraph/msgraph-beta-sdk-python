...
from ....models import cloud_pc_cross_cloud_government_organization_mapping
...
class CrossCloudGovernmentOrganizationMappingRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CrossCloudGovernmentOrganizationMappingRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CrossCloudGovernmentOrganizationMappingRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[cloud_pc_cross_cloud_government_organization_mapping.CloudPcCrossCloudGovernmentOrganizationMapping] = None, request_configuration: Optional[CrossCloudGovernmentOrganizationMappingRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
