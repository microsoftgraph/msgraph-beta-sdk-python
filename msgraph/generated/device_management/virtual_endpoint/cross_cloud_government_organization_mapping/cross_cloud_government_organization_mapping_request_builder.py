...
class CrossCloudGovernmentOrganizationMappingRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[CrossCloudGovernmentOrganizationMappingRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_cross_cloud_government_organization_mapping.CloudPcCrossCloudGovernmentOrganizationMapping] = None, request_configuration: Optional[CrossCloudGovernmentOrganizationMappingRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property crossCloudGovernmentOrganizationMapping in deviceManagement
        Args:
            body: The request body
