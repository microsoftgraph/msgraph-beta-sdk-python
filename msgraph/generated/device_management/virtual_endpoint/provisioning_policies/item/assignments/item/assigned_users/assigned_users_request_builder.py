...
count_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.provisioning_policies.item.assignments.item.assigned_users.count.count_request_builder')
user_collection_response = lazy_import('msgraph.generated.models.user_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class AssignedUsersRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}/assignedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[AssignedUsersRequestBuilderGetRequestConfiguration] = None) -> Optional[user_collection_response.UserCollectionResponse]:
        """
    ...
    @dataclass
    class AssignedUsersRequestBuilderGetRequestConfiguration():
        """
