...
class CloudPcProvisioningPolicyAssignmentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_provisioning_policy_assignment_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcProvisioningPolicyAssignmentItemRequestBuilder and sets the default values.
        Args:
            cloudPcProvisioningPolicyAssignmentId: key: id of cloudPcProvisioningPolicyAssignment
        ...
        url_tpl_params["cloudPcProvisioningPolicyAssignment%2Did"] = cloudPcProvisioningPolicyAssignmentId
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_provisioning_policy_assignment.CloudPcProvisioningPolicyAssignment] = None, request_configuration: Optional[CloudPcProvisioningPolicyAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceManagement
        Args:
            body: The request body
