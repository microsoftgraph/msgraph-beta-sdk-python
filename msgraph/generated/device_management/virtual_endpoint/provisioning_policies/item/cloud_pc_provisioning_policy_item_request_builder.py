...
microsoft_graph_assign_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.provisioning_policies.item.microsoft_graph_assign.microsoft_graph_assign_request_builder')
