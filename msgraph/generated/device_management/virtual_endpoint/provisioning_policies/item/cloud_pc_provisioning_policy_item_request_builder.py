...
assign_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.provisioning_policies.item.microsoft_graph_assign.assign_request_builder')
...
class CloudPcProvisioningPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_provisioning_policy_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcProvisioningPolicyItemRequestBuilder and sets the default values.
        Args:
            cloudPcProvisioningPolicyId: key: id of cloudPcProvisioningPolicy
        ...
        url_tpl_params["cloudPcProvisioningPolicy%2Did"] = cloudPcProvisioningPolicyId
