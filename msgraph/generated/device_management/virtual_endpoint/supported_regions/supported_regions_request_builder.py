...
if TYPE_CHECKING:
    ...
    from ....models.cloud_pc_supported_region_collection_response import CloudPcSupportedRegionCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.cloud_pc_supported_region_item_request_builder import CloudPcSupportedRegionItemRequestBuilder

class SupportedRegionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/supportedRegions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_cloud_pc_supported_region_id(self,cloud_pc_supported_region_id: str) -> CloudPcSupportedRegionItemRequestBuilder:
        """
        Provides operations to manage the supportedRegions property of the microsoft.graph.virtualEndpoint entity.
        param cloud_pc_supported_region_id: The unique identifier of cloudPcSupportedRegion
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SupportedRegionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SupportedRegionsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return SupportedRegionsRequestBuilder(self.request_adapter, raw_url)
