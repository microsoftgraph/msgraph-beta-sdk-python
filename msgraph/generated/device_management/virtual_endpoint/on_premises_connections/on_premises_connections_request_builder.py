...
count_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.on_premises_connections.count.count_request_builder')
cloud_pc_on_premises_connection = lazy_import('msgraph.generated.models.cloud_pc_on_premises_connection')
cloud_pc_on_premises_connection_collection_response = lazy_import('msgraph.generated.models.cloud_pc_on_premises_connection_collection_response')
...
class OnPremisesConnectionsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[OnPremisesConnectionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[cloud_pc_on_premises_connection.CloudPcOnPremisesConnection] = None, request_configuration: Optional[OnPremisesConnectionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
