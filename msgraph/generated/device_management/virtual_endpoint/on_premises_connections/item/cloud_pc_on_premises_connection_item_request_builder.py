...
run_health_checks_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.on_premises_connections.item.microsoft_graph_run_health_checks.run_health_checks_request_builder')
update_ad_domain_password_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.on_premises_connections.item.microsoft_graph_update_ad_domain_password.update_ad_domain_password_request_builder')
...
class CloudPcOnPremisesConnectionItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_run_health_checks(self) -> run_health_checks_request_builder.RunHealthChecksRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_update_ad_domain_password(self) -> update_ad_domain_password_request_builder.UpdateAdDomainPasswordRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_on_premises_connection_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcOnPremisesConnectionItemRequestBuilder and sets the default values.
        Args:
            cloudPcOnPremisesConnectionId: key: id of cloudPcOnPremisesConnection
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["cloudPcOnPremisesConnection%2Did"] = cloudPcOnPremisesConnectionId
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_on_premises_connection.CloudPcOnPremisesConnection] = None, request_configuration: Optional[CloudPcOnPremisesConnectionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property onPremisesConnections in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class CloudPcOnPremisesConnectionItemRequestBuilderDeleteRequestConfiguration():
        """
