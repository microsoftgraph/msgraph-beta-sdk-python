...
class CloudPcGalleryImageItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[CloudPcGalleryImageItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_gallery_image.CloudPcGalleryImage] = None, request_configuration: Optional[CloudPcGalleryImageItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property galleryImages in deviceManagement
        Args:
            body: The request body
