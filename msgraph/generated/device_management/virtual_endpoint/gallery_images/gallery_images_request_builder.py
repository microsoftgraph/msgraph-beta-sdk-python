...
class GalleryImagesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[cloud_pc_gallery_image.CloudPcGalleryImage] = None, request_configuration: Optional[GalleryImagesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to galleryImages for deviceManagement
        Args:
            body: The request body
