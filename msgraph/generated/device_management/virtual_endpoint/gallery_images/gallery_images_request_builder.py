...
count_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.gallery_images.count.count_request_builder')
cloud_pc_gallery_image = lazy_import('msgraph.generated.models.cloud_pc_gallery_image')
cloud_pc_gallery_image_collection_response = lazy_import('msgraph.generated.models.cloud_pc_gallery_image_collection_response')
...
class GalleryImagesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GalleryImagesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[cloud_pc_gallery_image.CloudPcGalleryImage] = None, request_configuration: Optional[GalleryImagesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
