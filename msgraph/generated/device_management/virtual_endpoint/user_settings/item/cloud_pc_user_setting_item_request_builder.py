...
assign_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.user_settings.item.microsoft_graph_assign.assign_request_builder')
...
class CloudPcUserSettingItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_user_setting_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcUserSettingItemRequestBuilder and sets the default values.
        Args:
            cloudPcUserSettingId: key: id of cloudPcUserSetting
        ...
        url_tpl_params["cloudPcUserSetting%2Did"] = cloudPcUserSettingId
