...
assign_post_request_body = lazy_import('msgraph.generated.device_management.virtual_endpoint.user_settings.item.microsoft_graph_assign.assign_post_request_body')
...
class AssignRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/userSettings/{cloudPcUserSetting%2Did}/microsoft.graph.assign"
