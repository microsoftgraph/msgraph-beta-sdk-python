...
class CloudPcUserSettingAssignmentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_user_setting_assignment_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcUserSettingAssignmentItemRequestBuilder and sets the default values.
        Args:
            cloudPcUserSettingAssignmentId: key: id of cloudPcUserSettingAssignment
        ...
        url_tpl_params["cloudPcUserSettingAssignment%2Did"] = cloudPcUserSettingAssignmentId
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_user_setting_assignment.CloudPcUserSettingAssignment] = None, request_configuration: Optional[CloudPcUserSettingAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceManagement
        Args:
            body: The request body
