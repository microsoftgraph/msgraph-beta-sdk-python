...
get_daily_aggregated_remote_connection_reports_post_request_body = lazy_import('msgraph.generated.device_management.virtual_endpoint.reports.get_daily_aggregated_remote_connection_reports.get_daily_aggregated_remote_connection_reports_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class GetDailyAggregatedRemoteConnectionReportsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/reports/microsoft.graph.getDailyAggregatedRemoteConnectionReports"
    ...
    async def post(self,body: Optional[get_daily_aggregated_remote_connection_reports_post_request_body.GetDailyAggregatedRemoteConnectionReportsPostRequestBody] = None, request_configuration: Optional[GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Get the daily aggregated remote connection reports, such as round trip time, available bandwidth, and so on, in a given period.
        Args:
            body: The request body
    ...
    @dataclass
    class GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration():
        """
