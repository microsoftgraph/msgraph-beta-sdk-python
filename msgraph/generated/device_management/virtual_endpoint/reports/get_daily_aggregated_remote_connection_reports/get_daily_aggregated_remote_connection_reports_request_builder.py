...
if TYPE_CHECKING:
    ...
    from .get_daily_aggregated_remote_connection_reports_post_request_body import GetDailyAggregatedRemoteConnectionReportsPostRequestBody

class GetDailyAggregatedRemoteConnectionReportsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetDailyAggregatedRemoteConnectionReportsRequestBuilder:
        """
    ...
    @dataclass
    class GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
