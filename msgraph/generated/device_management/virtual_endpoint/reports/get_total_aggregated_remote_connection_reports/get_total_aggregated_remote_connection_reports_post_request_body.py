...
@dataclass
class GetTotalAggregatedRemoteConnectionReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetTotalAggregatedRemoteConnectionReportsPostRequestBody:
        """
        ...
        return GetTotalAggregatedRemoteConnectionReportsPostRequestBody()
