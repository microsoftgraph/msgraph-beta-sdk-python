...
count_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.reports.export_jobs.count.count_request_builder')
cloud_pc_export_job = lazy_import('msgraph.generated.models.cloud_pc_export_job')
cloud_pc_export_job_collection_response = lazy_import('msgraph.generated.models.cloud_pc_export_job_collection_response')
...
class ExportJobsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[cloud_pc_export_job.CloudPcExportJob] = None, request_configuration: Optional[ExportJobsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
