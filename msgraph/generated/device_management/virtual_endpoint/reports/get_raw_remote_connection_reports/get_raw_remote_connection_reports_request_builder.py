...
class GetRawRemoteConnectionReportsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetRawRemoteConnectionReportsRequestBuilder:
        """
        ...
        return GetRawRemoteConnectionReportsRequestBuilder(raw_url, self.request_adapter)
