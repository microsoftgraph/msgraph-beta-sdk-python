...
class ReportsRequestBuilder():
    ...
    def export_jobs_by_id(self,id: str) -> Optional[cloud_pc_export_job_item_request_builder.CloudPcExportJobItemRequestBuilder]:
        """
        Provides operations to manage the exportJobs property of the microsoft.graph.cloudPcReports entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[cloud_pc_export_job_item_request_builder.CloudPcExportJobItemRequestBuilder]
        """
        if id is None:
