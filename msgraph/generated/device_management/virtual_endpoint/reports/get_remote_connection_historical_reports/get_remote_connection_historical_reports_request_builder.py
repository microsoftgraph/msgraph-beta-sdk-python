...
if TYPE_CHECKING:
    ...
    from .get_remote_connection_historical_reports_post_request_body import GetRemoteConnectionHistoricalReportsPostRequestBody

class GetRemoteConnectionHistoricalReportsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetRemoteConnectionHistoricalReportsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetRemoteConnectionHistoricalReportsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetRemoteConnectionHistoricalReportsRequestBuilder(raw_url, self.request_adapter)
