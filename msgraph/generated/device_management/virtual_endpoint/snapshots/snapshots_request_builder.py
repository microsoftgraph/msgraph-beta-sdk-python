...
count_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.snapshots.count.count_request_builder')
microsoft_graph_get_storage_accounts_with_subscription_id_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.snapshots.microsoft_graph_get_storage_accounts_with_subscription_id.microsoft_graph_get_storage_accounts_with_subscription_id_request_builder')
microsoft_graph_get_subscriptions_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.snapshots.microsoft_graph_get_subscriptions.microsoft_graph_get_subscriptions_request_builder')
cloud_pc_snapshot = lazy_import('msgraph.generated.models.cloud_pc_snapshot')
cloud_pc_snapshot_collection_response = lazy_import('msgraph.generated.models.cloud_pc_snapshot_collection_response')
...
class SnapshotsRequestBuilder():
    ...
    @property
    def microsoft_graph_get_subscriptions(self) -> microsoft_graph_get_subscriptions_request_builder.MicrosoftGraphGetSubscriptionsRequestBuilder:
        """
        Provides operations to call the getSubscriptions method.
        """
        return microsoft_graph_get_subscriptions_request_builder.MicrosoftGraphGetSubscriptionsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def microsoft_graph_get_storage_accounts_with_subscription_id(self,subscription_id: Optional[str] = None) -> microsoft_graph_get_storage_accounts_with_subscription_id_request_builder.MicrosoftGraphGetStorageAccountsWithSubscriptionIdRequestBuilder:
        """
        Provides operations to call the getStorageAccounts method.
        Args:
            subscriptionId: Usage: subscriptionId='{subscriptionId}'
        Returns: microsoft_graph_get_storage_accounts_with_subscription_id_request_builder.MicrosoftGraphGetStorageAccountsWithSubscriptionIdRequestBuilder
        """
        if subscription_id is None:
            raise Exception("subscription_id cannot be undefined")
        return microsoft_graph_get_storage_accounts_with_subscription_id_request_builder.MicrosoftGraphGetStorageAccountsWithSubscriptionIdRequestBuilder(self.request_adapter, self.path_parameters, subscriptionId)
    ...
    @dataclass
    class SnapshotsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
