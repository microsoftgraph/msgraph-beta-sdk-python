...
if TYPE_CHECKING:
    ...
    from .get_storage_accounts_with_subscription_id_response import GetStorageAccountsWithSubscriptionIdResponse
...
class GetStorageAccountsWithSubscriptionIdRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration] = None) -> Optional[GetStorageAccountsWithSubscriptionIdResponse]:
        """
        Invoke function getStorageAccounts
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[GetStorageAccountsWithSubscriptionIdResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetStorageAccountsWithSubscriptionIdResponse, error_mapping)
