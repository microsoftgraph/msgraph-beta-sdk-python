...
reupload_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.device_images.item.microsoft_graph_reupload.reupload_request_builder')
...
class CloudPcDeviceImageItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_reupload(self) -> reupload_request_builder.ReuploadRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, cloud_pc_device_image_id: Optional[str] = None) -> None:
        """
        Instantiates a new CloudPcDeviceImageItemRequestBuilder and sets the default values.
        Args:
            cloudPcDeviceImageId: key: id of cloudPcDeviceImage
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["cloudPcDeviceImage%2Did"] = cloudPcDeviceImageId
    ...
    def to_patch_request_information(self,body: Optional[cloud_pc_device_image.CloudPcDeviceImage] = None, request_configuration: Optional[CloudPcDeviceImageItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceImages in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class CloudPcDeviceImageItemRequestBuilderDeleteRequestConfiguration():
        """
