...
microsoft_graph_get_source_images_request_builder = lazy_import('msgraph.generated.device_management.virtual_endpoint.device_images.microsoft_graph_get_source_images.microsoft_graph_get_source_images_request_builder')
...
class DeviceImagesRequestBuilder():
    ...
    @property
    def microsoft_graph_get_source_images(self) -> microsoft_graph_get_source_images_request_builder.MicrosoftGraphGetSourceImagesRequestBuilder:
        """
        Provides operations to call the getSourceImages method.
        """
        return microsoft_graph_get_source_images_request_builder.MicrosoftGraphGetSourceImagesRequestBuilder(self.request_adapter, self.path_parameters)
