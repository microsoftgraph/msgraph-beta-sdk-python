...
get_role_scope_tags_by_resource_with_resource_response = lazy_import('msgraph.generated.device_management.get_role_scope_tags_by_resource_with_resource.get_role_scope_tags_by_resource_with_resource_response')
...
class GetRoleScopeTagsByResourceWithResourceRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
