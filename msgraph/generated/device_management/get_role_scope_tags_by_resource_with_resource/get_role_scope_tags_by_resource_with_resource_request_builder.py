...
if TYPE_CHECKING:
    ...
    from .get_role_scope_tags_by_resource_with_resource_response import GetRoleScopeTagsByResourceWithResourceResponse
...
class GetRoleScopeTagsByResourceWithResourceRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration] = None) -> Optional[GetRoleScopeTagsByResourceWithResourceResponse]:
        ...
        Returns: Optional[GetRoleScopeTagsByResourceWithResourceResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetRoleScopeTagsByResourceWithResourceResponse, error_mapping)
