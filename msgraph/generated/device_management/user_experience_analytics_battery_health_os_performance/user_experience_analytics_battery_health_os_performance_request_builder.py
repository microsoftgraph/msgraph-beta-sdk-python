...
if TYPE_CHECKING:
    from ...models import user_experience_analytics_battery_health_os_performance, user_experience_analytics_battery_health_os_performance_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import user_experience_analytics_battery_health_os_performance_item_request_builder

class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsBatteryHealthOsPerformance{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_user_experience_analytics_battery_health_os_performance_id(self,user_experience_analytics_battery_health_os_performance_id: str) -> user_experience_analytics_battery_health_os_performance_item_request_builder.UserExperienceAnalyticsBatteryHealthOsPerformanceItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsBatteryHealthOsPerformance property of the microsoft.graph.deviceManagement entity.
        Args:
            user_experience_analytics_battery_health_os_performance_id: Unique identifier of the item
        ...
        if user_experience_analytics_battery_health_os_performance_id is None:
            raise Exception("user_experience_analytics_battery_health_os_performance_id cannot be undefined")
        from .item import user_experience_analytics_battery_health_os_performance_item_request_builder
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_battery_health_os_performance_collection_response.UserExperienceAnalyticsBatteryHealthOsPerformanceCollectionResponse]:
        ...
        from ...models import user_experience_analytics_battery_health_os_performance_collection_response
    ...
    @dataclass
    class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilderGetQueryParameters():
        """
        User Experience Analytics Battery Health Os Performance
        """
    ...
    @dataclass
    class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsBatteryHealthOsPerformanceRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
