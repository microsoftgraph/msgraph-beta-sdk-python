...
create_token_request_builder = lazy_import('msgraph.generated.device_management.android_device_owner_enrollment_profiles.item.microsoft_graph_create_token.create_token_request_builder')
revoke_token_request_builder = lazy_import('msgraph.generated.device_management.android_device_owner_enrollment_profiles.item.microsoft_graph_revoke_token.revoke_token_request_builder')
...
class AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_create_token(self) -> create_token_request_builder.CreateTokenRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_revoke_token(self) -> revoke_token_request_builder.RevokeTokenRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, android_device_owner_enrollment_profile_id: Optional[str] = None) -> None:
        """
        Instantiates a new AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder and sets the default values.
        Args:
            androidDeviceOwnerEnrollmentProfileId: key: id of androidDeviceOwnerEnrollmentProfile
        ...
        url_tpl_params["androidDeviceOwnerEnrollmentProfile%2Did"] = androidDeviceOwnerEnrollmentProfileId
    ...
    def to_get_request_information(self,request_configuration: Optional[AndroidDeviceOwnerEnrollmentProfileItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Android device owner enrollment profile entities.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
