...
class AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder:
        """
        ...
        return AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder(raw_url, self.request_adapter)
