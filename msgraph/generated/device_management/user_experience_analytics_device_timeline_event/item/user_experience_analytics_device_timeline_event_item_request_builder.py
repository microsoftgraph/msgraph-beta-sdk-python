...
class UserExperienceAnalyticsDeviceTimelineEventItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceTimelineEvent/{userExperienceAnalyticsDeviceTimelineEvent%2Did}{?%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UserExperienceAnalyticsDeviceTimelineEventItemRequestBuilder:
        """
        ...
        return UserExperienceAnalyticsDeviceTimelineEventItemRequestBuilder(raw_url, self.request_adapter)
