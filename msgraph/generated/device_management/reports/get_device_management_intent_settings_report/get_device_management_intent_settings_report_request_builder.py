...
from . import get_device_management_intent_settings_report_post_request_body
from ....models.o_data_errors import o_data_error

class GetDeviceManagementIntentSettingsReportRequestBuilder():
    """
    ...
    async def post(self,body: Optional[get_device_management_intent_settings_report_post_request_body.GetDeviceManagementIntentSettingsReportPostRequestBody] = None, request_configuration: Optional[GetDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke action getDeviceManagementIntentSettingsReport
        Args:
            body: 
    ...
    @dataclass
    class GetDeviceManagementIntentSettingsReportRequestBuilderPostRequestConfiguration():
        """
