...
class GetConfigurationSettingDetailsReportPostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getConfigurationSettingDetailsReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetConfigurationSettingDetailsReportPostRequestBody:
        """
        ...
        return GetConfigurationSettingDetailsReportPostRequestBody()
