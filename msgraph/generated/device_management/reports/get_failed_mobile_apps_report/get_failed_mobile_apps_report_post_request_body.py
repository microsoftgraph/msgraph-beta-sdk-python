...
@dataclass
class GetFailedMobileAppsReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetFailedMobileAppsReportPostRequestBody:
        """
        ...
        return GetFailedMobileAppsReportPostRequestBody()
