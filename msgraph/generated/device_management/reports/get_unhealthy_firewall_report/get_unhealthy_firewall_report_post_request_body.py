...
class GetUnhealthyFirewallReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getUnhealthyFirewallReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetUnhealthyFirewallReportPostRequestBody:
        """
        ...
        return GetUnhealthyFirewallReportPostRequestBody()
