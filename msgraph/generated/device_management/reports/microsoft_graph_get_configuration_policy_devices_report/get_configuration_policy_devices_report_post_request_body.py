...
class GetConfigurationPolicyDevicesReportPostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getConfigurationPolicyDevicesReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetConfigurationPolicyDevicesReportPostRequestBody:
        """
        ...
        return GetConfigurationPolicyDevicesReportPostRequestBody()
