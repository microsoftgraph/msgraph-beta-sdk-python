...
class GetConfigurationPolicyDeviceSummaryReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getConfigurationPolicyDeviceSummaryReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetConfigurationPolicyDeviceSummaryReportPostRequestBody:
        """
        ...
        return GetConfigurationPolicyDeviceSummaryReportPostRequestBody()
