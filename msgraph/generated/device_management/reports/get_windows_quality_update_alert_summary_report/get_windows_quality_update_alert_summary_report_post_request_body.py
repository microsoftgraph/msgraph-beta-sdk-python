...
class GetWindowsQualityUpdateAlertSummaryReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getWindowsQualityUpdateAlertSummaryReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetWindowsQualityUpdateAlertSummaryReportPostRequestBody:
        """
        ...
        return GetWindowsQualityUpdateAlertSummaryReportPostRequestBody()
