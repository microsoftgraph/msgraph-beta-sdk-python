...
get_windows_quality_update_alert_summary_report_post_request_body = lazy_import('msgraph.generated.device_management.reports.get_windows_quality_update_alert_summary_report.get_windows_quality_update_alert_summary_report_post_request_body')
...
class GetWindowsQualityUpdateAlertSummaryReportRequestBuilder():
    ...
    async def post(self,body: Optional[get_windows_quality_update_alert_summary_report_post_request_body.GetWindowsQualityUpdateAlertSummaryReportPostRequestBody] = None, request_configuration: Optional[GetWindowsQualityUpdateAlertSummaryReportRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke action getWindowsQualityUpdateAlertSummaryReport
        Args:
            body: The request body
