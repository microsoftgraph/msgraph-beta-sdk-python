...
@dataclass
class GetDeviceInstallStatusReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetDeviceInstallStatusReportPostRequestBody:
        """
        ...
        return GetDeviceInstallStatusReportPostRequestBody()
