...
class GetConfigurationPoliciesReportForDevicePostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getConfigurationPoliciesReportForDevicePostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetConfigurationPoliciesReportForDevicePostRequestBody:
        """
        ...
        return GetConfigurationPoliciesReportForDevicePostRequestBody()
