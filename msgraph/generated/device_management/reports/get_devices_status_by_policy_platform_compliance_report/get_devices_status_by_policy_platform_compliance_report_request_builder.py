...
if TYPE_CHECKING:
    ...
    from .get_devices_status_by_policy_platform_compliance_report_post_request_body import GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody

class GetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetDevicesStatusByPolicyPlatformComplianceReportRequestBuilder(raw_url, self.request_adapter)
