...
class GetUnhealthyFirewallSummaryReportPostRequestBody(AdditionalDataHolder, Parsable):
    @property
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getUnhealthyFirewallSummaryReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetUnhealthyFirewallSummaryReportPostRequestBody:
        """
        ...
        return GetUnhealthyFirewallSummaryReportPostRequestBody()
