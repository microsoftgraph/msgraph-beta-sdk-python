...
@dataclass
class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody:
        """
        ...
        return GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody()
