...
class GetQuietTimePolicyUsersReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        ...
        self._skip_token: Optional[str] = None
        # The top property
        self._top: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetQuietTimePolicyUsersReportPostRequestBody:
        """
        ...
        return GetQuietTimePolicyUsersReportPostRequestBody()
    ...
    @skip_token.setter
    def skip_token(self,value: Optional[str] = None) -> None:
        """
