...
@dataclass
class GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody:
        """
        ...
        return GetDeviceConfigurationPolicySettingsSummaryReportPostRequestBody()
