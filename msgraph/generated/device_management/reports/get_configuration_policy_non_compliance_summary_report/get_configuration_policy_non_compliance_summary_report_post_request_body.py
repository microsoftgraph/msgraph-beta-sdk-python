...
class GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getConfigurationPolicyNonComplianceSummaryReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody:
        """
        ...
        return GetConfigurationPolicyNonComplianceSummaryReportPostRequestBody()
