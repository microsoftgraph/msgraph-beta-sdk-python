...
from . import get_device_management_intent_per_setting_contributing_profiles_post_request_body
from ....models.o_data_errors import o_data_error

class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/reports/microsoft.graph.getDeviceManagementIntentPerSettingContributingProfiles"
