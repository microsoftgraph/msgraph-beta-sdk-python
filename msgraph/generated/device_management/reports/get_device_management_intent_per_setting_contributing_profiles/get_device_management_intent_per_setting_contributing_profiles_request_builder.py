...
if TYPE_CHECKING:
    ...
    from .get_device_management_intent_per_setting_contributing_profiles_post_request_body import GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody

class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder(self.request_adapter, raw_url)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
