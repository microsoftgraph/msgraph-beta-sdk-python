...
class GetQuietTimePolicyUserSummaryReportPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    def __init__(self,) -> None:
        """
        Instantiates a new getQuietTimePolicyUserSummaryReportPostRequestBody and sets the default values.
        """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetQuietTimePolicyUserSummaryReportPostRequestBody:
        """
        ...
        return GetQuietTimePolicyUserSummaryReportPostRequestBody()
