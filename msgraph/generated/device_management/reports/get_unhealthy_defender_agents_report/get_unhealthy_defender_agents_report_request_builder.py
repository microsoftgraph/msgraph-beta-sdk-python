...
if TYPE_CHECKING:
    ...
    from .get_unhealthy_defender_agents_report_post_request_body import GetUnhealthyDefenderAgentsReportPostRequestBody

class GetUnhealthyDefenderAgentsReportRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetUnhealthyDefenderAgentsReportRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetUnhealthyDefenderAgentsReportRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetUnhealthyDefenderAgentsReportRequestBuilder(raw_url, self.request_adapter)
