...
if TYPE_CHECKING:
    ...
    from .get_autopilot_deployment_status.get_autopilot_deployment_status_request_builder import GetAutopilotDeploymentStatusRequestBuilder
...
class ReportsRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def get_autopilot_deployment_status(self) -> GetAutopilotDeploymentStatusRequestBuilder:
        """
        Provides operations to call the getAutopilotDeploymentStatus method.
        """
        from .get_autopilot_deployment_status.get_autopilot_deployment_status_request_builder import GetAutopilotDeploymentStatusRequestBuilder

        return GetAutopilotDeploymentStatusRequestBuilder(self.request_adapter, self.path_parameters)
