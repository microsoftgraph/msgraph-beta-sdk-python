...
count_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_work_from_anywhere_metrics.item.metric_devices.count.count_request_builder')
...
user_experience_analytics_work_from_anywhere_device_collection_response = lazy_import('msgraph.generated.models.user_experience_analytics_work_from_anywhere_device_collection_response')
...
class MetricDevicesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MetricDevicesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_experience_analytics_work_from_anywhere_device.UserExperienceAnalyticsWorkFromAnywhereDevice] = None, request_configuration: Optional[MetricDevicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
