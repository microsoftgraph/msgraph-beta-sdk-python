...
if TYPE_CHECKING:
    from .....models import user_experience_analytics_work_from_anywhere_device, user_experience_analytics_work_from_anywhere_device_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import user_experience_analytics_work_from_anywhere_device_item_request_builder

class MetricDevicesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics/{userExperienceAnalyticsWorkFromAnywhereMetric%2Did}/metricDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_user_experience_analytics_work_from_anywhere_device_id(self,user_experience_analytics_work_from_anywhere_device_id: str) -> user_experience_analytics_work_from_anywhere_device_item_request_builder.UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder:
        """
        Provides operations to manage the metricDevices property of the microsoft.graph.userExperienceAnalyticsWorkFromAnywhereMetric entity.
        Args:
        ...
        """
        if user_experience_analytics_work_from_anywhere_device_id is None:
            raise Exception("user_experience_analytics_work_from_anywhere_device_id cannot be undefined")
        from .item import user_experience_analytics_work_from_anywhere_device_item_request_builder
    ...
    async def get(self,request_configuration: Optional[MetricDevicesRequestBuilderGetRequestConfiguration] = None) -> Optional[user_experience_analytics_work_from_anywhere_device_collection_response.UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse]:
        ...
        from .....models import user_experience_analytics_work_from_anywhere_device_collection_response
    ...
    async def post(self,body: Optional[user_experience_analytics_work_from_anywhere_device.UserExperienceAnalyticsWorkFromAnywhereDevice] = None, request_configuration: Optional[MetricDevicesRequestBuilderPostRequestConfiguration] = None) -> Optional[user_experience_analytics_work_from_anywhere_device.UserExperienceAnalyticsWorkFromAnywhereDevice]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from .....models import user_experience_analytics_work_from_anywhere_device
    ...
    def to_post_request_information(self,body: Optional[user_experience_analytics_work_from_anywhere_device.UserExperienceAnalyticsWorkFromAnywhereDevice] = None, request_configuration: Optional[MetricDevicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to metricDevices for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class MetricDevicesRequestBuilderGetQueryParameters():
        """
        The work from anywhere metric devices.
        """
    ...
    @dataclass
    class MetricDevicesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
