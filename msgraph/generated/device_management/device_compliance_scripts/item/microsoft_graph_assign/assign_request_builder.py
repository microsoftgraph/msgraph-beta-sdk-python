...
assign_post_request_body = lazy_import('msgraph.generated.device_management.device_compliance_scripts.item.microsoft_graph_assign.assign_post_request_body')
...
class AssignRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/deviceComplianceScripts/{deviceComplianceScript%2Did}/microsoft.graph.assign"
