...
class DeviceComplianceScriptItemRequestBuilder():
    ...
    def device_run_states_by_id(self,id: str) -> Optional[device_compliance_script_device_state_item_request_builder.DeviceComplianceScriptDeviceStateItemRequestBuilder]:
        """
        Provides operations to manage the deviceRunStates property of the microsoft.graph.deviceComplianceScript entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[device_compliance_script_device_state_item_request_builder.DeviceComplianceScriptDeviceStateItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
