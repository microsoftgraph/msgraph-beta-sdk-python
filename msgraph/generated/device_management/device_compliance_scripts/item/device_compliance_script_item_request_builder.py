...
assign_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_scripts.item.microsoft_graph_assign.assign_request_builder')
...
class DeviceComplianceScriptItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_compliance_script_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceComplianceScriptItemRequestBuilder and sets the default values.
        Args:
            deviceComplianceScriptId: key: id of deviceComplianceScript
        ...
        url_tpl_params["deviceComplianceScript%2Did"] = deviceComplianceScriptId
