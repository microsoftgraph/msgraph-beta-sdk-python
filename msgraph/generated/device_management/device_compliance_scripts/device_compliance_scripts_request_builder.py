...
count_request_builder = lazy_import('msgraph.generated.device_management.device_compliance_scripts.count.count_request_builder')
device_compliance_script = lazy_import('msgraph.generated.models.device_compliance_script')
device_compliance_script_collection_response = lazy_import('msgraph.generated.models.device_compliance_script_collection_response')
...
class DeviceComplianceScriptsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceComplianceScriptsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_compliance_script.DeviceComplianceScript] = None, request_configuration: Optional[DeviceComplianceScriptsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
