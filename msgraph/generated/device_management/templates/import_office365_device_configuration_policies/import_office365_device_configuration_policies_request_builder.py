...
import_office365_device_configuration_policies_response = lazy_import('msgraph.generated.device_management.templates.import_office365_device_configuration_policies.import_office365_device_configuration_policies_response')
...
class ImportOffice365DeviceConfigurationPoliciesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/templates/importOffice365DeviceConfigurationPolicies"
