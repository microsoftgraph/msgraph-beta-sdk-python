...
class SettingsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[device_management_setting_instance.DeviceManagementSettingInstance] = None, request_configuration: Optional[SettingsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to settings for deviceManagement
        Args:
            body: The request body
