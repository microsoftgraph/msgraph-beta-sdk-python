...
class DeviceManagementTemplateSettingCategoryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_template_setting_category_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementTemplateSettingCategoryItemRequestBuilder and sets the default values.
        Args:
            deviceManagementTemplateSettingCategoryId: key: id of deviceManagementTemplateSettingCategory
        ...
        url_tpl_params["deviceManagementTemplateSettingCategory%2Did"] = deviceManagementTemplateSettingCategoryId
