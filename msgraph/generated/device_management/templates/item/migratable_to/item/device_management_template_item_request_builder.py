...
microsoft_graph_compare_with_template_id_request_builder = lazy_import('msgraph.generated.device_management.templates.item.migratable_to.item.microsoft_graph_compare_with_template_id.microsoft_graph_compare_with_template_id_request_builder')
microsoft_graph_create_instance_request_builder = lazy_import('msgraph.generated.device_management.templates.item.migratable_to.item.microsoft_graph_create_instance.microsoft_graph_create_instance_request_builder')
