...
if TYPE_CHECKING:
    from ......models import base_collection_pagination_count_response, device_management_intent
...
class ImportOffice365DeviceConfigurationPoliciesResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[device_management_intent.DeviceManagementIntent]] = None
