...
import_office365_device_configuration_policies_response = lazy_import('msgraph.generated.device_management.templates.item.migratable_to.import_office365_device_configuration_policies.import_office365_device_configuration_policies_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class ImportOffice365DeviceConfigurationPoliciesRequestBuilder():
    """
    ...
    def create_post_request_information(self,request_configuration: Optional[ImportOffice365DeviceConfigurationPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ImportOffice365DeviceConfigurationPoliciesRequestBuilderPostRequestConfiguration():
        """
