...
class ImportOffice365DeviceConfigurationPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ImportOffice365DeviceConfigurationPoliciesRequestBuilder:
        ...
        Returns: ImportOffice365DeviceConfigurationPoliciesRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class ImportOffice365DeviceConfigurationPoliciesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
