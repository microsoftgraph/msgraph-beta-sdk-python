...
class DeviceManagementScriptUserStateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_script_user_state_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementScriptUserStateItemRequestBuilder and sets the default values.
        Args:
            deviceManagementScriptUserStateId: key: id of deviceManagementScriptUserState
        ...
        url_tpl_params["deviceManagementScriptUserState%2Did"] = deviceManagementScriptUserStateId
    ...
    async def get(self,request_configuration: Optional[DeviceManagementScriptUserStateItemRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_script_user_state.DeviceManagementScriptUserState]:
        """
    ...
    async def patch(self,body: Optional[device_management_script_user_state.DeviceManagementScriptUserState] = None, request_configuration: Optional[DeviceManagementScriptUserStateItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[device_management_script_user_state.DeviceManagementScriptUserState]:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_script_user_state.DeviceManagementScriptUserState] = None, request_configuration: Optional[DeviceManagementScriptUserStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userRunStates in deviceManagement
        Args:
            body: The request body
