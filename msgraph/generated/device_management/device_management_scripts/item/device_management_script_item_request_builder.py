...
assign_request_builder = lazy_import('msgraph.generated.device_management.device_management_scripts.item.microsoft_graph_assign.assign_request_builder')
...
class DeviceManagementScriptItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_script_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementScriptItemRequestBuilder and sets the default values.
        Args:
            deviceManagementScriptId: key: id of deviceManagementScript
        ...
        url_tpl_params["deviceManagementScript%2Did"] = deviceManagementScriptId
