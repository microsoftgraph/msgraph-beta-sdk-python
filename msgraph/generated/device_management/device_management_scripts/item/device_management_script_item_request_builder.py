...
class DeviceManagementScriptItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceManagementScriptItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceManagementScriptItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_management_script.DeviceManagementScript] = None, request_configuration: Optional[DeviceManagementScriptItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
