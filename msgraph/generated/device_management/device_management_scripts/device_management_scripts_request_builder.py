...
class DeviceManagementScriptsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceManagementScriptsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_script.DeviceManagementScript] = None, request_configuration: Optional[DeviceManagementScriptsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
