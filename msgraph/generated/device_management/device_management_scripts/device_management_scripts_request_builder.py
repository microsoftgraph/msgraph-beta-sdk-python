...
if TYPE_CHECKING:
    from ...models import device_management_script, device_management_script_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .has_payload_links import has_payload_links_request_builder
    from .item import device_management_script_item_request_builder

class DeviceManagementScriptsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/deviceManagementScripts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_device_management_script_id(self,device_management_script_id: str) -> device_management_script_item_request_builder.DeviceManagementScriptItemRequestBuilder:
        """
        Provides operations to manage the deviceManagementScripts property of the microsoft.graph.deviceManagement entity.
        Args:
            device_management_script_id: Unique identifier of the item
        ...
        if device_management_script_id is None:
            raise Exception("device_management_script_id cannot be undefined")
        from .item import device_management_script_item_request_builder
    ...
    async def get(self,request_configuration: Optional[DeviceManagementScriptsRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_script_collection_response.DeviceManagementScriptCollectionResponse]:
        ...
        from ...models import device_management_script_collection_response
    ...
    def to_post_request_information(self,body: Optional[device_management_script.DeviceManagementScript] = None, request_configuration: Optional[DeviceManagementScriptsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceManagementScripts for deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class DeviceManagementScriptsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class DeviceManagementScriptsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
