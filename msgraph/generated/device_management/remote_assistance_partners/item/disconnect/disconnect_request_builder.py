...
class DisconnectRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}/disconnect", path_parameters)
    
    async def post(self,request_configuration: Optional[DisconnectRequestBuilderPostRequestConfiguration] = None) -> None:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DisconnectRequestBuilder:
        ...
        Returns: DisconnectRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class DisconnectRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
