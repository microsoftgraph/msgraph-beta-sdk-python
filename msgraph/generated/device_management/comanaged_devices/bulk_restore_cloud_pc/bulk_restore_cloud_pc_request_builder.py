...
bulk_restore_cloud_pc_post_request_body = lazy_import('msgraph.generated.device_management.comanaged_devices.bulk_restore_cloud_pc.bulk_restore_cloud_pc_post_request_body')
...
class BulkRestoreCloudPcRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/comanagedDevices/microsoft.graph.bulkRestoreCloudPc"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[bulk_restore_cloud_pc_post_request_body.BulkRestoreCloudPcPostRequestBody] = None, request_configuration: Optional[BulkRestoreCloudPcRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
