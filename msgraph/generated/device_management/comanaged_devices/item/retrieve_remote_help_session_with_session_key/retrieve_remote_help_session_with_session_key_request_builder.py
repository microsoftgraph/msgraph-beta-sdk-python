...
from .....models import retrieve_remote_help_session_response
...
class RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, session_key: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/microsoft.graph.retrieveRemoteHelpSession(sessionKey='{sessionKey}')"
    ...
    def create_get_request_information(self,request_configuration: Optional[RetrieveRemoteHelpSessionWithSessionKeyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
