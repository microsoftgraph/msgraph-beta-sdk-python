...
microsoft_graph_create_download_url_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.log_collection_requests.item.microsoft_graph_create_download_url.microsoft_graph_create_download_url_request_builder')
...
class DeviceLogCollectionResponseItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}{?%24select,%24expand}"
