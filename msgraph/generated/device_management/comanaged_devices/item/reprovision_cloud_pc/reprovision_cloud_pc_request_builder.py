...
class ReprovisionCloudPcRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/reprovisionCloudPc", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ReprovisionCloudPcRequestBuilder:
        ...
        return ReprovisionCloudPcRequestBuilder(raw_url, self.request_adapter)
