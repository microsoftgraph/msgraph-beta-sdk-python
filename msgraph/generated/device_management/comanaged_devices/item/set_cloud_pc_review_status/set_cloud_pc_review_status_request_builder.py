...
set_cloud_pc_review_status_post_request_body = lazy_import('msgraph.generated.device_management.comanaged_devices.item.set_cloud_pc_review_status.set_cloud_pc_review_status_post_request_body')
...
class SetCloudPcReviewStatusRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[set_cloud_pc_review_status_post_request_body.SetCloudPcReviewStatusPostRequestBody] = None, request_configuration: Optional[SetCloudPcReviewStatusRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
