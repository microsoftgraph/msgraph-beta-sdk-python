...
assignment_filter_evaluation_status_details_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.assignment_filter_evaluation_status_details.assignment_filter_evaluation_status_details_request_builder')
assignment_filter_evaluation_status_details_item_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.assignment_filter_evaluation_status_details.item.assignment_filter_evaluation_status_details_item_request_builder')
detected_apps_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.detected_apps.detected_apps_request_builder')
detected_app_item_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.detected_apps.item.detected_app_item_request_builder')
device_category_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.device_category.device_category_request_builder')
device_compliance_policy_states_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.device_compliance_policy_states.device_compliance_policy_states_request_builder')
...
managed_device_mobile_app_configuration_states_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.managed_device_mobile_app_configuration_states.managed_device_mobile_app_configuration_states_request_builder')
managed_device_mobile_app_configuration_state_item_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.managed_device_mobile_app_configuration_states.item.managed_device_mobile_app_configuration_state_item_request_builder')
activate_device_esim_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_activate_device_esim.activate_device_esim_request_builder')
bypass_activation_lock_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_bypass_activation_lock.bypass_activation_lock_request_builder')
clean_windows_device_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_clean_windows_device.clean_windows_device_request_builder')
create_device_log_collection_request_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_create_device_log_collection_request.create_device_log_collection_request_request_builder')
create_remote_help_session_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_create_remote_help_session.create_remote_help_session_request_builder')
delete_user_from_shared_apple_device_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_delete_user_from_shared_apple_device.delete_user_from_shared_apple_device_request_builder')
deprovision_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_deprovision.deprovision_request_builder')
disable_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_disable.disable_request_builder')
disable_lost_mode_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_disable_lost_mode.disable_lost_mode_request_builder')
enable_lost_mode_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_enable_lost_mode.enable_lost_mode_request_builder')
end_remote_help_session_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_end_remote_help_session.end_remote_help_session_request_builder')
enroll_now_action_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_enroll_now_action.enroll_now_action_request_builder')
get_cloud_pc_remote_action_results_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_get_cloud_pc_remote_action_results.get_cloud_pc_remote_action_results_request_builder')
get_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_get_cloud_pc_review_status.get_cloud_pc_review_status_request_builder')
get_file_vault_key_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_get_file_vault_key.get_file_vault_key_request_builder')
get_non_compliant_settings_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_get_non_compliant_settings.get_non_compliant_settings_request_builder')
get_oem_warranty_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_get_oem_warranty.get_oem_warranty_request_builder')
initiate_mobile_device_management_key_recovery_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_initiate_mobile_device_management_key_recovery.initiate_mobile_device_management_key_recovery_request_builder')
initiate_on_demand_proactive_remediation_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_initiate_on_demand_proactive_remediation.initiate_on_demand_proactive_remediation_request_builder')
locate_device_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_locate_device.locate_device_request_builder')
logout_shared_apple_device_active_user_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_logout_shared_apple_device_active_user.logout_shared_apple_device_active_user_request_builder')
override_compliance_state_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_override_compliance_state.override_compliance_state_request_builder')
play_lost_mode_sound_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_play_lost_mode_sound.play_lost_mode_sound_request_builder')
reboot_now_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_reboot_now.reboot_now_request_builder')
recover_passcode_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_recover_passcode.recover_passcode_request_builder')
reenable_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_reenable.reenable_request_builder')
remote_lock_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_remote_lock.remote_lock_request_builder')
remove_device_firmware_configuration_interface_management_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_remove_device_firmware_configuration_interface_management.remove_device_firmware_configuration_interface_management_request_builder')
reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_reprovision_cloud_pc.reprovision_cloud_pc_request_builder')
request_remote_assistance_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_request_remote_assistance.request_remote_assistance_request_builder')
request_remote_help_session_access_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_request_remote_help_session_access.request_remote_help_session_access_request_builder')
reset_passcode_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_reset_passcode.reset_passcode_request_builder')
resize_cloud_pc_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_resize_cloud_pc.resize_cloud_pc_request_builder')
restore_cloud_pc_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_restore_cloud_pc.restore_cloud_pc_request_builder')
retire_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_retire.retire_request_builder')
retrieve_remote_help_session_with_session_key_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_retrieve_remote_help_session_with_session_key.retrieve_remote_help_session_with_session_key_request_builder')
revoke_apple_vpp_licenses_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_revoke_apple_vpp_licenses.revoke_apple_vpp_licenses_request_builder')
rotate_bit_locker_keys_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_rotate_bit_locker_keys.rotate_bit_locker_keys_request_builder')
rotate_file_vault_key_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_rotate_file_vault_key.rotate_file_vault_key_request_builder')
send_custom_notification_to_company_portal_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_send_custom_notification_to_company_portal.send_custom_notification_to_company_portal_request_builder')
set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_set_cloud_pc_review_status.set_cloud_pc_review_status_request_builder')
set_device_name_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_set_device_name.set_device_name_request_builder')
shut_down_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_shut_down.shut_down_request_builder')
sync_device_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_sync_device.sync_device_request_builder')
trigger_configuration_manager_action_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_trigger_configuration_manager_action.trigger_configuration_manager_action_request_builder')
update_windows_device_account_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_update_windows_device_account.update_windows_device_account_request_builder')
windows_defender_scan_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_windows_defender_scan.windows_defender_scan_request_builder')
windows_defender_update_signatures_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_windows_defender_update_signatures.windows_defender_update_signatures_request_builder')
wipe_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.microsoft_graph_wipe.wipe_request_builder')
security_baseline_states_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.security_baseline_states.security_baseline_states_request_builder')
security_baseline_state_item_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.security_baseline_states.item.security_baseline_state_item_request_builder')
users_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.users.users_request_builder')
windows_protection_state_request_builder = lazy_import('msgraph.generated.device_management.comanaged_devices.item.windows_protection_state.windows_protection_state_request_builder')
...
class ManagedDeviceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_activate_device_esim(self) -> activate_device_esim_request_builder.ActivateDeviceEsimRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_create_device_log_collection_request(self) -> create_device_log_collection_request_request_builder.CreateDeviceLogCollectionRequestRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_create_remote_help_session(self) -> create_remote_help_session_request_builder.CreateRemoteHelpSessionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_deprovision(self) -> deprovision_request_builder.DeprovisionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_disable(self) -> disable_request_builder.DisableRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_enable_lost_mode(self) -> enable_lost_mode_request_builder.EnableLostModeRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_end_remote_help_session(self) -> end_remote_help_session_request_builder.EndRemoteHelpSessionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_enroll_now_action(self) -> enroll_now_action_request_builder.EnrollNowActionRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_cloud_pc_remote_action_results(self) -> get_cloud_pc_remote_action_results_request_builder.GetCloudPcRemoteActionResultsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_cloud_pc_review_status(self) -> get_cloud_pc_review_status_request_builder.GetCloudPcReviewStatusRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_file_vault_key(self) -> get_file_vault_key_request_builder.GetFileVaultKeyRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_non_compliant_settings(self) -> get_non_compliant_settings_request_builder.GetNonCompliantSettingsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_oem_warranty(self) -> get_oem_warranty_request_builder.GetOemWarrantyRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_initiate_mobile_device_management_key_recovery(self) -> initiate_mobile_device_management_key_recovery_request_builder.InitiateMobileDeviceManagementKeyRecoveryRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_initiate_on_demand_proactive_remediation(self) -> initiate_on_demand_proactive_remediation_request_builder.InitiateOnDemandProactiveRemediationRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_override_compliance_state(self) -> override_compliance_state_request_builder.OverrideComplianceStateRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_play_lost_mode_sound(self) -> play_lost_mode_sound_request_builder.PlayLostModeSoundRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_reenable(self) -> reenable_request_builder.ReenableRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_remove_device_firmware_configuration_interface_management(self) -> remove_device_firmware_configuration_interface_management_request_builder.RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_reprovision_cloud_pc(self) -> reprovision_cloud_pc_request_builder.ReprovisionCloudPcRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_request_remote_help_session_access(self) -> request_remote_help_session_access_request_builder.RequestRemoteHelpSessionAccessRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_resize_cloud_pc(self) -> resize_cloud_pc_request_builder.ResizeCloudPcRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_restore_cloud_pc(self) -> restore_cloud_pc_request_builder.RestoreCloudPcRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_revoke_apple_vpp_licenses(self) -> revoke_apple_vpp_licenses_request_builder.RevokeAppleVppLicensesRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_rotate_bit_locker_keys(self) -> rotate_bit_locker_keys_request_builder.RotateBitLockerKeysRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_rotate_file_vault_key(self) -> rotate_file_vault_key_request_builder.RotateFileVaultKeyRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_send_custom_notification_to_company_portal(self) -> send_custom_notification_to_company_portal_request_builder.SendCustomNotificationToCompanyPortalRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_set_cloud_pc_review_status(self) -> set_cloud_pc_review_status_request_builder.SetCloudPcReviewStatusRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_set_device_name(self) -> set_device_name_request_builder.SetDeviceNameRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_trigger_configuration_manager_action(self) -> trigger_configuration_manager_action_request_builder.TriggerConfigurationManagerActionRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, managed_device_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}{?%24select,%24expand}"
    ...
    def microsoft_graph_retrieve_remote_help_session_with_session_key(self,session_key: Optional[str] = None) -> retrieve_remote_help_session_with_session_key_request_builder.RetrieveRemoteHelpSessionWithSessionKeyRequestBuilder:
        """
