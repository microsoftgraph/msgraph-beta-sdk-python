...
if TYPE_CHECKING:
    ...
    from .update_windows_device_account_post_request_body import UpdateWindowsDeviceAccountPostRequestBody

class UpdateWindowsDeviceAccountRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UpdateWindowsDeviceAccountRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UpdateWindowsDeviceAccountRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return UpdateWindowsDeviceAccountRequestBuilder(raw_url, self.request_adapter)
