...
bulk_reprovision_cloud_pc_post_request_body = lazy_import('msgraph.generated.device_management.comanaged_devices.bulk_reprovision_cloud_pc.bulk_reprovision_cloud_pc_post_request_body')
...
class BulkReprovisionCloudPcRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/comanagedDevices/bulkReprovisionCloudPc"
