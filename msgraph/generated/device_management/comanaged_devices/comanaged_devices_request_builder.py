...
class ComanagedDevicesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ComanagedDevicesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[managed_device.ManagedDevice] = None, request_configuration: Optional[ComanagedDevicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
