...
if TYPE_CHECKING:
    ...
    from .get_role_scope_tags_by_ids_with_ids_response import GetRoleScopeTagsByIdsWithIdsResponse
...
class GetRoleScopeTagsByIdsWithIdsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, ids: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/getRoleScopeTagsByIds(ids={ids}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
    ...
    async def get(self,request_configuration: Optional[GetRoleScopeTagsByIdsWithIdsRequestBuilderGetRequestConfiguration] = None) -> Optional[GetRoleScopeTagsByIdsWithIdsResponse]:
        ...
        Returns: Optional[GetRoleScopeTagsByIdsWithIdsResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetRoleScopeTagsByIdsWithIdsResponse, error_mapping)
