...
get_role_scope_tags_by_ids_with_ids_response = lazy_import('msgraph.generated.device_management.get_role_scope_tags_by_ids_with_ids.get_role_scope_tags_by_ids_with_ids_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class GetRoleScopeTagsByIdsWithIdsRequestBuilder():
    """
    ...
    def create_get_request_information(self,request_configuration: Optional[GetRoleScopeTagsByIdsWithIdsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetRoleScopeTagsByIdsWithIdsRequestBuilderGetRequestConfiguration():
        """
