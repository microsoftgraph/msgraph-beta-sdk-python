...
count_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.count.count_request_builder')
device_shell_script = lazy_import('msgraph.generated.models.device_shell_script')
device_shell_script_collection_response = lazy_import('msgraph.generated.models.device_shell_script_collection_response')
...
class DeviceShellScriptsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceShellScriptsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_shell_script.DeviceShellScript] = None, request_configuration: Optional[DeviceShellScriptsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
