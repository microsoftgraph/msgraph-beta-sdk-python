...
count_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.user_run_states.count.count_request_builder')
...
class UserRunStatesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}/userRunStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
