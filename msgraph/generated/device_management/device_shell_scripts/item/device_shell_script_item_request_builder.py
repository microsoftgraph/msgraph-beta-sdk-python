...
assign_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.assign.assign_request_builder')
...
class DeviceShellScriptItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceShellScriptItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceShellScriptItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_shell_script.DeviceShellScript] = None, request_configuration: Optional[DeviceShellScriptItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
