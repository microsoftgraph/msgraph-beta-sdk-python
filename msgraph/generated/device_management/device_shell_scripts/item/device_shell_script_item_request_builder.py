...
assignments_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.assignments.assignments_request_builder')
device_management_script_assignment_item_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.assignments.item.device_management_script_assignment_item_request_builder')
device_run_states_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.device_run_states.device_run_states_request_builder')
device_management_script_device_state_item_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.device_run_states.item.device_management_script_device_state_item_request_builder')
group_assignments_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.group_assignments.group_assignments_request_builder')
device_management_script_group_assignment_item_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.group_assignments.item.device_management_script_group_assignment_item_request_builder')
assign_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.microsoft_graph_assign.assign_request_builder')
run_summary_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.run_summary.run_summary_request_builder')
user_run_states_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.user_run_states.user_run_states_request_builder')
device_management_script_user_state_item_request_builder = lazy_import('msgraph.generated.device_management.device_shell_scripts.item.user_run_states.item.device_management_script_user_state_item_request_builder')
...
class DeviceShellScriptItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_shell_script_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceShellScriptItemRequestBuilder and sets the default values.
        Args:
            deviceShellScriptId: key: id of deviceShellScript
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/deviceShellScripts/{deviceShellScript%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["deviceShellScript%2Did"] = deviceShellScriptId
    ...
    def to_get_request_information(self,request_configuration: Optional[DeviceShellScriptItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The list of device shell scripts associated with the tenant.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[device_shell_script.DeviceShellScript] = None, request_configuration: Optional[DeviceShellScriptItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceShellScripts in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class DeviceShellScriptItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DeviceShellScriptItemRequestBuilderGetQueryParameters():
        """
        The list of device shell scripts associated with the tenant.
        """
    ...
    @dataclass
    class DeviceShellScriptItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
        ...
        query_parameters: Optional[DeviceShellScriptItemRequestBuilder.DeviceShellScriptItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class DeviceShellScriptItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
