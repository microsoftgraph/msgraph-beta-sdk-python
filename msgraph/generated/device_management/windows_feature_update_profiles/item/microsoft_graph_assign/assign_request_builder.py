...
assign_post_request_body = lazy_import('msgraph.generated.device_management.windows_feature_update_profiles.item.microsoft_graph_assign.assign_post_request_body')
