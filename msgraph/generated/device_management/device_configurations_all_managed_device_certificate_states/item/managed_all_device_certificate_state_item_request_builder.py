...
class ManagedAllDeviceCertificateStateItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, managed_all_device_certificate_state_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagedAllDeviceCertificateStateItemRequestBuilder and sets the default values.
        Args:
            managedAllDeviceCertificateStateId: key: id of managedAllDeviceCertificateState
        ...
        url_tpl_params["managedAllDeviceCertificateState%2Did"] = managedAllDeviceCertificateStateId
    ...
    def to_patch_request_information(self,body: Optional[managed_all_device_certificate_state.ManagedAllDeviceCertificateState] = None, request_configuration: Optional[ManagedAllDeviceCertificateStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceConfigurationsAllManagedDeviceCertificateStates in deviceManagement
        Args:
            body: The request body
