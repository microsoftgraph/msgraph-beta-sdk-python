...
from .get_supported_properties import get_supported_properties_request_builder
...
class DeviceAndAppManagementAssignmentFilterItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[DeviceAndAppManagementAssignmentFilterItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceAndAppManagementAssignmentFilterItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[device_and_app_management_assignment_filter.DeviceAndAppManagementAssignmentFilter] = None, request_configuration: Optional[DeviceAndAppManagementAssignmentFilterItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
