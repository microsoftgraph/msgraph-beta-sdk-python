...
microsoft_graph_get_supported_properties_request_builder = lazy_import('msgraph.generated.device_management.assignment_filters.item.microsoft_graph_get_supported_properties.microsoft_graph_get_supported_properties_request_builder')
...
class DeviceAndAppManagementAssignmentFilterItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_get_supported_properties(self) -> microsoft_graph_get_supported_properties_request_builder.MicrosoftGraphGetSupportedPropertiesRequestBuilder:
        """
        Provides operations to call the getSupportedProperties method.
        """
        return microsoft_graph_get_supported_properties_request_builder.MicrosoftGraphGetSupportedPropertiesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[device_and_app_management_assignment_filter.DeviceAndAppManagementAssignmentFilter] = None, request_configuration: Optional[DeviceAndAppManagementAssignmentFilterItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignmentFilters in deviceManagement
        Args:
            body: The request body
