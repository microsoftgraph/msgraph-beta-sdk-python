...
get_platform_supported_properties_with_platform_response = lazy_import('msgraph.generated.device_management.assignment_filters.get_platform_supported_properties_with_platform.get_platform_supported_properties_with_platform_response')
...
class GetPlatformSupportedPropertiesWithPlatformRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, platform: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/assignmentFilters/microsoft.graph.getPlatformSupportedProperties(platform='{platform}'){?%24top,%24skip,%24search,%24filter,%24count}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params[""] = platform
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
