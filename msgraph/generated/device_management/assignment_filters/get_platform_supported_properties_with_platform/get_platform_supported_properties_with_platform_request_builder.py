...
class GetPlatformSupportedPropertiesWithPlatformRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, platform: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/assignmentFilters/getPlatformSupportedProperties(platform='{platform}'){?%24top,%24skip,%24search,%24filter,%24count}"
