...
assign_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.microsoft_graph_assign.assign_request_builder')
...
class WindowsAutopilotDeploymentProfileItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, windows_autopilot_deployment_profile_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            windowsAutopilotDeploymentProfileId: key: id of windowsAutopilotDeploymentProfile
        """
        ...
        url_tpl_params["windowsAutopilotDeploymentProfile%2Did"] = windowsAutopilotDeploymentProfileId
