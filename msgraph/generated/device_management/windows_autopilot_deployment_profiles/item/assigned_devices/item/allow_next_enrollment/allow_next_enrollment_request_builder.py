...
class AllowNextEnrollmentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}/allowNextEnrollment", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AllowNextEnrollmentRequestBuilder:
        ...
        return AllowNextEnrollmentRequestBuilder(self.request_adapter, raw_url)
