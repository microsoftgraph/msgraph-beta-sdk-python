...
deployment_profile_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.deployment_profile.deployment_profile_request_builder')
intended_deployment_profile_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.intended_deployment_profile.intended_deployment_profile_request_builder')
microsoft_graph_assign_resource_account_to_device_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.microsoft_graph_assign_resource_account_to_device.microsoft_graph_assign_resource_account_to_device_request_builder')
microsoft_graph_assign_user_to_device_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.microsoft_graph_assign_user_to_device.microsoft_graph_assign_user_to_device_request_builder')
microsoft_graph_unassign_resource_account_from_device_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.microsoft_graph_unassign_resource_account_from_device.microsoft_graph_unassign_resource_account_from_device_request_builder')
microsoft_graph_unassign_user_from_device_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.microsoft_graph_unassign_user_from_device.microsoft_graph_unassign_user_from_device_request_builder')
microsoft_graph_update_device_properties_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.item.assigned_devices.item.microsoft_graph_update_device_properties.microsoft_graph_update_device_properties_request_builder')
...
class WindowsAutopilotDeviceIdentityItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles/{windowsAutopilotDeploymentProfile%2Did}/assignedDevices/{windowsAutopilotDeviceIdentity%2Did}{?%24select,%24expand}"
