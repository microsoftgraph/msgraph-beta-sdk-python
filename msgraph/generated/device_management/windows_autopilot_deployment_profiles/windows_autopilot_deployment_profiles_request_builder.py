...
count_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.count.count_request_builder')
has_payload_links_request_builder = lazy_import('msgraph.generated.device_management.windows_autopilot_deployment_profiles.has_payload_links.has_payload_links_request_builder')
windows_autopilot_deployment_profile = lazy_import('msgraph.generated.models.windows_autopilot_deployment_profile')
windows_autopilot_deployment_profile_collection_response = lazy_import('msgraph.generated.models.windows_autopilot_deployment_profile_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class WindowsAutopilotDeploymentProfilesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/windowsAutopilotDeploymentProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[WindowsAutopilotDeploymentProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[windows_autopilot_deployment_profile.WindowsAutopilotDeploymentProfile] = None, request_configuration: Optional[WindowsAutopilotDeploymentProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
