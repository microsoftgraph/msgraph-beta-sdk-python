...
class UserExperienceAnalyticsCategoryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user_experience_analytics_category_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            userExperienceAnalyticsCategoryId: key: id of userExperienceAnalyticsCategory
        """
        ...
        url_tpl_params["userExperienceAnalyticsCategory%2Did"] = userExperienceAnalyticsCategoryId
    ...
    def to_patch_request_information(self,body: Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory] = None, request_configuration: Optional[UserExperienceAnalyticsCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsCategories in deviceManagement
        Args:
            body: The request body
