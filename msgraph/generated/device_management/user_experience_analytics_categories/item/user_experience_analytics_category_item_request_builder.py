...
metric_values_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_categories.item.metric_values.metric_values_request_builder')
user_experience_analytics_metric_item_request_builder = lazy_import('msgraph.generated.device_management.user_experience_analytics_categories.item.metric_values.item.user_experience_analytics_metric_item_request_builder')
...
class UserExperienceAnalyticsCategoryItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[UserExperienceAnalyticsCategoryItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsCategoryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[user_experience_analytics_category.UserExperienceAnalyticsCategory] = None, request_configuration: Optional[UserExperienceAnalyticsCategoryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsCategoryItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class UserExperienceAnalyticsCategoryItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
