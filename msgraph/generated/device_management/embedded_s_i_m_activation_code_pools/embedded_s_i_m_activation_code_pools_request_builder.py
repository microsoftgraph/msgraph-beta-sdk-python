...
count_request_builder = lazy_import('msgraph.generated.device_management.embedded_s_i_m_activation_code_pools.count.count_request_builder')
embedded_s_i_m_activation_code_pool = lazy_import('msgraph.generated.models.embedded_s_i_m_activation_code_pool')
embedded_s_i_m_activation_code_pool_collection_response = lazy_import('msgraph.generated.models.embedded_s_i_m_activation_code_pool_collection_response')
...
class EmbeddedSIMActivationCodePoolsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[EmbeddedSIMActivationCodePoolsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[embedded_s_i_m_activation_code_pool.EmbeddedSIMActivationCodePool] = None, request_configuration: Optional[EmbeddedSIMActivationCodePoolsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
