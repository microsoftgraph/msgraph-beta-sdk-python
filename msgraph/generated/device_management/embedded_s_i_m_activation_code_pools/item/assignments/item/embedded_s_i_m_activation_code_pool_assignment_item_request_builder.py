...
class EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[embedded_s_i_m_activation_code_pool_assignment.EmbeddedSIMActivationCodePoolAssignment] = None, request_configuration: Optional[EmbeddedSIMActivationCodePoolAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceManagement
        Args:
            body: The request body
