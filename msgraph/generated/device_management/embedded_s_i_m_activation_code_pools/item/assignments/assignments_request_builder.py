...
count_request_builder = lazy_import('msgraph.generated.device_management.embedded_s_i_m_activation_code_pools.item.assignments.count.count_request_builder')
...
embedded_s_i_m_activation_code_pool_assignment_collection_response = lazy_import('msgraph.generated.models.embedded_s_i_m_activation_code_pool_assignment_collection_response')
...
class AssignmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[embedded_s_i_m_activation_code_pool_assignment.EmbeddedSIMActivationCodePoolAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
