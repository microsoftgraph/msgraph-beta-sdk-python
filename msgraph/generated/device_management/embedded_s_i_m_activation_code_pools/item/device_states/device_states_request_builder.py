...
count_request_builder = lazy_import('msgraph.generated.device_management.embedded_s_i_m_activation_code_pools.item.device_states.count.count_request_builder')
embedded_s_i_m_device_state = lazy_import('msgraph.generated.models.embedded_s_i_m_device_state')
embedded_s_i_m_device_state_collection_response = lazy_import('msgraph.generated.models.embedded_s_i_m_device_state_collection_response')
...
class DeviceStatesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DeviceStatesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[embedded_s_i_m_device_state.EmbeddedSIMDeviceState] = None, request_configuration: Optional[DeviceStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
