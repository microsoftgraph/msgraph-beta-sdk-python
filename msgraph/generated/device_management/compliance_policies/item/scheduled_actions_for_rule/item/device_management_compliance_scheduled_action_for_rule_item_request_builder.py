...
class DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_management_compliance_scheduled_action_for_rule_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeviceManagementComplianceScheduledActionForRuleItemRequestBuilder and sets the default values.
        Args:
            deviceManagementComplianceScheduledActionForRuleId: key: id of deviceManagementComplianceScheduledActionForRule
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["deviceManagementComplianceScheduledActionForRule%2Did"] = deviceManagementComplianceScheduledActionForRuleId
    ...
    async def get(self,request_configuration: Optional[DeviceManagementComplianceScheduledActionForRuleItemRequestBuilderGetRequestConfiguration] = None) -> Optional[device_management_compliance_scheduled_action_for_rule.DeviceManagementComplianceScheduledActionForRule]:
        """
    ...
    async def patch(self,body: Optional[device_management_compliance_scheduled_action_for_rule.DeviceManagementComplianceScheduledActionForRule] = None, request_configuration: Optional[DeviceManagementComplianceScheduledActionForRuleItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[device_management_compliance_scheduled_action_for_rule.DeviceManagementComplianceScheduledActionForRule]:
        """
    ...
    def to_patch_request_information(self,body: Optional[device_management_compliance_scheduled_action_for_rule.DeviceManagementComplianceScheduledActionForRule] = None, request_configuration: Optional[DeviceManagementComplianceScheduledActionForRuleItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property scheduledActionsForRule in deviceManagement
        Args:
            body: The request body
