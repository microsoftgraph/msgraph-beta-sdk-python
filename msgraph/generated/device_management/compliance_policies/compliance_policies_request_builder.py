...
count_request_builder = lazy_import('msgraph.generated.device_management.compliance_policies.count.count_request_builder')
device_management_compliance_policy = lazy_import('msgraph.generated.models.device_management_compliance_policy')
device_management_compliance_policy_collection_response = lazy_import('msgraph.generated.models.device_management_compliance_policy_collection_response')
...
class CompliancePoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CompliancePoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[device_management_compliance_policy.DeviceManagementCompliancePolicy] = None, request_configuration: Optional[CompliancePoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
