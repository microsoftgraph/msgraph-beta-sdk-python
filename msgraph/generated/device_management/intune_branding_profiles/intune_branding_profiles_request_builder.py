...
count_request_builder = lazy_import('msgraph.generated.device_management.intune_branding_profiles.count.count_request_builder')
intune_branding_profile = lazy_import('msgraph.generated.models.intune_branding_profile')
intune_branding_profile_collection_response = lazy_import('msgraph.generated.models.intune_branding_profile_collection_response')
...
class IntuneBrandingProfilesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[IntuneBrandingProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[intune_branding_profile.IntuneBrandingProfile] = None, request_configuration: Optional[IntuneBrandingProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
