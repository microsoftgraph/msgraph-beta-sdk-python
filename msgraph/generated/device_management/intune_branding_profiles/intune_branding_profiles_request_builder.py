...
if TYPE_CHECKING:
    from ...models import intune_branding_profile, intune_branding_profile_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import intune_branding_profile_item_request_builder
...
class IntuneBrandingProfilesRequestBuilder():
    ...
    def by_intune_branding_profile_id(self,intune_branding_profile_id: str) -> intune_branding_profile_item_request_builder.IntuneBrandingProfileItemRequestBuilder:
        """
        Provides operations to manage the intuneBrandingProfiles property of the microsoft.graph.deviceManagement entity.
        Args:
        ...
        if intune_branding_profile_id is None:
            raise Exception("intune_branding_profile_id cannot be undefined")
        from .item import intune_branding_profile_item_request_builder
    ...
    async def get(self,request_configuration: Optional[IntuneBrandingProfilesRequestBuilderGetRequestConfiguration] = None) -> Optional[intune_branding_profile_collection_response.IntuneBrandingProfileCollectionResponse]:
        ...
        from ...models import intune_branding_profile_collection_response
    ...
    async def post(self,body: Optional[intune_branding_profile.IntuneBrandingProfile] = None, request_configuration: Optional[IntuneBrandingProfilesRequestBuilderPostRequestConfiguration] = None) -> Optional[intune_branding_profile.IntuneBrandingProfile]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ...models import intune_branding_profile
    ...
    def to_post_request_information(self,body: Optional[intune_branding_profile.IntuneBrandingProfile] = None, request_configuration: Optional[IntuneBrandingProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to intuneBrandingProfiles for deviceManagement
        Args:
            body: The request body
