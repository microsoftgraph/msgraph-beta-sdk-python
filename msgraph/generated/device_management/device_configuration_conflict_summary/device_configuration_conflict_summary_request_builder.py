...
class DeviceConfigurationConflictSummaryRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceConfigurationConflictSummary{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_device_configuration_conflict_summary_id(self,device_configuration_conflict_summary_id: str) -> DeviceConfigurationConflictSummaryItemRequestBuilder:
        """
        Provides operations to manage the deviceConfigurationConflictSummary property of the microsoft.graph.deviceManagement entity.
        param device_configuration_conflict_summary_id: The unique identifier of deviceConfigurationConflictSummary
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DeviceConfigurationConflictSummaryRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DeviceConfigurationConflictSummaryRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return DeviceConfigurationConflictSummaryRequestBuilder(raw_url, self.request_adapter)
