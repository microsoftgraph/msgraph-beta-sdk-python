...
if TYPE_CHECKING:
    from ...models import microsoft_tunnel_server_log_collection_response, microsoft_tunnel_server_log_collection_response_collection_response
    from ...models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import microsoft_tunnel_server_log_collection_response_item_request_builder
...
class MicrosoftTunnelServerLogCollectionResponsesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/microsoftTunnelServerLogCollectionResponses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_microsoft_tunnel_server_log_collection_response_id(self,microsoft_tunnel_server_log_collection_response_id: str) -> microsoft_tunnel_server_log_collection_response_item_request_builder.MicrosoftTunnelServerLogCollectionResponseItemRequestBuilder:
        """
        Provides operations to manage the microsoftTunnelServerLogCollectionResponses property of the microsoft.graph.deviceManagement entity.
        Args:
            microsoft_tunnel_server_log_collection_response_id: Unique identifier of the item
        ...
        if microsoft_tunnel_server_log_collection_response_id is None:
            raise Exception("microsoft_tunnel_server_log_collection_response_id cannot be undefined")
        from .item import microsoft_tunnel_server_log_collection_response_item_request_builder
    ...
    async def get(self,request_configuration: Optional[MicrosoftTunnelServerLogCollectionResponsesRequestBuilderGetRequestConfiguration] = None) -> Optional[microsoft_tunnel_server_log_collection_response_collection_response.MicrosoftTunnelServerLogCollectionResponseCollectionResponse]:
        ...
        from ...models import microsoft_tunnel_server_log_collection_response_collection_response
    ...
    def to_post_request_information(self,body: Optional[microsoft_tunnel_server_log_collection_response.MicrosoftTunnelServerLogCollectionResponse] = None, request_configuration: Optional[MicrosoftTunnelServerLogCollectionResponsesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to microsoftTunnelServerLogCollectionResponses for deviceManagement
        Args:
            body: The request body
