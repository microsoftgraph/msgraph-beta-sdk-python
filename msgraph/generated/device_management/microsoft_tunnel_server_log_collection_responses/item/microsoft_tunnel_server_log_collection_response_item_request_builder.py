...
microsoft_graph_create_download_url_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_server_log_collection_responses.item.microsoft_graph_create_download_url.microsoft_graph_create_download_url_request_builder')
microsoft_graph_generate_download_url_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_server_log_collection_responses.item.microsoft_graph_generate_download_url.microsoft_graph_generate_download_url_request_builder')
...
class MicrosoftTunnelServerLogCollectionResponseItemRequestBuilder():
    ...
    @property
    def microsoft_graph_generate_download_url(self) -> microsoft_graph_generate_download_url_request_builder.MicrosoftGraphGenerateDownloadUrlRequestBuilder:
        """
        Provides operations to call the generateDownloadUrl method.
        """
        return microsoft_graph_generate_download_url_request_builder.MicrosoftGraphGenerateDownloadUrlRequestBuilder(self.request_adapter, self.path_parameters)
