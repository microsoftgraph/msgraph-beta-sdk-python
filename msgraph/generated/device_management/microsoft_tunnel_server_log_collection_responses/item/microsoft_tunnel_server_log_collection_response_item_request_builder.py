...
create_download_url_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_server_log_collection_responses.item.microsoft_graph_create_download_url.create_download_url_request_builder')
generate_download_url_request_builder = lazy_import('msgraph.generated.device_management.microsoft_tunnel_server_log_collection_responses.item.microsoft_graph_generate_download_url.generate_download_url_request_builder')
...
class MicrosoftTunnelServerLogCollectionResponseItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_create_download_url(self) -> create_download_url_request_builder.CreateDownloadUrlRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_generate_download_url(self) -> generate_download_url_request_builder.GenerateDownloadUrlRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, microsoft_tunnel_server_log_collection_response_id: Optional[str] = None) -> None:
        """
        Instantiates a new MicrosoftTunnelServerLogCollectionResponseItemRequestBuilder and sets the default values.
        Args:
            microsoftTunnelServerLogCollectionResponseId: key: id of microsoftTunnelServerLogCollectionResponse
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/microsoftTunnelServerLogCollectionResponses/{microsoftTunnelServerLogCollectionResponse%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["microsoftTunnelServerLogCollectionResponse%2Did"] = microsoftTunnelServerLogCollectionResponseId
    ...
    def to_patch_request_information(self,body: Optional[microsoft_tunnel_server_log_collection_response.MicrosoftTunnelServerLogCollectionResponse] = None, request_configuration: Optional[MicrosoftTunnelServerLogCollectionResponseItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property microsoftTunnelServerLogCollectionResponses in deviceManagement
        Args:
            body: The request body
    ...
    @dataclass
    class MicrosoftTunnelServerLogCollectionResponseItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
