...
class CertificateConnectorDetailsItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CertificateConnectorDetailsItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CertificateConnectorDetailsItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[certificate_connector_details.CertificateConnectorDetails] = None, request_configuration: Optional[CertificateConnectorDetailsItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
