...
get_health_metrics_request_builder = lazy_import('msgraph.generated.device_management.certificate_connector_details.item.microsoft_graph_get_health_metrics.get_health_metrics_request_builder')
get_health_metric_time_series_request_builder = lazy_import('msgraph.generated.device_management.certificate_connector_details.item.microsoft_graph_get_health_metric_time_series.get_health_metric_time_series_request_builder')
...
class CertificateConnectorDetailsItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_get_health_metrics(self) -> get_health_metrics_request_builder.GetHealthMetricsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_health_metric_time_series(self) -> get_health_metric_time_series_request_builder.GetHealthMetricTimeSeriesRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, certificate_connector_details_id: Optional[str] = None) -> None:
        """
        Instantiates a new CertificateConnectorDetailsItemRequestBuilder and sets the default values.
        Args:
            certificateConnectorDetailsId: key: id of certificateConnectorDetails
        ...
        url_tpl_params["certificateConnectorDetails%2Did"] = certificateConnectorDetailsId
