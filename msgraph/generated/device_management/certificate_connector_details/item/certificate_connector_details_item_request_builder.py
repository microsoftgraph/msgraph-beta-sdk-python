...
microsoft_graph_get_health_metrics_request_builder = lazy_import('msgraph.generated.device_management.certificate_connector_details.item.microsoft_graph_get_health_metrics.microsoft_graph_get_health_metrics_request_builder')
microsoft_graph_get_health_metric_time_series_request_builder = lazy_import('msgraph.generated.device_management.certificate_connector_details.item.microsoft_graph_get_health_metric_time_series.microsoft_graph_get_health_metric_time_series_request_builder')
...
class CertificateConnectorDetailsItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_get_health_metrics(self) -> microsoft_graph_get_health_metrics_request_builder.MicrosoftGraphGetHealthMetricsRequestBuilder:
        """
        Provides operations to call the getHealthMetrics method.
        """
        return microsoft_graph_get_health_metrics_request_builder.MicrosoftGraphGetHealthMetricsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_get_health_metric_time_series(self) -> microsoft_graph_get_health_metric_time_series_request_builder.MicrosoftGraphGetHealthMetricTimeSeriesRequestBuilder:
        """
        Provides operations to call the getHealthMetricTimeSeries method.
        """
        return microsoft_graph_get_health_metric_time_series_request_builder.MicrosoftGraphGetHealthMetricTimeSeriesRequestBuilder(self.request_adapter, self.path_parameters)
