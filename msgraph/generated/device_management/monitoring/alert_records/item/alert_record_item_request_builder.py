...
device_management_set_portal_notification_as_sent_request_builder = lazy_import('msgraph.generated.device_management.monitoring.alert_records.item.device_management_set_portal_notification_as_sent.device_management_set_portal_notification_as_sent_request_builder')
...
class AlertRecordItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/monitoring/alertRecords/{alertRecord%2Did}{?%24select,%24expand}"
