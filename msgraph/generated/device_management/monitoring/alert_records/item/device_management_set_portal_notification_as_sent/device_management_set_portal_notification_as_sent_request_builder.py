...
class DeviceManagementSetPortalNotificationAsSentRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/monitoring/alertRecords/{alertRecord%2Did}/deviceManagement.setPortalNotificationAsSent"
    ...
    @dataclass
    class DeviceManagementSetPortalNotificationAsSentRequestBuilderPostRequestConfiguration():
        """
