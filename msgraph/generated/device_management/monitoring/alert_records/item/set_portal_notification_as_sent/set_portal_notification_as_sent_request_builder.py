...
class SetPortalNotificationAsSentRequestBuilder():
    """
    Provides operations to call the setPortalNotificationAsSent method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new SetPortalNotificationAsSentRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/deviceManagement/monitoring/alertRecords/{alertRecord%2Did}/microsoft.graph.deviceManagement.setPortalNotificationAsSent"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,request_configuration: Optional[SetPortalNotificationAsSentRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
