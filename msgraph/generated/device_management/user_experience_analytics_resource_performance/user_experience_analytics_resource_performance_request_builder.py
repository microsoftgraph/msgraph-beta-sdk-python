...
class UserExperienceAnalyticsResourcePerformanceRequestBuilder():
    ...
    def microsoft_graph_summarize_device_resource_performance_with_summarize_by(self,summarize_by: Optional[str] = None) -> summarize_device_resource_performance_with_summarize_by_request_builder.SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder:
        """
