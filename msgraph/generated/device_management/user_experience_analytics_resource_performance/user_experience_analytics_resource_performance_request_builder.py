...
class UserExperienceAnalyticsResourcePerformanceRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserExperienceAnalyticsResourcePerformanceRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_experience_analytics_resource_performance.UserExperienceAnalyticsResourcePerformance] = None, request_configuration: Optional[UserExperienceAnalyticsResourcePerformanceRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
