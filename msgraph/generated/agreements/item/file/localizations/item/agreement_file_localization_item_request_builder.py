...
versions_request_builder = lazy_import('msgraph.generated.agreements.item.file.localizations.item.versions.versions_request_builder')
agreement_file_version_item_request_builder = lazy_import('msgraph.generated.agreements.item.file.localizations.item.versions.item.agreement_file_version_item_request_builder')
...
class AgreementFileLocalizationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}{?%24select,%24expand}"
