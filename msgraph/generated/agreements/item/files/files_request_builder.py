...
count_request_builder = lazy_import('msgraph.generated.agreements.item.files.count.count_request_builder')
...
class FilesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/agreements/{agreement%2Did}/files{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[agreement_file_localization.AgreementFileLocalization] = None, request_configuration: Optional[FilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
