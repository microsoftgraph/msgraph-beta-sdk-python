...
count_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.registration.custom_questions.count.count_request_builder')
meeting_registration_question = lazy_import('msgraph.generated.models.meeting_registration_question')
meeting_registration_question_collection_response = lazy_import('msgraph.generated.models.meeting_registration_question_collection_response')
...
class CustomQuestionsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CustomQuestionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[meeting_registration_question.MeetingRegistrationQuestion] = None, request_configuration: Optional[CustomQuestionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
