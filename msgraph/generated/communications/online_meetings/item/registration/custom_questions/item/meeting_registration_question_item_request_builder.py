...
class MeetingRegistrationQuestionItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, meeting_registration_question_id: Optional[str] = None) -> None:
        """
        Instantiates a new MeetingRegistrationQuestionItemRequestBuilder and sets the default values.
        Args:
            meetingRegistrationQuestionId: key: id of meetingRegistrationQuestion
        ...
        url_tpl_params["meetingRegistrationQuestion%2Did"] = meetingRegistrationQuestionId
