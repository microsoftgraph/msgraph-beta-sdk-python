...
attendance_records_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.meeting_attendance_report.attendance_records.attendance_records_request_builder')
attendance_record_item_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.meeting_attendance_report.attendance_records.item.attendance_record_item_request_builder')
...
class MeetingAttendanceReportRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[MeetingAttendanceReportRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[MeetingAttendanceReportRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[meeting_attendance_report.MeetingAttendanceReport] = None, request_configuration: Optional[MeetingAttendanceReportRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
