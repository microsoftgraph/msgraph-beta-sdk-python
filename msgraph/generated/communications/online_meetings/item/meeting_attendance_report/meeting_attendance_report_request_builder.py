...
class MeetingAttendanceReportRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[meeting_attendance_report.MeetingAttendanceReport] = None, request_configuration: Optional[MeetingAttendanceReportRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property meetingAttendanceReport in communications
        Args:
            body: The request body
