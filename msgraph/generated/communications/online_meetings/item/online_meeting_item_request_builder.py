...
alternative_recording_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.alternative_recording.alternative_recording_request_builder')
...
meeting_attendance_report_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.meeting_attendance_report.meeting_attendance_report_request_builder')
recording_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.recording.recording_request_builder')
registration_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.registration.registration_request_builder')
transcripts_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.transcripts.transcripts_request_builder')
call_transcript_item_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.transcripts.item.call_transcript_item_request_builder')
virtual_appointment_request_builder = lazy_import('msgraph.generated.communications.online_meetings.item.virtual_appointment.virtual_appointment_request_builder')
