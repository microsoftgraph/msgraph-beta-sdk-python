...
if TYPE_CHECKING:
    ...
    from ...models.online_meeting_collection_response import OnlineMeetingCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .create_or_get.create_or_get_request_builder import CreateOrGetRequestBuilder
    from .get_all_recordings.get_all_recordings_request_builder import GetAllRecordingsRequestBuilder
    from .get_all_transcripts.get_all_transcripts_request_builder import GetAllTranscriptsRequestBuilder
...
class OnlineMeetingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    @property
    def create_or_get(self) -> CreateOrGetRequestBuilder:
        """
    ...
    @property
    def get_all_recordings(self) -> GetAllRecordingsRequestBuilder:
        """
        Provides operations to call the getAllRecordings method.
        """
        from .get_all_recordings.get_all_recordings_request_builder import GetAllRecordingsRequestBuilder

        return GetAllRecordingsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def get_all_transcripts(self) -> GetAllTranscriptsRequestBuilder:
        """
        Provides operations to call the getAllTranscripts method.
        """
        from .get_all_transcripts.get_all_transcripts_request_builder import GetAllTranscriptsRequestBuilder

        return GetAllTranscriptsRequestBuilder(self.request_adapter, self.path_parameters)
