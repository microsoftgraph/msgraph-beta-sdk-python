...
class PresenceItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[PresenceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PresenceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[presence.Presence] = None, request_configuration: Optional[PresenceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
