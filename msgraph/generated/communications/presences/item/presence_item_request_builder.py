...
microsoft_graph_clear_presence_request_builder = lazy_import('msgraph.generated.communications.presences.item.microsoft_graph_clear_presence.microsoft_graph_clear_presence_request_builder')
microsoft_graph_clear_user_preferred_presence_request_builder = lazy_import('msgraph.generated.communications.presences.item.microsoft_graph_clear_user_preferred_presence.microsoft_graph_clear_user_preferred_presence_request_builder')
microsoft_graph_set_presence_request_builder = lazy_import('msgraph.generated.communications.presences.item.microsoft_graph_set_presence.microsoft_graph_set_presence_request_builder')
microsoft_graph_set_status_message_request_builder = lazy_import('msgraph.generated.communications.presences.item.microsoft_graph_set_status_message.microsoft_graph_set_status_message_request_builder')
microsoft_graph_set_user_preferred_presence_request_builder = lazy_import('msgraph.generated.communications.presences.item.microsoft_graph_set_user_preferred_presence.microsoft_graph_set_user_preferred_presence_request_builder')
...
class PresenceItemRequestBuilder():
    ...
    def to_get_request_information(self,request_configuration: Optional[PresenceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get presences from communications
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[presence.Presence] = None, request_configuration: Optional[PresenceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property presences in communications
        Args:
            body: The request body
    ...
    @dataclass
    class PresenceItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    class PresenceItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[PresenceItemRequestBuilder.PresenceItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class PresenceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
