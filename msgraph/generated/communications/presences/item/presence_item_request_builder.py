...
class PresenceItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/communications/presences/{presence%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PresenceItemRequestBuilderGetRequestConfiguration] = None) -> Optional[Presence]:
        """
    ...
    async def patch(self,body: Optional[Presence] = None, request_configuration: Optional[PresenceItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[Presence]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Presence] = None, request_configuration: Optional[PresenceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property presences in communications
        Args:
            body: The request body
    ...
    @dataclass
    class PresenceItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PresenceItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PresenceItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
