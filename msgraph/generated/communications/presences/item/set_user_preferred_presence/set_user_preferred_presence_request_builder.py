...
set_user_preferred_presence_post_request_body = lazy_import('msgraph.generated.communications.presences.item.set_user_preferred_presence.set_user_preferred_presence_post_request_body')
...
class SetUserPreferredPresenceRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/presences/{presence%2Did}/microsoft.graph.setUserPreferredPresence"
