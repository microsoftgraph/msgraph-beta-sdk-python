...
record_post_request_body = lazy_import('msgraph.generated.communications.calls.item.record.record_post_request_body')
...
class RecordRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[record_post_request_body.RecordPostRequestBody] = None, request_configuration: Optional[RecordRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
