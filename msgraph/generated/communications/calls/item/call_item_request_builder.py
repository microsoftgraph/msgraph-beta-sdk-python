...
microsoft_graph_add_large_gallery_view_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_add_large_gallery_view.microsoft_graph_add_large_gallery_view_request_builder')
microsoft_graph_answer_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_answer.microsoft_graph_answer_request_builder')
microsoft_graph_cancel_media_processing_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_cancel_media_processing.microsoft_graph_cancel_media_processing_request_builder')
microsoft_graph_change_screen_sharing_role_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_change_screen_sharing_role.microsoft_graph_change_screen_sharing_role_request_builder')
microsoft_graph_keep_alive_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_keep_alive.microsoft_graph_keep_alive_request_builder')
microsoft_graph_mute_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_mute.microsoft_graph_mute_request_builder')
microsoft_graph_play_prompt_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_play_prompt.microsoft_graph_play_prompt_request_builder')
microsoft_graph_record_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_record.microsoft_graph_record_request_builder')
microsoft_graph_record_response_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_record_response.microsoft_graph_record_response_request_builder')
microsoft_graph_redirect_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_redirect.microsoft_graph_redirect_request_builder')
microsoft_graph_reject_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_reject.microsoft_graph_reject_request_builder')
microsoft_graph_subscribe_to_tone_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_subscribe_to_tone.microsoft_graph_subscribe_to_tone_request_builder')
microsoft_graph_transfer_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_transfer.microsoft_graph_transfer_request_builder')
microsoft_graph_unmute_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_unmute.microsoft_graph_unmute_request_builder')
microsoft_graph_update_recording_status_request_builder = lazy_import('msgraph.generated.communications.calls.item.microsoft_graph_update_recording_status.microsoft_graph_update_recording_status_request_builder')
