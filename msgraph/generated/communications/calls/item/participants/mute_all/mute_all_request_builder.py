...
mute_all_post_request_body = lazy_import('msgraph.generated.communications.calls.item.participants.mute_all.mute_all_post_request_body')
...
class MuteAllRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[mute_all_post_request_body.MuteAllPostRequestBody] = None, request_configuration: Optional[MuteAllRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
