...
mute_all_post_request_body = lazy_import('msgraph.generated.communications.calls.item.participants.microsoft_graph_mute_all.mute_all_post_request_body')
mute_participants_operation = lazy_import('msgraph.generated.models.mute_participants_operation')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class MuteAllRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/communications/calls/{call%2Did}/participants/microsoft.graph.muteAll"
    ...
    @dataclass
    class MuteAllRequestBuilderPostRequestConfiguration():
        """
