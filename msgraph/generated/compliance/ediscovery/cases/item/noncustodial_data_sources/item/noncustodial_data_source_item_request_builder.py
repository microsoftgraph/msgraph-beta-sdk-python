...
apply_hold_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.noncustodial_data_sources.item.microsoft_graph_ediscovery_apply_hold.apply_hold_request_builder')
release_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.noncustodial_data_sources.item.microsoft_graph_ediscovery_release.release_request_builder')
remove_hold_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.noncustodial_data_sources.item.microsoft_graph_ediscovery_remove_hold.remove_hold_request_builder')
update_index_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.noncustodial_data_sources.item.microsoft_graph_ediscovery_update_index.update_index_request_builder')
...
class NoncustodialDataSourceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_ediscovery_apply_hold(self) -> apply_hold_request_builder.ApplyHoldRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_ediscovery_release(self) -> release_request_builder.ReleaseRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_ediscovery_remove_hold(self) -> remove_hold_request_builder.RemoveHoldRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_ediscovery_update_index(self) -> update_index_request_builder.UpdateIndexRequestBuilder:
        """
