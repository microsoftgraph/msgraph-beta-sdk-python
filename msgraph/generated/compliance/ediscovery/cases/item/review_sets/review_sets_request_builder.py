...
count_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.count.count_request_builder')
review_set = lazy_import('msgraph.generated.models.ediscovery.review_set')
review_set_collection_response = lazy_import('msgraph.generated.models.ediscovery.review_set_collection_response')
...
class ReviewSetsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[review_set.ReviewSet] = None, request_configuration: Optional[ReviewSetsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[ReviewSetsRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[review_set_collection_response.ReviewSetCollectionResponse]:
        """
        Returns a list of reviewSet objects in the case. Read-only. Nullable.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        return await self.request_adapter.send_async(request_info, review_set_collection_response.ReviewSetCollectionResponse, response_handler, error_mapping)
    
    async def post(self,body: Optional[review_set.ReviewSet] = None, request_configuration: Optional[ReviewSetsRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[review_set.ReviewSet]:
        """
        Create a new reviewSet object. The request body contains the display name of the review set, which is the only writable property.
        Args:
            body: The request body
    ...
    @dataclass
    class ReviewSetsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
