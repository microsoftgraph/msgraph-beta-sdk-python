...
count_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.queries.count.count_request_builder')
review_set_query = lazy_import('msgraph.generated.models.ediscovery.review_set_query')
review_set_query_collection_response = lazy_import('msgraph.generated.models.ediscovery.review_set_query_collection_response')
...
class QueriesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[review_set_query.ReviewSetQuery] = None, request_configuration: Optional[QueriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
