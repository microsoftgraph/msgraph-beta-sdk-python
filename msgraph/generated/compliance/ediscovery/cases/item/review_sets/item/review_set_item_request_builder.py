...
microsoft_graph_ediscovery_add_to_review_set_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.microsoft_graph_ediscovery_add_to_review_set.microsoft_graph_ediscovery_add_to_review_set_request_builder')
microsoft_graph_ediscovery_export_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.microsoft_graph_ediscovery_export.microsoft_graph_ediscovery_export_request_builder')
