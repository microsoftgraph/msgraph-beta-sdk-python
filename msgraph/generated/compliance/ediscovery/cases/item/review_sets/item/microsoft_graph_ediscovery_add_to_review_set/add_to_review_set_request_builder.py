...
add_to_review_set_post_request_body = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.microsoft_graph_ediscovery_add_to_review_set.add_to_review_set_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class AddToReviewSetRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets/{reviewSet%2Did}/microsoft.graph.ediscovery.addToReviewSet"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,body: Optional[add_to_review_set_post_request_body.AddToReviewSetPostRequestBody] = None, request_configuration: Optional[AddToReviewSetRequestBuilderPostRequestConfiguration] = None) -> None:
        """
