...
ediscovery_apply_tags_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.queries.item.ediscovery_apply_tags.ediscovery_apply_tags_request_builder')
