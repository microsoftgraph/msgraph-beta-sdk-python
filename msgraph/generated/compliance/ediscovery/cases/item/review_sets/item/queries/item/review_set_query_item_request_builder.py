...
apply_tags_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.queries.item.microsoft_graph_ediscovery_apply_tags.apply_tags_request_builder')
...
class ReviewSetQueryItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_ediscovery_apply_tags(self) -> apply_tags_request_builder.ApplyTagsRequestBuilder:
        """
        Provides operations to call the applyTags method.
        """
        return apply_tags_request_builder.ApplyTagsRequestBuilder(self.request_adapter, self.path_parameters)
    
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, review_set_query_id: Optional[str] = None) -> None:
        """
        Instantiates a new ReviewSetQueryItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            reviewSetQueryId: key: id of reviewSetQuery
        """
        ...
        url_tpl_params["reviewSetQuery%2Did"] = reviewSetQueryId
