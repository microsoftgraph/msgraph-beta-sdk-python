...
microsoft_graph_ediscovery_apply_tags_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.review_sets.item.queries.item.microsoft_graph_ediscovery_apply_tags.microsoft_graph_ediscovery_apply_tags_request_builder')
