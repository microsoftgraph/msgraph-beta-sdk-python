...
class TagsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[tag.Tag] = None, request_configuration: Optional[TagsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
