...
microsoft_graph_ediscovery_as_hierarchy_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.tags.microsoft_graph_ediscovery_as_hierarchy.microsoft_graph_ediscovery_as_hierarchy_request_builder')
...
class TagsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
