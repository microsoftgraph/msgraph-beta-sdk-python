...
count_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.user_sources.count.count_request_builder')
user_source = lazy_import('msgraph.generated.models.ediscovery.user_source')
user_source_collection_response = lazy_import('msgraph.generated.models.ediscovery.user_source_collection_response')
...
class UserSourcesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/userSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
