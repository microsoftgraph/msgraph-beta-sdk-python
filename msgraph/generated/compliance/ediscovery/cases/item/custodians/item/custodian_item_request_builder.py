...
activate_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.microsoft_graph_ediscovery_activate.activate_request_builder')
apply_hold_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.microsoft_graph_ediscovery_apply_hold.apply_hold_request_builder')
release_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.microsoft_graph_ediscovery_release.release_request_builder')
remove_hold_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.microsoft_graph_ediscovery_remove_hold.remove_hold_request_builder')
update_index_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.custodians.item.microsoft_graph_ediscovery_update_index.update_index_request_builder')
...
class CustodianItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_ediscovery_activate(self) -> activate_request_builder.ActivateRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, custodian_id: Optional[str] = None) -> None:
        """
        Instantiates a new CustodianItemRequestBuilder and sets the default values.
        Args:
            custodianId: key: id of custodian
        ...
        url_tpl_params["custodian%2Did"] = custodianId
