...
if TYPE_CHECKING:
    from ........models.ediscovery import case_index_operation
...
class LastIndexOperationRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[LastIndexOperationRequestBuilderGetRequestConfiguration] = None) -> Optional[case_index_operation.CaseIndexOperation]:
        """
        ...
        return await self.request_adapter.send_async(request_info, case_index_operation.CaseIndexOperation, error_mapping)
