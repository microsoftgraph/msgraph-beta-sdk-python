...
if TYPE_CHECKING:
    from ........models.ediscovery.case_index_operation import CaseIndexOperation
...
class LastIndexOperationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/lastIndexOperation{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[LastIndexOperationRequestBuilderGetRequestConfiguration] = None) -> Optional[CaseIndexOperation]:
        """
        Get lastIndexOperation from compliance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[CaseIndexOperation]
        """
        ...
        return await self.request_adapter.send_async(request_info, CaseIndexOperation, error_mapping)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> LastIndexOperationRequestBuilder:
        ...
        return LastIndexOperationRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class LastIndexOperationRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
