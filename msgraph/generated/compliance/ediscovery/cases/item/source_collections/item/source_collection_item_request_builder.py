...
estimate_statistics_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.source_collections.item.microsoft_graph_ediscovery_estimate_statistics.estimate_statistics_request_builder')
purge_data_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.source_collections.item.microsoft_graph_ediscovery_purge_data.purge_data_request_builder')
...
class SourceCollectionItemRequestBuilder():
    ...
    @property
    def microsoft_graph_ediscovery_estimate_statistics(self) -> estimate_statistics_request_builder.EstimateStatisticsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_ediscovery_purge_data(self) -> purge_data_request_builder.PurgeDataRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, source_collection_id: Optional[str] = None) -> None:
        """
        Instantiates a new SourceCollectionItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            sourceCollectionId: key: id of sourceCollection
        """
        ...
        url_tpl_params["sourceCollection%2Did"] = sourceCollectionId
