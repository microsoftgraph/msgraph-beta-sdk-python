...
if TYPE_CHECKING:
    from ........models.ediscovery.add_to_review_set_operation import AddToReviewSetOperation
    from ........models.o_data_errors.o_data_error import ODataError

class AddToReviewSetOperationRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/addToReviewSetOperation{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AddToReviewSetOperationRequestBuilderGetRequestConfiguration] = None) -> Optional[AddToReviewSetOperation]:
        ...
        return await self.request_adapter.send_async(request_info, AddToReviewSetOperation, error_mapping)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AddToReviewSetOperationRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AddToReviewSetOperationRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class AddToReviewSetOperationRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
