...
class EdiscoveryEstimateStatisticsRequestBuilder():
    """
    Provides operations to call the estimateStatistics method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new EdiscoveryEstimateStatisticsRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/ediscovery.estimateStatistics"
