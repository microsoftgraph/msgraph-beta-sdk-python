...
count_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.legal_holds.count.count_request_builder')
legal_hold = lazy_import('msgraph.generated.models.ediscovery.legal_hold')
legal_hold_collection_response = lazy_import('msgraph.generated.models.ediscovery.legal_hold_collection_response')
...
class LegalHoldsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[legal_hold.LegalHold] = None, request_configuration: Optional[LegalHoldsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
