...
group_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.cases.item.legal_holds.item.unified_group_sources.item.group.group_request_builder')
...
class UnifiedGroupSourceItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/unifiedGroupSources/{unifiedGroupSource%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[UnifiedGroupSourceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UnifiedGroupSourceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[unified_group_source.UnifiedGroupSource] = None, request_configuration: Optional[UnifiedGroupSourceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class UnifiedGroupSourceItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[UnifiedGroupSourceItemRequestBuilder.UnifiedGroupSourceItemRequestBuilderGetQueryParameters] = None
