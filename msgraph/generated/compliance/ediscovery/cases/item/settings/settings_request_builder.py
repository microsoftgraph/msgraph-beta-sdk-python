...
class SettingsRequestBuilder():
    ...
    def create_patch_request_information(self,body: Optional[case_settings.CaseSettings] = None, request_configuration: Optional[SettingsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
