...
ediscovery_request_builder = lazy_import('msgraph.generated.compliance.ediscovery.ediscovery_request_builder')
...
class ComplianceRequestBuilder():
    ...
    """
    @property
    def ediscovery(self) -> ediscovery_request_builder.EdiscoveryRequestBuilder:
        """
        Provides operations to manage the ediscovery property of the microsoft.graph.compliance entity.
        """
        return ediscovery_request_builder.EdiscoveryRequestBuilder(self.request_adapter, self.path_parameters)
