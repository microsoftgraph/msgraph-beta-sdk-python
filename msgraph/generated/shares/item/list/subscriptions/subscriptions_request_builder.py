...
count_request_builder = lazy_import('msgraph.generated.shares.item.list.subscriptions.count.count_request_builder')
...
class SubscriptionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
