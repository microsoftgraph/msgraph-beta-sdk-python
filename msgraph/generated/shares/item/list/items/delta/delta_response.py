...
if TYPE_CHECKING:
    from ......models import base_delta_function_response, list_item
...
class DeltaResponse(base_delta_function_response.BaseDeltaFunctionResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[list_item.ListItem]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(list_item.ListItem)),
        }
    ...
    @property
    def value(self,) -> Optional[List[list_item.ListItem]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[list_item.ListItem]] = None) -> None:
        """
