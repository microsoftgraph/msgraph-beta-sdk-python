...
microsoft_graph_create_link_request_builder = lazy_import('msgraph.generated.shares.item.list.items.item.microsoft_graph_create_link.microsoft_graph_create_link_request_builder')
