...
class AlertRuleItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, alert_rule_id: Optional[str] = None) -> None:
        """
        Instantiates a new AlertRuleItemRequestBuilder and sets the default values.
        Args:
            alertRuleId: key: id of alertRule
        ...
        url_tpl_params["alertRule%2Did"] = alertRuleId
    ...
    async def get(self,request_configuration: Optional[AlertRuleItemRequestBuilderGetRequestConfiguration] = None) -> Optional[alert_rule.AlertRule]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, alert_rule.AlertRule, error_mapping)
