...
alert_records_request_builder = lazy_import('msgraph.generated.monitoring.alert_records.alert_records_request_builder')
alert_record_item_request_builder = lazy_import('msgraph.generated.monitoring.alert_records.item.alert_record_item_request_builder')
alert_rules_request_builder = lazy_import('msgraph.generated.monitoring.alert_rules.alert_rules_request_builder')
alert_rule_item_request_builder = lazy_import('msgraph.generated.monitoring.alert_rules.item.alert_rule_item_request_builder')
...
class MonitoringRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/monitoring{?%24select,%24expand}"
