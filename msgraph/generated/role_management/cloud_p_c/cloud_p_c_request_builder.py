...
class CloudPCRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CloudPCRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CloudPCRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[rbac_application_multiple.RbacApplicationMultiple] = None, request_configuration: Optional[CloudPCRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
