...
inherits_permissions_from_request_builder = lazy_import('msgraph.generated.role_management.directory.role_definitions.item.inherits_permissions_from.inherits_permissions_from_request_builder')
unified_role_definition_item_request_builder = lazy_import('msgraph.generated.role_management.directory.role_definitions.item.inherits_permissions_from.item.unified_role_definition_item_request_builder')
microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder = lazy_import('msgraph.generated.role_management.directory.role_definitions.item.microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id.microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder')
...
class UnifiedRoleDefinitionItemRequestBuilder():
    ...
    def inherits_permissions_from(self) -> inherits_permissions_from_request_builder.InheritsPermissionsFromRequestBuilder:
        ...
        """
        return inherits_permissions_from_request_builder.InheritsPermissionsFromRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id(self) -> microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder.MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder:
        """
        Provides operations to call the assignedPrincipals method.
        """
        return microsoft_graph_assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder.MicrosoftGraphAssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[unified_role_definition.UnifiedRoleDefinition] = None, request_configuration: Optional[UnifiedRoleDefinitionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property roleDefinitions in roleManagement
        Args:
            body: The request body
