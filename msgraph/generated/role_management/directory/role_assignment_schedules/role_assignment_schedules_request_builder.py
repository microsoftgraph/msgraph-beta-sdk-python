...
count_request_builder = lazy_import('msgraph.generated.role_management.directory.role_assignment_schedules.count.count_request_builder')
filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.role_management.directory.role_assignment_schedules.filter_by_current_user_with_on.filter_by_current_user_with_on_request_builder')
...
class RoleAssignmentSchedulesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/directory/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[unified_role_assignment_schedule.UnifiedRoleAssignmentSchedule] = None, request_configuration: Optional[RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[RoleAssignmentSchedulesRequestBuilder.RoleAssignmentSchedulesRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
