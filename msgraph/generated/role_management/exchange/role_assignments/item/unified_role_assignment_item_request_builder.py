...
app_scope_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_assignments.item.app_scope.app_scope_request_builder')
directory_scope_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_assignments.item.directory_scope.directory_scope_request_builder')
principal_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_assignments.item.principal.principal_request_builder')
role_definition_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_assignments.item.role_definition.role_definition_request_builder')
...
class UnifiedRoleAssignmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}"
