...
class CustomAppScopeItemRequestBuilder():
    """
    ...
    @dataclass
    class CustomAppScopeItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class CustomAppScopeItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class CustomAppScopeItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
