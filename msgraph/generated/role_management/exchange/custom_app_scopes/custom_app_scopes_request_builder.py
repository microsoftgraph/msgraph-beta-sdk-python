...
if TYPE_CHECKING:
    ...
    from ....models.custom_app_scope_collection_response import CustomAppScopeCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.custom_app_scope_item_request_builder import CustomAppScopeItemRequestBuilder

class CustomAppScopesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/roleManagement/exchange/customAppScopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_custom_app_scope_id(self,custom_app_scope_id: str) -> CustomAppScopeItemRequestBuilder:
        """
        Provides operations to manage the customAppScopes property of the microsoft.graph.unifiedRbacApplication entity.
        param custom_app_scope_id: The unique identifier of customAppScope
    ...
    async def post(self,body: Optional[CustomAppScope] = None, request_configuration: Optional[CustomAppScopesRequestBuilderPostRequestConfiguration] = None) -> Optional[CustomAppScope]:
        """
        Create a new customAppScope object for an RBAC provider. Currently only the Exchange Online RBAC provider is supported. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CustomAppScopesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CustomAppScopesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return CustomAppScopesRequestBuilder(self.request_adapter, raw_url)
