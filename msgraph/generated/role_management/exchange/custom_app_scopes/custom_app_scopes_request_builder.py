...
if TYPE_CHECKING:
    from ....models import custom_app_scope, custom_app_scope_collection_response
    from ....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import custom_app_scope_item_request_builder

class CustomAppScopesRequestBuilder():
    """
    ...
    def by_custom_app_scope_id(self,custom_app_scope_id: str) -> custom_app_scope_item_request_builder.CustomAppScopeItemRequestBuilder:
        """
        Provides operations to manage the customAppScopes property of the microsoft.graph.unifiedRbacApplication entity.
        Args:
        ...
        return custom_app_scope_item_request_builder.CustomAppScopeItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[CustomAppScopesRequestBuilderGetRequestConfiguration] = None) -> Optional[custom_app_scope_collection_response.CustomAppScopeCollectionResponse]:
        ...
        from ....models import custom_app_scope_collection_response

        return await self.request_adapter.send_async(request_info, custom_app_scope_collection_response.CustomAppScopeCollectionResponse, error_mapping)
    ...
    async def post(self,body: Optional[custom_app_scope.CustomAppScope] = None, request_configuration: Optional[CustomAppScopesRequestBuilderPostRequestConfiguration] = None) -> Optional[custom_app_scope.CustomAppScope]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ....models import custom_app_scope

        return await self.request_adapter.send_async(request_info, custom_app_scope.CustomAppScope, error_mapping)
    ...
    @dataclass
    class CustomAppScopesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class CustomAppScopesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
