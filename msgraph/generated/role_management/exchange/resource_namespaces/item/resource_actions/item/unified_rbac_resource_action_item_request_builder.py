...
resource_scope_request_builder = lazy_import('msgraph.generated.role_management.exchange.resource_namespaces.item.resource_actions.item.resource_scope.resource_scope_request_builder')
...
class UnifiedRbacResourceActionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}"
