...
import_resource_actions_request_builder = lazy_import('msgraph.generated.role_management.exchange.resource_namespaces.item.import_resource_actions.import_resource_actions_request_builder')
resource_actions_request_builder = lazy_import('msgraph.generated.role_management.exchange.resource_namespaces.item.resource_actions.resource_actions_request_builder')
unified_rbac_resource_action_item_request_builder = lazy_import('msgraph.generated.role_management.exchange.resource_namespaces.item.resource_actions.item.unified_rbac_resource_action_item_request_builder')
...
class UnifiedRbacResourceNamespaceItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/exchange/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}"
