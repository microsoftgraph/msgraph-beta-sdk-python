...
assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_definitions.item.assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id.assigned_principals_with_transitivedirectory_scope_type_directory_scope_type_directory_scope_id_directory_scope_id_request_builder')
inherits_permissions_from_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_definitions.item.inherits_permissions_from.inherits_permissions_from_request_builder')
unified_role_definition_item_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_definitions.item.inherits_permissions_from.item.unified_role_definition_item_request_builder')
...
class UnifiedRoleDefinitionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}"
