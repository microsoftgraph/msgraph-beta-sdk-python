...
count_request_builder = lazy_import('msgraph.generated.role_management.exchange.role_definitions.item.inherits_permissions_from.count.count_request_builder')
...
class InheritsPermissionsFromRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
