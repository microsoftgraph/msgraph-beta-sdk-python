...
unified_role_eligibility_schedule_collection_response = lazy_import('msgraph.generated.models.unified_role_eligibility_schedule_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_eligibility_schedules.count.count_request_builder')
filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_eligibility_schedules.filter_by_current_user_with_on.filter_by_current_user_with_on_request_builder')
...
class RoleEligibilitySchedulesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[RoleEligibilitySchedulesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[unified_role_eligibility_schedule.UnifiedRoleEligibilitySchedule] = None, request_configuration: Optional[RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class RoleEligibilitySchedulesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
