...
class InheritsPermissionsFromRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[unified_role_definition.UnifiedRoleDefinition] = None, request_configuration: Optional[InheritsPermissionsFromRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to inheritsPermissionsFrom for roleManagement
        Args:
            body: The request body
