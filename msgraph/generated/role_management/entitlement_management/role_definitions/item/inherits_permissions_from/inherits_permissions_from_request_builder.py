...
class InheritsPermissionsFromRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[InheritsPermissionsFromRequestBuilderGetRequestConfiguration] = None) -> Optional[unified_role_definition_collection_response.UnifiedRoleDefinitionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, unified_role_definition_collection_response.UnifiedRoleDefinitionCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[unified_role_definition.UnifiedRoleDefinition] = None, request_configuration: Optional[InheritsPermissionsFromRequestBuilderPostRequestConfiguration] = None) -> Optional[unified_role_definition.UnifiedRoleDefinition]:
        """
