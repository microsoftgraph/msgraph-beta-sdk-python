...
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_assignment_approvals.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
...
class RoleAssignmentApprovalsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RoleAssignmentApprovalsRequestBuilderGetRequestConfiguration] = None) -> Optional[approval_collection_response.ApprovalCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[approval.Approval] = None, request_configuration: Optional[RoleAssignmentApprovalsRequestBuilderPostRequestConfiguration] = None) -> Optional[approval.Approval]:
        """
