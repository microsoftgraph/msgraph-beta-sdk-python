...
filter_by_current_user_with_on_response = lazy_import('msgraph.generated.role_management.entitlement_management.role_assignment_approvals.filter_by_current_user_with_on.filter_by_current_user_with_on_response')
...
class FilterByCurrentUserWithOnRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, on: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentApprovals/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
