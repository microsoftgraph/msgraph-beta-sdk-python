...
count_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_assignment_approvals.item.steps.count.count_request_builder')
