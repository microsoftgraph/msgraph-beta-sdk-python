...
count_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.resource_namespaces.item.resource_actions.count.count_request_builder')
