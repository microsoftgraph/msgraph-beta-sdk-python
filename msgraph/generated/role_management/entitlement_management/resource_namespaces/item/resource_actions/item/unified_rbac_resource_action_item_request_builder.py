...
class UnifiedRbacResourceActionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, unified_rbac_resource_action_id: Optional[str] = None) -> None:
        """
        Instantiates a new UnifiedRbacResourceActionItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            unifiedRbacResourceActionId: key: id of unifiedRbacResourceAction
        """
        ...
        url_tpl_params["unifiedRbacResourceAction%2Did"] = unifiedRbacResourceActionId
