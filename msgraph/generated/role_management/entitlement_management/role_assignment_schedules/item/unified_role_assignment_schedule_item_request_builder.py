...
activated_using_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_assignment_schedules.item.activated_using.activated_using_request_builder')
...
class UnifiedRoleAssignmentScheduleItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, unified_role_assignment_schedule_id: Optional[str] = None) -> None:
        """
        ...
        Args:
            ...
            unifiedRoleAssignmentScheduleId: key: id of unifiedRoleAssignmentSchedule
        """
        ...
        self.url_template: str = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["unifiedRoleAssignmentSchedule%2Did"] = unifiedRoleAssignmentScheduleId
    ...
    async def patch(self,body: Optional[unified_role_assignment_schedule.UnifiedRoleAssignmentSchedule] = None, request_configuration: Optional[UnifiedRoleAssignmentScheduleItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[unified_role_assignment_schedule.UnifiedRoleAssignmentSchedule]:
        """
    ...
    def to_patch_request_information(self,body: Optional[unified_role_assignment_schedule.UnifiedRoleAssignmentSchedule] = None, request_configuration: Optional[UnifiedRoleAssignmentScheduleItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property roleAssignmentSchedules in roleManagement
        Args:
            body: The request body
    ...
    @dataclass
    class UnifiedRoleAssignmentScheduleItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
