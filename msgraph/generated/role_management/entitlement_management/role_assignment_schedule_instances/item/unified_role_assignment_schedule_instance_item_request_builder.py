...
activated_using_request_builder = lazy_import('msgraph.generated.role_management.entitlement_management.role_assignment_schedule_instances.item.activated_using.activated_using_request_builder')
