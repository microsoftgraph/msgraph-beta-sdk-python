...
unified_rbac_resource_action_collection_response = lazy_import('msgraph.generated.models.unified_rbac_resource_action_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.role_management.device_management.resource_namespaces.item.resource_actions.count.count_request_builder')
...
class ResourceActionsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ResourceActionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[unified_rbac_resource_action.UnifiedRbacResourceAction] = None, request_configuration: Optional[ResourceActionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
