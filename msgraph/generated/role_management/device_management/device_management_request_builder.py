...
class DeviceManagementRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DeviceManagementRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[rbac_application_multiple.RbacApplicationMultiple] = None, request_configuration: Optional[DeviceManagementRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceManagement in roleManagement
        Args:
            body: The request body
