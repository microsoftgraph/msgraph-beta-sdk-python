...
class BrowserSharedCookieItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, browser_shared_cookie_id: Optional[str] = None) -> None:
        """
        Instantiates a new BrowserSharedCookieItemRequestBuilder and sets the default values.
        Args:
            browserSharedCookieId: key: id of browserSharedCookie
        ...
        url_tpl_params["browserSharedCookie%2Did"] = browserSharedCookieId
