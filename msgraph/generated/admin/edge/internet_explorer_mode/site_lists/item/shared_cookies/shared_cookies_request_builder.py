...
count_request_builder = lazy_import('msgraph.generated.admin.edge.internet_explorer_mode.site_lists.item.shared_cookies.count.count_request_builder')
browser_shared_cookie = lazy_import('msgraph.generated.models.browser_shared_cookie')
browser_shared_cookie_collection_response = lazy_import('msgraph.generated.models.browser_shared_cookie_collection_response')
...
class SharedCookiesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SharedCookiesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[browser_shared_cookie.BrowserSharedCookie] = None, request_configuration: Optional[SharedCookiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
