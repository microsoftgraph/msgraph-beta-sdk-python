...
class PublishRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[publish_post_request_body.PublishPostRequestBody] = None, request_configuration: Optional[PublishRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
