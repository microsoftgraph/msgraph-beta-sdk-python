...
count_request_builder = lazy_import('msgraph.generated.admin.edge.internet_explorer_mode.site_lists.item.sites.count.count_request_builder')
browser_site = lazy_import('msgraph.generated.models.browser_site')
browser_site_collection_response = lazy_import('msgraph.generated.models.browser_site_collection_response')
...
class SitesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[browser_site.BrowserSite] = None, request_configuration: Optional[SitesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class SitesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
