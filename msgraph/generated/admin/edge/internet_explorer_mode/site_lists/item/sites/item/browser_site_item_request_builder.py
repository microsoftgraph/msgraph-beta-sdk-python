...
class BrowserSiteItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, browser_site_id: Optional[str] = None) -> None:
        """
        Instantiates a new BrowserSiteItemRequestBuilder and sets the default values.
        Args:
            browserSiteId: key: id of browserSite
        ...
        url_tpl_params["browserSite%2Did"] = browserSiteId
