...
class ReportSettingsRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ReportSettingsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ReportSettingsRequestBuilderGetRequestConfiguration] = None) -> Optional[admin_report_settings.AdminReportSettings]:
        ...
        return await self.request_adapter.send_async(request_info, admin_report_settings.AdminReportSettings, error_mapping)
