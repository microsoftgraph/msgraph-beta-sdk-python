...
class UpdateAudiencePostRequestBody(AdditionalDataHolder, Parsable):
    ...
    add_exclusions: Optional[List[updatable_asset.UpdatableAsset]] = None
    # The addMembers property
    add_members: Optional[List[updatable_asset.UpdatableAsset]] = None
    # The removeExclusions property
    remove_exclusions: Optional[List[updatable_asset.UpdatableAsset]] = None
    # The removeMembers property
    remove_members: Optional[List[updatable_asset.UpdatableAsset]] = None
