...
exclusions_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.exclusions_request_builder')
updatable_asset_item_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.updatable_asset_item_request_builder')
members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.members_request_builder')
updatable_asset_item_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.item.updatable_asset_item_request_builder')
update_audience_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.microsoft_graph_windows_updates_update_audience.update_audience_request_builder')
update_audience_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.microsoft_graph_windows_updates_update_audience_by_id.update_audience_by_id_request_builder')
...
class DeploymentAudienceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_windows_updates_update_audience(self) -> update_audience_request_builder.UpdateAudienceRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_windows_updates_update_audience_by_id(self) -> update_audience_by_id_request_builder.UpdateAudienceByIdRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, deployment_audience_id: Optional[str] = None) -> None:
        """
        Instantiates a new DeploymentAudienceItemRequestBuilder and sets the default values.
        Args:
            deploymentAudienceId: key: id of deploymentAudience
        ...
        url_tpl_params["deploymentAudience%2Did"] = deploymentAudienceId
