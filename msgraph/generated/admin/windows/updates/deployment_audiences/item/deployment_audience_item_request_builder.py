...
microsoft_graph_windows_updates_update_audience_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.microsoft_graph_windows_updates_update_audience.microsoft_graph_windows_updates_update_audience_request_builder')
microsoft_graph_windows_updates_update_audience_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.microsoft_graph_windows_updates_update_audience_by_id.microsoft_graph_windows_updates_update_audience_by_id_request_builder')
