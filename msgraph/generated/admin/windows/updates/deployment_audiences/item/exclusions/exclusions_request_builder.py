...
enroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.microsoft_graph_windows_updates_enroll_assets.enroll_assets_request_builder')
enroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.microsoft_graph_windows_updates_enroll_assets_by_id.enroll_assets_by_id_request_builder')
unenroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.microsoft_graph_windows_updates_unenroll_assets.unenroll_assets_request_builder')
unenroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.microsoft_graph_windows_updates_unenroll_assets_by_id.unenroll_assets_by_id_request_builder')
