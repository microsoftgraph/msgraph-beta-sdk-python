...
microsoft_graph_windows_updates_add_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.microsoft_graph_windows_updates_add_members.microsoft_graph_windows_updates_add_members_request_builder')
microsoft_graph_windows_updates_add_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.microsoft_graph_windows_updates_add_members_by_id.microsoft_graph_windows_updates_add_members_by_id_request_builder')
microsoft_graph_windows_updates_remove_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.microsoft_graph_windows_updates_remove_members.microsoft_graph_windows_updates_remove_members_request_builder')
microsoft_graph_windows_updates_remove_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.microsoft_graph_windows_updates_remove_members_by_id.microsoft_graph_windows_updates_remove_members_by_id_request_builder')
...
class UpdatableAssetItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/{updatableAsset%2Did}{?%24select,%24expand}"
