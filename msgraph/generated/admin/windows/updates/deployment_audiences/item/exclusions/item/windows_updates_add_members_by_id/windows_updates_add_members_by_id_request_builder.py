...
add_members_by_id_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.exclusions.item.windows_updates_add_members_by_id.add_members_by_id_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class WindowsUpdatesAddMembersByIdRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/{updatableAsset%2Did}/windowsUpdates.addMembersById"
    ...
    @dataclass
    class WindowsUpdatesAddMembersByIdRequestBuilderPostRequestConfiguration():
        """
