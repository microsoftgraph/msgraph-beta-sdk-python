...
class MicrosoftGraphWindowsUpdatesRemoveMembersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.removeMembers", path_parameters)
    ...
    async def post(self,body: Optional[RemoveMembersPostRequestBody] = None, request_configuration: Optional[MicrosoftGraphWindowsUpdatesRemoveMembersRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        Remove members from an updatableAssetGroup. You can also use the method removeMembersById to remove members. This API is supported in the following national cloud deployments.
