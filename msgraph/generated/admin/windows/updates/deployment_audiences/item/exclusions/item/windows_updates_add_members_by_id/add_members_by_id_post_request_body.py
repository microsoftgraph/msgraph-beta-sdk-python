...
class AddMembersByIdPostRequestBody(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AddMembersByIdPostRequestBody:
        """
        ...
        return AddMembersByIdPostRequestBody()
    ...
    def member_entity_type(self,value: Optional[str] = None) -> None:
        ...
        Args:
            value: Value to set for the member_entity_type property.
        """
