...
update_audience_by_id_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.windows_updates_update_audience_by_id.update_audience_by_id_post_request_body')
...
class WindowsUpdatesUpdateAudienceByIdRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/windowsUpdates.updateAudienceById"
