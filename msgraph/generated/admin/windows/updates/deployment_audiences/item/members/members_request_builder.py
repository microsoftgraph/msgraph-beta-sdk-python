...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.count.count_request_builder')
microsoft_graph_windows_updates_enroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.microsoft_graph_windows_updates_enroll_assets.microsoft_graph_windows_updates_enroll_assets_request_builder')
microsoft_graph_windows_updates_enroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.microsoft_graph_windows_updates_enroll_assets_by_id.microsoft_graph_windows_updates_enroll_assets_by_id_request_builder')
microsoft_graph_windows_updates_unenroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.microsoft_graph_windows_updates_unenroll_assets.microsoft_graph_windows_updates_unenroll_assets_request_builder')
microsoft_graph_windows_updates_unenroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.microsoft_graph_windows_updates_unenroll_assets_by_id.microsoft_graph_windows_updates_unenroll_assets_by_id_request_builder')
...
class MembersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
