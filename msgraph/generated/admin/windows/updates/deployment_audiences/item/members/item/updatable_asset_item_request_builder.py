...
add_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.item.microsoft_graph_windows_updates_add_members.add_members_request_builder')
add_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.item.microsoft_graph_windows_updates_add_members_by_id.add_members_by_id_request_builder')
remove_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.item.microsoft_graph_windows_updates_remove_members.remove_members_request_builder')
remove_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployment_audiences.item.members.item.microsoft_graph_windows_updates_remove_members_by_id.remove_members_by_id_request_builder')
...
class UpdatableAssetItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_windows_updates_add_members(self) -> add_members_request_builder.AddMembersRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_windows_updates_add_members_by_id(self) -> add_members_by_id_request_builder.AddMembersByIdRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_windows_updates_remove_members(self) -> remove_members_request_builder.RemoveMembersRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_windows_updates_remove_members_by_id(self) -> remove_members_by_id_request_builder.RemoveMembersByIdRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, updatable_asset_id: Optional[str] = None) -> None:
        """
        Instantiates a new UpdatableAssetItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            updatableAssetId: key: id of updatableAsset
        """
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["updatableAsset%2Did"] = updatableAssetId
