...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.catalog.entries.count.count_request_builder')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
catalog_entry = lazy_import('msgraph.generated.models.windows_updates.catalog_entry')
catalog_entry_collection_response = lazy_import('msgraph.generated.models.windows_updates.catalog_entry_collection_response')
...
class EntriesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[EntriesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[catalog_entry.CatalogEntry] = None, request_configuration: Optional[EntriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class EntriesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
