...
class CatalogEntryItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[CatalogEntryItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[catalog_entry.CatalogEntry] = None, request_configuration: Optional[CatalogEntryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property entries in admin
        Args:
            body: The request body
