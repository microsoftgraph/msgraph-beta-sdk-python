...
update_policy_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.compliance_changes.item.update_policy.update_policy_request_builder')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
compliance_change = lazy_import('msgraph.generated.models.windows_updates.compliance_change')

class ComplianceChangeItemRequestBuilder():
    """
    Provides operations to manage the complianceChanges property of the microsoft.graph.windowsUpdates.updatePolicy entity.
    """
    @property
    def update_policy(self) -> update_policy_request_builder.UpdatePolicyRequestBuilder:
        """
        Provides operations to manage the updatePolicy property of the microsoft.graph.windowsUpdates.complianceChange entity.
        """
        return update_policy_request_builder.UpdatePolicyRequestBuilder(self.request_adapter, self.path_parameters)
    
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, compliance_change_id: Optional[str] = None) -> None:
        """
        Instantiates a new ComplianceChangeItemRequestBuilder and sets the default values.
        Args:
            complianceChangeId: key: id of complianceChange
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges/{complianceChange%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["complianceChange%2Did"] = complianceChangeId
    ...
    @dataclass
    class ComplianceChangeItemRequestBuilderDeleteRequestConfiguration():
        """
