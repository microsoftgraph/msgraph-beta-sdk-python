...
if TYPE_CHECKING:
    ...
    from .update_policy import update_policy_request_builder
...
class ComplianceChangeItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ComplianceChangeItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
