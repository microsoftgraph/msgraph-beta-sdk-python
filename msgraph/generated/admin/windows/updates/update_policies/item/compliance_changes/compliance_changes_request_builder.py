...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.compliance_changes.count.count_request_builder')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
compliance_change = lazy_import('msgraph.generated.models.windows_updates.compliance_change')
compliance_change_collection_response = lazy_import('msgraph.generated.models.windows_updates.compliance_change_collection_response')
