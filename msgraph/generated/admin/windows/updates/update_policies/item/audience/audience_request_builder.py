...
exclusions_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.exclusions_request_builder')
updatable_asset_item_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.item.updatable_asset_item_request_builder')
members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.members_request_builder')
updatable_asset_item_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.item.updatable_asset_item_request_builder')
windows_updates_update_audience_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.windows_updates_update_audience.windows_updates_update_audience_request_builder')
windows_updates_update_audience_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.windows_updates_update_audience_by_id.windows_updates_update_audience_by_id_request_builder')
