...
windows_updates_add_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.item.windows_updates_add_members.windows_updates_add_members_request_builder')
windows_updates_add_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.item.windows_updates_add_members_by_id.windows_updates_add_members_by_id_request_builder')
windows_updates_remove_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.item.windows_updates_remove_members.windows_updates_remove_members_request_builder')
windows_updates_remove_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.item.windows_updates_remove_members_by_id.windows_updates_remove_members_by_id_request_builder')
...
class UpdatableAssetItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/members/{updatableAsset%2Did}{?%24select,%24expand}"
