...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.count.count_request_builder')
windows_updates_enroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.windows_updates_enroll_assets.windows_updates_enroll_assets_request_builder')
windows_updates_enroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.windows_updates_enroll_assets_by_id.windows_updates_enroll_assets_by_id_request_builder')
windows_updates_unenroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.windows_updates_unenroll_assets.windows_updates_unenroll_assets_request_builder')
windows_updates_unenroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.windows_updates_unenroll_assets_by_id.windows_updates_unenroll_assets_by_id_request_builder')
...
class ExclusionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def post(self,body: Optional[updatable_asset.UpdatableAsset] = None, request_configuration: Optional[ExclusionsRequestBuilderPostRequestConfiguration] = None) -> Optional[updatable_asset.UpdatableAsset]:
        """
    ...
    def to_post_request_information(self,body: Optional[updatable_asset.UpdatableAsset] = None, request_configuration: Optional[ExclusionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to exclusions for admin
        Args:
            body: The request body
