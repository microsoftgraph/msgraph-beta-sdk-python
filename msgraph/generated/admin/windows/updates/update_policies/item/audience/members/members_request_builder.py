...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.count.count_request_builder')
windows_updates_enroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.windows_updates_enroll_assets.windows_updates_enroll_assets_request_builder')
windows_updates_enroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.windows_updates_enroll_assets_by_id.windows_updates_enroll_assets_by_id_request_builder')
windows_updates_unenroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.windows_updates_unenroll_assets.windows_updates_unenroll_assets_request_builder')
windows_updates_unenroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.members.windows_updates_unenroll_assets_by_id.windows_updates_unenroll_assets_by_id_request_builder')
