...
add_members_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.exclusions.item.windows_updates_add_members.add_members_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class WindowsUpdatesAddMembersRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/exclusions/{updatableAsset%2Did}/windowsUpdates.addMembers"
