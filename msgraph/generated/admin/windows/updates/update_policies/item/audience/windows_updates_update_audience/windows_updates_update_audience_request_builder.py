...
update_audience_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.windows_updates_update_audience.update_audience_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class WindowsUpdatesUpdateAudienceRequestBuilder():
    """
    Provides operations to call the updateAudience method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new WindowsUpdatesUpdateAudienceRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/windowsUpdates.updateAudience"
    ...
    @dataclass
    class WindowsUpdatesUpdateAudienceRequestBuilderPostRequestConfiguration():
        """
