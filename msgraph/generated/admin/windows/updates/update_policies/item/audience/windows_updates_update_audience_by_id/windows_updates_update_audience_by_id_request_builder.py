...
update_audience_by_id_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.update_policies.item.audience.windows_updates_update_audience_by_id.update_audience_by_id_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class WindowsUpdatesUpdateAudienceByIdRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/audience/windowsUpdates.updateAudienceById"
    ...
    @dataclass
    class WindowsUpdatesUpdateAudienceByIdRequestBuilderPostRequestConfiguration():
        """
