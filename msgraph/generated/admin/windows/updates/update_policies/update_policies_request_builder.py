...
count_request_builder = lazy_import('msgraph.generated.admin.windows.updates.update_policies.count.count_request_builder')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
update_policy = lazy_import('msgraph.generated.models.windows_updates.update_policy')
update_policy_collection_response = lazy_import('msgraph.generated.models.windows_updates.update_policy_collection_response')
...
class UpdatePoliciesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[UpdatePoliciesRequestBuilderGetRequestConfiguration] = None) -> Optional[update_policy_collection_response.UpdatePolicyCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, update_policy_collection_response.UpdatePolicyCollectionResponse, error_mapping)
