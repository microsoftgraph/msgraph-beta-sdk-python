...
add_members_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.updatable_assets.item.windows_updates_add_members.add_members_post_request_body')
...
class WindowsUpdatesAddMembersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/updatableAssets/{updatableAsset%2Did}/windowsUpdates.addMembers"
