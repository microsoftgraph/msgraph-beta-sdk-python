...
class ResourceConnectionItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ResourceConnectionItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[resource_connection.ResourceConnection] = None, request_configuration: Optional[ResourceConnectionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property resourceConnections in admin
        Args:
            body: The request body
