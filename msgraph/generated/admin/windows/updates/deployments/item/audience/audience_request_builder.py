...
update_audience_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.microsoft_graph_windows_updates_update_audience.update_audience_request_builder')
update_audience_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.microsoft_graph_windows_updates_update_audience_by_id.update_audience_by_id_request_builder')
