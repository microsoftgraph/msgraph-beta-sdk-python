...
microsoft_graph_windows_updates_enroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.microsoft_graph_windows_updates_enroll_assets.microsoft_graph_windows_updates_enroll_assets_request_builder')
microsoft_graph_windows_updates_enroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.microsoft_graph_windows_updates_enroll_assets_by_id.microsoft_graph_windows_updates_enroll_assets_by_id_request_builder')
microsoft_graph_windows_updates_unenroll_assets_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.microsoft_graph_windows_updates_unenroll_assets.microsoft_graph_windows_updates_unenroll_assets_request_builder')
microsoft_graph_windows_updates_unenroll_assets_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.microsoft_graph_windows_updates_unenroll_assets_by_id.microsoft_graph_windows_updates_unenroll_assets_by_id_request_builder')
