...
update_audience_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.microsoft_graph_windows_updates_update_audience.update_audience_post_request_body')
