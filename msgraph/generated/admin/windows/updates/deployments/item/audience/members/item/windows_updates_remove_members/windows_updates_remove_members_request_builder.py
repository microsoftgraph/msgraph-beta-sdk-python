...
remove_members_post_request_body = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.members.item.windows_updates_remove_members.remove_members_post_request_body')
...
class WindowsUpdatesRemoveMembersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/members/{updatableAsset%2Did}/windowsUpdates.removeMembers"
