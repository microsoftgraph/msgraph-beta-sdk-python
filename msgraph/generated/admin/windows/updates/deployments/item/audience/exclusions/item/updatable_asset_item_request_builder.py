...
microsoft_graph_windows_updates_add_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.item.microsoft_graph_windows_updates_add_members.microsoft_graph_windows_updates_add_members_request_builder')
microsoft_graph_windows_updates_add_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.item.microsoft_graph_windows_updates_add_members_by_id.microsoft_graph_windows_updates_add_members_by_id_request_builder')
microsoft_graph_windows_updates_remove_members_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.item.microsoft_graph_windows_updates_remove_members.microsoft_graph_windows_updates_remove_members_request_builder')
microsoft_graph_windows_updates_remove_members_by_id_request_builder = lazy_import('msgraph.generated.admin.windows.updates.deployments.item.audience.exclusions.item.microsoft_graph_windows_updates_remove_members_by_id.microsoft_graph_windows_updates_remove_members_by_id_request_builder')
