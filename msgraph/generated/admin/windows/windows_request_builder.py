...
class WindowsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[WindowsRequestBuilderGetRequestConfiguration] = None) -> Optional[windows.Windows]:
        """
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, windows.Windows, error_mapping)
    
    async def patch(self,body: Optional[windows.Windows] = None, request_configuration: Optional[WindowsRequestBuilderPatchRequestConfiguration] = None) -> Optional[windows.Windows]:
        """
