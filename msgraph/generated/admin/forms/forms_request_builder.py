...
if TYPE_CHECKING:
    from ...models.admin_forms import AdminForms
...
class FormsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/forms{?%24select,%24expand}", path_parameters)
    
    async def delete(self,request_configuration: Optional[FormsRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[FormsRequestBuilderGetRequestConfiguration] = None) -> Optional[AdminForms]:
        ...
        return await self.request_adapter.send_async(request_info, AdminForms, error_mapping)
    ...
    async def patch(self,body: Optional[AdminForms] = None, request_configuration: Optional[FormsRequestBuilderPatchRequestConfiguration] = None) -> Optional[AdminForms]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[AdminForms]
        Find more info here: https://learn.microsoft.com/graph/api/adminforms-update?view=graph-rest-1.0
        """
        if not body:
    ...
    def to_delete_request_information(self,request_configuration: Optional[FormsRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property forms for admin
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> FormsRequestBuilder:
        """
        ...
        return FormsRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class FormsRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class FormsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[FormsRequestBuilder.FormsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class FormsRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
