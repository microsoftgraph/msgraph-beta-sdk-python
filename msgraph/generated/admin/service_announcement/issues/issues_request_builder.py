...
count_request_builder = lazy_import('msgraph.generated.admin.service_announcement.issues.count.count_request_builder')
service_health_issue = lazy_import('msgraph.generated.models.service_health_issue')
service_health_issue_collection_response = lazy_import('msgraph.generated.models.service_health_issue_collection_response')
...
class IssuesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/serviceAnnouncement/issues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[IssuesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[service_health_issue.ServiceHealthIssue] = None, request_configuration: Optional[IssuesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
