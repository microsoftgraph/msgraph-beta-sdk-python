...
count_request_builder = lazy_import('msgraph.generated.admin.service_announcement.health_overviews.count.count_request_builder')
service_health = lazy_import('msgraph.generated.models.service_health')
service_health_collection_response = lazy_import('msgraph.generated.models.service_health_collection_response')
