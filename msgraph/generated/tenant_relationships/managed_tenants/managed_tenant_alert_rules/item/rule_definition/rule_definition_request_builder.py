...
class RuleDefinitionRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RuleDefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[managed_tenant_alert_rule_definition.ManagedTenantAlertRuleDefinition]:
        """
