...
apply_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.management_actions.item.microsoft_graph_managed_tenants_apply.apply_request_builder')
...
class ManagementActionItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_managed_tenants_apply(self) -> apply_request_builder.ApplyRequestBuilder:
        """
        Provides operations to call the apply method.
        """
        return apply_request_builder.ApplyRequestBuilder(self.request_adapter, self.path_parameters)
    
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, management_action_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagementActionItemRequestBuilder and sets the default values.
        Args:
            managementActionId: key: id of managementAction
        ...
        url_tpl_params["managementAction%2Did"] = managementActionId
