...
class ManagementActionItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ManagementActionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagementActionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[management_action.ManagementAction] = None, request_configuration: Optional[ManagementActionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
