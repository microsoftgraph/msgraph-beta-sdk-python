...
tenant_search_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.tenant_groups.microsoft_graph_managed_tenants_tenant_search.tenant_search_request_builder')
...
class TenantGroupsRequestBuilder():
    ...
    @property
    def microsoft_graph_managed_tenants_tenant_search(self) -> tenant_search_request_builder.TenantSearchRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/tenantGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[tenant_group.TenantGroup] = None, request_configuration: Optional[TenantGroupsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tenantGroups for tenantRelationships
        Args:
            body: The request body
    ...
    @dataclass
    class TenantGroupsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class TenantGroupsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
