...
class ResetTenantOnboardingStatusRequestBuilder():
    """
    ...
    def create_post_request_information(self,request_configuration: Optional[ResetTenantOnboardingStatusRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
