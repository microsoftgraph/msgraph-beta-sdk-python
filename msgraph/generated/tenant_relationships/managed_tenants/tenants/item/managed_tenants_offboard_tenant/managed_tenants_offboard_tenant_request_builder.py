...
class ManagedTenantsOffboardTenantRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/managedTenants.offboardTenant"
    ...
    @dataclass
    class ManagedTenantsOffboardTenantRequestBuilderPostRequestConfiguration():
        """
