...
class MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}/microsoft.graph.managedTenants.offboardTenant"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,request_configuration: Optional[MicrosoftGraphManagedTenantsOffboardTenantRequestBuilderPostRequestConfiguration] = None) -> Optional[tenant.Tenant]:
        """
    ...
    @dataclass
    class MicrosoftGraphManagedTenantsOffboardTenantRequestBuilderPostRequestConfiguration():
        """
