...
class OffboardTenantRequestBuilder():
    """
    ...
    def create_post_request_information(self,request_configuration: Optional[OffboardTenantRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class OffboardTenantRequestBuilderPostRequestConfiguration():
        """
