...
class TenantsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[tenant.Tenant] = None, request_configuration: Optional[TenantsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tenants for tenantRelationships
        Args:
            body: The request body
