...
class ManagedTenantAlertRuleDefinitionItemRequestBuilder():
    ...
    def alert_rules_by_id(self,id: str) -> Optional[managed_tenant_alert_rule_item_request_builder.ManagedTenantAlertRuleItemRequestBuilder]:
        """
        Provides operations to manage the alertRules property of the microsoft.graph.managedTenants.managedTenantAlertRuleDefinition entity.
        Args:
    ...
    def create_delete_request_information(self,request_configuration: Optional[ManagedTenantAlertRuleDefinitionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagedTenantAlertRuleDefinitionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[managed_tenant_alert_rule_definition.ManagedTenantAlertRuleDefinition] = None, request_configuration: Optional[ManagedTenantAlertRuleDefinitionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
