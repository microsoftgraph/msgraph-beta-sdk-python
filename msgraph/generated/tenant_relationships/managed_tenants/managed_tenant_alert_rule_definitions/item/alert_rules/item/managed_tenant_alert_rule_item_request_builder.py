...
class ManagedTenantAlertRuleItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, managed_tenant_alert_rule_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagedTenantAlertRuleItemRequestBuilder and sets the default values.
        Args:
            managedTenantAlertRuleId: key: id of managedTenantAlertRule
        ...
        url_tpl_params["managedTenantAlertRule%2Did"] = managedTenantAlertRuleId
