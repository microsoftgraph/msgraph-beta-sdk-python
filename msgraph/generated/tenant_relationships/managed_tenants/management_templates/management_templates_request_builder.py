...
class ManagementTemplatesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[management_template.ManagementTemplate] = None, request_configuration: Optional[ManagementTemplatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managementTemplates for tenantRelationships
        Args:
            body: The request body
