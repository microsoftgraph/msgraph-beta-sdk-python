...
class ManagementTemplatesRequestBuilder():
    ...
    async def post(self,body: Optional[management_template.ManagementTemplate] = None, request_configuration: Optional[ManagementTemplatesRequestBuilderPostRequestConfiguration] = None) -> Optional[management_template.ManagementTemplate]:
        """
