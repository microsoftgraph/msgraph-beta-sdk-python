...
count_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.management_templates.item.management_template_collections.count.count_request_builder')
