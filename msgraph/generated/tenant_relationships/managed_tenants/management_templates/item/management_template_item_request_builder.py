...
class ManagementTemplateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, management_template_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagementTemplateItemRequestBuilder and sets the default values.
        Args:
            managementTemplateId: key: id of managementTemplate
        ...
        url_tpl_params["managementTemplate%2Did"] = managementTemplateId
    ...
    async def patch(self,body: Optional[management_template.ManagementTemplate] = None, request_configuration: Optional[ManagementTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[management_template.ManagementTemplate]:
        """
    ...
    def to_patch_request_information(self,body: Optional[management_template.ManagementTemplate] = None, request_configuration: Optional[ManagementTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managementTemplates in tenantRelationships
        Args:
            body: The request body
