...
class ManagedTenantEmailNotificationItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[managed_tenant_email_notification.ManagedTenantEmailNotification] = None, request_configuration: Optional[ManagedTenantEmailNotificationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managedTenantEmailNotifications in tenantRelationships
        Args:
            body: The request body
