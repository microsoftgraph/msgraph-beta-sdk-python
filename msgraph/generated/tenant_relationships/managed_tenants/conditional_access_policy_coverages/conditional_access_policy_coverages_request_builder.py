...
class ConditionalAccessPolicyCoveragesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[conditional_access_policy_coverage.ConditionalAccessPolicyCoverage] = None, request_configuration: Optional[ConditionalAccessPolicyCoveragesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to conditionalAccessPolicyCoverages for tenantRelationships
        Args:
            body: The request body
