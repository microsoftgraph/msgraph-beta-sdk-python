...
class ConditionalAccessPolicyCoveragesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ConditionalAccessPolicyCoveragesRequestBuilderGetRequestConfiguration] = None) -> Optional[conditional_access_policy_coverage_collection_response.ConditionalAccessPolicyCoverageCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, conditional_access_policy_coverage_collection_response.ConditionalAccessPolicyCoverageCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[conditional_access_policy_coverage.ConditionalAccessPolicyCoverage] = None, request_configuration: Optional[ConditionalAccessPolicyCoveragesRequestBuilderPostRequestConfiguration] = None) -> Optional[conditional_access_policy_coverage.ConditionalAccessPolicyCoverage]:
        """
