...
class ConditionalAccessPolicyCoverageItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, conditional_access_policy_coverage_id: Optional[str] = None) -> None:
        """
        Instantiates a new ConditionalAccessPolicyCoverageItemRequestBuilder and sets the default values.
        Args:
            conditionalAccessPolicyCoverageId: key: id of conditionalAccessPolicyCoverage
        ...
        url_tpl_params["conditionalAccessPolicyCoverage%2Did"] = conditionalAccessPolicyCoverageId
    ...
    def to_patch_request_information(self,body: Optional[conditional_access_policy_coverage.ConditionalAccessPolicyCoverage] = None, request_configuration: Optional[ConditionalAccessPolicyCoverageItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property conditionalAccessPolicyCoverages in tenantRelationships
        Args:
            body: The request body
