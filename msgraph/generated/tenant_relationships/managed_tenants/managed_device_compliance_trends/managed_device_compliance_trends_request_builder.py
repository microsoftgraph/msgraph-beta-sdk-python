...
managed_device_compliance_trend_collection_response = lazy_import('msgraph.generated.models.managed_tenants.managed_device_compliance_trend_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.managed_device_compliance_trends.count.count_request_builder')
...
class ManagedDeviceComplianceTrendsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/managedDeviceComplianceTrends{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ManagedDeviceComplianceTrendsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[managed_device_compliance_trend.ManagedDeviceComplianceTrend] = None, request_configuration: Optional[ManagedDeviceComplianceTrendsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
