...
class ManagedDeviceComplianceTrendsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[managed_device_compliance_trend.ManagedDeviceComplianceTrend] = None, request_configuration: Optional[ManagedDeviceComplianceTrendsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedDeviceComplianceTrends for tenantRelationships
        Args:
            body: The request body
