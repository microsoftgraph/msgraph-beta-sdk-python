...
class ManagedTenantAlertLogsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[managed_tenant_alert_log.ManagedTenantAlertLog] = None, request_configuration: Optional[ManagedTenantAlertLogsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedTenantAlertLogs for tenantRelationships
        Args:
            body: The request body
