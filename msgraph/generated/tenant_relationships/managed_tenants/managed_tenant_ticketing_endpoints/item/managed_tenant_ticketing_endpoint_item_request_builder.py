...
class ManagedTenantTicketingEndpointItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ManagedTenantTicketingEndpointItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagedTenantTicketingEndpointItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[managed_tenant_ticketing_endpoint.ManagedTenantTicketingEndpoint] = None, request_configuration: Optional[ManagedTenantTicketingEndpointItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
