...
class ManagementTemplateStepItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, management_template_step_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagementTemplateStepItemRequestBuilder and sets the default values.
        Args:
            managementTemplateStepId: key: id of managementTemplateStep
        ...
        url_tpl_params["managementTemplateStep%2Did"] = managementTemplateStepId
