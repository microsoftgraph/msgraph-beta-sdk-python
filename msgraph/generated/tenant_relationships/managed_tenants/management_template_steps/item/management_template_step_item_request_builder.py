...
if TYPE_CHECKING:
    ...
    from .accepted_version.accepted_version_request_builder import AcceptedVersionRequestBuilder
    from .management_template.management_template_request_builder import ManagementTemplateRequestBuilder
    from .versions.versions_request_builder import VersionsRequestBuilder

class ManagementTemplateStepItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ManagementTemplateStepItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ManagementTemplateStep]:
        """
    ...
    async def patch(self,body: Optional[ManagementTemplateStep] = None, request_configuration: Optional[ManagementTemplateStepItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ManagementTemplateStep]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ManagementTemplateStep] = None, request_configuration: Optional[ManagementTemplateStepItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managementTemplateSteps in tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ManagementTemplateStepItemRequestBuilder:
        """
        ...
        return ManagementTemplateStepItemRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def accepted_version(self) -> AcceptedVersionRequestBuilder:
        """
        ...
        return AcceptedVersionRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def management_template(self) -> ManagementTemplateRequestBuilder:
        """
        ...
        return ManagementTemplateRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class ManagementTemplateStepItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagementTemplateStepItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagementTemplateStepItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
