...
class CredentialUserRegistrationsSummaryItemRequestBuilder():
    """
    ...
    @dataclass
    class CredentialUserRegistrationsSummaryItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class CredentialUserRegistrationsSummaryItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
