...
class CredentialUserRegistrationsSummaryItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[CredentialUserRegistrationsSummaryItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[credential_user_registrations_summary.CredentialUserRegistrationsSummary] = None, request_configuration: Optional[CredentialUserRegistrationsSummaryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property credentialUserRegistrationsSummaries in tenantRelationships
        Args:
            body: The request body
