...
class CredentialUserRegistrationsSummariesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[credential_user_registrations_summary.CredentialUserRegistrationsSummary] = None, request_configuration: Optional[CredentialUserRegistrationsSummariesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to credentialUserRegistrationsSummaries for tenantRelationships
        Args:
            body: The request body
