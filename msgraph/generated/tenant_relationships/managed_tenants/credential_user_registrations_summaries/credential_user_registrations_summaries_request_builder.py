...
credential_user_registrations_summary_collection_response = lazy_import('msgraph.generated.models.managed_tenants.credential_user_registrations_summary_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.credential_user_registrations_summaries.count.count_request_builder')
...
class CredentialUserRegistrationsSummariesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CredentialUserRegistrationsSummariesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[credential_user_registrations_summary.CredentialUserRegistrationsSummary] = None, request_configuration: Optional[CredentialUserRegistrationsSummariesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
