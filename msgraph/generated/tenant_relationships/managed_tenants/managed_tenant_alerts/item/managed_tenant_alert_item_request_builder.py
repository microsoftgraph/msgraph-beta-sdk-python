...
add_user_input_log_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.managed_tenant_alerts.item.microsoft_graph_managed_tenants_add_user_input_log.add_user_input_log_request_builder')
...
class ManagedTenantAlertItemRequestBuilder():
    ...
    @property
    def microsoft_graph_managed_tenants_add_user_input_log(self) -> add_user_input_log_request_builder.AddUserInputLogRequestBuilder:
        """
