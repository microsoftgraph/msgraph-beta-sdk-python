...
from .change_deployment_status import change_deployment_status_request_builder
...
class ManagementActionTenantDeploymentStatusesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[management_action_tenant_deployment_status.ManagementActionTenantDeploymentStatus] = None, request_configuration: Optional[ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
