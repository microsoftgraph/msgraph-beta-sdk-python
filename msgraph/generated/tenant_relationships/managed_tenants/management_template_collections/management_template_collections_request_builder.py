...
if TYPE_CHECKING:
    from ....models.managed_tenants import management_template_collection, management_template_collection_collection_response
    from ....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import management_template_collection_item_request_builder
...
class ManagementTemplateCollectionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_management_template_collection_id(self,management_template_collection_id: str) -> management_template_collection_item_request_builder.ManagementTemplateCollectionItemRequestBuilder:
        """
        Provides operations to manage the managementTemplateCollections property of the microsoft.graph.managedTenants.managedTenant entity.
        Args:
            management_template_collection_id: Unique identifier of the item
        ...
        if management_template_collection_id is None:
            raise Exception("management_template_collection_id cannot be undefined")
        from .item import management_template_collection_item_request_builder
    ...
    async def get(self,request_configuration: Optional[ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration] = None) -> Optional[management_template_collection_collection_response.ManagementTemplateCollectionCollectionResponse]:
        ...
        from ....models.managed_tenants import management_template_collection_collection_response
    ...
    def to_post_request_information(self,body: Optional[management_template_collection.ManagementTemplateCollection] = None, request_configuration: Optional[ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managementTemplateCollections for tenantRelationships
        Args:
            body: The request body
    ...
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[ManagementTemplateCollectionsRequestBuilder.ManagementTemplateCollectionsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
