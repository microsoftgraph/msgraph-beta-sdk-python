...
class ManagementTemplateCollectionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration] = None) -> Optional[ManagementTemplateCollectionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ManagementTemplateCollection] = None, request_configuration: Optional[ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration] = None) -> Optional[ManagementTemplateCollection]:
        """
    ...
    def to_post_request_information(self,body: Optional[ManagementTemplateCollection] = None, request_configuration: Optional[ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managementTemplateCollections for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ManagementTemplateCollectionsRequestBuilder:
        ...
        return ManagementTemplateCollectionsRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
