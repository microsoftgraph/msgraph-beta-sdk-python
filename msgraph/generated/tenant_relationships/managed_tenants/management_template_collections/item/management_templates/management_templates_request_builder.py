...
count_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.management_template_collections.item.management_templates.count.count_request_builder')
