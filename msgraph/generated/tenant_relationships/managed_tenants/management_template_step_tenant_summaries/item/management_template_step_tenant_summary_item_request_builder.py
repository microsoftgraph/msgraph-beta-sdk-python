...
class ManagementTemplateStepTenantSummaryItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ManagementTemplateStepTenantSummaryItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[management_template_step_tenant_summary.ManagementTemplateStepTenantSummary] = None, request_configuration: Optional[ManagementTemplateStepTenantSummaryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managementTemplateStepTenantSummaries in tenantRelationships
        Args:
            body: The request body
