...
management_template_step_deployment_collection_response = lazy_import('msgraph.generated.models.managed_tenants.management_template_step_deployment_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.management_template_step_versions.item.deployments.count.count_request_builder')
...
class DeploymentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[management_template_step_deployment.ManagementTemplateStepDeployment] = None, request_configuration: Optional[DeploymentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
