...
class ManagementTemplateStepVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, management_template_step_version_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagementTemplateStepVersionItemRequestBuilder and sets the default values.
        Args:
            managementTemplateStepVersionId: key: id of managementTemplateStepVersion
        ...
        url_tpl_params["managementTemplateStepVersion%2Did"] = managementTemplateStepVersionId
