...
class ManagementTemplateStepVersionItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ManagementTemplateStepVersionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagementTemplateStepVersionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[management_template_step_version.ManagementTemplateStepVersion] = None, request_configuration: Optional[ManagementTemplateStepVersionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
