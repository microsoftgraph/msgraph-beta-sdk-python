...
assign_tag_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.tenant_tags.item.microsoft_graph_managed_tenants_assign_tag.assign_tag_request_builder')
unassign_tag_request_builder = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.tenant_tags.item.microsoft_graph_managed_tenants_unassign_tag.unassign_tag_request_builder')
...
class TenantTagItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_managed_tenants_assign_tag(self) -> assign_tag_request_builder.AssignTagRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_managed_tenants_unassign_tag(self) -> unassign_tag_request_builder.UnassignTagRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, tenant_tag_id: Optional[str] = None) -> None:
        """
        Instantiates a new TenantTagItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            tenantTagId: key: id of tenantTag
        """
        ...
        url_tpl_params["tenantTag%2Did"] = tenantTagId
