...
assign_tag_post_request_body = lazy_import('msgraph.generated.tenant_relationships.managed_tenants.tenant_tags.item.managed_tenants_assign_tag.assign_tag_post_request_body')
...
class ManagedTenantsAssignTagRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/tenantTags/{tenantTag%2Did}/managedTenants.assignTag"
    ...
    @dataclass
    class ManagedTenantsAssignTagRequestBuilderPostRequestConfiguration():
        """
