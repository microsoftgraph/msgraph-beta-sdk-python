...
class CloudPcConnectionsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[CloudPcConnectionsRequestBuilderGetRequestConfiguration] = None) -> Optional[cloud_pc_connection_collection_response.CloudPcConnectionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, cloud_pc_connection_collection_response.CloudPcConnectionCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[cloud_pc_connection.CloudPcConnection] = None, request_configuration: Optional[CloudPcConnectionsRequestBuilderPostRequestConfiguration] = None) -> Optional[cloud_pc_connection.CloudPcConnection]:
        """
