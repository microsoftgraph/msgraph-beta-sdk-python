...
class TenantsCustomizedInformationRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[tenant_customized_information.TenantCustomizedInformation] = None, request_configuration: Optional[TenantsCustomizedInformationRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tenantsCustomizedInformation for tenantRelationships
        Args:
            body: The request body
