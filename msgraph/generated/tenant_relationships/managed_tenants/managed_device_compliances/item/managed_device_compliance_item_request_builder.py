...
from .....models.managed_tenants import managed_device_compliance
from .....models.o_data_errors import o_data_error

class ManagedDeviceComplianceItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        """
        Instantiates a new ManagedDeviceComplianceItemRequestBuilder and sets the default values.
        Args:
        ...
        self.url_template: str = "{+baseurl}/tenantRelationships/managedTenants/managedDeviceCompliances/{managedDeviceCompliance%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[ManagedDeviceComplianceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagedDeviceComplianceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[managed_device_compliance.ManagedDeviceCompliance] = None, request_configuration: Optional[ManagedDeviceComplianceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
        ...
        query_parameters: Optional[ManagedDeviceComplianceItemRequestBuilder.ManagedDeviceComplianceItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
