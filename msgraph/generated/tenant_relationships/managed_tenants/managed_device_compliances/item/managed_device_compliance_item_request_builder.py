...
class ManagedDeviceComplianceItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managedDeviceCompliances/{managedDeviceCompliance%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def patch(self,body: Optional[ManagedDeviceCompliance] = None, request_configuration: Optional[ManagedDeviceComplianceItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ManagedDeviceCompliance]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ManagedDeviceComplianceItemRequestBuilder:
        """
        ...
        return ManagedDeviceComplianceItemRequestBuilder(self.request_adapter, raw_url)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagedDeviceComplianceItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
