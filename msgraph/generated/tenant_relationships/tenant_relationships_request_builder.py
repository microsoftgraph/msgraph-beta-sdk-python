...
microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder = lazy_import('msgraph.generated.tenant_relationships.microsoft_graph_find_tenant_information_by_domain_name_with_domain_name.microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder')
microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder = lazy_import('msgraph.generated.tenant_relationships.microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id.microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder')
...
class TenantRelationshipsRequestBuilder():
    ...
    def microsoft_graph_find_tenant_information_by_domain_name_with_domain_name(self,domain_name: Optional[str] = None) -> microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder.MicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilder:
        """
        Provides operations to call the findTenantInformationByDomainName method.
        Args:
            domainName: Usage: domainName='{domainName}'
        Returns: microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder.MicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilder
        """
        if domain_name is None:
            raise Exception("domain_name cannot be undefined")
        return microsoft_graph_find_tenant_information_by_domain_name_with_domain_name_request_builder.MicrosoftGraphFindTenantInformationByDomainNameWithDomainNameRequestBuilder(self.request_adapter, self.path_parameters, domainName)
    
    def microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id(self,tenant_id: Optional[str] = None) -> microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder.MicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilder:
        """
        Provides operations to call the findTenantInformationByTenantId method.
        Args:
            tenantId: Usage: tenantId='{tenantId}'
        Returns: microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder.MicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilder
        """
        if tenant_id is None:
            raise Exception("tenant_id cannot be undefined")
        return microsoft_graph_find_tenant_information_by_tenant_id_with_tenant_id_request_builder.MicrosoftGraphFindTenantInformationByTenantIdWithTenantIdRequestBuilder(self.request_adapter, self.path_parameters, tenantId)
