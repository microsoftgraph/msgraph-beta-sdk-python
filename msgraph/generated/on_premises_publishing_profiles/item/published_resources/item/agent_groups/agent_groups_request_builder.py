...
on_premises_agent_group_collection_response = lazy_import('msgraph.generated.models.on_premises_agent_group_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.published_resources.item.agent_groups.count.count_request_builder')
ref_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.published_resources.item.agent_groups.ref.ref_request_builder')
...
class AgentGroupsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}/agentGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AgentGroupsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[on_premises_agent_group.OnPremisesAgentGroup] = None, request_configuration: Optional[AgentGroupsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def post(self,body: Optional[on_premises_agent_group.OnPremisesAgentGroup] = None, request_configuration: Optional[AgentGroupsRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[on_premises_agent_group.OnPremisesAgentGroup]:
        """
        Create new navigation property to agentGroups for onPremisesPublishingProfiles
        Args:
            body: The request body
    ...
    @dataclass
    class AgentGroupsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class AgentGroupsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
