...
agent_groups_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.published_resources.item.agent_groups.agent_groups_request_builder')
on_premises_agent_group_item_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.published_resources.item.agent_groups.item.on_premises_agent_group_item_request_builder')
...
class PublishedResourceItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/publishedResources/{publishedResource%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[PublishedResourceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PublishedResourceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[published_resource.PublishedResource] = None, request_configuration: Optional[PublishedResourceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PublishedResourceItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    class PublishedResourceItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[PublishedResourceItemRequestBuilder.PublishedResourceItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class PublishedResourceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
