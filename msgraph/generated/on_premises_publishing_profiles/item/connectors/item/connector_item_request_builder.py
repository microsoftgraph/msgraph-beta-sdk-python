...
member_of_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.connectors.item.member_of.member_of_request_builder')
connector_group_item_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.connectors.item.member_of.item.connector_group_item_request_builder')
...
class ConnectorItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, connector_id: Optional[str] = None) -> None:
        """
        Instantiates a new ConnectorItemRequestBuilder and sets the default values.
        Args:
            connectorId: key: id of connector
        ...
        self.url_template: str = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/connectors/{connector%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["connector%2Did"] = connectorId
    ...
    def to_patch_request_information(self,body: Optional[connector.Connector] = None, request_configuration: Optional[ConnectorItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property connectors in onPremisesPublishingProfiles
        Args:
            body: The request body
    ...
    @dataclass
    class ConnectorItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ConnectorItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
