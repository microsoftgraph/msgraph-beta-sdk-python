...
class ConnectorsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[connector.Connector] = None, request_configuration: Optional[ConnectorsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to connectors for onPremisesPublishingProfiles
        Args:
            body: The request body
