...
count_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.agent_groups.item.published_resources.count.count_request_builder')
