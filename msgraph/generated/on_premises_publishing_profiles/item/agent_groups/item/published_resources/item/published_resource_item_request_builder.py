...
agent_groups_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.agent_groups.item.published_resources.item.agent_groups.agent_groups_request_builder')
on_premises_agent_group_item_request_builder = lazy_import('msgraph.generated.on_premises_publishing_profiles.item.agent_groups.item.published_resources.item.agent_groups.item.on_premises_agent_group_item_request_builder')
