...
class AgentGroupsRequestBuilder():
    ...
    def by_on_premises_agent_group_id1(self,on_premises_agent_group_id1: str) -> on_premises_agent_group_item_request_builder.OnPremisesAgentGroupItemRequestBuilder:
        """
        ...
        Args:
            on_premises_agent_group_id1: Unique identifier of the item
        ...
        if on_premises_agent_group_id1 is None:
            raise Exception("on_premises_agent_group_id1 cannot be undefined")
        from .item import on_premises_agent_group_item_request_builder
