...
class AgentGroupsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AgentGroupsRequestBuilderGetRequestConfiguration] = None) -> Optional[OnPremisesAgentGroupCollectionResponse]:
        """
        Retrieve a list of onPremisesAgentGroup objects. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[OnPremisesAgentGroup] = None, request_configuration: Optional[AgentGroupsRequestBuilderPostRequestConfiguration] = None) -> Optional[OnPremisesAgentGroup]:
        """
        Create a new onPremisesAgentGroup object. This API is supported in the following national cloud deployments.
