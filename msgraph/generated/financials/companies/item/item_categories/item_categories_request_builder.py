...
if TYPE_CHECKING:
    ...
    from .....models.item_category_collection_response import ItemCategoryCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.item_category_item_request_builder import ItemCategoryItemRequestBuilder

class ItemCategoriesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/itemCategories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_item_category_id(self,item_category_id: UUID) -> ItemCategoryItemRequestBuilder:
        """
        Provides operations to manage the itemCategories property of the microsoft.graph.company entity.
        param item_category_id: The unique identifier of itemCategory
    ...
    async def get(self,request_configuration: Optional[ItemCategoriesRequestBuilderGetRequestConfiguration] = None) -> Optional[ItemCategoryCollectionResponse]:
        ...
        Returns: Optional[ItemCategoryCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ItemCategoriesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ItemCategoriesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ItemCategoriesRequestBuilder(raw_url, self.request_adapter)
