...
class CompanyInformationItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[CompanyInformationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[company_information.CompanyInformation] = None, request_configuration: Optional[CompanyInformationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
