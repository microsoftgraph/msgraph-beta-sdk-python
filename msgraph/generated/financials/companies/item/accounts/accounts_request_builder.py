...
count_request_builder = lazy_import('msgraph.generated.financials.companies.item.accounts.count.count_request_builder')
account_collection_response = lazy_import('msgraph.generated.models.account_collection_response')
...
class AccountsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[AccountsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
