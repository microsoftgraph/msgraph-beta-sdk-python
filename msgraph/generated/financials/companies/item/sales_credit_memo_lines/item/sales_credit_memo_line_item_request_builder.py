...
account_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_credit_memo_lines.item.account.account_request_builder')
item_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_credit_memo_lines.item.item.item_request_builder')
...
class SalesCreditMemoLineItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SalesCreditMemoLineItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[sales_credit_memo_line.SalesCreditMemoLine] = None, request_configuration: Optional[SalesCreditMemoLineItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
