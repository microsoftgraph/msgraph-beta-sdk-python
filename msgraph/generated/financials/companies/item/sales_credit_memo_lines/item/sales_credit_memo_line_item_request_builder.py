...
class SalesCreditMemoLineItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, sales_credit_memo_line_id: Optional[str] = None) -> None:
        """
        Instantiates a new SalesCreditMemoLineItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            salesCreditMemoLineId: key: id of salesCreditMemoLine
        """
        ...
        url_tpl_params["salesCreditMemoLine%2Did"] = salesCreditMemoLineId
