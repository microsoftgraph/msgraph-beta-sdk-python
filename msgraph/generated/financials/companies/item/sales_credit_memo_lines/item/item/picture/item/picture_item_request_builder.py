...
content_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_credit_memo_lines.item.item.picture.item.content.content_request_builder')
...
class PictureItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, picture_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item/picture/{picture%2Did}{?%24select,%24expand}"
