...
class ItemCategoryRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ItemCategoryRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[item_category.ItemCategory] = None, request_configuration: Optional[ItemCategoryRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property itemCategory in financials
        Args:
            body: The request body
