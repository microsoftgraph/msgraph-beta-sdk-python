...
class ItemCategoryRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ItemCategoryRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ItemCategoryRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[item_category.ItemCategory] = None, request_configuration: Optional[ItemCategoryRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
