...
cancel_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_invoices.item.microsoft_graph_cancel.cancel_request_builder')
cancel_and_send_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_invoices.item.microsoft_graph_cancel_and_send.cancel_and_send_request_builder')
post_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_invoices.item.microsoft_graph_post.post_request_builder')
post_and_send_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_invoices.item.microsoft_graph_post_and_send.post_and_send_request_builder')
send_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_invoices.item.microsoft_graph_send.send_request_builder')
...
class SalesInvoiceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_cancel_and_send(self) -> cancel_and_send_request_builder.CancelAndSendRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_post_and_send(self) -> post_and_send_request_builder.PostAndSendRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, sales_invoice_id: Optional[str] = None) -> None:
        """
        Instantiates a new SalesInvoiceItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            salesInvoiceId: key: id of salesInvoice
        """
        ...
        url_tpl_params["salesInvoice%2Did"] = salesInvoiceId
