...
if TYPE_CHECKING:
    from .....models import sales_invoice_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import sales_invoice_item_request_builder
...
class SalesInvoicesRequestBuilder():
    ...
    def by_sales_invoice_id(self,sales_invoice_id: str) -> sales_invoice_item_request_builder.SalesInvoiceItemRequestBuilder:
        """
        Provides operations to manage the salesInvoices property of the microsoft.graph.company entity.
        Args:
            sales_invoice_id: Unique identifier of the item
        Returns: sales_invoice_item_request_builder.SalesInvoiceItemRequestBuilder
        """
        if sales_invoice_id is None:
            raise Exception("sales_invoice_id cannot be undefined")
        from .item import sales_invoice_item_request_builder
