...
class CustomerPaymentJournalItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, customer_payment_journal_id: Optional[str] = None) -> None:
        """
        Instantiates a new CustomerPaymentJournalItemRequestBuilder and sets the default values.
        Args:
            customerPaymentJournalId: key: id of customerPaymentJournal
        ...
        url_tpl_params["customerPaymentJournal%2Did"] = customerPaymentJournalId
