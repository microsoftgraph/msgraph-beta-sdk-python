...
class CustomerPaymentJournalItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CustomerPaymentJournalItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CustomerPaymentJournalItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[customer_payment_journal.CustomerPaymentJournal] = None, request_configuration: Optional[CustomerPaymentJournalItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
