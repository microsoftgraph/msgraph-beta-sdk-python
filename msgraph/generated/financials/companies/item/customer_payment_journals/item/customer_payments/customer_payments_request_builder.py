...
count_request_builder = lazy_import('msgraph.generated.financials.companies.item.customer_payment_journals.item.customer_payments.count.count_request_builder')
customer_payment = lazy_import('msgraph.generated.models.customer_payment')
customer_payment_collection_response = lazy_import('msgraph.generated.models.customer_payment_collection_response')
...
class CustomerPaymentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}/customerPayments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[CustomerPaymentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[customer_payment.CustomerPayment] = None, request_configuration: Optional[CustomerPaymentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
