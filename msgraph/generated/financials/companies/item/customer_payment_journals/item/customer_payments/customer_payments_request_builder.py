...
class CustomerPaymentsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[customer_payment.CustomerPayment] = None, request_configuration: Optional[CustomerPaymentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to customerPayments for financials
        Args:
            body: The request body
