...
class CustomerPaymentItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[customer_payment.CustomerPayment] = None, request_configuration: Optional[CustomerPaymentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property customerPayments in financials
        Args:
            body: The request body
