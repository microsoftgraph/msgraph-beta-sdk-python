...
class JournalItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[journal.Journal] = None, request_configuration: Optional[JournalItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property journals in financials
        Args:
            body: The request body
