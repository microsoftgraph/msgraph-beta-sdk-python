...
count_request_builder = lazy_import('msgraph.generated.financials.companies.item.tax_groups.count.count_request_builder')
tax_group = lazy_import('msgraph.generated.models.tax_group')
tax_group_collection_response = lazy_import('msgraph.generated.models.tax_group_collection_response')
...
class TaxGroupsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[TaxGroupsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[tax_group.TaxGroup] = None, request_configuration: Optional[TaxGroupsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
