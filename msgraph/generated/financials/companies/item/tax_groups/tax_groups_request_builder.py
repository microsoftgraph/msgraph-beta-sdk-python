...
if TYPE_CHECKING:
    from .....models import tax_group, tax_group_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import tax_group_item_request_builder
...
class TaxGroupsRequestBuilder():
    ...
    def by_tax_group_id(self,tax_group_id: str) -> tax_group_item_request_builder.TaxGroupItemRequestBuilder:
        """
        Provides operations to manage the taxGroups property of the microsoft.graph.company entity.
        Args:
        ...
        if tax_group_id is None:
            raise Exception("tax_group_id cannot be undefined")
        from .item import tax_group_item_request_builder
    ...
    async def get(self,request_configuration: Optional[TaxGroupsRequestBuilderGetRequestConfiguration] = None) -> Optional[tax_group_collection_response.TaxGroupCollectionResponse]:
        ...
        from .....models import tax_group_collection_response
    ...
    def to_post_request_information(self,body: Optional[tax_group.TaxGroup] = None, request_configuration: Optional[TaxGroupsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to taxGroups for financials
        Args:
            body: The request body
