...
account_request_builder = lazy_import('msgraph.generated.financials.companies.item.journal_lines.item.account.account_request_builder')
...
class JournalLineItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[JournalLineItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[JournalLineItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[journal_line.JournalLine] = None, request_configuration: Optional[JournalLineItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
