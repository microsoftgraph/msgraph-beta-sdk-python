...
class JournalLineItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[JournalLineItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[journal_line.JournalLine] = None, request_configuration: Optional[JournalLineItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property journalLines in financials
        Args:
            body: The request body
