...
class CustomerItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[CustomerItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[CustomerItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[customer.Customer] = None, request_configuration: Optional[CustomerItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
