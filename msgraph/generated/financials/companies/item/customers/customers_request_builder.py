...
count_request_builder = lazy_import('msgraph.generated.financials.companies.item.customers.count.count_request_builder')
customer = lazy_import('msgraph.generated.models.customer')
customer_collection_response = lazy_import('msgraph.generated.models.customer_collection_response')
...
class CustomersRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[customer.Customer] = None, request_configuration: Optional[CustomersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
