...
class UnitOfMeasureItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, unit_of_measure_id: Optional[str] = None) -> None:
        """
        Instantiates a new UnitOfMeasureItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            unitOfMeasureId: key: id of unitOfMeasure
        """
        ...
        url_tpl_params["unitOfMeasure%2Did"] = unitOfMeasureId
    ...
    def to_patch_request_information(self,body: Optional[unit_of_measure.UnitOfMeasure] = None, request_configuration: Optional[UnitOfMeasureItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property unitsOfMeasure in financials
        Args:
            body: The request body
