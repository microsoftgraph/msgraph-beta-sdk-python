...
class VendorRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/vendor{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[VendorRequestBuilderGetRequestConfiguration] = None) -> Optional[Vendor]:
        """
    ...
    async def patch(self,body: Optional[Vendor] = None, request_configuration: Optional[VendorRequestBuilderPatchRequestConfiguration] = None) -> Optional[Vendor]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Vendor] = None, request_configuration: Optional[VendorRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property vendor in financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> VendorRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: VendorRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return VendorRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class VendorRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class VendorRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class VendorRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
