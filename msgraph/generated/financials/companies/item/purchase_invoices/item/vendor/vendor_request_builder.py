...
currency_request_builder = lazy_import('msgraph.generated.financials.companies.item.purchase_invoices.item.vendor.currency.currency_request_builder')
payment_method_request_builder = lazy_import('msgraph.generated.financials.companies.item.purchase_invoices.item.vendor.payment_method.payment_method_request_builder')
payment_term_request_builder = lazy_import('msgraph.generated.financials.companies.item.purchase_invoices.item.vendor.payment_term.payment_term_request_builder')
picture_request_builder = lazy_import('msgraph.generated.financials.companies.item.purchase_invoices.item.vendor.picture.picture_request_builder')
picture_item_request_builder = lazy_import('msgraph.generated.financials.companies.item.purchase_invoices.item.vendor.picture.item.picture_item_request_builder')
...
class VendorRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/financials/companies/{company%2Did}/purchaseInvoices/{purchaseInvoice%2Did}/vendor{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[VendorRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[VendorRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[vendor.Vendor] = None, request_configuration: Optional[VendorRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class VendorRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class VendorRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
        ...
        query_parameters: Optional[VendorRequestBuilder.VendorRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class VendorRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
