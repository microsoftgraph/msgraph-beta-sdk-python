...
class VendorRequestBuilder():
    ...
    def to_delete_request_information(self,request_configuration: Optional[VendorRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property vendor for financials
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[VendorRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get vendor from financials
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[vendor.Vendor] = None, request_configuration: Optional[VendorRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property vendor in financials
        Args:
            body: The request body
