...
class ItemsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ItemsRequestBuilderGetRequestConfiguration] = None) -> Optional[item_collection_response.ItemCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, item_collection_response.ItemCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[item.Item] = None, request_configuration: Optional[ItemsRequestBuilderPostRequestConfiguration] = None) -> Optional[item.Item]:
        """
