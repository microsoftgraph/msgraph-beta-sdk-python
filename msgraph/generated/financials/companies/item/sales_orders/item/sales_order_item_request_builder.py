...
currency_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_orders.item.currency.currency_request_builder')
customer_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_orders.item.customer.customer_request_builder')
payment_term_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_orders.item.payment_term.payment_term_request_builder')
sales_order_lines_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_orders.item.sales_order_lines.sales_order_lines_request_builder')
sales_order_line_item_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_orders.item.sales_order_lines.item.sales_order_line_item_request_builder')
...
class SalesOrderItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SalesOrderItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[sales_order.SalesOrder] = None, request_configuration: Optional[SalesOrderItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[SalesOrderItemRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[sales_order.SalesOrder]:
        """
        Get salesOrders from financials
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[sales_order.SalesOrder] = None, request_configuration: Optional[SalesOrderItemRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[sales_order.SalesOrder]:
        """
        Update the navigation property salesOrders in financials
        Args:
            body: The request body
