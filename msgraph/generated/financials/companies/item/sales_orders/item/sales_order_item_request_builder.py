...
class SalesOrderItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, sales_order_id: Optional[str] = None) -> None:
        """
        Instantiates a new SalesOrderItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            salesOrderId: key: id of salesOrder
        """
        ...
        url_tpl_params["salesOrder%2Did"] = salesOrderId
