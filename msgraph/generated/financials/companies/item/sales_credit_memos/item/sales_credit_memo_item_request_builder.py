...
class SalesCreditMemoItemRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SalesCreditMemoItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[sales_credit_memo.SalesCreditMemo] = None, request_configuration: Optional[SalesCreditMemoItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
