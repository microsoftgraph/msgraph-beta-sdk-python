...
if TYPE_CHECKING:
    ...
    from ........models.sales_credit_memo_line import SalesCreditMemoLine
...
class SalesCreditMemoLineItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[SalesCreditMemoLineItemRequestBuilderGetRequestConfiguration] = None) -> Optional[SalesCreditMemoLine]:
        """
        Get salesCreditMemoLines from financials
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SalesCreditMemoLine]
        """
        ...
        return await self.request_adapter.send_async(request_info, SalesCreditMemoLine, error_mapping)
    
    async def patch(self,body: Optional[SalesCreditMemoLine] = None, request_configuration: Optional[SalesCreditMemoLineItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[SalesCreditMemoLine]:
        """
    ...
    def to_patch_request_information(self,body: Optional[SalesCreditMemoLine] = None, request_configuration: Optional[SalesCreditMemoLineItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property salesCreditMemoLines in financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SalesCreditMemoLineItemRequestBuilder:
        """
    ...
    @dataclass
    class SalesCreditMemoLineItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class SalesCreditMemoLineItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
