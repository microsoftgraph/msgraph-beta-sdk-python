...
content_request_builder = lazy_import('msgraph.generated.financials.companies.item.sales_credit_memos.item.sales_credit_memo_lines.item.item.picture.item.content.content_request_builder')
picture = lazy_import('msgraph.generated.models.picture')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class PictureItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, picture_id: Optional[str] = None) -> None:
        """
        Instantiates a new PictureItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            pictureId: key: id of picture
        ...
        self.url_template: str = "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}/salesCreditMemoLines/{salesCreditMemoLine%2Did}/item/picture/{picture%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["picture%2Did"] = pictureId
    ...
    def to_patch_request_information(self,body: Optional[picture.Picture] = None, request_configuration: Optional[PictureItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property picture in financials
        Args:
            body: The request body
    ...
    @dataclass
    class PictureItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PictureItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
