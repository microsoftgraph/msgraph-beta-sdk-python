...
class PaymentMethodRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PaymentMethodRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[payment_method.PaymentMethod] = None, request_configuration: Optional[PaymentMethodRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property paymentMethod in financials
        Args:
            body: The request body
