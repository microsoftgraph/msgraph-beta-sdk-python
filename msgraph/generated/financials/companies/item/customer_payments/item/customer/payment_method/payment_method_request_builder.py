...
class PaymentMethodRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[PaymentMethodRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PaymentMethodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[payment_method.PaymentMethod] = None, request_configuration: Optional[PaymentMethodRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
