...
count_request_builder = lazy_import('msgraph.generated.financials.companies.item.tax_areas.count.count_request_builder')
tax_area = lazy_import('msgraph.generated.models.tax_area')
tax_area_collection_response = lazy_import('msgraph.generated.models.tax_area_collection_response')
...
class TaxAreasRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[TaxAreasRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[tax_area.TaxArea] = None, request_configuration: Optional[TaxAreasRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class TaxAreasRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
