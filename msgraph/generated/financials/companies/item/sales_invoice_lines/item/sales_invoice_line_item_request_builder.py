...
class SalesInvoiceLineItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[sales_invoice_line.SalesInvoiceLine] = None, request_configuration: Optional[SalesInvoiceLineItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property salesInvoiceLines in financials
        Args:
            body: The request body
