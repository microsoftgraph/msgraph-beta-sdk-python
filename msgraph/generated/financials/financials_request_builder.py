...
class FinancialsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/financials{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[FinancialsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get financials
        Args:
    ...
    def create_patch_request_information(self,body: Optional[financials.Financials] = None, request_configuration: Optional[FinancialsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update financials
        Args:
