...
self_activate_post_request_body = lazy_import('msgraph.generated.privileged_approval.item.role_info.microsoft_graph_self_activate.self_activate_post_request_body')
