...
microsoft_graph_self_activate_request_builder = lazy_import('msgraph.generated.privileged_approval.item.role_info.microsoft_graph_self_activate.microsoft_graph_self_activate_request_builder')
microsoft_graph_self_deactivate_request_builder = lazy_import('msgraph.generated.privileged_approval.item.role_info.microsoft_graph_self_deactivate.microsoft_graph_self_deactivate_request_builder')
...
class RoleInfoRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo{?%24select,%24expand}"
