...
class PrivilegedApprovalItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, privileged_approval_id: Optional[str] = None) -> None:
        """
        Instantiates a new PrivilegedApprovalItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            privilegedApprovalId: key: id of privilegedApproval
        ...
        url_tpl_params["privilegedApproval%2Did"] = privilegedApprovalId
