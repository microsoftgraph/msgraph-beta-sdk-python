...
my_requests_request_builder = lazy_import('msgraph.generated.privileged_approval.microsoft_graph_my_requests.my_requests_request_builder')
...
class PrivilegedApprovalRequestBuilder():
    ...
    @property
    def microsoft_graph_my_requests(self) -> my_requests_request_builder.MyRequestsRequestBuilder:
        """
