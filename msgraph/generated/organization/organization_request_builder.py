...
if TYPE_CHECKING:
    ...
    from .item import organization_item_request_builder
...
class OrganizationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/organization{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_organization_id(self,organization_id: str) -> organization_item_request_builder.OrganizationItemRequestBuilder:
        """
        Provides operations to manage the collection of organization entities.
        Args:
            organization_id: Unique identifier of the item
        Returns: organization_item_request_builder.OrganizationItemRequestBuilder
        """
        if organization_id is None:
            raise Exception("organization_id cannot be undefined")
        from .item import organization_item_request_builder
    ...
    def to_post_request_information(self,body: Optional[organization.Organization] = None, request_configuration: Optional[OrganizationRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to organization
        Args:
            body: The request body
    ...
    @dataclass
    class OrganizationRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
