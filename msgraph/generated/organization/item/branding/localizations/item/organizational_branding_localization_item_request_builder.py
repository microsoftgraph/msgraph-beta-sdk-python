...
custom_c_s_s_request_builder = lazy_import('msgraph.generated.organization.item.branding.localizations.item.custom_c_s_s.custom_c_s_s_request_builder')
favicon_request_builder = lazy_import('msgraph.generated.organization.item.branding.localizations.item.favicon.favicon_request_builder')
header_logo_request_builder = lazy_import('msgraph.generated.organization.item.branding.localizations.item.header_logo.header_logo_request_builder')
...
square_logo_dark_request_builder = lazy_import('msgraph.generated.organization.item.branding.localizations.item.square_logo_dark.square_logo_dark_request_builder')
