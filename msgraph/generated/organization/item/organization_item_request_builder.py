...
microsoft_graph_activate_service_request_builder = lazy_import('msgraph.generated.organization.item.microsoft_graph_activate_service.microsoft_graph_activate_service_request_builder')
...
class OrganizationItemRequestBuilder():
    ...
    @property
    def microsoft_graph_activate_service(self) -> microsoft_graph_activate_service_request_builder.MicrosoftGraphActivateServiceRequestBuilder:
        """
        Provides operations to call the activateService method.
        """
        return microsoft_graph_activate_service_request_builder.MicrosoftGraphActivateServiceRequestBuilder(self.request_adapter, self.path_parameters)
