...
class ProfileCardPropertyItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[profile_card_property.ProfileCardProperty] = None, request_configuration: Optional[ProfileCardPropertyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property profileCardProperties in organization
        Args:
            body: The request body
