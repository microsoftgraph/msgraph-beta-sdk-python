...
if TYPE_CHECKING:
    from .....models import pronouns_settings
...
class PronounsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/organization/{organization%2Did}/settings/pronouns{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[PronounsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[PronounsRequestBuilderGetRequestConfiguration] = None) -> Optional[pronouns_settings.PronounsSettings]:
        ...
        return await self.request_adapter.send_async(request_info, pronouns_settings.PronounsSettings, error_mapping)
    ...
    @dataclass
    class PronounsRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PronounsRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class PronounsRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
