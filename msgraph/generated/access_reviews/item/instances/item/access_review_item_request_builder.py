...
microsoft_graph_apply_decisions_request_builder = lazy_import('msgraph.generated.access_reviews.item.instances.item.microsoft_graph_apply_decisions.microsoft_graph_apply_decisions_request_builder')
microsoft_graph_reset_decisions_request_builder = lazy_import('msgraph.generated.access_reviews.item.instances.item.microsoft_graph_reset_decisions.microsoft_graph_reset_decisions_request_builder')
microsoft_graph_send_reminder_request_builder = lazy_import('msgraph.generated.access_reviews.item.instances.item.microsoft_graph_send_reminder.microsoft_graph_send_reminder_request_builder')
microsoft_graph_stop_request_builder = lazy_import('msgraph.generated.access_reviews.item.instances.item.microsoft_graph_stop.microsoft_graph_stop_request_builder')
