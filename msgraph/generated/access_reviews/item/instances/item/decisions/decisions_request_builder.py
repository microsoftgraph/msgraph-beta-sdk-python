...
class DecisionsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[access_review_decision.AccessReviewDecision] = None, request_configuration: Optional[DecisionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to decisions for accessReviews
        Args:
            body: The request body
