...
class OfficeConfigurationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/officeConfiguration{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[OfficeConfigurationRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[office_configuration.OfficeConfiguration] = None, request_configuration: Optional[OfficeConfigurationRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class OfficeConfigurationRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[OfficeConfigurationRequestBuilder.OfficeConfigurationRequestBuilderGetQueryParameters] = None
