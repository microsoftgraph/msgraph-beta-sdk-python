...
class OfficeConfigurationRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[office_configuration.OfficeConfiguration] = None, request_configuration: Optional[OfficeConfigurationRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update officeConfiguration
        Args:
            body: The request body
