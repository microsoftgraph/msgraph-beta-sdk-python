...
class ServicePrincipalsWithAppIdRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ServicePrincipalsWithAppIdRequestBuilder:
        """
        ...
        return ServicePrincipalsWithAppIdRequestBuilder(raw_url, self.request_adapter)
