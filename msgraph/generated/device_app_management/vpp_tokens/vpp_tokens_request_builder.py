...
microsoft_graph_get_licenses_for_app_with_bundle_id_request_builder = lazy_import('msgraph.generated.device_app_management.vpp_tokens.microsoft_graph_get_licenses_for_app_with_bundle_id.microsoft_graph_get_licenses_for_app_with_bundle_id_request_builder')
microsoft_graph_sync_license_counts_request_builder = lazy_import('msgraph.generated.device_app_management.vpp_tokens.microsoft_graph_sync_license_counts.microsoft_graph_sync_license_counts_request_builder')
...
class VppTokensRequestBuilder():
    ...
    @property
    def microsoft_graph_sync_license_counts(self) -> microsoft_graph_sync_license_counts_request_builder.MicrosoftGraphSyncLicenseCountsRequestBuilder:
        """
        Provides operations to call the syncLicenseCounts method.
        """
        return microsoft_graph_sync_license_counts_request_builder.MicrosoftGraphSyncLicenseCountsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def microsoft_graph_get_licenses_for_app_with_bundle_id(self,bundle_id: Optional[str] = None) -> microsoft_graph_get_licenses_for_app_with_bundle_id_request_builder.MicrosoftGraphGetLicensesForAppWithBundleIdRequestBuilder:
        """
        Provides operations to call the getLicensesForApp method.
        Args:
            bundleId: Usage: bundleId='{bundleId}'
        Returns: microsoft_graph_get_licenses_for_app_with_bundle_id_request_builder.MicrosoftGraphGetLicensesForAppWithBundleIdRequestBuilder
        """
        if bundle_id is None:
            raise Exception("bundle_id cannot be undefined")
        return microsoft_graph_get_licenses_for_app_with_bundle_id_request_builder.MicrosoftGraphGetLicensesForAppWithBundleIdRequestBuilder(self.request_adapter, self.path_parameters, bundleId)
    ...
    @dataclass
    class VppTokensRequestBuilderGetRequestConfiguration():
        """
