...
if TYPE_CHECKING:
    from ....models import base_collection_pagination_count_response, has_payload_link_result_item
...
class HasPayloadLinksResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[has_payload_link_result_item.HasPayloadLinkResultItem]] = None
