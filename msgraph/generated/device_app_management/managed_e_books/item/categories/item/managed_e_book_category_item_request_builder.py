...
class ManagedEBookCategoryItemRequestBuilder():
    """
    ...
    def create_get_request_information(self,request_configuration: Optional[ManagedEBookCategoryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
