...
class UserInstallStateSummaryItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[user_install_state_summary.UserInstallStateSummary] = None, request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def delete(self,request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderDeleteRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> None:
        """
        Delete navigation property userStateSummary for deviceAppManagement
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def get(self,request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[user_install_state_summary.UserInstallStateSummary]:
        """
        The list of installation states for this eBook.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[user_install_state_summary.UserInstallStateSummary] = None, request_configuration: Optional[UserInstallStateSummaryItemRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[user_install_state_summary.UserInstallStateSummary]:
        """
        Update the navigation property userStateSummary in deviceAppManagement
        Args:
            body: 
    ...
    @dataclass
    class UserInstallStateSummaryItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class UserInstallStateSummaryItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
