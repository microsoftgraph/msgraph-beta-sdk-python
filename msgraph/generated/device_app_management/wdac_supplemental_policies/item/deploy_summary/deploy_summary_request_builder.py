...
class DeploySummaryRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[DeploySummaryRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[windows_defender_application_control_supplemental_policy_deployment_summary.WindowsDefenderApplicationControlSupplementalPolicyDeploymentSummary] = None, request_configuration: Optional[DeploySummaryRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deploySummary in deviceAppManagement
        Args:
            body: The request body
