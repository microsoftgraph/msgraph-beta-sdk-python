...
class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[windows_defender_application_control_supplemental_policy_deployment_status.WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus] = None, request_configuration: Optional[WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceStatuses in deviceAppManagement
        Args:
            body: The request body
