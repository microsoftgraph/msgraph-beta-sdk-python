...
policy_request_builder = lazy_import('msgraph.generated.device_app_management.wdac_supplemental_policies.item.device_statuses.item.policy.policy_request_builder')
...
class WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[windows_defender_application_control_supplemental_policy_deployment_status.WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus] = None, request_configuration: Optional[WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
