...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicy%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicyAssignmentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicyAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicyAssignment]:
        """
    ...
    def to_post_request_information(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicyAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to assignments for deviceAppManagement
        Args:
            body: The request body
