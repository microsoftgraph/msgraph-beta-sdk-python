...
class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder():
    ...
    def assignments_by_id(self,id: str) -> Optional[windows_defender_application_control_supplemental_policy_assignment_item_request_builder.WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder]:
        """
        Provides operations to manage the assignments property of the microsoft.graph.windowsDefenderApplicationControlSupplementalPolicy entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[windows_defender_application_control_supplemental_policy_assignment_item_request_builder.WindowsDefenderApplicationControlSupplementalPolicyAssignmentItemRequestBuilder]
        """
        if id is None:
    ...
    def device_statuses_by_id(self,id: str) -> Optional[windows_defender_application_control_supplemental_policy_deployment_status_item_request_builder.WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder]:
        """
        Provides operations to manage the deviceStatuses property of the microsoft.graph.windowsDefenderApplicationControlSupplementalPolicy entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[windows_defender_application_control_supplemental_policy_deployment_status_item_request_builder.WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatusItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
