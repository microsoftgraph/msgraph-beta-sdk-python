...
class GetTopMobileAppsWithStatusWithCountRequestBuilder():
    ...
    @dataclass
    class GetTopMobileAppsWithStatusWithCountRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[GetTopMobileAppsWithStatusWithCountRequestBuilder.GetTopMobileAppsWithStatusWithCountRequestBuilderGetQueryParameters] = None
