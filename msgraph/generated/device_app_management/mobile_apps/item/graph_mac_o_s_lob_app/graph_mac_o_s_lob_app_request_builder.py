...
if TYPE_CHECKING:
    from .....models.mac_o_s_lob_app import MacOSLobApp
...
class GraphMacOSLobAppRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[GraphMacOSLobAppRequestBuilderGetRequestConfiguration] = None) -> Optional[MacOSLobApp]:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSLobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MacOSLobApp]
        """
        ...
        return await self.request_adapter.send_async(request_info, MacOSLobApp, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[GraphMacOSLobAppRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSLobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphMacOSLobAppRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphMacOSLobAppRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GraphMacOSLobAppRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphMacOSLobAppRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GraphMacOSLobAppRequestBuilder.GraphMacOSLobAppRequestBuilderGetQueryParameters] = None
