...
class DeviceStatusesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[mobile_app_install_status.MobileAppInstallStatus] = None, request_configuration: Optional[DeviceStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceStatuses for deviceAppManagement
        Args:
            body: The request body
