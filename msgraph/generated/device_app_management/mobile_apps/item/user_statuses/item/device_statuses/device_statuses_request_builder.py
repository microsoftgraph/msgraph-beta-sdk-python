...
count_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.item.user_statuses.item.device_statuses.count.count_request_builder')
mobile_app_install_status = lazy_import('msgraph.generated.models.mobile_app_install_status')
mobile_app_install_status_collection_response = lazy_import('msgraph.generated.models.mobile_app_install_status_collection_response')
...
class DeviceStatusesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/userStatuses/{userAppInstallStatus%2Did}/deviceStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[mobile_app_install_status.MobileAppInstallStatus] = None, request_configuration: Optional[DeviceStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
