...
count_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.item.relationships.count.count_request_builder')
mobile_app_relationship = lazy_import('msgraph.generated.models.mobile_app_relationship')
mobile_app_relationship_collection_response = lazy_import('msgraph.generated.models.mobile_app_relationship_collection_response')
...
class RelationshipsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/relationships{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[mobile_app_relationship.MobileAppRelationship] = None, request_configuration: Optional[RelationshipsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class RelationshipsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
