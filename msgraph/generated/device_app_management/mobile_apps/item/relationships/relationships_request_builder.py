...
class RelationshipsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[mobile_app_relationship.MobileAppRelationship] = None, request_configuration: Optional[RelationshipsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to relationships for deviceAppManagement
        Args:
            body: The request body
