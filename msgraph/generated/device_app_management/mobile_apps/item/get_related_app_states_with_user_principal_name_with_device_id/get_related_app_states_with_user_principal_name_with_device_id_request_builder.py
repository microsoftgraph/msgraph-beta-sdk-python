...
class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder.GetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilderGetQueryParameters] = None
