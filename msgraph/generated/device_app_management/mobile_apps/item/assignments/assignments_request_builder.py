...
count_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.item.assignments.count.count_request_builder')
mobile_app_assignment = lazy_import('msgraph.generated.models.mobile_app_assignment')
mobile_app_assignment_collection_response = lazy_import('msgraph.generated.models.mobile_app_assignment_collection_response')
...
class AssignmentsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[mobile_app_assignment.MobileAppAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
