...
microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.item.microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id.microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id_request_builder')
...
microsoft_graph_update_relationships_request_builder = lazy_import('msgraph.generated.device_app_management.mobile_apps.item.microsoft_graph_update_relationships.microsoft_graph_update_relationships_request_builder')
...
class MobileAppItemRequestBuilder():
    ...
    @property
    def microsoft_graph_update_relationships(self) -> microsoft_graph_update_relationships_request_builder.MicrosoftGraphUpdateRelationshipsRequestBuilder:
        """
        Provides operations to call the updateRelationships method.
        """
        return microsoft_graph_update_relationships_request_builder.MicrosoftGraphUpdateRelationshipsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id(self,device_id: Optional[str] = None, user_principal_name: Optional[str] = None) -> microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id_request_builder.MicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder:
        """
        ...
        Returns: microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id_request_builder.MicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder
        """
        ...
        return microsoft_graph_get_related_app_states_with_user_principal_name_with_device_id_request_builder.MicrosoftGraphGetRelatedAppStatesWithUserPrincipalNameWithDeviceIdRequestBuilder(self.request_adapter, self.path_parameters, deviceId, userPrincipalName)
