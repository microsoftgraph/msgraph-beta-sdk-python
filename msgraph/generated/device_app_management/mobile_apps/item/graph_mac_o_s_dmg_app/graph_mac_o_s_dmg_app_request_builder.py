...
if TYPE_CHECKING:
    from .....models.mac_o_s_dmg_app import MacOSDmgApp
...
class GraphMacOSDmgAppRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSDmgApp{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[GraphMacOSDmgAppRequestBuilderGetRequestConfiguration] = None) -> Optional[MacOSDmgApp]:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSDmgApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[MacOSDmgApp]
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GraphMacOSDmgAppRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSDmgApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphMacOSDmgAppRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphMacOSDmgAppRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GraphMacOSDmgAppRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphMacOSDmgAppRequestBuilderGetQueryParameters():
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSDmgApp
        """
    ...
    @dataclass
    class GraphMacOSDmgAppRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GraphMacOSDmgAppRequestBuilder.GraphMacOSDmgAppRequestBuilderGetQueryParameters] = None
