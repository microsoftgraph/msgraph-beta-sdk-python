...
class GraphAndroidStoreAppRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[GraphAndroidStoreAppRequestBuilderGetRequestConfiguration] = None) -> Optional[AndroidStoreApp]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GraphAndroidStoreAppRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.androidStoreApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphAndroidStoreAppRequestBuilder:
        """
    ...
    @dataclass
    class GraphAndroidStoreAppRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GraphAndroidStoreAppRequestBuilder.GraphAndroidStoreAppRequestBuilderGetQueryParameters] = None
