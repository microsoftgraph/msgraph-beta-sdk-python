...
class ManagedAppStatusesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/managedAppStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def post(self,body: Optional[ManagedAppStatus] = None, request_configuration: Optional[ManagedAppStatusesRequestBuilderPostRequestConfiguration] = None) -> Optional[ManagedAppStatus]:
        """
    ...
    def to_post_request_information(self,body: Optional[ManagedAppStatus] = None, request_configuration: Optional[ManagedAppStatusesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedAppStatuses for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ManagedAppStatusesRequestBuilder:
        """
        ...
        return ManagedAppStatusesRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class ManagedAppStatusesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ManagedAppStatusesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
