...
class PolicySetsRequestBuilder():
    ...
    @property
    def get_policy_sets(self) -> get_policy_sets_request_builder.GetPolicySetsRequestBuilder:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PolicySetsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[policy_set.PolicySet] = None, request_configuration: Optional[PolicySetsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
