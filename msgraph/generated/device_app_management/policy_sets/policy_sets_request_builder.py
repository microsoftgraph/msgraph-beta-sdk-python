...
microsoft_graph_get_policy_sets_request_builder = lazy_import('msgraph.generated.device_app_management.policy_sets.microsoft_graph_get_policy_sets.microsoft_graph_get_policy_sets_request_builder')
...
class PolicySetsRequestBuilder():
    ...
    @property
    def microsoft_graph_get_policy_sets(self) -> microsoft_graph_get_policy_sets_request_builder.MicrosoftGraphGetPolicySetsRequestBuilder:
        """
        Provides operations to call the getPolicySets method.
        """
        return microsoft_graph_get_policy_sets_request_builder.MicrosoftGraphGetPolicySetsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def to_post_request_information(self,body: Optional[policy_set.PolicySet] = None, request_configuration: Optional[PolicySetsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to policySets for deviceAppManagement
        Args:
            body: The request body
