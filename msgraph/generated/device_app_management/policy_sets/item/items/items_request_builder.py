...
count_request_builder = lazy_import('msgraph.generated.device_app_management.policy_sets.item.items.count.count_request_builder')
policy_set_item = lazy_import('msgraph.generated.models.policy_set_item')
policy_set_item_collection_response = lazy_import('msgraph.generated.models.policy_set_item_collection_response')
...
class ItemsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[policy_set_item.PolicySetItem] = None, request_configuration: Optional[ItemsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
