...
class PolicySetItemItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PolicySetItemItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[policy_set_item.PolicySetItem] = None, request_configuration: Optional[PolicySetItemItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property items in deviceAppManagement
        Args:
            body: The request body
