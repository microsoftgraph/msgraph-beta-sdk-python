...
microsoft_graph_update_request_builder = lazy_import('msgraph.generated.device_app_management.policy_sets.item.microsoft_graph_update.microsoft_graph_update_request_builder')
...
class PolicySetItemRequestBuilder():
    ...
    @property
    def microsoft_graph_update(self) -> microsoft_graph_update_request_builder.MicrosoftGraphUpdateRequestBuilder:
        """
        Provides operations to call the update method.
        """
        return microsoft_graph_update_request_builder.MicrosoftGraphUpdateRequestBuilder(self.request_adapter, self.path_parameters)
