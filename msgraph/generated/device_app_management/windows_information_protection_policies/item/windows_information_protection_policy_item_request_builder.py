...
class WindowsInformationProtectionPolicyItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[WindowsInformationProtectionPolicyItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsInformationProtectionPolicyItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[windows_information_protection_policy.WindowsInformationProtectionPolicy] = None, request_configuration: Optional[WindowsInformationProtectionPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
