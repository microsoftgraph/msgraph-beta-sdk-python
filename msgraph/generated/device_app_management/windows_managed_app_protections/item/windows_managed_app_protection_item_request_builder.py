...
microsoft_graph_assign_request_builder = lazy_import('msgraph.generated.device_app_management.windows_managed_app_protections.item.microsoft_graph_assign.microsoft_graph_assign_request_builder')
microsoft_graph_target_apps_request_builder = lazy_import('msgraph.generated.device_app_management.windows_managed_app_protections.item.microsoft_graph_target_apps.microsoft_graph_target_apps_request_builder')
