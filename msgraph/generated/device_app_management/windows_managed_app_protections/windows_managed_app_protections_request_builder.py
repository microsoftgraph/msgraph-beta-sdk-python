...
count_request_builder = lazy_import('msgraph.generated.device_app_management.windows_managed_app_protections.count.count_request_builder')
windows_managed_app_protection = lazy_import('msgraph.generated.models.windows_managed_app_protection')
windows_managed_app_protection_collection_response = lazy_import('msgraph.generated.models.windows_managed_app_protection_collection_response')
...
class WindowsManagedAppProtectionsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[WindowsManagedAppProtectionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[windows_managed_app_protection.WindowsManagedAppProtection] = None, request_configuration: Optional[WindowsManagedAppProtectionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
