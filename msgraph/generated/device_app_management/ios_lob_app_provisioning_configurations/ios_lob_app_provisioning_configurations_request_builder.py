...
count_request_builder = lazy_import('msgraph.generated.device_app_management.ios_lob_app_provisioning_configurations.count.count_request_builder')
has_payload_links_request_builder = lazy_import('msgraph.generated.device_app_management.ios_lob_app_provisioning_configurations.has_payload_links.has_payload_links_request_builder')
ios_lob_app_provisioning_configuration = lazy_import('msgraph.generated.models.ios_lob_app_provisioning_configuration')
ios_lob_app_provisioning_configuration_collection_response = lazy_import('msgraph.generated.models.ios_lob_app_provisioning_configuration_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class IosLobAppProvisioningConfigurationsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[IosLobAppProvisioningConfigurationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[ios_lob_app_provisioning_configuration.IosLobAppProvisioningConfiguration] = None, request_configuration: Optional[IosLobAppProvisioningConfigurationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class IosLobAppProvisioningConfigurationsRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[IosLobAppProvisioningConfigurationsRequestBuilder.IosLobAppProvisioningConfigurationsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class IosLobAppProvisioningConfigurationsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
