...
class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder():
    """
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, managed_device_mobile_app_configuration_device_status_id: Optional[str] = None) -> None:
        """
        Instantiates a new ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder and sets the default values.
        Args:
            managedDeviceMobileAppConfigurationDeviceStatusId: key: id of managedDeviceMobileAppConfigurationDeviceStatus
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/{iosLobAppProvisioningConfiguration%2Did}/deviceStatuses/{managedDeviceMobileAppConfigurationDeviceStatus%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["managedDeviceMobileAppConfigurationDeviceStatus%2Did"] = managedDeviceMobileAppConfigurationDeviceStatusId
    ...
    async def get(self,request_configuration: Optional[ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderGetRequestConfiguration] = None) -> Optional[managed_device_mobile_app_configuration_device_status.ManagedDeviceMobileAppConfigurationDeviceStatus]:
        """
    ...
    async def patch(self,body: Optional[managed_device_mobile_app_configuration_device_status.ManagedDeviceMobileAppConfigurationDeviceStatus] = None, request_configuration: Optional[ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[managed_device_mobile_app_configuration_device_status.ManagedDeviceMobileAppConfigurationDeviceStatus]:
        """
    ...
    def to_patch_request_information(self,body: Optional[managed_device_mobile_app_configuration_device_status.ManagedDeviceMobileAppConfigurationDeviceStatus] = None, request_configuration: Optional[ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceStatuses in deviceAppManagement
        Args:
            body: The request body
    ...
    @dataclass
    class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
