...
class IosLobAppProvisioningConfigurationAssignmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[IosLobAppProvisioningConfigurationAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[ios_lob_app_provisioning_configuration_assignment.IosLobAppProvisioningConfigurationAssignment] = None, request_configuration: Optional[IosLobAppProvisioningConfigurationAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceAppManagement
        Args:
            body: The request body
