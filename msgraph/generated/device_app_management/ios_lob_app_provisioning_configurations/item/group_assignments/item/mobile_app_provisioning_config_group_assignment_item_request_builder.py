...
class MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, mobile_app_provisioning_config_group_assignment_id: Optional[str] = None) -> None:
        """
        Instantiates a new MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder and sets the default values.
        Args:
            mobileAppProvisioningConfigGroupAssignmentId: key: id of mobileAppProvisioningConfigGroupAssignment
        ...
        url_tpl_params["mobileAppProvisioningConfigGroupAssignment%2Did"] = mobileAppProvisioningConfigGroupAssignmentId
