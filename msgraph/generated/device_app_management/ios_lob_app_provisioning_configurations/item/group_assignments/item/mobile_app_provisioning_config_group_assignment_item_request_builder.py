...
class MobileAppProvisioningConfigGroupAssignmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[MobileAppProvisioningConfigGroupAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
