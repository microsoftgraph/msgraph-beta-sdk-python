...
class EnterpriseCodeSigningCertificatesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/enterpriseCodeSigningCertificates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_enterprise_code_signing_certificate_id(self,enterprise_code_signing_certificate_id: str) -> EnterpriseCodeSigningCertificateItemRequestBuilder:
        """
        Provides operations to manage the enterpriseCodeSigningCertificates property of the microsoft.graph.deviceAppManagement entity.
        param enterprise_code_signing_certificate_id: The unique identifier of enterpriseCodeSigningCertificate
    ...
    def with_url(self,raw_url: Optional[str] = None) -> EnterpriseCodeSigningCertificatesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: EnterpriseCodeSigningCertificatesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return EnterpriseCodeSigningCertificatesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class EnterpriseCodeSigningCertificatesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class EnterpriseCodeSigningCertificatesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
