...
class WindowsInformationProtectionDeviceRegistrationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[WindowsInformationProtectionDeviceRegistrationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
