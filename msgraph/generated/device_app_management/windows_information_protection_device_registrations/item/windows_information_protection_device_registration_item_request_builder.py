...
microsoft_graph_wipe_request_builder = lazy_import('msgraph.generated.device_app_management.windows_information_protection_device_registrations.item.microsoft_graph_wipe.microsoft_graph_wipe_request_builder')
...
class WindowsInformationProtectionDeviceRegistrationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/deviceAppManagement/windowsInformationProtectionDeviceRegistrations/{windowsInformationProtectionDeviceRegistration%2Did}{?%24select,%24expand}"
    ...
    def to_patch_request_information(self,body: Optional[windows_information_protection_device_registration.WindowsInformationProtectionDeviceRegistration] = None, request_configuration: Optional[WindowsInformationProtectionDeviceRegistrationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property windowsInformationProtectionDeviceRegistrations in deviceAppManagement
        Args:
            body: The request body
    ...
    @dataclass
    class WindowsInformationProtectionDeviceRegistrationItemRequestBuilderDeleteRequestConfiguration():
        """
