...
count_request_builder = lazy_import('msgraph.generated.device_app_management.managed_app_registrations.item.intended_policies.count.count_request_builder')
...
class IntendedPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[IntendedPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[IntendedPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[IntendedPoliciesRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[managed_app_policy_collection_response.ManagedAppPolicyCollectionResponse]:
        """
        Zero or more policies admin intended for the app as of now.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def post(self,body: Optional[managed_app_policy.ManagedAppPolicy] = None, request_configuration: Optional[IntendedPoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[managed_app_policy.ManagedAppPolicy]:
        """
        Create new navigation property to intendedPolicies for deviceAppManagement
        Args:
            body: The request body
