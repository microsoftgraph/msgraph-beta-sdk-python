...
class EmailThreatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/threatSubmission/emailThreats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_email_threat_submission_id(self,email_threat_submission_id: str) -> EmailThreatSubmissionItemRequestBuilder:
        ...
        """
        if not email_threat_submission_id:
    ...
    async def get(self,request_configuration: Optional[EmailThreatsRequestBuilderGetRequestConfiguration] = None) -> Optional[EmailThreatSubmissionCollectionResponse]:
        """
        Get a list of the emailThreatSubmission objects and their properties. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[EmailThreatSubmission] = None, request_configuration: Optional[EmailThreatsRequestBuilderPostRequestConfiguration] = None) -> Optional[EmailThreatSubmission]:
        """
        Create a new emailThreatSubmission object. This API is supported in the following national cloud deployments.
    ...
    def to_post_request_information(self,body: Optional[EmailThreatSubmission] = None, request_configuration: Optional[EmailThreatsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create a new emailThreatSubmission object. This API is supported in the following national cloud deployments.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> EmailThreatsRequestBuilder:
        """
    ...
    @dataclass
    class EmailThreatsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class EmailThreatsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
