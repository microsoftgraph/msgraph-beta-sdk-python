...
class GradingCategoryRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/gradingCategory{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[GradingCategoryRequestBuilderGetRequestConfiguration] = None) -> Optional[education_grading_category.EducationGradingCategory]:
        """
    ...
    @dataclass
    class GradingCategoryRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class GradingCategoryRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
