...
class GradingCategoryRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/gradingCategory{?%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GradingCategoryRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GradingCategoryRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GradingCategoryRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class GradingCategoryRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GradingCategoryRequestBuilder.GradingCategoryRequestBuilderGetQueryParameters] = None
