...
count_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.count.count_request_builder')
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.education.users.item.assignments.microsoft_graph_delta.microsoft_graph_delta_request_builder')
...
class AssignmentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/users/{educationUser%2Did}/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[AssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[education_assignment_collection_response.EducationAssignmentCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, education_assignment_collection_response.EducationAssignmentCollectionResponse, error_mapping)
