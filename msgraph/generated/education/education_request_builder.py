...
synchronization_profiles_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.synchronization_profiles_request_builder')
education_synchronization_profile_item_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.education_synchronization_profile_item_request_builder')
...
class EducationRequestBuilder():
    ...
    def synchronization_profiles_by_id(self,id: str) -> Optional[education_synchronization_profile_item_request_builder.EducationSynchronizationProfileItemRequestBuilder]:
        """
        Provides operations to manage the synchronizationProfiles property of the microsoft.graph.educationRoot entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[education_synchronization_profile_item_request_builder.EducationSynchronizationProfileItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
