...
class ActivateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/activate", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ActivateRequestBuilder:
        ...
        return ActivateRequestBuilder(raw_url, self.request_adapter)
