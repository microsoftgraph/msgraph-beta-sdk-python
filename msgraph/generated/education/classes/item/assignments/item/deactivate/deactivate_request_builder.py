...
class DeactivateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/deactivate"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,request_configuration: Optional[DeactivateRequestBuilderPostRequestConfiguration] = None) -> Optional[education_assignment.EducationAssignment]:
        """
    ...
    @dataclass
    class DeactivateRequestBuilderPostRequestConfiguration():
        """
