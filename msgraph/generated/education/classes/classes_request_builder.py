...
count_request_builder = lazy_import('msgraph.generated.education.classes.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.education.classes.delta.delta_request_builder')
education_class = lazy_import('msgraph.generated.models.education_class')
education_class_collection_response = lazy_import('msgraph.generated.models.education_class_collection_response')
...
class ClassesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[ClassesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[education_class.EducationClass] = None, request_configuration: Optional[ClassesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class ClassesRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[ClassesRequestBuilder.ClassesRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ClassesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
