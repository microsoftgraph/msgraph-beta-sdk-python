...
microsoft_graph_pause_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.microsoft_graph_pause.microsoft_graph_pause_request_builder')
microsoft_graph_reset_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.microsoft_graph_reset.microsoft_graph_reset_request_builder')
microsoft_graph_resume_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.microsoft_graph_resume.microsoft_graph_resume_request_builder')
microsoft_graph_start_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.microsoft_graph_start.microsoft_graph_start_request_builder')
microsoft_graph_upload_url_request_builder = lazy_import('msgraph.generated.education.synchronization_profiles.item.microsoft_graph_upload_url.microsoft_graph_upload_url_request_builder')
...
class EducationSynchronizationProfileItemRequestBuilder():
    ...
    @property
    def microsoft_graph_reset(self) -> microsoft_graph_reset_request_builder.MicrosoftGraphResetRequestBuilder:
        """
        Provides operations to call the reset method.
        """
        return microsoft_graph_reset_request_builder.MicrosoftGraphResetRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_resume(self) -> microsoft_graph_resume_request_builder.MicrosoftGraphResumeRequestBuilder:
        """
        Provides operations to call the resume method.
        """
        return microsoft_graph_resume_request_builder.MicrosoftGraphResumeRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def microsoft_graph_upload_url(self) -> microsoft_graph_upload_url_request_builder.MicrosoftGraphUploadUrlRequestBuilder:
        """
        Provides operations to call the uploadUrl method.
        """
        return microsoft_graph_upload_url_request_builder.MicrosoftGraphUploadUrlRequestBuilder(self.request_adapter, self.path_parameters)
