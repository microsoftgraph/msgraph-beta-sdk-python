...
count_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.submissions.count.count_request_builder')
education_submission = lazy_import('msgraph.generated.models.education_submission')
education_submission_collection_response = lazy_import('msgraph.generated.models.education_submission_collection_response')
...
class SubmissionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[education_submission.EducationSubmission] = None, request_configuration: Optional[SubmissionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[SubmissionsRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[education_submission_collection_response.EducationSubmissionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, education_submission_collection_response.EducationSubmissionCollectionResponse, response_handler, error_mapping)
    
    async def post(self,body: Optional[education_submission.EducationSubmission] = None, request_configuration: Optional[SubmissionsRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[education_submission.EducationSubmission]:
        """
        Create new navigation property to submissions for education
        Args:
            body: The request body
    ...
    @dataclass
    class SubmissionsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class SubmissionsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
