...
count_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.submissions.item.outcomes.count.count_request_builder')
education_outcome = lazy_import('msgraph.generated.models.education_outcome')
education_outcome_collection_response = lazy_import('msgraph.generated.models.education_outcome_collection_response')
...
class OutcomesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[OutcomesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[education_outcome.EducationOutcome] = None, request_configuration: Optional[OutcomesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
