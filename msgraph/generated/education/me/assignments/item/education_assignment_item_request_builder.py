...
microsoft_graph_publish_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.microsoft_graph_publish.microsoft_graph_publish_request_builder')
microsoft_graph_set_up_feedback_resources_folder_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.microsoft_graph_set_up_feedback_resources_folder.microsoft_graph_set_up_feedback_resources_folder_request_builder')
microsoft_graph_set_up_resources_folder_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.microsoft_graph_set_up_resources_folder.microsoft_graph_set_up_resources_folder_request_builder')
...
class EducationAssignmentItemRequestBuilder():
    ...
    @property
    def microsoft_graph_set_up_feedback_resources_folder(self) -> microsoft_graph_set_up_feedback_resources_folder_request_builder.MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilder:
        """
        Provides operations to call the setUpFeedbackResourcesFolder method.
        """
        return microsoft_graph_set_up_feedback_resources_folder_request_builder.MicrosoftGraphSetUpFeedbackResourcesFolderRequestBuilder(self.request_adapter, self.path_parameters)
