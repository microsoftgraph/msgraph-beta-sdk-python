...
categories_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.categories.categories_request_builder')
education_category_item_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.categories.item.education_category_item_request_builder')
publish_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.publish.publish_request_builder')
resources_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.resources.resources_request_builder')
education_assignment_resource_item_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.resources.item.education_assignment_resource_item_request_builder')
rubric_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.rubric.rubric_request_builder')
set_up_feedback_resources_folder_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.set_up_feedback_resources_folder.set_up_feedback_resources_folder_request_builder')
set_up_resources_folder_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.set_up_resources_folder.set_up_resources_folder_request_builder')
submissions_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.submissions.submissions_request_builder')
education_submission_item_request_builder = lazy_import('msgraph.generated.education.me.assignments.item.submissions.item.education_submission_item_request_builder')
...
class EducationAssignmentItemRequestBuilder():
    ...
    def categories_by_id(self,id: str) -> Optional[education_category_item_request_builder.EducationCategoryItemRequestBuilder]:
        """
        Gets an item from the msgraph.generated.education.me.assignments.item.categories.item collection
        Args:
            id: Unique identifier of the item
        Returns: Optional[education_category_item_request_builder.EducationCategoryItemRequestBuilder]
        """
        if id is None:
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}{?%24select,%24expand}"
    ...
    def resources_by_id(self,id: str) -> Optional[education_assignment_resource_item_request_builder.EducationAssignmentResourceItemRequestBuilder]:
        """
        Provides operations to manage the resources property of the microsoft.graph.educationAssignment entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[education_assignment_resource_item_request_builder.EducationAssignmentResourceItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def submissions_by_id(self,id: str) -> Optional[education_submission_item_request_builder.EducationSubmissionItemRequestBuilder]:
        """
        Provides operations to manage the submissions property of the microsoft.graph.educationAssignment entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[education_submission_item_request_builder.EducationSubmissionItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
