...
class TaughtClassesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/me/taughtClasses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[TaughtClassesRequestBuilderGetRequestConfiguration] = None) -> Optional[EducationClassCollectionResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TaughtClassesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: TaughtClassesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return TaughtClassesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class TaughtClassesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
