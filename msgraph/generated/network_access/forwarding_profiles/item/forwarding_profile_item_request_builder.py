...
class ForwardingProfileItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/networkAccess/forwardingProfiles/{forwardingProfile%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ForwardingProfileItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ForwardingProfile]:
        """
        Retrieve information about a specific forwarding profile. This API is supported in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[ForwardingProfile] = None, request_configuration: Optional[ForwardingProfileItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ForwardingProfile]:
        """
        Update an existing forwarding profile. This API is supported in the following national cloud deployments.
