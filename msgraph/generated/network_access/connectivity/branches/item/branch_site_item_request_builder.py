...
if TYPE_CHECKING:
    ...
    from .device_links import device_links_request_builder
    from .forwarding_profiles import forwarding_profiles_request_builder

class BranchSiteItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[BranchSiteItemRequestBuilderGetRequestConfiguration] = None) -> Optional[branch_site.BranchSite]:
        """
    ...
    async def patch(self,body: Optional[branch_site.BranchSite] = None, request_configuration: Optional[BranchSiteItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[branch_site.BranchSite]:
        """
    ...
    def to_patch_request_information(self,body: Optional[branch_site.BranchSite] = None, request_configuration: Optional[BranchSiteItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property branches in networkAccess
        Args:
            body: The request body
    ...
    @property
    def device_links(self) -> device_links_request_builder.DeviceLinksRequestBuilder:
        """
        Provides operations to manage the deviceLinks property of the microsoft.graph.networkaccess.branchSite entity.
        """
        from .device_links import device_links_request_builder

        return device_links_request_builder.DeviceLinksRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class BranchSiteItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class BranchSiteItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class BranchSiteItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
