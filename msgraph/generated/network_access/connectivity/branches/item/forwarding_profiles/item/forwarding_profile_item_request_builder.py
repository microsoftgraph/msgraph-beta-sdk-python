...
if TYPE_CHECKING:
    from .......models.networkaccess import forwarding_profile
    from .......models.o_data_errors import o_data_error
    from .policies import policies_request_builder

class ForwardingProfileItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/forwardingProfiles/{forwardingProfile%2Did}{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[ForwardingProfileItemRequestBuilderGetRequestConfiguration] = None) -> Optional[forwarding_profile.ForwardingProfile]:
        """
        Get forwardingProfiles from networkAccess
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[forwarding_profile.ForwardingProfile]
        """
        ...
        return await self.request_adapter.send_async(request_info, forwarding_profile.ForwardingProfile, error_mapping)
    
    async def patch(self,body: Optional[forwarding_profile.ForwardingProfile] = None, request_configuration: Optional[ForwardingProfileItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[forwarding_profile.ForwardingProfile]:
        """
    ...
    def to_patch_request_information(self,body: Optional[forwarding_profile.ForwardingProfile] = None, request_configuration: Optional[ForwardingProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property forwardingProfiles in networkAccess
        Args:
            body: The request body
    ...
    @dataclass
    class ForwardingProfileItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class ForwardingProfileItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class ForwardingProfileItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
