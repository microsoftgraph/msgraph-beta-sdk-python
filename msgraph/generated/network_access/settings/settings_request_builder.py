...
if TYPE_CHECKING:
    from ...models.networkaccess import settings
    from ...models.o_data_errors import o_data_error
    from .conditional_access import conditional_access_request_builder
    from .cross_tenant_access import cross_tenant_access_request_builder
    from .enriched_audit_logs import enriched_audit_logs_request_builder
    from .forwarding_options import forwarding_options_request_builder
...
class SettingsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/networkAccess/settings{?%24select,%24expand}"
    ...
    @property
    def cross_tenant_access(self) -> cross_tenant_access_request_builder.CrossTenantAccessRequestBuilder:
        """
        Provides operations to manage the crossTenantAccess property of the microsoft.graph.networkaccess.settings entity.
        """
        from .cross_tenant_access import cross_tenant_access_request_builder

        return cross_tenant_access_request_builder.CrossTenantAccessRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def enriched_audit_logs(self) -> enriched_audit_logs_request_builder.EnrichedAuditLogsRequestBuilder:
        """
        Provides operations to manage the enrichedAuditLogs property of the microsoft.graph.networkaccess.settings entity.
        """
        from .enriched_audit_logs import enriched_audit_logs_request_builder

        return enriched_audit_logs_request_builder.EnrichedAuditLogsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def forwarding_options(self) -> forwarding_options_request_builder.ForwardingOptionsRequestBuilder:
        """
        Provides operations to manage the forwardingOptions property of the microsoft.graph.networkaccess.settings entity.
        """
        from .forwarding_options import forwarding_options_request_builder

        return forwarding_options_request_builder.ForwardingOptionsRequestBuilder(self.request_adapter, self.path_parameters)
