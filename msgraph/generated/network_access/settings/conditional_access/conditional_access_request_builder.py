...
if TYPE_CHECKING:
    from ....models.networkaccess import conditional_access_settings
...
class ConditionalAccessRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/networkAccess/settings/conditionalAccess{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[ConditionalAccessRequestBuilderGetRequestConfiguration] = None) -> Optional[conditional_access_settings.ConditionalAccessSettings]:
        """
        Get conditionalAccess from networkAccess
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[conditional_access_settings.ConditionalAccessSettings]
        """
        ...
        return await self.request_adapter.send_async(request_info, conditional_access_settings.ConditionalAccessSettings, error_mapping)
    
    async def patch(self,body: Optional[conditional_access_settings.ConditionalAccessSettings] = None, request_configuration: Optional[ConditionalAccessRequestBuilderPatchRequestConfiguration] = None) -> Optional[conditional_access_settings.ConditionalAccessSettings]:
        """
    ...
    def to_patch_request_information(self,body: Optional[conditional_access_settings.ConditionalAccessSettings] = None, request_configuration: Optional[ConditionalAccessRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property conditionalAccess in networkAccess
        Args:
            body: The request body
