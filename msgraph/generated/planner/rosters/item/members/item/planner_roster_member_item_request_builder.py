...
from ......models import planner_roster_member
from ......models.o_data_errors import o_data_error

class PlannerRosterMemberItemRequestBuilder():
    """
    ...
    def create_delete_request_information(self,request_configuration: Optional[PlannerRosterMemberItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PlannerRosterMemberItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[planner_roster_member.PlannerRosterMember] = None, request_configuration: Optional[PlannerRosterMemberItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PlannerRosterMemberItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PlannerRosterMemberItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
