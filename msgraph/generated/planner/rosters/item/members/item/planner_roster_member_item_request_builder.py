...
class PlannerRosterMemberItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[PlannerRosterMemberItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[planner_roster_member.PlannerRosterMember] = None, request_configuration: Optional[PlannerRosterMemberItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property members in planner
        Args:
            body: The request body
