...
tasks_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.tasks_request_builder')
planner_task_item_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.item.planner_task_item_request_builder')
...
class PlannerBucketItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/planner/buckets/{plannerBucket%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[PlannerBucketItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[PlannerBucketItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[planner_bucket.PlannerBucket] = None, request_configuration: Optional[PlannerBucketItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class PlannerBucketItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class PlannerBucketItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
