...
assigned_to_task_board_format_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.item.assigned_to_task_board_format.assigned_to_task_board_format_request_builder')
bucket_task_board_format_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.item.bucket_task_board_format.bucket_task_board_format_request_builder')
details_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.item.details.details_request_builder')
progress_task_board_format_request_builder = lazy_import('msgraph.generated.planner.buckets.item.tasks.item.progress_task_board_format.progress_task_board_format_request_builder')
