...
if TYPE_CHECKING:
    from .....models import learning_course_activity, learning_course_activity_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import learning_course_activity_item_request_builder
...
class LearningCourseActivitiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_learning_course_activity_id(self,learning_course_activity_id: str) -> learning_course_activity_item_request_builder.LearningCourseActivityItemRequestBuilder:
        """
        Provides operations to manage the learningCourseActivities property of the microsoft.graph.learningProvider entity.
        Args:
            learning_course_activity_id: Unique identifier of the item
        Returns: learning_course_activity_item_request_builder.LearningCourseActivityItemRequestBuilder
        """
        if learning_course_activity_id is None:
            raise Exception("learning_course_activity_id cannot be undefined")
        from .item import learning_course_activity_item_request_builder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["learningCourseActivity%2Did"] = learning_course_activity_id
        return learning_course_activity_item_request_builder.LearningCourseActivityItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[LearningCourseActivitiesRequestBuilderGetRequestConfiguration] = None) -> Optional[learning_course_activity_collection_response.LearningCourseActivityCollectionResponse]:
        ...
        from .....models import learning_course_activity_collection_response

        return await self.request_adapter.send_async(request_info, learning_course_activity_collection_response.LearningCourseActivityCollectionResponse, error_mapping)
    ...
    @dataclass
    class LearningCourseActivitiesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class LearningCourseActivitiesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
