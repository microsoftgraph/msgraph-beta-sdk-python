...
count_request_builder = lazy_import('msgraph.generated.employee_experience.learning_providers.item.learning_contents.count.count_request_builder')
learning_content = lazy_import('msgraph.generated.models.learning_content')
learning_content_collection_response = lazy_import('msgraph.generated.models.learning_content_collection_response')
...
class LearningContentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[LearningContentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[learning_content.LearningContent] = None, request_configuration: Optional[LearningContentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class LearningContentsRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[LearningContentsRequestBuilder.LearningContentsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class LearningContentsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
