...
class LearningContentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, learning_content_id: Optional[str] = None) -> None:
        """
        Instantiates a new LearningContentItemRequestBuilder and sets the default values.
        Args:
            learningContentId: key: id of learningContent
        ...
        url_tpl_params["learningContent%2Did"] = learningContentId
