...
class ConfirmSafeRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ConfirmSafePostRequestBody] = None, request_configuration: Optional[ConfirmSafeRequestBuilderPostRequestConfiguration] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: Optional[ConfirmSafePostRequestBody] = None, request_configuration: Optional[ConfirmSafeRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Allow admins to mark an event in Azure AD sign in logs as safe. Admins can either mark the events flagged as risky by Azure AD Identity Protection as safe, or they can mark unflagged events as safe. For details about investigating Identity Protection risks, see How to investigate risk.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ConfirmSafeRequestBuilder:
        """
        ...
        return ConfirmSafeRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ConfirmSafeRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
