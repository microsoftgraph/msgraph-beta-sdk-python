...
microsoft_graph_confirm_compromised_request_builder = lazy_import('msgraph.generated.audit_logs.sign_ins.microsoft_graph_confirm_compromised.microsoft_graph_confirm_compromised_request_builder')
microsoft_graph_confirm_safe_request_builder = lazy_import('msgraph.generated.audit_logs.sign_ins.microsoft_graph_confirm_safe.microsoft_graph_confirm_safe_request_builder')
...
class SignInsRequestBuilder():
    ...
    @property
    def microsoft_graph_confirm_safe(self) -> microsoft_graph_confirm_safe_request_builder.MicrosoftGraphConfirmSafeRequestBuilder:
        """
        Provides operations to call the confirmSafe method.
        """
        return microsoft_graph_confirm_safe_request_builder.MicrosoftGraphConfirmSafeRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/auditLogs/signIns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    @dataclass
    class SignInsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
