...
confirm_compromised_post_request_body = lazy_import('msgraph.generated.audit_logs.sign_ins.microsoft_graph_confirm_compromised.confirm_compromised_post_request_body')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class ConfirmCompromisedRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/auditLogs/signIns/microsoft.graph.confirmCompromised"
