...
class PrivacyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privacy{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[PrivacyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get privacy
        Args:
    ...
    def create_patch_request_information(self,body: Optional[privacy.Privacy] = None, request_configuration: Optional[PrivacyRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update privacy
        Args:
    ...
    async def get(self,request_configuration: Optional[PrivacyRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[privacy.Privacy]:
        """
        Get privacy
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def patch(self,body: Optional[privacy.Privacy] = None, request_configuration: Optional[PrivacyRequestBuilderPatchRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[privacy.Privacy]:
        """
        Update privacy
        Args:
            body: The request body
    ...
    class PrivacyRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[PrivacyRequestBuilder.PrivacyRequestBuilderGetQueryParameters] = None
