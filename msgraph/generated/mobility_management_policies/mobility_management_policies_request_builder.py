...
count_request_builder = lazy_import('msgraph.generated.mobility_management_policies.count.count_request_builder')
mobility_management_policy = lazy_import('msgraph.generated.models.mobility_management_policy')
mobility_management_policy_collection_response = lazy_import('msgraph.generated.models.mobility_management_policy_collection_response')
...
class MobilityManagementPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[MobilityManagementPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mobility_management_policy.MobilityManagementPolicy] = None, request_configuration: Optional[MobilityManagementPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[MobilityManagementPoliciesRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mobility_management_policy_collection_response.MobilityManagementPolicyCollectionResponse]:
        """
        Get entities from mobilityManagementPolicies
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def post(self,body: Optional[mobility_management_policy.MobilityManagementPolicy] = None, request_configuration: Optional[MobilityManagementPoliciesRequestBuilderPostRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[mobility_management_policy.MobilityManagementPolicy]:
        """
        Add new entity to mobilityManagementPolicies
        Args:
            body: The request body
