...
hosted_contents_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.hosted_contents.hosted_contents_request_builder')
chat_message_hosted_content_item_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.hosted_contents.item.chat_message_hosted_content_item_request_builder')
microsoft_graph_set_reaction_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.microsoft_graph_set_reaction.microsoft_graph_set_reaction_request_builder')
microsoft_graph_soft_delete_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.microsoft_graph_soft_delete.microsoft_graph_soft_delete_request_builder')
microsoft_graph_undo_soft_delete_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.microsoft_graph_undo_soft_delete.microsoft_graph_undo_soft_delete_request_builder')
microsoft_graph_unset_reaction_request_builder = lazy_import('msgraph.generated.chats.item.messages.item.replies.item.microsoft_graph_unset_reaction.microsoft_graph_unset_reaction_request_builder')
