...
get_member_groups_post_request_body = lazy_import('msgraph.generated.chats.item.permission_grants.item.get_member_groups.get_member_groups_post_request_body')
get_member_groups_response = lazy_import('msgraph.generated.chats.item.permission_grants.item.get_member_groups.get_member_groups_response')
...
class GetMemberGroupsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups"
