...
check_member_groups_post_request_body = lazy_import('msgraph.generated.chats.item.permission_grants.item.microsoft_graph_check_member_groups.check_member_groups_post_request_body')
check_member_groups_response = lazy_import('msgraph.generated.chats.item.permission_grants.item.microsoft_graph_check_member_groups.check_member_groups_response')
...
class CheckMemberGroupsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/microsoft.graph.checkMemberGroups"
