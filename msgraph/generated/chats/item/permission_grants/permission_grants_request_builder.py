...
count_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.count.count_request_builder')
microsoft_graph_get_by_ids_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_get_by_ids.microsoft_graph_get_by_ids_request_builder')
microsoft_graph_get_user_owned_objects_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_get_user_owned_objects.microsoft_graph_get_user_owned_objects_request_builder')
microsoft_graph_validate_properties_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_validate_properties.microsoft_graph_validate_properties_request_builder')
...
class PermissionGrantsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
