...
get_by_ids_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_get_user_owned_objects.get_user_owned_objects_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_validate_properties.validate_properties_request_builder')
