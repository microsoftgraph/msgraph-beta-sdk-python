...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.chats.item.permission_grants.microsoft_graph_get_user_owned_objects.get_user_owned_objects_post_request_body')
