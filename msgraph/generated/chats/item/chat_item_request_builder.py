...
hide_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_hide_for_user.hide_for_user_request_builder')
mark_chat_read_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_mark_chat_read_for_user.mark_chat_read_for_user_request_builder')
mark_chat_unread_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_mark_chat_unread_for_user.mark_chat_unread_for_user_request_builder')
send_activity_notification_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_send_activity_notification.send_activity_notification_request_builder')
unhide_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_unhide_for_user.unhide_for_user_request_builder')
