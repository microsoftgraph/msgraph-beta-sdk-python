...
microsoft_graph_hide_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_hide_for_user.microsoft_graph_hide_for_user_request_builder')
microsoft_graph_mark_chat_read_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_mark_chat_read_for_user.microsoft_graph_mark_chat_read_for_user_request_builder')
microsoft_graph_mark_chat_unread_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_mark_chat_unread_for_user.microsoft_graph_mark_chat_unread_for_user_request_builder')
microsoft_graph_send_activity_notification_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_send_activity_notification.microsoft_graph_send_activity_notification_request_builder')
microsoft_graph_unhide_for_user_request_builder = lazy_import('msgraph.generated.chats.item.microsoft_graph_unhide_for_user.microsoft_graph_unhide_for_user_request_builder')
