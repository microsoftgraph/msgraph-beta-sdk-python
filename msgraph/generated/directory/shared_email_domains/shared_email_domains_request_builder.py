...
class SharedEmailDomainsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SharedEmailDomainsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SharedEmailDomainsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return SharedEmailDomainsRequestBuilder(self.request_adapter, raw_url)
