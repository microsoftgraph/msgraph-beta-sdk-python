...
class TenantsRequestBuilder():
    ...
    async def post(self,body: Optional[TenantReference] = None, request_configuration: Optional[TenantsRequestBuilderPostRequestConfiguration] = None) -> Optional[TenantReference]:
        """
    ...
    def to_post_request_information(self,body: Optional[TenantReference] = None, request_configuration: Optional[TenantsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tenants for directory
        Args:
            body: The request body
