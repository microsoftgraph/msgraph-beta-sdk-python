...
class TenantReferenceTenantItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TenantReferenceTenantItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TenantReferenceTenantItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[tenant_reference.TenantReference] = None, request_configuration: Optional[TenantReferenceTenantItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
