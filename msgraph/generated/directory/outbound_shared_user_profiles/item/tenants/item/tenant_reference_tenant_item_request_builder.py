...
microsoft_graph_remove_personal_data_request_builder = lazy_import('msgraph.generated.directory.outbound_shared_user_profiles.item.tenants.item.microsoft_graph_remove_personal_data.microsoft_graph_remove_personal_data_request_builder')
...
class TenantReferenceTenantItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[tenant_reference.TenantReference] = None, request_configuration: Optional[TenantReferenceTenantItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property tenants in directory
        Args:
            body: The request body
    ...
    @dataclass
    class TenantReferenceTenantItemRequestBuilderDeleteRequestConfiguration():
        """
