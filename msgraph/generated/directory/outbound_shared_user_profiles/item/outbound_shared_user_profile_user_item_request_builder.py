...
class OutboundSharedUserProfileUserItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile%2DuserId}{?%24select,%24expand}", path_parameters)
    ...
    async def patch(self,body: Optional[OutboundSharedUserProfile] = None, request_configuration: Optional[OutboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[OutboundSharedUserProfile]:
        """
    ...
    def to_patch_request_information(self,body: Optional[OutboundSharedUserProfile] = None, request_configuration: Optional[OutboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property outboundSharedUserProfiles in directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> OutboundSharedUserProfileUserItemRequestBuilder:
        """
    ...
    @dataclass
    class OutboundSharedUserProfileUserItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class OutboundSharedUserProfileUserItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class OutboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
