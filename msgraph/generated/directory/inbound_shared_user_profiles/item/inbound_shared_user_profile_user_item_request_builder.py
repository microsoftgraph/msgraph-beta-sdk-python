...
microsoft_graph_export_personal_data_request_builder = lazy_import('msgraph.generated.directory.inbound_shared_user_profiles.item.microsoft_graph_export_personal_data.microsoft_graph_export_personal_data_request_builder')
microsoft_graph_remove_personal_data_request_builder = lazy_import('msgraph.generated.directory.inbound_shared_user_profiles.item.microsoft_graph_remove_personal_data.microsoft_graph_remove_personal_data_request_builder')
...
class InboundSharedUserProfileUserItemRequestBuilder():
    ...
    @property
    def microsoft_graph_remove_personal_data(self) -> microsoft_graph_remove_personal_data_request_builder.MicrosoftGraphRemovePersonalDataRequestBuilder:
        """
        Provides operations to call the removePersonalData method.
        """
        return microsoft_graph_remove_personal_data_request_builder.MicrosoftGraphRemovePersonalDataRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[inbound_shared_user_profile.InboundSharedUserProfile] = None, request_configuration: Optional[InboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property inboundSharedUserProfiles in directory
        Args:
            body: The request body
    ...
    @dataclass
    class InboundSharedUserProfileUserItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
