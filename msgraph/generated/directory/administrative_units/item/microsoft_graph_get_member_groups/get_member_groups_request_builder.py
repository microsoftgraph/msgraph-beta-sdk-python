...
get_member_groups_post_request_body = lazy_import('msgraph.generated.directory.administrative_units.item.microsoft_graph_get_member_groups.get_member_groups_post_request_body')
get_member_groups_response = lazy_import('msgraph.generated.directory.administrative_units.item.microsoft_graph_get_member_groups.get_member_groups_response')
