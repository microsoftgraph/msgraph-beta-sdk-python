...
class ReactivateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/recommendations/{recommendation%2Did}/reactivate", path_parameters)
    
    async def post(self,request_configuration: Optional[ReactivateRequestBuilderPostRequestConfiguration] = None) -> Optional[Recommendation]:
        """
        Reactivate a completed, dismissed, or postponed recommendation object. This action updates the status of the recommendation to active. This method only works when the status of the recommendation is completedByUser, dismissed, or postponed. This API is supported in the following national cloud deployments.
