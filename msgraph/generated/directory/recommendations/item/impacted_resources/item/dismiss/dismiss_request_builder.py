...
dismiss_post_request_body = lazy_import('msgraph.generated.directory.recommendations.item.impacted_resources.item.dismiss.dismiss_post_request_body')
...
class DismissRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{recommendationResource%2Did}/microsoft.graph.dismiss"
