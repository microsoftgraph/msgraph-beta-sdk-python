...
count_request_builder = lazy_import('msgraph.generated.directory.recommendations.item.impacted_resources.count.count_request_builder')
...
class ImpactedResourcesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
