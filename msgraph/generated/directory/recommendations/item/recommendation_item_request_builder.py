...
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.directory.recommendations.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
microsoft_graph_dismiss_request_builder = lazy_import('msgraph.generated.directory.recommendations.item.microsoft_graph_dismiss.microsoft_graph_dismiss_request_builder')
microsoft_graph_postpone_request_builder = lazy_import('msgraph.generated.directory.recommendations.item.microsoft_graph_postpone.microsoft_graph_postpone_request_builder')
microsoft_graph_reactivate_request_builder = lazy_import('msgraph.generated.directory.recommendations.item.microsoft_graph_reactivate.microsoft_graph_reactivate_request_builder')
