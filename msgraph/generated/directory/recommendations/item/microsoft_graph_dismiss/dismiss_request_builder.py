...
dismiss_post_request_body = lazy_import('msgraph.generated.directory.recommendations.item.microsoft_graph_dismiss.dismiss_post_request_body')
...
class DismissRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/recommendations/{recommendation%2Did}/microsoft.graph.dismiss"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,body: Optional[dismiss_post_request_body.DismissPostRequestBody] = None, request_configuration: Optional[DismissRequestBuilderPostRequestConfiguration] = None) -> Optional[recommendation.Recommendation]:
        """
