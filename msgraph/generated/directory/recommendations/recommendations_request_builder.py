...
class RecommendationsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[recommendation.Recommendation] = None, request_configuration: Optional[RecommendationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to recommendations for directory
        Args:
            body: The request body
