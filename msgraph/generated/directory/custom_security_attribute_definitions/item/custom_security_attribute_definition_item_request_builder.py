...
class CustomSecurityAttributeDefinitionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, custom_security_attribute_definition_id: Optional[str] = None) -> None:
        """
        ...
        url_tpl_params["customSecurityAttributeDefinition%2Did"] = customSecurityAttributeDefinitionId
