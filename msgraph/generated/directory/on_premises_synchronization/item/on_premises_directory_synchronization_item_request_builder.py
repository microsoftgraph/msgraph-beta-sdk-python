...
class OnPremisesDirectorySynchronizationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, on_premises_directory_synchronization_id: Optional[str] = None) -> None:
        """
        Instantiates a new OnPremisesDirectorySynchronizationItemRequestBuilder and sets the default values.
        Args:
            onPremisesDirectorySynchronizationId: key: id of onPremisesDirectorySynchronization
        ...
        url_tpl_params["onPremisesDirectorySynchronization%2Did"] = onPremisesDirectorySynchronizationId
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[OnPremisesDirectorySynchronizationItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
