...
class TrustedCertificateAuthoritiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/certificateAuthorities/certificateBasedApplicationConfigurations/{certificateBasedApplicationConfiguration%2Did}/trustedCertificateAuthorities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[TrustedCertificateAuthoritiesRequestBuilderGetRequestConfiguration] = None) -> Optional[CertificateAuthorityAsEntityCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[CertificateAuthorityAsEntity] = None, request_configuration: Optional[TrustedCertificateAuthoritiesRequestBuilderPostRequestConfiguration] = None) -> Optional[CertificateAuthorityAsEntity]:
        """
    ...
    def to_post_request_information(self,body: Optional[CertificateAuthorityAsEntity] = None, request_configuration: Optional[TrustedCertificateAuthoritiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to trustedCertificateAuthorities for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TrustedCertificateAuthoritiesRequestBuilder:
        ...
        return TrustedCertificateAuthoritiesRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class TrustedCertificateAuthoritiesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class TrustedCertificateAuthoritiesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
