...
class AttributeSetItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, attribute_set_id: Optional[str] = None) -> None:
        """
        Instantiates a new AttributeSetItemRequestBuilder and sets the default values.
        Args:
            attributeSetId: key: id of attributeSet
        ...
        url_tpl_params["attributeSet%2Did"] = attributeSetId
    ...
    async def get(self,request_configuration: Optional[AttributeSetItemRequestBuilderGetRequestConfiguration] = None) -> Optional[attribute_set.AttributeSet]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, attribute_set.AttributeSet, error_mapping)
