...
applies_to_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.applies_to_request_builder')
directory_object_item_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.item.directory_object_item_request_builder')
...
class FeatureRolloutPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}{?%24select,%24expand}"
