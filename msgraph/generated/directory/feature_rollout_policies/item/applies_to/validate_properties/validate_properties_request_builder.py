...
validate_properties_post_request_body = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.validate_properties.validate_properties_post_request_body')
...
class ValidatePropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/validateProperties"
