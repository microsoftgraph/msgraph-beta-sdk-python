...
get_by_ids_post_request_body = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.get_by_ids.get_by_ids_post_request_body')
get_by_ids_response = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.get_by_ids.get_by_ids_response')
...
class GetByIdsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/getByIds"
