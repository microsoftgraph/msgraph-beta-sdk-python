...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.get_user_owned_objects.get_user_owned_objects_post_request_body')
