...
delta_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.delta.delta_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.get_user_owned_objects.get_user_owned_objects_request_builder')
...
validate_properties_request_builder = lazy_import('msgraph.generated.directory.feature_rollout_policies.item.applies_to.validate_properties.validate_properties_request_builder')
