...
from ...models import recommendation_resource, recommendation_resource_collection_response
...
class ImpactedResourcesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ImpactedResourcesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[recommendation_resource.RecommendationResource] = None, request_configuration: Optional[ImpactedResourcesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
