...
class RecommendationResourceItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directory/impactedResources/{recommendationResource%2Did}{?%24select,%24expand}"
    ...
    def to_delete_request_information(self,request_configuration: Optional[RecommendationResourceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property impactedResources for directory
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[RecommendationResourceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get impactedResources from directory
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[recommendation_resource.RecommendationResource] = None, request_configuration: Optional[RecommendationResourceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property impactedResources in directory
        Args:
            body: The request body
