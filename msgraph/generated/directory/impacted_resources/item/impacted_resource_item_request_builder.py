...
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
microsoft_graph_dismiss_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_dismiss.microsoft_graph_dismiss_request_builder')
microsoft_graph_postpone_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_postpone.microsoft_graph_postpone_request_builder')
microsoft_graph_reactivate_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_reactivate.microsoft_graph_reactivate_request_builder')
...
class ImpactedResourceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_postpone(self) -> microsoft_graph_postpone_request_builder.MicrosoftGraphPostponeRequestBuilder:
        """
        Provides operations to call the postpone method.
        """
        return microsoft_graph_postpone_request_builder.MicrosoftGraphPostponeRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_reactivate(self) -> microsoft_graph_reactivate_request_builder.MicrosoftGraphReactivateRequestBuilder:
        """
        Provides operations to call the reactivate method.
        """
        return microsoft_graph_reactivate_request_builder.MicrosoftGraphReactivateRequestBuilder(self.request_adapter, self.path_parameters)
