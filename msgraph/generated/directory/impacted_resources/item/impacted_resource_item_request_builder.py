...
complete_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_complete.complete_request_builder')
dismiss_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_dismiss.dismiss_request_builder')
postpone_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_postpone.postpone_request_builder')
reactivate_request_builder = lazy_import('msgraph.generated.directory.impacted_resources.item.microsoft_graph_reactivate.reactivate_request_builder')
...
class ImpactedResourceItemRequestBuilder():
    ...
    @property
    def microsoft_graph_postpone(self) -> postpone_request_builder.PostponeRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_reactivate(self) -> reactivate_request_builder.ReactivateRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, impacted_resource_id: Optional[str] = None) -> None:
        """
        Instantiates a new ImpactedResourceItemRequestBuilder and sets the default values.
        Args:
            impactedResourceId: key: id of impactedResource
        ...
        url_tpl_params["impactedResource%2Did"] = impactedResourceId
