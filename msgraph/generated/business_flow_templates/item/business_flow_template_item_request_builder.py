...
class BusinessFlowTemplateItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, business_flow_template_id: Optional[str] = None) -> None:
        """
        Instantiates a new BusinessFlowTemplateItemRequestBuilder and sets the default values.
        Args:
            businessFlowTemplateId: key: id of businessFlowTemplate
        ...
        url_tpl_params["businessFlowTemplate%2Did"] = businessFlowTemplateId
