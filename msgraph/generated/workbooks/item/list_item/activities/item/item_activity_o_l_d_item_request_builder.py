...
drive_item_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.activities.item.drive_item.drive_item_request_builder')
list_item_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.activities.item.list_item.list_item_request_builder')
...
class ItemActivityOLDItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
    ...
    def create_delete_request_information(self,request_configuration: Optional[ItemActivityOLDItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property activities for workbooks
        Args:
    ...
    def create_patch_request_information(self,body: Optional[item_activity_o_l_d.ItemActivityOLD] = None, request_configuration: Optional[ItemActivityOLDItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property activities in workbooks
        Args:
