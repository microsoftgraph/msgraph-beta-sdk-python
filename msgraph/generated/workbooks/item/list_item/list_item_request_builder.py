...
activities_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.analytics.analytics_request_builder')
create_link_request_builder = lazy_import('msgraph.generated.workbooks.item.list_item.create_link.create_link_request_builder')
...
class ListItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/workbooks/{driveItem%2Did}/listItem{?%24select,%24expand}"
