...
class GovernanceRoleAssignmentsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/governanceRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[GovernanceRoleAssignmentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[GovernanceRoleAssignment] = None, request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration] = None) -> Optional[GovernanceRoleAssignment]:
        """
    ...
    def to_post_request_information(self,body: Optional[GovernanceRoleAssignment] = None, request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to governanceRoleAssignments
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GovernanceRoleAssignmentsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GovernanceRoleAssignmentsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GovernanceRoleAssignmentsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GovernanceRoleAssignmentsRequestBuilderGetQueryParameters():
        """
        Get entities from governanceRoleAssignments
        """
    ...
    @dataclass
    class GovernanceRoleAssignmentsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GovernanceRoleAssignmentsRequestBuilder.GovernanceRoleAssignmentsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
