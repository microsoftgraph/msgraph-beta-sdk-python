...
export_request_builder = lazy_import('msgraph.generated.governance_role_assignments.export.export_request_builder')
...
class GovernanceRoleAssignmentsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[governance_role_assignment.GovernanceRoleAssignment] = None, request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
