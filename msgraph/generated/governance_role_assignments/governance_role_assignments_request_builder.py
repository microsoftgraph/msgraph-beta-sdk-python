...
count_request_builder = lazy_import('msgraph.generated.governance_role_assignments.count.count_request_builder')
microsoft_graph_export_request_builder = lazy_import('msgraph.generated.governance_role_assignments.microsoft_graph_export.microsoft_graph_export_request_builder')
...
class GovernanceRoleAssignmentsRequestBuilder():
    ...
    @property
    def microsoft_graph_export(self) -> microsoft_graph_export_request_builder.MicrosoftGraphExportRequestBuilder:
        """
        Provides operations to call the export method.
        """
        return microsoft_graph_export_request_builder.MicrosoftGraphExportRequestBuilder(self.request_adapter, self.path_parameters)
