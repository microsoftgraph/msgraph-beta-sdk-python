...
if TYPE_CHECKING:
    from ..models import governance_role_assignment, governance_role_assignment_collection_response
    from ..models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .export import export_request_builder
    from .item import governance_role_assignment_item_request_builder

class GovernanceRoleAssignmentsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/governanceRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_governance_role_assignment_id(self,governance_role_assignment_id: str) -> governance_role_assignment_item_request_builder.GovernanceRoleAssignmentItemRequestBuilder:
        """
        Provides operations to manage the collection of governanceRoleAssignment entities.
        Args:
            governance_role_assignment_id: Unique identifier of the item
        ...
        if governance_role_assignment_id is None:
            raise Exception("governance_role_assignment_id cannot be undefined")
        from .item import governance_role_assignment_item_request_builder
    ...
    async def get(self,request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[governance_role_assignment_collection_response.GovernanceRoleAssignmentCollectionResponse]:
        ...
        from ..models import governance_role_assignment_collection_response
    ...
    def to_post_request_information(self,body: Optional[governance_role_assignment.GovernanceRoleAssignment] = None, request_configuration: Optional[GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to governanceRoleAssignments
        Args:
            body: The request body
    ...
    @dataclass
    class GovernanceRoleAssignmentsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class GovernanceRoleAssignmentsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
