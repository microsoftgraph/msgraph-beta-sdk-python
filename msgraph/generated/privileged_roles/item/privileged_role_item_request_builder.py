...
self_activate_request_builder = lazy_import('msgraph.generated.privileged_roles.item.microsoft_graph_self_activate.self_activate_request_builder')
self_deactivate_request_builder = lazy_import('msgraph.generated.privileged_roles.item.microsoft_graph_self_deactivate.self_deactivate_request_builder')
...
class PrivilegedRoleItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, privileged_role_id: Optional[str] = None) -> None:
        """
        Instantiates a new PrivilegedRoleItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            privilegedRoleId: key: id of privilegedRole
        ...
        url_tpl_params["privilegedRole%2Did"] = privilegedRoleId
