...
count_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_application.count.count_request_builder')
...
class GraphApplicationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[GraphApplicationRequestBuilderGetRequestConfiguration] = None) -> Optional[application_collection_response.ApplicationCollectionResponse]:
        """
