...
count_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.microsoft_graph_user.count.count_request_builder')
...
class UserRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
