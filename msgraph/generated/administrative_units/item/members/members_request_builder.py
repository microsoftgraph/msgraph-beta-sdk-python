...
application_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.application.application_request_builder')
count_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.count.count_request_builder')
device_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.org_contact.org_contact_request_builder')
ref_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.user.user_request_builder')
