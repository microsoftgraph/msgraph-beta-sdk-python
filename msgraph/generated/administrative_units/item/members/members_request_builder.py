...
graph_application_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_application.graph_application_request_builder')
graph_device_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_device.graph_device_request_builder')
graph_group_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_group.graph_group_request_builder')
graph_org_contact_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_org_contact.graph_org_contact_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_service_principal.graph_service_principal_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.graph_user.graph_user_request_builder')
