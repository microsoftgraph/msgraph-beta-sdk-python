...
application_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.application.application_request_builder')
device_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.org_contact.org_contact_request_builder')
ref_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.administrative_units.item.members.item.user.user_request_builder')
