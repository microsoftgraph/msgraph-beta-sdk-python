...
delta_request_builder = lazy_import('msgraph.generated.administrative_units.delta.delta_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.administrative_units.get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.administrative_units.get_user_owned_objects.get_user_owned_objects_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.administrative_units.validate_properties.validate_properties_request_builder')
