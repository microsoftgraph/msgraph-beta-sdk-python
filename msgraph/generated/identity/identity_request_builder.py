...
class IdentityRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity{?%24select,%24expand}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> IdentityRequestBuilder:
        """
    ...
    @property
    def b2c_user_flows(self) -> B2cUserFlowsRequestBuilder:
        """
        Provides operations to manage the b2cUserFlows property of the microsoft.graph.identityContainer entity.
        """
        from .b2c_user_flows.b2c_user_flows_request_builder import B2cUserFlowsRequestBuilder

        return B2cUserFlowsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def continuous_access_evaluation_policy(self) -> ContinuousAccessEvaluationPolicyRequestBuilder:
        """
        ...
        return ContinuousAccessEvaluationPolicyRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def user_flows(self) -> UserFlowsRequestBuilder:
        """
    ...
    @dataclass
    class IdentityRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class IdentityRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
