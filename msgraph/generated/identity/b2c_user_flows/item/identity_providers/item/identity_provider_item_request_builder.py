...
ref_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.identity_providers.item.ref.ref_request_builder')
...
class IdentityProviderItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/identityProviders/{identityProvider%2Did}"
