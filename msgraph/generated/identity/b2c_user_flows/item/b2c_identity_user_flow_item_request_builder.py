...
identity_providers_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.identity_providers.identity_providers_request_builder')
identity_provider_item_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.identity_providers.item.identity_provider_item_request_builder')
languages_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.languages.languages_request_builder')
user_flow_language_configuration_item_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.languages.item.user_flow_language_configuration_item_request_builder')
user_attribute_assignments_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_attribute_assignments.user_attribute_assignments_request_builder')
identity_user_flow_attribute_assignment_item_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_attribute_assignments.item.identity_user_flow_attribute_assignment_item_request_builder')
user_flow_identity_providers_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_flow_identity_providers.user_flow_identity_providers_request_builder')
identity_provider_base_item_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_flow_identity_providers.item.identity_provider_base_item_request_builder')
...
class B2cIdentityUserFlowItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[B2cIdentityUserFlowItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[B2cIdentityUserFlowItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[b2c_identity_user_flow.B2cIdentityUserFlow] = None, request_configuration: Optional[B2cIdentityUserFlowItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
