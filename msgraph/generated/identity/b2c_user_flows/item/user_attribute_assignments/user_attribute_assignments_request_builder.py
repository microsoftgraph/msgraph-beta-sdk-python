...
get_order_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_attribute_assignments.microsoft_graph_get_order.get_order_request_builder')
set_order_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.user_attribute_assignments.microsoft_graph_set_order.set_order_request_builder')
