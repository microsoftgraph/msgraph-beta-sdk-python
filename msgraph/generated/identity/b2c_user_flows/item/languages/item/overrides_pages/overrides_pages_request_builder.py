...
count_request_builder = lazy_import('msgraph.generated.identity.b2c_user_flows.item.languages.item.overrides_pages.count.count_request_builder')
...
class OverridesPagesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def post(self,body: Optional[user_flow_language_page.UserFlowLanguagePage] = None, request_configuration: Optional[OverridesPagesRequestBuilderPostRequestConfiguration] = None) -> Optional[user_flow_language_page.UserFlowLanguagePage]:
        """
    ...
    def to_post_request_information(self,body: Optional[user_flow_language_page.UserFlowLanguagePage] = None, request_configuration: Optional[OverridesPagesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to overridesPages for identity
        Args:
            body: The request body
