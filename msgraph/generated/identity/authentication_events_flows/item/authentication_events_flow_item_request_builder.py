...
class AuthenticationEventsFlowItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[AuthenticationEventsFlowItemRequestBuilderGetRequestConfiguration] = None) -> Optional[authentication_events_flow.AuthenticationEventsFlow]:
        """
    ...
    async def patch(self,body: Optional[authentication_events_flow.AuthenticationEventsFlow] = None, request_configuration: Optional[AuthenticationEventsFlowItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[authentication_events_flow.AuthenticationEventsFlow]:
        """
    ...
    def to_patch_request_information(self,body: Optional[authentication_events_flow.AuthenticationEventsFlow] = None, request_configuration: Optional[AuthenticationEventsFlowItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the properties of an authenticationEventsFlow object. Only the externalUsersSelfServiceSignupEventsFlow object type is supported.
        Args:
            body: The request body
    ...
    @dataclass
    class AuthenticationEventsFlowItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class AuthenticationEventsFlowItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class AuthenticationEventsFlowItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
