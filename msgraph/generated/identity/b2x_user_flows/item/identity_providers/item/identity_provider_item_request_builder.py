...
class IdentityProviderItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, identity_provider_id: Optional[str] = None) -> None:
        """
        Instantiates a new IdentityProviderItemRequestBuilder and sets the default values.
        Args:
            identityProviderId: key: id of identityProvider
        ...
        url_tpl_params["identityProvider%2Did"] = identityProviderId
