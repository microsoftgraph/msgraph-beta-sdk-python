...
class B2xIdentityUserFlowItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, b2x_identity_user_flow_id: Optional[str] = None) -> None:
        """
        Instantiates a new B2xIdentityUserFlowItemRequestBuilder and sets the default values.
        Args:
            b2xIdentityUserFlowId: key: id of b2xIdentityUserFlow
        ...
        url_tpl_params["b2xIdentityUserFlow%2Did"] = b2xIdentityUserFlowId
