...
class UploadClientCertificateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/apiConnectorConfiguration/preTokenIssuance/uploadClientCertificate", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UploadClientCertificateRequestBuilder:
        ...
        return UploadClientCertificateRequestBuilder(raw_url, self.request_adapter)
