...
count_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.authentication_method_modes.count.count_request_builder')
authentication_method_mode_detail = lazy_import('msgraph.generated.models.authentication_method_mode_detail')
authentication_method_mode_detail_collection_response = lazy_import('msgraph.generated.models.authentication_method_mode_detail_collection_response')
...
class AuthenticationMethodModesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/authenticationStrength/authenticationMethodModes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[authentication_method_mode_detail.AuthenticationMethodModeDetail] = None, request_configuration: Optional[AuthenticationMethodModesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to authenticationMethodModes for identity
        Args:
            body: The request body
    ...
    @dataclass
    class AuthenticationMethodModesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
