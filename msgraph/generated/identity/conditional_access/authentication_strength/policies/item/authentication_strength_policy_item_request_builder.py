...
update_allowed_combinations_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.update_allowed_combinations.update_allowed_combinations_request_builder')
usage_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.usage.usage_request_builder')
