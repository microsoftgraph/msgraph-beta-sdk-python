...
combination_configurations_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.combination_configurations.combination_configurations_request_builder')
authentication_combination_configuration_item_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.combination_configurations.item.authentication_combination_configuration_item_request_builder')
microsoft_graph_update_allowed_combinations_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.microsoft_graph_update_allowed_combinations.microsoft_graph_update_allowed_combinations_request_builder')
microsoft_graph_usage_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.microsoft_graph_usage.microsoft_graph_usage_request_builder')
...
class AuthenticationStrengthPolicyItemRequestBuilder():
    ...
    @property
    def microsoft_graph_update_allowed_combinations(self) -> microsoft_graph_update_allowed_combinations_request_builder.MicrosoftGraphUpdateAllowedCombinationsRequestBuilder:
        """
        Provides operations to call the updateAllowedCombinations method.
        """
        return microsoft_graph_update_allowed_combinations_request_builder.MicrosoftGraphUpdateAllowedCombinationsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_usage(self) -> microsoft_graph_usage_request_builder.MicrosoftGraphUsageRequestBuilder:
        """
        Provides operations to call the usage method.
        """
        return microsoft_graph_usage_request_builder.MicrosoftGraphUsageRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}{?%24select,%24expand}"
