...
update_allowed_combinations_post_request_body = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.update_allowed_combinations.update_allowed_combinations_post_request_body')
