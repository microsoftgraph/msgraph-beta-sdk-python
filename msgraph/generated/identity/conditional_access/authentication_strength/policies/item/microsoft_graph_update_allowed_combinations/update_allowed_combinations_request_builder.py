...
update_allowed_combinations_post_request_body = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.microsoft_graph_update_allowed_combinations.update_allowed_combinations_post_request_body')
...
class UpdateAllowedCombinationsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}/microsoft.graph.updateAllowedCombinations"
