...
count_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strength.policies.item.combination_configurations.count.count_request_builder')
