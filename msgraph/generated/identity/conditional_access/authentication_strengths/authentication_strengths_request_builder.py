...
class AuthenticationStrengthsRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[AuthenticationStrengthsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[authentication_strength_root.AuthenticationStrengthRoot] = None, request_configuration: Optional[AuthenticationStrengthsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property authenticationStrengths in identity
        Args:
            body: The request body
