...
class AuthenticationStrengthsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identity/conditionalAccess/authenticationStrengths{?%24select,%24expand}"
    ...
    @dataclass
    class AuthenticationStrengthsRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class AuthenticationStrengthsRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
