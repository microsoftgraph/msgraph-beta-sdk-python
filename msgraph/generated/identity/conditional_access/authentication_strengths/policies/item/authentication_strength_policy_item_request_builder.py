...
microsoft_graph_update_allowed_combinations_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strengths.policies.item.microsoft_graph_update_allowed_combinations.microsoft_graph_update_allowed_combinations_request_builder')
microsoft_graph_usage_request_builder = lazy_import('msgraph.generated.identity.conditional_access.authentication_strengths.policies.item.microsoft_graph_usage.microsoft_graph_usage_request_builder')
