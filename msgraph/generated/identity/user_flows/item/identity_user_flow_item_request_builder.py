...
class IdentityUserFlowItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, identity_user_flow_id: Optional[str] = None) -> None:
        """
        Instantiates a new IdentityUserFlowItemRequestBuilder and sets the default values.
        Args:
            identityUserFlowId: key: id of identityUserFlow
        ...
        url_tpl_params["identityUserFlow%2Did"] = identityUserFlowId
    ...
    async def get(self,request_configuration: Optional[IdentityUserFlowItemRequestBuilderGetRequestConfiguration] = None) -> Optional[identity_user_flow.IdentityUserFlow]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, identity_user_flow.IdentityUserFlow, error_mapping)
    
    async def patch(self,body: Optional[identity_user_flow.IdentityUserFlow] = None, request_configuration: Optional[IdentityUserFlowItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[identity_user_flow.IdentityUserFlow]:
        """
