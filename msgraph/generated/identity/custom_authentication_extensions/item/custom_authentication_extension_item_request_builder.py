...
validate_authentication_configuration_request_builder = lazy_import('msgraph.generated.identity.custom_authentication_extensions.item.microsoft_graph_validate_authentication_configuration.validate_authentication_configuration_request_builder')
...
class CustomAuthenticationExtensionItemRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_validate_authentication_configuration(self) -> validate_authentication_configuration_request_builder.ValidateAuthenticationConfigurationRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, custom_authentication_extension_id: Optional[str] = None) -> None:
        """
        Instantiates a new CustomAuthenticationExtensionItemRequestBuilder and sets the default values.
        Args:
            customAuthenticationExtensionId: key: id of customAuthenticationExtension
        ...
        self.url_template: str = "{+baseurl}/identity/customAuthenticationExtensions/{customAuthenticationExtension%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["customAuthenticationExtension%2Did"] = customAuthenticationExtensionId
    ...
    def to_patch_request_information(self,body: Optional[custom_authentication_extension.CustomAuthenticationExtension] = None, request_configuration: Optional[CustomAuthenticationExtensionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property customAuthenticationExtensions in identity
        Args:
            body: The request body
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class CustomAuthenticationExtensionItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
