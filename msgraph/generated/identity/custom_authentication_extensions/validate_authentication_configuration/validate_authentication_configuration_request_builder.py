...
class ValidateAuthenticationConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ValidateAuthenticationConfigurationRequestBuilder:
        ...
        return ValidateAuthenticationConfigurationRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ValidateAuthenticationConfigurationRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
