...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.devices.microsoft_graph_get_user_owned_objects.get_user_owned_objects_post_request_body')
