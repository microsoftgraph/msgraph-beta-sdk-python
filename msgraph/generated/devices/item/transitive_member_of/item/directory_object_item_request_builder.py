...
graph_administrative_unit_request_builder = lazy_import('msgraph.generated.devices.item.transitive_member_of.item.graph_administrative_unit.graph_administrative_unit_request_builder')
graph_group_request_builder = lazy_import('msgraph.generated.devices.item.transitive_member_of.item.graph_group.graph_group_request_builder')
