...
responsepayload_request_builder = lazy_import('msgraph.generated.devices.item.commands.item.responsepayload.responsepayload_request_builder')
...
class CommandItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/devices/{device%2Did}/commands/{command%2Did}{?%24select,%24expand}"
