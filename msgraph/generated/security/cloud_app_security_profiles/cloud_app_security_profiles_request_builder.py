...
class CloudAppSecurityProfilesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[cloud_app_security_profile.CloudAppSecurityProfile] = None, request_configuration: Optional[CloudAppSecurityProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cloudAppSecurityProfiles for security
        Args:
            body: The request body
