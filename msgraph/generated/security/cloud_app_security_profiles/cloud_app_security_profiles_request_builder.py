...
cloud_app_security_profile_collection_response = lazy_import('msgraph.generated.models.cloud_app_security_profile_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.security.cloud_app_security_profiles.count.count_request_builder')
...
class CloudAppSecurityProfilesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/cloudAppSecurityProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[CloudAppSecurityProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[cloud_app_security_profile.CloudAppSecurityProfile] = None, request_configuration: Optional[CloudAppSecurityProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
