...
class RetentionEventItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, retention_event_id: Optional[str] = None) -> None:
        """
        Instantiates a new RetentionEventItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            retentionEventId: key: id of retentionEvent
        """
        ...
        url_tpl_params["retentionEvent%2Did"] = retentionEventId
