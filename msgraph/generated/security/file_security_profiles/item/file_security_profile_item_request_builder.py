...
class FileSecurityProfileItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, file_security_profile_id: Optional[str] = None) -> None:
        """
        Instantiates a new FileSecurityProfileItemRequestBuilder and sets the default values.
        Args:
            fileSecurityProfileId: key: id of fileSecurityProfile
        ...
        url_tpl_params["fileSecurityProfile%2Did"] = fileSecurityProfileId
    ...
    def to_patch_request_information(self,body: Optional[file_security_profile.FileSecurityProfile] = None, request_configuration: Optional[FileSecurityProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property fileSecurityProfiles in security
        Args:
            body: The request body
