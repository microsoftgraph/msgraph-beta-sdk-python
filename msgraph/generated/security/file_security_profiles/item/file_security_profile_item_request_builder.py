...
class FileSecurityProfileItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[FileSecurityProfileItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[FileSecurityProfileItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[file_security_profile.FileSecurityProfile] = None, request_configuration: Optional[FileSecurityProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
