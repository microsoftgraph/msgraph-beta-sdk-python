...
class RetentionEventTypeItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, retention_event_type_id: Optional[str] = None) -> None:
        """
        Instantiates a new RetentionEventTypeItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            retentionEventTypeId: key: id of retentionEventType
        """
        ...
        url_tpl_params["retentionEventType%2Did"] = retentionEventTypeId
