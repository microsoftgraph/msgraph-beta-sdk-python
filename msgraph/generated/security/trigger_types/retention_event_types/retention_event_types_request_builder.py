...
retention_event_type_collection_response = lazy_import('msgraph.generated.models.security.retention_event_type_collection_response')
count_request_builder = lazy_import('msgraph.generated.security.trigger_types.retention_event_types.count.count_request_builder')
...
class RetentionEventTypesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[RetentionEventTypesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[retention_event_type.RetentionEventType] = None, request_configuration: Optional[RetentionEventTypesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
