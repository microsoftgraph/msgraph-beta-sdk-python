...
microsoft_graph_delete_ti_indicators_request_builder = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_delete_ti_indicators.microsoft_graph_delete_ti_indicators_request_builder')
microsoft_graph_delete_ti_indicators_by_external_id_request_builder = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_delete_ti_indicators_by_external_id.microsoft_graph_delete_ti_indicators_by_external_id_request_builder')
microsoft_graph_submit_ti_indicators_request_builder = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_submit_ti_indicators.microsoft_graph_submit_ti_indicators_request_builder')
microsoft_graph_update_ti_indicators_request_builder = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_update_ti_indicators.microsoft_graph_update_ti_indicators_request_builder')
...
class TiIndicatorsRequestBuilder():
    ...
    @property
    def microsoft_graph_delete_ti_indicators(self) -> microsoft_graph_delete_ti_indicators_request_builder.MicrosoftGraphDeleteTiIndicatorsRequestBuilder:
        """
        Provides operations to call the deleteTiIndicators method.
        """
        return microsoft_graph_delete_ti_indicators_request_builder.MicrosoftGraphDeleteTiIndicatorsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_delete_ti_indicators_by_external_id(self) -> microsoft_graph_delete_ti_indicators_by_external_id_request_builder.MicrosoftGraphDeleteTiIndicatorsByExternalIdRequestBuilder:
        """
        Provides operations to call the deleteTiIndicatorsByExternalId method.
        """
        return microsoft_graph_delete_ti_indicators_by_external_id_request_builder.MicrosoftGraphDeleteTiIndicatorsByExternalIdRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_submit_ti_indicators(self) -> microsoft_graph_submit_ti_indicators_request_builder.MicrosoftGraphSubmitTiIndicatorsRequestBuilder:
        """
        Provides operations to call the submitTiIndicators method.
        """
        return microsoft_graph_submit_ti_indicators_request_builder.MicrosoftGraphSubmitTiIndicatorsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_update_ti_indicators(self) -> microsoft_graph_update_ti_indicators_request_builder.MicrosoftGraphUpdateTiIndicatorsRequestBuilder:
        """
        Provides operations to call the updateTiIndicators method.
        """
        return microsoft_graph_update_ti_indicators_request_builder.MicrosoftGraphUpdateTiIndicatorsRequestBuilder(self.request_adapter, self.path_parameters)
