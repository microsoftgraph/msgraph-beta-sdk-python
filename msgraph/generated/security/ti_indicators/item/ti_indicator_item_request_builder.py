...
class TiIndicatorItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, ti_indicator_id: Optional[str] = None) -> None:
        """
        Instantiates a new TiIndicatorItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            tiIndicatorId: key: id of tiIndicator
        """
        ...
        url_tpl_params["tiIndicator%2Did"] = tiIndicatorId
