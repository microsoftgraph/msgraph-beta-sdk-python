...
submit_ti_indicators_post_request_body = lazy_import('msgraph.generated.security.ti_indicators.submit_ti_indicators.submit_ti_indicators_post_request_body')
submit_ti_indicators_response = lazy_import('msgraph.generated.security.ti_indicators.submit_ti_indicators.submit_ti_indicators_response')
...
class SubmitTiIndicatorsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[submit_ti_indicators_post_request_body.SubmitTiIndicatorsPostRequestBody] = None, request_configuration: Optional[SubmitTiIndicatorsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
