...
delete_ti_indicators_post_request_body = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_delete_ti_indicators.delete_ti_indicators_post_request_body')
delete_ti_indicators_response = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_delete_ti_indicators.delete_ti_indicators_response')

class DeleteTiIndicatorsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/tiIndicators/microsoft.graph.deleteTiIndicators"
    ...
    async def post(self,body: Optional[delete_ti_indicators_post_request_body.DeleteTiIndicatorsPostRequestBody] = None, request_configuration: Optional[DeleteTiIndicatorsRequestBuilderPostRequestConfiguration] = None) -> Optional[delete_ti_indicators_response.DeleteTiIndicatorsResponse]:
        ...
        Returns: Optional[delete_ti_indicators_response.DeleteTiIndicatorsResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, delete_ti_indicators_response.DeleteTiIndicatorsResponse, error_mapping)
    ...
    @dataclass
    class DeleteTiIndicatorsRequestBuilderPostRequestConfiguration():
        """
