...
class DeleteTiIndicatorsByExternalIdRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[DeleteTiIndicatorsByExternalIdPostRequestBody] = None, request_configuration: Optional[DeleteTiIndicatorsByExternalIdRequestBuilderPostRequestConfiguration] = None) -> Optional[DeleteTiIndicatorsByExternalIdPostResponse]:
        """
        Delete multiple threat intelligence (TI) indicators in one request instead of multiple requests, when the request contains external IDs instead of IDs. This API is supported in the following national cloud deployments.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DeleteTiIndicatorsByExternalIdRequestBuilder:
        """
    ...
    @dataclass
    class DeleteTiIndicatorsByExternalIdRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
