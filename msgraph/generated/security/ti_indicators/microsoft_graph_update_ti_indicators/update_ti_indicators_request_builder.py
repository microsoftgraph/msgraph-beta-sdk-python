...
update_ti_indicators_post_request_body = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_update_ti_indicators.update_ti_indicators_post_request_body')
update_ti_indicators_response = lazy_import('msgraph.generated.security.ti_indicators.microsoft_graph_update_ti_indicators.update_ti_indicators_response')
...
class UpdateTiIndicatorsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/tiIndicators/microsoft.graph.updateTiIndicators"
    ...
    @dataclass
    class UpdateTiIndicatorsRequestBuilderPostRequestConfiguration():
        """
