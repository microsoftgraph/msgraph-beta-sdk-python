...
ediscovery_file_collection_response = lazy_import('msgraph.generated.models.security.ediscovery_file_collection_response')
count_request_builder = lazy_import('msgraph.generated.security.cases.ediscovery_cases.item.review_sets.item.files.count.count_request_builder')
...
class FilesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[FilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[ediscovery_file.EdiscoveryFile] = None, request_configuration: Optional[FilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
