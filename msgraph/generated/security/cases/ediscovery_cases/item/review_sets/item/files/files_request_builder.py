...
class FilesRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[ediscovery_file.EdiscoveryFile] = None, request_configuration: Optional[FilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to files for security
        Args:
            body: The request body
