...
export_post_request_body = lazy_import('msgraph.generated.security.cases.ediscovery_cases.item.review_sets.item.security_export.export_post_request_body')
...
class SecurityExportRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/security.export"
