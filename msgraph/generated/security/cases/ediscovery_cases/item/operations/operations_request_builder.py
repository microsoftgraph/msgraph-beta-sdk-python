...
case_operation_collection_response = lazy_import('msgraph.generated.models.security.case_operation_collection_response')
count_request_builder = lazy_import('msgraph.generated.security.cases.ediscovery_cases.item.operations.count.count_request_builder')
...
class OperationsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[case_operation.CaseOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
