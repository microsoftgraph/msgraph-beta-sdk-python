...
class EdiscoveryCaseItemRequestBuilder():
    ...
    def legal_holds_by_id(self,id: str) -> Optional[ediscovery_hold_policy_item_request_builder.EdiscoveryHoldPolicyItemRequestBuilder]:
        """
        Provides operations to manage the legalHolds property of the microsoft.graph.security.ediscoveryCase entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[ediscovery_hold_policy_item_request_builder.EdiscoveryHoldPolicyItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
