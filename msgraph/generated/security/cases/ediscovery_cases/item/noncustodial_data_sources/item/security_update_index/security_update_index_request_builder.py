...
class SecurityUpdateIndexRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/{ediscoveryNoncustodialDataSource%2Did}/security.updateIndex"
    ...
    @dataclass
    class SecurityUpdateIndexRequestBuilderPostRequestConfiguration():
        """
