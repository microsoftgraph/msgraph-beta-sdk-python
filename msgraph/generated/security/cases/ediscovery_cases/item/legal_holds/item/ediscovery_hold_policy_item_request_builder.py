...
class EdiscoveryHoldPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, ediscovery_hold_policy_id: Optional[str] = None) -> None:
        """
        Instantiates a new EdiscoveryHoldPolicyItemRequestBuilder and sets the default values.
        Args:
            ediscoveryHoldPolicyId: key: id of ediscoveryHoldPolicy
        ...
        url_tpl_params["ediscoveryHoldPolicy%2Did"] = ediscoveryHoldPolicyId
