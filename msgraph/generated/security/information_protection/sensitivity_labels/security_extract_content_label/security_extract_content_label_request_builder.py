...
extract_content_label_post_request_body = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.security_extract_content_label.extract_content_label_post_request_body')
...
class SecurityExtractContentLabelRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/informationProtection/sensitivityLabels/security.extractContentLabel"
