...
parent_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.item.parent.parent_request_builder')
...
class SensitivityLabelItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
