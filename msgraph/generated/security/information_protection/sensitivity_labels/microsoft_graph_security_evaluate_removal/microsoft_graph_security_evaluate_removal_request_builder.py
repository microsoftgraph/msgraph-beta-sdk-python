...
class MicrosoftGraphSecurityEvaluateRemovalRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateRemoval", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftGraphSecurityEvaluateRemovalRequestBuilder:
        ...
        return MicrosoftGraphSecurityEvaluateRemovalRequestBuilder(raw_url, self.request_adapter)
