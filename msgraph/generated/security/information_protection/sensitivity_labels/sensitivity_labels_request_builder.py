...
count_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.count.count_request_builder')
microsoft_graph_security_evaluate_application_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_application.microsoft_graph_security_evaluate_application_request_builder')
microsoft_graph_security_evaluate_classification_results_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_classification_results.microsoft_graph_security_evaluate_classification_results_request_builder')
microsoft_graph_security_evaluate_removal_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.microsoft_graph_security_evaluate_removal.microsoft_graph_security_evaluate_removal_request_builder')
microsoft_graph_security_extract_content_label_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.microsoft_graph_security_extract_content_label.microsoft_graph_security_extract_content_label_request_builder')
...
class SensitivityLabelsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/informationProtection/sensitivityLabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
