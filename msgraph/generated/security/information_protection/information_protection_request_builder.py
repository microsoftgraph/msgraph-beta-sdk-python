...
label_policy_settings_request_builder = lazy_import('msgraph.generated.security.information_protection.label_policy_settings.label_policy_settings_request_builder')
sensitivity_labels_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.sensitivity_labels_request_builder')
sensitivity_label_item_request_builder = lazy_import('msgraph.generated.security.information_protection.sensitivity_labels.item.sensitivity_label_item_request_builder')
...
class InformationProtectionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/informationProtection{?%24select,%24expand}"
