...
incident_collection_response = lazy_import('msgraph.generated.models.security.incident_collection_response')
count_request_builder = lazy_import('msgraph.generated.security.incidents.count.count_request_builder')
...
class IncidentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/incidents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[IncidentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[incident.Incident] = None, request_configuration: Optional[IncidentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class IncidentsRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[IncidentsRequestBuilder.IncidentsRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class IncidentsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
