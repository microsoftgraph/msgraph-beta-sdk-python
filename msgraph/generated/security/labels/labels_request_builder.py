...
class LabelsRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[labels_root.LabelsRoot] = None, request_configuration: Optional[LabelsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property labels in security
        Args:
            body: The request body
