...
class AuthoritiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/labels/authorities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def post(self,body: Optional[AuthorityTemplate] = None, request_configuration: Optional[AuthoritiesRequestBuilderPostRequestConfiguration] = None) -> Optional[AuthorityTemplate]:
        """
        Create a new authorityTemplate object. This API is supported in the following national cloud deployments.
