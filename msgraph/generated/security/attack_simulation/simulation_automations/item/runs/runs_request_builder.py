...
simulation_automation_run_collection_response = lazy_import('msgraph.generated.models.simulation_automation_run_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.security.attack_simulation.simulation_automations.item.runs.count.count_request_builder')
...
class RunsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[simulation_automation_run.SimulationAutomationRun] = None, request_configuration: Optional[RunsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
