...
simulation_collection_response = lazy_import('msgraph.generated.models.simulation_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.security.attack_simulation.simulations.count.count_request_builder')
...
class SimulationsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[SimulationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[simulation.Simulation] = None, request_configuration: Optional[SimulationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
