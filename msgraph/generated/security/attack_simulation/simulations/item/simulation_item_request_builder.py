...
if TYPE_CHECKING:
    ...
    from .payload import payload_request_builder
...
class SimulationItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[SimulationItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
