...
class DomainSecurityProfilesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/domainSecurityProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[DomainSecurityProfilesRequestBuilderGetRequestConfiguration] = None) -> Optional[DomainSecurityProfileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DomainSecurityProfile] = None, request_configuration: Optional[DomainSecurityProfilesRequestBuilderPostRequestConfiguration] = None) -> Optional[DomainSecurityProfile]:
        """
    ...
    def to_post_request_information(self,body: Optional[DomainSecurityProfile] = None, request_configuration: Optional[DomainSecurityProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to domainSecurityProfiles for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DomainSecurityProfilesRequestBuilder:
        """
    ...
    @dataclass
    class DomainSecurityProfilesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class DomainSecurityProfilesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
