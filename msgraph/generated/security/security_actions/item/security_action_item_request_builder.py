...
class SecurityActionItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[SecurityActionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[SecurityActionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[security_action.SecurityAction] = None, request_configuration: Optional[SecurityActionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
