...
update_alerts_post_request_body = lazy_import('msgraph.generated.security.alerts.update_alerts.update_alerts_post_request_body')
update_alerts_response = lazy_import('msgraph.generated.security.alerts.update_alerts.update_alerts_response')
...
class UpdateAlertsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[update_alerts_post_request_body.UpdateAlertsPostRequestBody] = None, request_configuration: Optional[UpdateAlertsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
