...
update_alerts_request_builder = lazy_import('msgraph.generated.security.alerts.microsoft_graph_update_alerts.update_alerts_request_builder')
...
class AlertsRequestBuilder():
    ...
    @property
    def microsoft_graph_update_alerts(self) -> update_alerts_request_builder.UpdateAlertsRequestBuilder:
        """
    ...
    def to_post_request_information(self,body: Optional[alert.Alert] = None, request_configuration: Optional[AlertsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to alerts for security
        Args:
            body: The request body
