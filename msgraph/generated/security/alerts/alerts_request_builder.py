...
if TYPE_CHECKING:
    ...
    from ...models.alert_collection_response import AlertCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.alert_item_request_builder import AlertItemRequestBuilder
    from .update_alerts.update_alerts_request_builder import UpdateAlertsRequestBuilder
...
class AlertsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/alerts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AlertsRequestBuilderGetRequestConfiguration] = None) -> Optional[AlertCollectionResponse]:
        """
        Retrieve a list of alert objects. This API is supported in the following national cloud deployments.
    ...
    async def post(self,body: Optional[Alert] = None, request_configuration: Optional[AlertsRequestBuilderPostRequestConfiguration] = None) -> Optional[Alert]:
        """
    ...
    def to_post_request_information(self,body: Optional[Alert] = None, request_configuration: Optional[AlertsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to alerts for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @property
    def update_alerts(self) -> UpdateAlertsRequestBuilder:
        """
        Provides operations to call the updateAlerts method.
        """
        from .update_alerts.update_alerts_request_builder import UpdateAlertsRequestBuilder

        return UpdateAlertsRequestBuilder(self.request_adapter, self.path_parameters)
