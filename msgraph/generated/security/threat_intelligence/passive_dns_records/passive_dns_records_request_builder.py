...
if TYPE_CHECKING:
    ...
    from ....models.security import passive_dns_record, passive_dns_record_collection_response
...
class PassiveDnsRecordsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/passiveDnsRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[PassiveDnsRecordsRequestBuilderGetRequestConfiguration] = None) -> Optional[passive_dns_record_collection_response.PassiveDnsRecordCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, passive_dns_record_collection_response.PassiveDnsRecordCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[passive_dns_record.PassiveDnsRecord] = None, request_configuration: Optional[PassiveDnsRecordsRequestBuilderPostRequestConfiguration] = None) -> Optional[passive_dns_record.PassiveDnsRecord]:
        """
    ...
    def to_post_request_information(self,body: Optional[passive_dns_record.PassiveDnsRecord] = None, request_configuration: Optional[PassiveDnsRecordsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to passiveDnsRecords for security
        Args:
            body: The request body
    ...
    @dataclass
    class PassiveDnsRecordsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class PassiveDnsRecordsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
