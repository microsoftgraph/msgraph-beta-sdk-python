...
class IntelligenceProfileItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/intelProfiles/{intelligenceProfile%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[IntelligenceProfileItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[IntelligenceProfileItemRequestBuilderGetRequestConfiguration] = None) -> Optional[intelligence_profile.IntelligenceProfile]:
        """
    ...
    def to_patch_request_information(self,body: Optional[intelligence_profile.IntelligenceProfile] = None, request_configuration: Optional[IntelligenceProfileItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property intelProfiles in security
        Args:
            body: The request body
    ...
    @dataclass
    class IntelligenceProfileItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class IntelligenceProfileItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class IntelligenceProfileItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
