...
class IntelProfilesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/intelProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[IntelProfilesRequestBuilderGetRequestConfiguration] = None) -> Optional[intelligence_profile_collection_response.IntelligenceProfileCollectionResponse]:
        ...
        from ....models.security import intelligence_profile_collection_response

        return await self.request_adapter.send_async(request_info, intelligence_profile_collection_response.IntelligenceProfileCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[intelligence_profile.IntelligenceProfile] = None, request_configuration: Optional[IntelProfilesRequestBuilderPostRequestConfiguration] = None) -> Optional[intelligence_profile.IntelligenceProfile]:
        """
        Create new navigation property to intelProfiles for security
        Args:
            body: The request body
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[intelligence_profile.IntelligenceProfile]
        """
        if body is None:
    ...
    def to_post_request_information(self,body: Optional[intelligence_profile.IntelligenceProfile] = None, request_configuration: Optional[IntelProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to intelProfiles for security
        Args:
            body: The request body
    ...
    @dataclass
    class IntelProfilesRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class IntelProfilesRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
