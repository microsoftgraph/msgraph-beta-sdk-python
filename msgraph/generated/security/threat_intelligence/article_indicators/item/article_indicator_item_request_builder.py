...
class ArticleIndicatorItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/articleIndicators/{articleIndicator%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[ArticleIndicatorItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ArticleIndicatorItemRequestBuilderGetRequestConfiguration] = None) -> Optional[article_indicator.ArticleIndicator]:
        ...
        return await self.request_adapter.send_async(request_info, article_indicator.ArticleIndicator, error_mapping)
    
    async def patch(self,body: Optional[article_indicator.ArticleIndicator] = None, request_configuration: Optional[ArticleIndicatorItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[article_indicator.ArticleIndicator]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[ArticleIndicatorItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property articleIndicators for security
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[article_indicator.ArticleIndicator] = None, request_configuration: Optional[ArticleIndicatorItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property articleIndicators in security
        Args:
            body: The request body
    ...
    @dataclass
    class ArticleIndicatorItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class ArticleIndicatorItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
