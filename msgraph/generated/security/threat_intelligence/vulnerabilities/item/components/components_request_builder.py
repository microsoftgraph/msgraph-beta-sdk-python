...
class ComponentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}/components{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[ComponentsRequestBuilderGetRequestConfiguration] = None) -> Optional[vulnerability_component_collection_response.VulnerabilityComponentCollectionResponse]:
        ...
        from ......models.security import vulnerability_component_collection_response

        return await self.request_adapter.send_async(request_info, vulnerability_component_collection_response.VulnerabilityComponentCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[vulnerability_component.VulnerabilityComponent] = None, request_configuration: Optional[ComponentsRequestBuilderPostRequestConfiguration] = None) -> Optional[vulnerability_component.VulnerabilityComponent]:
        """
        Create new navigation property to components for security
        Args:
            body: The request body
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[vulnerability_component.VulnerabilityComponent]
        """
        if body is None:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ......models.security import vulnerability_component

        return await self.request_adapter.send_async(request_info, vulnerability_component.VulnerabilityComponent, error_mapping)
    ...
    def to_post_request_information(self,body: Optional[vulnerability_component.VulnerabilityComponent] = None, request_configuration: Optional[ComponentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to components for security
        Args:
            body: The request body
    ...
    @dataclass
    class ComponentsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class ComponentsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
