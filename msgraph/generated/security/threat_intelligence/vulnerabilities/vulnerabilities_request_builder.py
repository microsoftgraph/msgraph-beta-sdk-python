...
class VulnerabilitiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/vulnerabilities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[VulnerabilitiesRequestBuilderGetRequestConfiguration] = None) -> Optional[vulnerability_collection_response.VulnerabilityCollectionResponse]:
        ...
        Returns: Optional[vulnerability_collection_response.VulnerabilityCollectionResponse]
        """
        ...
        from ....models.security import vulnerability_collection_response

        return await self.request_adapter.send_async(request_info, vulnerability_collection_response.VulnerabilityCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[vulnerability.Vulnerability] = None, request_configuration: Optional[VulnerabilitiesRequestBuilderPostRequestConfiguration] = None) -> Optional[vulnerability.Vulnerability]:
        """
        Create new navigation property to vulnerabilities for security
        Args:
            body: The request body
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[vulnerability.Vulnerability]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, vulnerability.Vulnerability, error_mapping)
    ...
    def to_post_request_information(self,body: Optional[vulnerability.Vulnerability] = None, request_configuration: Optional[VulnerabilitiesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to vulnerabilities for security
        Args:
            body: The request body
