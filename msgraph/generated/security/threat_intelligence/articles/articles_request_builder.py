...
class ArticlesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[ArticlesRequestBuilderGetRequestConfiguration] = None) -> Optional[article_collection_response.ArticleCollectionResponse]:
        ...
        from ....models.security import article_collection_response

        return await self.request_adapter.send_async(request_info, article_collection_response.ArticleCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[article.Article] = None, request_configuration: Optional[ArticlesRequestBuilderPostRequestConfiguration] = None) -> Optional[article.Article]:
        """
    ...
    def to_post_request_information(self,body: Optional[article.Article] = None, request_configuration: Optional[ArticlesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to articles for security
        Args:
            body: The request body
