...
if TYPE_CHECKING:
    ...
    from .ssl_certificate.ssl_certificate_request_builder import SslCertificateRequestBuilder

class HostSslCertificateItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/hostSslCertificates/{hostSslCertificate%2Did}{?%24select,%24expand}", path_parameters)
    
    async def delete(self,request_configuration: Optional[HostSslCertificateItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def patch(self,body: Optional[HostSslCertificate] = None, request_configuration: Optional[HostSslCertificateItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[HostSslCertificate]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[HostSslCertificateItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property hostSslCertificates for security
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[HostSslCertificate] = None, request_configuration: Optional[HostSslCertificateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property hostSslCertificates in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> HostSslCertificateItemRequestBuilder:
        """
    ...
    @property
    def ssl_certificate(self) -> SslCertificateRequestBuilder:
        """
        Provides operations to manage the sslCertificate property of the microsoft.graph.security.hostSslCertificate entity.
        """
        from .ssl_certificate.ssl_certificate_request_builder import SslCertificateRequestBuilder

        return SslCertificateRequestBuilder(self.request_adapter, self.path_parameters)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class HostSslCertificateItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class HostSslCertificateItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[HostSslCertificateItemRequestBuilder.HostSslCertificateItemRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class HostSslCertificateItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
