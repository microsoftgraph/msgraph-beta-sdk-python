...
class ReputationRequestBuilder():
    ...
    async def patch(self,body: Optional[HostReputation] = None, request_configuration: Optional[ReputationRequestBuilderPatchRequestConfiguration] = None) -> Optional[HostReputation]:
        """
