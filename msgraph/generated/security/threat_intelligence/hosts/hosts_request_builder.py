...
class HostsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/hosts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[HostsRequestBuilderGetRequestConfiguration] = None) -> Optional[host_collection_response.HostCollectionResponse]:
        ...
        from ....models.security import host_collection_response

        return await self.request_adapter.send_async(request_info, host_collection_response.HostCollectionResponse, error_mapping)
    
    async def post(self,body: Optional[host.Host] = None, request_configuration: Optional[HostsRequestBuilderPostRequestConfiguration] = None) -> Optional[host.Host]:
        """
    ...
    def to_post_request_information(self,body: Optional[host.Host] = None, request_configuration: Optional[HostsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to hosts for security
        Args:
            body: The request body
    ...
    @dataclass
    class HostsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
