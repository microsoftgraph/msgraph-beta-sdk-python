...
class SubdomainsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/subdomains{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def by_subdomain_id(self,subdomain_id: str) -> SubdomainItemRequestBuilder:
        ...
        Provides operations to manage the subdomains property of the microsoft.graph.security.threatIntelligence entity.
        Args:
            subdomain_id: Unique identifier of the item
    ...
    @dataclass
    class SubdomainsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class SubdomainsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
