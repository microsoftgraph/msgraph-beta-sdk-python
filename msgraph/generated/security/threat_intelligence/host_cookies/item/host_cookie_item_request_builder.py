...
class HostCookieItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/security/threatIntelligence/hostCookies/{hostCookie%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def delete(self,request_configuration: Optional[HostCookieItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def patch(self,body: Optional[host_cookie.HostCookie] = None, request_configuration: Optional[HostCookieItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[host_cookie.HostCookie]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[HostCookieItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property hostCookies for security
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[host_cookie.HostCookie] = None, request_configuration: Optional[HostCookieItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property hostCookies in security
        Args:
            body: The request body
    ...
    @dataclass
    class HostCookieItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class HostCookieItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
