...
add_activities_request_builder = lazy_import('msgraph.generated.connections.item.items.item.microsoft_graph_external_connectors_add_activities.add_activities_request_builder')
