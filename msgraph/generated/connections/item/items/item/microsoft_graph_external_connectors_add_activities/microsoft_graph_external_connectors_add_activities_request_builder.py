...
add_activities_post_request_body = lazy_import('msgraph.generated.connections.item.items.item.microsoft_graph_external_connectors_add_activities.add_activities_post_request_body')
add_activities_response = lazy_import('msgraph.generated.connections.item.items.item.microsoft_graph_external_connectors_add_activities.add_activities_response')
