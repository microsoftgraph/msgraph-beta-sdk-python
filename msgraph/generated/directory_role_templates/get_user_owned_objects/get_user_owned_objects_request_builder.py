...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.directory_role_templates.get_user_owned_objects.get_user_owned_objects_post_request_body')
