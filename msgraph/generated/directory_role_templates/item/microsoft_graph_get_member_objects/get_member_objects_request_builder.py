...
get_member_objects_post_request_body = lazy_import('msgraph.generated.directory_role_templates.item.microsoft_graph_get_member_objects.get_member_objects_post_request_body')
get_member_objects_response = lazy_import('msgraph.generated.directory_role_templates.item.microsoft_graph_get_member_objects.get_member_objects_response')
...
class GetMemberObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/directoryRoleTemplates/{directoryRoleTemplate%2Did}/microsoft.graph.getMemberObjects"
