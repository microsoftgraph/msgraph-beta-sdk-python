...
class AccessReviewDecisionsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[access_review_decision.AccessReviewDecision] = None, request_configuration: Optional[AccessReviewDecisionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to accessReviewDecisions
        Args:
            body: The request body
