...
available_provider_types_request_builder = lazy_import('msgraph.generated.identity_providers.available_provider_types.available_provider_types_request_builder')
count_request_builder = lazy_import('msgraph.generated.identity_providers.count.count_request_builder')
identity_provider = lazy_import('msgraph.generated.models.identity_provider')
identity_provider_collection_response = lazy_import('msgraph.generated.models.identity_provider_collection_response')
...
class IdentityProvidersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[IdentityProvidersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[identity_provider.IdentityProvider] = None, request_configuration: Optional[IdentityProvidersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
