...
copy_to_notebook_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.copy_to_notebook.copy_to_notebook_request_builder')
copy_to_section_group_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.copy_to_section_group.copy_to_section_group_request_builder')
pages_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.pages.pages_request_builder')
onenote_page_item_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.pages.item.onenote_page_item_request_builder')
parent_notebook_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.parent_notebook.parent_notebook_request_builder')
parent_section_group_request_builder = lazy_import('msgraph.generated.sites.item.onenote.sections.item.parent_section_group.parent_section_group_request_builder')
...
class OnenoteSectionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}"
