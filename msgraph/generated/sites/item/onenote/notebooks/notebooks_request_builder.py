...
count_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.count.count_request_builder')
get_notebook_from_web_url_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.get_notebook_from_web_url.get_notebook_from_web_url_request_builder')
get_recent_notebooks_with_include_personal_notebooks_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.get_recent_notebooks_with_include_personal_notebooks.get_recent_notebooks_with_include_personal_notebooks_request_builder')
...
class NotebooksRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[NotebooksRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[notebook.Notebook] = None, request_configuration: Optional[NotebooksRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
