...
parent_notebook_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.parent_notebook.parent_notebook_request_builder')
parent_section_group_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.parent_section_group.parent_section_group_request_builder')
section_groups_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.section_groups.section_groups_request_builder')
section_group_item_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.section_groups.item.section_group_item_request_builder')
sections_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.sections.sections_request_builder')
onenote_section_item_request_builder = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.sections.item.onenote_section_item_request_builder')
...
class SectionGroupItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}"
