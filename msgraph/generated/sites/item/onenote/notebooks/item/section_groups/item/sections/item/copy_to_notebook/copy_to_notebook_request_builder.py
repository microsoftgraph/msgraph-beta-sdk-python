...
copy_to_notebook_post_request_body = lazy_import('msgraph.generated.sites.item.onenote.notebooks.item.section_groups.item.sections.item.copy_to_notebook.copy_to_notebook_post_request_body')
