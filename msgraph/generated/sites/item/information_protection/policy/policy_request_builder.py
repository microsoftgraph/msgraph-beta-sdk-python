...
labels_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.policy.labels.labels_request_builder')
information_protection_label_item_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.policy.labels.item.information_protection_label_item_request_builder')
...
class PolicyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/informationProtection/policy{?%24select,%24expand}"
    ...
    async def delete(self,request_configuration: Optional[PolicyRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
        Delete navigation property policy for sites
        Args:
