...
sublabels_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.sensitivity_labels.item.sublabels.sublabels_request_builder')
sensitivity_label_item_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.sensitivity_labels.item.sublabels.item.sensitivity_label_item_request_builder')
...
class SensitivityLabelItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, sensitivity_label_id: Optional[str] = None) -> None:
        """
        Instantiates a new SensitivityLabelItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            sensitivityLabelId: key: id of sensitivityLabel
        """
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["sensitivityLabel%2Did"] = sensitivityLabelId
    ...
    def to_patch_request_information(self,body: Optional[sensitivity_label.SensitivityLabel] = None, request_configuration: Optional[SensitivityLabelItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property sensitivityLabels in sites
        Args:
            body: The request body
    ...
    @dataclass
    class SensitivityLabelItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
