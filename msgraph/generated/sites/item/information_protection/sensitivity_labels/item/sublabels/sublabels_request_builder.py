...
evaluate_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.sensitivity_labels.item.sublabels.evaluate.evaluate_request_builder')
