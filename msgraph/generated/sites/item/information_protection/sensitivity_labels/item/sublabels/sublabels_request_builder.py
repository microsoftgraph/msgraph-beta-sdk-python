...
evaluate_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.sensitivity_labels.item.sublabels.microsoft_graph_evaluate.evaluate_request_builder')
