...
results_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.threat_assessment_requests.item.results.results_request_builder')
threat_assessment_result_item_request_builder = lazy_import('msgraph.generated.sites.item.information_protection.threat_assessment_requests.item.results.item.threat_assessment_result_item_request_builder')
...
class ThreatAssessmentRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}"
    ...
    async def delete(self,request_configuration: Optional[ThreatAssessmentRequestItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
        Delete navigation property threatAssessmentRequests for sites
        Args:
    ...
    async def patch(self,body: Optional[threat_assessment_request.ThreatAssessmentRequest] = None, request_configuration: Optional[ThreatAssessmentRequestItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[threat_assessment_request.ThreatAssessmentRequest]:
        """
        Update the navigation property threatAssessmentRequests in sites
        Args:
