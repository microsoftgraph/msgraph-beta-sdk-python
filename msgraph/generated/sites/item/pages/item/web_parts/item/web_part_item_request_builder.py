...
microsoft_graph_get_position_of_web_part_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.web_parts.item.microsoft_graph_get_position_of_web_part.microsoft_graph_get_position_of_web_part_request_builder')
...
class WebPartItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/webParts/{webPart%2Did}{?%24select,%24expand}"
