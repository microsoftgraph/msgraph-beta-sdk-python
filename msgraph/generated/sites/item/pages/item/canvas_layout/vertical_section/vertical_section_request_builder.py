...
class VerticalSectionRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[vertical_section.VerticalSection] = None, request_configuration: Optional[VerticalSectionRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property verticalSection in sites
        Args:
            body: The request body
