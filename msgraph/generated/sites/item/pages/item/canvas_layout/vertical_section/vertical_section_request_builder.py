...
webparts_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.vertical_section.webparts.webparts_request_builder')
web_part_item_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.vertical_section.webparts.item.web_part_item_request_builder')
...
class VerticalSectionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/verticalSection{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[VerticalSectionRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[VerticalSectionRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[vertical_section.VerticalSection] = None, request_configuration: Optional[VerticalSectionRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class VerticalSectionRequestBuilderDeleteRequestConfiguration():
        """
    ...
    class VerticalSectionRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[VerticalSectionRequestBuilder.VerticalSectionRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class VerticalSectionRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
