...
microsoft_graph_get_position_of_web_part_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.horizontal_sections.item.columns.item.webparts.item.microsoft_graph_get_position_of_web_part.microsoft_graph_get_position_of_web_part_request_builder')
...
class WebPartItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/pages/{sitePage%2Did}/canvasLayout/horizontalSections/{horizontalSection%2Did}/columns/{horizontalSectionColumn%2Did}/webparts/{webPart%2Did}{?%24select,%24expand}"
