...
get_position_of_web_part_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.horizontal_sections.item.columns.item.webparts.item.get_position_of_web_part.get_position_of_web_part_request_builder')
