...
class HorizontalSectionItemRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[horizontal_section.HorizontalSection] = None, request_configuration: Optional[HorizontalSectionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property horizontalSections in sites
        Args:
            body: The request body
