...
webparts_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.horizontal_sections.item.columns.item.webparts.webparts_request_builder')
web_part_item_request_builder = lazy_import('msgraph.generated.sites.item.pages.item.canvas_layout.horizontal_sections.item.columns.item.webparts.item.web_part_item_request_builder')
...
class HorizontalSectionColumnItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, horizontal_section_column_id: Optional[str] = None) -> None:
        """
        Instantiates a new HorizontalSectionColumnItemRequestBuilder and sets the default values.
        Args:
            horizontalSectionColumnId: key: id of horizontalSectionColumn
        ...
        url_tpl_params["horizontalSectionColumn%2Did"] = horizontalSectionColumnId
