...
if TYPE_CHECKING:
    ...
    from ....models.site_page_collection_response import SitePageCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.site_page_item_request_builder import SitePageItemRequestBuilder
...
class PagesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/sites/{site%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_site_page_id(self,site_page_id: str) -> SitePageItemRequestBuilder:
        """
        Provides operations to manage the pages property of the microsoft.graph.site entity.
        Args:
            site_page_id: Unique identifier of the item
        Returns: SitePageItemRequestBuilder
        """
        if not site_page_id:
            raise TypeError("site_page_id cannot be null.")
        from .item.site_page_item_request_builder import SitePageItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["sitePage%2Did"] = site_page_id
        return SitePageItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[PagesRequestBuilderGetRequestConfiguration] = None) -> Optional[SitePageCollectionResponse]:
        """
        ...
        Returns: Optional[SitePageCollectionResponse]
        """
    ...
    async def post(self,body: Optional[SitePage] = None, request_configuration: Optional[PagesRequestBuilderPostRequestConfiguration] = None) -> Optional[SitePage]:
        """
    ...
    def to_post_request_information(self,body: Optional[SitePage] = None, request_configuration: Optional[PagesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create a new [sitePage][] in the site pages [list][] in a [site][].
        Args:
            body: The request body
