...
activities_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.activities.activities_request_builder')
columns_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.columns.columns_request_builder')
column_definition_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.columns.item.column_definition_item_request_builder')
content_types_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.content_types_request_builder')
content_type_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.item.content_type_item_request_builder')
drive_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.drive.drive_request_builder')
items_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.items_request_builder')
list_item_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.list_item_item_request_builder')
operations_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.operations.operations_request_builder')
rich_long_running_operation_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.operations.item.rich_long_running_operation_item_request_builder')
subscriptions_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.subscriptions.subscriptions_request_builder')
subscription_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.subscriptions.item.subscription_item_request_builder')
