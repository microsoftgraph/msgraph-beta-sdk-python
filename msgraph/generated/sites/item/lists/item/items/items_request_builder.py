...
delta_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.microsoft_graph_delta.delta_request_builder')
delta_with_token_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.microsoft_graph_delta_with_token.delta_with_token_request_builder')
