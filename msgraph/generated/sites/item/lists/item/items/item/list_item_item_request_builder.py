...
activities_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.activities.item.item_activity_o_l_d_item_request_builder')
...
microsoft_graph_create_link_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.items.item.microsoft_graph_create_link.microsoft_graph_create_link_request_builder')
