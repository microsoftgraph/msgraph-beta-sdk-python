...
delta_with_token_response = lazy_import('msgraph.generated.sites.item.lists.item.items.delta_with_token.delta_with_token_response')
...
class DeltaWithTokenRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, token: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
