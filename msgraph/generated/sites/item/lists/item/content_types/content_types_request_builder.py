...
add_copy_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.add_copy.add_copy_request_builder')
add_copy_from_content_type_hub_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.add_copy_from_content_type_hub.add_copy_from_content_type_hub_request_builder')
count_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.count.count_request_builder')
get_compatible_hub_content_types_request_builder = lazy_import('msgraph.generated.sites.item.lists.item.content_types.get_compatible_hub_content_types.get_compatible_hub_content_types_request_builder')
...
class ContentTypesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
