...
children_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.children.children_request_builder')
term_item_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.children.item.term_item_request_builder')
parent_group_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.parent_group.parent_group_request_builder')
relations_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.relations.relations_request_builder')
relation_item_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.relations.item.relation_item_request_builder')
terms_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.terms.terms_request_builder')
term_item_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.terms.item.term_item_request_builder')
...
class SetItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}{?%24select,%24expand}"
