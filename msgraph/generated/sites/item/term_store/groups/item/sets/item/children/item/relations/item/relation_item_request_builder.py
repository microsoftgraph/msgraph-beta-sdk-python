...
from_term_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.children.item.relations.item.from_term.from_term_request_builder')
set_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.children.item.relations.item.set.set_request_builder')
to_term_request_builder = lazy_import('msgraph.generated.sites.item.term_store.groups.item.sets.item.children.item.relations.item.to_term.to_term_request_builder')
