...
class GetCompatibleHubContentTypesResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[content_type.ContentType]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetCompatibleHubContentTypesResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        Args:
            parseNode: The parse node to use to read the discriminator value and create the object
        Returns: GetCompatibleHubContentTypesResponse
        """
        if parse_node is None:
            raise Exception("parse_node cannot be undefined")
        return GetCompatibleHubContentTypesResponse()
    ...
    @property
    def value(self,) -> Optional[List[content_type.ContentType]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[content_type.ContentType]] = None) -> None:
        """
