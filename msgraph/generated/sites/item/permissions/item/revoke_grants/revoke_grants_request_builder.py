...
revoke_grants_post_request_body = lazy_import('msgraph.generated.sites.item.permissions.item.revoke_grants.revoke_grants_post_request_body')
...
class RevokeGrantsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/sites/{site%2Did}/permissions/{permission%2Did}/revokeGrants"
