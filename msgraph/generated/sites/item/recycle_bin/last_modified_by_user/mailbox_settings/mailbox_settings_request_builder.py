...
class MailboxSettingsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /sites/{site-id}/recycleBin/lastModifiedByUser/mailboxSettings
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/sites/{site%2Did}/recycleBin/lastModifiedByUser/mailboxSettings{?%24select,%24expand}", path_parameters)
