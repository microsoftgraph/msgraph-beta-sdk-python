...
class HeaderLogoRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/headerLogo"
    ...
    async def put(self,body: bytes, request_configuration: Optional[HeaderLogoRequestBuilderPutRequestConfiguration] = None) -> None:
        """
        A company logo that appears in the header of the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
        Args:
    ...
    @dataclass
    class HeaderLogoRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class HeaderLogoRequestBuilderPutRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
