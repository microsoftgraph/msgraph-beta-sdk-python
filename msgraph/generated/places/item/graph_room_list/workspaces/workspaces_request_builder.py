...
if TYPE_CHECKING:
    ...
    from .item.workspace_item_request_builder import WorkspaceItemRequestBuilder
...
class WorkspacesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.roomList/workspaces{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_workspace_id(self,workspace_id: str) -> WorkspaceItemRequestBuilder:
        """
        Provides operations to manage the workspaces property of the microsoft.graph.roomList entity.
        param workspace_id: The unique identifier of workspace
    ...
    def with_url(self,raw_url: Optional[str] = None) -> WorkspacesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: WorkspacesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return WorkspacesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class WorkspacesRequestBuilderGetQueryParameters():
        """
        Get workspaces from places
        """
