...
count_request_builder = lazy_import('msgraph.generated.booking_currencies.count.count_request_builder')
booking_currency = lazy_import('msgraph.generated.models.booking_currency')
booking_currency_collection_response = lazy_import('msgraph.generated.models.booking_currency_collection_response')
...
class BookingCurrenciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[BookingCurrenciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[booking_currency.BookingCurrency] = None, request_configuration: Optional[BookingCurrenciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
