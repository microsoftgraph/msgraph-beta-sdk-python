...
if TYPE_CHECKING:
    ...
    from .generate_key_post_request_body import GenerateKeyPostRequestBody

class GenerateKeyRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/trustFramework/keySets/{trustFrameworkKeySet%2Did}/generateKey", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GenerateKeyRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GenerateKeyRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class GenerateKeyRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
