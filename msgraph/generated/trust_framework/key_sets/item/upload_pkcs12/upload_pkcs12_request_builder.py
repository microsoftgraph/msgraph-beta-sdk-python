...
upload_pkcs12_post_request_body = lazy_import('msgraph.generated.trust_framework.key_sets.item.upload_pkcs12.upload_pkcs12_post_request_body')

class UploadPkcs12RequestBuilder():
    """
    ...
    def create_post_request_information(self,body: Optional[upload_pkcs12_post_request_body.UploadPkcs12PostRequestBody] = None, request_configuration: Optional[UploadPkcs12RequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
