...
class KeySetsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/trustFramework/keySets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_trust_framework_key_set_id(self,trust_framework_key_set_id: str) -> TrustFrameworkKeySetItemRequestBuilder:
        ...
        """
        if not trust_framework_key_set_id:
    ...
    def with_url(self,raw_url: Optional[str] = None) -> KeySetsRequestBuilder:
        """
    ...
    @dataclass
    class KeySetsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class KeySetsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
