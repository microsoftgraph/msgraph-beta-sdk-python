...
class TrustFrameworkRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[TrustFrameworkRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get trustFramework
        Args:
    ...
    def create_patch_request_information(self,body: Optional[trust_framework.TrustFramework] = None, request_configuration: Optional[TrustFrameworkRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
