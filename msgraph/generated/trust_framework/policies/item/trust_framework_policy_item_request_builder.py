...
class TrustFrameworkPolicyItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[TrustFrameworkPolicyItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TrustFrameworkPolicyItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[trust_framework_policy.TrustFrameworkPolicy] = None, request_configuration: Optional[TrustFrameworkPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
