...
content_request_builder = lazy_import('msgraph.generated.trust_framework.policies.item.value.content_request_builder')
...
class TrustFrameworkPolicyItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, trust_framework_policy_id: Optional[str] = None) -> None:
        """
        Instantiates a new TrustFrameworkPolicyItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            trustFrameworkPolicyId: key: id of trustFrameworkPolicy
        """
        ...
        url_tpl_params["trustFrameworkPolicy%2Did"] = trustFrameworkPolicyId
    ...
    def to_patch_request_information(self,body: Optional[trust_framework_policy.TrustFrameworkPolicy] = None, request_configuration: Optional[TrustFrameworkPolicyItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property policies in trustFramework
        Args:
            body: The request body
