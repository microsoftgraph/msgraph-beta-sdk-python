...
steps_request_builder = lazy_import('msgraph.generated.me.approvals.item.steps.steps_request_builder')
approval_step_item_request_builder = lazy_import('msgraph.generated.me.approvals.item.steps.item.approval_step_item_request_builder')
...
class ApprovalItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/approvals/{approval%2Did}{?%24select,%24expand}"
    ...
    def create_delete_request_information(self,request_configuration: Optional[ApprovalItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property approvals for me
        Args:
    ...
    def create_patch_request_information(self,body: Optional[approval.Approval] = None, request_configuration: Optional[ApprovalItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property approvals in me
        Args:
