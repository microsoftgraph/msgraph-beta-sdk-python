...
class EnrollmentConfigurationAssignmentItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[EnrollmentConfigurationAssignmentItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[enrollment_configuration_assignment.EnrollmentConfigurationAssignment] = None, request_configuration: Optional[EnrollmentConfigurationAssignmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in me
        Args:
            body: The request body
