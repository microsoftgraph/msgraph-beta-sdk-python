...
mentions_request_builder = lazy_import('msgraph.generated.me.messages.item.mentions.mentions_request_builder')
mention_item_request_builder = lazy_import('msgraph.generated.me.messages.item.mentions.item.mention_item_request_builder')
microsoft_graph_copy_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_copy.microsoft_graph_copy_request_builder')
microsoft_graph_create_forward_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_create_forward.microsoft_graph_create_forward_request_builder')
microsoft_graph_create_reply_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_create_reply.microsoft_graph_create_reply_request_builder')
microsoft_graph_create_reply_all_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_create_reply_all.microsoft_graph_create_reply_all_request_builder')
microsoft_graph_forward_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_forward.microsoft_graph_forward_request_builder')
microsoft_graph_move_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_move.microsoft_graph_move_request_builder')
microsoft_graph_reply_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_reply.microsoft_graph_reply_request_builder')
microsoft_graph_reply_all_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_reply_all.microsoft_graph_reply_all_request_builder')
microsoft_graph_send_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_send.microsoft_graph_send_request_builder')
microsoft_graph_unsubscribe_request_builder = lazy_import('msgraph.generated.me.messages.item.microsoft_graph_unsubscribe.microsoft_graph_unsubscribe_request_builder')
