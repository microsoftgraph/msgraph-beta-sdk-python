...
copy_to_section_group_post_request_body = lazy_import('msgraph.generated.me.onenote.section_groups.item.sections.item.copy_to_section_group.copy_to_section_group_post_request_body')
...
class CopyToSectionGroupRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/microsoft.graph.copyToSectionGroup"
