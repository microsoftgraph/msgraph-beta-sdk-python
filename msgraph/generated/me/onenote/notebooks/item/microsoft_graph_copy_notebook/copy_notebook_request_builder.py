...
copy_notebook_post_request_body = lazy_import('msgraph.generated.me.onenote.notebooks.item.microsoft_graph_copy_notebook.copy_notebook_post_request_body')
...
class CopyNotebookRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/microsoft.graph.copyNotebook"
