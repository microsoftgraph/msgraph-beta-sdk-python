...
copy_to_section_group_post_request_body = lazy_import('msgraph.generated.me.onenote.notebooks.item.sections.item.microsoft_graph_copy_to_section_group.copy_to_section_group_post_request_body')
