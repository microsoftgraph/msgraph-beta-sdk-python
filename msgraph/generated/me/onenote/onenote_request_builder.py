...
notebooks_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.notebooks_request_builder')
notebook_item_request_builder = lazy_import('msgraph.generated.me.onenote.notebooks.item.notebook_item_request_builder')
operations_request_builder = lazy_import('msgraph.generated.me.onenote.operations.operations_request_builder')
onenote_operation_item_request_builder = lazy_import('msgraph.generated.me.onenote.operations.item.onenote_operation_item_request_builder')
pages_request_builder = lazy_import('msgraph.generated.me.onenote.pages.pages_request_builder')
onenote_page_item_request_builder = lazy_import('msgraph.generated.me.onenote.pages.item.onenote_page_item_request_builder')
resources_request_builder = lazy_import('msgraph.generated.me.onenote.resources.resources_request_builder')
onenote_resource_item_request_builder = lazy_import('msgraph.generated.me.onenote.resources.item.onenote_resource_item_request_builder')
section_groups_request_builder = lazy_import('msgraph.generated.me.onenote.section_groups.section_groups_request_builder')
section_group_item_request_builder = lazy_import('msgraph.generated.me.onenote.section_groups.item.section_group_item_request_builder')
sections_request_builder = lazy_import('msgraph.generated.me.onenote.sections.sections_request_builder')
onenote_section_item_request_builder = lazy_import('msgraph.generated.me.onenote.sections.item.onenote_section_item_request_builder')
...
class OnenoteRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/onenote{?%24select,%24expand}"
