...
class UserConsentRequestItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, user_consent_request_id: Optional[str] = None) -> None:
        """
        Instantiates a new UserConsentRequestItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            userConsentRequestId: key: id of userConsentRequest
        """
        ...
        url_tpl_params["userConsentRequest%2Did"] = userConsentRequestId
