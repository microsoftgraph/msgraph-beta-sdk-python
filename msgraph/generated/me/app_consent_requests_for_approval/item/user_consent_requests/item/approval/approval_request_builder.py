...
steps_request_builder = lazy_import('msgraph.generated.me.app_consent_requests_for_approval.item.user_consent_requests.item.approval.steps.steps_request_builder')
approval_step_item_request_builder = lazy_import('msgraph.generated.me.app_consent_requests_for_approval.item.user_consent_requests.item.approval.steps.item.approval_step_item_request_builder')
...
class ApprovalRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/appConsentRequestsForApproval/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}/approval{?%24select,%24expand}"
