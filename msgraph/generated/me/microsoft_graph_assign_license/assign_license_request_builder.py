...
assign_license_post_request_body = lazy_import('msgraph.generated.me.microsoft_graph_assign_license.assign_license_post_request_body')
...
class AssignLicenseRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/microsoft.graph.assignLicense"
