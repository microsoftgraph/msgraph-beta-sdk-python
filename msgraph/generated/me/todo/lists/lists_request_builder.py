...
count_request_builder = lazy_import('msgraph.generated.me.todo.lists.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.me.todo.lists.delta.delta_request_builder')
...
class ListsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[todo_task_list.TodoTaskList] = None, request_configuration: Optional[ListsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
