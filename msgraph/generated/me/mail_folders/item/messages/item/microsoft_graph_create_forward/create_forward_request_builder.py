...
create_forward_post_request_body = lazy_import('msgraph.generated.me.mail_folders.item.messages.item.microsoft_graph_create_forward.create_forward_post_request_body')
