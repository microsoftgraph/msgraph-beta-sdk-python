...
attachments_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.attachments.item.attachment_item_request_builder')
...
extension_item_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.extensions.item.extension_item_request_builder')
mentions_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.mentions.mentions_request_builder')
mention_item_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.mentions.item.mention_item_request_builder')
microsoft_graph_copy_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_copy.microsoft_graph_copy_request_builder')
microsoft_graph_create_forward_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_create_forward.microsoft_graph_create_forward_request_builder')
microsoft_graph_create_reply_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_create_reply.microsoft_graph_create_reply_request_builder')
microsoft_graph_create_reply_all_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_create_reply_all.microsoft_graph_create_reply_all_request_builder')
microsoft_graph_forward_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_forward.microsoft_graph_forward_request_builder')
microsoft_graph_move_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_move.microsoft_graph_move_request_builder')
microsoft_graph_reply_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_reply.microsoft_graph_reply_request_builder')
microsoft_graph_reply_all_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_reply_all.microsoft_graph_reply_all_request_builder')
microsoft_graph_send_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_send.microsoft_graph_send_request_builder')
microsoft_graph_unsubscribe_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.microsoft_graph_unsubscribe.microsoft_graph_unsubscribe_request_builder')
multi_value_extended_properties_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
...
single_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
content_request_builder = lazy_import('msgraph.generated.me.mail_folders.item.child_folders.item.messages.item.value.content_request_builder')
...
class MessageItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}{?%24select,%24expand}"
