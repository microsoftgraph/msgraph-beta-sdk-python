...
restore_post_request_body = lazy_import('msgraph.generated.me.drives.item.root.restore.restore_post_request_body')
...
class RestoreRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/root/microsoft.graph.restore"
