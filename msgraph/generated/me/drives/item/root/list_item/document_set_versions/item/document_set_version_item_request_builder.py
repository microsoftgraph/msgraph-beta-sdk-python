...
restore_request_builder = lazy_import('msgraph.generated.me.drives.item.root.list_item.document_set_versions.item.restore.restore_request_builder')
...
class DocumentSetVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"
