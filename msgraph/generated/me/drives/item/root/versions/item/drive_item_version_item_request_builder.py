...
content_request_builder = lazy_import('msgraph.generated.me.drives.item.root.versions.item.content.content_request_builder')
restore_version_request_builder = lazy_import('msgraph.generated.me.drives.item.root.versions.item.restore_version.restore_version_request_builder')
...
class DriveItemVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[DriveItemVersionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[DriveItemVersionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[drive_item_version.DriveItemVersion] = None, request_configuration: Optional[DriveItemVersionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class DriveItemVersionItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[DriveItemVersionItemRequestBuilder.DriveItemVersionItemRequestBuilderGetQueryParameters] = None
