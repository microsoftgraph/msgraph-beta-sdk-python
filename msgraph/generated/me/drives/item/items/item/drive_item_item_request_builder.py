...
activities_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.analytics.analytics_request_builder')
assign_sensitivity_label_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.assign_sensitivity_label.assign_sensitivity_label_request_builder')
...
extract_sensitivity_labels_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.extract_sensitivity_labels.extract_sensitivity_labels_request_builder')
