...
create_upload_session_post_request_body = lazy_import('msgraph.generated.me.drives.item.items.item.create_upload_session.create_upload_session_post_request_body')
...
class CreateUploadSessionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.createUploadSession"
