...
count_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.activities.count.count_request_builder')
...
class ActivitiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
