...
restore_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.document_set_versions.item.restore.restore_request_builder')
...
class DocumentSetVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[DocumentSetVersionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property documentSetVersions for me
        Args:
    ...
    def create_get_request_information(self,request_configuration: Optional[DocumentSetVersionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[document_set_version.DocumentSetVersion] = None, request_configuration: Optional[DocumentSetVersionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property documentSetVersions in me
        Args:
    ...
    @dataclass
    class DocumentSetVersionItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class DocumentSetVersionItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
