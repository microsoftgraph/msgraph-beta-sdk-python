...
drive_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.activities.item.drive_item.drive_item_request_builder')
list_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.activities.item.list_item.list_item_request_builder')
...
class ItemActivityOLDItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/activities/{itemActivityOLD%2Did}{?%24select,%24expand}"
