...
activities_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.activities.activities_request_builder')
item_activity_o_l_d_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.activities.item.item_activity_o_l_d_item_request_builder')
analytics_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.analytics.analytics_request_builder')
create_link_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.create_link.create_link_request_builder')
document_set_versions_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.document_set_versions.document_set_versions_request_builder')
document_set_version_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.document_set_versions.item.document_set_version_item_request_builder')
drive_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.drive_item.drive_item_request_builder')
fields_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.fields.fields_request_builder')
get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval.get_activities_by_interval_with_start_date_time_with_end_date_time_with_interval_request_builder')
versions_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.versions.versions_request_builder')
list_item_version_item_request_builder = lazy_import('msgraph.generated.me.drives.item.items.item.list_item.versions.item.list_item_version_item_request_builder')
...
class ListItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem{?%24select,%24expand}"
