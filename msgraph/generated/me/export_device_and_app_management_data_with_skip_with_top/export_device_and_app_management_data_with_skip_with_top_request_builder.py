...
class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, skip: Optional[int] = None, top: Optional[int] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/microsoft.graph.exportDeviceAndAppManagementData(skip={skip},top={top})"
    ...
    def create_get_request_information(self,request_configuration: Optional[ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
