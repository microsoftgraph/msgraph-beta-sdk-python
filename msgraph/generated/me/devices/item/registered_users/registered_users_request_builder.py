...
microsoft_graph_endpoint_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.microsoft_graph_endpoint.microsoft_graph_endpoint_request_builder')
microsoft_graph_service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.microsoft_graph_service_principal.microsoft_graph_service_principal_request_builder')
microsoft_graph_user_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.microsoft_graph_user.microsoft_graph_user_request_builder')
...
class RegisteredUsersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/devices/{device%2Did}/registeredUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
