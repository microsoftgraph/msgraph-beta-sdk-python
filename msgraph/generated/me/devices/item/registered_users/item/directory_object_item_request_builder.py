...
endpoint_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.endpoint.endpoint_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.user.user_request_builder')
