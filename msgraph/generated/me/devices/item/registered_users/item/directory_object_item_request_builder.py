...
graph_endpoint_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.graph_endpoint.graph_endpoint_request_builder')
graph_service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.graph_service_principal.graph_service_principal_request_builder')
graph_user_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_users.item.graph_user.graph_user_request_builder')
