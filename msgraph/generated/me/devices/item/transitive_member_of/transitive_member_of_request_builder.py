...
application_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.application.application_request_builder')
count_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.count.count_request_builder')
device_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.org_contact.org_contact_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.user.user_request_builder')
