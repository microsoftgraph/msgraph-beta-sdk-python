...
count_request_builder = lazy_import('msgraph.generated.me.devices.item.transitive_member_of.microsoft_graph_application.count.count_request_builder')
...
class ApplicationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
