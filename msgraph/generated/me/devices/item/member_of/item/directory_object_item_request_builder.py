...
application_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.application.application_request_builder')
device_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.org_contact.org_contact_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.devices.item.member_of.item.user.user_request_builder')
