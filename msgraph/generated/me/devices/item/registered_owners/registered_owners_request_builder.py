...
endpoint_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_owners.endpoint.endpoint_request_builder')
ref_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_owners.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_owners.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.devices.item.registered_owners.user.user_request_builder')
