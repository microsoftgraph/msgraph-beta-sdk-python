...
delta_request_builder = lazy_import('msgraph.generated.me.devices.delta.delta_request_builder')
get_by_ids_request_builder = lazy_import('msgraph.generated.me.devices.get_by_ids.get_by_ids_request_builder')
get_user_owned_objects_request_builder = lazy_import('msgraph.generated.me.devices.get_user_owned_objects.get_user_owned_objects_request_builder')
validate_properties_request_builder = lazy_import('msgraph.generated.me.devices.validate_properties.validate_properties_request_builder')
...
class DevicesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DevicesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get devices from me
        Args:
    ...
    def create_post_request_information(self,body: Optional[device.Device] = None, request_configuration: Optional[DevicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
