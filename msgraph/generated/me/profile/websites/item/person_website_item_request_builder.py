...
class PersonWebsiteItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, person_website_id: Optional[str] = None) -> None:
        """
        Instantiates a new PersonWebsiteItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            personWebsiteId: key: id of personWebsite
        ...
        url_tpl_params["personWebsite%2Did"] = personWebsiteId
