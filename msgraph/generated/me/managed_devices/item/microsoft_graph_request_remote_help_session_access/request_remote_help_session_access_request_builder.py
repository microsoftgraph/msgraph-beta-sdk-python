...
request_remote_help_session_access_post_request_body = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_request_remote_help_session_access.request_remote_help_session_access_post_request_body')
...
class RequestRemoteHelpSessionAccessRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/microsoft.graph.requestRemoteHelpSessionAccess"
