...
count_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.device_health_script_states.count.count_request_builder')
with_id_with_policy_id_with_device_id_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.device_health_script_states.with_id_with_policy_id_with_device_id.with_id_with_policy_id_with_device_id_request_builder')
