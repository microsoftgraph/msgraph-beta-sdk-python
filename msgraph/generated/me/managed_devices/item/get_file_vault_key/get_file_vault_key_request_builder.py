...
get_file_vault_key_response = lazy_import('msgraph.generated.me.managed_devices.item.get_file_vault_key.get_file_vault_key_response')
...
class GetFileVaultKeyRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/microsoft.graph.getFileVaultKey()"
