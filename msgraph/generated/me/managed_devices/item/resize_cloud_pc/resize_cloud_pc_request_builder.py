...
resize_cloud_pc_post_request_body = lazy_import('msgraph.generated.me.managed_devices.item.resize_cloud_pc.resize_cloud_pc_post_request_body')
...
class ResizeCloudPcRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/resizeCloudPc"
