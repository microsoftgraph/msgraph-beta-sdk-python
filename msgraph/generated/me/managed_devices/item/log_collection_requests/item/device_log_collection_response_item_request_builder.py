...
create_download_url_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.log_collection_requests.item.microsoft_graph_create_download_url.create_download_url_request_builder')
...
class DeviceLogCollectionResponseItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, device_log_collection_response_id: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}{?%24select,%24expand}"
