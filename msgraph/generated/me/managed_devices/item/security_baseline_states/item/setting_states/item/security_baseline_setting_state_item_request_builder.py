...
class SecurityBaselineSettingStateItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[SecurityBaselineSettingStateItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[security_baseline_setting_state.SecurityBaselineSettingState] = None, request_configuration: Optional[SecurityBaselineSettingStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property settingStates in me
        Args:
            body: The request body
