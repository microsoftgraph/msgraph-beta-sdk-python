...
setting_states_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.security_baseline_states.item.setting_states.setting_states_request_builder')
security_baseline_setting_state_item_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.security_baseline_states.item.setting_states.item.security_baseline_setting_state_item_request_builder')
...
class SecurityBaselineStateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, security_baseline_state_id: Optional[str] = None) -> None:
        """
        Instantiates a new SecurityBaselineStateItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            securityBaselineStateId: key: id of securityBaselineState
        """
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/securityBaselineStates/{securityBaselineState%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["securityBaselineState%2Did"] = securityBaselineStateId
    ...
    async def delete(self,request_configuration: Optional[SecurityBaselineStateItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
        Delete navigation property securityBaselineStates for me
        Args:
    ...
    async def get(self,request_configuration: Optional[SecurityBaselineStateItemRequestBuilderGetRequestConfiguration] = None) -> Optional[security_baseline_state.SecurityBaselineState]:
        """
    ...
    async def patch(self,body: Optional[security_baseline_state.SecurityBaselineState] = None, request_configuration: Optional[SecurityBaselineStateItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[security_baseline_state.SecurityBaselineState]:
        """
    ...
    def to_patch_request_information(self,body: Optional[security_baseline_state.SecurityBaselineState] = None, request_configuration: Optional[SecurityBaselineStateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property securityBaselineStates in me
        Args:
            body: The request body
