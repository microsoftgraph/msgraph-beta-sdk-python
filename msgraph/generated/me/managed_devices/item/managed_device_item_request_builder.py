...
activate_device_esim_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_activate_device_esim.activate_device_esim_request_builder')
...
create_device_log_collection_request_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_create_device_log_collection_request.create_device_log_collection_request_request_builder')
create_remote_help_session_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_create_remote_help_session.create_remote_help_session_request_builder')
...
deprovision_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_deprovision.deprovision_request_builder')
disable_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_disable.disable_request_builder')
...
enable_lost_mode_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_enable_lost_mode.enable_lost_mode_request_builder')
end_remote_help_session_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_end_remote_help_session.end_remote_help_session_request_builder')
enroll_now_action_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_enroll_now_action.enroll_now_action_request_builder')
get_cloud_pc_remote_action_results_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_get_cloud_pc_remote_action_results.get_cloud_pc_remote_action_results_request_builder')
get_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_get_cloud_pc_review_status.get_cloud_pc_review_status_request_builder')
get_file_vault_key_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_get_file_vault_key.get_file_vault_key_request_builder')
get_non_compliant_settings_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_get_non_compliant_settings.get_non_compliant_settings_request_builder')
get_oem_warranty_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_get_oem_warranty.get_oem_warranty_request_builder')
initiate_mobile_device_management_key_recovery_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_initiate_mobile_device_management_key_recovery.initiate_mobile_device_management_key_recovery_request_builder')
initiate_on_demand_proactive_remediation_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_initiate_on_demand_proactive_remediation.initiate_on_demand_proactive_remediation_request_builder')
...
override_compliance_state_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_override_compliance_state.override_compliance_state_request_builder')
play_lost_mode_sound_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_play_lost_mode_sound.play_lost_mode_sound_request_builder')
...
reenable_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_reenable.reenable_request_builder')
...
remove_device_firmware_configuration_interface_management_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_remove_device_firmware_configuration_interface_management.remove_device_firmware_configuration_interface_management_request_builder')
reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_reprovision_cloud_pc.reprovision_cloud_pc_request_builder')
...
request_remote_help_session_access_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_request_remote_help_session_access.request_remote_help_session_access_request_builder')
...
resize_cloud_pc_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_resize_cloud_pc.resize_cloud_pc_request_builder')
restore_cloud_pc_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_restore_cloud_pc.restore_cloud_pc_request_builder')
...
retrieve_remote_help_session_with_session_key_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_retrieve_remote_help_session_with_session_key.retrieve_remote_help_session_with_session_key_request_builder')
revoke_apple_vpp_licenses_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_revoke_apple_vpp_licenses.revoke_apple_vpp_licenses_request_builder')
rotate_bit_locker_keys_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_rotate_bit_locker_keys.rotate_bit_locker_keys_request_builder')
rotate_file_vault_key_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_rotate_file_vault_key.rotate_file_vault_key_request_builder')
send_custom_notification_to_company_portal_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_send_custom_notification_to_company_portal.send_custom_notification_to_company_portal_request_builder')
set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_set_cloud_pc_review_status.set_cloud_pc_review_status_request_builder')
set_device_name_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_set_device_name.set_device_name_request_builder')
...
trigger_configuration_manager_action_request_builder = lazy_import('msgraph.generated.me.managed_devices.item.microsoft_graph_trigger_configuration_manager_action.trigger_configuration_manager_action_request_builder')
