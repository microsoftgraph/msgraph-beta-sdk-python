...
app_diagnostics_with_upn_response = lazy_import('msgraph.generated.me.managed_devices.app_diagnostics_with_upn.app_diagnostics_with_upn_response')
...
class AppDiagnosticsWithUpnRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, upn: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/managedDevices/appDiagnostics(upn='{upn}'){?%24top,%24skip,%24search,%24filter,%24count}"
