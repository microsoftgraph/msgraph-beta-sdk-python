...
app_diagnostics_with_upn_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_app_diagnostics_with_upn.app_diagnostics_with_upn_request_builder')
bulk_reprovision_cloud_pc_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_bulk_reprovision_cloud_pc.bulk_reprovision_cloud_pc_request_builder')
bulk_restore_cloud_pc_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_bulk_restore_cloud_pc.bulk_restore_cloud_pc_request_builder')
bulk_set_cloud_pc_review_status_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_bulk_set_cloud_pc_review_status.bulk_set_cloud_pc_review_status_request_builder')
download_app_diagnostics_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_download_app_diagnostics.download_app_diagnostics_request_builder')
execute_action_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_execute_action.execute_action_request_builder')
move_devices_to_o_u_request_builder = lazy_import('msgraph.generated.me.managed_devices.microsoft_graph_move_devices_to_o_u.move_devices_to_o_u_request_builder')
