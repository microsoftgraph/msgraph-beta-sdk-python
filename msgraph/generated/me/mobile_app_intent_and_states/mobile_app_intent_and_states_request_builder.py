...
if TYPE_CHECKING:
    ...
    from ...models.mobile_app_intent_and_state_collection_response import MobileAppIntentAndStateCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.mobile_app_intent_and_state_item_request_builder import MobileAppIntentAndStateItemRequestBuilder

class MobileAppIntentAndStatesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/me/mobileAppIntentAndStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_mobile_app_intent_and_state_id(self,mobile_app_intent_and_state_id: str) -> MobileAppIntentAndStateItemRequestBuilder:
        """
        Provides operations to manage the mobileAppIntentAndStates property of the microsoft.graph.user entity.
        Args:
        ...
        """
        if not mobile_app_intent_and_state_id:
            raise TypeError("mobile_app_intent_and_state_id cannot be null.")
        from .item.mobile_app_intent_and_state_item_request_builder import MobileAppIntentAndStateItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[MobileAppIntentAndStatesRequestBuilderGetRequestConfiguration] = None) -> Optional[MobileAppIntentAndStateCollectionResponse]:
        ...
        Returns: Optional[MobileAppIntentAndStateCollectionResponse]
        """
