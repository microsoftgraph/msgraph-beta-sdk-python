...
microsoft_graph_filter_by_current_user_with_on_request_builder = lazy_import('msgraph.generated.me.pending_access_review_instances.item.stages.item.decisions.microsoft_graph_filter_by_current_user_with_on.microsoft_graph_filter_by_current_user_with_on_request_builder')
microsoft_graph_record_all_decisions_request_builder = lazy_import('msgraph.generated.me.pending_access_review_instances.item.stages.item.decisions.microsoft_graph_record_all_decisions.microsoft_graph_record_all_decisions_request_builder')
...
class DecisionsRequestBuilder():
    ...
    @property
    def microsoft_graph_record_all_decisions(self) -> microsoft_graph_record_all_decisions_request_builder.MicrosoftGraphRecordAllDecisionsRequestBuilder:
        """
        Provides operations to call the recordAllDecisions method.
        """
        return microsoft_graph_record_all_decisions_request_builder.MicrosoftGraphRecordAllDecisionsRequestBuilder(self.request_adapter, self.path_parameters)
