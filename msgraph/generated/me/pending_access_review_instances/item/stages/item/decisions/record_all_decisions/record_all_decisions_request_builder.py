...
record_all_decisions_post_request_body = lazy_import('msgraph.generated.me.pending_access_review_instances.item.stages.item.decisions.record_all_decisions.record_all_decisions_post_request_body')
...
class RecordAllDecisionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/stages/{accessReviewStage%2Did}/decisions/recordAllDecisions"
