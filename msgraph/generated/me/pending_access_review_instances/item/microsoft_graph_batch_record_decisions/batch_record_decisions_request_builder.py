...
batch_record_decisions_post_request_body = lazy_import('msgraph.generated.me.pending_access_review_instances.item.microsoft_graph_batch_record_decisions.batch_record_decisions_post_request_body')
...
class BatchRecordDecisionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/pendingAccessReviewInstances/{accessReviewInstance%2Did}/microsoft.graph.batchRecordDecisions"
