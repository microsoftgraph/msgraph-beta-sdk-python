...
class DefinitionRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[DefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[access_review_schedule_definition.AccessReviewScheduleDefinition]:
        """
