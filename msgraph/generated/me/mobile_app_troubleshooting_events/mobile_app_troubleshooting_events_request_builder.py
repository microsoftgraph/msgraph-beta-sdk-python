...
count_request_builder = lazy_import('msgraph.generated.me.mobile_app_troubleshooting_events.count.count_request_builder')
mobile_app_troubleshooting_event = lazy_import('msgraph.generated.models.mobile_app_troubleshooting_event')
mobile_app_troubleshooting_event_collection_response = lazy_import('msgraph.generated.models.mobile_app_troubleshooting_event_collection_response')
...
class MobileAppTroubleshootingEventsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/mobileAppTroubleshootingEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[MobileAppTroubleshootingEventsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[mobile_app_troubleshooting_event.MobileAppTroubleshootingEvent] = None, request_configuration: Optional[MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class MobileAppTroubleshootingEventsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
