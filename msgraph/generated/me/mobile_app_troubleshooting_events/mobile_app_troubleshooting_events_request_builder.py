...
class MobileAppTroubleshootingEventsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[mobile_app_troubleshooting_event.MobileAppTroubleshootingEvent] = None, request_configuration: Optional[MobileAppTroubleshootingEventsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to mobileAppTroubleshootingEvents for me
        Args:
            body: The request body
