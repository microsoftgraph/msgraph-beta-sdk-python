...
count_request_builder = lazy_import('msgraph.generated.me.chats.item.messages.count.count_request_builder')
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.me.chats.item.messages.microsoft_graph_delta.microsoft_graph_delta_request_builder')
...
class MessagesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
