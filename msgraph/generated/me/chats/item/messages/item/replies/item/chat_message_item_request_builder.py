...
set_reaction_request_builder = lazy_import('msgraph.generated.me.chats.item.messages.item.replies.item.microsoft_graph_set_reaction.set_reaction_request_builder')
...
unset_reaction_request_builder = lazy_import('msgraph.generated.me.chats.item.messages.item.replies.item.microsoft_graph_unset_reaction.unset_reaction_request_builder')
