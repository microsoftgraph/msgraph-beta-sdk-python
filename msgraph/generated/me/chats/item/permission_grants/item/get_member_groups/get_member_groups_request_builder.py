...
get_member_groups_post_request_body = lazy_import('msgraph.generated.me.chats.item.permission_grants.item.get_member_groups.get_member_groups_post_request_body')
get_member_groups_response = lazy_import('msgraph.generated.me.chats.item.permission_grants.item.get_member_groups.get_member_groups_response')
