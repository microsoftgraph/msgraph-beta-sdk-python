...
get_member_objects_post_request_body = lazy_import('msgraph.generated.me.chats.item.permission_grants.item.get_member_objects.get_member_objects_post_request_body')
get_member_objects_response = lazy_import('msgraph.generated.me.chats.item.permission_grants.item.get_member_objects.get_member_objects_response')
...
class GetMemberObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberObjects"
