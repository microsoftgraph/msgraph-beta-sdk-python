...
get_user_owned_objects_post_request_body = lazy_import('msgraph.generated.me.chats.item.permission_grants.get_user_owned_objects.get_user_owned_objects_post_request_body')
...
class GetUserOwnedObjectsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants/microsoft.graph.getUserOwnedObjects"
