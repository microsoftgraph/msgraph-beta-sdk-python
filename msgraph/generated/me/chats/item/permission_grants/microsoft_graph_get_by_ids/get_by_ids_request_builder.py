...
get_by_ids_post_request_body = lazy_import('msgraph.generated.me.chats.item.permission_grants.microsoft_graph_get_by_ids.get_by_ids_post_request_body')
get_by_ids_response = lazy_import('msgraph.generated.me.chats.item.permission_grants.microsoft_graph_get_by_ids.get_by_ids_response')
...
class GetByIdsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants/microsoft.graph.getByIds"
