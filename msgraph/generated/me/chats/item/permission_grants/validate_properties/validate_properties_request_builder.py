...
validate_properties_post_request_body = lazy_import('msgraph.generated.me.chats.item.permission_grants.validate_properties.validate_properties_post_request_body')
...
class ValidatePropertiesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/permissionGrants/validateProperties"
