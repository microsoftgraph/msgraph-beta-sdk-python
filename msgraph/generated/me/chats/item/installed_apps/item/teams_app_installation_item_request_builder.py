...
teams_app_request_builder = lazy_import('msgraph.generated.me.chats.item.installed_apps.item.teams_app.teams_app_request_builder')
teams_app_definition_request_builder = lazy_import('msgraph.generated.me.chats.item.installed_apps.item.teams_app_definition.teams_app_definition_request_builder')
upgrade_request_builder = lazy_import('msgraph.generated.me.chats.item.installed_apps.item.upgrade.upgrade_request_builder')
...
class TeamsAppInstallationItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[TeamsAppInstallationItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[TeamsAppInstallationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[teams_app_installation.TeamsAppInstallation] = None, request_configuration: Optional[TeamsAppInstallationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
