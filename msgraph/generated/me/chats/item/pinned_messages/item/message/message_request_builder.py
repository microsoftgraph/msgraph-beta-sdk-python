...
class MessageRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}/message{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[MessageRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[MessageRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[chat_message.ChatMessage]:
        """
        Represents details about the chat message that is pinned.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
