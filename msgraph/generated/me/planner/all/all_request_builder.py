...
count_request_builder = lazy_import('msgraph.generated.me.planner.all.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.me.planner.all.delta.delta_request_builder')
...
class AllRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/planner/all{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[AllRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get all from me
        Args:
    ...
    def create_post_request_information(self,body: Optional[planner_delta.PlannerDelta] = None, request_configuration: Optional[AllRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
