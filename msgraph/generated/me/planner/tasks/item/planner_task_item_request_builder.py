...
assigned_to_task_board_format_request_builder = lazy_import('msgraph.generated.me.planner.tasks.item.assigned_to_task_board_format.assigned_to_task_board_format_request_builder')
bucket_task_board_format_request_builder = lazy_import('msgraph.generated.me.planner.tasks.item.bucket_task_board_format.bucket_task_board_format_request_builder')
details_request_builder = lazy_import('msgraph.generated.me.planner.tasks.item.details.details_request_builder')
progress_task_board_format_request_builder = lazy_import('msgraph.generated.me.planner.tasks.item.progress_task_board_format.progress_task_board_format_request_builder')
...
class PlannerTaskItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/planner/tasks/{plannerTask%2Did}{?%24select,%24expand}"
