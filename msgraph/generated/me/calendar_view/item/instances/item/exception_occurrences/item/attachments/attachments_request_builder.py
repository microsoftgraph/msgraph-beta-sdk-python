...
create_upload_session_request_builder = lazy_import('msgraph.generated.me.calendar_view.item.instances.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_request_builder')
