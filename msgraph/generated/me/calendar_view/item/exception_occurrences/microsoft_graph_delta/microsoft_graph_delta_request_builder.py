...
delta_response = lazy_import('msgraph.generated.me.calendar_view.item.exception_occurrences.microsoft_graph_delta.delta_response')
...
class MicrosoftGraphDeltaRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/microsoft.graph.delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
