...
create_upload_session_post_request_body = lazy_import('msgraph.generated.me.calendar_view.item.exception_occurrences.item.instances.item.attachments.create_upload_session.create_upload_session_post_request_body')
...
class CreateUploadSessionRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/attachments/createUploadSession"
