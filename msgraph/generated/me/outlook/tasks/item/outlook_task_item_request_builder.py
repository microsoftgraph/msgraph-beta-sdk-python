...
attachments_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.attachments.item.attachment_item_request_builder')
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
multi_value_extended_properties_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
...
class OutlookTaskItemRequestBuilder():
    ...
    @property
    def microsoft_graph_complete(self) -> microsoft_graph_complete_request_builder.MicrosoftGraphCompleteRequestBuilder:
        """
        Provides operations to call the complete method.
        """
        return microsoft_graph_complete_request_builder.MicrosoftGraphCompleteRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}{?%24select}"
