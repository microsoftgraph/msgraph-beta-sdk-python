...
count_request_builder = lazy_import('msgraph.generated.me.outlook.tasks.count.count_request_builder')
...
class TasksRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/outlook/tasks{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
