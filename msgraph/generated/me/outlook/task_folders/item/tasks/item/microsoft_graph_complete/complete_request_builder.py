...
complete_response = lazy_import('msgraph.generated.me.outlook.task_folders.item.tasks.item.microsoft_graph_complete.complete_response')
...
class CompleteRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/outlook/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/microsoft.graph.complete"
