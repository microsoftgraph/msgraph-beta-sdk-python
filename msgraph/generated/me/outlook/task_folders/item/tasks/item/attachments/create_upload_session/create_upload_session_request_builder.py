...
create_upload_session_post_request_body = lazy_import('msgraph.generated.me.outlook.task_folders.item.tasks.item.attachments.create_upload_session.create_upload_session_post_request_body')
