...
microsoft_graph_complete_request_builder = lazy_import('msgraph.generated.me.outlook.task_groups.item.task_folders.item.tasks.item.microsoft_graph_complete.microsoft_graph_complete_request_builder')
