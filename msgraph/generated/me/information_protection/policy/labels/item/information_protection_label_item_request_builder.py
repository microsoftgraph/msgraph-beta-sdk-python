...
class InformationProtectionLabelItemRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[InformationProtectionLabelItemRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[information_protection_label.InformationProtectionLabel] = None, request_configuration: Optional[InformationProtectionLabelItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property labels in me
        Args:
            body: The request body
