...
evaluate_removal_post_request_body = lazy_import('msgraph.generated.me.information_protection.policy.labels.evaluate_removal.evaluate_removal_post_request_body')
evaluate_removal_response = lazy_import('msgraph.generated.me.information_protection.policy.labels.evaluate_removal.evaluate_removal_response')
...
class EvaluateRemovalRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/informationProtection/policy/labels/microsoft.graph.evaluateRemoval"
