...
evaluate_request_builder = lazy_import('msgraph.generated.me.information_protection.data_loss_prevention_policies.evaluate.evaluate_request_builder')
...
class DataLossPreventionPoliciesRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[DataLossPreventionPoliciesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[data_loss_prevention_policy.DataLossPreventionPolicy] = None, request_configuration: Optional[DataLossPreventionPoliciesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
