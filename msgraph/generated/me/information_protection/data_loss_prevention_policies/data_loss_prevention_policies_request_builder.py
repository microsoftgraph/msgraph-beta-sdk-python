...
count_request_builder = lazy_import('msgraph.generated.me.information_protection.data_loss_prevention_policies.count.count_request_builder')
microsoft_graph_evaluate_request_builder = lazy_import('msgraph.generated.me.information_protection.data_loss_prevention_policies.microsoft_graph_evaluate.microsoft_graph_evaluate_request_builder')
...
class DataLossPreventionPoliciesRequestBuilder():
    ...
    @property
    def microsoft_graph_evaluate(self) -> microsoft_graph_evaluate_request_builder.MicrosoftGraphEvaluateRequestBuilder:
        """
        Provides operations to call the evaluate method.
        """
        return microsoft_graph_evaluate_request_builder.MicrosoftGraphEvaluateRequestBuilder(self.request_adapter, self.path_parameters)
