...
encrypt_buffer_post_request_body = lazy_import('msgraph.generated.me.information_protection.encrypt_buffer.encrypt_buffer_post_request_body')
...
class EncryptBufferRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/informationProtection/microsoft.graph.encryptBuffer"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[encrypt_buffer_post_request_body.EncryptBufferPostRequestBody] = None, request_configuration: Optional[EncryptBufferRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
