...
count_request_builder = lazy_import('msgraph.generated.me.information_protection.sensitivity_labels.item.sublabels.count.count_request_builder')
microsoft_graph_evaluate_request_builder = lazy_import('msgraph.generated.me.information_protection.sensitivity_labels.item.sublabels.microsoft_graph_evaluate.microsoft_graph_evaluate_request_builder')
...
class SublabelsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
