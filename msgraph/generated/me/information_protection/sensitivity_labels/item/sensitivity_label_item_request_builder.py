...
sublabels_request_builder = lazy_import('msgraph.generated.me.information_protection.sensitivity_labels.item.sublabels.sublabels_request_builder')
sensitivity_label_item_request_builder = lazy_import('msgraph.generated.me.information_protection.sensitivity_labels.item.sublabels.item.sensitivity_label_item_request_builder')
...
class SensitivityLabelItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}"
