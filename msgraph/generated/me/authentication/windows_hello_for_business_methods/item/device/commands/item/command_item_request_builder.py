...
responsepayload_request_builder = lazy_import('msgraph.generated.me.authentication.windows_hello_for_business_methods.item.device.commands.item.responsepayload.responsepayload_request_builder')
...
class CommandItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/commands/{command%2Did}{?%24select,%24expand}"
