...
count_request_builder = lazy_import('msgraph.generated.me.authentication.methods.count.count_request_builder')
authentication_method = lazy_import('msgraph.generated.models.authentication_method')
authentication_method_collection_response = lazy_import('msgraph.generated.models.authentication_method_collection_response')
...
class MethodsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/authentication/methods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
