...
device_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.device_request_builder')
...
class PasswordlessMicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}{?%24select,%24expand}"
