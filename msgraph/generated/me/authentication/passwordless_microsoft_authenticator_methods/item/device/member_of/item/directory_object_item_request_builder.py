...
application_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.application.application_request_builder')
device_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.device.device_request_builder')
group_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.group.group_request_builder')
org_contact_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.org_contact.org_contact_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.authentication.passwordless_microsoft_authenticator_methods.item.device.member_of.item.user.user_request_builder')
...
class DirectoryObjectItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/authentication/passwordlessMicrosoftAuthenticatorMethods/{passwordlessMicrosoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}{?%24select,%24expand}"
