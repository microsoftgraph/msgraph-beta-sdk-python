...
class DeviceRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[DeviceRequestBuilderGetRequestConfiguration] = None) -> Optional[device_collection_response.DeviceCollectionResponse]:
        """
