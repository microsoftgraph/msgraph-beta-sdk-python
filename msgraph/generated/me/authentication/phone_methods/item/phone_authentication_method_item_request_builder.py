...
class PhoneAuthenticationMethodItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, phone_authentication_method_id: Optional[str] = None) -> None:
        """
        Instantiates a new PhoneAuthenticationMethodItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            phoneAuthenticationMethodId: key: id of phoneAuthenticationMethod
        ...
        url_tpl_params["phoneAuthenticationMethod%2Did"] = phoneAuthenticationMethodId
