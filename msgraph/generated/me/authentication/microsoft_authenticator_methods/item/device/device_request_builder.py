...
commands_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.commands.commands_request_builder')
command_item_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.commands.item.command_item_request_builder')
...
usage_rights_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.usage_rights.usage_rights_request_builder')
usage_right_item_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.usage_rights.item.usage_right_item_request_builder')
