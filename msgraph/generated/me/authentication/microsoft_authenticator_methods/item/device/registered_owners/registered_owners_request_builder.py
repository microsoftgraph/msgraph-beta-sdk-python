...
count_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.registered_owners.count.count_request_builder')
endpoint_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.registered_owners.endpoint.endpoint_request_builder')
ref_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.registered_owners.ref.ref_request_builder')
service_principal_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.registered_owners.service_principal.service_principal_request_builder')
user_request_builder = lazy_import('msgraph.generated.me.authentication.microsoft_authenticator_methods.item.device.registered_owners.user.user_request_builder')
...
class RegisteredOwnersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
