...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.me.joined_groups.microsoft_graph_delta.microsoft_graph_delta_request_builder')
microsoft_graph_evaluate_dynamic_membership_request_builder = lazy_import('msgraph.generated.me.joined_groups.microsoft_graph_evaluate_dynamic_membership.microsoft_graph_evaluate_dynamic_membership_request_builder')
microsoft_graph_get_by_ids_request_builder = lazy_import('msgraph.generated.me.joined_groups.microsoft_graph_get_by_ids.microsoft_graph_get_by_ids_request_builder')
microsoft_graph_get_user_owned_objects_request_builder = lazy_import('msgraph.generated.me.joined_groups.microsoft_graph_get_user_owned_objects.microsoft_graph_get_user_owned_objects_request_builder')
microsoft_graph_validate_properties_request_builder = lazy_import('msgraph.generated.me.joined_groups.microsoft_graph_validate_properties.microsoft_graph_validate_properties_request_builder')
...
class JoinedGroupsRequestBuilder():
    ...
    @property
    def microsoft_graph_evaluate_dynamic_membership(self) -> microsoft_graph_evaluate_dynamic_membership_request_builder.MicrosoftGraphEvaluateDynamicMembershipRequestBuilder:
        """
        Provides operations to call the evaluateDynamicMembership method.
        """
        return microsoft_graph_evaluate_dynamic_membership_request_builder.MicrosoftGraphEvaluateDynamicMembershipRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/joinedGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
