...
microsoft_graph_device_request_builder = lazy_import('msgraph.generated.me.registered_devices.microsoft_graph_device.microsoft_graph_device_request_builder')
microsoft_graph_endpoint_request_builder = lazy_import('msgraph.generated.me.registered_devices.microsoft_graph_endpoint.microsoft_graph_endpoint_request_builder')
...
class RegisteredDevicesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/registeredDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
