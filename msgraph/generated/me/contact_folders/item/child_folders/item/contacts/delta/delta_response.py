...
class DeltaResponse(base_delta_function_response.BaseDeltaFunctionResponse):
    ...
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[contact.Contact]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        """
        fields = {
            "value": lambda n : setattr(self, 'value', n.get_collection_of_object_values(contact.Contact)),
        }
    ...
    @property
    def value(self,) -> Optional[List[contact.Contact]]:
        """
    ...
    @value.setter
    def value(self,value: Optional[List[contact.Contact]] = None) -> None:
        """
