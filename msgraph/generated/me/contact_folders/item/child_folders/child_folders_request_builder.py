...
count_request_builder = lazy_import('msgraph.generated.me.contact_folders.item.child_folders.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.me.contact_folders.item.child_folders.delta.delta_request_builder')
...
class ChildFoldersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def create_post_request_information(self,body: Optional[contact_folder.ContactFolder] = None, request_configuration: Optional[ChildFoldersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
