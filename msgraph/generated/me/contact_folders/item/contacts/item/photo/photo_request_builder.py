...
content_request_builder = lazy_import('msgraph.generated.me.contact_folders.item.contacts.item.photo.value.content_request_builder')
...
class PhotoRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/photo{?%24select}"
