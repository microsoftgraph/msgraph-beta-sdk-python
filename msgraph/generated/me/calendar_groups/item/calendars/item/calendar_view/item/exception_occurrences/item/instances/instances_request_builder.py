...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.microsoft_graph_delta.microsoft_graph_delta_request_builder')
