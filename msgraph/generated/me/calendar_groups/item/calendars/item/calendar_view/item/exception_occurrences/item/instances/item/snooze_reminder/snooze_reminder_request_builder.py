...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.item.snooze_reminder.snooze_reminder_post_request_body')
