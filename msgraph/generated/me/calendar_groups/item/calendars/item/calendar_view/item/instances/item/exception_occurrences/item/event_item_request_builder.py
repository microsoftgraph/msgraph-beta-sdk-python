...
attachments_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.attachments.attachments_request_builder')
attachment_item_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.attachments.item.attachment_item_request_builder')
calendar_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.calendar.calendar_request_builder')
extensions_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.extensions.extensions_request_builder')
extension_item_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.extensions.item.extension_item_request_builder')
microsoft_graph_accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_accept.microsoft_graph_accept_request_builder')
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
microsoft_graph_decline_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_decline.microsoft_graph_decline_request_builder')
microsoft_graph_dismiss_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_dismiss_reminder.microsoft_graph_dismiss_reminder_request_builder')
microsoft_graph_forward_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_forward.microsoft_graph_forward_request_builder')
microsoft_graph_snooze_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_snooze_reminder.microsoft_graph_snooze_reminder_request_builder')
microsoft_graph_tentatively_accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.microsoft_graph_tentatively_accept.microsoft_graph_tentatively_accept_request_builder')
multi_value_extended_properties_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.multi_value_extended_properties.multi_value_extended_properties_request_builder')
multi_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.multi_value_extended_properties.item.multi_value_legacy_extended_property_item_request_builder')
single_value_extended_properties_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.single_value_extended_properties.single_value_extended_properties_request_builder')
single_value_legacy_extended_property_item_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.single_value_extended_properties.item.single_value_legacy_extended_property_item_request_builder')
...
class EventItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24select,%24expand}"
