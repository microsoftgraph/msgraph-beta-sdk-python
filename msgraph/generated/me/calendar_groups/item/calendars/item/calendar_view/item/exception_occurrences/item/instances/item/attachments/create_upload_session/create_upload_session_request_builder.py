...
create_upload_session_post_request_body = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.exception_occurrences.item.instances.item.attachments.create_upload_session.create_upload_session_post_request_body')
