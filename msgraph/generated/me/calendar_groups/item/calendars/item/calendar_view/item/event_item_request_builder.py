...
accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.accept.accept_request_builder')
...
cancel_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.cancel.cancel_request_builder')
decline_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.decline.decline_request_builder')
dismiss_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.dismiss_reminder.dismiss_reminder_request_builder')
...
forward_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.forward.forward_request_builder')
...
snooze_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.snooze_reminder.snooze_reminder_request_builder')
tentatively_accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.calendar_view.item.tentatively_accept.tentatively_accept_request_builder')
...
class EventItemRequestBuilder():
    ...
    def exception_occurrences_by_id(self,id: str) -> Optional[EventItemRequestBuilder]:
        """
        Provides operations to manage the exceptionOccurrences property of the microsoft.graph.event entity.
        Args:
            id: Unique identifier of the item
