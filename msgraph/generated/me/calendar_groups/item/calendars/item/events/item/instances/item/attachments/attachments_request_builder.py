...
count_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.attachments.count.count_request_builder')
microsoft_graph_create_upload_session_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.attachments.microsoft_graph_create_upload_session.microsoft_graph_create_upload_session_request_builder')
...
class AttachmentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
