...
create_upload_session_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.exception_occurrences.item.attachments.create_upload_session.create_upload_session_request_builder')
