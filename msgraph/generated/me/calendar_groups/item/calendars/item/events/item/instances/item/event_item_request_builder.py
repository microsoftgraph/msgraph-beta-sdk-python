...
accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.accept.accept_request_builder')
...
cancel_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.cancel.cancel_request_builder')
decline_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.decline.decline_request_builder')
dismiss_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.dismiss_reminder.dismiss_reminder_request_builder')
...
forward_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.forward.forward_request_builder')
...
snooze_reminder_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.snooze_reminder.snooze_reminder_request_builder')
tentatively_accept_request_builder = lazy_import('msgraph.generated.me.calendar_groups.item.calendars.item.events.item.instances.item.tentatively_accept.tentatively_accept_request_builder')
