...
delta_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.exception_occurrences.item.instances.microsoft_graph_delta.delta_request_builder')
