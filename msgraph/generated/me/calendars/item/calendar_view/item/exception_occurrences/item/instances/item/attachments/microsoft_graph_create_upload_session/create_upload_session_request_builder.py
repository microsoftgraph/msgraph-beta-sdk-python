...
create_upload_session_post_request_body = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.exception_occurrences.item.instances.item.attachments.microsoft_graph_create_upload_session.create_upload_session_post_request_body')
