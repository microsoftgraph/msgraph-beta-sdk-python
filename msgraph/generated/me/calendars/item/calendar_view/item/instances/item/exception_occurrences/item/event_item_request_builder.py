...
accept_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.accept.accept_request_builder')
...
cancel_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.cancel.cancel_request_builder')
decline_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.decline.decline_request_builder')
dismiss_reminder_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.dismiss_reminder.dismiss_reminder_request_builder')
...
forward_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.forward.forward_request_builder')
...
snooze_reminder_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.snooze_reminder.snooze_reminder_request_builder')
tentatively_accept_request_builder = lazy_import('msgraph.generated.me.calendars.item.calendar_view.item.instances.item.exception_occurrences.item.tentatively_accept.tentatively_accept_request_builder')
