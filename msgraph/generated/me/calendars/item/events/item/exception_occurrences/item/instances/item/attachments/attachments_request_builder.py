...
create_upload_session_request_builder = lazy_import('msgraph.generated.me.calendars.item.events.item.exception_occurrences.item.instances.item.attachments.microsoft_graph_create_upload_session.create_upload_session_request_builder')
