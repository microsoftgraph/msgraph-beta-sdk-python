...
tentatively_accept_post_request_body = lazy_import('msgraph.generated.me.calendars.item.events.item.exception_occurrences.item.instances.item.microsoft_graph_tentatively_accept.tentatively_accept_post_request_body')
...
class TentativelyAcceptRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/microsoft.graph.tentativelyAccept"
