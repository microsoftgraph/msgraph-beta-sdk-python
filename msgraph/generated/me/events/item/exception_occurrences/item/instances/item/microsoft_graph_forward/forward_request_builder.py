...
forward_post_request_body = lazy_import('msgraph.generated.me.events.item.exception_occurrences.item.instances.item.microsoft_graph_forward.forward_post_request_body')
