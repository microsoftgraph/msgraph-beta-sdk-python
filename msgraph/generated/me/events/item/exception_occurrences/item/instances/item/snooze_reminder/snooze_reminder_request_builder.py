...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.me.events.item.exception_occurrences.item.instances.item.snooze_reminder.snooze_reminder_post_request_body')
