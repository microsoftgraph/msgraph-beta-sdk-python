...
count_request_builder = lazy_import('msgraph.generated.me.events.item.instances.count.count_request_builder')
delta_request_builder = lazy_import('msgraph.generated.me.events.item.instances.delta.delta_request_builder')
...
class InstancesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
