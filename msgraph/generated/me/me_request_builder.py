...
activate_service_plan_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_activate_service_plan.activate_service_plan_request_builder')
...
find_room_lists_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_find_room_lists.find_room_lists_request_builder')
find_rooms_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_find_rooms.find_rooms_request_builder')
find_rooms_with_room_list_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_find_rooms_with_room_list.find_rooms_with_room_list_request_builder')
get_effective_device_enrollment_configurations_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_get_effective_device_enrollment_configurations.get_effective_device_enrollment_configurations_request_builder')
get_logged_on_managed_devices_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_get_logged_on_managed_devices.get_logged_on_managed_devices_request_builder')
...
get_managed_devices_with_failed_or_pending_apps_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_get_managed_devices_with_failed_or_pending_apps.get_managed_devices_with_failed_or_pending_apps_request_builder')
...
invalidate_all_refresh_tokens_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_invalidate_all_refresh_tokens.invalidate_all_refresh_tokens_request_builder')
is_managed_app_user_blocked_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_is_managed_app_user_blocked.is_managed_app_user_blocked_request_builder')
...
unblock_managed_apps_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_unblock_managed_apps.unblock_managed_apps_request_builder')
wipe_and_block_managed_apps_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_wipe_and_block_managed_apps.wipe_and_block_managed_apps_request_builder')
wipe_managed_app_registration_by_device_tag_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_wipe_managed_app_registration_by_device_tag.wipe_managed_app_registration_by_device_tag_request_builder')
wipe_managed_app_registrations_by_azure_ad_device_id_request_builder = lazy_import('msgraph.generated.me.microsoft_graph_wipe_managed_app_registrations_by_azure_ad_device_id.wipe_managed_app_registrations_by_azure_ad_device_id_request_builder')
