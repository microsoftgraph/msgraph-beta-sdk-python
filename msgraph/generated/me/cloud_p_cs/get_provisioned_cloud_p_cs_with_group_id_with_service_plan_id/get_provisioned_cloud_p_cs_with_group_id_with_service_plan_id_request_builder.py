...
class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, group_id: Optional[str] = None, service_plan_id: Optional[str] = None) -> None:
        ...
        Args:
            ...
            service_plan_id: Usage: servicePlanId='{servicePlanId}'
        """
        super().__init__(request_adapter, "{+baseurl}/me/cloudPCs/getProvisionedCloudPCs(groupId='{groupId}',servicePlanId='{servicePlanId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", path_parameters)
