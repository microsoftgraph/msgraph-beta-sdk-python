...
get_supported_cloud_pc_remote_actions_response = lazy_import('msgraph.generated.me.cloud_p_cs.item.get_supported_cloud_pc_remote_actions.get_supported_cloud_pc_remote_actions_response')
...
class GetSupportedCloudPcRemoteActionsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/cloudPCs/{cloudPC%2Did}/getSupportedCloudPcRemoteActions(){?%24top,%24skip,%24search,%24filter,%24count}"
