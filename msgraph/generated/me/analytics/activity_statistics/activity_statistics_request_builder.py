...
count_request_builder = lazy_import('msgraph.generated.me.analytics.activity_statistics.count.count_request_builder')
activity_statistics = lazy_import('msgraph.generated.models.activity_statistics')
activity_statistics_collection_response = lazy_import('msgraph.generated.models.activity_statistics_collection_response')
...
class ActivityStatisticsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[ActivityStatisticsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[activity_statistics.ActivityStatistics] = None, request_configuration: Optional[ActivityStatisticsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
