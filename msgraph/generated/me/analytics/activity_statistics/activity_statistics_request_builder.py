...
if TYPE_CHECKING:
    from ....models import activity_statistics, activity_statistics_collection_response
    from ....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import activity_statistics_item_request_builder

class ActivityStatisticsRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/analytics/activityStatistics{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def by_activity_statistics_id(self,activity_statistics_id: str) -> activity_statistics_item_request_builder.ActivityStatisticsItemRequestBuilder:
        """
        Provides operations to manage the activityStatistics property of the microsoft.graph.userAnalytics entity.
        Args:
            activity_statistics_id: Unique identifier of the item
        Returns: activity_statistics_item_request_builder.ActivityStatisticsItemRequestBuilder
        """
        if activity_statistics_id is None:
            raise Exception("activity_statistics_id cannot be undefined")
        from .item import activity_statistics_item_request_builder
    ...
    async def get(self,request_configuration: Optional[ActivityStatisticsRequestBuilderGetRequestConfiguration] = None) -> Optional[activity_statistics_collection_response.ActivityStatisticsCollectionResponse]:
        ...
        from ....models import activity_statistics_collection_response
    ...
    def to_post_request_information(self,body: Optional[activity_statistics.ActivityStatistics] = None, request_configuration: Optional[ActivityStatisticsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to activityStatistics for me
        Args:
            body: The request body
    ...
    @dataclass
    class ActivityStatisticsRequestBuilderGetRequestConfiguration():
        """
    ...
    @dataclass
    class ActivityStatisticsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
