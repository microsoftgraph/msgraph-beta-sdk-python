...
class AnalyticsRequestBuilder():
    ...
    def to_patch_request_information(self,body: Optional[user_analytics.UserAnalytics] = None, request_configuration: Optional[AnalyticsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property analytics in me
        Args:
            body: The request body
