...
class ContactMergeSuggestionsRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ContactMergeSuggestionsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[ContactMergeSuggestionsRequestBuilderGetRequestConfiguration] = None) -> Optional[contact_merge_suggestions.ContactMergeSuggestions]:
        ...
        return await self.request_adapter.send_async(request_info, contact_merge_suggestions.ContactMergeSuggestions, error_mapping)
