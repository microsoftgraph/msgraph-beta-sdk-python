...
class RegionalAndLanguageSettingsRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[RegionalAndLanguageSettingsRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    async def get(self,request_configuration: Optional[RegionalAndLanguageSettingsRequestBuilderGetRequestConfiguration] = None) -> Optional[regional_and_language_settings.RegionalAndLanguageSettings]:
        ...
        return await self.request_adapter.send_async(request_info, regional_and_language_settings.RegionalAndLanguageSettings, error_mapping)
