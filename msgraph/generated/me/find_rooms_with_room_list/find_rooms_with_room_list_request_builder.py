...
find_rooms_with_room_list_response = lazy_import('msgraph.generated.me.find_rooms_with_room_list.find_rooms_with_room_list_response')
...
class FindRoomsWithRoomListRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[FindRoomsWithRoomListRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
