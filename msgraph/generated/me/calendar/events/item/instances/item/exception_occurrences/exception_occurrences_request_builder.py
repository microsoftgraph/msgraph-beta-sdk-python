...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.me.calendar.events.item.instances.item.exception_occurrences.microsoft_graph_delta.microsoft_graph_delta_request_builder')
