...
forward_post_request_body = lazy_import('msgraph.generated.me.calendar.events.item.instances.item.exception_occurrences.item.forward.forward_post_request_body')
...
class ForwardRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/forward"
