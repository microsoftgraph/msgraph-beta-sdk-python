...
snooze_reminder_post_request_body = lazy_import('msgraph.generated.me.calendar.events.item.exception_occurrences.item.instances.item.snooze_reminder.snooze_reminder_post_request_body')
...
class SnoozeReminderRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/microsoft.graph.snoozeReminder"
