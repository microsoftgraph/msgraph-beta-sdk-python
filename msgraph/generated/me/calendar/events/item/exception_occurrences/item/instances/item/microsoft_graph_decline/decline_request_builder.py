...
decline_post_request_body = lazy_import('msgraph.generated.me.calendar.events.item.exception_occurrences.item.instances.item.microsoft_graph_decline.decline_post_request_body')
