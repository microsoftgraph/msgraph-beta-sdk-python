...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.me.calendar.events.item.exception_occurrences.item.instances.microsoft_graph_delta.microsoft_graph_delta_request_builder')
