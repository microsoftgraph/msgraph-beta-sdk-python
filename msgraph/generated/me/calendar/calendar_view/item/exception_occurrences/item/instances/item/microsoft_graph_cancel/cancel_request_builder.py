...
cancel_post_request_body = lazy_import('msgraph.generated.me.calendar.calendar_view.item.exception_occurrences.item.instances.item.microsoft_graph_cancel.cancel_post_request_body')
