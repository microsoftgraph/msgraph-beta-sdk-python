...
find_room_lists_response = lazy_import('msgraph.generated.me.find_room_lists.find_room_lists_response')
...
class FindRoomListsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/microsoft.graph.findRoomLists(){?%24top,%24skip,%24search,%24filter,%24count}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[FindRoomListsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class FindRoomListsRequestBuilderGetRequestConfiguration():
        """
        ...
        query_parameters: Optional[FindRoomListsRequestBuilder.FindRoomListsRequestBuilderGetQueryParameters] = None
