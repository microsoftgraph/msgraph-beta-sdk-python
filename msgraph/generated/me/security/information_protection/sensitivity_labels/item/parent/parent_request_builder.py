...
class ParentRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[ParentRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
    ...
    def to_patch_request_information(self,body: Optional[sensitivity_label.SensitivityLabel] = None, request_configuration: Optional[ParentRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property parent in me
        Args:
            body: The request body
