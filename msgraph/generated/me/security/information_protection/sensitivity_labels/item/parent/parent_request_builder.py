...
class ParentRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[ParentRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ParentRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[sensitivity_label.SensitivityLabel] = None, request_configuration: Optional[ParentRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
