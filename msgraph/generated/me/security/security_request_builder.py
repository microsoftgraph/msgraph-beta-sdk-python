...
information_protection_request_builder = lazy_import('msgraph.generated.me.security.information_protection.information_protection_request_builder')
...
class SecurityRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/security{?%24select,%24expand}"
