...
microsoft_graph_create_or_get_request_builder = lazy_import('msgraph.generated.me.online_meetings.microsoft_graph_create_or_get.microsoft_graph_create_or_get_request_builder')
...
class OnlineMeetingsRequestBuilder():
    ...
    def to_post_request_information(self,body: Optional[online_meeting.OnlineMeeting] = None, request_configuration: Optional[OnlineMeetingsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create an online meeting on behalf of a user.
        Args:
            body: The request body
