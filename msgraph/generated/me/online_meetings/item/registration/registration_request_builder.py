...
custom_questions_request_builder = lazy_import('msgraph.generated.me.online_meetings.item.registration.custom_questions.custom_questions_request_builder')
meeting_registration_question_item_request_builder = lazy_import('msgraph.generated.me.online_meetings.item.registration.custom_questions.item.meeting_registration_question_item_request_builder')
...
class RegistrationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration{?%24select,%24expand}"
