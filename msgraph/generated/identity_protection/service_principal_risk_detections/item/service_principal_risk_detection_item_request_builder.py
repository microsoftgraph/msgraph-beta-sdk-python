...
class ServicePrincipalRiskDetectionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/identityProtection/servicePrincipalRiskDetections/{servicePrincipalRiskDetection%2Did}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_delete_request_information(self,request_configuration: Optional[ServicePrincipalRiskDetectionItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[ServicePrincipalRiskDetectionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[service_principal_risk_detection.ServicePrincipalRiskDetection] = None, request_configuration: Optional[ServicePrincipalRiskDetectionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class ServicePrincipalRiskDetectionItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[ServicePrincipalRiskDetectionItemRequestBuilder.ServicePrincipalRiskDetectionItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class ServicePrincipalRiskDetectionItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
