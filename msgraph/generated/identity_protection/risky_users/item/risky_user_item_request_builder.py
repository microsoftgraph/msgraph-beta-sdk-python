...
history_request_builder = lazy_import('msgraph.generated.identity_protection.risky_users.item.history.history_request_builder')
risky_user_history_item_item_request_builder = lazy_import('msgraph.generated.identity_protection.risky_users.item.history.item.risky_user_history_item_item_request_builder')
