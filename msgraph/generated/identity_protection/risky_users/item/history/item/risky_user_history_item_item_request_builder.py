...
class RiskyUserHistoryItemItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, risky_user_history_item_id: Optional[str] = None) -> None:
        """
        Instantiates a new RiskyUserHistoryItemItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            riskyUserHistoryItemId: key: id of riskyUserHistoryItem
        """
        ...
        url_tpl_params["riskyUserHistoryItem%2Did"] = riskyUserHistoryItemId
    ...
    def to_patch_request_information(self,body: Optional[risky_user_history_item.RiskyUserHistoryItem] = None, request_configuration: Optional[RiskyUserHistoryItemItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property history in identityProtection
        Args:
            body: The request body
