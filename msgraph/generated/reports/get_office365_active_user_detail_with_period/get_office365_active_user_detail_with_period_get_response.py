...
@dataclass
class GetOffice365ActiveUserDetailWithPeriodGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[Office365ActiveUserDetail]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetOffice365ActiveUserDetailWithPeriodGetResponse:
        """
