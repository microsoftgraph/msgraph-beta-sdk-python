...
if TYPE_CHECKING:
    ...
    from .get_office365_groups_activity_storage_with_period_response import GetOffice365GroupsActivityStorageWithPeriodResponse
...
class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration] = None) -> Optional[GetOffice365GroupsActivityStorageWithPeriodResponse]:
        """
        Invoke function getOffice365GroupsActivityStorage
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[GetOffice365GroupsActivityStorageWithPeriodResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetOffice365GroupsActivityStorageWithPeriodResponse, error_mapping)
