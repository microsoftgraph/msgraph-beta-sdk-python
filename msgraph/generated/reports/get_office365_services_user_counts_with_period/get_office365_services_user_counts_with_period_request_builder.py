...
if TYPE_CHECKING:
    ...
    from .get_office365_services_user_counts_with_period_response import GetOffice365ServicesUserCountsWithPeriodResponse
...
class GetOffice365ServicesUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetOffice365ServicesUserCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> Optional[GetOffice365ServicesUserCountsWithPeriodResponse]:
        ...
        Returns: Optional[GetOffice365ServicesUserCountsWithPeriodResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetOffice365ServicesUserCountsWithPeriodResponse, error_mapping)
