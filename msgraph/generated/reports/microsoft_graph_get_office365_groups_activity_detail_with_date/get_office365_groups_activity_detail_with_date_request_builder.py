...
get_office365_groups_activity_detail_with_date_response = lazy_import('msgraph.generated.reports.microsoft_graph_get_office365_groups_activity_detail_with_date.get_office365_groups_activity_detail_with_date_response')
...
class GetOffice365GroupsActivityDetailWithDateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, date: Optional[Date] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/microsoft.graph.getOffice365GroupsActivityDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
    ...
    class GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[GetOffice365GroupsActivityDetailWithDateRequestBuilder.GetOffice365GroupsActivityDetailWithDateRequestBuilderGetQueryParameters] = None
