...
get_office365_groups_activity_file_counts_with_period_response = lazy_import('msgraph.generated.reports.get_office365_groups_activity_file_counts_with_period.get_office365_groups_activity_file_counts_with_period_response')
...
class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
