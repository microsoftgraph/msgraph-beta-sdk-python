...
class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/microsoft.graph.getTeamsDeviceUsageUserDetail(period='{period}')"
    ...
    def create_get_request_information(self,request_configuration: Optional[GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    async def get(self,request_configuration: Optional[GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> bytes:
        """
        Invoke function getTeamsDeviceUsageUserDetail
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
