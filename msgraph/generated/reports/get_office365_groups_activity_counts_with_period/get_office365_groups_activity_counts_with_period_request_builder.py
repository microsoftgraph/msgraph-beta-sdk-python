...
class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetOffice365GroupsActivityCountsWithPeriodRequestBuilder:
        """
