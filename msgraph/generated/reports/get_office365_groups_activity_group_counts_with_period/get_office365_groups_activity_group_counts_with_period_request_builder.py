...
get_office365_groups_activity_group_counts_with_period_response = lazy_import('msgraph.generated.reports.get_office365_groups_activity_group_counts_with_period.get_office365_groups_activity_group_counts_with_period_response')
...
class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/getOffice365GroupsActivityGroupCounts(period='{period}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
