...
if TYPE_CHECKING:
    from ...models import base_collection_pagination_count_response, office365_groups_activity_group_counts
...
class GetOffice365GroupsActivityGroupCountsWithPeriodResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[office365_groups_activity_group_counts.Office365GroupsActivityGroupCounts]] = None
