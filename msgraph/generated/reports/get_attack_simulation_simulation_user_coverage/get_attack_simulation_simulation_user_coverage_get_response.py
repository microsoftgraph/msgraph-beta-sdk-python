...
@dataclass
class GetAttackSimulationSimulationUserCoverageGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[AttackSimulationSimulationUserCoverage]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetAttackSimulationSimulationUserCoverageGetResponse:
        """
        ...
        return GetAttackSimulationSimulationUserCoverageGetResponse()
