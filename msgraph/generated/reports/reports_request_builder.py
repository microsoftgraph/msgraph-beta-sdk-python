...
from .application_sign_in_detailed_summary.item import application_sign_in_detailed_summary_item_request_builder
...
from .credential_user_registration_details.item import credential_user_registration_details_item_request_builder
from .daily_print_usage import daily_print_usage_request_builder
from .daily_print_usage.item import print_usage_item_request_builder
...
from .daily_print_usage_summaries_by_printer.item import print_usage_by_printer_item_request_builder
from .daily_print_usage_summaries_by_user import daily_print_usage_summaries_by_user_request_builder
from .daily_print_usage_summaries_by_user.item import print_usage_by_user_item_request_builder
...
from .monthly_print_usage_summaries_by_printer.item import print_usage_by_printer_item_request_builder
from .monthly_print_usage_summaries_by_user import monthly_print_usage_summaries_by_user_request_builder
from .monthly_print_usage_summaries_by_user.item import print_usage_by_user_item_request_builder
...
from .user_credential_usage_details.item import user_credential_usage_details_item_request_builder
...
class ReportsRequestBuilder():
    ...
    def get_credential_user_registration_count(self,) -> get_credential_user_registration_count_request_builder.GetCredentialUserRegistrationCountRequestBuilder:
        ...
        Returns: get_credential_user_registration_count_request_builder.GetCredentialUserRegistrationCountRequestBuilder
        """
    ...
    def managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token(self,filter: Optional[str] = None, skip: Optional[int] = None, skip_token: Optional[str] = None, top: Optional[int] = None) -> managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token_request_builder.ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder:
        ...
        return managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token_request_builder.ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder(self.request_adapter, self.path_parameters, filter, skip, skipToken, top)
    ...
    def managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token(self,filter: Optional[str] = None, skip: Optional[int] = None, skip_token: Optional[str] = None, top: Optional[int] = None) -> managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token_request_builder.ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilder:
        ...
        if top is None:
            raise Exception("top cannot be undefined")
        return managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token_request_builder.ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTopWithFilterWithSkipTokenRequestBuilder(self.request_adapter, self.path_parameters, filter, skip, skipToken, top)
    ...
    def managed_device_enrollment_failure_trends(self,) -> managed_device_enrollment_failure_trends_request_builder.ManagedDeviceEnrollmentFailureTrendsRequestBuilder:
        ...
        Returns: managed_device_enrollment_failure_trends_request_builder.ManagedDeviceEnrollmentFailureTrendsRequestBuilder
        """
