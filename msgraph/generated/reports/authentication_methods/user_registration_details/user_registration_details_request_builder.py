...
user_registration_details_collection_response = lazy_import('msgraph.generated.models.user_registration_details_collection_response')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
count_request_builder = lazy_import('msgraph.generated.reports.authentication_methods.user_registration_details.count.count_request_builder')
...
class UserRegistrationDetailsRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[UserRegistrationDetailsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[user_registration_details.UserRegistrationDetails] = None, request_configuration: Optional[UserRegistrationDetailsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
