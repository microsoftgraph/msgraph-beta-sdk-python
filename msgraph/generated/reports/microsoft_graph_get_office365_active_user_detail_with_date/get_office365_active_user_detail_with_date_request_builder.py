...
get_office365_active_user_detail_with_date_response = lazy_import('msgraph.generated.reports.microsoft_graph_get_office365_active_user_detail_with_date.get_office365_active_user_detail_with_date_response')
...
class GetOffice365ActiveUserDetailWithDateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, date: Optional[Date] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/reports/microsoft.graph.getOffice365ActiveUserDetail(date={date}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
