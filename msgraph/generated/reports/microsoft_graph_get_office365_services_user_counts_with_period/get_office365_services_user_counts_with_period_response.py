...
office365_services_user_counts = lazy_import('msgraph.generated.models.office365_services_user_counts')
...
class GetOffice365ServicesUserCountsWithPeriodResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[office365_services_user_counts.Office365ServicesUserCounts]] = None
    ...
    @property
    def value(self,) -> Optional[List[office365_services_user_counts.Office365ServicesUserCounts]]:
        """
        Gets the value property value. The value property
        Returns: Optional[List[office365_services_user_counts.Office365ServicesUserCounts]]
        """
        return self._value
    
    @value.setter
    def value(self,value: Optional[List[office365_services_user_counts.Office365ServicesUserCounts]] = None) -> None:
        """
