...
@dataclass
class GetOffice365GroupsActivityDetailWithPeriodGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetOffice365GroupsActivityDetailWithPeriodGetResponse:
        ...
        return GetOffice365GroupsActivityDetailWithPeriodGetResponse()
