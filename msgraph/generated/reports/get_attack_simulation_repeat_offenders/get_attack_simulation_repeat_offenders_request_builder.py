...
class GetAttackSimulationRepeatOffendersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/getAttackSimulationRepeatOffenders(){?%24top,%24skip,%24search,%24filter,%24count}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetAttackSimulationRepeatOffendersRequestBuilder:
        """
        ...
        return GetAttackSimulationRepeatOffendersRequestBuilder(raw_url, self.request_adapter)
