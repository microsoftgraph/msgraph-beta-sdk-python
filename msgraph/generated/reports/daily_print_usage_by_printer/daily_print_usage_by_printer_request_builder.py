...
class DailyPrintUsageByPrinterRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[DailyPrintUsageByPrinterRequestBuilderGetRequestConfiguration] = None) -> Optional[print_usage_by_printer_collection_response.PrintUsageByPrinterCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[print_usage_by_printer.PrintUsageByPrinter] = None, request_configuration: Optional[DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration] = None) -> Optional[print_usage_by_printer.PrintUsageByPrinter]:
        """
    ...
    def to_post_request_information(self,body: Optional[print_usage_by_printer.PrintUsageByPrinter] = None, request_configuration: Optional[DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to dailyPrintUsageByPrinter for reports
        Args:
            body: The request body
