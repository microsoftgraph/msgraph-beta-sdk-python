...
get_relying_party_detailed_summary_with_period_response = lazy_import('msgraph.generated.reports.get_relying_party_detailed_summary_with_period.get_relying_party_detailed_summary_with_period_response')
...
class GetRelyingPartyDetailedSummaryWithPeriodRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[GetRelyingPartyDetailedSummaryWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
