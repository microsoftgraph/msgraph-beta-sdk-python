...
cancel_request_builder = lazy_import('msgraph.generated.privileged_access.item.role_assignment_requests.item.microsoft_graph_cancel.cancel_request_builder')
update_request_request_builder = lazy_import('msgraph.generated.privileged_access.item.role_assignment_requests.item.microsoft_graph_update_request.update_request_request_builder')
