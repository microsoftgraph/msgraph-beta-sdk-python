...
update_request_post_request_body = lazy_import('msgraph.generated.privileged_access.item.role_assignment_requests.item.update_request.update_request_post_request_body')
...
class UpdateRequestRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/updateRequest"
