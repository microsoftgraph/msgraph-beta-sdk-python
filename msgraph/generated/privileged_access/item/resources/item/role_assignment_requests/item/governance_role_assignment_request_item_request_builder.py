...
cancel_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.microsoft_graph_cancel.cancel_request_builder')
update_request_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.microsoft_graph_update_request.update_request_request_builder')
resource_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.resource.resource_request_builder')
role_definition_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.role_definition.role_definition_request_builder')
subject_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.subject.subject_request_builder')
...
class GovernanceRoleAssignmentRequestItemRequestBuilder():
    ...
    @property
    def microsoft_graph_update_request(self) -> update_request_request_builder.UpdateRequestRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, governance_role_assignment_request_id: Optional[str] = None) -> None:
        """
        Instantiates a new GovernanceRoleAssignmentRequestItemRequestBuilder and sets the default values.
        Args:
            governanceRoleAssignmentRequestId: key: id of governanceRoleAssignmentRequest
        ...
        url_tpl_params["governanceRoleAssignmentRequest%2Did"] = governanceRoleAssignmentRequestId
