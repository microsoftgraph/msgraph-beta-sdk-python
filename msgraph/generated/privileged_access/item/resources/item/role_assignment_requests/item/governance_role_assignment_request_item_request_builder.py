...
cancel_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.cancel.cancel_request_builder')
...
update_request_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.update_request.update_request_request_builder')
