...
microsoft_graph_cancel_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.microsoft_graph_cancel.microsoft_graph_cancel_request_builder')
microsoft_graph_update_request_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.microsoft_graph_update_request.microsoft_graph_update_request_request_builder')
...
class GovernanceRoleAssignmentRequestItemRequestBuilder():
    ...
    @property
    def microsoft_graph_update_request(self) -> microsoft_graph_update_request_request_builder.MicrosoftGraphUpdateRequestRequestBuilder:
        """
        Provides operations to call the updateRequest method.
        """
        return microsoft_graph_update_request_request_builder.MicrosoftGraphUpdateRequestRequestBuilder(self.request_adapter, self.path_parameters)
