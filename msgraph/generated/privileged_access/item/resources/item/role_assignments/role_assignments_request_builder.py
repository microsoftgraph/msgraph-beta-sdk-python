...
count_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.count.count_request_builder')
microsoft_graph_export_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.microsoft_graph_export.microsoft_graph_export_request_builder')
...
class RoleAssignmentsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[governance_role_assignment.GovernanceRoleAssignment] = None, request_configuration: Optional[RoleAssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to roleAssignments for privilegedAccess
        Args:
            body: The request body
