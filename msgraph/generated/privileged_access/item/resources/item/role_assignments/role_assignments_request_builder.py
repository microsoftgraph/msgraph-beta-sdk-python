...
export_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.microsoft_graph_export.export_request_builder')
