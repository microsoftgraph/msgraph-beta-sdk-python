...
class LinkedEligibleRoleAssignmentRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[LinkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration] = None) -> Optional[governance_role_assignment.GovernanceRoleAssignment]:
        """
