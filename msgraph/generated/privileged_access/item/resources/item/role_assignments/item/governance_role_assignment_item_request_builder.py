...
linked_eligible_role_assignment_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.item.linked_eligible_role_assignment.linked_eligible_role_assignment_request_builder')
resource_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.item.resource.resource_request_builder')
role_definition_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.item.role_definition.role_definition_request_builder')
subject_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.item.subject.subject_request_builder')
...
class GovernanceRoleAssignmentItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24select,%24expand}"
