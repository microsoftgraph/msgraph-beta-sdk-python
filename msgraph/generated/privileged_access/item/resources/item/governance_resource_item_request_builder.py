...
parent_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.parent.parent_request_builder')
role_assignment_requests_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.role_assignment_requests_request_builder')
governance_role_assignment_request_item_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignment_requests.item.governance_role_assignment_request_item_request_builder')
role_assignments_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.role_assignments_request_builder')
governance_role_assignment_item_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_assignments.item.governance_role_assignment_item_request_builder')
role_definitions_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_definitions.role_definitions_request_builder')
governance_role_definition_item_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_definitions.item.governance_role_definition_item_request_builder')
role_settings_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_settings.role_settings_request_builder')
governance_role_setting_item_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.item.role_settings.item.governance_role_setting_item_request_builder')
...
class GovernanceResourceItemRequestBuilder():
    ...
    def create_delete_request_information(self,request_configuration: Optional[GovernanceResourceItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_get_request_information(self,request_configuration: Optional[GovernanceResourceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_patch_request_information(self,body: Optional[governance_resource.GovernanceResource] = None, request_configuration: Optional[GovernanceResourceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    class GovernanceResourceItemRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[GovernanceResourceItemRequestBuilder.GovernanceResourceItemRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class GovernanceResourceItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
