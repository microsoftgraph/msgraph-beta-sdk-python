...
class ResourcesRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[governance_resource.GovernanceResource] = None, request_configuration: Optional[ResourcesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
