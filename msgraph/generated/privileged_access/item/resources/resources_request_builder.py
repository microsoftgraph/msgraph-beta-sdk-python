...
register_request_builder = lazy_import('msgraph.generated.privileged_access.item.resources.microsoft_graph_register.register_request_builder')
...
class ResourcesRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
    ...
    def to_post_request_information(self,body: Optional[governance_resource.GovernanceResource] = None, request_configuration: Optional[ResourcesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to resources for privilegedAccess
        Args:
            body: The request body
