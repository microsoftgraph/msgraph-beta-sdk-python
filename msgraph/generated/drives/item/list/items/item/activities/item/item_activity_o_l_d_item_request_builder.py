...
drive_item_request_builder = lazy_import('msgraph.generated.drives.item.list.items.item.activities.item.drive_item.drive_item_request_builder')
list_item_request_builder = lazy_import('msgraph.generated.drives.item.list.items.item.activities.item.list_item.list_item_request_builder')
