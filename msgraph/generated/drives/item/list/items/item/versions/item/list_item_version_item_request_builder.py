...
restore_version_request_builder = lazy_import('msgraph.generated.drives.item.list.items.item.versions.item.restore_version.restore_version_request_builder')
