...
microsoft_graph_delta_request_builder = lazy_import('msgraph.generated.drives.item.list.items.microsoft_graph_delta.microsoft_graph_delta_request_builder')
microsoft_graph_delta_with_token_request_builder = lazy_import('msgraph.generated.drives.item.list.items.microsoft_graph_delta_with_token.microsoft_graph_delta_with_token_request_builder')
