...
delta_request_builder = lazy_import('msgraph.generated.drives.item.list.items.delta.delta_request_builder')
delta_with_token_request_builder = lazy_import('msgraph.generated.drives.item.list.items.delta_with_token.delta_with_token_request_builder')
