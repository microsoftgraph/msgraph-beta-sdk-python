...
activities_request_builder = lazy_import('msgraph.generated.drives.item.list.activities.activities_request_builder')
columns_request_builder = lazy_import('msgraph.generated.drives.item.list.columns.columns_request_builder')
column_definition_item_request_builder = lazy_import('msgraph.generated.drives.item.list.columns.item.column_definition_item_request_builder')
content_types_request_builder = lazy_import('msgraph.generated.drives.item.list.content_types.content_types_request_builder')
content_type_item_request_builder = lazy_import('msgraph.generated.drives.item.list.content_types.item.content_type_item_request_builder')
drive_request_builder = lazy_import('msgraph.generated.drives.item.list.drive.drive_request_builder')
items_request_builder = lazy_import('msgraph.generated.drives.item.list.items.items_request_builder')
list_item_item_request_builder = lazy_import('msgraph.generated.drives.item.list.items.item.list_item_item_request_builder')
operations_request_builder = lazy_import('msgraph.generated.drives.item.list.operations.operations_request_builder')
rich_long_running_operation_item_request_builder = lazy_import('msgraph.generated.drives.item.list.operations.item.rich_long_running_operation_item_request_builder')
subscriptions_request_builder = lazy_import('msgraph.generated.drives.item.list.subscriptions.subscriptions_request_builder')
subscription_item_request_builder = lazy_import('msgraph.generated.drives.item.list.subscriptions.item.subscription_item_request_builder')
...
class ListRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/list{?%24select,%24expand}"
