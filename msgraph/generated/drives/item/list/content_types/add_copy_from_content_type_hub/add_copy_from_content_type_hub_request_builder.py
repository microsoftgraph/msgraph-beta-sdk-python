...
add_copy_from_content_type_hub_post_request_body = lazy_import('msgraph.generated.drives.item.list.content_types.add_copy_from_content_type_hub.add_copy_from_content_type_hub_post_request_body')
