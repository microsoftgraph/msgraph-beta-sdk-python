...
content_request_builder = lazy_import('msgraph.generated.drives.item.root.versions.item.content.content_request_builder')
restore_version_request_builder = lazy_import('msgraph.generated.drives.item.root.versions.item.restore_version.restore_version_request_builder')
...
class DriveItemVersionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}"
