...
grant_request_builder = lazy_import('msgraph.generated.drives.item.root.permissions.item.grant.grant_request_builder')
revoke_grants_request_builder = lazy_import('msgraph.generated.drives.item.root.permissions.item.revoke_grants.revoke_grants_request_builder')
...
class PermissionItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/root/permissions/{permission%2Did}{?%24select,%24expand}"
