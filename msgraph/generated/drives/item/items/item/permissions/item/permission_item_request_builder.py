...
revoke_grants_request_builder = lazy_import('msgraph.generated.drives.item.items.item.permissions.item.microsoft_graph_revoke_grants.revoke_grants_request_builder')
