...
assign_sensitivity_label_request_builder = lazy_import('msgraph.generated.drives.item.items.item.microsoft_graph_assign_sensitivity_label.assign_sensitivity_label_request_builder')
...
extract_sensitivity_labels_request_builder = lazy_import('msgraph.generated.drives.item.items.item.microsoft_graph_extract_sensitivity_labels.extract_sensitivity_labels_request_builder')
...
class DriveItemItemRequestBuilder():
    ...
    @property
    def microsoft_graph_assign_sensitivity_label(self) -> assign_sensitivity_label_request_builder.AssignSensitivityLabelRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_extract_sensitivity_labels(self) -> extract_sensitivity_labels_request_builder.ExtractSensitivityLabelsRequestBuilder:
        """
