...
class CloseSessionRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/closeSession", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CloseSessionRequestBuilder:
        ...
        Returns: CloseSessionRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class CloseSessionRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
