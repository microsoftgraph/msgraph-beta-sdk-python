...
if TYPE_CHECKING:
    from .............models import workbook_chart_axis_title
...
class TitleRequestBuilder():
    ...
    async def delete(self,request_configuration: Optional[TitleRequestBuilderDeleteRequestConfiguration] = None) -> bytes:
        """
