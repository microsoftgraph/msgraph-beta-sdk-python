...
format_request_builder = lazy_import('msgraph.generated.drives.item.items.item.workbook.worksheets.item.charts.item.axes.series_axis.title.format.format_request_builder')
workbook_chart_axis_title = lazy_import('msgraph.generated.models.workbook_chart_axis_title')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class TitleRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/seriesAxis/title{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[TitleRequestBuilderGetRequestConfiguration] = None) -> Optional[workbook_chart_axis_title.WorkbookChartAxisTitle]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_async(request_info, workbook_chart_axis_title.WorkbookChartAxisTitle, error_mapping)
    ...
    @dataclass
    class TitleRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class TitleRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
