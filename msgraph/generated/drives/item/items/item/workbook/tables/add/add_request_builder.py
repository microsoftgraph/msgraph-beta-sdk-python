...
add_post_request_body = lazy_import('msgraph.generated.drives.item.items.item.workbook.tables.add.add_post_request_body')
...
class AddRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/add"
