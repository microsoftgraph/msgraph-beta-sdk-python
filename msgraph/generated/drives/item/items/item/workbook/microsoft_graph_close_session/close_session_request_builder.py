...
class CloseSessionRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/microsoft.graph.closeSession"
    ...
    @dataclass
    class CloseSessionRequestBuilderPostRequestConfiguration():
        """
