...
create_upload_session_post_request_body = lazy_import('msgraph.generated.drives.item.items.item.create_upload_session.create_upload_session_post_request_body')
