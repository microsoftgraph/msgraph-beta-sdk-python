...
class AddLargeGalleryViewPostRequestBody(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AddLargeGalleryViewPostRequestBody:
        """
        ...
        return AddLargeGalleryViewPostRequestBody()
