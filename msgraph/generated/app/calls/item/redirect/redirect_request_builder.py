...
redirect_post_request_body = lazy_import('msgraph.generated.app.calls.item.redirect.redirect_post_request_body')
...
class RedirectRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[redirect_post_request_body.RedirectPostRequestBody] = None, request_configuration: Optional[RedirectRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
