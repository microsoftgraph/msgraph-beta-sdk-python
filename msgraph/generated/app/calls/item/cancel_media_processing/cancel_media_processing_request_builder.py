...
cancel_media_processing_post_request_body = lazy_import('msgraph.generated.app.calls.item.cancel_media_processing.cancel_media_processing_post_request_body')
...
class CancelMediaProcessingRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.cancelMediaProcessing"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[cancel_media_processing_post_request_body.CancelMediaProcessingPostRequestBody] = None, request_configuration: Optional[CancelMediaProcessingRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
