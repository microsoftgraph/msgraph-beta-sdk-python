...
class CancelMediaProcessingRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/app/calls/{call%2Did}/cancelMediaProcessing", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CancelMediaProcessingRequestBuilder:
        ...
        return CancelMediaProcessingRequestBuilder(raw_url, self.request_adapter)
