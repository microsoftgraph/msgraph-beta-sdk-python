...
add_large_gallery_view_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_add_large_gallery_view.add_large_gallery_view_request_builder')
answer_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_answer.answer_request_builder')
cancel_media_processing_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_cancel_media_processing.cancel_media_processing_request_builder')
change_screen_sharing_role_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_change_screen_sharing_role.change_screen_sharing_role_request_builder')
keep_alive_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_keep_alive.keep_alive_request_builder')
mute_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_mute.mute_request_builder')
play_prompt_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_play_prompt.play_prompt_request_builder')
record_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_record.record_request_builder')
record_response_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_record_response.record_response_request_builder')
redirect_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_redirect.redirect_request_builder')
reject_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_reject.reject_request_builder')
subscribe_to_tone_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_subscribe_to_tone.subscribe_to_tone_request_builder')
transfer_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_transfer.transfer_request_builder')
unmute_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_unmute.unmute_request_builder')
update_recording_status_request_builder = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_update_recording_status.update_recording_status_request_builder')
