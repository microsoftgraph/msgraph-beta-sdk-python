...
mute_post_request_body = lazy_import('msgraph.generated.app.calls.item.mute.mute_post_request_body')
...
class MuteRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[mute_post_request_body.MutePostRequestBody] = None, request_configuration: Optional[MuteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
