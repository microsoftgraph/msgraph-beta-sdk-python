...
if TYPE_CHECKING:
    from .....models import comms_operation, comms_operation_collection_response
    from .....models.o_data_errors import o_data_error
    from .count import count_request_builder
    from .item import comms_operation_item_request_builder
...
class OperationsRequestBuilder():
    ...
    def by_comms_operation_id(self,comms_operation_id: str) -> comms_operation_item_request_builder.CommsOperationItemRequestBuilder:
        """
        Provides operations to manage the operations property of the microsoft.graph.call entity.
        Args:
        ...
        """
        if comms_operation_id is None:
            raise Exception("comms_operation_id cannot be undefined")
        from .item import comms_operation_item_request_builder
    ...
    async def get(self,request_configuration: Optional[OperationsRequestBuilderGetRequestConfiguration] = None) -> Optional[comms_operation_collection_response.CommsOperationCollectionResponse]:
        ...
        from .....models import comms_operation_collection_response
    ...
    async def post(self,body: Optional[comms_operation.CommsOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> Optional[comms_operation.CommsOperation]:
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from .....models import comms_operation
    ...
    def to_post_request_information(self,body: Optional[comms_operation.CommsOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to operations for app
        Args:
            body: The request body
