...
count_request_builder = lazy_import('msgraph.generated.app.calls.item.operations.count.count_request_builder')
comms_operation = lazy_import('msgraph.generated.models.comms_operation')
comms_operation_collection_response = lazy_import('msgraph.generated.models.comms_operation_collection_response')
...
class OperationsRequestBuilder():
    ...
    def create_post_request_information(self,body: Optional[comms_operation.CommsOperation] = None, request_configuration: Optional[OperationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
