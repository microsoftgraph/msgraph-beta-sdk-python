...
invite_request_builder = lazy_import('msgraph.generated.app.calls.item.participants.microsoft_graph_invite.invite_request_builder')
mute_all_request_builder = lazy_import('msgraph.generated.app.calls.item.participants.microsoft_graph_mute_all.mute_all_request_builder')
...
class ParticipantsRequestBuilder():
    ...
    @property
    def microsoft_graph_mute_all(self) -> mute_all_request_builder.MuteAllRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/participants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
