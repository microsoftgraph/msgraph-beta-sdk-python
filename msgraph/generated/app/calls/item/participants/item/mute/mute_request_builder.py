...
mute_post_request_body = lazy_import('msgraph.generated.app.calls.item.participants.item.mute.mute_post_request_body')
...
class MuteRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}/mute"
