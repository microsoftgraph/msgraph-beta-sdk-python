...
microsoft_graph_mute_request_builder = lazy_import('msgraph.generated.app.calls.item.participants.item.microsoft_graph_mute.microsoft_graph_mute_request_builder')
microsoft_graph_start_hold_music_request_builder = lazy_import('msgraph.generated.app.calls.item.participants.item.microsoft_graph_start_hold_music.microsoft_graph_start_hold_music_request_builder')
microsoft_graph_stop_hold_music_request_builder = lazy_import('msgraph.generated.app.calls.item.participants.item.microsoft_graph_stop_hold_music.microsoft_graph_stop_hold_music_request_builder')
...
class ParticipantItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}{?%24select,%24expand}"
