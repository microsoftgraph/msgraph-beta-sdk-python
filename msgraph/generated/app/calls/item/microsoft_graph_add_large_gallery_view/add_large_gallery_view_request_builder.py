...
add_large_gallery_view_post_request_body = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_add_large_gallery_view.add_large_gallery_view_post_request_body')
...
class AddLargeGalleryViewRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.addLargeGalleryView"
