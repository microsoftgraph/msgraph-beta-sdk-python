...
unmute_post_request_body = lazy_import('msgraph.generated.app.calls.item.unmute.unmute_post_request_body')
unmute_participant_operation = lazy_import('msgraph.generated.models.unmute_participant_operation')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')

class UnmuteRequestBuilder():
    """
    ...
    def create_post_request_information(self,body: Optional[unmute_post_request_body.UnmutePostRequestBody] = None, request_configuration: Optional[UnmuteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class UnmuteRequestBuilderPostRequestConfiguration():
        """
