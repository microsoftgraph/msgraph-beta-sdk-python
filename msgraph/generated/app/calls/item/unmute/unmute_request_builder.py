...
if TYPE_CHECKING:
    ...
    from .....models.unmute_participant_operation import UnmuteParticipantOperation
    from .unmute_post_request_body import UnmutePostRequestBody

class UnmuteRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UnmuteRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UnmuteRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return UnmuteRequestBuilder(raw_url, self.request_adapter)
