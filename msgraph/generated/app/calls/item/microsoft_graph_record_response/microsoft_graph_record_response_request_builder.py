...
record_response_post_request_body = lazy_import('msgraph.generated.app.calls.item.microsoft_graph_record_response.record_response_post_request_body')
...
class MicrosoftGraphRecordResponseRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/{call%2Did}/microsoft.graph.recordResponse"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,body: Optional[record_response_post_request_body.RecordResponsePostRequestBody] = None, request_configuration: Optional[MicrosoftGraphRecordResponseRequestBuilderPostRequestConfiguration] = None) -> Optional[record_operation.RecordOperation]:
        """
    ...
    def to_post_request_information(self,body: Optional[record_response_post_request_body.RecordResponsePostRequestBody] = None, request_configuration: Optional[MicrosoftGraphRecordResponseRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Record a short audio response from the caller. A bot can use this to capture a voice response from a caller after they are prompted for a response. For more information about how to handle operations, see commsOperation This action is not intended to record the entire call. The maximum length of recording is 2 minutes. The recording is not saved permanently by the by the Cloud Communications Platform and is discarded shortly after the call ends. The bot must download the recording promptly after the recording operation finishes by using the recordingLocation value that's given in the completed notification.
        Args:
            body: The request body
