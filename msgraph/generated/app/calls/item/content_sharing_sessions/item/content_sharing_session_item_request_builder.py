...
class ContentSharingSessionItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions/{contentSharingSession%2Did}{?%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ContentSharingSessionItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ContentSharingSession]:
        """
        Retrieve the properties of a contentSharingSession object. This API is available in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
