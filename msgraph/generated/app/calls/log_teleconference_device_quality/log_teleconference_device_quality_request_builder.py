...
log_teleconference_device_quality_post_request_body = lazy_import('msgraph.generated.app.calls.log_teleconference_device_quality.log_teleconference_device_quality_post_request_body')
...
class LogTeleconferenceDeviceQualityRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/calls/logTeleconferenceDeviceQuality"
