...
count_request_builder = lazy_import('msgraph.generated.app.online_meetings.count.count_request_builder')
microsoft_graph_create_or_get_request_builder = lazy_import('msgraph.generated.app.online_meetings.microsoft_graph_create_or_get.microsoft_graph_create_or_get_request_builder')
...
class OnlineMeetingsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
