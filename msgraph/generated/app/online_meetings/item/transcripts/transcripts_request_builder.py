...
count_request_builder = lazy_import('msgraph.generated.app.online_meetings.item.transcripts.count.count_request_builder')
call_transcript = lazy_import('msgraph.generated.models.call_transcript')
call_transcript_collection_response = lazy_import('msgraph.generated.models.call_transcript_collection_response')
...
class TranscriptsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/transcripts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_get_request_information(self,request_configuration: Optional[TranscriptsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    def create_post_request_information(self,body: Optional[call_transcript.CallTranscript] = None, request_configuration: Optional[TranscriptsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to transcripts for app
        Args:
    ...
    @dataclass
    class TranscriptsRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
