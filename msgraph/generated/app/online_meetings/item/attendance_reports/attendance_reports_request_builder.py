...
class AttendanceReportsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/attendanceReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_meeting_attendance_report_id(self,meeting_attendance_report_id: str) -> MeetingAttendanceReportItemRequestBuilder:
        ...
        """
        if not meeting_attendance_report_id:
    ...
    async def post(self,body: Optional[MeetingAttendanceReport] = None, request_configuration: Optional[AttendanceReportsRequestBuilderPostRequestConfiguration] = None) -> Optional[MeetingAttendanceReport]:
        """
        Create new navigation property to attendanceReports for app
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AttendanceReportsRequestBuilder:
        """
        ...
        return AttendanceReportsRequestBuilder(raw_url, self.request_adapter)
    ...
    @dataclass
    class AttendanceReportsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AttendanceReportsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
