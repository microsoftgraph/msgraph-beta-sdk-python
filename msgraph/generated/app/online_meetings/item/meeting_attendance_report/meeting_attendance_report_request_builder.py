...
attendance_records_request_builder = lazy_import('msgraph.generated.app.online_meetings.item.meeting_attendance_report.attendance_records.attendance_records_request_builder')
attendance_record_item_request_builder = lazy_import('msgraph.generated.app.online_meetings.item.meeting_attendance_report.attendance_records.item.attendance_record_item_request_builder')
...
class MeetingAttendanceReportRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24select,%24expand}"
