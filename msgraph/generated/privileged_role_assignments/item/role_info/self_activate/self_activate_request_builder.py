...
self_activate_post_request_body = lazy_import('msgraph.generated.privileged_role_assignments.item.role_info.self_activate.self_activate_post_request_body')
...
class SelfActivateRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/selfActivate"
