...
self_activate_request_builder = lazy_import('msgraph.generated.privileged_role_assignments.item.role_info.microsoft_graph_self_activate.self_activate_request_builder')
self_deactivate_request_builder = lazy_import('msgraph.generated.privileged_role_assignments.item.role_info.microsoft_graph_self_deactivate.self_deactivate_request_builder')
...
class RoleInfoRequestBuilder():
    ...
    @property
    def microsoft_graph_self_activate(self) -> self_activate_request_builder.SelfActivateRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_self_deactivate(self) -> self_deactivate_request_builder.SelfDeactivateRequestBuilder:
        """
