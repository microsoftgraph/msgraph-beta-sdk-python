...
class PrivilegedRoleAssignmentItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, privileged_role_assignment_id1: Optional[str] = None) -> None:
        """
        Instantiates a new PrivilegedRoleAssignmentItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            privilegedRoleAssignmentId1: key: id of privilegedRoleAssignment
        ...
        self.url_template: str = "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did1}{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        url_tpl_params["privilegedRoleAssignment%2Did1"] = privilegedRoleAssignmentId1
