...
get_plan_request_builder = lazy_import('msgraph.generated.solutions.business_scenarios.item.planner.microsoft_graph_get_plan.get_plan_request_builder')
...
class PlannerRequestBuilder():
    ...
    """
    @property
    def microsoft_graph_get_plan(self) -> get_plan_request_builder.GetPlanRequestBuilder:
        """
