...
business_scenario_plan_reference = lazy_import('msgraph.generated.models.business_scenario_plan_reference')
o_data_error = lazy_import('msgraph.generated.models.o_data_errors.o_data_error')
get_plan_post_request_body = lazy_import('msgraph.generated.solutions.business_scenarios.item.planner.get_plan.get_plan_post_request_body')

class GetPlanRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/microsoft.graph.getPlan"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[get_plan_post_request_body.GetPlanPostRequestBody] = None, request_configuration: Optional[GetPlanRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
    ...
    @dataclass
    class GetPlanRequestBuilderPostRequestConfiguration():
        """
