...
class PlannerPlanConfigurationLocalizationItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, planner_plan_configuration_localization_id: Optional[str] = None) -> None:
        """
        Instantiates a new PlannerPlanConfigurationLocalizationItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            plannerPlanConfigurationLocalizationId: key: id of plannerPlanConfigurationLocalization
        ...
        url_tpl_params["plannerPlanConfigurationLocalization%2Did"] = plannerPlanConfigurationLocalizationId
