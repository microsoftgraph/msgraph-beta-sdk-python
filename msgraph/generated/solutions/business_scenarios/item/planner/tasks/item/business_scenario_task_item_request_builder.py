...
class BusinessScenarioTaskItemRequestBuilder():
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, business_scenario_task_id: Optional[str] = None) -> None:
        """
        Instantiates a new BusinessScenarioTaskItemRequestBuilder and sets the default values.
        Args:
            businessScenarioTaskId: key: id of businessScenarioTask
        ...
        url_tpl_params["businessScenarioTask%2Did"] = businessScenarioTaskId
