...
if TYPE_CHECKING:
    from ...models import virtual_events_root
    from ...models.o_data_errors import o_data_error
    from .events import events_request_builder
    from .webinars import webinars_request_builder
...
class VirtualEventsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/solutions/virtualEvents{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[VirtualEventsRequestBuilderGetRequestConfiguration] = None) -> Optional[virtual_events_root.VirtualEventsRoot]:
        """
        ...
        return await self.request_adapter.send_async(request_info, virtual_events_root.VirtualEventsRoot, error_mapping)
    
    async def patch(self,body: Optional[virtual_events_root.VirtualEventsRoot] = None, request_configuration: Optional[VirtualEventsRequestBuilderPatchRequestConfiguration] = None) -> Optional[virtual_events_root.VirtualEventsRoot]:
        """
    ...
    def to_patch_request_information(self,body: Optional[virtual_events_root.VirtualEventsRoot] = None, request_configuration: Optional[VirtualEventsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property virtualEvents in solutions
        Args:
            body: The request body
    ...
    @property
    def webinars(self) -> webinars_request_builder.WebinarsRequestBuilder:
        """
        Provides operations to manage the webinars property of the microsoft.graph.virtualEventsRoot entity.
        """
        from .webinars import webinars_request_builder

        return webinars_request_builder.WebinarsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @dataclass
    class VirtualEventsRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class VirtualEventsRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class VirtualEventsRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
