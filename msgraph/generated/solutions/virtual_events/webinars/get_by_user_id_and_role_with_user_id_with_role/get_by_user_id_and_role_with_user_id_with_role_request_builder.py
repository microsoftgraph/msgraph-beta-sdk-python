...
class GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, role: Optional[str] = None, user_id: Optional[str] = None) -> None:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GetByUserIdAndRoleWithUserIdWithRoleRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getByUserIdAndRole
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder:
        """
    ...
    @dataclass
    class GetByUserIdAndRoleWithUserIdWithRoleRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder.GetByUserIdAndRoleWithUserIdWithRoleRequestBuilderGetQueryParameters] = None
