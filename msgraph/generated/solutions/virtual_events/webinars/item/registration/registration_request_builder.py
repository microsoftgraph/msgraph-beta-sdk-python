...
if TYPE_CHECKING:
    from ......models import virtual_event_registration
...
class RegistrationRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registration{?%24select,%24expand}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[RegistrationRequestBuilderGetRequestConfiguration] = None) -> Optional[virtual_event_registration.VirtualEventRegistration]:
        """
        ...
        return await self.request_adapter.send_async(request_info, virtual_event_registration.VirtualEventRegistration, error_mapping)
