...
class VirtualEventWebinarItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}{?%24select,%24expand}"
    ...
    async def get(self,request_configuration: Optional[VirtualEventWebinarItemRequestBuilderGetRequestConfiguration] = None) -> Optional[virtual_event_webinar.VirtualEventWebinar]:
        """
    ...
    async def patch(self,body: Optional[virtual_event_webinar.VirtualEventWebinar] = None, request_configuration: Optional[VirtualEventWebinarItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[virtual_event_webinar.VirtualEventWebinar]:
        """
    ...
    def to_patch_request_information(self,body: Optional[virtual_event_webinar.VirtualEventWebinar] = None, request_configuration: Optional[VirtualEventWebinarItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property webinars in solutions
        Args:
            body: The request body
    ...
    @property
    def presenters(self) -> presenters_request_builder.PresentersRequestBuilder:
        """
        Provides operations to manage the presenters property of the microsoft.graph.virtualEvent entity.
        """
        from .presenters import presenters_request_builder

        return presenters_request_builder.PresentersRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class VirtualEventWebinarItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class VirtualEventWebinarItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class VirtualEventWebinarItemRequestBuilderPatchRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
