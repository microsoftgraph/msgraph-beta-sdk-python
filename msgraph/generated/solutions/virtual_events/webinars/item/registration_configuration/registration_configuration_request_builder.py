...
class RegistrationConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class RegistrationConfigurationRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[RegistrationConfigurationRequestBuilder.RegistrationConfigurationRequestBuilderGetQueryParameters] = None
