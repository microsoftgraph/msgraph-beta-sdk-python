...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[EventsRequestBuilderGetRequestConfiguration] = None) -> Optional[VirtualEventCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[VirtualEvent] = None, request_configuration: Optional[EventsRequestBuilderPostRequestConfiguration] = None) -> Optional[VirtualEvent]:
        """
