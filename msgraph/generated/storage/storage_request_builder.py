...
storage = lazy_import('msgraph.generated.models.storage')
...
class StorageRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[StorageRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get storage
        Args:
    ...
    def create_patch_request_information(self,body: Optional[storage.Storage] = None, request_configuration: Optional[StorageRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update storage
        Args:
