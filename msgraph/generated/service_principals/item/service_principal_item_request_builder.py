...
microsoft_graph_create_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_create_password_single_sign_on_credentials.microsoft_graph_create_password_single_sign_on_credentials_request_builder')
microsoft_graph_delete_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_delete_password_single_sign_on_credentials.microsoft_graph_delete_password_single_sign_on_credentials_request_builder')
...
microsoft_graph_get_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_get_password_single_sign_on_credentials.microsoft_graph_get_password_single_sign_on_credentials_request_builder')
...
microsoft_graph_update_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_update_password_single_sign_on_credentials.microsoft_graph_update_password_single_sign_on_credentials_request_builder')
...
class ServicePrincipalItemRequestBuilder():
    ...
    @property
    def microsoft_graph_create_password_single_sign_on_credentials(self) -> microsoft_graph_create_password_single_sign_on_credentials_request_builder.MicrosoftGraphCreatePasswordSingleSignOnCredentialsRequestBuilder:
        """
        Provides operations to call the createPasswordSingleSignOnCredentials method.
        """
        return microsoft_graph_create_password_single_sign_on_credentials_request_builder.MicrosoftGraphCreatePasswordSingleSignOnCredentialsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_delete_password_single_sign_on_credentials(self) -> microsoft_graph_delete_password_single_sign_on_credentials_request_builder.MicrosoftGraphDeletePasswordSingleSignOnCredentialsRequestBuilder:
        """
        Provides operations to call the deletePasswordSingleSignOnCredentials method.
        """
        return microsoft_graph_delete_password_single_sign_on_credentials_request_builder.MicrosoftGraphDeletePasswordSingleSignOnCredentialsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def microsoft_graph_get_password_single_sign_on_credentials(self) -> microsoft_graph_get_password_single_sign_on_credentials_request_builder.MicrosoftGraphGetPasswordSingleSignOnCredentialsRequestBuilder:
        """
        Provides operations to call the getPasswordSingleSignOnCredentials method.
        """
        return microsoft_graph_get_password_single_sign_on_credentials_request_builder.MicrosoftGraphGetPasswordSingleSignOnCredentialsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def microsoft_graph_update_password_single_sign_on_credentials(self) -> microsoft_graph_update_password_single_sign_on_credentials_request_builder.MicrosoftGraphUpdatePasswordSingleSignOnCredentialsRequestBuilder:
        """
        Provides operations to call the updatePasswordSingleSignOnCredentials method.
        """
        return microsoft_graph_update_password_single_sign_on_credentials_request_builder.MicrosoftGraphUpdatePasswordSingleSignOnCredentialsRequestBuilder(self.request_adapter, self.path_parameters)
