...
class ServicePrincipalItemRequestBuilder():
    ...
    def app_role_assigned_to_by_id(self,id: str) -> Optional[app_role_assignment_item_request_builder.AppRoleAssignmentItemRequestBuilder]:
        """
        Provides operations to manage the appRoleAssignedTo property of the microsoft.graph.servicePrincipal entity.
        Args:
            id: Unique identifier of the item
    ...
    def delegated_permission_classifications_by_id(self,id: str) -> Optional[delegated_permission_classification_item_request_builder.DelegatedPermissionClassificationItemRequestBuilder]:
        """
        Provides operations to manage the delegatedPermissionClassifications property of the microsoft.graph.servicePrincipal entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[delegated_permission_classification_item_request_builder.DelegatedPermissionClassificationItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
    ...
    def endpoints_by_id(self,id: str) -> Optional[endpoint_item_request_builder.EndpointItemRequestBuilder]:
        """
        Provides operations to manage the endpoints property of the microsoft.graph.servicePrincipal entity.
        Args:
            id: Unique identifier of the item
        Returns: Optional[endpoint_item_request_builder.EndpointItemRequestBuilder]
        """
        if id is None:
            raise Exception("id cannot be undefined")
        url_tpl_params = get_path_parameters(self.path_parameters)
