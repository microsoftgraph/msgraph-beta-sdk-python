...
create_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_create_password_single_sign_on_credentials.create_password_single_sign_on_credentials_request_builder')
delete_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_delete_password_single_sign_on_credentials.delete_password_single_sign_on_credentials_request_builder')
...
get_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_get_password_single_sign_on_credentials.get_password_single_sign_on_credentials_request_builder')
...
update_password_single_sign_on_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_update_password_single_sign_on_credentials.update_password_single_sign_on_credentials_request_builder')
...
class ServicePrincipalItemRequestBuilder():
    ...
    @property
    def microsoft_graph_create_password_single_sign_on_credentials(self) -> create_password_single_sign_on_credentials_request_builder.CreatePasswordSingleSignOnCredentialsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_delete_password_single_sign_on_credentials(self) -> delete_password_single_sign_on_credentials_request_builder.DeletePasswordSingleSignOnCredentialsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_get_password_single_sign_on_credentials(self) -> get_password_single_sign_on_credentials_request_builder.GetPasswordSingleSignOnCredentialsRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_update_password_single_sign_on_credentials(self) -> update_password_single_sign_on_credentials_request_builder.UpdatePasswordSingleSignOnCredentialsRequestBuilder:
        """
