...
if TYPE_CHECKING:
    ...
    from .create_password_single_sign_on_credentials_post_request_body import CreatePasswordSingleSignOnCredentialsPostRequestBody

class CreatePasswordSingleSignOnCredentialsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createPasswordSingleSignOnCredentials", path_parameters)
    ...
    async def post(self,body: Optional[CreatePasswordSingleSignOnCredentialsPostRequestBody] = None, request_configuration: Optional[CreatePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration] = None) -> Optional[PasswordSingleSignOnCredentialSet]:
        """
        Create single sign-on credentials using a password for a user or group. This API is supported in the following national cloud deployments.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PasswordSingleSignOnCredentialSet]
        Find more info here: https://learn.microsoft.com/graph/api/serviceprincipal-createpasswordsinglesignoncredentials?view=graph-rest-1.0
        """
        if not body:
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CreatePasswordSingleSignOnCredentialsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CreatePasswordSingleSignOnCredentialsRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class CreatePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
