...
add_token_signing_certificate_post_request_body = lazy_import('msgraph.generated.service_principals.item.microsoft_graph_add_token_signing_certificate.add_token_signing_certificate_post_request_body')
