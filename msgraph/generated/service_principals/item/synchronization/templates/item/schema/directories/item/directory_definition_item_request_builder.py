...
microsoft_graph_discover_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.templates.item.schema.directories.item.microsoft_graph_discover.microsoft_graph_discover_request_builder')
