...
class SynchronizationTemplateItemRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, synchronization_template_id: Optional[str] = None) -> None:
        """
        Instantiates a new SynchronizationTemplateItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            synchronizationTemplateId: key: id of synchronizationTemplate
        """
        ...
        url_tpl_params["synchronizationTemplate%2Did"] = synchronizationTemplateId
    ...
    def to_patch_request_information(self,body: Optional[synchronization_template.SynchronizationTemplate] = None, request_configuration: Optional[SynchronizationTemplateItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property templates in servicePrincipals
        Args:
            body: The request body
