...
pause_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_pause.pause_request_builder')
provision_on_demand_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_provision_on_demand.provision_on_demand_request_builder')
restart_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_restart.restart_request_builder')
start_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_start.start_request_builder')
stop_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_stop.stop_request_builder')
validate_credentials_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.microsoft_graph_validate_credentials.validate_credentials_request_builder')
