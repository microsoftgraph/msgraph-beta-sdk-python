...
filter_operators_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.schema.microsoft_graph_filter_operators.filter_operators_request_builder')
functions_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.schema.microsoft_graph_functions.functions_request_builder')
parse_expression_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.schema.microsoft_graph_parse_expression.parse_expression_request_builder')
