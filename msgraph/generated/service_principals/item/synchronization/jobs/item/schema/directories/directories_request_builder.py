...
class DirectoriesRequestBuilder():
    ...
    async def post(self,body: Optional[DirectoryDefinition] = None, request_configuration: Optional[DirectoriesRequestBuilderPostRequestConfiguration] = None) -> Optional[DirectoryDefinition]:
        """
    ...
    def to_post_request_information(self,body: Optional[DirectoryDefinition] = None, request_configuration: Optional[DirectoriesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to directories for servicePrincipals
        Args:
            body: The request body
