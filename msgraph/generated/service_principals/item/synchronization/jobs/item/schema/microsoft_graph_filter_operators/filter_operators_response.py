...
class FilterOperatorsResponse(base_collection_pagination_count_response.BaseCollectionPaginationCountResponse):
    def __init__(self,) -> None:
        ...
        super().__init__()
        # The value property
        self._value: Optional[List[filter_operator_schema.FilterOperatorSchema]] = None
    ...
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> FilterOperatorsResponse:
        ...
        Returns: FilterOperatorsResponse
        """
        if parse_node is None:
            raise Exception("parse_node cannot be undefined")
        return FilterOperatorsResponse()
    ...
    @property
    def value(self,) -> Optional[List[filter_operator_schema.FilterOperatorSchema]]:
        """
        Gets the value property value. The value property
        Returns: Optional[List[filter_operator_schema.FilterOperatorSchema]]
        """
        return self._value
    
    @value.setter
    def value(self,value: Optional[List[filter_operator_schema.FilterOperatorSchema]] = None) -> None:
        """
