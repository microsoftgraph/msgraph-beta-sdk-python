...
discover_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.schema.directories.item.microsoft_graph_discover.discover_request_builder')
