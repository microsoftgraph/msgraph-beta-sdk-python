...
filter_operators_response = lazy_import('msgraph.generated.service_principals.item.synchronization.jobs.item.schema.microsoft_graph_filter_operators.filter_operators_response')
