...
acquire_access_token_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.microsoft_graph_acquire_access_token.acquire_access_token_request_builder')
ping_request_builder = lazy_import('msgraph.generated.service_principals.item.synchronization.microsoft_graph_ping.ping_request_builder')
...
class SynchronizationRequestBuilder():
    ...
    @property
    def microsoft_graph_acquire_access_token(self) -> acquire_access_token_request_builder.AcquireAccessTokenRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_ping(self) -> ping_request_builder.PingRequestBuilder:
        """
