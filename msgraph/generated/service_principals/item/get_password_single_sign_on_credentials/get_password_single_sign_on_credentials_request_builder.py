...
get_password_single_sign_on_credentials_post_request_body = lazy_import('msgraph.generated.service_principals.item.get_password_single_sign_on_credentials.get_password_single_sign_on_credentials_post_request_body')
...
class GetPasswordSingleSignOnCredentialsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.getPasswordSingleSignOnCredentials"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    def create_post_request_information(self,body: Optional[get_password_single_sign_on_credentials_post_request_body.GetPasswordSingleSignOnCredentialsPostRequestBody] = None, request_configuration: Optional[GetPasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
