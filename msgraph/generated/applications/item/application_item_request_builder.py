...
microsoft_graph_add_key_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_add_key.microsoft_graph_add_key_request_builder')
microsoft_graph_add_password_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_add_password.microsoft_graph_add_password_request_builder')
microsoft_graph_check_member_groups_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_check_member_groups.microsoft_graph_check_member_groups_request_builder')
microsoft_graph_check_member_objects_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_check_member_objects.microsoft_graph_check_member_objects_request_builder')
microsoft_graph_get_member_groups_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_get_member_groups.microsoft_graph_get_member_groups_request_builder')
microsoft_graph_get_member_objects_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_get_member_objects.microsoft_graph_get_member_objects_request_builder')
microsoft_graph_remove_key_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_remove_key.microsoft_graph_remove_key_request_builder')
microsoft_graph_remove_password_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_remove_password.microsoft_graph_remove_password_request_builder')
microsoft_graph_restore_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_restore.microsoft_graph_restore_request_builder')
microsoft_graph_set_verified_publisher_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_set_verified_publisher.microsoft_graph_set_verified_publisher_request_builder')
microsoft_graph_unset_verified_publisher_request_builder = lazy_import('msgraph.generated.applications.item.microsoft_graph_unset_verified_publisher.microsoft_graph_unset_verified_publisher_request_builder')
...
class ApplicationItemRequestBuilder():
    ...
    @property
    def microsoft_graph_set_verified_publisher(self) -> microsoft_graph_set_verified_publisher_request_builder.MicrosoftGraphSetVerifiedPublisherRequestBuilder:
        """
        Provides operations to call the setVerifiedPublisher method.
        """
        return microsoft_graph_set_verified_publisher_request_builder.MicrosoftGraphSetVerifiedPublisherRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def microsoft_graph_unset_verified_publisher(self) -> microsoft_graph_unset_verified_publisher_request_builder.MicrosoftGraphUnsetVerifiedPublisherRequestBuilder:
        """
        Provides operations to call the unsetVerifiedPublisher method.
        """
        return microsoft_graph_unset_verified_publisher_request_builder.MicrosoftGraphUnsetVerifiedPublisherRequestBuilder(self.request_adapter, self.path_parameters)
