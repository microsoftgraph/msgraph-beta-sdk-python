...
if TYPE_CHECKING:
    ...
    from .acquire_access_token_post_request_body import AcquireAccessTokenPostRequestBody

class AcquireAccessTokenRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/applications/{application%2Did}/synchronization/acquireAccessToken", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AcquireAccessTokenRequestBuilder:
        """
        ...
        return AcquireAccessTokenRequestBuilder(raw_url, self.request_adapter)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class AcquireAccessTokenRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
