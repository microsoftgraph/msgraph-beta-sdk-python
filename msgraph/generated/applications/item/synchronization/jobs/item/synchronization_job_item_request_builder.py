...
pause_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_pause.pause_request_builder')
provision_on_demand_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_provision_on_demand.provision_on_demand_request_builder')
restart_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_restart.restart_request_builder')
start_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_start.start_request_builder')
stop_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_stop.stop_request_builder')
validate_credentials_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_validate_credentials.validate_credentials_request_builder')
...
class SynchronizationJobItemRequestBuilder():
    ...
    @property
    def microsoft_graph_provision_on_demand(self) -> provision_on_demand_request_builder.ProvisionOnDemandRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_restart(self) -> restart_request_builder.RestartRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_validate_credentials(self) -> validate_credentials_request_builder.ValidateCredentialsRequestBuilder:
        """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, synchronization_job_id: Optional[str] = None) -> None:
        """
        Instantiates a new SynchronizationJobItemRequestBuilder and sets the default values.
        Args:
            pathParameters: The raw url or the Url template parameters for the request.
            requestAdapter: The request adapter to use to execute the requests.
            synchronizationJobId: key: id of synchronizationJob
        """
        ...
        url_tpl_params["synchronizationJob%2Did"] = synchronizationJobId
