...
microsoft_graph_pause_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_pause.microsoft_graph_pause_request_builder')
microsoft_graph_provision_on_demand_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_provision_on_demand.microsoft_graph_provision_on_demand_request_builder')
microsoft_graph_restart_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_restart.microsoft_graph_restart_request_builder')
microsoft_graph_start_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_start.microsoft_graph_start_request_builder')
microsoft_graph_stop_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_stop.microsoft_graph_stop_request_builder')
microsoft_graph_validate_credentials_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.microsoft_graph_validate_credentials.microsoft_graph_validate_credentials_request_builder')
