...
filter_operators_response = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.schema.microsoft_graph_filter_operators.filter_operators_response')
...
class FilterOperatorsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/microsoft.graph.filterOperators(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
