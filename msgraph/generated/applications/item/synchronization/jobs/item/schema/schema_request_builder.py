...
microsoft_graph_filter_operators_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.schema.microsoft_graph_filter_operators.microsoft_graph_filter_operators_request_builder')
microsoft_graph_functions_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.schema.microsoft_graph_functions.microsoft_graph_functions_request_builder')
microsoft_graph_parse_expression_request_builder = lazy_import('msgraph.generated.applications.item.synchronization.jobs.item.schema.microsoft_graph_parse_expression.microsoft_graph_parse_expression_request_builder')
