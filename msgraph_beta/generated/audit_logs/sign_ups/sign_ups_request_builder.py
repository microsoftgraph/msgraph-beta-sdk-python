...
if TYPE_CHECKING:
    ...
    from ...models.self_service_sign_up_collection_response import SelfServiceSignUpCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.self_service_sign_up_item_request_builder import SelfServiceSignUpItemRequestBuilder
...
class SignUpsRequestBuilder(BaseRequestBuilder):
    ...
    def by_self_service_sign_up_id(self,self_service_sign_up_id: str) -> SelfServiceSignUpItemRequestBuilder:
        """
        Provides operations to manage the signUps property of the microsoft.graph.auditLogRoot entity.
        param self_service_sign_up_id: The unique identifier of selfServiceSignUp
        Returns: SelfServiceSignUpItemRequestBuilder
        """
        if self_service_sign_up_id is None:
            raise TypeError("self_service_sign_up_id cannot be null.")
        from .item.self_service_sign_up_item_request_builder import SelfServiceSignUpItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["selfServiceSignUp%2Did"] = self_service_sign_up_id
        return SelfServiceSignUpItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: SelfServiceSignUp, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SelfServiceSignUp]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SignUpsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/auditLogs/signUps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: SelfServiceSignUp, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to signUps for auditLogs
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/auditLogs/signUps', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class SignUpsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
