...
class SetsRequestBuilder(BaseRequestBuilder):
    ...
    def by_set_id(self,set_id: str) -> SetItemRequestBuilder:
        """
        Provides operations to manage the sets property of the microsoft.graph.termStore.group entity.
        param set_id: The unique identifier of set
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SetsRequestBuilderGetQueryParameters]] = None) -> Optional[SetCollectionResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/termstore-group-list-sets?view=graph-rest-beta
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SetsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/termStore/groups/{group%2Did}/sets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: Set, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/termStore/groups/{group%2Did}/sets', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
