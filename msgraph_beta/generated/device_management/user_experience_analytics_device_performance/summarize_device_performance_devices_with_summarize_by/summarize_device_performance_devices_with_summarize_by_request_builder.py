...
class SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SummarizeDevicePerformanceDevicesWithSummarizeByGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SummarizeDevicePerformanceDevicesWithSummarizeByRequestBuilder:
        """
