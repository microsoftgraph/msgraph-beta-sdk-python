...
class NotificationMessageTemplatesRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class NotificationMessageTemplatesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class NotificationMessageTemplatesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
