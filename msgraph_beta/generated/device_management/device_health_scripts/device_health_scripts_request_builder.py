...
class DeviceHealthScriptsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_device_health_script_id(self,device_health_script_id: str) -> DeviceHealthScriptItemRequestBuilder:
        """
        Provides operations to manage the deviceHealthScripts property of the microsoft.graph.deviceManagement entity.
        param device_health_script_id: The unique identifier of deviceHealthScript
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DeviceHealthScriptsRequestBuilderGetQueryParameters]] = None) -> Optional[DeviceHealthScriptCollectionResponse]:
        """
    ...
    async def post(self,body: DeviceHealthScript, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeviceHealthScript]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DeviceHealthScriptsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The list of device health scripts associated with the tenant.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/deviceHealthScripts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: DeviceHealthScript, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to deviceHealthScripts for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/deviceHealthScripts', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> DeviceHealthScriptsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DeviceHealthScriptsRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class DeviceHealthScriptsRequestBuilderGetRequestConfiguration(RequestConfiguration[DeviceHealthScriptsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DeviceHealthScriptsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
