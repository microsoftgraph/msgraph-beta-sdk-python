...
class AreGlobalScriptsAvailableRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[globalDeviceHealthScriptState]:
        """
    ...
    def with_url(self,raw_url: str) -> AreGlobalScriptsAvailableRequestBuilder:
        """
    ...
    @dataclass
    class AreGlobalScriptsAvailableRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
