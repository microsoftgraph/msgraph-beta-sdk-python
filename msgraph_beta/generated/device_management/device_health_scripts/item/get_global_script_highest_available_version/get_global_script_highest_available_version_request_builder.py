...
class GetGlobalScriptHighestAvailableVersionRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetGlobalScriptHighestAvailableVersionPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GetGlobalScriptHighestAvailableVersionRequestBuilder:
        """
    ...
    @dataclass
    class GetGlobalScriptHighestAvailableVersionRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
