...
class GetGlobalScriptHighestAvailableVersionRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetGlobalScriptHighestAvailableVersionPostResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetGlobalScriptHighestAvailableVersionRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetGlobalScriptHighestAvailableVersionRequestBuilder
        """
        if not raw_url:
