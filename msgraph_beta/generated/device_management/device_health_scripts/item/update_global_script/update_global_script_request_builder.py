...
class UpdateGlobalScriptRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[UpdateGlobalScriptPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UpdateGlobalScriptPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[UpdateGlobalScriptPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the Proprietary Device Health Script
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
