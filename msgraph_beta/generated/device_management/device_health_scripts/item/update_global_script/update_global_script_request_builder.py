...
class UpdateGlobalScriptRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: UpdateGlobalScriptPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UpdateGlobalScriptPostResponse]:
        """
    ...
    def to_post_request_information(self,body: UpdateGlobalScriptPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the Proprietary Device Health Script
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UpdateGlobalScriptRequestBuilder:
        """
    ...
    @dataclass
    class UpdateGlobalScriptRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
