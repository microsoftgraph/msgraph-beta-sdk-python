...
class GetHealthMetricTimeSeriesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetHealthMetricTimeSeriesPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetHealthMetricTimeSeriesPostResponse]:
        """
    ...
    def to_post_request_information(self,body: GetHealthMetricTimeSeriesPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action getHealthMetricTimeSeries
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetHealthMetricTimeSeriesRequestBuilder:
        """
    ...
    @dataclass
    class GetHealthMetricTimeSeriesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
