...
class ComplianceManagementPartnerItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ComplianceManagementPartnerItemRequestBuilder:
        """
    ...
    @dataclass
    class ComplianceManagementPartnerItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class ComplianceManagementPartnerItemRequestBuilderGetRequestConfiguration(RequestConfiguration[ComplianceManagementPartnerItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class ComplianceManagementPartnerItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
