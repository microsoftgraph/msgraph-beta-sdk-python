...
class GetPlatformSupportedPropertiesWithPlatformRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getPlatformSupportedProperties
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetPlatformSupportedPropertiesWithPlatformRequestBuilder:
        """
    ...
    @dataclass
    class GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetRequestConfiguration(RequestConfiguration[GetPlatformSupportedPropertiesWithPlatformRequestBuilderGetQueryParameters]):
        """
