...
class GetSupportedPropertiesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetSupportedPropertiesRequestBuilder:
        """
    ...
    @dataclass
    class GetSupportedPropertiesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
