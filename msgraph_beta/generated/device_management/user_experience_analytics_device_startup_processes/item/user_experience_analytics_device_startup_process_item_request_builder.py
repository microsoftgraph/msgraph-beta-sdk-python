...
class UserExperienceAnalyticsDeviceStartupProcessItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceStartupProcess]:
        """
    ...
    async def patch(self,body: Optional[UserExperienceAnalyticsDeviceStartupProcess] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceStartupProcess]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UserExperienceAnalyticsDeviceStartupProcess] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsDeviceStartupProcesses in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UserExperienceAnalyticsDeviceStartupProcessItemRequestBuilder:
        """
