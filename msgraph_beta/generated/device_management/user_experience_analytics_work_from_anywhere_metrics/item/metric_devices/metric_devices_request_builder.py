...
if TYPE_CHECKING:
    ...
    from .....models.user_experience_analytics_work_from_anywhere_device import UserExperienceAnalyticsWorkFromAnywhereDevice
    from .....models.user_experience_analytics_work_from_anywhere_device_collection_response import UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.user_experience_analytics_work_from_anywhere_device_item_request_builder import UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder

class MetricDevicesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics/{userExperienceAnalyticsWorkFromAnywhereMetric%2Did}/metricDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_user_experience_analytics_work_from_anywhere_device_id(self,user_experience_analytics_work_from_anywhere_device_id: str) -> UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder:
        """
        Provides operations to manage the metricDevices property of the microsoft.graph.userExperienceAnalyticsWorkFromAnywhereMetric entity.
        param user_experience_analytics_work_from_anywhere_device_id: The unique identifier of userExperienceAnalyticsWorkFromAnywhereDevice
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse]:
        ...
        Returns: Optional[UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse]
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MetricDevicesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MetricDevicesRequestBuilder
        """
        if not raw_url:
