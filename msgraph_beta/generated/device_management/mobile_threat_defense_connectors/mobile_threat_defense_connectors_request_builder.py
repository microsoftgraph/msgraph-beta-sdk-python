...
class MobileThreatDefenseConnectorsRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class MobileThreatDefenseConnectorsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class MobileThreatDefenseConnectorsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
