...
class ScheduledActionConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_device_management_compliance_action_item_id(self,device_management_compliance_action_item_id: str) -> DeviceManagementComplianceActionItemItemRequestBuilder:
        ...
        """
        if device_management_compliance_action_item_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ScheduledActionConfigurationsRequestBuilderGetQueryParameters]] = None) -> Optional[DeviceManagementComplianceActionItemCollectionResponse]:
        """
    ...
    async def post(self,body: DeviceManagementComplianceActionItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeviceManagementComplianceActionItem]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ScheduledActionConfigurationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: DeviceManagementComplianceActionItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to scheduledActionConfigurations for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
