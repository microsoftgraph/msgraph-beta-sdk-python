...
class ScheduledActionsForRuleRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementComplianceScheduledActionForRuleCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DeviceManagementComplianceScheduledActionForRule] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementComplianceScheduledActionForRule]:
        """
    ...
    def to_post_request_information(self,body: Optional[DeviceManagementComplianceScheduledActionForRule] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to scheduledActionsForRule for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
