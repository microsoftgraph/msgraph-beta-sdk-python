...
if TYPE_CHECKING:
    ...
    from ...models.device_compliance_policy_setting_state_summary_collection_response import DeviceCompliancePolicySettingStateSummaryCollectionResponse
...
class DeviceCompliancePolicySettingStateSummariesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
