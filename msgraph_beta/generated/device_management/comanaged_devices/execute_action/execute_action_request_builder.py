...
if TYPE_CHECKING:
    from ....models.bulk_managed_device_action_result import BulkManagedDeviceActionResult
    from ....models.o_data_errors.o_data_error import ODataError
    from .execute_action_post_request_body import ExecuteActionPostRequestBody

class ExecuteActionRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/executeAction", path_parameters)
    ...
    async def post(self,body: Optional[ExecuteActionPostRequestBody] = None, request_configuration: Optional[ExecuteActionRequestBuilderPostRequestConfiguration] = None) -> Optional[BulkManagedDeviceActionResult]:
        ...
        Returns: Optional[BulkManagedDeviceActionResult]
        """
        if not body:
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ExecuteActionRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ExecuteActionRequestBuilder
        """
        if not raw_url:
