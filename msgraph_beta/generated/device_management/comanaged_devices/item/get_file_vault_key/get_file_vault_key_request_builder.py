...
class GetFileVaultKeyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetFileVaultKeyGetResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GetFileVaultKeyRequestBuilder:
        """
    ...
    @dataclass
    class GetFileVaultKeyRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
