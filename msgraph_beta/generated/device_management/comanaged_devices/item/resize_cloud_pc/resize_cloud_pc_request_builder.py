...
class ResizeCloudPcRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ResizeCloudPcRequestBuilder:
        """
    ...
    @dataclass
    class ResizeCloudPcRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
