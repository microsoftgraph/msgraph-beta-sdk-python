...
class ReprovisionCloudPcRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ReprovisionCloudPcRequestBuilder:
        """
    ...
    @dataclass
    class ReprovisionCloudPcRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
