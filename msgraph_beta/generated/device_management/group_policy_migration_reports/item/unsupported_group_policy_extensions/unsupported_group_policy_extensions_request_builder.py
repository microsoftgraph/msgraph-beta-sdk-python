...
class UnsupportedGroupPolicyExtensionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnsupportedGroupPolicyExtensionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[UnsupportedGroupPolicyExtension] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnsupportedGroupPolicyExtension]:
        """
    ...
    def to_post_request_information(self,body: Optional[UnsupportedGroupPolicyExtension] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to unsupportedGroupPolicyExtensions for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
