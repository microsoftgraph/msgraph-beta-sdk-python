...
class UnsupportedGroupPolicyExtensionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport%2Did}/unsupportedGroupPolicyExtensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_unsupported_group_policy_extension_id(self,unsupported_group_policy_extension_id: str) -> UnsupportedGroupPolicyExtensionItemRequestBuilder:
        ...
        """
        if not unsupported_group_policy_extension_id:
    ...
    async def get(self,request_configuration: Optional[UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration] = None) -> Optional[UnsupportedGroupPolicyExtensionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[UnsupportedGroupPolicyExtension] = None, request_configuration: Optional[UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration] = None) -> Optional[UnsupportedGroupPolicyExtension]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        A list of unsupported group policy extensions inside the Group Policy Object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[UnsupportedGroupPolicyExtension] = None, request_configuration: Optional[UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to unsupportedGroupPolicyExtensions for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UnsupportedGroupPolicyExtensionsRequestBuilder:
        """
    ...
    @dataclass
    class UnsupportedGroupPolicyExtensionsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[UnsupportedGroupPolicyExtensionsRequestBuilder.UnsupportedGroupPolicyExtensionsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class UnsupportedGroupPolicyExtensionsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
