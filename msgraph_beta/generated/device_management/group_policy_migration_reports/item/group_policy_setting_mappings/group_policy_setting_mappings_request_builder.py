...
class GroupPolicySettingMappingsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicySettingMappingCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[GroupPolicySettingMapping] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicySettingMapping]:
        """
    ...
    def to_post_request_information(self,body: Optional[GroupPolicySettingMapping] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to groupPolicySettingMappings for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
