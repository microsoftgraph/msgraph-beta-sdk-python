...
class CloudPCConnectivityIssuesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPCConnectivityIssueCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[CloudPCConnectivityIssue] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPCConnectivityIssue]:
        """
    ...
    def to_post_request_information(self,body: Optional[CloudPCConnectivityIssue] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cloudPCConnectivityIssues for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
