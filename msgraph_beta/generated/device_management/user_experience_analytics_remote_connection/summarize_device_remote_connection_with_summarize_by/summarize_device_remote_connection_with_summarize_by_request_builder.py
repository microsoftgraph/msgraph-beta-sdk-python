...
class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilder:
        """
    ...
    @dataclass
    class SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetRequestConfiguration(RequestConfiguration[SummarizeDeviceRemoteConnectionWithSummarizeByRequestBuilderGetQueryParameters]):
        """
