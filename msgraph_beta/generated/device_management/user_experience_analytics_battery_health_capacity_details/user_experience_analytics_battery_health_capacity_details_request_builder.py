...
class UserExperienceAnalyticsBatteryHealthCapacityDetailsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsBatteryHealthCapacityDetails]:
        """
    ...
    async def patch(self,body: Optional[UserExperienceAnalyticsBatteryHealthCapacityDetails] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsBatteryHealthCapacityDetails]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/deviceManagement/userExperienceAnalyticsBatteryHealthCapacityDetails', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[UserExperienceAnalyticsBatteryHealthCapacityDetails] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsBatteryHealthCapacityDetails in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/deviceManagement/userExperienceAnalyticsBatteryHealthCapacityDetails', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
