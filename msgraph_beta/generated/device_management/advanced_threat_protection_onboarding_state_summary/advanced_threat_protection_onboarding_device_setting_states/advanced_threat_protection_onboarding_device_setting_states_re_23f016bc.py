...
if TYPE_CHECKING:
    ...
    from ....models.advanced_threat_protection_onboarding_device_setting_state_col_ff8dc798 import AdvancedThreatProtectionOnboardingDeviceSettingStateCol_ff8dc798
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.advanced_threat_protection_onboarding_device_setting_state_ite_1d3f82f2 import AdvancedThreatProtectionOnboardingDeviceSettingStateIte_1d3f82f2

class AdvancedThreatProtectionOnboardingDeviceSettingStatesRe_23f016bc(BaseRequestBuilder):
    """
    ...
    def by_advanced_threat_protection_onboarding_device_setting_state_id(self,advanced_threat_protection_onboarding_device_setting_state_id: str) -> AdvancedThreatProtectionOnboardingDeviceSettingStateIte_1d3f82f2:
        """
        ...
        Returns: AdvancedThreatProtectionOnboardingDeviceSettingStateIte_1d3f82f2
        """
        ...
        return AdvancedThreatProtectionOnboardingDeviceSettingStateIte_1d3f82f2(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetQueryParameters]] = None) -> Optional[AdvancedThreatProtectionOnboardingDeviceSettingStateCol_ff8dc798]:
        """
        Get advancedThreatProtectionOnboardingDeviceSettingStates from deviceManagement
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[AdvancedThreatProtectionOnboardingDeviceSettingStateCol_ff8dc798]
        """
        ...
        return await self.request_adapter.send_async(request_info, AdvancedThreatProtectionOnboardingDeviceSettingStateCol_ff8dc798, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/advancedThreatProtectionOnboardingStateSummary/advancedThreatProtectionOnboardingDeviceSettingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def with_url(self,raw_url: str) -> AdvancedThreatProtectionOnboardingDeviceSettingStatesRe_23f016bc:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AdvancedThreatProtectionOnboardingDeviceSettingStatesRe_23f016bc
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return AdvancedThreatProtectionOnboardingDeviceSettingStatesRe_23f016bc(self.request_adapter, raw_url)
