...
class AdvancedThreatProtectionOnboardingDeviceSettingStatesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AdvancedThreatProtectionOnboardingDeviceSettingStateCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AdvancedThreatProtectionOnboardingDeviceSettingState] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AdvancedThreatProtectionOnboardingDeviceSettingState]:
        """
    ...
    def to_post_request_information(self,body: Optional[AdvancedThreatProtectionOnboardingDeviceSettingState] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to advancedThreatProtectionOnboardingDeviceSettingStates for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
