...
class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetQueryParameters]] = None) -> Optional[AdvancedThreatProtectionOnboardingStateSummary]:
        """
    ...
    async def patch(self,body: AdvancedThreatProtectionOnboardingStateSummary, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AdvancedThreatProtectionOnboardingStateSummary]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The summary state of ATP onboarding state for this account.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: AdvancedThreatProtectionOnboardingStateSummary, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property advancedThreatProtectionOnboardingStateSummary in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AdvancedThreatProtectionOnboardingStateSummaryRequestBuilder:
        """
    ...
    @dataclass
    class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetRequestConfiguration(RequestConfiguration[AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class AdvancedThreatProtectionOnboardingStateSummaryRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
