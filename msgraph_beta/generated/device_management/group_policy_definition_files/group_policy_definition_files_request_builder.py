...
class GroupPolicyDefinitionFilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicyDefinitionFileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[GroupPolicyDefinitionFile] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicyDefinitionFile]:
        """
    ...
    def to_post_request_information(self,body: Optional[GroupPolicyDefinitionFile] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to groupPolicyDefinitionFiles for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GroupPolicyDefinitionFilesRequestBuilder:
        """
