...
class ExchangeOnPremisesPolicyRequestBuilder(BaseRequestBuilder):
    ...
    async def delete(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderGetRequestConfiguration] = None) -> Optional[DeviceManagementExchangeOnPremisesPolicy]:
        """
    ...
    async def patch(self,body: Optional[DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderPatchRequestConfiguration] = None) -> Optional[DeviceManagementExchangeOnPremisesPolicy]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/deviceManagement/exchangeOnPremisesPolicy', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_get_request_information(self,request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The policy which controls mobile device access to Exchange On Premises
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: Optional[DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[ExchangeOnPremisesPolicyRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property exchangeOnPremisesPolicy in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/deviceManagement/exchangeOnPremisesPolicy', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> ExchangeOnPremisesPolicyRequestBuilder:
        """
    ...
    @dataclass
    class ExchangeOnPremisesPolicyRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ExchangeOnPremisesPolicyRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ExchangeOnPremisesPolicyRequestBuilder.ExchangeOnPremisesPolicyRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ExchangeOnPremisesPolicyRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
