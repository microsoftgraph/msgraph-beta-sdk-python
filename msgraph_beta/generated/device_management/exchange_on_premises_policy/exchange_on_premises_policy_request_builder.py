...
class ExchangeOnPremisesPolicyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementExchangeOnPremisesPolicy]:
        """
    ...
    async def patch(self,body: Optional[DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementExchangeOnPremisesPolicy]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DeviceManagementExchangeOnPremisesPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property exchangeOnPremisesPolicy in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
