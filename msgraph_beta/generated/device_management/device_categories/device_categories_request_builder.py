...
if TYPE_CHECKING:
    ...
    from ...models.device_category_collection_response import DeviceCategoryCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.device_category_item_request_builder import DeviceCategoryItemRequestBuilder

class DeviceCategoriesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceCategories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_device_category_id(self,device_category_id: str) -> DeviceCategoryItemRequestBuilder:
        """
        Provides operations to manage the deviceCategories property of the microsoft.graph.deviceManagement entity.
        param device_category_id: The unique identifier of deviceCategory
        Returns: DeviceCategoryItemRequestBuilder
        """
        if device_category_id is None:
            raise TypeError("device_category_id cannot be null.")
        from .item.device_category_item_request_builder import DeviceCategoryItemRequestBuilder
    ...
    def with_url(self,raw_url: str) -> DeviceCategoriesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DeviceCategoriesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return DeviceCategoriesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class DeviceCategoriesRequestBuilderGetRequestConfiguration(RequestConfiguration[DeviceCategoriesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DeviceCategoriesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
