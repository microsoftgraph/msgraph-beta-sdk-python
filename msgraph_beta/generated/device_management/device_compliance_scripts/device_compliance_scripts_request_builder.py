...
class DeviceComplianceScriptsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceComplianceScriptCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DeviceComplianceScript] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceComplianceScript]:
        """
    ...
    def to_post_request_information(self,body: Optional[DeviceComplianceScript] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceComplianceScripts for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
