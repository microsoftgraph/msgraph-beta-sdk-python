...
class AssignPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    device_health_script_assignments: Optional[List[DeviceHealthScriptAssignment]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "deviceHealthScriptAssignments": lambda n : setattr(self, 'device_health_script_assignments', n.get_collection_of_object_values(DeviceHealthScriptAssignment)),
        }
        return fields
