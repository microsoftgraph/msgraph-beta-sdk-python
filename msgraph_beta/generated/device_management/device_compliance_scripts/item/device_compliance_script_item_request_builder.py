...
class DeviceComplianceScriptItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceComplianceScript]:
        """
    ...
    async def patch(self,body: Optional[DeviceComplianceScript] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceComplianceScript]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DeviceComplianceScript] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceComplianceScripts in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
