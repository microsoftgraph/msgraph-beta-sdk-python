...
class GenerateDownloadUrlRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GenerateDownloadUrlPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GenerateDownloadUrlRequestBuilder:
        """
    ...
    @dataclass
    class GenerateDownloadUrlRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
