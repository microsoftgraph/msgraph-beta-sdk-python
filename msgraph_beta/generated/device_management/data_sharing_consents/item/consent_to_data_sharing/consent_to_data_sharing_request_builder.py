...
class ConsentToDataSharingRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DataSharingConsent]:
        """
    ...
    def with_url(self,raw_url: str) -> ConsentToDataSharingRequestBuilder:
        """
    ...
    @dataclass
    class ConsentToDataSharingRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
