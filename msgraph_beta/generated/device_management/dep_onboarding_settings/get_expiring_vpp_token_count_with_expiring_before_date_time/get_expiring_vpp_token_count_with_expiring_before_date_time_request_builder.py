...
class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], expiring_before_date_time: Optional[str] = None) -> None:
        ...
        if isinstance(path_parameters, dict):
            path_parameters['expiringBeforeDateTime'] = expiring_before_date_time
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder:
        """
    ...
    @dataclass
    class GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
