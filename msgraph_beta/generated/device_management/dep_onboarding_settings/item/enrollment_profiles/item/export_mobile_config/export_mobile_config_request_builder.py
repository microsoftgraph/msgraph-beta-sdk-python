...
class ExportMobileConfigRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ExportMobileConfigGetResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> ExportMobileConfigRequestBuilder:
        """
    ...
    @dataclass
    class ExportMobileConfigRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
