...
class GetEncryptionPublicKeyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetEncryptionPublicKeyGetResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GetEncryptionPublicKeyRequestBuilder:
        """
    ...
    @dataclass
    class GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
