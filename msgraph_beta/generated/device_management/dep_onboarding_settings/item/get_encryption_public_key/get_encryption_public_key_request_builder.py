...
class GetEncryptionPublicKeyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetEncryptionPublicKeyRequestBuilderGetRequestConfiguration] = None) -> Optional[GetEncryptionPublicKeyGetResponse]:
        """
