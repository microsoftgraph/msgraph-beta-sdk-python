...
class RevokeRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: RevokePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PrivilegeManagementElevationRequest]:
        """
    ...
    def to_post_request_information(self,body: RevokePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action revoke
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
