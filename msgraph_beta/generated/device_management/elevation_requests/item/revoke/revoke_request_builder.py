...
class RevokeRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RevokePostRequestBody] = None, request_configuration: Optional[RevokeRequestBuilderPostRequestConfiguration] = None) -> Optional[PrivilegeManagementElevationRequest]:
        """
    ...
    def to_post_request_information(self,body: Optional[RevokePostRequestBody] = None, request_configuration: Optional[RevokeRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action revoke
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class RevokeRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
