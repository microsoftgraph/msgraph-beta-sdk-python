...
class ElevationRequestsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/elevationRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ElevationRequestsRequestBuilderGetRequestConfiguration] = None) -> Optional[PrivilegeManagementElevationRequestCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegeManagementElevationRequest] = None, request_configuration: Optional[ElevationRequestsRequestBuilderPostRequestConfiguration] = None) -> Optional[PrivilegeManagementElevationRequest]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[ElevationRequestsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        List of elevation requests
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[PrivilegeManagementElevationRequest] = None, request_configuration: Optional[ElevationRequestsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to elevationRequests for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ElevationRequestsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ElevationRequestsRequestBuilder.ElevationRequestsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ElevationRequestsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
