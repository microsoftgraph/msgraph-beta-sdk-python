...
class RetrieveMyRequestByIdWithIdRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RetrieveMyRequestByIdWithIdRequestBuilder:
        """
    ...
    @dataclass
    class RetrieveMyRequestByIdWithIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
