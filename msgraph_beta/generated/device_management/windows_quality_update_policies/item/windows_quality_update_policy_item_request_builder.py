...
class WindowsQualityUpdatePolicyItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[WindowsQualityUpdatePolicyItemRequestBuilderGetQueryParameters]] = None) -> Optional[WindowsQualityUpdatePolicy]:
        """
        A collection of Windows quality update policies
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[WindowsQualityUpdatePolicy]
        """
    ...
    async def patch(self,body: WindowsQualityUpdatePolicy, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WindowsQualityUpdatePolicy]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[WindowsQualityUpdatePolicyItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        A collection of Windows quality update policies
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/windowsQualityUpdatePolicies/{windowsQualityUpdatePolicy%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: WindowsQualityUpdatePolicy, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property windowsQualityUpdatePolicies in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> WindowsQualityUpdatePolicyItemRequestBuilder:
        """
        ...
        return WindowsQualityUpdatePolicyItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class WindowsQualityUpdatePolicyItemRequestBuilderGetQueryParameters():
        """
        A collection of Windows quality update policies
        """
    ...
    @dataclass
    class WindowsQualityUpdatePolicyItemRequestBuilderGetRequestConfiguration(RequestConfiguration[WindowsQualityUpdatePolicyItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WindowsQualityUpdatePolicyItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
