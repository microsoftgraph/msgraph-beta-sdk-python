...
@dataclass
class UploadExternallySignedCertificationAuthorityCertificate_7c3c0420(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UploadExternallySignedCertificationAuthorityCertificate_7c3c0420:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UploadExternallySignedCertificationAuthorityCertificate_7c3c0420
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return UploadExternallySignedCertificationAuthorityCertificate_7c3c0420()
