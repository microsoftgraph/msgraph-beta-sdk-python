...
class GetTargetedUsersAndDevicesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetTargetedUsersAndDevicesPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetTargetedUsersAndDevicesPostResponse]:
        """
    ...
    def to_post_request_information(self,body: GetTargetedUsersAndDevicesPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action getTargetedUsersAndDevices
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetTargetedUsersAndDevicesRequestBuilder:
        """
    ...
    @dataclass
    class GetTargetedUsersAndDevicesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
