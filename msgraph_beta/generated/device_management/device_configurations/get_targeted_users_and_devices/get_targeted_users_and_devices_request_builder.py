...
class GetTargetedUsersAndDevicesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetTargetedUsersAndDevicesPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetTargetedUsersAndDevicesPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[GetTargetedUsersAndDevicesPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action getTargetedUsersAndDevices
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetTargetedUsersAndDevicesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetTargetedUsersAndDevicesRequestBuilder
        """
        if not raw_url:
