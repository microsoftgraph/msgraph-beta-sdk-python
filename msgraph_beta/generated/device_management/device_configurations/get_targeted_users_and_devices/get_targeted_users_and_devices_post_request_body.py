...
@dataclass
class GetTargetedUsersAndDevicesPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    device_configuration_ids: Optional[List[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetTargetedUsersAndDevicesPostRequestBody:
        """
