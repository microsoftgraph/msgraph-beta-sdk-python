...
if TYPE_CHECKING:
    ...
    from .assigned_access_multi_mode_profiles.assigned_access_multi_mode_profiles_request_builder import AssignedAccessMultiModeProfilesRequestBuilder
    ...
    from .windows_privacy_access_controls.windows_privacy_access_controls_request_builder import WindowsPrivacyAccessControlsRequestBuilder
...
class DeviceConfigurationItemRequestBuilder(BaseRequestBuilder):
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[DeviceConfiguration] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def assigned_access_multi_mode_profiles(self) -> AssignedAccessMultiModeProfilesRequestBuilder:
        """
        Provides operations to call the assignedAccessMultiModeProfiles method.
        """
        from .assigned_access_multi_mode_profiles.assigned_access_multi_mode_profiles_request_builder import AssignedAccessMultiModeProfilesRequestBuilder

        return AssignedAccessMultiModeProfilesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    def windows_privacy_access_controls(self) -> WindowsPrivacyAccessControlsRequestBuilder:
        ...
        return WindowsPrivacyAccessControlsRequestBuilder(self.request_adapter, self.path_parameters)
