...
class UserRunStatesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[UserRunStatesRequestBuilderGetRequestConfiguration] = None) -> Optional[DeviceManagementScriptUserStateCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DeviceManagementScriptUserState] = None, request_configuration: Optional[UserRunStatesRequestBuilderPostRequestConfiguration] = None) -> Optional[DeviceManagementScriptUserState]:
        """
    ...
    def to_post_request_information(self,body: Optional[DeviceManagementScriptUserState] = None, request_configuration: Optional[UserRunStatesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userRunStates for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
