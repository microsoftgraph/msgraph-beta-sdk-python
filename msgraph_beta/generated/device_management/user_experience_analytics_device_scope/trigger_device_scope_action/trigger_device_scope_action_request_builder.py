...
class TriggerDeviceScopeActionRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[TriggerDeviceScopeActionPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceScopeActionResult]:
        """
    ...
    def to_post_request_information(self,body: Optional[TriggerDeviceScopeActionPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action triggerDeviceScopeAction
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
