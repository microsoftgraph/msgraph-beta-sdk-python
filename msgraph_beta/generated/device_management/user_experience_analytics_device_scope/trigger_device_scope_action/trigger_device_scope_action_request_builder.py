...
class TriggerDeviceScopeActionRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: TriggerDeviceScopeActionPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeviceScopeActionResult]:
        """
    ...
    def to_post_request_information(self,body: TriggerDeviceScopeActionPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action triggerDeviceScopeAction
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> TriggerDeviceScopeActionRequestBuilder:
        """
    ...
    @dataclass
    class TriggerDeviceScopeActionRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
