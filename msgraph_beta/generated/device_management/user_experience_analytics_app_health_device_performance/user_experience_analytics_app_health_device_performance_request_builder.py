...
class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder(BaseRequestBuilder):
    ...
    def by_user_experience_analytics_app_health_device_performance_id(self,user_experience_analytics_app_health_device_performance_id: str) -> UserExperienceAnalyticsAppHealthDevicePerformanceItemRequestBuilder:
        ...
        """
        if not user_experience_analytics_app_health_device_performance_id:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[UserExperienceAnalyticsAppHealthDevicePerformance] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsAppHealthDevicePerformance]:
        """
    ...
    def to_post_request_information(self,body: Optional[UserExperienceAnalyticsAppHealthDevicePerformance] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsAppHealthDevicePerformance for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilderGetQueryParameters():
        """
        User experience analytics appHealth Device Performance
        """
