...
class CartToClassAssociationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_cart_to_class_association_id(self,cart_to_class_association_id: str) -> CartToClassAssociationItemRequestBuilder:
        ...
        """
        if cart_to_class_association_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CartToClassAssociationsRequestBuilderGetQueryParameters]] = None) -> Optional[CartToClassAssociationCollectionResponse]:
        """
    ...
    async def post(self,body: CartToClassAssociation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CartToClassAssociation]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CartToClassAssociationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The Cart To Class Associations.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/cartToClassAssociations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: CartToClassAssociation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to cartToClassAssociations for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/cartToClassAssociations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> CartToClassAssociationsRequestBuilder:
        """
    ...
    @dataclass
    class CartToClassAssociationsRequestBuilderGetRequestConfiguration(RequestConfiguration[CartToClassAssociationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class CartToClassAssociationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
