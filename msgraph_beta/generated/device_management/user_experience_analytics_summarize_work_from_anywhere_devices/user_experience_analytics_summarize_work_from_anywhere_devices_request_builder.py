...
class UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsWorkFromAnywhereDevicesSummary]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder:
        """
