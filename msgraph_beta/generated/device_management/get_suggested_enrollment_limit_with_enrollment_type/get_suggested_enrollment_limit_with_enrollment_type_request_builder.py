...
class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder:
        """
    ...
    @dataclass
    class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
