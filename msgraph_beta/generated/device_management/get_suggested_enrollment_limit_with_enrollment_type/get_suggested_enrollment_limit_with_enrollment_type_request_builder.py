...
class GetSuggestedEnrollmentLimitWithEnrollmentTypeRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], enrollment_type: Optional[str] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SuggestedEnrollmentLimit]:
        """
