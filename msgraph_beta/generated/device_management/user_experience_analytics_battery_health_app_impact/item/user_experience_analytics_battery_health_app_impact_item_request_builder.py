...
class UserExperienceAnalyticsBatteryHealthAppImpactItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsBatteryHealthAppImpact]:
        """
    ...
    async def patch(self,body: Optional[UserExperienceAnalyticsBatteryHealthAppImpact] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsBatteryHealthAppImpact]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UserExperienceAnalyticsBatteryHealthAppImpact] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property userExperienceAnalyticsBatteryHealthAppImpact in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
