...
class SoftwareUpdateStatusSummaryRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SoftwareUpdateStatusSummaryRequestBuilderGetQueryParameters]] = None) -> Optional[SoftwareUpdateStatusSummary]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SoftwareUpdateStatusSummaryRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The software update status summary.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SoftwareUpdateStatusSummaryRequestBuilder:
        """
    ...
    @dataclass
    class SoftwareUpdateStatusSummaryRequestBuilderGetRequestConfiguration(RequestConfiguration[SoftwareUpdateStatusSummaryRequestBuilderGetQueryParameters]):
        """
