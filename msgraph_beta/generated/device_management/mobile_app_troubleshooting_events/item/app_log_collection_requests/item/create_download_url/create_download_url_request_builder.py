...
if TYPE_CHECKING:
    from .......models.app_log_collection_download_details import AppLogCollectionDownloadDetails
...
class CreateDownloadUrlRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}/createDownloadUrl", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AppLogCollectionDownloadDetails]:
        """
        ...
        return await self.request_adapter.send_async(request_info, AppLogCollectionDownloadDetails, error_mapping)
