...
class MicrosoftTunnelSiteItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration] = None) -> Optional[MicrosoftTunnelSite]:
        """
    ...
    async def patch(self,body: Optional[MicrosoftTunnelSite] = None, request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[MicrosoftTunnelSite]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/deviceManagement/microsoftTunnelSites/{microsoftTunnelSite%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[MicrosoftTunnelSite] = None, request_configuration: Optional[MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property microsoftTunnelSites in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/deviceManagement/microsoftTunnelSites/{microsoftTunnelSite%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftTunnelSiteItemRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftTunnelSiteItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class MicrosoftTunnelSiteItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class MicrosoftTunnelSiteItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
