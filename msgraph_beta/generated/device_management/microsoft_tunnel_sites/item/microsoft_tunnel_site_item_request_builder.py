...
class MicrosoftTunnelSiteItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[MicrosoftTunnelSite]:
        """
    ...
    async def patch(self,body: Optional[MicrosoftTunnelSite] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[MicrosoftTunnelSite]:
        """
    ...
    def to_patch_request_information(self,body: Optional[MicrosoftTunnelSite] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property microsoftTunnelSites in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
