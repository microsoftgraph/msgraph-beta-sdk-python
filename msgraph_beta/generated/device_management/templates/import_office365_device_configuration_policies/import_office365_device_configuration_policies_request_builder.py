...
class ImportOffice365DeviceConfigurationPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ImportOffice365DeviceConfigurationPoliciesPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> ImportOffice365DeviceConfigurationPoliciesRequestBuilder:
        """
    ...
    @dataclass
    class ImportOffice365DeviceConfigurationPoliciesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
