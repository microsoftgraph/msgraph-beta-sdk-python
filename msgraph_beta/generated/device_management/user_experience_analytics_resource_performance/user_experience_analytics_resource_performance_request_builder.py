...
class UserExperienceAnalyticsResourcePerformanceRequestBuilder(BaseRequestBuilder):
    ...
    def by_user_experience_analytics_resource_performance_id(self,user_experience_analytics_resource_performance_id: str) -> UserExperienceAnalyticsResourcePerformanceItemRequestBuilder:
        """
        Provides operations to manage the userExperienceAnalyticsResourcePerformance property of the microsoft.graph.deviceManagement entity.
        param user_experience_analytics_resource_performance_id: The unique identifier of userExperienceAnalyticsResourcePerformance
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsResourcePerformanceRequestBuilderGetQueryParameters]] = None) -> Optional[UserExperienceAnalyticsResourcePerformanceCollectionResponse]:
        """
    ...
    async def post(self,body: UserExperienceAnalyticsResourcePerformance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserExperienceAnalyticsResourcePerformance]:
        """
    ...
    def summarize_device_resource_performance_with_summarize_by(self,summarize_by: str) -> SummarizeDeviceResourcePerformanceWithSummarizeByRequestBuilder:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsResourcePerformanceRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        User experience analytics resource performance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/userExperienceAnalyticsResourcePerformance{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: UserExperienceAnalyticsResourcePerformance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsResourcePerformance for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsResourcePerformanceRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UserExperienceAnalyticsResourcePerformanceRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return UserExperienceAnalyticsResourcePerformanceRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class UserExperienceAnalyticsResourcePerformanceRequestBuilderGetRequestConfiguration(RequestConfiguration[UserExperienceAnalyticsResourcePerformanceRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserExperienceAnalyticsResourcePerformanceRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
