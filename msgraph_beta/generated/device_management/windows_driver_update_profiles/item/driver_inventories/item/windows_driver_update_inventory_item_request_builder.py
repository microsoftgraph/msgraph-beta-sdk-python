...
class WindowsDriverUpdateInventoryItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDriverUpdateInventory]:
        """
    ...
    async def patch(self,body: Optional[WindowsDriverUpdateInventory] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDriverUpdateInventory]:
        """
    ...
    def to_patch_request_information(self,body: Optional[WindowsDriverUpdateInventory] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property driverInventories in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
