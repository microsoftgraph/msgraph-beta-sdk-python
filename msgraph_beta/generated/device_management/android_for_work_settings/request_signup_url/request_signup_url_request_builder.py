...
class RequestSignupUrlRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RequestSignupUrlPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[RequestSignupUrlPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[RequestSignupUrlPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action requestSignupUrl
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
