...
class RequestSignupUrlRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: RequestSignupUrlPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RequestSignupUrlPostResponse]:
        """
    ...
    def to_post_request_information(self,body: RequestSignupUrlPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action requestSignupUrl
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> RequestSignupUrlRequestBuilder:
        """
    ...
    @dataclass
    class RequestSignupUrlRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
