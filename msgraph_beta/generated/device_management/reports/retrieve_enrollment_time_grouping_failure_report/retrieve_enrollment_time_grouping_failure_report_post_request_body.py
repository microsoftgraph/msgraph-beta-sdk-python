...
@dataclass
class RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody:
        """
        ...
        return RetrieveEnrollmentTimeGroupingFailureReportPostRequestBody()
