...
@dataclass
class GetWindowsUpdateAlertSummaryReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetWindowsUpdateAlertSummaryReportPostRequestBody:
        """
        ...
        return GetWindowsUpdateAlertSummaryReportPostRequestBody()
