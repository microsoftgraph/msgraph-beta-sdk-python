...
@dataclass
class GetDevicesStatusBySettingReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetDevicesStatusBySettingReportPostRequestBody:
        """
        ...
        return GetDevicesStatusBySettingReportPostRequestBody()
