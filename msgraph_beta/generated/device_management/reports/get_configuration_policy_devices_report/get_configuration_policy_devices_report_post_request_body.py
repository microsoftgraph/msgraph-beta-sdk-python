...
@dataclass
class GetConfigurationPolicyDevicesReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetConfigurationPolicyDevicesReportPostRequestBody:
        """
