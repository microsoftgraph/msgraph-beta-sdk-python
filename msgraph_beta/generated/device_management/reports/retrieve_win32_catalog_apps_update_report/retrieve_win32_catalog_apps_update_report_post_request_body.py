...
@dataclass
class RetrieveWin32CatalogAppsUpdateReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveWin32CatalogAppsUpdateReportPostRequestBody:
        """
        ...
        return RetrieveWin32CatalogAppsUpdateReportPostRequestBody()
