...
@dataclass
class GetFailedMobileAppsSummaryReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetFailedMobileAppsSummaryReportPostRequestBody:
        """
        ...
        return GetFailedMobileAppsSummaryReportPostRequestBody()
