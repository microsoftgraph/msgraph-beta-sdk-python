...
@dataclass
class GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPo_78a4c0d9(AdditionalDataHolder, BackedModel, Parsable):
    """
    Original name: GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPostRequestBody
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPo_78a4c0d9:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPo_78a4c0d9
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return GetWindowsQualityUpdateAlertsPerPolicyPerDeviceReportPo_78a4c0d9()
