...
class CachedReportConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementCachedReportConfigurationCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DeviceManagementCachedReportConfiguration] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementCachedReportConfiguration]:
        """
    ...
    def to_post_request_information(self,body: Optional[DeviceManagementCachedReportConfiguration] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cachedReportConfigurations for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
