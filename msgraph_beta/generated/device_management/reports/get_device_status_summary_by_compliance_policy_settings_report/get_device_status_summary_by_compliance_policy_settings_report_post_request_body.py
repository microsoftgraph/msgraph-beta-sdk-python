...
@dataclass
class GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody:
        """
