...
@dataclass
class GetDeviceStatusSummaryByCompliancePolicySettingsReportP_3ae506e5(AdditionalDataHolder, BackedModel, Parsable):
    """
    Original name: GetDeviceStatusSummaryByCompliancePolicySettingsReportPostRequestBody
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetDeviceStatusSummaryByCompliancePolicySettingsReportP_3ae506e5:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GetDeviceStatusSummaryByCompliancePolicySettingsReportP_3ae506e5
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return GetDeviceStatusSummaryByCompliancePolicySettingsReportP_3ae506e5()
