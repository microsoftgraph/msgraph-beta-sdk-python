...
@dataclass
class GetMobileApplicationManagementAppConfigurationReportPos_7beacf32(AdditionalDataHolder, BackedModel, Parsable):
    """
    Original name: GetMobileApplicationManagementAppConfigurationReportPostRequestBody
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetMobileApplicationManagementAppConfigurationReportPos_7beacf32:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: GetMobileApplicationManagementAppConfigurationReportPos_7beacf32
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return GetMobileApplicationManagementAppConfigurationReportPos_7beacf32()
