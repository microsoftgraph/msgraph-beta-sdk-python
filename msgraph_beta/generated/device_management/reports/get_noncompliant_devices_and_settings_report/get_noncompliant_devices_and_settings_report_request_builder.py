...
class GetNoncompliantDevicesAndSettingsReportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetNoncompliantDevicesAndSettingsReportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> bytes:
        """
