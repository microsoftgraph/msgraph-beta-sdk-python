...
class GetNoncompliantDevicesAndSettingsReportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetNoncompliantDevicesAndSettingsReportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> bytes:
        """
    ...
    def to_post_request_information(self,body: Optional[GetNoncompliantDevicesAndSettingsReportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action getNoncompliantDevicesAndSettingsReport
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
