...
@dataclass
class GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody:
        """
        ...
        return GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody()
