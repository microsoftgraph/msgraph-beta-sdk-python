...
@dataclass
class GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody:
        """
        ...
        return GetDevicesStatusByPolicyPlatformComplianceReportPostRequestBody()
