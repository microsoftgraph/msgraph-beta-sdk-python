...
class DeviceManagementIntentAssignmentItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementIntentAssignment]:
        """
    ...
    async def patch(self,body: Optional[DeviceManagementIntentAssignment] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceManagementIntentAssignment]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DeviceManagementIntentAssignment] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property assignments in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
