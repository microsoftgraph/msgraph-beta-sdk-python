...
class GenerateApplePushNotificationCertificateSigningRequestRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GenerateApplePushNotificationCertificateSigningRequestPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> GenerateApplePushNotificationCertificateSigningRequestRequestBuilder:
        """
