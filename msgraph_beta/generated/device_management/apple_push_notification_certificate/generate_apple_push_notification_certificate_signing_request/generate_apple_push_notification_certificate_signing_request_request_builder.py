...
class GenerateApplePushNotificationCertificateSigningRequestRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GenerateApplePushNotificationCertificateSigningRequestPostResponse]:
        """
