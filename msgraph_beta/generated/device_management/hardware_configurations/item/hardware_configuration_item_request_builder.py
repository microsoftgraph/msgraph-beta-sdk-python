...
class HardwareConfigurationItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/hardwareConfigurations/{hardwareConfiguration%2Did}{?%24expand,%24select}", path_parameters)
    
    async def delete(self,request_configuration: Optional[HardwareConfigurationItemRequestBuilderDeleteRequestConfiguration] = None) -> None:
        """
    ...
    async def get(self,request_configuration: Optional[HardwareConfigurationItemRequestBuilderGetRequestConfiguration] = None) -> Optional[HardwareConfiguration]:
        """
    ...
    async def patch(self,body: Optional[HardwareConfiguration] = None, request_configuration: Optional[HardwareConfigurationItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[HardwareConfiguration]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[HardwareConfigurationItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property hardwareConfigurations for deviceManagement
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[HardwareConfigurationItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The hardware configurations for this account.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: Optional[HardwareConfiguration] = None, request_configuration: Optional[HardwareConfigurationItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property hardwareConfigurations in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> HardwareConfigurationItemRequestBuilder:
        """
        ...
        return HardwareConfigurationItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class HardwareConfigurationItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class HardwareConfigurationItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[HardwareConfigurationItemRequestBuilder.HardwareConfigurationItemRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class HardwareConfigurationItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
