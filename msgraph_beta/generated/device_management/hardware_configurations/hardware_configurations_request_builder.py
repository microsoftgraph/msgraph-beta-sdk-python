...
class HardwareConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[HardwareConfigurationsRequestBuilderGetRequestConfiguration] = None) -> Optional[HardwareConfigurationCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[HardwareConfiguration] = None, request_configuration: Optional[HardwareConfigurationsRequestBuilderPostRequestConfiguration] = None) -> Optional[HardwareConfiguration]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[HardwareConfigurationsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        The hardware configurations for this account.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[HardwareConfiguration] = None, request_configuration: Optional[HardwareConfigurationsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to hardwareConfigurations for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class HardwareConfigurationsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[HardwareConfigurationsRequestBuilder.HardwareConfigurationsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class HardwareConfigurationsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
