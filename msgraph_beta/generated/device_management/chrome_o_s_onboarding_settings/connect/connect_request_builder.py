...
class ConnectRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ConnectPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[chromeOSOnboardingStatus]:
        """
    ...
    def with_url(self,raw_url: str) -> ConnectRequestBuilder:
        """
    ...
    @dataclass
    class ConnectRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
