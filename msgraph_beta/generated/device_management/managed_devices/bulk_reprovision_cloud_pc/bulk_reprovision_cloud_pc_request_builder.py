...
class BulkReprovisionCloudPcRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: BulkReprovisionCloudPcPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CloudPcBulkRemoteActionResult]:
        ...
        """
        warn("The bulkReprovisionCloudPc action is deprecated and will stop supporting on September 24, 2023. Please use bulk action entity api. as of 2023-05/bulkReprovisionCloudPc", DeprecationWarning)
        if body is None:
