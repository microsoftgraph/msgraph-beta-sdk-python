...
class DownloadDeviceLogsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}/downloadDeviceLogs", path_parameters)
    
    async def post(self,request_configuration: Optional[DownloadDeviceLogsRequestBuilderPostRequestConfiguration] = None) -> Optional[DownloadDeviceLogsPostResponse]:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[DownloadDeviceLogsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action downloadDeviceLogs
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class DownloadDeviceLogsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
