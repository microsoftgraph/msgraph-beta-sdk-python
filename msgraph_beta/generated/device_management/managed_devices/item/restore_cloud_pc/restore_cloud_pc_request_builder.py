...
if TYPE_CHECKING:
    ...
    from .restore_cloud_pc_post_request_body import RestoreCloudPcPostRequestBody

class RestoreCloudPcRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/restoreCloudPc", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RestoreCloudPcRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RestoreCloudPcRequestBuilder
        """
        warn("The restoreCloudPc API is deprecated and will stop returning on Sep 30, 2023. Please use restore instead as of 2023-07/restoreCloudPc", DeprecationWarning)
        if raw_url is None:
    ...
    @dataclass
    class RestoreCloudPcRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
