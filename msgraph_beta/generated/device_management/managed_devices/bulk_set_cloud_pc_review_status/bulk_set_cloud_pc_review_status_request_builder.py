...
class BulkSetCloudPcReviewStatusRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: BulkSetCloudPcReviewStatusPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CloudPcBulkRemoteActionResult]:
        ...
        """
        warn("The BulkSetCloudPcReviewStatus action is deprecated and will stop supporting on September 30, 2024. Please use bulk action entity api. as of 2024-05/BulkSetCloudPcReviewStatus on 2024-05-15 and will be removed 2024-09-30", DeprecationWarning)
        if body is None:
    ...
    def with_url(self,raw_url: str) -> BulkSetCloudPcReviewStatusRequestBuilder:
        """
    ...
    @dataclass
    class BulkSetCloudPcReviewStatusRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
