...
class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        User experience analytics devices without cloud identity.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: UserExperienceAnalyticsDeviceWithoutCloudIdentity, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsDevicesWithoutCloudIdentity for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder:
        """
    ...
    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration(RequestConfiguration[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
