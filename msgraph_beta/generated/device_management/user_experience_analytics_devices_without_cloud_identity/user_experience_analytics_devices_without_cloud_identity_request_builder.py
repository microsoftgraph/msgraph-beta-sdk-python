...
class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentityCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity]:
        """
    ...
    def to_post_request_information(self,body: Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsDevicesWithoutCloudIdentity for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
