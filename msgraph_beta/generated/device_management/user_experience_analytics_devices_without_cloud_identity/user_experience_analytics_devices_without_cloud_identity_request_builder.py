...
class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDevicesWithoutCloudIdentity{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_user_experience_analytics_device_without_cloud_identity_id(self,user_experience_analytics_device_without_cloud_identity_id: str) -> UserExperienceAnalyticsDeviceWithoutCloudIdentityItemRequestBuilder:
        ...
        """
        if not user_experience_analytics_device_without_cloud_identity_id:
    ...
    async def get(self,request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentityCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration] = None) -> Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity]:
        """
    ...
    def to_post_request_information(self,body: Optional[UserExperienceAnalyticsDeviceWithoutCloudIdentity] = None, request_configuration: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to userExperienceAnalyticsDevicesWithoutCloudIdentity for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilder.UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class UserExperienceAnalyticsDevicesWithoutCloudIdentityRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
