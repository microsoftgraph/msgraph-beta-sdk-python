...
class GroupPolicyUploadedDefinitionFilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicyUploadedDefinitionFileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[GroupPolicyUploadedDefinitionFile] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GroupPolicyUploadedDefinitionFile]:
        """
    ...
    def to_post_request_information(self,body: Optional[GroupPolicyUploadedDefinitionFile] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to groupPolicyUploadedDefinitionFiles for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
