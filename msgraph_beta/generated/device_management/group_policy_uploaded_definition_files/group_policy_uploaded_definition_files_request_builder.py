...
class GroupPolicyUploadedDefinitionFilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GroupPolicyUploadedDefinitionFilesRequestBuilderGetQueryParameters]] = None) -> Optional[GroupPolicyUploadedDefinitionFileCollectionResponse]:
        """
    ...
    async def post(self,body: GroupPolicyUploadedDefinitionFile, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GroupPolicyUploadedDefinitionFile]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GroupPolicyUploadedDefinitionFilesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The available group policy uploaded definition files for this account.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: GroupPolicyUploadedDefinitionFile, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to groupPolicyUploadedDefinitionFiles for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> GroupPolicyUploadedDefinitionFilesRequestBuilder:
        """
    ...
    @dataclass
    class GroupPolicyUploadedDefinitionFilesRequestBuilderGetRequestConfiguration(RequestConfiguration[GroupPolicyUploadedDefinitionFilesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GroupPolicyUploadedDefinitionFilesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
