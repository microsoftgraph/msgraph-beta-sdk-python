...
if TYPE_CHECKING:
    ...
    from .get_role_scope_tags_by_resource_with_resource_get_response import GetRoleScopeTagsByResourceWithResourceGetResponse

class GetRoleScopeTagsByResourceWithResourceRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetQueryParameters]] = None) -> Optional[GetRoleScopeTagsByResourceWithResourceGetResponse]:
        ...
        Returns: Optional[GetRoleScopeTagsByResourceWithResourceGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetRoleScopeTagsByResourceWithResourceGetResponse, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getRoleScopeTagsByResource
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetRoleScopeTagsByResourceWithResourceRequestBuilder:
        """
    ...
    @dataclass
    class GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration(RequestConfiguration[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetQueryParameters]):
        """
