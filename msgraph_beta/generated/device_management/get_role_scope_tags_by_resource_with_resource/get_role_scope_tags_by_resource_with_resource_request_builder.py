...
class GetRoleScopeTagsByResourceWithResourceRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration] = None) -> Optional[GetRoleScopeTagsByResourceWithResourceGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetRoleScopeTagsByResourceWithResourceRequestBuilder:
        """
    ...
    @dataclass
    class GetRoleScopeTagsByResourceWithResourceRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
