...
class GetPolicySummaryWithPolicyIdRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetPolicySummaryWithPolicyIdRequestBuilder:
        """
    ...
    @dataclass
    class GetPolicySummaryWithPolicyIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
