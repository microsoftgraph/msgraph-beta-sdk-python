...
class HasActiveDeploymentsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[HasActiveDeploymentsPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> HasActiveDeploymentsRequestBuilder:
        """
    ...
    @dataclass
    class HasActiveDeploymentsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
