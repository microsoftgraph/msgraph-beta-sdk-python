...
if TYPE_CHECKING:
    ...
    from .schedule_policy_apply_task_post_request_body import SchedulePolicyApplyTaskPostRequestBody

class SchedulePolicyApplyTaskRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/schedulePolicyApplyTask", path_parameters)
    ...
    def with_url(self,raw_url: str) -> SchedulePolicyApplyTaskRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SchedulePolicyApplyTaskRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SchedulePolicyApplyTaskRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class SchedulePolicyApplyTaskRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
