...
if TYPE_CHECKING:
    ...
    from ......models.cloud_pc_provisioning_policy_assignment_collection_response import CloudPcProvisioningPolicyAssignmentCollectionResponse
...
class AssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_cloud_pc_provisioning_policy_assignment_id(self,cloud_pc_provisioning_policy_assignment_id: str) -> CloudPcProvisioningPolicyAssignmentItemRequestBuilder:
        """
        Provides operations to manage the assignments property of the microsoft.graph.cloudPcProvisioningPolicy entity.
        param cloud_pc_provisioning_policy_assignment_id: The unique identifier of cloudPcProvisioningPolicyAssignment
        ...
        if not cloud_pc_provisioning_policy_assignment_id:
            raise TypeError("cloud_pc_provisioning_policy_assignment_id cannot be null.")
        from .item.cloud_pc_provisioning_policy_assignment_item_request_builder import CloudPcProvisioningPolicyAssignmentItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["cloudPcProvisioningPolicyAssignment%2Did"] = cloud_pc_provisioning_policy_assignment_id
        return CloudPcProvisioningPolicyAssignmentItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[AssignmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[CloudPcProvisioningPolicyAssignmentCollectionResponse]:
        """
        ...
        Returns: Optional[CloudPcProvisioningPolicyAssignmentCollectionResponse]
        """
        warn("The onPremisesConnectionId property is deprecated and will stop returning on July 30, 2023. as of 2023-03/onPremisesConnectionId", DeprecationWarning)
    ...
    async def post(self,body: Optional[CloudPcProvisioningPolicyAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> Optional[CloudPcProvisioningPolicyAssignment]:
        """
    ...
    def to_post_request_information(self,body: Optional[CloudPcProvisioningPolicyAssignment] = None, request_configuration: Optional[AssignmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to assignments for deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
