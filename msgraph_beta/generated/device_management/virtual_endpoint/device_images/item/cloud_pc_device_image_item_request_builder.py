...
class CloudPcDeviceImageItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcDeviceImage]:
        """
    ...
    async def patch(self,body: Optional[CloudPcDeviceImage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcDeviceImage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[CloudPcDeviceImage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property deviceImages in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
