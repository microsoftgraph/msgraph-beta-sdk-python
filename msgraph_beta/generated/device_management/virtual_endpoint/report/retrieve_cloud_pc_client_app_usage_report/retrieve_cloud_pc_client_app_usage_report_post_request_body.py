...
if TYPE_CHECKING:
    from .....models.cloud_pc_client_app_usage_report_type import CloudPcClientAppUsageReportType

@dataclass
class RetrieveCloudPcClientAppUsageReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_type: Optional[CloudPcClientAppUsageReportType] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveCloudPcClientAppUsageReportPostRequestBody:
        """
        ...
        return RetrieveCloudPcClientAppUsageReportPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "reportType": lambda n : setattr(self, 'report_type', n.get_enum_value(CloudPcClientAppUsageReportType)),
