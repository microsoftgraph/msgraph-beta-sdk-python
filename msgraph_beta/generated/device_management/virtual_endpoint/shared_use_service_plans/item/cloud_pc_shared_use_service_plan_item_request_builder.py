...
class CloudPcSharedUseServicePlanItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CloudPcSharedUseServicePlanItemRequestBuilderGetQueryParameters]] = None) -> Optional[CloudPcSharedUseServicePlan]:
        """
    ...
    async def patch(self,body: CloudPcSharedUseServicePlan, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CloudPcSharedUseServicePlan]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CloudPcSharedUseServicePlanItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of a cloudPcSharedUseServicePlan object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: CloudPcSharedUseServicePlan, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property sharedUseServicePlans in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> CloudPcSharedUseServicePlanItemRequestBuilder:
        """
    ...
    @dataclass
    class CloudPcSharedUseServicePlanItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CloudPcSharedUseServicePlanItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CloudPcSharedUseServicePlanItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CloudPcSharedUseServicePlanItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
