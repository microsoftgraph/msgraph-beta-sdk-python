...
class CloudPcGalleryImageItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcGalleryImage]:
        """
    ...
    async def patch(self,body: Optional[CloudPcGalleryImage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcGalleryImage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[CloudPcGalleryImage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property galleryImages in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
