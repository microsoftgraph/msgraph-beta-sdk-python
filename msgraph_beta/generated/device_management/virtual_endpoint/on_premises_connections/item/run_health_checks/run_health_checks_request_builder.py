...
class RunHealthChecksRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RunHealthChecksRequestBuilder:
        """
    ...
    @dataclass
    class RunHealthChecksRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
