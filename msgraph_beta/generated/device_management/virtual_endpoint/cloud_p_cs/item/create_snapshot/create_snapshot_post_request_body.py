...
if TYPE_CHECKING:
    from ......models.cloud_pc_blob_access_tier import CloudPcBlobAccessTier

@dataclass
class CreateSnapshotPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreateSnapshotPostRequestBody:
        """
