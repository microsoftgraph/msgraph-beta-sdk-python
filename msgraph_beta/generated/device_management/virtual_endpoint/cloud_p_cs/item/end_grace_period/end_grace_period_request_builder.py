...
class EndGracePeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> EndGracePeriodRequestBuilder:
        """
    ...
    @dataclass
    class EndGracePeriodRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
