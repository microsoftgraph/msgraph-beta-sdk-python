...
class RetrieveReviewStatusRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/retrieveReviewStatus()", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RetrieveReviewStatusRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RetrieveReviewStatusRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return RetrieveReviewStatusRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RetrieveReviewStatusRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
