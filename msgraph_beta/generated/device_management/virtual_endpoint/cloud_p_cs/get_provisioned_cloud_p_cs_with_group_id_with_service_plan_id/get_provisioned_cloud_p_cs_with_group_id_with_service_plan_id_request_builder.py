...
class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get all provisioned Cloud PCs of a specific service plan for users under a Microsoft Entra user group.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilder:
        """
    ...
    @dataclass
    class GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilderGetRequestConfiguration(RequestConfiguration[GetProvisionedCloudPCsWithGroupIdWithServicePlanIdRequestBuilderGetQueryParameters]):
        """
