...
class CloudPcFrontLineServicePlanItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[CloudPcFrontLineServicePlan] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcFrontLineServicePlan]:
        """
    ...
    def to_patch_request_information(self,body: Optional[CloudPcFrontLineServicePlan] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property frontLineServicePlans in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
