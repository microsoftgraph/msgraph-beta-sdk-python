...
class GetAuditActivityTypesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetAuditActivityTypesRequestBuilder:
        """
    ...
    @dataclass
    class GetAuditActivityTypesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAuditActivityTypesRequestBuilderGetQueryParameters]):
        """
