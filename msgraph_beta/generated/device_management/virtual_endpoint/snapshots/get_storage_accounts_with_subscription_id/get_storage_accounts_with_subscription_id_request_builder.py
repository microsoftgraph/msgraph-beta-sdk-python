...
class GetStorageAccountsWithSubscriptionIdRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetStorageAccountsWithSubscriptionIdRequestBuilderGetQueryParameters]] = None) -> Optional[GetStorageAccountsWithSubscriptionIdGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetStorageAccountsWithSubscriptionIdRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        List all storage accounts cloudPcForensicStorageAccount that can be used to store a snapshot or snapshots of a Cloud PC for forensic analysis.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetStorageAccountsWithSubscriptionIdRequestBuilder:
        """
    ...
    @dataclass
    class GetStorageAccountsWithSubscriptionIdRequestBuilderGetRequestConfiguration(RequestConfiguration[GetStorageAccountsWithSubscriptionIdRequestBuilderGetQueryParameters]):
        """
