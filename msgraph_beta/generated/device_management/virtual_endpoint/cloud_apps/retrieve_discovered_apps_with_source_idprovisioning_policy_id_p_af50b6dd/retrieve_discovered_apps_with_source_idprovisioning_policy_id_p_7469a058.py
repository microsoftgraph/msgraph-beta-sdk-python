...
if TYPE_CHECKING:
    ...
    from .retrieve_discovered_apps_with_source_idprovisioning_policy_id_p_c52ea2f2 import RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_c52ea2f2

class RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_7469a058(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], source_id: Optional[str] = None) -> None:
        """
        Instantiates a new RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_7469a058 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdProvisioningPolicyIdRequestBuilderGetQueryParameters]] = None) -> Optional[RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_c52ea2f2]:
        """
        ...
        Returns: Optional[RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_c52ea2f2]
        ...
        return await self.request_adapter.send_async(request_info, RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_c52ea2f2, error_mapping)
    ...
    def with_url(self,raw_url: str) -> RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_7469a058:
        """
        ...
        return RetrieveDiscoveredAppsWithSourceIdprovisioningPolicyIdP_7469a058(self.request_adapter, raw_url)
