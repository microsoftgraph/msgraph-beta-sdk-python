...
@dataclass
class RetrieveCloudPcRecommendationReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[CloudPcRecommendationReportType] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveCloudPcRecommendationReportsPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(CloudPcRecommendationReportType)),
