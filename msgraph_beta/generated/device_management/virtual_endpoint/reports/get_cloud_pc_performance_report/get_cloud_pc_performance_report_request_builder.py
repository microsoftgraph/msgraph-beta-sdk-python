...
class GetCloudPcPerformanceReportRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetCloudPcPerformanceReportRequestBuilder:
        """
    ...
    @dataclass
    class GetCloudPcPerformanceReportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
