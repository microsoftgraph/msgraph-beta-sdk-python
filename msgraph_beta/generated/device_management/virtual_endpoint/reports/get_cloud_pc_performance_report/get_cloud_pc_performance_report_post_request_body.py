...
if TYPE_CHECKING:
    from .get_cloud_pc_performance_report_post_request_body_report_name import GetCloudPcPerformanceReportPostRequestBody_reportName
...
class GetCloudPcPerformanceReportPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[GetCloudPcPerformanceReportPostRequestBody_reportName] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetCloudPcPerformanceReportPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(GetCloudPcPerformanceReportPostRequestBody_reportName)),
