...
if TYPE_CHECKING:
    from .get_inaccessible_cloud_pc_reports_post_request_body_report_name import GetInaccessibleCloudPcReportsPostRequestBody_reportName
...
class GetInaccessibleCloudPcReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[GetInaccessibleCloudPcReportsPostRequestBody_reportName] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetInaccessibleCloudPcReportsPostRequestBody:
        """
        ...
        return GetInaccessibleCloudPcReportsPostRequestBody()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(GetInaccessibleCloudPcReportsPostRequestBody_reportName)),
