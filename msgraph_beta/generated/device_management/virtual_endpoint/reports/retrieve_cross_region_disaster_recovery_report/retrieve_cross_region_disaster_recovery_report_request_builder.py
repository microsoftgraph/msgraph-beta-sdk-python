...
class RetrieveCrossRegionDisasterRecoveryReportRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RetrieveCrossRegionDisasterRecoveryReportRequestBuilder:
        """
    ...
    @dataclass
    class RetrieveCrossRegionDisasterRecoveryReportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
