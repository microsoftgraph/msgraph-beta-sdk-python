...
if TYPE_CHECKING:
    from .....models.cloud_p_c_frontline_report_type import CloudPCFrontlineReportType

@dataclass
class RetrieveFrontlineReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[CloudPCFrontlineReportType] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveFrontlineReportsPostRequestBody:
        """
        ...
        return RetrieveFrontlineReportsPostRequestBody()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(CloudPCFrontlineReportType)),
