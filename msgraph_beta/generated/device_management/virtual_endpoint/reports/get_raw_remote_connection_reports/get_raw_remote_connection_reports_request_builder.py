...
if TYPE_CHECKING:
    ...
    from .get_raw_remote_connection_reports_post_request_body import GetRawRemoteConnectionReportsPostRequestBody

class GetRawRemoteConnectionReportsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def to_post_request_information(self,body: GetRawRemoteConnectionReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get the raw real-time remote connection report for a Cloud PC without any calculation, such as roundTripTime or available bandwidth, which are aggregated hourly from the raw event data.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetRawRemoteConnectionReportsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetRawRemoteConnectionReportsRequestBuilder
        """
        warn("Starting from December 31, 2026, this entity type (&apos;cloudPcReports&apos;) will be deprecated and no longer supported. Please use &apos;cloudPcReport&apos; instead. as of 2025-09/cloudPcReports on 2025-09-01 and will be removed 2026-12-31", DeprecationWarning)
        if raw_url is None:
    ...
    @dataclass
    class GetRawRemoteConnectionReportsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
