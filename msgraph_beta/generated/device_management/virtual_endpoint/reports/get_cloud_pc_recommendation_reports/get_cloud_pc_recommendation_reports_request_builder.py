...
class GetCloudPcRecommendationReportsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetCloudPcRecommendationReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> bytes:
        """
