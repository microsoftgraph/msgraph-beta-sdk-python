...
if TYPE_CHECKING:
    from .get_cloud_pc_recommendation_reports_post_request_body_report_name import GetCloudPcRecommendationReportsPostRequestBody_reportName

@dataclass
class GetCloudPcRecommendationReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[GetCloudPcRecommendationReportsPostRequestBody_reportName] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetCloudPcRecommendationReportsPostRequestBody:
        """
        ...
        return GetCloudPcRecommendationReportsPostRequestBody()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(GetCloudPcRecommendationReportsPostRequestBody_reportName)),
