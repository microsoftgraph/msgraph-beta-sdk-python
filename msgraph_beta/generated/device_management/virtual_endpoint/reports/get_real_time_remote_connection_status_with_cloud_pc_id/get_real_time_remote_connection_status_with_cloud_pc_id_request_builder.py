...
class GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder:
        """
    ...
    @dataclass
    class GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
