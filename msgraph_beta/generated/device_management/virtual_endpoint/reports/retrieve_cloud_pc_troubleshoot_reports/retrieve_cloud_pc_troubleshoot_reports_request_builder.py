...
if TYPE_CHECKING:
    ...
    from .retrieve_cloud_pc_troubleshoot_reports_post_request_body import RetrieveCloudPcTroubleshootReportsPostRequestBody

class RetrieveCloudPcTroubleshootReportsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> RetrieveCloudPcTroubleshootReportsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RetrieveCloudPcTroubleshootReportsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return RetrieveCloudPcTroubleshootReportsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RetrieveCloudPcTroubleshootReportsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
