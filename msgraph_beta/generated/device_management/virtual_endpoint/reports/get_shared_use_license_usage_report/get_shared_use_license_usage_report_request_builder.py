...
class GetSharedUseLicenseUsageReportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetSharedUseLicenseUsageReportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    def to_post_request_information(self,body: GetSharedUseLicenseUsageReportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get a usage report on shared-use licenses, such as servicePlanId, licenseCount, and claimedLicenseCount, for real-time, 7 days, or 28 days trend.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetSharedUseLicenseUsageReportRequestBuilder:
        """
    ...
    @dataclass
    class GetSharedUseLicenseUsageReportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
