...
class GetRemoteConnectionHistoricalReportsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetRemoteConnectionHistoricalReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    def to_post_request_information(self,body: GetRemoteConnectionHistoricalReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get the remote connection history records of a Cloud PC during a given period. This report contains data such as signInDateTime, signOutDateTime, usageInHour, remoteSignInTimeInSec and roundTripTimeInMsP50, and so on. This data is aggregated hourly for a specified time period, such as the last seven days.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetRemoteConnectionHistoricalReportsRequestBuilder:
        """
    ...
    @dataclass
    class GetRemoteConnectionHistoricalReportsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
