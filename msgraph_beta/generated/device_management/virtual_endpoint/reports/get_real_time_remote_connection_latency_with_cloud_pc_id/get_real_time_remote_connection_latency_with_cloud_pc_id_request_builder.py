...
class GetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilder:
        """
    ...
    @dataclass
    class GetRealTimeRemoteConnectionLatencyWithCloudPcIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
