...
class GetFrontlineReportRequestBuilder(BaseRequestBuilder):
    ...
    def to_post_request_information(self,body: GetFrontlineReportPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get the Windows 365 Frontline reports, such as real-time or historical data reports.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetFrontlineReportRequestBuilder:
        """
    ...
    @dataclass
    class GetFrontlineReportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
