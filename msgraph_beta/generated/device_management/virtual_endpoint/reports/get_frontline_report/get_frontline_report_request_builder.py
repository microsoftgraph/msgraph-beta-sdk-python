...
class GetFrontlineReportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetFrontlineReportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> bytes:
        """
    ...
    def to_post_request_information(self,body: Optional[GetFrontlineReportPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Get the Windows 365 Frontline reports, such as real-time or historical data reports.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
