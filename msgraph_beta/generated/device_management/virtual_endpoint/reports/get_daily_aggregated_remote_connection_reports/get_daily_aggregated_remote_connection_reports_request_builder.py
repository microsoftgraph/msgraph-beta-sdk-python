...
class GetDailyAggregatedRemoteConnectionReportsRequestBuilder(BaseRequestBuilder):
    ...
    def to_post_request_information(self,body: GetDailyAggregatedRemoteConnectionReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get the daily aggregated remote connection reports, such as round trip time, available bandwidth, and so on, in a given period.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetDailyAggregatedRemoteConnectionReportsRequestBuilder:
        """
    ...
    @dataclass
    class GetDailyAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
