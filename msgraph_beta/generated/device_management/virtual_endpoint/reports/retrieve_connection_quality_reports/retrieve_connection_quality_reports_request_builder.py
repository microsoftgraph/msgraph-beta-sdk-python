...
class RetrieveConnectionQualityReportsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: RetrieveConnectionQualityReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> bytes:
        """
