...
@dataclass
class RetrieveConnectionQualityReportsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    report_name: Optional[CloudPCConnectionQualityReportType] = None
    # The search property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveConnectionQualityReportsPostRequestBody:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "reportName": lambda n : setattr(self, 'report_name', n.get_enum_value(CloudPCConnectionQualityReportType)),
