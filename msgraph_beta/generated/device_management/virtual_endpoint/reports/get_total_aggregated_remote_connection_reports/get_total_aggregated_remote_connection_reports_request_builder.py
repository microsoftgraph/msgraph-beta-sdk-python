...
class GetTotalAggregatedRemoteConnectionReportsRequestBuilder(BaseRequestBuilder):
    ...
    def to_post_request_information(self,body: GetTotalAggregatedRemoteConnectionReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get the total aggregated remote connection usage of a Cloud PC during a given time span.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetTotalAggregatedRemoteConnectionReportsRequestBuilder:
        """
    ...
    @dataclass
    class GetTotalAggregatedRemoteConnectionReportsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
