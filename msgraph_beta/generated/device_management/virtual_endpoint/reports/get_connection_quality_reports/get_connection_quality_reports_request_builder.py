...
class GetConnectionQualityReportsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetConnectionQualityReportsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[bytes]:
        ...
        """
        warn("Starting from December 31, 2024, this API (&apos;getConnectionQualityReports&apos;) will be deprecated and no longer supported. Please use the retrieveConnectionQualityReports API. as of 2024-09/getConnectionQualityReports on 2024-09-10 and will be removed 2024-12-31", DeprecationWarning)
        if body is None:
