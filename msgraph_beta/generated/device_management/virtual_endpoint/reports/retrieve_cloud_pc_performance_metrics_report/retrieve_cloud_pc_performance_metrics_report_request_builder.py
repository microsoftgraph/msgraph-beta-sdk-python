...
if TYPE_CHECKING:
    ...
    from .retrieve_cloud_pc_performance_metrics_report_post_request_body import RetrieveCloudPcPerformanceMetricsReportPostRequestBody

class RetrieveCloudPcPerformanceMetricsReportRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/reports/retrieveCloudPcPerformanceMetricsReport", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RetrieveCloudPcPerformanceMetricsReportRequestBuilder:
        """
        ...
        return RetrieveCloudPcPerformanceMetricsReportRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class RetrieveCloudPcPerformanceMetricsReportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
