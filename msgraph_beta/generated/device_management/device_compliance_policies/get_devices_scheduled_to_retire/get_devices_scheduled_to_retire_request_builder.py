...
class GetDevicesScheduledToRetireRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetDevicesScheduledToRetireRequestBuilder:
        """
    ...
    @dataclass
    class GetDevicesScheduledToRetireRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
