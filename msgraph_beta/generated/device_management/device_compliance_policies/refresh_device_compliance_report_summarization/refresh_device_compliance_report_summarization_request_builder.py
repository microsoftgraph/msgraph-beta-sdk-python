...
class RefreshDeviceComplianceReportSummarizationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RefreshDeviceComplianceReportSummarizationRequestBuilder:
        """
    ...
    @dataclass
    class RefreshDeviceComplianceReportSummarizationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
