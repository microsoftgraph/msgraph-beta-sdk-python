...
class ScheduledActionsForRuleRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ScheduledActionsForRuleRequestBuilder:
        """
    ...
    @dataclass
    class ScheduledActionsForRuleRequestBuilderGetRequestConfiguration(RequestConfiguration[ScheduledActionsForRuleRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ScheduledActionsForRuleRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
