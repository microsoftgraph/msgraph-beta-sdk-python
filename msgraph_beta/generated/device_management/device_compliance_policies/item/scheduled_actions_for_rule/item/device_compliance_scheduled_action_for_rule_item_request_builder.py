...
class DeviceComplianceScheduledActionForRuleItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: DeviceComplianceScheduledActionForRule, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeviceComplianceScheduledActionForRule]:
        """
    ...
    def to_patch_request_information(self,body: DeviceComplianceScheduledActionForRule, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property scheduledActionsForRule in deviceManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DeviceComplianceScheduledActionForRuleItemRequestBuilder:
        """
    ...
    @dataclass
    class DeviceComplianceScheduledActionForRuleItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class DeviceComplianceScheduledActionForRuleItemRequestBuilderGetRequestConfiguration(RequestConfiguration[DeviceComplianceScheduledActionForRuleItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DeviceComplianceScheduledActionForRuleItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
