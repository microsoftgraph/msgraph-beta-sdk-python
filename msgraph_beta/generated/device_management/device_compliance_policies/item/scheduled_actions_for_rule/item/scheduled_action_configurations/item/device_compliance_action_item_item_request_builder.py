...
class DeviceComplianceActionItemItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DeviceComplianceActionItemItemRequestBuilder:
        """
    ...
    @dataclass
    class DeviceComplianceActionItemItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class DeviceComplianceActionItemItemRequestBuilderGetRequestConfiguration(RequestConfiguration[DeviceComplianceActionItemItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DeviceComplianceActionItemItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
