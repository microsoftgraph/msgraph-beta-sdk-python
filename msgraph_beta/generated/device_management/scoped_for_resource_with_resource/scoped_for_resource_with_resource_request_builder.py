...
class ScopedForResourceWithResourceRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ScopedForResourceWithResourceRequestBuilder:
        """
    ...
    @dataclass
    class ScopedForResourceWithResourceRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
