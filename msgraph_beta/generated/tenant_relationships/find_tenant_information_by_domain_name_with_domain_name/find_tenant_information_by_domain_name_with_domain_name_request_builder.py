...
class FindTenantInformationByDomainNameWithDomainNameRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> FindTenantInformationByDomainNameWithDomainNameRequestBuilder:
        """
    ...
    @dataclass
    class FindTenantInformationByDomainNameWithDomainNameRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
