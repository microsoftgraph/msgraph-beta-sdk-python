...
class ManagedTenantApiNotificationsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ManagedTenantApiNotification] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagedTenantApiNotification]:
        """
    ...
    def to_post_request_information(self,body: Optional[ManagedTenantApiNotification] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managedTenantApiNotifications for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
