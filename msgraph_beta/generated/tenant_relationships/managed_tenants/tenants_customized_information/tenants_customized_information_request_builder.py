...
class TenantsCustomizedInformationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/tenantsCustomizedInformation{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[TenantsCustomizedInformationRequestBuilderGetRequestConfiguration] = None) -> Optional[TenantCustomizedInformationCollectionResponse]:
        """
        Get a list of the tenantCustomizedInformation objects and their properties. This API is available in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TenantCustomizedInformationCollectionResponse]
        Find more info here: https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-tenantscustomizedinformation?view=graph-rest-1.0
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TenantsCustomizedInformationRequestBuilder:
        """
