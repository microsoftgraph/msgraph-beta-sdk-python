...
class DeviceAppPerformancesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceAppPerformanceCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DeviceAppPerformance] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceAppPerformance]:
        """
    ...
    def to_post_request_information(self,body: Optional[DeviceAppPerformance] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to deviceAppPerformances for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
