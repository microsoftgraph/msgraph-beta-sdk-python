...
class ManagementTemplateStepsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagementTemplateStepCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ManagementTemplateStep] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagementTemplateStep]:
        """
    ...
    def to_post_request_information(self,body: Optional[ManagementTemplateStep] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managementTemplateSteps for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ManagementTemplateStepsRequestBuilder:
        """
