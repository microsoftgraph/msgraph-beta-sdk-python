...
class ManagementTemplateCollectionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_management_template_collection_id(self,management_template_collection_id: str) -> ManagementTemplateCollectionItemRequestBuilder:
        ...
        """
        if management_template_collection_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ManagementTemplateCollectionsRequestBuilderGetQueryParameters]] = None) -> Optional[ManagementTemplateCollectionCollectionResponse]:
        """
    ...
    async def post(self,body: ManagementTemplateCollection, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ManagementTemplateCollection]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ManagementTemplateCollectionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get managementTemplateCollections from tenantRelationships
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: ManagementTemplateCollection, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to managementTemplateCollections for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/tenantRelationships/managedTenants/managementTemplateCollections', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ManagementTemplateCollectionsRequestBuilder:
        """
    ...
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderGetRequestConfiguration(RequestConfiguration[ManagementTemplateCollectionsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ManagementTemplateCollectionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
