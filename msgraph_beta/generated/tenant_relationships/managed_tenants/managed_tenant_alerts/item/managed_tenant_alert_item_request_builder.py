...
class ManagedTenantAlertItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagedTenantAlert]:
        """
    ...
    async def patch(self,body: Optional[ManagedTenantAlert] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagedTenantAlert]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ManagedTenantAlert] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property managedTenantAlerts in tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
