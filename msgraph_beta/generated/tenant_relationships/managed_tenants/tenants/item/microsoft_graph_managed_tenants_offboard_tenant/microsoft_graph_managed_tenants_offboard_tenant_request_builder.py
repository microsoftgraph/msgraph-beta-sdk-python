...
class MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphManagedTenantsOffboardTenantRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
