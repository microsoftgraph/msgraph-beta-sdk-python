...
class MicrosoftGraphManagedTenantsAssignTagRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: AssignTagPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TenantTag]:
        """
    ...
    def to_post_request_information(self,body: AssignTagPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Assign the tenant tag to the specified managed tenants.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphManagedTenantsAssignTagRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphManagedTenantsAssignTagRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
