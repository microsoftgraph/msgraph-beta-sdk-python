...
if TYPE_CHECKING:
    ...
    from ....models.managed_tenants.cloud_pc_device_collection_response import CloudPcDeviceCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.cloud_pc_device_item_request_builder import CloudPcDeviceItemRequestBuilder

class CloudPcDevicesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_cloud_pc_device_id(self,cloud_pc_device_id: str) -> CloudPcDeviceItemRequestBuilder:
        """
        Provides operations to manage the cloudPcDevices property of the microsoft.graph.managedTenants.managedTenant entity.
        param cloud_pc_device_id: The unique identifier of cloudPcDevice
    ...
    async def post(self,body: CloudPcDevice, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CloudPcDevice]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[CloudPcDevice]
        """
        if body is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CloudPcDevicesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/tenantRelationships/managedTenants/cloudPcDevices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: CloudPcDevice, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/tenantRelationships/managedTenants/cloudPcDevices', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    def with_url(self,raw_url: str) -> CloudPcDevicesRequestBuilder:
        ...
        Returns: CloudPcDevicesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CloudPcDevicesRequestBuilder(self.request_adapter, raw_url)
