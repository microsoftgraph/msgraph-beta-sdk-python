...
class CloudPcConnectionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcConnectionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[CloudPcConnection] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CloudPcConnection]:
        """
    ...
    def to_post_request_information(self,body: Optional[CloudPcConnection] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to cloudPcConnections for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
