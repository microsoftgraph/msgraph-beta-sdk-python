...
class ManagementActionTenantDeploymentStatusesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagementActionTenantDeploymentStatusCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ManagementActionTenantDeploymentStatus] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ManagementActionTenantDeploymentStatus]:
        """
    ...
    def to_post_request_information(self,body: Optional[ManagementActionTenantDeploymentStatus] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to managementActionTenantDeploymentStatuses for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
