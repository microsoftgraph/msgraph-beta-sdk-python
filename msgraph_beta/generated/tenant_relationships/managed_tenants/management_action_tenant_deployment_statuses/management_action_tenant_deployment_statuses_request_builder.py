...
class ManagementActionTenantDeploymentStatusesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ManagementActionTenantDeploymentStatusesRequestBuilderGetQueryParameters]] = None) -> Optional[ManagementActionTenantDeploymentStatusCollectionResponse]:
        """
    ...
    async def post(self,body: ManagementActionTenantDeploymentStatus, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ManagementActionTenantDeploymentStatus]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ManagementActionTenantDeploymentStatusesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the managementActionTenantDeploymentStatus objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: ManagementActionTenantDeploymentStatus, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to managementActionTenantDeploymentStatuses for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/tenantRelationships/managedTenants/managementActionTenantDeploymentStatuses', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ManagementActionTenantDeploymentStatusesRequestBuilder:
        """
    ...
    @dataclass
    class ManagementActionTenantDeploymentStatusesRequestBuilderGetRequestConfiguration(RequestConfiguration[ManagementActionTenantDeploymentStatusesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ManagementActionTenantDeploymentStatusesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
