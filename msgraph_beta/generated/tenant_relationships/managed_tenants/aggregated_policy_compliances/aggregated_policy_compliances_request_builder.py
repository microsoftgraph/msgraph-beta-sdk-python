...
class AggregatedPolicyCompliancesRequestBuilder(BaseRequestBuilder):
    ...
    def by_aggregated_policy_compliance_id(self,aggregated_policy_compliance_id: str) -> AggregatedPolicyComplianceItemRequestBuilder:
        """
        Provides operations to manage the aggregatedPolicyCompliances property of the microsoft.graph.managedTenants.managedTenant entity.
        param aggregated_policy_compliance_id: The unique identifier of aggregatedPolicyCompliance
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AggregatedPolicyCompliancesRequestBuilderGetQueryParameters]] = None) -> Optional[AggregatedPolicyComplianceCollectionResponse]:
        """
    ...
    async def post(self,body: AggregatedPolicyCompliance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AggregatedPolicyCompliance]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AggregatedPolicyCompliancesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the aggregatedPolicyCompliance objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/tenantRelationships/managedTenants/aggregatedPolicyCompliances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: AggregatedPolicyCompliance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to aggregatedPolicyCompliances for tenantRelationships
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/tenantRelationships/managedTenants/aggregatedPolicyCompliances', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> AggregatedPolicyCompliancesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AggregatedPolicyCompliancesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return AggregatedPolicyCompliancesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class AggregatedPolicyCompliancesRequestBuilderGetRequestConfiguration(RequestConfiguration[AggregatedPolicyCompliancesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AggregatedPolicyCompliancesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
