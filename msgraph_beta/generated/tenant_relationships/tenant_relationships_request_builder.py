...
if TYPE_CHECKING:
    ...
    from .managed_tenants.managed_tenants_request_builder import ManagedTenantsRequestBuilder
...
class TenantRelationshipsRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def managed_tenants(self) -> ManagedTenantsRequestBuilder:
        """
        Provides operations to manage the managedTenants property of the microsoft.graph.tenantRelationship entity.
        """
        from .managed_tenants.managed_tenants_request_builder import ManagedTenantsRequestBuilder

        return ManagedTenantsRequestBuilder(self.request_adapter, self.path_parameters)
