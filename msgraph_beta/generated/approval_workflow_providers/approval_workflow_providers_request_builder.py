...
class ApprovalWorkflowProvidersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/approvalWorkflowProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ApprovalWorkflowProvidersRequestBuilderGetRequestConfiguration] = None) -> Optional[ApprovalWorkflowProviderCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ApprovalWorkflowProvider] = None, request_configuration: Optional[ApprovalWorkflowProvidersRequestBuilderPostRequestConfiguration] = None) -> Optional[ApprovalWorkflowProvider]:
        """
    ...
    def to_post_request_information(self,body: Optional[ApprovalWorkflowProvider] = None, request_configuration: Optional[ApprovalWorkflowProvidersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to approvalWorkflowProviders
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ApprovalWorkflowProvidersRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ApprovalWorkflowProvidersRequestBuilder.ApprovalWorkflowProvidersRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ApprovalWorkflowProvidersRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
