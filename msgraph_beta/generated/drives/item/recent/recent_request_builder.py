...
class RecentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/recent(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RecentRequestBuilderGetQueryParameters]] = None) -> Optional[RecentGetResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/drive-recent?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: str) -> RecentRequestBuilder:
        """
    ...
    @dataclass
    class RecentRequestBuilderGetRequestConfiguration(RequestConfiguration[RecentRequestBuilderGetQueryParameters]):
        """
