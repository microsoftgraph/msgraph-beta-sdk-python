...
if TYPE_CHECKING:
    ...
    from .apply_custom_filter_post_request_body import ApplyCustomFilterPostRequestBody

class ApplyCustomFilterRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ApplyCustomFilterRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ApplyCustomFilterRequestBuilder
        """
        if not raw_url:
