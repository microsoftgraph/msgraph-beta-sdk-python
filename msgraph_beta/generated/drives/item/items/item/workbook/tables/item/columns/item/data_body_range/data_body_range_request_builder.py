...
class DataBodyRangeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DataBodyRangeRequestBuilder:
        """
    ...
    @dataclass
    class DataBodyRangeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
