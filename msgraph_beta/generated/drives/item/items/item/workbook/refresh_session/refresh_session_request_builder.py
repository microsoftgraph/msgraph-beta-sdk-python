...
class RefreshSessionRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RefreshSessionRequestBuilder:
        """
    ...
    @dataclass
    class RefreshSessionRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
