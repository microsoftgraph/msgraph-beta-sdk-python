...
if TYPE_CHECKING:
    ...
    from .add_formula_local_post_request_body import AddFormulaLocalPostRequestBody

class AddFormulaLocalRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/addFormulaLocal", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AddFormulaLocalRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AddFormulaLocalRequestBuilder
        """
        if not raw_url:
