...
class FormatRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookChartDataLabelFormat]:
        """
    ...
    async def patch(self,body: Optional[WorkbookChartDataLabelFormat] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookChartDataLabelFormat]:
        """
    ...
    def to_patch_request_information(self,body: Optional[WorkbookChartDataLabelFormat] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property format in drives
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
