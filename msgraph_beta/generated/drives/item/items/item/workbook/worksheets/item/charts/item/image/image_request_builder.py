...
class ImageRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ImageGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ImageRequestBuilder:
        ...
        Returns: ImageRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ImageRequestBuilder(self.request_adapter, raw_url)
