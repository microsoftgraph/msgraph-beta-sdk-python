...
class TasksRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[WorkbookDocumentTask] = None, request_configuration: Optional[TasksRequestBuilderPostRequestConfiguration] = None) -> Optional[WorkbookDocumentTask]:
        """
    ...
    def to_post_request_information(self,body: Optional[WorkbookDocumentTask] = None, request_configuration: Optional[TasksRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to tasks for drives
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
