...
class TotalRowRangeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> TotalRowRangeRequestBuilder:
        """
    ...
    @dataclass
    class TotalRowRangeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
