...
class HeaderRowRangeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> HeaderRowRangeRequestBuilder:
        """
    ...
    @dataclass
    class HeaderRowRangeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
