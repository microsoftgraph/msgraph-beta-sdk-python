...
class Norm_InvRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[Norm_InvPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookFunctionResult]:
        """
    ...
    def to_post_request_information(self,body: Optional[Norm_InvPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action norm_Inv
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> Norm_InvRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: Norm_InvRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return Norm_InvRequestBuilder(self.request_adapter, raw_url)
