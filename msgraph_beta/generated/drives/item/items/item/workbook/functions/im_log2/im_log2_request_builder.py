...
class ImLog2RequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ImLog2PostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookFunctionResult]:
        """
    ...
    def to_post_request_information(self,body: Optional[ImLog2PostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action imLog2
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ImLog2RequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ImLog2RequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ImLog2RequestBuilder(self.request_adapter, raw_url)
