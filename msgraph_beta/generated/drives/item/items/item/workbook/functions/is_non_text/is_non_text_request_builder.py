...
class IsNonTextRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[IsNonTextPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookFunctionResult]:
        """
    ...
    def to_post_request_information(self,body: Optional[IsNonTextPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action isNonText
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
