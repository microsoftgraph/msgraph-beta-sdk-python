...
class RowsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RowsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookFunctionResult]:
        """
        Invoke action rows
    ...
    def to_post_request_information(self,body: Optional[RowsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action rows
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
