...
class CodeRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[CodePostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkbookFunctionResult]:
        """
        Invoke action code
    ...
    def to_post_request_information(self,body: Optional[CodePostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action code
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> CodeRequestBuilder:
        """
