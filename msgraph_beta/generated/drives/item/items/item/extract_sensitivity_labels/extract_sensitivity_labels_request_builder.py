...
class ExtractSensitivityLabelsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ExtractSensitivityLabelsResult]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ExtractSensitivityLabelsRequestBuilder:
        """
