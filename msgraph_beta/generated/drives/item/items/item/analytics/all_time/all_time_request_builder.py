...
class AllTimeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AllTimeRequestBuilder:
        """
    ...
    @dataclass
    class AllTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[AllTimeRequestBuilderGetQueryParameters]):
        """
