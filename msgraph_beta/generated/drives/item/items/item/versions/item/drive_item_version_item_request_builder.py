...
class DriveItemVersionItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[DriveItemVersion] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DriveItemVersion]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DriveItemVersion] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property versions in drives
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DriveItemVersionItemRequestBuilder:
        """
