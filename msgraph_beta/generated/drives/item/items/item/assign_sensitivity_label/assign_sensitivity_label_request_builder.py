...
class AssignSensitivityLabelRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AssignSensitivityLabelRequestBuilder:
        """
    ...
    @dataclass
    class AssignSensitivityLabelRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
