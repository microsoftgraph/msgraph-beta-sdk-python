...
class DirectoryRoleTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DirectoryRoleTemplate]:
        """
    ...
    async def patch(self,body: Optional[DirectoryRoleTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DirectoryRoleTemplate]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DirectoryRoleTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update entity in directoryRoleTemplates
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
