...
class PrivilegedRolesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/privilegedRoles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PrivilegedRolesRequestBuilderGetRequestConfiguration] = None) -> Optional[PrivilegedRoleCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegedRole] = None, request_configuration: Optional[PrivilegedRolesRequestBuilderPostRequestConfiguration] = None) -> Optional[PrivilegedRole]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrivilegedRole] = None, request_configuration: Optional[PrivilegedRolesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to privilegedRoles
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PrivilegedRolesRequestBuilder:
        """
    ...
    @dataclass
    class PrivilegedRolesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[PrivilegedRolesRequestBuilder.PrivilegedRolesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class PrivilegedRolesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
