...
class DetailsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PlannerPlanDetails]:
        """
    ...
    async def patch(self,body: Optional[PlannerPlanDetails] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PlannerPlanDetails]:
        """
    ...
    def to_patch_request_information(self,body: Optional[PlannerPlanDetails] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property details in groups
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
