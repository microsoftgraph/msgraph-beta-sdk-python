...
class EndpointsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[EndpointCollectionResponse]:
        """
        Retrieve a list of endpoint objects.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[EndpointCollectionResponse]
        Find more info here: https://learn.microsoft.com/graph/api/group-list-endpoints?view=graph-rest-1.0
        """
    ...
    async def post(self,body: Optional[Endpoint] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Endpoint]:
        """
    ...
    def to_post_request_information(self,body: Optional[Endpoint] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to endpoints for groups
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
