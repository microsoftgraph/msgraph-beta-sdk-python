...
class ProfilePhotoItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/photos/{profilePhoto%2Did}{?%24select}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ProfilePhotoItemRequestBuilder:
        """
