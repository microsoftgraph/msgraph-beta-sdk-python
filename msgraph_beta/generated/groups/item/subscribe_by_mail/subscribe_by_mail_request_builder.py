...
class SubscribeByMailRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/subscribeByMail", path_parameters)
    ...
    async def post(self,request_configuration: Optional[SubscribeByMailRequestBuilderPostRequestConfiguration] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/group-subscribebymail?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SubscribeByMailRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SubscribeByMailRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return SubscribeByMailRequestBuilder(self.request_adapter, raw_url)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class SubscribeByMailRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
