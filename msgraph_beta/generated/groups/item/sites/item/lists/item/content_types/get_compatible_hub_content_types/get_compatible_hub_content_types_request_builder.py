...
class GetCompatibleHubContentTypesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/getCompatibleHubContentTypes(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetCompatibleHubContentTypesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetCompatibleHubContentTypesRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class GetCompatibleHubContentTypesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetCompatibleHubContentTypesRequestBuilderGetQueryParameters]):
        """
