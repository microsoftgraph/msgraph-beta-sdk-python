...
class LastModifiedByUserRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> LastModifiedByUserRequestBuilder:
        """
    ...
    @dataclass
    class LastModifiedByUserRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[LastModifiedByUserRequestBuilder.LastModifiedByUserRequestBuilderGetQueryParameters] = None
