...
class ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e(BaseRequestBuilder):
    """
    Provides operations to call the computeInheritance method. Original name: ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], content_formats: Optional[str] = None, label_ids: Optional[str] = None, locale: Optional[str] = None) -> None:
        """
        Instantiates a new ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e and sets the default values.
        ...
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/computeInheritance(labelIds={labelIds},locale='{locale}',contentFormats={contentFormats})", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e:
        """
        ...
        return ComputeInheritanceWithLabelIdsWithLocaleWithContentForm_9657694e(self.request_adapter, raw_url)
