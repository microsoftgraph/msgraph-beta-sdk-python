...
class AssignLicenseRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[AssignLicensePostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Group]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AssignLicenseRequestBuilder:
        """
