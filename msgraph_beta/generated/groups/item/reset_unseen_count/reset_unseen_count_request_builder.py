...
class ResetUnseenCountRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/resetUnseenCount", path_parameters)
    ...
    async def post(self,request_configuration: Optional[ResetUnseenCountRequestBuilderPostRequestConfiguration] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/group-resetunseencount?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ResetUnseenCountRequestBuilder:
        ...
        Returns: ResetUnseenCountRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ResetUnseenCountRequestBuilder(self.request_adapter, raw_url)
    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ResetUnseenCountRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
