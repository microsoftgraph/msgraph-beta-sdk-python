...
@dataclass
class GetPasswordSingleSignOnCredentialsPostResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[PasswordSingleSignOnCredentialSet]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetPasswordSingleSignOnCredentialsPostResponse:
        """
