...
class GoalsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Goals]:
        """
    ...
    async def patch(self,body: Optional[Goals] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Goals]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Goals] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property goals in employeeExperience
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
