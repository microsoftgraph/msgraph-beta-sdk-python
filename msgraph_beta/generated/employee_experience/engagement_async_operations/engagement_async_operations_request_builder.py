...
class EngagementAsyncOperationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/employeeExperience/engagementAsyncOperations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[EngagementAsyncOperationsRequestBuilderGetQueryParameters]] = None) -> Optional[EngagementAsyncOperationCollectionResponse]:
        """
    ...
    async def post(self,body: EngagementAsyncOperation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EngagementAsyncOperation]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[EngagementAsyncOperationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get an engagementAsyncOperation to track a long-running operation request.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: EngagementAsyncOperation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to engagementAsyncOperations for employeeExperience
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> EngagementAsyncOperationsRequestBuilder:
        """
    ...
    @dataclass
    class EngagementAsyncOperationsRequestBuilderGetRequestConfiguration(RequestConfiguration[EngagementAsyncOperationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class EngagementAsyncOperationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
