...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[MessageEventCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[MessageEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[MessageEvent]:
        """
    ...
    def to_post_request_information(self,body: Optional[MessageEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to events for messageTraces
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
