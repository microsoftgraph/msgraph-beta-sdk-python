...
class PlannerRosterItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[PlannerRoster] = None, request_configuration: Optional[PlannerRosterItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[PlannerRoster]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[PlannerRosterItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/planner/rosters/{plannerRoster%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[PlannerRoster] = None, request_configuration: Optional[PlannerRosterItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property rosters in planner
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/planner/rosters/{plannerRoster%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> PlannerRosterItemRequestBuilder:
        """
    ...
    @dataclass
    class PlannerRosterItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PlannerRosterItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class PlannerRosterItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
