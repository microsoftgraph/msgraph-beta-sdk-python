...
class PlannerRosterItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PlannerRoster]:
        """
    ...
    async def patch(self,body: Optional[PlannerRoster] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PlannerRoster]:
        """
    ...
    def to_patch_request_information(self,body: Optional[PlannerRoster] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property rosters in planner
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
