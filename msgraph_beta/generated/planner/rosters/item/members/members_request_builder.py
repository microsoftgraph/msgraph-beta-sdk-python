...
if TYPE_CHECKING:
    ...
    from .....models.planner_roster_member_collection_response import PlannerRosterMemberCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.planner_roster_member_item_request_builder import PlannerRosterMemberItemRequestBuilder
...
class MembersRequestBuilder(BaseRequestBuilder):
    ...
    def by_planner_roster_member_id(self,planner_roster_member_id: str) -> PlannerRosterMemberItemRequestBuilder:
        """
        Provides operations to manage the members property of the microsoft.graph.plannerRoster entity.
        param planner_roster_member_id: The unique identifier of plannerRosterMember
        Returns: PlannerRosterMemberItemRequestBuilder
        """
        if planner_roster_member_id is None:
            raise TypeError("planner_roster_member_id cannot be null.")
        from .item.planner_roster_member_item_request_builder import PlannerRosterMemberItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["plannerRosterMember%2Did"] = planner_roster_member_id
        return PlannerRosterMemberItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[MembersRequestBuilderGetQueryParameters]] = None) -> Optional[PlannerRosterMemberCollectionResponse]:
        """
    ...
    async def post(self,body: PlannerRosterMember, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PlannerRosterMember]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MembersRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/planner/rosters/{plannerRoster%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: PlannerRosterMember, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Add a member to the plannerRoster object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/planner/rosters/{plannerRoster%2Did}/members', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
