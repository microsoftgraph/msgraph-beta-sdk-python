...
class GovernanceRoleAssignmentRequestsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GovernanceRoleAssignmentRequestsRequestBuilderGetQueryParameters]] = None) -> Optional[GovernanceRoleAssignmentRequestCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GovernanceRoleAssignmentRequestsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get entities from governanceRoleAssignmentRequests
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/governanceRoleAssignmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: GovernanceRoleAssignmentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/governanceRoleAssignmentRequests', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> GovernanceRoleAssignmentRequestsRequestBuilder:
        """
    ...
    @dataclass
    class GovernanceRoleAssignmentRequestsRequestBuilderGetRequestConfiguration(RequestConfiguration[GovernanceRoleAssignmentRequestsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GovernanceRoleAssignmentRequestsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
