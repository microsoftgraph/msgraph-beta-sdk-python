...
class ConfirmCompromisedRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityProtection/riskyAgents/confirmCompromised", path_parameters)
    ...
    async def post(self,body: ConfirmCompromisedPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        """
        Confirm one or more riskyAgent objects as compromised. This action sets the targeted agent's riskLevel to high.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/riskyagent-confirmcompromised?view=graph-rest-beta
        """
        if body is None:
