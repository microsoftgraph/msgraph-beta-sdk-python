...
class ConfirmSafeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityProtection/riskyAgents/confirmSafe", path_parameters)
    ...
    async def post(self,body: ConfirmSafePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/riskyagent-confirmsafe?view=graph-rest-beta
        """
        if body is None:
