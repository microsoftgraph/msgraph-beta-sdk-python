...
if TYPE_CHECKING:
    ...
    from .connector_group.connector_group_request_builder import ConnectorGroupRequestBuilder
...
class ApplicationItemRequestBuilder(BaseRequestBuilder):
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/applications/{application%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[Application] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/applications/{application%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def connector_group(self) -> ConnectorGroupRequestBuilder:
        """
        Provides operations to manage the connectorGroup property of the microsoft.graph.application entity.
        """
        from .connector_group.connector_group_request_builder import ConnectorGroupRequestBuilder

        return ConnectorGroupRequestBuilder(self.request_adapter, self.path_parameters)
