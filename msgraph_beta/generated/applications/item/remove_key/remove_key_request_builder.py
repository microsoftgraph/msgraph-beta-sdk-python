...
class RemoveKeyRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: RemoveKeyPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/agentidentityblueprint-removekey?view=graph-rest-beta
        """
        if body is None:
    ...
    def with_url(self,raw_url: str) -> RemoveKeyRequestBuilder:
        """
    ...
    @dataclass
    class RemoveKeyRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
