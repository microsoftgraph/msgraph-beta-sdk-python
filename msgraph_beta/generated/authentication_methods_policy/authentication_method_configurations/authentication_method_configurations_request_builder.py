...
class AuthenticationMethodConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_authentication_method_configuration_id(self,authentication_method_configuration_id: str) -> AuthenticationMethodConfigurationItemRequestBuilder:
        """
        Provides operations to manage the authenticationMethodConfigurations property of the microsoft.graph.authenticationMethodsPolicy entity.
        param authentication_method_configuration_id: The unique identifier of authenticationMethodConfiguration
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthenticationMethodConfigurationCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AuthenticationMethodConfiguration] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthenticationMethodConfiguration]:
        """
    ...
    def to_post_request_information(self,body: Optional[AuthenticationMethodConfiguration] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to authenticationMethodConfigurations for authenticationMethodsPolicy
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AuthenticationMethodConfigurationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AuthenticationMethodConfigurationsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return AuthenticationMethodConfigurationsRequestBuilder(self.request_adapter, raw_url)
