...
if TYPE_CHECKING:
    ...
    from .shifts_role_definitions.shifts_role_definitions_request_builder import ShiftsRoleDefinitionsRequestBuilder
...
class ScheduleRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Schedule]:
        """
    ...
    async def put(self,body: Optional[Schedule] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Schedule]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule', self.path_parameters)
    ...
    def to_put_request_information(self,body: Optional[Schedule] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property schedule in teamwork
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PUT, '{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> ScheduleRequestBuilder:
        """
    ...
    @property
    def shifts_role_definitions(self) -> ShiftsRoleDefinitionsRequestBuilder:
        """
        Provides operations to manage the shiftsRoleDefinitions property of the microsoft.graph.schedule entity.
        """
        from .shifts_role_definitions.shifts_role_definitions_request_builder import ShiftsRoleDefinitionsRequestBuilder

        return ShiftsRoleDefinitionsRequestBuilder(self.request_adapter, self.path_parameters)
