...
class EndBreakRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: EndBreakPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimeCard]:
        """
    ...
    def to_post_request_information(self,body: EndBreakPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        End the open break in a specific timeCard.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> EndBreakRequestBuilder:
        """
    ...
    @dataclass
    class EndBreakRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
