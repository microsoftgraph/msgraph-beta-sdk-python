...
class FilesFolderRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/filesFolder{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[FilesFolderRequestBuilderGetQueryParameters]] = None) -> Optional[DriveItem]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[FilesFolderRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Metadata for the location where the channel's files are stored.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> FilesFolderRequestBuilder:
        """
    ...
    @dataclass
    class FilesFolderRequestBuilderGetRequestConfiguration(RequestConfiguration[FilesFolderRequestBuilderGetQueryParameters]):
        """
