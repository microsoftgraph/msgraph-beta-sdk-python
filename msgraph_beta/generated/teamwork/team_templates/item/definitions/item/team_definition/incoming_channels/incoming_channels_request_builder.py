...
class IncomingChannelsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/incomingChannels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[IncomingChannelsRequestBuilderGetQueryParameters]] = None) -> Optional[ChannelCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IncomingChannelsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        List of channels shared with the team.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IncomingChannelsRequestBuilder:
        """
    ...
    @dataclass
    class IncomingChannelsRequestBuilderGetRequestConfiguration(RequestConfiguration[IncomingChannelsRequestBuilderGetQueryParameters]):
        """
