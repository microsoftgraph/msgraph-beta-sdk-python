...
class SchedulingGroupsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SchedulingGroupCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[SchedulingGroup] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[SchedulingGroup]:
        """
    ...
    def to_post_request_information(self,body: Optional[SchedulingGroup] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new schedulingGroup.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
