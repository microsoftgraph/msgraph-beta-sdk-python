...
@dataclass
class StartBreakPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    at_approved_location: Optional[bool] = False
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StartBreakPostRequestBody:
        """
