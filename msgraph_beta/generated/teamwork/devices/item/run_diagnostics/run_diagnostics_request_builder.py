...
class RunDiagnosticsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RunDiagnosticsRequestBuilder:
        """
    ...
    @dataclass
    class RunDiagnosticsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
