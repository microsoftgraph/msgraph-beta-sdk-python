...
if TYPE_CHECKING:
    ...
    from ...models.teamwork_device_collection_response import TeamworkDeviceCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.teamwork_device_item_request_builder import TeamworkDeviceItemRequestBuilder
...
class DevicesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamwork/devices{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_teamwork_device_id(self,teamwork_device_id: str) -> TeamworkDeviceItemRequestBuilder:
        """
        Provides operations to manage the devices property of the microsoft.graph.teamwork entity.
        param teamwork_device_id: The unique identifier of teamworkDevice
        Returns: TeamworkDeviceItemRequestBuilder
        """
        if not teamwork_device_id:
            raise TypeError("teamwork_device_id cannot be null.")
        from .item.teamwork_device_item_request_builder import TeamworkDeviceItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["teamworkDevice%2Did"] = teamwork_device_id
        return TeamworkDeviceItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[DevicesRequestBuilderGetRequestConfiguration] = None) -> Optional[TeamworkDeviceCollectionResponse]:
        """
        Get a list of all Microsoft Teams-enabled devices provisioned for a tenant.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TeamworkDeviceCollectionResponse]
    ...
    async def post(self,body: Optional[TeamworkDevice] = None, request_configuration: Optional[DevicesRequestBuilderPostRequestConfiguration] = None) -> Optional[TeamworkDevice]:
        """
    ...
    def to_post_request_information(self,body: Optional[TeamworkDevice] = None, request_configuration: Optional[DevicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to devices for teamwork
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/teamwork/devices', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
