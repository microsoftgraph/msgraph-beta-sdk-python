...
class CustomEmojisRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CustomEmojisRequestBuilderGetQueryParameters]] = None) -> Optional[TeamworkCustomEmojiCollectionResponse]:
        ...
        Returns: Optional[TeamworkCustomEmojiCollectionResponse]
        Find more info here: https://learn.microsoft.com/graph/api/teamworkmessaging-list-customemojis?view=graph-rest-beta
        """
        ...
        return await self.request_adapter.send_async(request_info, TeamworkCustomEmojiCollectionResponse, error_mapping)
    
    async def post(self,body: TeamworkCustomEmoji, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TeamworkCustomEmoji]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TeamworkCustomEmoji]
        Find more info here: https://learn.microsoft.com/graph/api/teamworkmessaging-post-customemojis?view=graph-rest-beta
        """
        if body is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CustomEmojisRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of custom emojis available in the teamwork messaging of the organization.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: TeamworkCustomEmoji, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new custom emoji in the teamwork messaging of the organization, which adds the custom emoji to Teams for the tenant. The emoji image is provided as base64-encoded content bytes.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> CustomEmojisRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CustomEmojisRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CustomEmojisRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class CustomEmojisRequestBuilderGetRequestConfiguration(RequestConfiguration[CustomEmojisRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class CustomEmojisRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
