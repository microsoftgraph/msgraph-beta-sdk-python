...
class TeamworkCustomEmojiDisplayNameItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: TeamworkCustomEmoji, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TeamworkCustomEmoji]:
        """
    ...
    def to_patch_request_information(self,body: TeamworkCustomEmoji, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property customEmojis in teamwork
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
