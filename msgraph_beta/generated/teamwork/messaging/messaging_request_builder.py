...
class MessagingRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MessagingRequestBuilderGetQueryParameters]] = None) -> Optional[TeamworkMessaging]:
        ...
        return await self.request_adapter.send_async(request_info, TeamworkMessaging, error_mapping)
    
    async def patch(self,body: TeamworkMessaging, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TeamworkMessaging]:
        """
    ...
    def to_patch_request_information(self,body: TeamworkMessaging, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property messaging in teamwork
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MessagingRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MessagingRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MessagingRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def custom_emojis(self) -> CustomEmojisRequestBuilder:
        """
        Provides operations to manage the customEmojis property of the microsoft.graph.teamworkMessaging entity.
        """
        from .custom_emojis.custom_emojis_request_builder import CustomEmojisRequestBuilder

        return CustomEmojisRequestBuilder(self.request_adapter, self.path_parameters)
    
    @dataclass
    class MessagingRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class MessagingRequestBuilderGetRequestConfiguration(RequestConfiguration[MessagingRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class MessagingRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
