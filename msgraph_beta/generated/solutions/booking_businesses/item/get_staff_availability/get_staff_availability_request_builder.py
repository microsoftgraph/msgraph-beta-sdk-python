...
class GetStaffAvailabilityRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetStaffAvailabilityRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetStaffAvailabilityRequestBuilder
        """
        warn(" as of 2023-03/PrivatePreview:responderForm on 2025-06-17 and will be removed 2025-12-17", DeprecationWarning)
        if raw_url is None:
    ...
    @dataclass
    class GetStaffAvailabilityRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
