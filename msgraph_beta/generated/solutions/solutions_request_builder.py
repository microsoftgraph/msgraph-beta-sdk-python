...
class SolutionsRequestBuilder(BaseRequestBuilder):
    ...
    def business_scenarios_with_unique_name(self,unique_name: str) -> BusinessScenariosWithUniqueNameRequestBuilder:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SolutionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/solutions{?%24expand,%24select}', self.path_parameters)
