...
if TYPE_CHECKING:
    ...
    from .validate_post_request_body import ValidatePostRequestBody
...
class ValidateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/migrations/crossTenantMigrationJobs/validate", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ValidateRequestBuilder:
        """
        ...
        return ValidateRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ValidateRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
