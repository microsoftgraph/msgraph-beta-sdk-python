...
class ExchangeRestoreSessionItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ExchangeRestoreSessionItemRequestBuilderGetQueryParameters]] = None) -> Optional[ExchangeRestoreSession]:
        """
    ...
    async def patch(self,body: ExchangeRestoreSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ExchangeRestoreSession]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ExchangeRestoreSessionItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The list of Exchange restore sessions available in the tenant.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: ExchangeRestoreSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the properties of an exchangeRestoreSession.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ExchangeRestoreSessionItemRequestBuilder:
        """
        ...
        return ExchangeRestoreSessionItemRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def granular_mailbox_restore_artifacts(self) -> GranularMailboxRestoreArtifactsRequestBuilder:
        """
        ...
        return GranularMailboxRestoreArtifactsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def mailbox_restore_artifacts(self) -> MailboxRestoreArtifactsRequestBuilder:
        """
    ...
    @dataclass
    class ExchangeRestoreSessionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[ExchangeRestoreSessionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class ExchangeRestoreSessionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
