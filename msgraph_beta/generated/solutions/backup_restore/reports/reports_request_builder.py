...
if TYPE_CHECKING:
    from ....models.backup_report import BackupReport
...
class ReportsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/reports", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ReportsRequestBuilderGetQueryParameters]] = None) -> Optional[BackupReport]:
        ...
        return await self.request_adapter.send_async(request_info, BackupReport, error_mapping)
    
    def get_statistics_by_policy_with_policy_id(self,policy_id: str) -> GetStatisticsByPolicyWithPolicyIdRequestBuilder:
        """
        ...
        return GetStatisticsByPolicyWithPolicyIdRequestBuilder(self.request_adapter, self.path_parameters, policy_id)
    
    async def patch(self,body: BackupReport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BackupReport]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ReportsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/solutions/backupRestore/reports{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: BackupReport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property reports in solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
