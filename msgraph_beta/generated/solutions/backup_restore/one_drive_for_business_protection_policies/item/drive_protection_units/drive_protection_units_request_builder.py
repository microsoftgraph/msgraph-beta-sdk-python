...
class DriveProtectionUnitsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicy%2Did}/driveProtectionUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_drive_protection_unit_id(self,drive_protection_unit_id: str) -> DriveProtectionUnitItemRequestBuilder:
        """
        Provides operations to manage the driveProtectionUnits property of the microsoft.graph.oneDriveForBusinessProtectionPolicy entity.
        ...
        url_tpl_params["driveProtectionUnit%2Did"] = drive_protection_unit_id
        return DriveProtectionUnitItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    def with_url(self,raw_url: str) -> DriveProtectionUnitsRequestBuilder:
        """
    ...
    @dataclass
    class DriveProtectionUnitsRequestBuilderGetRequestConfiguration(RequestConfiguration[DriveProtectionUnitsRequestBuilderGetQueryParameters]):
        """
