...
class DriveExclusionUnitItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicy%2Did}/driveExclusionUnits/{driveExclusionUnit%2Did}{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> DriveExclusionUnitItemRequestBuilder:
        """
        ...
        return DriveExclusionUnitItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class DriveExclusionUnitItemRequestBuilderGetRequestConfiguration(RequestConfiguration[DriveExclusionUnitItemRequestBuilderGetQueryParameters]):
        """
