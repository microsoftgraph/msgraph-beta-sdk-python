...
class DeactivateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/serviceApps/{serviceApp%2Did}/deactivate", path_parameters)
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ServiceApp]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/serviceapp-deactivate?view=graph-rest-beta
        """
