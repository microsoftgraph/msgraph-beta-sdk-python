...
class SiteProtectionUnitsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/siteProtectionUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_site_protection_unit_id(self,site_protection_unit_id: str) -> SiteProtectionUnitItemRequestBuilder:
        """
        Provides operations to manage the siteProtectionUnits property of the microsoft.graph.backupRestoreRoot entity.
        ...
        url_tpl_params["siteProtectionUnit%2Did"] = site_protection_unit_id
        return SiteProtectionUnitItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: SiteProtectionUnit, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SiteProtectionUnit]:
        """
    ...
    def to_post_request_information(self,body: SiteProtectionUnit, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to siteProtectionUnits for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SiteProtectionUnitsRequestBuilder:
        """
    ...
    @dataclass
    class SiteProtectionUnitsRequestBuilderGetRequestConfiguration(RequestConfiguration[SiteProtectionUnitsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class SiteProtectionUnitsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
