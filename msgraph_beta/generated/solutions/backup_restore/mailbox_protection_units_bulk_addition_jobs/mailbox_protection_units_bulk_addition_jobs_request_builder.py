...
if TYPE_CHECKING:
    ...
    from ....models.mailbox_protection_units_bulk_addition_job_collection_response import MailboxProtectionUnitsBulkAdditionJobCollectionResponse
...
class MailboxProtectionUnitsBulkAdditionJobsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/mailboxProtectionUnitsBulkAdditionJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_mailbox_protection_units_bulk_addition_job_id(self,mailbox_protection_units_bulk_addition_job_id: str) -> MailboxProtectionUnitsBulkAdditionJobItemRequestBuilder:
        """
        Provides operations to manage the mailboxProtectionUnitsBulkAdditionJobs property of the microsoft.graph.backupRestoreRoot entity.
        ...
        url_tpl_params["mailboxProtectionUnitsBulkAdditionJob%2Did"] = mailbox_protection_units_bulk_addition_job_id
        return MailboxProtectionUnitsBulkAdditionJobItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MailboxProtectionUnitsBulkAdditionJobsRequestBuilderGetQueryParameters]] = None) -> Optional[MailboxProtectionUnitsBulkAdditionJobCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, MailboxProtectionUnitsBulkAdditionJobCollectionResponse, error_mapping)
    
    async def post(self,body: MailboxProtectionUnitsBulkAdditionJob, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MailboxProtectionUnitsBulkAdditionJob]:
        """
    ...
    def to_post_request_information(self,body: MailboxProtectionUnitsBulkAdditionJob, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to mailboxProtectionUnitsBulkAdditionJobs for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MailboxProtectionUnitsBulkAdditionJobsRequestBuilder:
        """
    ...
    @dataclass
    class MailboxProtectionUnitsBulkAdditionJobsRequestBuilderGetRequestConfiguration(RequestConfiguration[MailboxProtectionUnitsBulkAdditionJobsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class MailboxProtectionUnitsBulkAdditionJobsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
