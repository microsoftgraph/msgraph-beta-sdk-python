...
class ProtectionUnitRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/restorePoints/{restorePoint%2Did}/protectionUnit{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ProtectionUnitRequestBuilder:
        """
    ...
    @dataclass
    class ProtectionUnitRequestBuilderGetRequestConfiguration(RequestConfiguration[ProtectionUnitRequestBuilderGetQueryParameters]):
        """
