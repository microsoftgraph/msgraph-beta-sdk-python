...
if TYPE_CHECKING:
    ...
    from ......models.site_exclusion_units_bulk_addition_job_collection_response import SiteExclusionUnitsBulkAdditionJobCollectionResponse
...
class SiteExclusionUnitsBulkAdditionJobsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy%2Did}/siteExclusionUnitsBulkAdditionJobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_site_exclusion_units_bulk_addition_job_id(self,site_exclusion_units_bulk_addition_job_id: str) -> SiteExclusionUnitsBulkAdditionJobItemRequestBuilder:
        """
        Provides operations to manage the siteExclusionUnitsBulkAdditionJobs property of the microsoft.graph.sharePointProtectionPolicy entity.
        ...
        url_tpl_params["siteExclusionUnitsBulkAdditionJob%2Did"] = site_exclusion_units_bulk_addition_job_id
        return SiteExclusionUnitsBulkAdditionJobItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SiteExclusionUnitsBulkAdditionJobsRequestBuilderGetQueryParameters]] = None) -> Optional[SiteExclusionUnitsBulkAdditionJobCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SiteExclusionUnitsBulkAdditionJobCollectionResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> SiteExclusionUnitsBulkAdditionJobsRequestBuilder:
        """
    ...
    @dataclass
    class SiteExclusionUnitsBulkAdditionJobsRequestBuilderGetRequestConfiguration(RequestConfiguration[SiteExclusionUnitsBulkAdditionJobsRequestBuilderGetQueryParameters]):
        """
