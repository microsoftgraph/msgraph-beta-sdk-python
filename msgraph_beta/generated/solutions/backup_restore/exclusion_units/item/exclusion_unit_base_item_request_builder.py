...
if TYPE_CHECKING:
    from .....models.exclusion_unit_base import ExclusionUnitBase
    from .....models.o_data_errors.o_data_error import ODataError

class ExclusionUnitBaseItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/exclusionUnits/{exclusionUnitBase%2Did}{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ExclusionUnitBaseItemRequestBuilderGetQueryParameters]] = None) -> Optional[ExclusionUnitBase]:
        ...
        return await self.request_adapter.send_async(request_info, ExclusionUnitBase, error_mapping)
    ...
    def with_url(self,raw_url: str) -> ExclusionUnitBaseItemRequestBuilder:
        """
        ...
        return ExclusionUnitBaseItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ExclusionUnitBaseItemRequestBuilderGetRequestConfiguration(RequestConfiguration[ExclusionUnitBaseItemRequestBuilderGetQueryParameters]):
        """
