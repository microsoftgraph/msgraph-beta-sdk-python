...
class ProtectionUnitsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/protectionUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_protection_unit_base_id(self,protection_unit_base_id: str) -> ProtectionUnitBaseItemRequestBuilder:
        """
        Provides operations to manage the protectionUnits property of the microsoft.graph.backupRestoreRoot entity.
        ...
        url_tpl_params["protectionUnitBase%2Did"] = protection_unit_base_id
        return ProtectionUnitBaseItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ProtectionUnitsRequestBuilderGetQueryParameters]] = None) -> Optional[ProtectionUnitBaseCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ProtectionUnitsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of a protectionUnitBase object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ProtectionUnitsRequestBuilder:
        """
    ...
    @dataclass
    class ProtectionUnitsRequestBuilderGetRequestConfiguration(RequestConfiguration[ProtectionUnitsRequestBuilderGetQueryParameters]):
        """
