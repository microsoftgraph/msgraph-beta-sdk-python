...
if TYPE_CHECKING:
    from .....models.full_service_backup_disable_mode import FullServiceBackupDisableMode

@dataclass
class DisablePostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DisablePostRequestBody:
        """
