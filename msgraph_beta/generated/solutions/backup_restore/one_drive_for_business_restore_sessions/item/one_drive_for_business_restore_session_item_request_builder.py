...
class OneDriveForBusinessRestoreSessionItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[OneDriveForBusinessRestoreSessionItemRequestBuilderGetQueryParameters]] = None) -> Optional[OneDriveForBusinessRestoreSession]:
        """
    ...
    async def patch(self,body: OneDriveForBusinessRestoreSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OneDriveForBusinessRestoreSession]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[OneDriveForBusinessRestoreSessionItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The list of OneDrive for Business restore sessions available in the tenant.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions/{oneDriveForBusinessRestoreSession%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: OneDriveForBusinessRestoreSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the properties of a oneDriveForBusinessRestoreSession object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> OneDriveForBusinessRestoreSessionItemRequestBuilder:
        """
        ...
        return OneDriveForBusinessRestoreSessionItemRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def drive_restore_artifacts(self) -> DriveRestoreArtifactsRequestBuilder:
        """
    ...
    @dataclass
    class OneDriveForBusinessRestoreSessionItemRequestBuilderGetQueryParameters():
        """
        The list of OneDrive for Business restore sessions available in the tenant.
        """
    ...
    @dataclass
    class OneDriveForBusinessRestoreSessionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[OneDriveForBusinessRestoreSessionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class OneDriveForBusinessRestoreSessionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
