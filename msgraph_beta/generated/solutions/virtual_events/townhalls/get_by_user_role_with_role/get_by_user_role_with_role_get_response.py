...
@dataclass
class GetByUserRoleWithRoleGetResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[VirtualEventTownhall]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> GetByUserRoleWithRoleGetResponse:
        """
