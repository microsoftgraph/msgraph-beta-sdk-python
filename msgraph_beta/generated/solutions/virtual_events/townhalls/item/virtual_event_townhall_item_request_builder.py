...
class VirtualEventTownhallItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> VirtualEventTownhallItemRequestBuilder:
        """
    ...
    @dataclass
    class VirtualEventTownhallItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class VirtualEventTownhallItemRequestBuilderGetRequestConfiguration(RequestConfiguration[VirtualEventTownhallItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class VirtualEventTownhallItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
