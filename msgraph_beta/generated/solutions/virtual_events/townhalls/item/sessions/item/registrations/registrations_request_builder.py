...
if TYPE_CHECKING:
    ...
    from ........models.virtual_event_registration_collection_response import VirtualEventRegistrationCollectionResponse
...
class RegistrationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/registrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_virtual_event_registration_id(self,virtual_event_registration_id: str) -> VirtualEventRegistrationItemRequestBuilder:
        """
        Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.
    ...
    def with_url(self,raw_url: str) -> RegistrationsRequestBuilder:
        """
    ...
    @dataclass
    class RegistrationsRequestBuilderGetRequestConfiguration(RequestConfiguration[RegistrationsRequestBuilderGetQueryParameters]):
        """
