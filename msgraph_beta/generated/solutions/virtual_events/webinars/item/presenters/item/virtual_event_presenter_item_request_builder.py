...
class VirtualEventPresenterItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEventPresenter]:
        """
    ...
    async def patch(self,body: Optional[VirtualEventPresenter] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEventPresenter]:
        """
    ...
    def to_patch_request_information(self,body: Optional[VirtualEventPresenter] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property presenters in solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
