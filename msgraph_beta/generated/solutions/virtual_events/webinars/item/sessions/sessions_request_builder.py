...
if TYPE_CHECKING:
    ...
    from ......models.virtual_event_session_collection_response import VirtualEventSessionCollectionResponse
...
class SessionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_virtual_event_session_id(self,virtual_event_session_id: str) -> VirtualEventSessionItemRequestBuilder:
        ...
        return VirtualEventSessionItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: VirtualEventSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[VirtualEventSession]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SessionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: VirtualEventSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to sessions for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
