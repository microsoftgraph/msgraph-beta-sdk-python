...
class GetByUserRoleWithRoleRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetByUserRoleWithRoleRequestBuilderGetRequestConfiguration] = None) -> Optional[GetByUserRoleWithRoleGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GetByUserRoleWithRoleRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get a virtualEventWebinar collection where the signed-in user is either the organizer or a coorganizer.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetByUserRoleWithRoleRequestBuilder:
        """
    ...
    @dataclass
    class GetByUserRoleWithRoleRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GetByUserRoleWithRoleRequestBuilder.GetByUserRoleWithRoleRequestBuilderGetQueryParameters] = None
