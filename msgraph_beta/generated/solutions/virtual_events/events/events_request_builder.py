...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEventCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[VirtualEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[VirtualEvent]:
        """
    ...
    def to_post_request_information(self,body: Optional[VirtualEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to events for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
