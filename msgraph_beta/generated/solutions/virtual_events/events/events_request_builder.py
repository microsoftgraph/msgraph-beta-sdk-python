...
class EventsRequestBuilder(BaseRequestBuilder):
    ...
    def by_virtual_event_id(self,virtual_event_id: str) -> VirtualEventItemRequestBuilder:
        """
        Provides operations to manage the events property of the microsoft.graph.virtualEventsRoot entity.
        param virtual_event_id: The unique identifier of virtualEvent
        Returns: VirtualEventItemRequestBuilder
        """
        ...
        return VirtualEventItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[EventsRequestBuilderGetQueryParameters]] = None) -> Optional[VirtualEventCollectionResponse]:
        """
        Get events from solutions
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[VirtualEventCollectionResponse]
        """
        warn(" as of 2023-03/PrivatePreview:responderForm on 2025-06-17 and will be removed 2025-12-17", DeprecationWarning)
    ...
    async def post(self,body: VirtualEvent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[VirtualEvent]:
        """
        Create new navigation property to events for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[VirtualEvent]
        """
        warn(" as of 2023-03/PrivatePreview:responderForm on 2025-06-17 and will be removed 2025-12-17", DeprecationWarning)
        if body is None:
    ...
    def to_post_request_information(self,body: VirtualEvent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to events for solutions
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
