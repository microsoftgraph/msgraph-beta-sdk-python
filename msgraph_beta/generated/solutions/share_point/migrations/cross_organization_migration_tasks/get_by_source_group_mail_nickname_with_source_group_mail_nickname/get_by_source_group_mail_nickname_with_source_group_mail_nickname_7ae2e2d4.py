...
class GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], source_group_mail_nickname: Optional[str] = None) -> None:
        """
        Instantiates a new GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4:
        """
        ...
        return GetBySourceGroupMailNicknameWithSourceGroupMailNickname_7ae2e2d4(self.request_adapter, raw_url)
