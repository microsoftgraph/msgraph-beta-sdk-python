...
class GetBySourceUserPrincipalNameWithSourcePrincipalNameRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetBySourceUserPrincipalNameWithSourcePrincipalNameRequestBuilder:
        """
        ...
        return GetBySourceUserPrincipalNameWithSourcePrincipalNameRequestBuilder(self.request_adapter, raw_url)
