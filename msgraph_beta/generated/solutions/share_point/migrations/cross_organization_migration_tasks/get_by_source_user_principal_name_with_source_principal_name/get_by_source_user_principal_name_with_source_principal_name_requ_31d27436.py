...
class GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436(BaseRequestBuilder):
    """
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], source_principal_name: Optional[str] = None) -> None:
        """
        Instantiates a new GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436 and sets the default values.
        ...
        if isinstance(path_parameters, dict):
            path_parameters['sourcePrincipalName'] = source_principal_name
        super().__init__(request_adapter, "{+baseurl}/solutions/sharePoint/migrations/crossOrganizationMigrationTasks/getBySourceUserPrincipalName(sourcePrincipalName='{sourcePrincipalName}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436:
        """
        ...
        return GetBySourceUserPrincipalNameWithSourcePrincipalNameRequ_31d27436(self.request_adapter, raw_url)
    
    @dataclass
    class GetBySourceUserPrincipalNameWithSourcePrincipalNameRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
