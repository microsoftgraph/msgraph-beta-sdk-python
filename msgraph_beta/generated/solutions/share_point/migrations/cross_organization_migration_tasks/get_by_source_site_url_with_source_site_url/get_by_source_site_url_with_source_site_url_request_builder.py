...
class GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder(BaseRequestBuilder):
    """
    Provides operations to call the getBySourceSiteUrl method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], source_site_url: Optional[str] = None) -> None:
        """
        ...
        if isinstance(path_parameters, dict):
            path_parameters['sourceSiteUrl'] = source_site_url
        super().__init__(request_adapter, "{+baseurl}/solutions/sharePoint/migrations/crossOrganizationMigrationTasks/getBySourceSiteUrl(sourceSiteUrl='{sourceSiteUrl}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetBySourceSiteUrlWithSourceSiteUrlRequestBuilder:
        """
    ...
    @dataclass
    class GetBySourceSiteUrlWithSourceSiteUrlRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
