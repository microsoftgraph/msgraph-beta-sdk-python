...
class WorkflowTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[WorkflowTemplate]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> WorkflowTemplateItemRequestBuilder:
        """
