...
class TaskProcessingResultsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/taskProcessingResults{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TaskProcessingResultsRequestBuilderGetQueryParameters]] = None) -> Optional[TaskProcessingResultCollectionResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/identitygovernance-run-list-taskprocessingresults?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: str) -> TaskProcessingResultsRequestBuilder:
        """
    ...
    @dataclass
    class TaskProcessingResultsRequestBuilderGetRequestConfiguration(RequestConfiguration[TaskProcessingResultsRequestBuilderGetQueryParameters]):
        """
