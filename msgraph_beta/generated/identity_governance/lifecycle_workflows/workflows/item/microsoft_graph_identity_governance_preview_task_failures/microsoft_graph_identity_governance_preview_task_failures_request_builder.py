...
class MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequestBuilder
        """
        warn(" as of 2025-01/PrivatePreview:organizationalUnit on 2025-08-12 and will be removed 2026-02-28", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphIdentityGovernancePreviewTaskFailuresRequestBuilder(self.request_adapter, raw_url)
