...
if TYPE_CHECKING:
    ...
    from .top_tasks_processed_summary_with_start_date_time_with_end_date_tim_6add09fc import TopTasksProcessedSummaryWithStartDateTimeWithEndDateTim_6add09fc

class MicrosoftGraphIdentityGovernanceTopTasksProcessedSummar_f084ca11(BaseRequestBuilder):
    """
    Provides operations to call the topTasksProcessedSummary method. Original name: MicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphIdentityGovernanceTopTasksProcessedSummar_f084ca11 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]] = None) -> Optional[TopTasksProcessedSummaryWithStartDateTimeWithEndDateTim_6add09fc]:
        """
        ...
        Returns: Optional[TopTasksProcessedSummaryWithStartDateTimeWithEndDateTim_6add09fc]
        ...
        return await self.request_adapter.send_async(request_info, TopTasksProcessedSummaryWithStartDateTimeWithEndDateTim_6add09fc, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernanceTopTasksProcessedSummar_f084ca11:
        """
        ...
        return MicrosoftGraphIdentityGovernanceTopTasksProcessedSummar_f084ca11(self.request_adapter, raw_url)
