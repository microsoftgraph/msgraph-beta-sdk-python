...
class MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WorkflowsInsightsByCategory]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/identitygovernance-insights-workflowsprocessedbycategory?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c:
        """
        ...
        return MicrosoftGraphIdentityGovernanceWorkflowsProcessedByCat_7e0e042c(self.request_adapter, raw_url)
