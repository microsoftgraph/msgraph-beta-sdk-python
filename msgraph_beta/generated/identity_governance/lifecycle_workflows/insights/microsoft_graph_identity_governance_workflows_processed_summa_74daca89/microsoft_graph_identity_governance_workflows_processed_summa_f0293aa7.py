...
class MicrosoftGraphIdentityGovernanceWorkflowsProcessedSumma_f0293aa7(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphIdentityGovernanceWorkflowsProcessedSumma_f0293aa7 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernanceWorkflowsProcessedSumma_f0293aa7:
        """
        ...
        return MicrosoftGraphIdentityGovernanceWorkflowsProcessedSumma_f0293aa7(self.request_adapter, raw_url)
