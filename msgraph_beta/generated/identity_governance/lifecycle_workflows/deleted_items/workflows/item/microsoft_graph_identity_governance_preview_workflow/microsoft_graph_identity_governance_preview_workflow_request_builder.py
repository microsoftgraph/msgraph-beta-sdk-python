...
if TYPE_CHECKING:
    ...
    from .preview_workflow_post_request_body import PreviewWorkflowPostRequestBody

class MicrosoftGraphIdentityGovernancePreviewWorkflowRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/microsoft.graph.identityGovernance.previewWorkflow", path_parameters)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernancePreviewWorkflowRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphIdentityGovernancePreviewWorkflowRequestBuilder
        """
        warn(" as of 2025-01/PrivatePreview:organizationalUnit on 2025-08-12 and will be removed 2026-02-28", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphIdentityGovernancePreviewWorkflowRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class MicrosoftGraphIdentityGovernancePreviewWorkflowRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
