...
class MicrosoftGraphIdentityGovernanceResumeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}/taskProcessingResults/{taskProcessingResult%2Did}/microsoft.graph.identityGovernance.resume", path_parameters)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIdentityGovernanceResumeRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphIdentityGovernanceResumeRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
