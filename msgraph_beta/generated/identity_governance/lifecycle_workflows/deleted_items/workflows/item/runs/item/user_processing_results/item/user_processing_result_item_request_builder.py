...
class UserProcessingResultItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/{userProcessingResult%2Did}{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> UserProcessingResultItemRequestBuilder:
        """
    ...
    @dataclass
    class UserProcessingResultItemRequestBuilderGetRequestConfiguration(RequestConfiguration[UserProcessingResultItemRequestBuilderGetQueryParameters]):
        """
