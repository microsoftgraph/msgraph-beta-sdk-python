...
class ExecutionScopeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/executionScope{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ExecutionScopeRequestBuilder:
        """
    ...
    @dataclass
    class ExecutionScopeRequestBuilderGetRequestConfiguration(RequestConfiguration[ExecutionScopeRequestBuilderGetQueryParameters]):
        """
