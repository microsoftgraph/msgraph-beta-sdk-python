...
class PreviewScopeRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/previewScope{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PreviewScopeRequestBuilderGetQueryParameters]] = None) -> Optional[DirectoryObjectCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[PreviewScopeRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get previewScope from identityGovernance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> PreviewScopeRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: PreviewScopeRequestBuilder
        """
        warn(" as of 2025-01/PrivatePreview:organizationalUnit on 2025-08-12 and will be removed 2026-02-28", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return PreviewScopeRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class PreviewScopeRequestBuilderGetQueryParameters():
        """
        Get previewScope from identityGovernance
        """
    ...
    @dataclass
    class PreviewScopeRequestBuilderGetRequestConfiguration(RequestConfiguration[PreviewScopeRequestBuilderGetQueryParameters]):
        """
