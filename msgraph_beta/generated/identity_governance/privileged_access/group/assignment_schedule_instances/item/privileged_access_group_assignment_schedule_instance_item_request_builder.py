...
class PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder:
        """
