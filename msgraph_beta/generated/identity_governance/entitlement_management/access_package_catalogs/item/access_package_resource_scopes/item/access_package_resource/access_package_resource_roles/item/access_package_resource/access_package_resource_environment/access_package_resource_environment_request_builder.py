...
class AccessPackageResourceEnvironmentRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessPackageResourceEnvironment]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AccessPackageResourceEnvironmentRequestBuilder:
        """
