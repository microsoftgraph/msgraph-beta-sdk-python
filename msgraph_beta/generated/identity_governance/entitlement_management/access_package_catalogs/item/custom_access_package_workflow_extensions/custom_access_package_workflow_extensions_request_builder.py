...
if TYPE_CHECKING:
    ...
    from ......models.custom_access_package_workflow_extension_collection_response import CustomAccessPackageWorkflowExtensionCollectionResponse
    from ......models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.custom_access_package_workflow_extension_item_request_builder import CustomAccessPackageWorkflowExtensionItemRequestBuilder

class CustomAccessPackageWorkflowExtensionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_custom_access_package_workflow_extension_id(self,custom_access_package_workflow_extension_id: str) -> CustomAccessPackageWorkflowExtensionItemRequestBuilder:
        """
        Provides operations to manage the customAccessPackageWorkflowExtensions property of the microsoft.graph.accessPackageCatalog entity.
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CustomAccessPackageWorkflowExtensionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn(" as of 2022-10/PrivatePreview:MicrosofEntitlementManagementCustomextensions on 2023-03-01 and will be removed 2023-12-31", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog%2Did}/customAccessPackageWorkflowExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: CustomAccessPackageWorkflowExtension, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog%2Did}/customAccessPackageWorkflowExtensions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    def with_url(self,raw_url: str) -> CustomAccessPackageWorkflowExtensionsRequestBuilder:
        ...
        Returns: CustomAccessPackageWorkflowExtensionsRequestBuilder
        """
        warn(" as of 2022-10/PrivatePreview:MicrosofEntitlementManagementCustomextensions on 2023-03-01 and will be removed 2023-12-31", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CustomAccessPackageWorkflowExtensionsRequestBuilder(self.request_adapter, raw_url)
