...
class GetApplicablePolicyRequirementsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages(uniqueName='{uniqueName}')/getApplicablePolicyRequirements", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetApplicablePolicyRequirementsRequestBuilder:
        """
    ...
    @dataclass
    class GetApplicablePolicyRequirementsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
