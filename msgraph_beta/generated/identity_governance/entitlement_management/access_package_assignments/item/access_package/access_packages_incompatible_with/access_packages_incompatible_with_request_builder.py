...
class AccessPackagesIncompatibleWithRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackagesIncompatibleWith{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters]] = None) -> Optional[AccessPackageCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The access packages that are incompatible with this package. Read-only.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AccessPackagesIncompatibleWithRequestBuilder:
        """
    ...
    @dataclass
    class AccessPackagesIncompatibleWithRequestBuilderGetRequestConfiguration(RequestConfiguration[AccessPackagesIncompatibleWithRequestBuilderGetQueryParameters]):
        """
