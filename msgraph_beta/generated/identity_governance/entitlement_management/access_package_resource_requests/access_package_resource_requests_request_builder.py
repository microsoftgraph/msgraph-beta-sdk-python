...
class AccessPackageResourceRequestsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AccessPackageResourceRequestsRequestBuilderGetQueryParameters]] = None) -> Optional[AccessPackageResourceRequestCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AccessPackageResourceRequestsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve a list of accessPackageResourceRequest objects.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def with_url(self,raw_url: str) -> AccessPackageResourceRequestsRequestBuilder:
        """
    ...
    @dataclass
    class AccessPackageResourceRequestsRequestBuilderGetRequestConfiguration(RequestConfiguration[AccessPackageResourceRequestsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AccessPackageResourceRequestsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
