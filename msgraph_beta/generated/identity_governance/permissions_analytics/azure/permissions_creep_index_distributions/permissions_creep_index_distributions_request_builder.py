...
class PermissionsCreepIndexDistributionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[PermissionsCreepIndexDistributionsRequestBuilderGetRequestConfiguration] = None) -> Optional[PermissionsCreepIndexDistributionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PermissionsCreepIndexDistribution] = None, request_configuration: Optional[PermissionsCreepIndexDistributionsRequestBuilderPostRequestConfiguration] = None) -> Optional[PermissionsCreepIndexDistribution]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[PermissionsCreepIndexDistributionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get a list of the permissionsCreepIndexDistribution objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[PermissionsCreepIndexDistribution] = None, request_configuration: Optional[PermissionsCreepIndexDistributionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to permissionsCreepIndexDistributions for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> PermissionsCreepIndexDistributionsRequestBuilder:
        """
    ...
    @dataclass
    class PermissionsCreepIndexDistributionsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[PermissionsCreepIndexDistributionsRequestBuilder.PermissionsCreepIndexDistributionsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class PermissionsCreepIndexDistributionsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
