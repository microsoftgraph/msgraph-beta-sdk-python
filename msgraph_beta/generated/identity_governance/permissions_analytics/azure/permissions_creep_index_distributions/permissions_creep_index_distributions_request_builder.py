...
class PermissionsCreepIndexDistributionsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[PermissionsCreepIndexDistribution] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PermissionsCreepIndexDistribution]:
        """
    ...
    def to_post_request_information(self,body: Optional[PermissionsCreepIndexDistribution] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to permissionsCreepIndexDistributions for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
