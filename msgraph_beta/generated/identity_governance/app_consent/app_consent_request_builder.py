...
class AppConsentRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AppConsentApprovalRoute]:
        """
    ...
    async def patch(self,body: Optional[AppConsentApprovalRoute] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AppConsentApprovalRoute]:
        """
    ...
    def to_patch_request_information(self,body: Optional[AppConsentApprovalRoute] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property appConsent in identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AppConsentRequestBuilder:
        """
