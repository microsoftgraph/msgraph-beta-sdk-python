...
class RoleManagementAlertsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RoleManagementAlertsRequestBuilderGetQueryParameters]] = None) -> Optional[RoleManagementAlert]:
        """
        Get roleManagementAlerts from identityGovernance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[RoleManagementAlert]
        """
    ...
    async def patch(self,body: RoleManagementAlert, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RoleManagementAlert]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RoleManagementAlertsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get roleManagementAlerts from identityGovernance
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/identityGovernance/roleManagementAlerts{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: RoleManagementAlert, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property roleManagementAlerts in identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> RoleManagementAlertsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RoleManagementAlertsRequestBuilder
        """
        if raw_url is None:
    ...
    @property
    def alert_definitions(self) -> AlertDefinitionsRequestBuilder:
        """
        Provides operations to manage the alertDefinitions property of the microsoft.graph.roleManagementAlert entity.
        """
        from .alert_definitions.alert_definitions_request_builder import AlertDefinitionsRequestBuilder

        return AlertDefinitionsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class RoleManagementAlertsRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class RoleManagementAlertsRequestBuilderGetRequestConfiguration(RequestConfiguration[RoleManagementAlertsRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class RoleManagementAlertsRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
