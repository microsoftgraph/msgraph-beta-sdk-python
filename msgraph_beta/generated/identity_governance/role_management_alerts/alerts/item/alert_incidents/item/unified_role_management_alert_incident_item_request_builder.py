...
class UnifiedRoleManagementAlertIncidentItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[UnifiedRoleManagementAlertIncident] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnifiedRoleManagementAlertIncident]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UnifiedRoleManagementAlertIncident] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property alertIncidents in identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
