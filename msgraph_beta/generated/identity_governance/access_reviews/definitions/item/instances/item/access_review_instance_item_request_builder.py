...
if TYPE_CHECKING:
    ...
    from .stop_apply_decisions.stop_apply_decisions_request_builder import StopApplyDecisionsRequestBuilder
...
class AccessReviewInstanceItemRequestBuilder(BaseRequestBuilder):
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[AccessReviewInstance] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def stop_apply_decisions(self) -> StopApplyDecisionsRequestBuilder:
        """
        Provides operations to call the stopApplyDecisions method.
        """
        from .stop_apply_decisions.stop_apply_decisions_request_builder import StopApplyDecisionsRequestBuilder

        return StopApplyDecisionsRequestBuilder(self.request_adapter, self.path_parameters)
