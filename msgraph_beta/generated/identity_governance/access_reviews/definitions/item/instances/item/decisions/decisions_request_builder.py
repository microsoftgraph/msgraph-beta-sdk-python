...
if TYPE_CHECKING:
    ...
    from .record_all_decisions.record_all_decisions_request_builder import RecordAllDecisionsRequestBuilder
...
class DecisionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewInstanceDecisionItemCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AccessReviewInstanceDecisionItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewInstanceDecisionItem]:
        """
    ...
    def to_post_request_information(self,body: Optional[AccessReviewInstanceDecisionItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to decisions for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/decisions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def record_all_decisions(self) -> RecordAllDecisionsRequestBuilder:
        """
        Provides operations to call the recordAllDecisions method.
        """
        from .record_all_decisions.record_all_decisions_request_builder import RecordAllDecisionsRequestBuilder

        return RecordAllDecisionsRequestBuilder(self.request_adapter, self.path_parameters)
