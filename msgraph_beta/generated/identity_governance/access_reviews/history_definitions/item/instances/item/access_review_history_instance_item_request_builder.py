...
class AccessReviewHistoryInstanceItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewHistoryInstance]:
        """
    ...
    async def patch(self,body: Optional[AccessReviewHistoryInstance] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewHistoryInstance]:
        """
    ...
    def to_patch_request_information(self,body: Optional[AccessReviewHistoryInstance] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property instances in identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AccessReviewHistoryInstanceItemRequestBuilder:
        """
