...
class InstancesRequestBuilder(BaseRequestBuilder):
    ...
    def by_access_review_history_instance_id(self,access_review_history_instance_id: str) -> AccessReviewHistoryInstanceItemRequestBuilder:
        ...
        """
        if not access_review_history_instance_id:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewHistoryInstanceCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AccessReviewHistoryInstance] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AccessReviewHistoryInstance]:
        """
    ...
    def to_post_request_information(self,body: Optional[AccessReviewHistoryInstance] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to instances for identityGovernance
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
