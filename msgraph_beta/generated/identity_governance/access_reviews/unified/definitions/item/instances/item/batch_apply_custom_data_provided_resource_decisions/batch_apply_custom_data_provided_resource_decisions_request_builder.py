...
if TYPE_CHECKING:
    ...
    from .batch_apply_custom_data_provided_resource_decisions_post_request_body import BatchApplyCustomDataProvidedResourceDecisionsPostRequestBody

class BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder(BaseRequestBuilder):
    """
    Provides operations to call the batchApplyCustomDataProvidedResourceDecisions method.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/batchApplyCustomDataProvidedResourceDecisions", path_parameters)
    ...
    def with_url(self,raw_url: str) -> BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder
        """
        warn(" as of 2022-02/PrivatePreview:groupPeerOutlierInsights on 2021-10-21 and will be removed 2022-02-18", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return BatchApplyCustomDataProvidedResourceDecisionsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class BatchApplyCustomDataProvidedResourceDecisionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
