...
class DefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/accessReviews/unified/definitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DefinitionsRequestBuilderGetQueryParameters]] = None) -> Optional[AccessReviewScheduleDefinitionCollectionResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/unifiedroot-list-definitions?view=graph-rest-beta
        """
        warn(" as of 2022-02/PrivatePreview:groupPeerOutlierInsights on 2021-10-21 and will be removed 2022-02-18", DeprecationWarning)
    ...
    async def post(self,body: AccessReviewScheduleDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AccessReviewScheduleDefinition]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/unifiedroot-post-definitions?view=graph-rest-beta
        """
        warn(" as of 2022-02/PrivatePreview:groupPeerOutlierInsights on 2021-10-21 and will be removed 2022-02-18", DeprecationWarning)
        if body is None:
