...
class PolicyRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/accessReviews/policy{?%24select,%24expand}", path_parameters)
    ...
    async def patch(self,body: Optional[AccessReviewPolicy] = None, request_configuration: Optional[PolicyRequestBuilderPatchRequestConfiguration] = None) -> Optional[AccessReviewPolicy]:
        """
        Update the properties of an accessReviewPolicy object. This API is available in the following national cloud deployments.
