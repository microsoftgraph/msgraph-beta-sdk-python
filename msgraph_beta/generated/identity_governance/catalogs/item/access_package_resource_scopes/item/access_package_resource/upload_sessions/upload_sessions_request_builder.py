...
if TYPE_CHECKING:
    ...
    from ........models.custom_data_provided_resource_upload_session_collection_response import CustomDataProvidedResourceUploadSessionCollectionResponse
...
class UploadSessionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_custom_data_provided_resource_upload_session_id(self,custom_data_provided_resource_upload_session_id: str) -> CustomDataProvidedResourceUploadSessionItemRequestBuilder:
        """
        Provides operations to manage the uploadSessions property of the microsoft.graph.accessPackageResource entity.
        ...
        url_tpl_params["customDataProvidedResourceUploadSession%2Did"] = custom_data_provided_resource_upload_session_id
        return CustomDataProvidedResourceUploadSessionItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UploadSessionsRequestBuilderGetQueryParameters]] = None) -> Optional[CustomDataProvidedResourceUploadSessionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CustomDataProvidedResourceUploadSessionCollectionResponse, error_mapping)
    ...
    async def post(self,body: CustomDataProvidedResourceUploadSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CustomDataProvidedResourceUploadSession]:
        ...
        return await self.request_adapter.send_async(request_info, CustomDataProvidedResourceUploadSession, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UploadSessionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn(" as of 2022-10/PrivatePreview:MicrosofEntitlementManagementCustomextensions on 2023-03-01 and will be removed 2023-12-31", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResourceScopes/{accessPackageResourceScope%2Did}/accessPackageResource/uploadSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: CustomDataProvidedResourceUploadSession, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResourceScopes/{accessPackageResourceScope%2Did}/accessPackageResource/uploadSessions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> UploadSessionsRequestBuilder:
        """
    ...
    @dataclass
    class UploadSessionsRequestBuilderGetRequestConfiguration(RequestConfiguration[UploadSessionsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class UploadSessionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
