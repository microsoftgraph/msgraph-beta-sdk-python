...
class CustomDataProvidedResourceFileItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files/{customDataProvidedResourceFile%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[CustomDataProvidedResourceFileItemRequestBuilderGetQueryParameters]] = None) -> Optional[CustomDataProvidedResourceFile]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CustomDataProvidedResourceFileItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The files uploaded during this upload session. Supports $expand and $expand with nested $filter and $orderby.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> CustomDataProvidedResourceFileItemRequestBuilder:
        """
        ...
        return CustomDataProvidedResourceFileItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class CustomDataProvidedResourceFileItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CustomDataProvidedResourceFileItemRequestBuilderGetQueryParameters]):
        """
