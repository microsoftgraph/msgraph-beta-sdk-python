...
class FilesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityGovernance/catalogs/{accessPackageCatalog%2Did}/accessPackageResources/{accessPackageResource%2Did}/uploadSessions/{customDataProvidedResourceUploadSession%2Did}/files{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_custom_data_provided_resource_file_id(self,custom_data_provided_resource_file_id: str) -> CustomDataProvidedResourceFileItemRequestBuilder:
        """
        Provides operations to manage the files property of the microsoft.graph.customDataProvidedResourceUploadSession entity.
        ...
        url_tpl_params["customDataProvidedResourceFile%2Did"] = custom_data_provided_resource_file_id
        return CustomDataProvidedResourceFileItemRequestBuilder(self.request_adapter, url_tpl_params)
