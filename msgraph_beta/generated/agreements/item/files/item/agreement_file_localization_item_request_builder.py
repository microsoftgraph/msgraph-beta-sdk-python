...
class AgreementFileLocalizationItemRequestBuilder(BaseRequestBuilder):
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/agreements/{agreement%2Did}/files/{agreementFileLocalization%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[AgreementFileLocalization] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/agreements/{agreement%2Did}/files/{agreementFileLocalization%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
