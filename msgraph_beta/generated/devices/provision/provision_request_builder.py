...
if TYPE_CHECKING:
    ...
    from .provision_post_request_body import ProvisionPostRequestBody

class ProvisionRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/devices/provision", path_parameters)
    ...
    async def post(self,body: ProvisionPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ProvisionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ProvisionResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> ProvisionRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ProvisionRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ProvisionRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ProvisionRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
