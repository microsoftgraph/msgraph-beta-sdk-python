...
class PrivilegedRoleAssignmentRequestsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedRoleAssignmentRequestCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegedRoleAssignmentRequest] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedRoleAssignmentRequest]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrivilegedRoleAssignmentRequest] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to privilegedRoleAssignmentRequests
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
