...
class CancelRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/cancel", path_parameters)
    
    async def post(self,request_configuration: Optional[CancelRequestBuilderPostRequestConfiguration] = None) -> Optional[PrivilegedRoleAssignmentRequest]:
        """
