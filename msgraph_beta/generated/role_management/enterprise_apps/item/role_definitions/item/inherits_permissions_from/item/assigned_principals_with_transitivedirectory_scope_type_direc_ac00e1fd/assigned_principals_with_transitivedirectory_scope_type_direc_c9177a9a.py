...
if TYPE_CHECKING:
    ...
    from .assigned_principals_with_transitivedirectory_scope_type_direc_fab3e57d import AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_fab3e57d

class AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a(BaseRequestBuilder):
    """
    Provides operations to call the assignedPrincipals method. Original name: AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom/{unifiedRoleDefinition%2Did1}/assignedPrincipals(transitive=@transitive,directoryScopeType='@directoryScopeType',directoryScopeId='@directoryScopeId'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,directoryScopeId*,directoryScopeType*,transitive*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[AssignedPrincipalsWithTransitivedirectoryScopeTypeDirectoryScopeTypeDirectoryScopeIdDirectoryScopeIdRequestBuilderGetQueryParameters]] = None) -> Optional[AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_fab3e57d]:
        """
        ...
        Returns: Optional[AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_fab3e57d]
        ...
        return await self.request_adapter.send_async(request_info, AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_fab3e57d, error_mapping)
    ...
    def with_url(self,raw_url: str) -> AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a
        """
        warn("This version is being deprecated and is scheduled for removal on 2025-12-01.Please migrate to the latest version before the removal date. as of 2025-01/PrivatePreview:microsoft.applicationAuthorization on 2025-01-01 and will be removed 2025-12-01", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return AssignedPrincipalsWithTransitivedirectoryScopeTypeDirec_c9177a9a(self.request_adapter, raw_url)
