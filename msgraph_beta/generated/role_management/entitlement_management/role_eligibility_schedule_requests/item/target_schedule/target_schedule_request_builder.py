...
class TargetScheduleRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[TargetScheduleRequestBuilderGetQueryParameters]] = None) -> Optional[UnifiedRoleEligibilitySchedule]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TargetScheduleRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The schedule for a role eligibility that is referenced through the targetScheduleId property. Supports $expand.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> TargetScheduleRequestBuilder:
        """
    ...
    @dataclass
    class TargetScheduleRequestBuilderGetRequestConfiguration(RequestConfiguration[TargetScheduleRequestBuilderGetQueryParameters]):
        """
