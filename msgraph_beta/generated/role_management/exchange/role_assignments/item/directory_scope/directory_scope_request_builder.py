...
class DirectoryScopeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}", path_parameters)
