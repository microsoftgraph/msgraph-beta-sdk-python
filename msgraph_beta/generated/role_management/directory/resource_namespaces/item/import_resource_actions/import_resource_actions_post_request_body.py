...
@dataclass
class ImportResourceActionsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    overwrite_resource_namespace: Optional[bool] = False
    # The format property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ImportResourceActionsPostRequestBody:
        """
