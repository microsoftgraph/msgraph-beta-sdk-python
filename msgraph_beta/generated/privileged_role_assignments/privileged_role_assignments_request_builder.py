...
class PrivilegedRoleAssignmentsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedRoleAssignmentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegedRoleAssignment] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedRoleAssignment]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrivilegedRoleAssignment] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to privilegedRoleAssignments
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
