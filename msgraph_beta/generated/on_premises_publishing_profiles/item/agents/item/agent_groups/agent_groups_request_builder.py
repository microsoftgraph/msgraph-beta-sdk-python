...
class AgentGroupsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agents/{onPremisesAgent%2Did}/agentGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_on_premises_agent_group_id(self,on_premises_agent_group_id: str) -> OnPremisesAgentGroupItemRequestBuilder:
        """
        Gets an item from the msgraph_beta.generated.onPremisesPublishingProfiles.item.agents.item.agentGroups.item collection
        param on_premises_agent_group_id: The unique identifier of onPremisesAgentGroup
        Returns: OnPremisesAgentGroupItemRequestBuilder
        """
        if not on_premises_agent_group_id:
            raise TypeError("on_premises_agent_group_id cannot be null.")
        from .item.on_premises_agent_group_item_request_builder import OnPremisesAgentGroupItemRequestBuilder
