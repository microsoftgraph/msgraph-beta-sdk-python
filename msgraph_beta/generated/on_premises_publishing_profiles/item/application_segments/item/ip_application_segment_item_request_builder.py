...
if TYPE_CHECKING:
    from .....models.ip_application_segment import IpApplicationSegment
    from .....models.o_data_errors.o_data_error import ODataError

class IpApplicationSegmentItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/applicationSegments/{ipApplicationSegment%2Did}{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[IpApplicationSegmentItemRequestBuilderGetQueryParameters]] = None) -> Optional[IpApplicationSegment]:
        ...
        return await self.request_adapter.send_async(request_info, IpApplicationSegment, error_mapping)
    ...
    def with_url(self,raw_url: str) -> IpApplicationSegmentItemRequestBuilder:
        """
        ...
        return IpApplicationSegmentItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class IpApplicationSegmentItemRequestBuilderGetRequestConfiguration(RequestConfiguration[IpApplicationSegmentItemRequestBuilderGetQueryParameters]):
        """
