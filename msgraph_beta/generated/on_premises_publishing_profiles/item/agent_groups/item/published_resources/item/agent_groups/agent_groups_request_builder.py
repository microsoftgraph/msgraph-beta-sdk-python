...
class AgentGroupsRequestBuilder(BaseRequestBuilder):
    ...
    def by_on_premises_agent_group_id1(self,on_premises_agent_group_id1: str) -> OnPremisesAgentGroupItemRequestBuilder:
        ...
        """
        if on_premises_agent_group_id1 is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AgentGroupsRequestBuilderGetQueryParameters]] = None) -> Optional[OnPremisesAgentGroupCollectionResponse]:
        """
    ...
    async def post(self,body: OnPremisesAgentGroup, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OnPremisesAgentGroup]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AgentGroupsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        List of onPremisesAgentGroups that a publishedResource is assigned to. Read-only. Nullable.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: OnPremisesAgentGroup, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to agentGroups for onPremisesPublishingProfiles
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> AgentGroupsRequestBuilder:
        """
    ...
    @dataclass
    class AgentGroupsRequestBuilderGetRequestConfiguration(RequestConfiguration[AgentGroupsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AgentGroupsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
