...
class ConnectorItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Connector]:
        """
    ...
    async def patch(self,body: Optional[Connector] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Connector]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Connector] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property connectors in onPremisesPublishingProfiles
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
