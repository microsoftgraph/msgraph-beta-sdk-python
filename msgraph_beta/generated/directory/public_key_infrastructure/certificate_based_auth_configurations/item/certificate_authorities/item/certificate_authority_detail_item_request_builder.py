...
if TYPE_CHECKING:
    from .......models.certificate_authority_detail import CertificateAuthorityDetail
    from .......models.o_data_errors.o_data_error import ODataError

class CertificateAuthorityDetailItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CertificateAuthorityDetailItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/publicKeyInfrastructure/certificateBasedAuthConfigurations/{certificateBasedAuthPki%2Did}/certificateAuthorities/{certificateAuthorityDetail%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> CertificateAuthorityDetailItemRequestBuilder:
        """
        ...
        return CertificateAuthorityDetailItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CertificateAuthorityDetailItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CertificateAuthorityDetailItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CertificateAuthorityDetailItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CertificateAuthorityDetailItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
