...
@dataclass
class UploadPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    sha256_file_hash: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "sha256FileHash": lambda n : setattr(self, 'sha256_file_hash', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("sha256FileHash", self.sha256_file_hash)
