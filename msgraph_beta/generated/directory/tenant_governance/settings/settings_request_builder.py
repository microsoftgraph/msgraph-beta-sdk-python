...
if TYPE_CHECKING:
    ...
    from ....models.tenant_governance_setting import TenantGovernanceSetting
    from .enable_related_tenants.enable_related_tenants_request_builder import EnableRelatedTenantsRequestBuilder
...
class SettingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/tenantGovernance/settings{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SettingsRequestBuilderGetQueryParameters]] = None) -> Optional[TenantGovernanceSetting]:
        """
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TenantGovernanceSetting]
        ...
        return await self.request_adapter.send_async(request_info, TenantGovernanceSetting, error_mapping)
    
    async def patch(self,body: TenantGovernanceSetting, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TenantGovernanceSetting]:
        """
    ...
    def to_patch_request_information(self,body: TenantGovernanceSetting, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the canReceiveInvitations property of the tenantGovernanceSetting singleton. This property controls whether the tenant can receive governance invitations.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @property
    def enable_related_tenants(self) -> EnableRelatedTenantsRequestBuilder:
        """
        Provides operations to call the enableRelatedTenants method.
        """
        from .enable_related_tenants.enable_related_tenants_request_builder import EnableRelatedTenantsRequestBuilder

        return EnableRelatedTenantsRequestBuilder(self.request_adapter, self.path_parameters)
