...
class RelatedTenantsRequestBuilder(BaseRequestBuilder):
    ...
    def by_related_tenant_id(self,related_tenant_id: str) -> RelatedTenantItemRequestBuilder:
        ...
        """
        if related_tenant_id is None:
            raise TypeError("related_tenant_id cannot be null.")
        from .item.related_tenant_item_request_builder import RelatedTenantItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["relatedTenant%2Did"] = related_tenant_id
        return RelatedTenantItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: RelatedTenant, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RelatedTenant]:
        """
    ...
    def to_post_request_information(self,body: RelatedTenant, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to relatedTenants for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> RelatedTenantsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RelatedTenantsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return RelatedTenantsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class RelatedTenantsRequestBuilderGetRequestConfiguration(RequestConfiguration[RelatedTenantsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class RelatedTenantsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
