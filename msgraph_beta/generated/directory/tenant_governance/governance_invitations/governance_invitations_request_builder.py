...
class GovernanceInvitationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_governance_invitation_id(self,governance_invitation_id: str) -> GovernanceInvitationItemRequestBuilder:
        ...
        """
        if governance_invitation_id is None:
            raise TypeError("governance_invitation_id cannot be null.")
        from .item.governance_invitation_item_request_builder import GovernanceInvitationItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["governanceInvitation%2Did"] = governance_invitation_id
        return GovernanceInvitationItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GovernanceInvitationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/tenantGovernance/governanceInvitations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: GovernanceInvitation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/tenantGovernance/governanceInvitations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> GovernanceInvitationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GovernanceInvitationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GovernanceInvitationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GovernanceInvitationsRequestBuilderGetRequestConfiguration(RequestConfiguration[GovernanceInvitationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GovernanceInvitationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
