...
class TenantGovernancePolicyTemplateItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/tenantGovernance/governancePolicyTemplates/{tenantGovernancePolicyTemplate%2Did}{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> TenantGovernancePolicyTemplateItemRequestBuilder:
        """
        ...
        return TenantGovernancePolicyTemplateItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class TenantGovernancePolicyTemplateItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class TenantGovernancePolicyTemplateItemRequestBuilderGetRequestConfiguration(RequestConfiguration[TenantGovernancePolicyTemplateItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class TenantGovernancePolicyTemplateItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
