...
class GovernancePolicyTemplateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GovernancePolicyTemplateRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GovernancePolicyTemplateRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GovernancePolicyTemplateRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GovernancePolicyTemplateRequestBuilderGetRequestConfiguration(RequestConfiguration[GovernancePolicyTemplateRequestBuilderGetQueryParameters]):
        """
