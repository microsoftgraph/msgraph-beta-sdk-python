...
class AdministrativeUnitsRequestBuilder(BaseRequestBuilder):
    ...
    @dataclass
    class AdministrativeUnitsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AdministrativeUnitsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
