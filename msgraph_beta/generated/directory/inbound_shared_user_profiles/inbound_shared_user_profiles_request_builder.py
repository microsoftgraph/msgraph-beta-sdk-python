...
class InboundSharedUserProfilesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/inboundSharedUserProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_inbound_shared_user_profile_user_id(self,inbound_shared_user_profile_user_id: str) -> InboundSharedUserProfileUserItemRequestBuilder:
        ...
        """
        if not inbound_shared_user_profile_user_id:
    ...
    async def get(self,request_configuration: Optional[InboundSharedUserProfilesRequestBuilderGetRequestConfiguration] = None) -> Optional[InboundSharedUserProfileCollectionResponse]:
        """
        Retrieve the properties of all inboundSharedUserProfiles. This API is available in the following national cloud deployments.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[InboundSharedUserProfileCollectionResponse]
        Find more info here: https://learn.microsoft.com/graph/api/directory-list-inboundshareduserprofiles?view=graph-rest-1.0
        """
    ...
    async def post(self,body: Optional[InboundSharedUserProfile] = None, request_configuration: Optional[InboundSharedUserProfilesRequestBuilderPostRequestConfiguration] = None) -> Optional[InboundSharedUserProfile]:
        """
    ...
    def to_post_request_information(self,body: Optional[InboundSharedUserProfile] = None, request_configuration: Optional[InboundSharedUserProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to inboundSharedUserProfiles for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> InboundSharedUserProfilesRequestBuilder:
        """
    ...
    @dataclass
    class InboundSharedUserProfilesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[InboundSharedUserProfilesRequestBuilder.InboundSharedUserProfilesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class InboundSharedUserProfilesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
