...
class RemovePersonalDataRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}/removePersonalData", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> RemovePersonalDataRequestBuilder:
        """
