...
if TYPE_CHECKING:
    ...
    from ....models.mutual_tls_oauth_configuration_collection_response import MutualTlsOauthConfigurationCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.mutual_tls_oauth_configuration_item_request_builder import MutualTlsOauthConfigurationItemRequestBuilder

class MutualTlsOauthConfigurationsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new MutualTlsOauthConfigurationsRequestBuilder and sets the default values.
    ...
    def by_mutual_tls_oauth_configuration_id(self,mutual_tls_oauth_configuration_id: str) -> MutualTlsOauthConfigurationItemRequestBuilder:
        """
        Provides operations to manage the mutualTlsOauthConfigurations property of the microsoft.graph.certificateAuthorityPath entity.
        param mutual_tls_oauth_configuration_id: The unique identifier of mutualTlsOauthConfiguration
        Returns: MutualTlsOauthConfigurationItemRequestBuilder
        """
        if mutual_tls_oauth_configuration_id is None:
            raise TypeError("mutual_tls_oauth_configuration_id cannot be null.")
        from .item.mutual_tls_oauth_configuration_item_request_builder import MutualTlsOauthConfigurationItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["mutualTlsOauthConfiguration%2Did"] = mutual_tls_oauth_configuration_id
        return MutualTlsOauthConfigurationItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MutualTlsOauthConfigurationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/certificateAuthorities/mutualTlsOauthConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: MutualTlsOauthConfiguration, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/certificateAuthorities/mutualTlsOauthConfigurations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> MutualTlsOauthConfigurationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MutualTlsOauthConfigurationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MutualTlsOauthConfigurationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class MutualTlsOauthConfigurationsRequestBuilderGetRequestConfiguration(RequestConfiguration[MutualTlsOauthConfigurationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class MutualTlsOauthConfigurationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
