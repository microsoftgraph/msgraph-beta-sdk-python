...
if TYPE_CHECKING:
    ...
    from ...models.company_subscription_collection_response import CompanySubscriptionCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.company_subscription_item_request_builder import CompanySubscriptionItemRequestBuilder
...
class SubscriptionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_company_subscription_id(self,company_subscription_id: str) -> CompanySubscriptionItemRequestBuilder:
        """
        Provides operations to manage the subscriptions property of the microsoft.graph.directory entity.
        param company_subscription_id: The unique identifier of companySubscription
        Returns: CompanySubscriptionItemRequestBuilder
        """
        if company_subscription_id is None:
            raise TypeError("company_subscription_id cannot be null.")
        from .item.company_subscription_item_request_builder import CompanySubscriptionItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SubscriptionsRequestBuilderGetQueryParameters]] = None) -> Optional[CompanySubscriptionCollectionResponse]:
        """
    ...
    async def post(self,body: CompanySubscription, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CompanySubscription]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SubscriptionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/subscriptions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: CompanySubscription, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to subscriptions for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/subscriptions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
