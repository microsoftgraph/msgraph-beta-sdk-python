...
class SubscriptionsWithOcpSubscriptionIdRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, ocp_subscription_id: Optional[str] = None) -> None:
        """
        ...
        super().__init__(request_adapter, "{+baseurl}/directory/subscriptions(ocpSubscriptionId='{ocpSubscriptionId}'){?%24select,%24expand}", path_parameters)
