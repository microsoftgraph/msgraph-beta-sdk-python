...
if TYPE_CHECKING:
    ...
    from ....models.entra_recovery_services.snapshot_collection_response import SnapshotCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.snapshot_item_request_builder import SnapshotItemRequestBuilder
...
class SnapshotsRequestBuilder(BaseRequestBuilder):
    ...
    def by_snapshot_id(self,snapshot_id: str) -> SnapshotItemRequestBuilder:
        """
        Provides operations to manage the snapshots property of the microsoft.graph.entraRecoveryServices.recovery entity.
        param snapshot_id: The unique identifier of snapshot
        ...
        url_tpl_params["snapshot%2Did"] = snapshot_id
        return SnapshotItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SnapshotsRequestBuilderGetQueryParameters]] = None) -> Optional[SnapshotCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, SnapshotCollectionResponse, error_mapping)
    
    async def post(self,body: Snapshot, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Snapshot]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SnapshotsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/directory/recovery/snapshots{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: Snapshot, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to snapshots for directory
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directory/recovery/snapshots', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
