...
class DirectoryObjectItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/policies/onPremAuthenticationPolicies/{onPremAuthenticationPolicy%2Did}/appliesTo/{directoryObject%2Did}{?%24expand,%24select}", path_parameters)
