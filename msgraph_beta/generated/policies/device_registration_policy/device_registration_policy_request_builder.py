...
class DeviceRegistrationPolicyRequestBuilder(BaseRequestBuilder):
    ...
    def to_patch_request_information(self,body: Optional[DeviceRegistrationPolicy] = None, request_configuration: Optional[DeviceRegistrationPolicyRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/policies/deviceRegistrationPolicy', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class DeviceRegistrationPolicyRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
