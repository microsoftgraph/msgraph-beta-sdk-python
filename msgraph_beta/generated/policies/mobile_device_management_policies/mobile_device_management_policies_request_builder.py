...
class MobileDeviceManagementPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MobileDeviceManagementPoliciesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/policies/mobileDeviceManagementPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def with_url(self,raw_url: str) -> MobileDeviceManagementPoliciesRequestBuilder:
        """
    ...
    @dataclass
    class MobileDeviceManagementPoliciesRequestBuilderGetRequestConfiguration(RequestConfiguration[MobileDeviceManagementPoliciesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class MobileDeviceManagementPoliciesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
