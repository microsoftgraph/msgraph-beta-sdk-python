...
class AuthorizationPolicyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthorizationPolicyCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AuthorizationPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthorizationPolicy]:
        """
    ...
    def to_post_request_information(self,body: Optional[AuthorizationPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to authorizationPolicy for policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
