...
class IncludesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/policies/servicePrincipalCreationPolicies/{servicePrincipalCreationPolicy%2Did}/includes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_service_principal_creation_condition_set_id(self,service_principal_creation_condition_set_id: str) -> ServicePrincipalCreationConditionSetItemRequestBuilder:
        """
        Provides operations to manage the includes property of the microsoft.graph.servicePrincipalCreationPolicy entity.
        param service_principal_creation_condition_set_id: The unique identifier of servicePrincipalCreationConditionSet
    ...
    async def get(self,request_configuration: Optional[IncludesRequestBuilderGetRequestConfiguration] = None) -> Optional[ServicePrincipalCreationConditionSetCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[IncludesRequestBuilderPostRequestConfiguration] = None) -> Optional[ServicePrincipalCreationConditionSet]:
        """
    ...
    def to_post_request_information(self,body: Optional[ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[IncludesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to includes for policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/policies/servicePrincipalCreationPolicies/{servicePrincipalCreationPolicy%2Did}/includes', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
