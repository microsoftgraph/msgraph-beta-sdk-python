...
class IncludesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServicePrincipalCreationConditionSetCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServicePrincipalCreationConditionSet]:
        """
    ...
    def to_post_request_information(self,body: Optional[ServicePrincipalCreationConditionSet] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to includes for policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
