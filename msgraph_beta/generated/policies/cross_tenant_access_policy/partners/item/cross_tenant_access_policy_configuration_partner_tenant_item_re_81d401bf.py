...
class CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf(BaseRequestBuilder):
    """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CrossTenantAccessPolicyConfigurationPartnerTenantItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/policies/crossTenantAccessPolicy/partners/{crossTenantAccessPolicyConfigurationPartner%2DtenantId}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf:
        """
        ...
        return CrossTenantAccessPolicyConfigurationPartnerTenantItemRe_81d401bf(self.request_adapter, raw_url)
