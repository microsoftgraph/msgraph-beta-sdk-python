...
class IdentitySynchronizationRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CrossTenantIdentitySyncPolicyPartner]:
        """
    ...
    async def put(self,body: Optional[CrossTenantIdentitySyncPolicyPartner] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CrossTenantIdentitySyncPolicyPartner]:
        """
    ...
    def to_put_request_information(self,body: Optional[CrossTenantIdentitySyncPolicyPartner] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property identitySynchronization in policies
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
