...
class ResetToDefaultSettingsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ResetToDefaultSettingsRequestBuilder:
        """
    ...
    @dataclass
    class ResetToDefaultSettingsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
