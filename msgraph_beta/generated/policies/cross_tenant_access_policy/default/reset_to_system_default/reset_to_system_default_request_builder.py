...
class ResetToSystemDefaultRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ResetToSystemDefaultRequestBuilder:
        """
    ...
    @dataclass
    class ResetToSystemDefaultRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
