...
class HomeRealmDiscoveryPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[HomeRealmDiscoveryPolicyCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[HomeRealmDiscoveryPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[HomeRealmDiscoveryPolicy]:
        """
    ...
    def to_post_request_information(self,body: Optional[HomeRealmDiscoveryPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new homeRealmDiscoveryPolicy object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
