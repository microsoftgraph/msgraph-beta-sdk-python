...
class ApplyDecisionsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ApplyDecisionsRequestBuilder:
        """
    ...
    @dataclass
    class ApplyDecisionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
