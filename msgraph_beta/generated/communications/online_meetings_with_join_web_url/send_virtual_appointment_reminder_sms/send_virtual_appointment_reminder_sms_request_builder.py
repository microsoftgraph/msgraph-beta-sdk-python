...
class SendVirtualAppointmentReminderSmsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')/sendVirtualAppointmentReminderSms", path_parameters)
    
    async def post(self,body: Optional[SendVirtualAppointmentReminderSmsPostRequestBody] = None, request_configuration: Optional[SendVirtualAppointmentReminderSmsRequestBuilderPostRequestConfiguration] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: Optional[SendVirtualAppointmentReminderSmsPostRequestBody] = None, request_configuration: Optional[SendVirtualAppointmentReminderSmsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Send an SMS reminder to external attendees for a Teams Virtual Appointment. This feature requires Teams Premium and attendees must have a valid United States phone number to receive SMS notifications.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SendVirtualAppointmentReminderSmsRequestBuilder:
        """
    ...
    @dataclass
    class SendVirtualAppointmentReminderSmsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
