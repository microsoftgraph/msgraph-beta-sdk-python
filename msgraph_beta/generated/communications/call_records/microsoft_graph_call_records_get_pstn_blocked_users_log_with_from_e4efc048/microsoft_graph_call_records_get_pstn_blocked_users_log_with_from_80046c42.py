...
class MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFrom_80046c42(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], from_date_time: Optional[datetime.datetime] = None, to_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFrom_80046c42 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFrom_80046c42:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFrom_80046c42
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphCallRecordsGetPstnBlockedUsersLogWithFrom_80046c42(self.request_adapter, raw_url)
