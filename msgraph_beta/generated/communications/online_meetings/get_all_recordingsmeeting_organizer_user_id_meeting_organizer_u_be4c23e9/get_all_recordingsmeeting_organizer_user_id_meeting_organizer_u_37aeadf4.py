...
if TYPE_CHECKING:
    ...
    from .get_all_recordingsmeeting_organizer_user_id_meeting_organizer_u_d8a14a3e import GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_d8a14a3e

class GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4 and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/onlineMeetings/getAllRecordings(meetingOrganizerUserId='@meetingOrganizerUserId',startDateTime=@startDateTime,endDateTime=@endDateTime){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top,endDateTime*,meetingOrganizerUserId*,startDateTime*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerUserIdWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]] = None) -> Optional[GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_d8a14a3e]:
        """
        ...
        Returns: Optional[GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_d8a14a3e]
        ...
        return await self.request_adapter.send_async(request_info, GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_d8a14a3e, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GetAllRecordingsmeetingOrganizerUserIdMeetingOrganizerU_37aeadf4(self.request_adapter, raw_url)
