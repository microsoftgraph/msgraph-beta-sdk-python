...
if TYPE_CHECKING:
    ...
    from .....models.call_recording_collection_response import CallRecordingCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .delta.delta_request_builder import DeltaRequestBuilder
    from .item.call_recording_item_request_builder import CallRecordingItemRequestBuilder
...
class RecordingsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/recordings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_call_recording_id(self,call_recording_id: str) -> CallRecordingItemRequestBuilder:
        """
        Provides operations to manage the recordings property of the microsoft.graph.onlineMeeting entity.
        param call_recording_id: The unique identifier of callRecording
        ...
        return CallRecordingItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: Optional[CallRecording] = None, request_configuration: Optional[RecordingsRequestBuilderPostRequestConfiguration] = None) -> Optional[CallRecording]:
        """
    ...
    def to_post_request_information(self,body: Optional[CallRecording] = None, request_configuration: Optional[RecordingsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/recordings', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> RecordingsRequestBuilder:
        """
    ...
    @dataclass
    class RecordingsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class RecordingsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
