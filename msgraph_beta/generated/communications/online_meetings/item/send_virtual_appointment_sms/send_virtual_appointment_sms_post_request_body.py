...
if TYPE_CHECKING:
    from .send_virtual_appointment_sms_post_request_body_sms_type import SendVirtualAppointmentSmsPostRequestBody_smsType
...
class SendVirtualAppointmentSmsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    sms_type: Optional[SendVirtualAppointmentSmsPostRequestBody_smsType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "smsType": lambda n : setattr(self, 'sms_type', n.get_enum_value(SendVirtualAppointmentSmsPostRequestBody_smsType)),
        }
        return fields
