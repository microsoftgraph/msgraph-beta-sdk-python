...
class AudioRoutingGroupsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AudioRoutingGroupCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[AudioRoutingGroup] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AudioRoutingGroup]:
        """
    ...
    def to_post_request_information(self,body: Optional[AudioRoutingGroup] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new audioRoutingGroup.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
