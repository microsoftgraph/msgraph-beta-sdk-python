...
if TYPE_CHECKING:
    ...
    from .report_synthetic_media_post_request_body import ReportSyntheticMediaPostRequestBody

class ReportSyntheticMediaRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/calls/{call%2Did}/participants/{participant%2Did}/reportSyntheticMedia", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ReportSyntheticMediaRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ReportSyntheticMediaRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ReportSyntheticMediaRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ReportSyntheticMediaRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
