...
class RedirectRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/calls/{call%2Did}/redirect", path_parameters)
    
    async def post(self,body: Optional[RedirectPostRequestBody] = None, request_configuration: Optional[RedirectRequestBuilderPostRequestConfiguration] = None) -> None:
        """
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/call-redirect?view=graph-rest-beta
        """
        if not body:
