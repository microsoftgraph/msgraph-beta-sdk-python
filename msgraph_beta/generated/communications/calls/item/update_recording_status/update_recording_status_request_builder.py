...
class UpdateRecordingStatusRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: UpdateRecordingStatusPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UpdateRecordingStatusOperation]:
        """
    ...
    def to_post_request_information(self,body: UpdateRecordingStatusPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the application's recording status associated with a call. This requires the use of the Teams policy-based recording solution.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UpdateRecordingStatusRequestBuilder:
        """
    ...
    @dataclass
    class UpdateRecordingStatusRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
