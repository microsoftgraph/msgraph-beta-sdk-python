...
class GetPresencesByUserIdRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetPresencesByUserIdPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetPresencesByUserIdPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[GetPresencesByUserIdPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Get the presence information for multiple users.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetPresencesByUserIdRequestBuilder:
        """
