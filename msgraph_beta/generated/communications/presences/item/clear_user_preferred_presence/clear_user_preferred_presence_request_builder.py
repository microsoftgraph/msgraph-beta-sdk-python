...
class ClearUserPreferredPresenceRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/communications/presences/{presence%2Did}/clearUserPreferredPresence", path_parameters)
    ...
    async def post(self,request_configuration: Optional[ClearUserPreferredPresenceRequestBuilderPostRequestConfiguration] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/presence-clearuserpreferredpresence?view=graph-rest-beta
        """
