...
class DirectoryObjectsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/directoryObjects{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[DirectoryObjectsRequestBuilderGetRequestConfiguration] = None) -> Optional[DirectoryObjectCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DirectoryObject] = None, request_configuration: Optional[DirectoryObjectsRequestBuilderPostRequestConfiguration] = None) -> Optional[DirectoryObject]:
        """
    ...
    def to_post_request_information(self,body: Optional[DirectoryObject] = None, request_configuration: Optional[DirectoryObjectsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to directoryObjects
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/directoryObjects', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> DirectoryObjectsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DirectoryObjectsRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class DirectoryObjectsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class DirectoryObjectsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
