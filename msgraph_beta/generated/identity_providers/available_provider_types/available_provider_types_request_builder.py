...
class AvailableProviderTypesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identityProviders/availableProviderTypes(){?%24count,%24filter,%24search,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[AvailableProviderTypesRequestBuilderGetRequestConfiguration] = None) -> Optional[AvailableProviderTypesGetResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/identityprovider-list-availableprovidertypes?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AvailableProviderTypesRequestBuilder:
        """
    ...
    @dataclass
    class AvailableProviderTypesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
