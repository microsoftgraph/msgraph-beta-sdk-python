...
@dataclass
class DeviceManagementConfigurationChoiceSettingValue(DeviceManagementConfigurationSettingValue, Parsable):
    """
    Setting value
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationChoiceSettingValue:
        """
