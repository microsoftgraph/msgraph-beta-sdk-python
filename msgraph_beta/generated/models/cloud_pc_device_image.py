...
if TYPE_CHECKING:
    from .cloud_pc_device_image_error_code import CloudPcDeviceImage_errorCode
    from .cloud_pc_device_image_os_status import CloudPcDeviceImage_osStatus
    from .cloud_pc_device_image_status import CloudPcDeviceImage_status
    from .cloud_pc_device_image_status_details import CloudPcDeviceImage_statusDetails
...
class CloudPcDeviceImage(Entity):
    ...
    error_code: Optional[CloudPcDeviceImage_errorCode] = None
    ...
    os_status: Optional[CloudPcDeviceImage_osStatus] = None
    ...
    status: Optional[CloudPcDeviceImage_status] = None
    ...
    status_details: Optional[CloudPcDeviceImage_statusDetails] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "errorCode": lambda n : setattr(self, 'error_code', n.get_enum_value(CloudPcDeviceImage_errorCode)),
            ...
            "osStatus": lambda n : setattr(self, 'os_status', n.get_enum_value(CloudPcDeviceImage_osStatus)),
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(CloudPcDeviceImage_status)),
            "statusDetails": lambda n : setattr(self, 'status_details', n.get_enum_value(CloudPcDeviceImage_statusDetails)),
