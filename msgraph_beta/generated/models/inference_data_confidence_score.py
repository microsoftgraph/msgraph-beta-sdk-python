...
@dataclass
class InferenceData_confidenceScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> InferenceData_confidenceScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: InferenceData_confidenceScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = InferenceData_confidenceScore()
