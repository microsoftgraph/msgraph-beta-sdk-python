...
if TYPE_CHECKING:
    ...
    from .alert_rule_alert_rule_template import AlertRule_alertRuleTemplate
    from .alert_rule_severity import AlertRule_severity
...
class AlertRule(Entity):
    ...
    alert_rule_template: Optional[AlertRule_alertRuleTemplate] = None
    ...
    severity: Optional[AlertRule_severity] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "alertRuleTemplate": lambda n : setattr(self, 'alert_rule_template', n.get_enum_value(AlertRule_alertRuleTemplate)),
            ...
            "severity": lambda n : setattr(self, 'severity', n.get_enum_value(AlertRule_severity)),
