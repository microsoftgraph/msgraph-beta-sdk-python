...
if TYPE_CHECKING:
    from .rule_condition_aggregation import RuleCondition_aggregation
    from .rule_condition_condition_category import RuleCondition_conditionCategory
    from .rule_condition_operator import RuleCondition_operator
    from .rule_condition_relationship_type import RuleCondition_relationshipType
...
class RuleCondition(AdditionalDataHolder, BackedModel, Parsable):
    ...
    aggregation: Optional[RuleCondition_aggregation] = None
    ...
    condition_category: Optional[RuleCondition_conditionCategory] = None
    ...
    operator: Optional[RuleCondition_operator] = None
    # The relationship type.  Possible values are: and, or.
    relationship_type: Optional[RuleCondition_relationshipType] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> RuleCondition:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "aggregation": lambda n : setattr(self, 'aggregation', n.get_enum_value(RuleCondition_aggregation)),
            "conditionCategory": lambda n : setattr(self, 'condition_category', n.get_enum_value(RuleCondition_conditionCategory)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "operator": lambda n : setattr(self, 'operator', n.get_enum_value(RuleCondition_operator)),
            "relationshipType": lambda n : setattr(self, 'relationship_type', n.get_enum_value(RuleCondition_relationshipType)),
