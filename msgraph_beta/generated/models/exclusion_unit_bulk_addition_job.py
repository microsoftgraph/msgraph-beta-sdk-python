...
if TYPE_CHECKING:
    ...
    from .exclusion_unit_bulk_job_status import ExclusionUnitBulkJobStatus
...
class ExclusionUnitBulkAdditionJob(Entity, Parsable):
    ...
    # The status property
    status: Optional[ExclusionUnitBulkJobStatus] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ExclusionUnitBulkAdditionJob:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(ExclusionUnitBulkJobStatus)),
        }
