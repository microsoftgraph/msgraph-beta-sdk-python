...
@dataclass
class WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[WindowsDefenderApplicationControlSupplementalPolicy]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse:
        """
