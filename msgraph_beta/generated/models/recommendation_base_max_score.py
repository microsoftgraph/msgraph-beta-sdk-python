...
@dataclass
class RecommendationBase_maxScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecommendationBase_maxScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecommendationBase_maxScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = RecommendationBase_maxScore()
