...
if TYPE_CHECKING:
    ...
    from .user_experience_analytics_device_scores_mean_resource_spike_time_score import UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore
...
class UserExperienceAnalyticsDeviceScores(Entity):
    ...
    mean_resource_spike_time_score: Optional[UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "meanResourceSpikeTimeScore": lambda n : setattr(self, 'mean_resource_spike_time_score', n.get_object_value(UserExperienceAnalyticsDeviceScores_meanResourceSpikeTimeScore)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("meanResourceSpikeTimeScore", self.mean_resource_spike_time_score)
