...
@dataclass
class DeviceManagementSettingSddlConstraint(DeviceManagementConstraint, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementSettingSddlConstraint:
        """
