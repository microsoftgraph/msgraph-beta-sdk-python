...
class InternalDomainFederation(SamlOrWsFedProvider, Parsable):
    ...
    default_interactive_authentication_method: Optional[str] = None
    ...
    password_change_uri: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "defaultInteractiveAuthenticationMethod": lambda n : setattr(self, 'default_interactive_authentication_method', n.get_str_value()),
            ...
            "openIdConnectDiscoveryEndpoint": lambda n : setattr(self, 'open_id_connect_discovery_endpoint', n.get_str_value()),
            "passwordChangeUri": lambda n : setattr(self, 'password_change_uri', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("defaultInteractiveAuthenticationMethod", self.default_interactive_authentication_method)
        ...
        writer.write_str_value("openIdConnectDiscoveryEndpoint", self.open_id_connect_discovery_endpoint)
        writer.write_str_value("passwordChangeUri", self.password_change_uri)
