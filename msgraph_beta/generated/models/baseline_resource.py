...
@dataclass
class BaselineResource(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BaselineResource:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "properties": lambda n : setattr(self, 'properties', n.get_object_value(OpenComplexDictionaryType)),
