...
if TYPE_CHECKING:
    from .service_level_agreement_attainment_score import ServiceLevelAgreementAttainment_score
...
class ServiceLevelAgreementAttainment(AdditionalDataHolder, BackedModel, Parsable):
    ...
    score: Optional[ServiceLevelAgreementAttainment_score] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "score": lambda n : setattr(self, 'score', n.get_object_value(ServiceLevelAgreementAttainment_score)),
