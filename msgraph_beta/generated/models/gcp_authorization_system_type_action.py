...
@dataclass
class GcpAuthorizationSystemTypeAction(AuthorizationSystemTypeAction, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GcpAuthorizationSystemTypeAction:
        """
