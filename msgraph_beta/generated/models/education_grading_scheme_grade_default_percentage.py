...
@dataclass
class EducationGradingSchemeGrade_defaultPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EducationGradingSchemeGrade_defaultPercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: EducationGradingSchemeGrade_defaultPercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = EducationGradingSchemeGrade_defaultPercentage()
        if reference_numeric_value := parse_node.get_enum_value(ReferenceNumeric):
            result.reference_numeric = reference_numeric_value
        elif float_value := parse_node.get_float_value():
            result.float = float_value
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        if self.reference_numeric:
            ...
            writer.write_float_value(None, self.float)
        elif self.string:
