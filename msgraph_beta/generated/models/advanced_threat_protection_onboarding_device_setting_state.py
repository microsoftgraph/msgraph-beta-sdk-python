...
@dataclass
class AdvancedThreatProtectionOnboardingDeviceSettingState(Entity, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AdvancedThreatProtectionOnboardingDeviceSettingState:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "platformType": lambda n : setattr(self, 'platform_type', n.get_enum_value(DeviceType)),
