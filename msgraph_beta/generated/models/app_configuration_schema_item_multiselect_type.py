...
@dataclass
class AppConfigurationSchemaItemMultiselectType(AppConfigurationSchemaItemType, Parsable):
    """
    Multiselect configuration item inside an Android application's custom configuration schema.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.appConfigurationSchemaItemMultiselectType"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AppConfigurationSchemaItemMultiselectType:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "defaultValue": lambda n : setattr(self, 'default_value', n.get_collection_of_primitive_values(str)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("defaultValue", self.default_value)
