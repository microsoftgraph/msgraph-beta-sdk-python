...
@dataclass
class DeviceManagementExchangeDeviceClass(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    type: Optional[DeviceManagementExchangeAccessRuleType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(DeviceManagementExchangeAccessRuleType)),
        }
        return fields
