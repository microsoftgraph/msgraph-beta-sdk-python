...
@dataclass
class CloudCertificationAuthorityVersionUsage(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    issued_staged_leaf_certificate_count: Optional[int] = None
    # The OdataType property
    odata_type: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudCertificationAuthorityVersionUsage:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "issuedStagedLeafCertificateCount": lambda n : setattr(self, 'issued_staged_leaf_certificate_count', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("issuedStagedLeafCertificateCount", self.issued_staged_leaf_certificate_count)
