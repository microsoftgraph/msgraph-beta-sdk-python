...
@dataclass
class UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsResourcePerformance_ramSpikeTimePercentage()
