...
class IosEducationDeviceConfiguration(DeviceConfiguration):
    ...
    odata_type: Optional[str] = "#microsoft.graph.iosEducationDeviceConfiguration"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> IosEducationDeviceConfiguration:
        """
