...
class DeviceEnrollmentWindowsHelloForBusinessConfiguration(DeviceEnrollmentConfiguration):
    ...
    enhanced_sign_in_security: Optional[int] = None
    ...
    # Possible values of a property
    security_key_for_sign_in: Optional[Enablement] = None
    # Possible values of a property
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "enhancedSignInSecurity": lambda n : setattr(self, 'enhanced_sign_in_security', n.get_int_value()),
            ...
            "securityKeyForSignIn": lambda n : setattr(self, 'security_key_for_sign_in', n.get_enum_value(Enablement)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("securityKeyForSignIn", self.security_key_for_sign_in)
