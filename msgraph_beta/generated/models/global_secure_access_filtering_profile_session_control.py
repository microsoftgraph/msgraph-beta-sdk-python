...
@dataclass
class GlobalSecureAccessFilteringProfileSessionControl(ConditionalAccessSessionControl, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.globalSecureAccessFilteringProfileSessionControl"
    # Specifies the distinct identifier that is assigned to the security profile or filtering profile.
    profile_id: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GlobalSecureAccessFilteringProfileSessionControl:
        """
