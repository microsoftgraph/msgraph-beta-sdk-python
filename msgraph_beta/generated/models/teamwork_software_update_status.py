...
if TYPE_CHECKING:
    from .teamwork_software_update_status_software_freshness import TeamworkSoftwareUpdateStatus_softwareFreshness
...
class TeamworkSoftwareUpdateStatus(AdditionalDataHolder, BackedModel, Parsable):
    ...
    software_freshness: Optional[TeamworkSoftwareUpdateStatus_softwareFreshness] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "softwareFreshness": lambda n : setattr(self, 'software_freshness', n.get_enum_value(TeamworkSoftwareUpdateStatus_softwareFreshness)),
        }
        return fields
