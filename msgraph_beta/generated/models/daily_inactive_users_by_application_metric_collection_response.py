...
@dataclass
class DailyInactiveUsersByApplicationMetricCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[DailyInactiveUsersByApplicationMetric]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DailyInactiveUsersByApplicationMetricCollectionResponse:
        """
