...
@dataclass
class VirtualEventRegistratioCustomQuestion(VirtualEventRegistrationQuestionBase):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.virtualEventRegistratioCustomQuestion"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> VirtualEventRegistratioCustomQuestion:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: VirtualEventRegistratioCustomQuestion
        """
        if not parse_node:
