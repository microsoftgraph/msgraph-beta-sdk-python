...
class Entity(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> Entity:
        ...
        if mapping_value and mapping_value.casefold() == "#microsoft.graph.cloudPcBulkMove".casefold():
            from .cloud_pc_bulk_move import CloudPcBulkMove

            return CloudPcBulkMove()
        ...
        if mapping_value and mapping_value.casefold() == "#microsoft.graph.networkaccess.connection".casefold():
            from .networkaccess.connection import Connection
