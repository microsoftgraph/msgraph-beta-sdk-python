...
@dataclass
class DeviceManagementConfigurationStringSettingValueConstant_a54093e9(DeviceManagementConfigurationStringSettingValueDefaultTemplate, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationStringSettingValueConstant_a54093e9:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceManagementConfigurationStringSettingValueConstant_a54093e9
        """
