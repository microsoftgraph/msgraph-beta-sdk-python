...
@dataclass
class UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsBatteryHealthDeviceAppImpact_batteryUsagePercentage()
