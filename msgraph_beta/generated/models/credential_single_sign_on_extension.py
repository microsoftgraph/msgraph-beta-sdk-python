...
@dataclass
class CredentialSingleSignOnExtension(SingleSignOnExtension, Parsable):
    """
    Represents a Credential-type Single Sign-On extension profile.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.credentialSingleSignOnExtension"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CredentialSingleSignOnExtension:
        """
