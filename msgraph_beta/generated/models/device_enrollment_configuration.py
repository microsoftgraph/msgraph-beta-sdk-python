...
class DeviceEnrollmentConfiguration(Entity):
    ...
    device_enrollment_configuration_type: Optional[DeviceEnrollmentConfigurationType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "deviceEnrollmentConfigurationType": lambda n : setattr(self, 'device_enrollment_configuration_type', n.get_enum_value(DeviceEnrollmentConfigurationType)),
