...
if TYPE_CHECKING:
    ...
    from .android_for_work_scep_certificate_profile_certificate_store import AndroidForWorkScepCertificateProfile_certificateStore
...
class AndroidForWorkScepCertificateProfile(AndroidForWorkCertificateProfileBase):
    ...
    certificate_store: Optional[AndroidForWorkScepCertificateProfile_certificateStore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "certificateStore": lambda n : setattr(self, 'certificate_store', n.get_enum_value(AndroidForWorkScepCertificateProfile_certificateStore)),
