...
if TYPE_CHECKING:
    from .structured_data_entry_value_type import StructuredDataEntryValueType

@dataclass
class StructuredDataEntryTypedValue(AdditionalDataHolder, BackedModel, Parsable):
    ...
    # The type property
    type: Optional[StructuredDataEntryValueType] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StructuredDataEntryTypedValue:
        """
        ...
        return StructuredDataEntryTypedValue()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(StructuredDataEntryValueType)),
