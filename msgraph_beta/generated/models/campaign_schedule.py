...
@dataclass
class CampaignSchedule(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> CampaignSchedule:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(CampaignStatus)),
        }
        return fields
