...
@dataclass
class ManagedDeviceMobileAppConfigurationPolicySetItem(PolicySetItem, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ManagedDeviceMobileAppConfigurationPolicySetItem:
        """
