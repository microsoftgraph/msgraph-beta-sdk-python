...
@dataclass
class DeviceManagementConfigurationIntegerSettingValue(DeviceManagementConfigurationSimpleSettingValue, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationIntegerSettingValue:
        """
