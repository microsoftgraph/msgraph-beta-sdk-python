...
class CloudPcProvisioningPolicy(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "autopilotConfiguration": lambda n : setattr(self, 'autopilot_configuration', n.get_object_value(CloudPcAutopilotConfiguration)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("autopilotConfiguration", self.autopilot_configuration)
