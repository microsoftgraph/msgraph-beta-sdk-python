...
@dataclass
class CallActivityStatistics(ActivityStatistics, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.callActivityStatistics"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CallActivityStatistics:
        """
