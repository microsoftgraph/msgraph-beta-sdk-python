...
@dataclass
class DeviceManagementIntentCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[DeviceManagementIntent]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementIntentCollectionResponse:
        """
