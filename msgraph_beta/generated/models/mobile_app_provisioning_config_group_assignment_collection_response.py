...
@dataclass
class MobileAppProvisioningConfigGroupAssignmentCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[MobileAppProvisioningConfigGroupAssignment]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MobileAppProvisioningConfigGroupAssignmentCollectionResponse:
        """
