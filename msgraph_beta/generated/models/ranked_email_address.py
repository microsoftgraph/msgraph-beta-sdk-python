...
if TYPE_CHECKING:
    from .ranked_email_address_rank import RankedEmailAddress_rank
...
class RankedEmailAddress(AdditionalDataHolder, BackedModel, Parsable):
    ...
    rank: Optional[RankedEmailAddress_rank] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "rank": lambda n : setattr(self, 'rank', n.get_object_value(RankedEmailAddress_rank)),
        }
        return fields
