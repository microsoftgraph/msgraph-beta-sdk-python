...
@dataclass
class CloudFirewallSourceIpAddress(CloudFirewallSourceAddress, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.networkaccess.cloudFirewallSourceIpAddress"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudFirewallSourceIpAddress:
        """
