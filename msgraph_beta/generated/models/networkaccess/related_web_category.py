...
@dataclass
class RelatedWebCategory(RelatedResource):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> RelatedWebCategory:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "webCategoryName": lambda n : setattr(self, 'web_category_name', n.get_str_value()),
        }
