...
@dataclass
class CloudFirewallDestinationFqdnAddress(CloudFirewallDestinationAddress, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.networkaccess.cloudFirewallDestinationFqdnAddress"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudFirewallDestinationFqdnAddress:
        """
