...
if TYPE_CHECKING:
    ...
    from .cloud_firewall_protocol import CloudFirewallProtocol

@dataclass
class CloudFirewallDestinationMatching(AdditionalDataHolder, BackedModel, Parsable):
    ...
    addresses: Optional[list[CloudFirewallDestinationAddress]] = None
    ...
    protocols: Optional[CloudFirewallProtocol] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudFirewallDestinationMatching:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "addresses": lambda n : setattr(self, 'addresses', n.get_collection_of_object_values(CloudFirewallDestinationAddress)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "ports": lambda n : setattr(self, 'ports', n.get_collection_of_primitive_values(str)),
            "protocols": lambda n : setattr(self, 'protocols', n.get_collection_of_enum_values(CloudFirewallProtocol)),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("protocols", self.protocols)
