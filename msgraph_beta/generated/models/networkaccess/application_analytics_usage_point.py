...
@dataclass
class ApplicationAnalyticsUsagePoint(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApplicationAnalyticsUsagePoint:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "cloudAppsCount": lambda n : setattr(self, 'cloud_apps_count', n.get_int_value()),
            "enterpriseAppsCount": lambda n : setattr(self, 'enterprise_apps_count', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("cloudAppsCount", self.cloud_apps_count)
        writer.write_int_value("enterpriseAppsCount", self.enterprise_apps_count)
