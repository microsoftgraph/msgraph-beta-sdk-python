...
@dataclass
class MacOSManagedDeviceLocalAdminAccountDetail(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    password_last_rotated_date_time: Optional[datetime.datetime] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MacOSManagedDeviceLocalAdminAccountDetail:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "passwordLastRotatedDateTime": lambda n : setattr(self, 'password_last_rotated_date_time', n.get_datetime_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("passwordLastRotatedDateTime", self.password_last_rotated_date_time)
