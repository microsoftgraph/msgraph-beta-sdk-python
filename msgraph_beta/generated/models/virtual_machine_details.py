...
@dataclass
class VirtualMachineDetails(Entity, Parsable):
    # The OdataType property
    odata_type: Optional[str] = None
    # The virtualMachine property
    virtual_machine: Optional[AuthorizationSystemResource] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VirtualMachineDetails:
        """
