...
@dataclass
class AndroidCertificateProfileBase(DeviceConfiguration, Parsable):
    """
    Android certificate profile base.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.androidCertificateProfileBase"
    ...
    root_certificate: Optional[AndroidTrustedRootCertificate] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidCertificateProfileBase:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "rootCertificate": lambda n : setattr(self, 'root_certificate', n.get_object_value(AndroidTrustedRootCertificate)),
