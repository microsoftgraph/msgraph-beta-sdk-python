...
@dataclass
class AccessReviewInstanceDecisionItemAccessPackageAssignment_0e602484(AccessReviewInstanceDecisionItemResource, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AccessReviewInstanceDecisionItemAccessPackageAssignment_0e602484:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: AccessReviewInstanceDecisionItemAccessPackageAssignment_0e602484
        """
