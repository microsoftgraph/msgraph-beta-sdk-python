...
@dataclass
class AospDeviceOwnerScepCertificateProfile(AospDeviceOwnerCertificateProfileBase, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AospDeviceOwnerScepCertificateProfile:
        """
