...
class Person(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "emailAddresses": lambda n : setattr(self, 'email_addresses', n.get_collection_of_object_values(RankedEmailAddress)),
            ...
            "sources": lambda n : setattr(self, 'sources', n.get_collection_of_object_values(PersonDataSource)),
