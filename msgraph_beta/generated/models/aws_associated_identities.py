...
@dataclass
class AwsAssociatedIdentities(AdditionalDataHolder, BackedModel, Parsable):
    ...
    # The all property
    all: Optional[List[AwsIdentity]] = None
    # The OdataType property
    odata_type: Optional[str] = None
    # The roles property
    roles: Optional[List[AwsRole]] = None
    # The users property
    users: Optional[List[AwsUser]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AwsAssociatedIdentities:
        """
        ...
        return AwsAssociatedIdentities()
