...
@dataclass
class PlannerFieldRules(AdditionalDataHolder, BackedModel, Parsable):
    ...
    overrides: Optional[List[PlannerRuleOverride]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PlannerFieldRules:
        """
