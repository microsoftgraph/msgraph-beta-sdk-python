...
@dataclass
class AppConfigurationSchemaItemHiddenType(AppConfigurationSchemaItemType, Parsable):
    """
    Hidden configuration item inside an Android application's custom configuration schema.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.appConfigurationSchemaItemHiddenType"
    # Default value, if specified by the app developer
    default_value: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AppConfigurationSchemaItemHiddenType:
        """
