...
class DeviceConfigurationState(Entity):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceConfigurationState:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "settingStates": lambda n : setattr(self, 'setting_states', n.get_collection_of_object_values(DeviceConfigurationSettingState)),
