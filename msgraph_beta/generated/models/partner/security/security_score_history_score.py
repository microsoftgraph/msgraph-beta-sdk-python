...
@dataclass
class SecurityScoreHistory_score(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SecurityScoreHistory_score:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SecurityScoreHistory_score
        """
        ...
        try:
            ...
            mapping_value = None
        result = SecurityScoreHistory_score()
