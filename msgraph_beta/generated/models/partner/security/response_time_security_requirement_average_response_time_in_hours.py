...
@dataclass
class ResponseTimeSecurityRequirement_averageResponseTimeInHours(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ResponseTimeSecurityRequirement_averageResponseTimeInHours:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ResponseTimeSecurityRequirement_averageResponseTimeInHours
        """
        ...
        try:
            ...
            mapping_value = None
        result = ResponseTimeSecurityRequirement_averageResponseTimeInHours()
