...
@dataclass
class MobileAppCatalogPackageCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[MobileAppCatalogPackage]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> MobileAppCatalogPackageCollectionResponse:
        """
