...
@dataclass
class DeviceLogCollectionResponse_size(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceLogCollectionResponse_size:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceLogCollectionResponse_size
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceLogCollectionResponse_size()
