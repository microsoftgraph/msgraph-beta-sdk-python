...
@dataclass
class ApplicationTemplateCategory(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ApplicationTemplateCategory:
        """
        ...
        return ApplicationTemplateCategory()
