...
@dataclass
class KeyLongValuePair(AdditionalDataHolder, BackedModel, Parsable):
    """
    Key long value pair
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> KeyLongValuePair:
        """
