...
class Win32LobAppAutoUpdateSettings(AdditionalDataHolder, BackedModel, Parsable):
    ...
    auto_update_superseded_apps_state: Optional[Win32LobAutoUpdateSupersededAppsState] = None
    # The OdataType property
    odata_type: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Win32LobAppAutoUpdateSettings:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "autoUpdateSupersededAppsState": lambda n : setattr(self, 'auto_update_superseded_apps_state', n.get_enum_value(Win32LobAutoUpdateSupersededAppsState)),
