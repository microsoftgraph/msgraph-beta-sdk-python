...
if TYPE_CHECKING:
    from .call_event_call_event_type import CallEvent_callEventType
...
class CallEvent(Entity):
    ...
    call_event_type: Optional[CallEvent_callEventType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "callEventType": lambda n : setattr(self, 'call_event_type', n.get_enum_value(CallEvent_callEventType)),
