...
@dataclass
class EnrollmentTimeDeviceMembershipTarget(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    target_type: Optional[EnrollmentTimeDeviceMembershipTargetType] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EnrollmentTimeDeviceMembershipTarget:
        """
        ...
        return EnrollmentTimeDeviceMembershipTarget()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "targetType": lambda n : setattr(self, 'target_type', n.get_enum_value(EnrollmentTimeDeviceMembershipTargetType)),
        }
        return fields
