...
@dataclass
class DeviceManagementScriptPolicySetItem(PolicySetItem, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementScriptPolicySetItem:
        """
