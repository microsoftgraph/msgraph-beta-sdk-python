...
@dataclass
class WindowsRestoreDeviceEnrollmentConfiguration(DeviceEnrollmentConfiguration, Parsable):
    """
    ...
    odata_type: Optional[str] = "#microsoft.graph.windowsRestoreDeviceEnrollmentConfiguration"
    # Possible values of a property
    state: Optional[Enablement] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WindowsRestoreDeviceEnrollmentConfiguration:
        """
