...
@dataclass
class UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsRemoteConnection_cloudPcFailurePercentage()
