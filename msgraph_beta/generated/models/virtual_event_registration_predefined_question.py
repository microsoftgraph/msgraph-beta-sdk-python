...
if TYPE_CHECKING:
    from .virtual_event_registration_predefined_question_label import VirtualEventRegistrationPredefinedQuestion_label
...
class VirtualEventRegistrationPredefinedQuestion(VirtualEventRegistrationQuestionBase):
    ...
    # The label property
    label: Optional[VirtualEventRegistrationPredefinedQuestion_label] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> VirtualEventRegistrationPredefinedQuestion:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "label": lambda n : setattr(self, 'label', n.get_enum_value(VirtualEventRegistrationPredefinedQuestion_label)),
        }
