...
@dataclass
class CloudPcAgentPool(CloudPcPool, Parsable):
    ...
    session_usage: Optional[CloudPcAgentPoolSessionUsage] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CloudPcAgentPool:
        """
