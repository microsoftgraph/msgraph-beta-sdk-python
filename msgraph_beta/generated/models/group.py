...
if TYPE_CHECKING:
    ...
    from .group_access_type import Group_accessType
...
class Group(DirectoryObject):
    ...
    access_type: Optional[Group_accessType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "accessType": lambda n : setattr(self, 'access_type', n.get_enum_value(Group_accessType)),
