...
@dataclass
class TranscriptionState(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TranscriptionState:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "state": lambda n : setattr(self, 'state', n.get_enum_value(MediaState)),
        }
        return fields
