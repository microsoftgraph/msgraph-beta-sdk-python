...
@dataclass
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersion(Entity, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAppHealthAppPerformanceByAppVersion:
        """
