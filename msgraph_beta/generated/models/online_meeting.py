...
if TYPE_CHECKING:
    ...
    from .online_meeting_capabilities import OnlineMeeting_capabilities
...
class OnlineMeeting(OnlineMeetingBase):
    ...
    capabilities: Optional[List[OnlineMeeting_capabilities]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "capabilities": lambda n : setattr(self, 'capabilities', n.get_collection_of_enum_values(OnlineMeeting_capabilities)),
