...
@dataclass
class AndroidFotaDeploymentAssignmentTarget(DeviceAndAppManagementAssignmentTarget, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidFotaDeploymentAssignmentTarget:
        """
