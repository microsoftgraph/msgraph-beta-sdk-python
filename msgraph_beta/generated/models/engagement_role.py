...
@dataclass
class EngagementRole(Entity, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EngagementRole:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "members": lambda n : setattr(self, 'members', n.get_collection_of_object_values(EngagementRoleMember)),
        }
