...
@dataclass
class RolesAssignedOutsidePrivilegedIdentityManagementAlertCo_5cc28e38(UnifiedRoleManagementAlertConfiguration, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RolesAssignedOutsidePrivilegedIdentityManagementAlertCo_5cc28e38:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RolesAssignedOutsidePrivilegedIdentityManagementAlertCo_5cc28e38
        """
