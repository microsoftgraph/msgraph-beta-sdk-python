...
if TYPE_CHECKING:
    from .x509_certificate_user_binding_trust_affinity_level import X509CertificateUserBinding_trustAffinityLevel
...
class X509CertificateUserBinding(AdditionalDataHolder, BackedModel, Parsable):
    ...
    trust_affinity_level: Optional[X509CertificateUserBinding_trustAffinityLevel] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "trustAffinityLevel": lambda n : setattr(self, 'trust_affinity_level', n.get_enum_value(X509CertificateUserBinding_trustAffinityLevel)),
