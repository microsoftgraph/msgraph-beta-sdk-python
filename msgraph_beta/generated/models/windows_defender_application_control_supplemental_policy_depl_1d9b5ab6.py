...
@dataclass
class WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6(Entity, Parsable):
    """
    Contains properties for the deployment state of a WindowsDefenderApplicationControl supplemental policy for a device. Original name: WindowsDefenderApplicationControlSupplementalPolicyDeploymentStatus
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: WindowsDefenderApplicationControlSupplementalPolicyDepl_1d9b5ab6
        """
