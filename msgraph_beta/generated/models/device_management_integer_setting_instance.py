...
@dataclass
class DeviceManagementIntegerSettingInstance(DeviceManagementSettingInstance, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementIntegerSettingInstance:
        """
