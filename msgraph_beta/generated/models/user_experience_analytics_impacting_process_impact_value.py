...
@dataclass
class UserExperienceAnalyticsImpactingProcess_impactValue(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsImpactingProcess_impactValue:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsImpactingProcess_impactValue
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsImpactingProcess_impactValue()
