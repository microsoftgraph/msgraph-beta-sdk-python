...
@dataclass
class AssignmentFilterEvaluationStatusDetailsCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[AssignmentFilterEvaluationStatusDetails]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AssignmentFilterEvaluationStatusDetailsCollectionResponse:
        """
