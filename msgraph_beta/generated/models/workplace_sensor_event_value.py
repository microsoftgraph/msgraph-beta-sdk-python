...
@dataclass
class WorkplaceSensorEventValue(AdditionalDataHolder, BackedModel, Parsable):
    ...
    user: Optional[EmailIdentity] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> WorkplaceSensorEventValue:
        """
