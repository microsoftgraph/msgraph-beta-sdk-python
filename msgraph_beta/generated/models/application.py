...
class Application(DirectoryObject, Parsable):
    ...
    on_premises_publishing: Optional[OnPremisesPublishing] = None
    ...
    # Directory objects that are owners of this application. The owners are a set of nonadmin users or servicePrincipals who are allowed to modify this object. Read-only. Nullable. Supports $expand, $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1), and $select nested in $expand.
    ...
    windows: Optional[WindowsApplication] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "windows": lambda n : setattr(self, 'windows', n.get_object_value(WindowsApplication)),
        }
