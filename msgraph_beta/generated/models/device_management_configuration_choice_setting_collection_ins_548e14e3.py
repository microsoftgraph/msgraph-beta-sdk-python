...
@dataclass
class DeviceManagementConfigurationChoiceSettingCollectionIns_548e14e3(DeviceManagementConfigurationSettingInstanceTemplate, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationChoiceSettingCollectionIns_548e14e3:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceManagementConfigurationChoiceSettingCollectionIns_548e14e3
        """
