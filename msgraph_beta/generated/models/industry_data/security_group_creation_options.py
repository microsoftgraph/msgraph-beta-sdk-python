...
@dataclass
class SecurityGroupCreationOptions(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SecurityGroupCreationOptions:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "createBasedOnRoleGroup": lambda n : setattr(self, 'create_based_on_role_group', n.get_bool_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("createBasedOnRoleGroup", self.create_based_on_role_group)
