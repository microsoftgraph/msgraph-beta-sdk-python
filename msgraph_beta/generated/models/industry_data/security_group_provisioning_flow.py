...
@dataclass
class SecurityGroupProvisioningFlow(ProvisioningFlow):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.industryData.securityGroupProvisioningFlow"
    # The creationOptions property
    creation_options: Optional[SecurityGroupCreationOptions] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> SecurityGroupProvisioningFlow:
        """
