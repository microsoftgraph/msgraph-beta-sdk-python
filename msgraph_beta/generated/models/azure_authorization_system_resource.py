...
@dataclass
class AzureAuthorizationSystemResource(AuthorizationSystemResource, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AzureAuthorizationSystemResource:
        """
