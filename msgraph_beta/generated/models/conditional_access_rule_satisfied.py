...
if TYPE_CHECKING:
    from .conditional_access_rule_satisfied_conditional_access_condition import ConditionalAccessRuleSatisfied_conditionalAccessCondition
    from .conditional_access_rule_satisfied_rule_satisfied import ConditionalAccessRuleSatisfied_ruleSatisfied
...
class ConditionalAccessRuleSatisfied(AdditionalDataHolder, BackedModel, Parsable):
    ...
    conditional_access_condition: Optional[ConditionalAccessRuleSatisfied_conditionalAccessCondition] = None
    ...
    rule_satisfied: Optional[ConditionalAccessRuleSatisfied_ruleSatisfied] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "conditionalAccessCondition": lambda n : setattr(self, 'conditional_access_condition', n.get_enum_value(ConditionalAccessRuleSatisfied_conditionalAccessCondition)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "ruleSatisfied": lambda n : setattr(self, 'rule_satisfied', n.get_enum_value(ConditionalAccessRuleSatisfied_ruleSatisfied)),
        }
        return fields
