...
class WindowsManagedAppRegistration(ManagedAppRegistration):
    ...
    odata_type: Optional[str] = "#microsoft.graph.windowsManagedAppRegistration"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> WindowsManagedAppRegistration:
        """
