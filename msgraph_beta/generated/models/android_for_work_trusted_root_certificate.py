...
@dataclass
class AndroidForWorkTrustedRootCertificate(DeviceConfiguration, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidForWorkTrustedRootCertificate:
        """
