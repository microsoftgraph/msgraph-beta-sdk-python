...
if TYPE_CHECKING:
    ...
    from .windows_wifi_enterprise_e_a_p_configuration_authentication_method import WindowsWifiEnterpriseEAPConfiguration_authenticationMethod
    from .windows_wifi_enterprise_e_a_p_configuration_authentication_type import WindowsWifiEnterpriseEAPConfiguration_authenticationType
    from .windows_wifi_enterprise_e_a_p_configuration_inner_authentication_protocol_for_e_a_p_t_t_l_s import WindowsWifiEnterpriseEAPConfiguration_innerAuthenticationProtocolForEAPTTLS
    from .windows_wifi_enterprise_e_a_p_configuration_network_single_sign_on import WindowsWifiEnterpriseEAPConfiguration_networkSingleSignOn
...
class WindowsWifiEnterpriseEAPConfiguration(WindowsWifiConfiguration):
    ...
    authentication_method: Optional[WindowsWifiEnterpriseEAPConfiguration_authenticationMethod] = None
    ...
    authentication_type: Optional[WindowsWifiEnterpriseEAPConfiguration_authenticationType] = None
    ...
    inner_authentication_protocol_for_e_a_p_t_t_l_s: Optional[WindowsWifiEnterpriseEAPConfiguration_innerAuthenticationProtocolForEAPTTLS] = None
    ...
    network_single_sign_on: Optional[WindowsWifiEnterpriseEAPConfiguration_networkSingleSignOn] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "authenticationMethod": lambda n : setattr(self, 'authentication_method', n.get_enum_value(WindowsWifiEnterpriseEAPConfiguration_authenticationMethod)),
            ...
            "authenticationType": lambda n : setattr(self, 'authentication_type', n.get_enum_value(WindowsWifiEnterpriseEAPConfiguration_authenticationType)),
            ...
            "innerAuthenticationProtocolForEAPTTLS": lambda n : setattr(self, 'inner_authentication_protocol_for_e_a_p_t_t_l_s', n.get_enum_value(WindowsWifiEnterpriseEAPConfiguration_innerAuthenticationProtocolForEAPTTLS)),
            ...
            "networkSingleSignOn": lambda n : setattr(self, 'network_single_sign_on', n.get_enum_value(WindowsWifiEnterpriseEAPConfiguration_networkSingleSignOn)),
