...
@dataclass
class IosDdmVppAppAssignmentSettings(MobileAppAssignmentSettings, Parsable):
    """
    Contains properties used to assign an iOS Declarative Device Management (DDM) VPP mobile app to a group.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.iosDdmVppAppAssignmentSettings"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> IosDdmVppAppAssignmentSettings:
        """
