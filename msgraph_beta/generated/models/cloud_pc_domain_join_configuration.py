...
if TYPE_CHECKING:
    from .cloud_pc_domain_join_configuration_domain_join_type import CloudPcDomainJoinConfiguration_domainJoinType
    from .cloud_pc_domain_join_configuration_region_group import CloudPcDomainJoinConfiguration_regionGroup
    from .cloud_pc_domain_join_configuration_type import CloudPcDomainJoinConfiguration_type
...
class CloudPcDomainJoinConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    domain_join_type: Optional[CloudPcDomainJoinConfiguration_domainJoinType] = None
    ...
    region_group: Optional[CloudPcDomainJoinConfiguration_regionGroup] = None
    ...
    type: Optional[CloudPcDomainJoinConfiguration_type] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "domainJoinType": lambda n : setattr(self, 'domain_join_type', n.get_enum_value(CloudPcDomainJoinConfiguration_domainJoinType)),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "onPremisesConnectionId": lambda n : setattr(self, 'on_premises_connection_id', n.get_str_value()),
            "regionGroup": lambda n : setattr(self, 'region_group', n.get_enum_value(CloudPcDomainJoinConfiguration_regionGroup)),
            "regionName": lambda n : setattr(self, 'region_name', n.get_str_value()),
            "type": lambda n : setattr(self, 'type', n.get_enum_value(CloudPcDomainJoinConfiguration_type)),
        }
        return fields
