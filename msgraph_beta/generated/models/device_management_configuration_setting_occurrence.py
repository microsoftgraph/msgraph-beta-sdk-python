...
@dataclass
class DeviceManagementConfigurationSettingOccurrence(AdditionalDataHolder, BackedModel, Parsable):
    ...
    max_device_occurrence: Optional[int] = None
    # Minimum times setting can be set on device. A MinDeviceOccurrence of 0 means setting is optional
    min_device_occurrence: Optional[int] = None
    # The OdataType property
    odata_type: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationSettingOccurrence:
        """
