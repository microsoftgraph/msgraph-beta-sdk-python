...
if TYPE_CHECKING:
    ...
    from .online_meeting_base_allowed_presenters import OnlineMeetingBase_allowedPresenters
    from .online_meeting_base_allow_meeting_chat import OnlineMeetingBase_allowMeetingChat
    from .online_meeting_base_anonymize_identity_for_roles import OnlineMeetingBase_anonymizeIdentityForRoles
    from .online_meeting_base_share_meeting_chat_history_default import OnlineMeetingBase_shareMeetingChatHistoryDefault
...
class OnlineMeetingBase(Entity):
    ...
    allow_meeting_chat: Optional[OnlineMeetingBase_allowMeetingChat] = None
    ...
    allowed_presenters: Optional[OnlineMeetingBase_allowedPresenters] = None
    ...
    anonymize_identity_for_roles: Optional[List[OnlineMeetingBase_anonymizeIdentityForRoles]] = None
    ...
    share_meeting_chat_history_default: Optional[OnlineMeetingBase_shareMeetingChatHistoryDefault] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "allowMeetingChat": lambda n : setattr(self, 'allow_meeting_chat', n.get_enum_value(OnlineMeetingBase_allowMeetingChat)),
            ...
            "allowedPresenters": lambda n : setattr(self, 'allowed_presenters', n.get_enum_value(OnlineMeetingBase_allowedPresenters)),
            "anonymizeIdentityForRoles": lambda n : setattr(self, 'anonymize_identity_for_roles', n.get_collection_of_enum_values(OnlineMeetingBase_anonymizeIdentityForRoles)),
            ...
            "shareMeetingChatHistoryDefault": lambda n : setattr(self, 'share_meeting_chat_history_default', n.get_enum_value(OnlineMeetingBase_shareMeetingChatHistoryDefault)),
