...
@dataclass
class BookingAppointment_invoiceAmount(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BookingAppointment_invoiceAmount:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BookingAppointment_invoiceAmount
        """
        ...
        try:
            ...
            mapping_value = None
        result = BookingAppointment_invoiceAmount()
