...
@dataclass
class VideoNewsLinkPage(BaseSitePage, Parsable):
    ...
    video_duration: Optional[datetime.timedelta] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VideoNewsLinkPage:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "videoDuration": lambda n : setattr(self, 'video_duration', n.get_timedelta_value()),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_timedelta_value("videoDuration", self.video_duration)
