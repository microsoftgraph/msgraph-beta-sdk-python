...
@dataclass
class CountryRegionCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[CountryRegion]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CountryRegionCollectionResponse:
        """
