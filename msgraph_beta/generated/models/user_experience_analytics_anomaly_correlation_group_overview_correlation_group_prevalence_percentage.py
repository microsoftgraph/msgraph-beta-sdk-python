...
@dataclass
class UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsAnomalyCorrelationGroupOverview_correlationGroupPrevalencePercentage()
