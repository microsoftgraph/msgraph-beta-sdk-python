...
@dataclass
class AndroidForWorkImportedPFXCertificateProfile(AndroidCertificateProfileBase, Parsable):
    """
    Android For Work PFX Import certificate profile
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.androidForWorkImportedPFXCertificateProfile"
    # PFX Import Options.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidForWorkImportedPFXCertificateProfile:
        """
