...
class GuestSponsorTrigger(WorkflowExecutionTrigger, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GuestSponsorTrigger:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "minimumRequiredSponsors": lambda n : setattr(self, 'minimum_required_sponsors', n.get_int_value()),
        }
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("minimumRequiredSponsors", self.minimum_required_sponsors)
