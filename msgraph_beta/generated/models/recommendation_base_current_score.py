...
@dataclass
class RecommendationBase_currentScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RecommendationBase_currentScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RecommendationBase_currentScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = RecommendationBase_currentScore()
