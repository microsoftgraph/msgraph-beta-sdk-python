...
@dataclass
class CustomClaimConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "transformations": lambda n : setattr(self, 'transformations', n.get_collection_of_object_values(CustomClaimTransformation)),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("transformations", self.transformations)
