...
class Team(Entity):
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "discoverySettings": lambda n : setattr(self, 'discovery_settings', n.get_object_value(TeamDiscoverySettings)),
            ...
            "templateDefinition": lambda n : setattr(self, 'template_definition', n.get_object_value(TeamTemplateDefinition)),
