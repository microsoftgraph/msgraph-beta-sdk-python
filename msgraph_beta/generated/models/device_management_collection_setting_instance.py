...
@dataclass
class DeviceManagementCollectionSettingInstance(DeviceManagementSettingInstance, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementCollectionSettingInstance:
        """
