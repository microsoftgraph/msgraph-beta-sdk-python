...
@dataclass
class CustomUsernameSignInIdentifier(SignInIdentifierBase, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.customUsernameSignInIdentifier"
    # The validationRegEx property
    validation_reg_ex: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CustomUsernameSignInIdentifier:
        """
