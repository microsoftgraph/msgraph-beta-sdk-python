...
class SharedPCConfiguration(DeviceConfiguration):
    ...
    fast_first_sign_in: Optional[Enablement] = None
    ...
    # Possible values of a property
    local_storage: Optional[Enablement] = None
    # Specifies the daily start time of maintenance hour.
    maintenance_start_time: Optional[datetime.time] = None
    # Possible values of a property
    set_account_manager: Optional[Enablement] = None
    # Possible values of a property
    set_edu_policies: Optional[Enablement] = None
    # Possible values of a property
    set_power_policies: Optional[Enablement] = None
    # Possible values of a property
    sign_in_on_resume: Optional[Enablement] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "fastFirstSignIn": lambda n : setattr(self, 'fast_first_sign_in', n.get_enum_value(Enablement)),
            ...
            "localStorage": lambda n : setattr(self, 'local_storage', n.get_enum_value(Enablement)),
            "maintenanceStartTime": lambda n : setattr(self, 'maintenance_start_time', n.get_time_value()),
            "setAccountManager": lambda n : setattr(self, 'set_account_manager', n.get_enum_value(Enablement)),
            "setEduPolicies": lambda n : setattr(self, 'set_edu_policies', n.get_enum_value(Enablement)),
            "setPowerPolicies": lambda n : setattr(self, 'set_power_policies', n.get_enum_value(Enablement)),
            "signInOnResume": lambda n : setattr(self, 'sign_in_on_resume', n.get_enum_value(Enablement)),
        }
