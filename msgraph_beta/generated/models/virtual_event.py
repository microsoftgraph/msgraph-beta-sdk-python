...
if TYPE_CHECKING:
    ...
    from .virtual_event_status import VirtualEvent_status
...
class VirtualEvent(Entity):
    ...
    status: Optional[VirtualEvent_status] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "status": lambda n : setattr(self, 'status', n.get_enum_value(VirtualEvent_status)),
        }
