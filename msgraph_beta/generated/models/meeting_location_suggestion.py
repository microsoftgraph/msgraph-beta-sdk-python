...
@dataclass
class MeetingLocationSuggestion(AdditionalDataHolder, BackedModel, Parsable):
    ...
    time_slot_availabilities: Optional[list[TimeSlotAvailability]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MeetingLocationSuggestion:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "timeSlotAvailabilities": lambda n : setattr(self, 'time_slot_availabilities', n.get_collection_of_object_values(TimeSlotAvailability)),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("timeSlotAvailabilities", self.time_slot_availabilities)
