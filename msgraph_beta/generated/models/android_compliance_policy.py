...
@dataclass
class AndroidCompliancePolicy(DeviceCompliancePolicy, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidCompliancePolicy:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "restrictedApps": lambda n : setattr(self, 'restricted_apps', n.get_collection_of_object_values(AppListItem)),
