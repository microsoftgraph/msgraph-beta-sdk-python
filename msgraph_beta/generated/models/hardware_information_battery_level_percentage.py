...
@dataclass
class HardwareInformation_batteryLevelPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> HardwareInformation_batteryLevelPercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: HardwareInformation_batteryLevelPercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = HardwareInformation_batteryLevelPercentage()
