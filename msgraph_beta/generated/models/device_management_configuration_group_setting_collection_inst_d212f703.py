...
@dataclass
class DeviceManagementConfigurationGroupSettingCollectionInst_d212f703(DeviceManagementConfigurationSettingInstanceTemplate, Parsable):
    """
    Group Setting Collection Instance Template Original name: DeviceManagementConfigurationGroupSettingCollectionInstanceTemplate
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationGroupSettingCollectionInst_d212f703:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceManagementConfigurationGroupSettingCollectionInst_d212f703
        """
