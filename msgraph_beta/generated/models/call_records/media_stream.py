...
if TYPE_CHECKING:
    ...
    from .media_stream_average_audio_degradation import MediaStream_averageAudioDegradation
    from .media_stream_average_packet_loss_rate import MediaStream_averagePacketLossRate
    from .media_stream_average_ratio_of_concealed_samples import MediaStream_averageRatioOfConcealedSamples
    from .media_stream_average_received_frame_rate import MediaStream_averageReceivedFrameRate
    from .media_stream_average_video_frame_loss_percentage import MediaStream_averageVideoFrameLossPercentage
    from .media_stream_average_video_frame_rate import MediaStream_averageVideoFrameRate
    from .media_stream_average_video_packet_loss_rate import MediaStream_averageVideoPacketLossRate
    from .media_stream_direction import MediaStreamDirection
    from .media_stream_low_frame_rate_ratio import MediaStream_lowFrameRateRatio
    from .media_stream_low_video_processing_capability_ratio import MediaStream_lowVideoProcessingCapabilityRatio
    from .media_stream_max_packet_loss_rate import MediaStream_maxPacketLossRate
    from .media_stream_max_ratio_of_concealed_samples import MediaStream_maxRatioOfConcealedSamples
    from .media_stream_post_forward_error_correction_packet_loss_rate import MediaStream_postForwardErrorCorrectionPacketLossRate
...
class MediaStream(AdditionalDataHolder, BackedModel, Parsable):
    ...
    average_audio_degradation: Optional[MediaStream_averageAudioDegradation] = None
    ...
    average_packet_loss_rate: Optional[MediaStream_averagePacketLossRate] = None
    ...
    average_ratio_of_concealed_samples: Optional[MediaStream_averageRatioOfConcealedSamples] = None
    # Average frames per second received for all video streams computed over the duration of the session.
    average_received_frame_rate: Optional[MediaStream_averageReceivedFrameRate] = None
    ...
    average_video_frame_loss_percentage: Optional[MediaStream_averageVideoFrameLossPercentage] = None
    # Average frames per second received for a video stream, computed over the duration of the session.
    average_video_frame_rate: Optional[MediaStream_averageVideoFrameRate] = None
    # Average fraction of packets lost, as specified in RFC 3550, computed over the duration of the session.
    average_video_packet_loss_rate: Optional[MediaStream_averageVideoPacketLossRate] = None
    ...
    low_frame_rate_ratio: Optional[MediaStream_lowFrameRateRatio] = None
    # Fraction of the call that the client is running less than 70% expected video processing capability.
    low_video_processing_capability_ratio: Optional[MediaStream_lowVideoProcessingCapabilityRatio] = None
    ...
    max_packet_loss_rate: Optional[MediaStream_maxPacketLossRate] = None
    # Maximum ratio of packets concealed by the healer.
    max_ratio_of_concealed_samples: Optional[MediaStream_maxRatioOfConcealedSamples] = None
    ...
    post_forward_error_correction_packet_loss_rate: Optional[MediaStream_postForwardErrorCorrectionPacketLossRate] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "averageAudioDegradation": lambda n : setattr(self, 'average_audio_degradation', n.get_object_value(MediaStream_averageAudioDegradation)),
            ...
            "averagePacketLossRate": lambda n : setattr(self, 'average_packet_loss_rate', n.get_object_value(MediaStream_averagePacketLossRate)),
            "averageRatioOfConcealedSamples": lambda n : setattr(self, 'average_ratio_of_concealed_samples', n.get_object_value(MediaStream_averageRatioOfConcealedSamples)),
            "averageReceivedFrameRate": lambda n : setattr(self, 'average_received_frame_rate', n.get_object_value(MediaStream_averageReceivedFrameRate)),
            "averageRoundTripTime": lambda n : setattr(self, 'average_round_trip_time', n.get_timedelta_value()),
            "averageVideoFrameLossPercentage": lambda n : setattr(self, 'average_video_frame_loss_percentage', n.get_object_value(MediaStream_averageVideoFrameLossPercentage)),
            ...
            "averageVideoPacketLossRate": lambda n : setattr(self, 'average_video_packet_loss_rate', n.get_object_value(MediaStream_averageVideoPacketLossRate)),
            ...
            "lowFrameRateRatio": lambda n : setattr(self, 'low_frame_rate_ratio', n.get_object_value(MediaStream_lowFrameRateRatio)),
            "lowVideoProcessingCapabilityRatio": lambda n : setattr(self, 'low_video_processing_capability_ratio', n.get_object_value(MediaStream_lowVideoProcessingCapabilityRatio)),
            ...
            "maxPacketLossRate": lambda n : setattr(self, 'max_packet_loss_rate', n.get_object_value(MediaStream_maxPacketLossRate)),
            "maxRatioOfConcealedSamples": lambda n : setattr(self, 'max_ratio_of_concealed_samples', n.get_object_value(MediaStream_maxRatioOfConcealedSamples)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("averageAudioDegradation", self.average_audio_degradation)
        ...
        writer.write_object_value("averagePacketLossRate", self.average_packet_loss_rate)
        writer.write_object_value("averageRatioOfConcealedSamples", self.average_ratio_of_concealed_samples)
        writer.write_object_value("averageReceivedFrameRate", self.average_received_frame_rate)
        writer.write_timedelta_value("averageRoundTripTime", self.average_round_trip_time)
        writer.write_object_value("averageVideoFrameLossPercentage", self.average_video_frame_loss_percentage)
        writer.write_object_value("averageVideoFrameRate", self.average_video_frame_rate)
        writer.write_object_value("averageVideoPacketLossRate", self.average_video_packet_loss_rate)
        writer.write_datetime_value("endDateTime", self.end_date_time)
        writer.write_bool_value("isAudioForwardErrorCorrectionUsed", self.is_audio_forward_error_correction_used)
        writer.write_object_value("lowFrameRateRatio", self.low_frame_rate_ratio)
        writer.write_object_value("lowVideoProcessingCapabilityRatio", self.low_video_processing_capability_ratio)
        ...
        writer.write_object_value("maxPacketLossRate", self.max_packet_loss_rate)
        writer.write_object_value("maxRatioOfConcealedSamples", self.max_ratio_of_concealed_samples)
        ...
        writer.write_object_value("postForwardErrorCorrectionPacketLossRate", self.post_forward_error_correction_packet_loss_rate)
