...
@dataclass
class DeviceManagementComplexSettingInstance(DeviceManagementSettingInstance, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementComplexSettingInstance:
        """
