...
@dataclass
class Win32LobAppUninstallPowerShellScript(Win32LobAppScript, Parsable):
    """
    ...
    odata_type: Optional[str] = "#microsoft.graph.win32LobAppUninstallPowerShellScript"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Win32LobAppUninstallPowerShellScript:
        """
