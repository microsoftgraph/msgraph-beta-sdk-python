...
class WindowsFirewallNetworkProfile(AdditionalDataHolder, BackedModel, Parsable):
    ...
    authorized_application_rules_from_group_policy_not_merged: Optional[bool] = None
    ...
    connection_security_rules_from_group_policy_not_merged: Optional[bool] = None
    ...
    global_port_rules_from_group_policy_not_merged: Optional[bool] = None
    ...
    inbound_connections_required: Optional[bool] = None
    ...
    inbound_notifications_required: Optional[bool] = None
    ...
    incoming_traffic_required: Optional[bool] = None
    ...
    outbound_connections_required: Optional[bool] = None
    ...
    policy_rules_from_group_policy_not_merged: Optional[bool] = None
    ...
    secured_packet_exemption_blocked: Optional[bool] = None
    ...
    stealth_mode_required: Optional[bool] = None
    ...
    unicast_responses_to_multicast_broadcasts_required: Optional[bool] = None
