...
if TYPE_CHECKING:
    ...
    from .investigation_action_step import InvestigationActionStep
...
class MultiTenantApplicationMetrics(Entity, Parsable):
    ...
    # The recent property
    recent: Optional[MultiTenantApplicationMetricsRecent] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MultiTenantApplicationMetrics:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "investigationHints": lambda n : setattr(self, 'investigation_hints', n.get_collection_of_object_values(InvestigationActionStep)),
