...
@dataclass
class MacOSAssociatedDomainsItem(AdditionalDataHolder, BackedModel, Parsable):
    """
    ...
    direct_downloads_enabled: Optional[bool] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MacOSAssociatedDomainsItem:
        """
