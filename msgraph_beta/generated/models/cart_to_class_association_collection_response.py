...
@dataclass
class CartToClassAssociationCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[CartToClassAssociation]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> CartToClassAssociationCollectionResponse:
        """
