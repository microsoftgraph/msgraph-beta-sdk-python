...
@dataclass
class AppConfigurationSchemaItemIntegerType(AppConfigurationSchemaItemType, Parsable):
    """
    Integer configuration item inside an Android application's custom configuration schema.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.appConfigurationSchemaItemIntegerType"
    # Default value, if specified by the app developer. Valid values 0 to 2147483647
    default_value: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AppConfigurationSchemaItemIntegerType:
        """
