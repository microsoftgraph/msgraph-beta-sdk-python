...
@dataclass
class DeviceHealthStatus_startupPerformanceScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceHealthStatus_startupPerformanceScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceHealthStatus_startupPerformanceScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = DeviceHealthStatus_startupPerformanceScore()
