...
if TYPE_CHECKING:
    from .tenant_status_information_delegated_privilege_status import TenantStatusInformation_delegatedPrivilegeStatus
    from .tenant_status_information_onboarding_status import TenantStatusInformation_onboardingStatus
    from .tenant_status_information_tenant_onboarding_eligibility_reason import TenantStatusInformation_tenantOnboardingEligibilityReason
...
class TenantStatusInformation(AdditionalDataHolder, BackedModel, Parsable):
    ...
    delegated_privilege_status: Optional[TenantStatusInformation_delegatedPrivilegeStatus] = None
    ...
    onboarding_status: Optional[TenantStatusInformation_onboardingStatus] = None
    ...
    tenant_onboarding_eligibility_reason: Optional[TenantStatusInformation_tenantOnboardingEligibilityReason] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "delegatedPrivilegeStatus": lambda n : setattr(self, 'delegated_privilege_status', n.get_enum_value(TenantStatusInformation_delegatedPrivilegeStatus)),
            ...
            "onboardingStatus": lambda n : setattr(self, 'onboarding_status', n.get_enum_value(TenantStatusInformation_onboardingStatus)),
            "tenantOnboardingEligibilityReason": lambda n : setattr(self, 'tenant_onboarding_eligibility_reason', n.get_enum_value(TenantStatusInformation_tenantOnboardingEligibilityReason)),
