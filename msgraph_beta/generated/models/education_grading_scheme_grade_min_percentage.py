...
@dataclass
class EducationGradingSchemeGrade_minPercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EducationGradingSchemeGrade_minPercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: EducationGradingSchemeGrade_minPercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = EducationGradingSchemeGrade_minPercentage()
