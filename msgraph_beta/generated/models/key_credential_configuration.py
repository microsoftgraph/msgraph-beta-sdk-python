...
class KeyCredentialConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    # A unique identifier key for keyCredentialConfiguration. This value also represents the type of restriction being applied. Possible values are asymmetricKeyLifetime, and unknownFutureValue. Each value of restrictionType can be used only once per policy.
