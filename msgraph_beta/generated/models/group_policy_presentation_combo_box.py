...
@dataclass
class GroupPolicyPresentationComboBox(GroupPolicyUploadedPresentation, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GroupPolicyPresentationComboBox:
        """
