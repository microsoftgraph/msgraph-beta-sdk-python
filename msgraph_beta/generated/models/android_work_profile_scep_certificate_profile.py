...
@dataclass
class AndroidWorkProfileScepCertificateProfile(AndroidWorkProfileCertificateProfileBase, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidWorkProfileScepCertificateProfile:
        """
