...
@dataclass
class DeviceManagementComplianceActionItem(Entity, Parsable):
    """
    Scheduled Action for Rule
    """
    # Scheduled Action Type Enum
    action_type: Optional[DeviceManagementComplianceActionType] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementComplianceActionItem:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "actionType": lambda n : setattr(self, 'action_type', n.get_enum_value(DeviceManagementComplianceActionType)),
