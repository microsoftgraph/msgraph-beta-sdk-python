...
if TYPE_CHECKING:
    from .chat_message_policy_violation_dlp_action import ChatMessagePolicyViolation_dlpAction
    from .chat_message_policy_violation_policy_tip import ChatMessagePolicyViolationPolicyTip
    from .chat_message_policy_violation_user_action import ChatMessagePolicyViolation_userAction
    from .chat_message_policy_violation_verdict_details import ChatMessagePolicyViolation_verdictDetails
...
class ChatMessagePolicyViolation(AdditionalDataHolder, BackedModel, Parsable):
    ...
    dlp_action: Optional[ChatMessagePolicyViolation_dlpAction] = None
    ...
    user_action: Optional[ChatMessagePolicyViolation_userAction] = None
    ...
    verdict_details: Optional[ChatMessagePolicyViolation_verdictDetails] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "dlpAction": lambda n : setattr(self, 'dlp_action', n.get_enum_value(ChatMessagePolicyViolation_dlpAction)),
            ...
            "userAction": lambda n : setattr(self, 'user_action', n.get_enum_value(ChatMessagePolicyViolation_userAction)),
            "verdictDetails": lambda n : setattr(self, 'verdict_details', n.get_enum_value(ChatMessagePolicyViolation_verdictDetails)),
        }
        return fields
