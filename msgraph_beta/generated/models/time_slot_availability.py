...
@dataclass
class TimeSlotAvailability(TimeSlot, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.timeSlotAvailability"
    # The availability property
    availability: Optional[FreeBusyStatus] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TimeSlotAvailability:
        """
