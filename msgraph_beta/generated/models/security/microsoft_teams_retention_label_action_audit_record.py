...
@dataclass
class MicrosoftTeamsRetentionLabelActionAuditRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.microsoftTeamsRetentionLabelActionAuditRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MicrosoftTeamsRetentionLabelActionAuditRecord:
        """
