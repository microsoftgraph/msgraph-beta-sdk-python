...
if TYPE_CHECKING:
    from .verdict_category import VerdictCategory

@dataclass
class CompromiseIndicator(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CompromiseIndicator:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "verdict": lambda n : setattr(self, 'verdict', n.get_enum_value(VerdictCategory)),
        }
        return fields
