...
@dataclass
class CustomerKeyServiceEncryptionAuditRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.customerKeyServiceEncryptionAuditRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CustomerKeyServiceEncryptionAuditRecord:
        """
