...
class RulesRoot(Entity):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> RulesRoot:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "detectionRules": lambda n : setattr(self, 'detection_rules', n.get_collection_of_object_values(DetectionRule)),
        }
