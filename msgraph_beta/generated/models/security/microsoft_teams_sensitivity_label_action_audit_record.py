...
@dataclass
class MicrosoftTeamsSensitivityLabelActionAuditRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.microsoftTeamsSensitivityLabelActionAuditRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MicrosoftTeamsSensitivityLabelActionAuditRecord:
        """
