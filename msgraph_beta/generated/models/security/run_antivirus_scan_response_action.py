...
@dataclass
class RunAntivirusScanResponseAction(ResponseAction):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.runAntivirusScanResponseAction"
    # The identifier property
    identifier: Optional[DeviceIdEntityIdentifier] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> RunAntivirusScanResponseAction:
        """
