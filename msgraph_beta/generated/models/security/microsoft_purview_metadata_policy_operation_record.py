...
@dataclass
class MicrosoftPurviewMetadataPolicyOperationRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.microsoftPurviewMetadataPolicyOperationRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MicrosoftPurviewMetadataPolicyOperationRecord:
        """
