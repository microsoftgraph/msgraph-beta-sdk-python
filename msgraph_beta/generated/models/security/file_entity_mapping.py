...
@dataclass
class FileEntityMapping(EntityMapping, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.fileEntityMapping"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FileEntityMapping:
        """
