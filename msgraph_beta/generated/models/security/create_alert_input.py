...
@dataclass
class CreateAlertInput(AdditionalDataHolder, BackedModel, Parsable):
    ...
    entity_definitions: Optional[list[EntityDefinition]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreateAlertInput:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "entityDefinitions": lambda n : setattr(self, 'entity_definitions', n.get_collection_of_object_values(EntityDefinition)),
