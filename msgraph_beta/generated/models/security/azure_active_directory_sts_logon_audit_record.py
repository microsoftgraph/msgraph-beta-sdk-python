...
@dataclass
class AzureActiveDirectoryStsLogonAuditRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.azureActiveDirectoryStsLogonAuditRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AzureActiveDirectoryStsLogonAuditRecord:
        """
