...
if TYPE_CHECKING:
    from .tenant_allow_block_list_entry_result_entry_type import TenantAllowBlockListEntryResult_entryType
    from .tenant_allow_block_list_entry_result_status import TenantAllowBlockListEntryResult_status
...
class TenantAllowBlockListEntryResult(AdditionalDataHolder, BackedModel, Parsable):
    ...
    entry_type: Optional[TenantAllowBlockListEntryResult_entryType] = None
    ...
    status: Optional[TenantAllowBlockListEntryResult_status] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "entryType": lambda n : setattr(self, 'entry_type', n.get_enum_value(TenantAllowBlockListEntryResult_entryType)),
            "expirationDateTime": lambda n : setattr(self, 'expiration_date_time', n.get_datetime_value()),
            "identity": lambda n : setattr(self, 'identity', n.get_str_value()),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "status": lambda n : setattr(self, 'status', n.get_enum_value(TenantAllowBlockListEntryResult_status)),
