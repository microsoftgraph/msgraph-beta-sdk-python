...
@dataclass
class CollectInvestigationPackageResponseAction(ResponseAction, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CollectInvestigationPackageResponseAction:
        """
