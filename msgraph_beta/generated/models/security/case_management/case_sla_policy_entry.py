...
@dataclass
class CaseSlaPolicyEntry(AdditionalDataHolder, BackedModel, Parsable):
    ...
    breach_target_date_time: Optional[datetime.datetime] = None
    ...
    # The status property
    status: Optional[CaseSlaPolicyStatus] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CaseSlaPolicyEntry:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "breachTargetDateTime": lambda n : setattr(self, 'breach_target_date_time', n.get_datetime_value()),
            "@odata.type": lambda n : setattr(self, 'odata_type', n.get_str_value()),
            "policyDisplayName": lambda n : setattr(self, 'policy_display_name', n.get_str_value()),
            "policyId": lambda n : setattr(self, 'policy_id', n.get_str_value()),
            "status": lambda n : setattr(self, 'status', n.get_enum_value(CaseSlaPolicyStatus)),
        }
        return fields
