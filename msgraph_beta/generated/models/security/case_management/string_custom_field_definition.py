...
@dataclass
class StringCustomFieldDefinition(CustomFieldDefinition, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.caseManagement.stringCustomFieldDefinition"
    # The default string value applied to the field on a new case.
    default_value: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StringCustomFieldDefinition:
        """
