...
@dataclass
class ActivityResourceDetails(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ActivityResourceDetails:
        """
        ...
        return ActivityResourceDetails()
