...
@dataclass
class NumberCustomFieldDefinition(CustomFieldDefinition, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.caseManagement.numberCustomFieldDefinition"
    # The default numeric value applied to the field on a new case.
    default_value: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NumberCustomFieldDefinition:
        """
