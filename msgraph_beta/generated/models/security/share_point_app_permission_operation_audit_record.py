...
@dataclass
class SharePointAppPermissionOperationAuditRecord(AuditData):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.sharePointAppPermissionOperationAuditRecord"
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SharePointAppPermissionOperationAuditRecord:
        """
