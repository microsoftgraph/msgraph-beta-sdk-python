...
@dataclass
class EmailAction(AutomatedAction, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.emailAction"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EmailAction:
        """
