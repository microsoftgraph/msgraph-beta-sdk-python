...
@dataclass
class DeviceAction(AutomatedAction, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.deviceAction"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceAction:
        """
