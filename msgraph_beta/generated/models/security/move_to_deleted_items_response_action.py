...
@dataclass
class MoveToDeletedItemsResponseAction(ResponseAction):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.security.moveToDeletedItemsResponseAction"
    # The identifier property
    identifier: Optional[EmailEntityIdentifier] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> MoveToDeletedItemsResponseAction:
        """
