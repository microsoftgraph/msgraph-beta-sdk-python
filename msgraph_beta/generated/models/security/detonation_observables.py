...
class DetonationObservables(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> DetonationObservables:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_primitive_values("contactedIps", self.contacted_ips)
        writer.write_collection_of_primitive_values("contactedUrls", self.contacted_urls)
        writer.write_collection_of_primitive_values("droppedfiles", self.droppedfiles)
