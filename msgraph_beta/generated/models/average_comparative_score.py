...
class AverageComparativeScore(AdditionalDataHolder, BackedModel, Parsable):
    ...
    average_score: Optional[AverageComparativeScore_averageScore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "averageScore": lambda n : setattr(self, 'average_score', n.get_object_value(AverageComparativeScore_averageScore)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("averageScore", self.average_score)
