...
@dataclass
class DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd(DeviceManagementConfigurationChoiceSettingValueDefaultTemplate, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DeviceManagementConfigurationChoiceSettingValueConstant_24db14cd
        """
