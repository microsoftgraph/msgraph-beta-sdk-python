...
@dataclass
class AppConfigurationSchemaItemBooleanType(AppConfigurationSchemaItemType, Parsable):
    """
    Boolean configuration item inside an Android application's custom configuration schema.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.appConfigurationSchemaItemBooleanType"
    # Default value, if specified by the app developer
    default_value: Optional[bool] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AppConfigurationSchemaItemBooleanType:
        """
