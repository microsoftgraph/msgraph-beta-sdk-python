...
if TYPE_CHECKING:
    ...
    from .android_device_owner_enterprise_wi_fi_configuration_authentication_method import AndroidDeviceOwnerEnterpriseWiFiConfiguration_authenticationMethod
    from .android_device_owner_enterprise_wi_fi_configuration_inner_authentication_protocol_for_eap_ttls import AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls
    from .android_device_owner_enterprise_wi_fi_configuration_inner_authentication_protocol_for_peap import AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap
...
class AndroidDeviceOwnerEnterpriseWiFiConfiguration(AndroidDeviceOwnerWiFiConfiguration):
    ...
    authentication_method: Optional[AndroidDeviceOwnerEnterpriseWiFiConfiguration_authenticationMethod] = None
    ...
    inner_authentication_protocol_for_eap_ttls: Optional[AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls] = None
    ...
    inner_authentication_protocol_for_peap: Optional[AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "authenticationMethod": lambda n : setattr(self, 'authentication_method', n.get_enum_value(AndroidDeviceOwnerEnterpriseWiFiConfiguration_authenticationMethod)),
            ...
            "innerAuthenticationProtocolForEapTtls": lambda n : setattr(self, 'inner_authentication_protocol_for_eap_ttls', n.get_enum_value(AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls)),
            "innerAuthenticationProtocolForPeap": lambda n : setattr(self, 'inner_authentication_protocol_for_peap', n.get_enum_value(AndroidDeviceOwnerEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap)),
