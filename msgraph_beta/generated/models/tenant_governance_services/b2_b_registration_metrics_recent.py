...
class B2BRegistrationMetricsRecent(B2BRegistrationMetricsBase, Parsable):
    ...
    odata_type: Optional[str] = "#microsoft.graph.tenantGovernanceServices.b2BRegistrationMetricsRecent"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> B2BRegistrationMetricsRecent:
        """
