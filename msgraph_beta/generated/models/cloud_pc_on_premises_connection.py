...
if TYPE_CHECKING:
    ...
    from .cloud_pc_on_premises_connection_connection_type import CloudPcOnPremisesConnection_connectionType
    ...
    from .cloud_pc_on_premises_connection_type import CloudPcOnPremisesConnection_type
...
class CloudPcOnPremisesConnection(Entity):
    ...
    connection_type: Optional[CloudPcOnPremisesConnection_connectionType] = None
    ...
    type: Optional[CloudPcOnPremisesConnection_type] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "connectionType": lambda n : setattr(self, 'connection_type', n.get_enum_value(CloudPcOnPremisesConnection_connectionType)),
            ...
            "type": lambda n : setattr(self, 'type', n.get_enum_value(CloudPcOnPremisesConnection_type)),
