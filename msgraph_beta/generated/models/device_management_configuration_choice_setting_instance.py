...
@dataclass
class DeviceManagementConfigurationChoiceSettingInstance(DeviceManagementConfigurationSettingInstance, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceManagementConfigurationChoiceSettingInstance:
        """
