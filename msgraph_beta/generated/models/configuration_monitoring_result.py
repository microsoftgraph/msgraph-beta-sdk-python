...
if TYPE_CHECKING:
    ...
    from .monitor_run_type import MonitorRunType
...
class ConfigurationMonitoringResult(Entity, Parsable):
    ...
    # The driftsFixed property
    drifts_fixed: Optional[int] = None
    ...
    run_type: Optional[MonitorRunType] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "driftsFixed": lambda n : setattr(self, 'drifts_fixed', n.get_int_value()),
            ...
            "runType": lambda n : setattr(self, 'run_type', n.get_enum_value(MonitorRunType)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_enum_value("runType", self.run_type)
