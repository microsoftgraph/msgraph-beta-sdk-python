...
if TYPE_CHECKING:
    ...
    from .android_for_work_enterprise_wi_fi_configuration_authentication_method import AndroidForWorkEnterpriseWiFiConfiguration_authenticationMethod
    from .android_for_work_enterprise_wi_fi_configuration_inner_authentication_protocol_for_eap_ttls import AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls
    from .android_for_work_enterprise_wi_fi_configuration_inner_authentication_protocol_for_peap import AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap
...
class AndroidForWorkEnterpriseWiFiConfiguration(AndroidForWorkWiFiConfiguration):
    ...
    authentication_method: Optional[AndroidForWorkEnterpriseWiFiConfiguration_authenticationMethod] = None
    ...
    inner_authentication_protocol_for_eap_ttls: Optional[AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls] = None
    ...
    inner_authentication_protocol_for_peap: Optional[AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "authenticationMethod": lambda n : setattr(self, 'authentication_method', n.get_enum_value(AndroidForWorkEnterpriseWiFiConfiguration_authenticationMethod)),
            ...
            "innerAuthenticationProtocolForEapTtls": lambda n : setattr(self, 'inner_authentication_protocol_for_eap_ttls', n.get_enum_value(AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForEapTtls)),
            "innerAuthenticationProtocolForPeap": lambda n : setattr(self, 'inner_authentication_protocol_for_peap', n.get_enum_value(AndroidForWorkEnterpriseWiFiConfiguration_innerAuthenticationProtocolForPeap)),
            "outerIdentityPrivacyTemporaryValue": lambda n : setattr(self, 'outer_identity_privacy_temporary_value', n.get_str_value()),
            "rootCertificateForServerValidation": lambda n : setattr(self, 'root_certificate_for_server_validation', n.get_object_value(AndroidForWorkTrustedRootCertificate)),
