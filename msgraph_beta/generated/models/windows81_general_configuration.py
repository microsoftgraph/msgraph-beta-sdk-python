...
if TYPE_CHECKING:
    ...
    from .update_classification import UpdateClassification
...
class Windows81GeneralConfiguration(DeviceConfiguration):
    ...
    minimum_auto_install_classification: Optional[UpdateClassification] = None
    ...
    # Possible values for automatic update classification.
    updates_minimum_auto_install_classification: Optional[UpdateClassification] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "minimumAutoInstallClassification": lambda n : setattr(self, 'minimum_auto_install_classification', n.get_enum_value(UpdateClassification)),
            ...
            "updatesMinimumAutoInstallClassification": lambda n : setattr(self, 'updates_minimum_auto_install_classification', n.get_enum_value(UpdateClassification)),
