...
@dataclass
class EditionCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[Edition]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> EditionCollectionResponse:
        """
