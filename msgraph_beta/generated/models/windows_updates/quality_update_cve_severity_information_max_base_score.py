...
@dataclass
class QualityUpdateCveSeverityInformation_maxBaseScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> QualityUpdateCveSeverityInformation_maxBaseScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: QualityUpdateCveSeverityInformation_maxBaseScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = QualityUpdateCveSeverityInformation_maxBaseScore()
