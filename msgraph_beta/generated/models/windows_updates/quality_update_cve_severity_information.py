...
if TYPE_CHECKING:
    ...
    from .quality_update_cve_severity_information_max_base_score import QualityUpdateCveSeverityInformation_maxBaseScore
...
class QualityUpdateCveSeverityInformation(AdditionalDataHolder, BackedModel, Parsable):
    ...
    max_base_score: Optional[QualityUpdateCveSeverityInformation_maxBaseScore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "maxBaseScore": lambda n : setattr(self, 'max_base_score', n.get_object_value(QualityUpdateCveSeverityInformation_maxBaseScore)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_object_value("maxBaseScore", self.max_base_score)
