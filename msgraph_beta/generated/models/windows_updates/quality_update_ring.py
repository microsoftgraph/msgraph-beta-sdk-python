...
@dataclass
class QualityUpdateRing(Ring, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.windowsUpdates.qualityUpdateRing"
    # Identifies whether a hotpatch update is available.
    is_hotpatch_enabled: Optional[bool] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> QualityUpdateRing:
        """
