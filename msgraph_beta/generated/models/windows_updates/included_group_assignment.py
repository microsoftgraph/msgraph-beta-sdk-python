...
@dataclass
class IncludedGroupAssignment(GroupAssignment, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.windowsUpdates.includedGroupAssignment"
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> IncludedGroupAssignment:
        """
