...
@dataclass
class TokenProtectionStatusDetails(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TokenProtectionStatusDetails:
        """
        ...
        return TokenProtectionStatusDetails()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "signInSessionStatus": lambda n : setattr(self, 'sign_in_session_status', n.get_enum_value(TokenProtectionStatus)),
            "signInSessionStatusCode": lambda n : setattr(self, 'sign_in_session_status_code', n.get_int_value()),
        }
        return fields
