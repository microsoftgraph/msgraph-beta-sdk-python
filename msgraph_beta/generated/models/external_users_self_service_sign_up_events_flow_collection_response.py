...
@dataclass
class ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse(BaseCollectionPaginationCountResponse):
    # The value property
    value: Optional[List[ExternalUsersSelfServiceSignUpEventsFlow]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse:
        """
