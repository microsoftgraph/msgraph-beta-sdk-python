...
@dataclass
class AndroidWorkProfileEnterpriseWiFiConfiguration(AndroidWorkProfileWiFiConfiguration, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidWorkProfileEnterpriseWiFiConfiguration:
        """
