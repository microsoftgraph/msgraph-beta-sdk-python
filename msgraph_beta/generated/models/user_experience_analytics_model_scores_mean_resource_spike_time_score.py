...
@dataclass
class UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore()
