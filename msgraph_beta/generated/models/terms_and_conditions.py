...
class TermsAndConditions(Entity):
    ...
    group_assignments: Optional[List[TermsAndConditionsGroupAssignment]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "groupAssignments": lambda n : setattr(self, 'group_assignments', n.get_collection_of_object_values(TermsAndConditionsGroupAssignment)),
