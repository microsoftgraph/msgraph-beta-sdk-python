...
if TYPE_CHECKING:
    ...
    from .user_experience_analytics_model_scores_mean_resource_spike_time_score import UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore
...
class UserExperienceAnalyticsModelScores(Entity):
    ...
    mean_resource_spike_time_score: Optional[UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "meanResourceSpikeTimeScore": lambda n : setattr(self, 'mean_resource_spike_time_score', n.get_object_value(UserExperienceAnalyticsModelScores_meanResourceSpikeTimeScore)),
