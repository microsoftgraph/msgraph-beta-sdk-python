...
@dataclass
class RedundantAssignmentAlertIncident(UnifiedRoleManagementAlertIncident, Parsable):
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.redundantAssignmentAlertIncident"
    ...
    last_activation_date_time: Optional[datetime.datetime] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RedundantAssignmentAlertIncident:
        """
