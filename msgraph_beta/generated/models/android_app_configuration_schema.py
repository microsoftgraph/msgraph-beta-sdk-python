...
if TYPE_CHECKING:
    from .app_configuration_schema_item_type import AppConfigurationSchemaItemType
    from .entity import Entity

from .entity import Entity

@dataclass
class AndroidAppConfigurationSchema(Entity, Parsable):
    """
    ...
    nested_schema_items: Optional[list[AppConfigurationSchemaItemType]] = None
    ...
    schema_items: Optional[list[AppConfigurationSchemaItemType]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidAppConfigurationSchema:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "nestedSchemaItems": lambda n : setattr(self, 'nested_schema_items', n.get_collection_of_object_values(AppConfigurationSchemaItemType)),
            "schemaItems": lambda n : setattr(self, 'schema_items', n.get_collection_of_object_values(AppConfigurationSchemaItemType)),
        }
