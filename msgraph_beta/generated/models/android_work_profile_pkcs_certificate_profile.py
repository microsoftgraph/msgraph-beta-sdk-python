...
@dataclass
class AndroidWorkProfilePkcsCertificateProfile(AndroidWorkProfileCertificateProfileBase, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AndroidWorkProfilePkcsCertificateProfile:
        """
