...
@dataclass
class UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage(BackedModel, ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage
        """
        ...
        try:
            ...
            mapping_value = None
        result = UserExperienceAnalyticsBatteryHealthAppImpact_batteryUsagePercentage()
