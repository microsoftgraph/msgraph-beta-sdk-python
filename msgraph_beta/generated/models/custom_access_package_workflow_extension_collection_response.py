...
@dataclass
class CustomAccessPackageWorkflowExtensionCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[CustomAccessPackageWorkflowExtension]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CustomAccessPackageWorkflowExtensionCollectionResponse:
        """
