...
if TYPE_CHECKING:
    from .cloud_pc_tenant_encryption_setting_tenant_disk_encryption_type import CloudPcTenantEncryptionSetting_tenantDiskEncryptionType
...
class CloudPcTenantEncryptionSetting(AdditionalDataHolder, BackedModel, Parsable):
    ...
    tenant_disk_encryption_type: Optional[CloudPcTenantEncryptionSetting_tenantDiskEncryptionType] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "tenantDiskEncryptionType": lambda n : setattr(self, 'tenant_disk_encryption_type', n.get_enum_value(CloudPcTenantEncryptionSetting_tenantDiskEncryptionType)),
        }
        return fields
