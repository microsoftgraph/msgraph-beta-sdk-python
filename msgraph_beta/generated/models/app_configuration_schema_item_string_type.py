...
@dataclass
class AppConfigurationSchemaItemStringType(AppConfigurationSchemaItemType, Parsable):
    """
    String configuration item inside an Android application's custom configuration schema.
    """
    # The OdataType property
    odata_type: Optional[str] = "#microsoft.graph.appConfigurationSchemaItemStringType"
    # Default value, if specified by the app developer
    default_value: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> AppConfigurationSchemaItemStringType:
        """
