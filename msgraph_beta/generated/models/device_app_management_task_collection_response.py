...
@dataclass
class DeviceAppManagementTaskCollectionResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[DeviceAppManagementTask]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeviceAppManagementTaskCollectionResponse:
        """
