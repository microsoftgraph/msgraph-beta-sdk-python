...
@dataclass
class ContainerFilter(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ContainerFilter:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "includedContainers": lambda n : setattr(self, 'included_containers', n.get_collection_of_primitive_values(str)),
