...
@dataclass
class TeamsAppDashboardCardBotConfiguration(AdditionalDataHolder, BackedModel, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> TeamsAppDashboardCardBotConfiguration:
        """
        ...
        return TeamsAppDashboardCardBotConfiguration()
