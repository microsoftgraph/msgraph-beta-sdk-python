...
class CustomerPaymentJournalsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CustomerPaymentJournalCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[CustomerPaymentJournal] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CustomerPaymentJournal]:
        """
    ...
    def to_post_request_information(self,body: Optional[CustomerPaymentJournal] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to customerPaymentJournals for financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
