...
class SalesOrderLineItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SalesOrderLine]:
        """
    ...
    async def patch(self,body: Optional[SalesOrderLine] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[SalesOrderLine]:
        """
    ...
    def to_patch_request_information(self,body: Optional[SalesOrderLine] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property salesOrderLines in financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
