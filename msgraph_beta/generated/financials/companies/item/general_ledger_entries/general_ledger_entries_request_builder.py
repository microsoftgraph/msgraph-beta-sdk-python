...
class GeneralLedgerEntriesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GeneralLedgerEntriesRequestBuilderGetQueryParameters]] = None) -> Optional[GeneralLedgerEntryCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GeneralLedgerEntriesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get generalLedgerEntries from financials
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GeneralLedgerEntriesRequestBuilder:
        """
    ...
    @dataclass
    class GeneralLedgerEntriesRequestBuilderGetRequestConfiguration(RequestConfiguration[GeneralLedgerEntriesRequestBuilderGetQueryParameters]):
        """
