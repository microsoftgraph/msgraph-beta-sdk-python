...
class DimensionItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/dimensions/{dimension%2Did}{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[DimensionItemRequestBuilderGetRequestConfiguration] = None) -> Optional[Dimension]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DimensionItemRequestBuilder:
        """
    ...
    @dataclass
    class DimensionItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[DimensionItemRequestBuilder.DimensionItemRequestBuilderGetQueryParameters] = None
