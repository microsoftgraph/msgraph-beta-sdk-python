...
class JournalsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[JournalCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[Journal] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Journal]:
        """
    ...
    def to_post_request_information(self,body: Optional[Journal] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to journals for financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
