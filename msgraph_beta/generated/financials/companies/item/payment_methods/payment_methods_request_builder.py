...
if TYPE_CHECKING:
    ...
    from .....models.payment_method_collection_response import PaymentMethodCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.payment_method_item_request_builder import PaymentMethodItemRequestBuilder
...
class PaymentMethodsRequestBuilder(BaseRequestBuilder):
    ...
    def by_payment_method_id(self,payment_method_id: UUID) -> PaymentMethodItemRequestBuilder:
        """
        Provides operations to manage the paymentMethods property of the microsoft.graph.company entity.
        param payment_method_id: The unique identifier of paymentMethod
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PaymentMethodsRequestBuilderGetQueryParameters]] = None) -> Optional[PaymentMethodCollectionResponse]:
        """
        Get paymentMethods from financials
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PaymentMethodCollectionResponse]
        """
    ...
    async def post(self,body: PaymentMethod, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PaymentMethod]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[PaymentMethodsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/financials/companies/{company%2Did}/paymentMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: PaymentMethod, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to paymentMethods for financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/financials/companies/{company%2Did}/paymentMethods', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
