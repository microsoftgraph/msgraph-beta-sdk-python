...
class EmployeeItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Employee]:
        """
    ...
    async def patch(self,body: Optional[Employee] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Employee]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Employee] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property employees in financials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
