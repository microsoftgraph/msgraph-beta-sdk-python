...
class SalesQuotesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/salesQuotes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SalesQuotesRequestBuilderGetQueryParameters]] = None) -> Optional[SalesQuoteCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SalesQuotesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get salesQuotes from financials
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SalesQuotesRequestBuilder:
        """
    ...
    @dataclass
    class SalesQuotesRequestBuilderGetRequestConfiguration(RequestConfiguration[SalesQuotesRequestBuilderGetQueryParameters]):
        """
