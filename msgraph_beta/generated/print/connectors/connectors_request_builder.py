...
class ConnectorsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[PrintConnector] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrintConnector]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrintConnector] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to connectors for print
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
