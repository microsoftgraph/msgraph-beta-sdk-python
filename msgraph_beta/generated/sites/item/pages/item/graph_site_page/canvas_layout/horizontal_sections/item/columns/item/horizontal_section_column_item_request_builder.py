...
class HorizontalSectionColumnItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[HorizontalSectionColumn]:
        """
    ...
    async def patch(self,body: Optional[HorizontalSectionColumn] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[HorizontalSectionColumn]:
        """
    ...
    def to_patch_request_information(self,body: Optional[HorizontalSectionColumn] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property columns in sites
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
