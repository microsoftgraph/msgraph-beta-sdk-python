...
if TYPE_CHECKING:
    ...
    from ....models.base_site_page_collection_response import BaseSitePageCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.base_site_page_item_request_builder import BaseSitePageItemRequestBuilder
...
class PagesRequestBuilder(BaseRequestBuilder):
    ...
    def by_base_site_page_id(self,base_site_page_id: str) -> BaseSitePageItemRequestBuilder:
        """
        Provides operations to manage the pages property of the microsoft.graph.site entity.
        param base_site_page_id: The unique identifier of baseSitePage
        Returns: BaseSitePageItemRequestBuilder
        """
        if not base_site_page_id:
            raise TypeError("base_site_page_id cannot be null.")
        from .item.base_site_page_item_request_builder import BaseSitePageItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[PagesRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseSitePageCollectionResponse]:
        """
        Get the collection of baseSitePage][] objects from the site pages [list][] in a [site][]. All pages in the site are returned (with pagination). Sort alphabetically by name in ascending order. The following table lists the available subtypes. This API is available in the following [national cloud deployments.
    ...
    async def post(self,body: Optional[BaseSitePage] = None, request_configuration: Optional[PagesRequestBuilderPostRequestConfiguration] = None) -> Optional[BaseSitePage]:
        """
        Create a new sitePage][] in the site pages [list][] in a [site][]. This API is available in the following [national cloud deployments.
