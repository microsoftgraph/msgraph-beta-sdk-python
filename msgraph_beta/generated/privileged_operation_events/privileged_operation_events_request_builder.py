...
class PrivilegedOperationEventsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedOperationEventCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegedOperationEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedOperationEvent]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrivilegedOperationEvent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to privilegedOperationEvents
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
