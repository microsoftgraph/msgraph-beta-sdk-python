...
class KeepAliveRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/app/calls/{call%2Did}/keepAlive", path_parameters)
    ...
    def with_url(self,raw_url: str) -> KeepAliveRequestBuilder:
        """
    ...
    @dataclass
    class KeepAliveRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
