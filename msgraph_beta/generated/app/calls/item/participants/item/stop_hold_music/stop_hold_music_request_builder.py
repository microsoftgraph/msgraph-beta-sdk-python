...
class StopHoldMusicRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[StopHoldMusicPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[StopHoldMusicOperation]:
        """
    ...
    def to_post_request_information(self,body: Optional[StopHoldMusicPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Reincorporate a participant previously put on hold to the call.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
