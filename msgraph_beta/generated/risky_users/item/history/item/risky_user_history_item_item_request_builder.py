...
class RiskyUserHistoryItemItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}{?%24expand,%24select}", path_parameters)
    ...
    async def patch(self,body: Optional[RiskyUserHistoryItem] = None, request_configuration: Optional[RiskyUserHistoryItemItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[RiskyUserHistoryItem]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RiskyUserHistoryItemItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[RiskyUserHistoryItem] = None, request_configuration: Optional[RiskyUserHistoryItemItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property history in riskyUsers
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> RiskyUserHistoryItemItemRequestBuilder:
        """
    ...
    @dataclass
    class RiskyUserHistoryItemItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class RiskyUserHistoryItemItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[RiskyUserHistoryItemItemRequestBuilder.RiskyUserHistoryItemItemRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class RiskyUserHistoryItemItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
