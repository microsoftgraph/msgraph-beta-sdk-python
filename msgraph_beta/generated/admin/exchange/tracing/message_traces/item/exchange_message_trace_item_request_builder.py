...
class ExchangeMessageTraceItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/tracing/messageTraces/{exchangeMessageTrace%2Did}", path_parameters)
    ...
    def get_details_by_recipient_with_recipient_address(self,recipient_address: str) -> GetDetailsByRecipientWithRecipientAddressRequestBuilder:
        """
        ...
        return GetDetailsByRecipientWithRecipientAddressRequestBuilder(self.request_adapter, self.path_parameters, recipient_address)
    
    async def patch(self,body: ExchangeMessageTrace, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ExchangeMessageTrace]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ExchangeMessageTraceItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn("Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/admin/exchange/tracing/messageTraces/{exchangeMessageTrace%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: ExchangeMessageTrace, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property messageTraces in admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ExchangeMessageTraceItemRequestBuilder:
        """
    ...
    @dataclass
    class ExchangeMessageTraceItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class ExchangeMessageTraceItemRequestBuilderGetRequestConfiguration(RequestConfiguration[ExchangeMessageTraceItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class ExchangeMessageTraceItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
