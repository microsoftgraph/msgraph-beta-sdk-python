...
class FoldersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_mailbox_folder_id(self,mailbox_folder_id: str) -> MailboxFolderItemRequestBuilder:
        """
        Provides operations to manage the folders property of the microsoft.graph.mailbox entity.
        ...
        url_tpl_params["mailboxFolder%2Did"] = mailbox_folder_id
    ...
    @dataclass
    class FoldersRequestBuilderGetRequestConfiguration(RequestConfiguration[FoldersRequestBuilderGetQueryParameters]):
        """
