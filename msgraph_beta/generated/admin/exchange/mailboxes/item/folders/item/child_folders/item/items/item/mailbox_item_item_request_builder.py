...
if TYPE_CHECKING:
    from ...........models.mailbox_item import MailboxItem
    from ...........models.o_data_errors.o_data_error import ODataError

class MailboxItemItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/{mailboxFolder%2Did1}/items/{mailboxItem%2Did}{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MailboxItemItemRequestBuilderGetQueryParameters]] = None) -> Optional[MailboxItem]:
        ...
        return await self.request_adapter.send_async(request_info, MailboxItem, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MailboxItemItemRequestBuilder:
        """
    ...
    @dataclass
    class MailboxItemItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class MailboxItemItemRequestBuilderGetRequestConfiguration(RequestConfiguration[MailboxItemItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
