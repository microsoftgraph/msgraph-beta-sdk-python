...
if TYPE_CHECKING:
    from ..........models.mailbox_item_collection_response import MailboxItemCollectionResponse
...
class ItemsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/{mailboxFolder%2Did1}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_mailbox_item_id(self,mailbox_item_id: str) -> MailboxItemItemRequestBuilder:
        """
        Provides operations to manage the items property of the microsoft.graph.mailboxFolder entity.
        ...
        url_tpl_params["mailboxItem%2Did"] = mailbox_item_id
        return MailboxItemItemRequestBuilder(self.request_adapter, url_tpl_params)
