...
class ChildFoldersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_mailbox_folder_id1(self,mailbox_folder_id1: str) -> MailboxFolderItemRequestBuilder:
        """
        Provides operations to manage the childFolders property of the microsoft.graph.mailboxFolder entity.
        param mailbox_folder_id1: The unique identifier of mailboxFolder
        ...
        if mailbox_folder_id1 is None:
            raise TypeError("mailbox_folder_id1 cannot be null.")
        from .item.mailbox_folder_item_request_builder import MailboxFolderItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["mailboxFolder%2Did1"] = mailbox_folder_id1
        return MailboxFolderItemRequestBuilder(self.request_adapter, url_tpl_params)
