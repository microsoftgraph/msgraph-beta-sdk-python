...
if TYPE_CHECKING:
    from ......models.mailbox_item_import_session import MailboxItemImportSession
    from ......models.o_data_errors.o_data_error import ODataError

class CreateImportSessionRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/createImportSession", path_parameters)
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MailboxItemImportSession]:
        ...
        return await self.request_adapter.send_async(request_info, MailboxItemImportSession, error_mapping)
    ...
    def with_url(self,raw_url: str) -> CreateImportSessionRequestBuilder:
        """
    ...
    @dataclass
    class CreateImportSessionRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
