...
if TYPE_CHECKING:
    ...
    from .export_items_post_request_body import ExportItemsPostRequestBody
    from .export_items_post_response import ExportItemsPostResponse

class ExportItemsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/exportItems", path_parameters)
    ...
    async def post(self,body: ExportItemsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ExportItemsPostResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ExportItemsPostResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> ExportItemsRequestBuilder:
        """
    ...
    @dataclass
    class ExportItemsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
