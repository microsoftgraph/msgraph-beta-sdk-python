...
if TYPE_CHECKING:
    ...
    from .get_known_issues_by_time_range_with_days_in_past_with_include_all_ac_1ad18fab import GetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllAc_1ad18fab

class MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], days_in_past: Optional[int] = None) -> None:
        """
        Instantiates a new MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllActiveRequestBuilderGetQueryParameters]] = None) -> Optional[GetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllAc_1ad18fab]:
        """
        Get known issues related to a particular product based on a specified timeframe in the past.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[GetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllAc_1ad18fab]
        ...
        return await self.request_adapter.send_async(request_info, GetKnownIssuesByTimeRangeWithDaysInPastWithIncludeAllAc_1ad18fab, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905:
        """
        ...
        return MicrosoftGraphWindowsUpdatesGetKnownIssuesByTimeRangeWi_8adb2905(self.request_adapter, raw_url)
