...
class MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], catalog_i_d: Optional[str] = None) -> None:
        ...
        if isinstance(path_parameters, dict):
            path_parameters['catalogID'] = str(catalog_i_d)
    ...
    async def get(self,request_configuration: Optional[MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilderGetRequestConfiguration] = None) -> Optional[FindByCatalogIdWithCatalogIDGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function findByCatalogId
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilder.MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogIDRequestBuilderGetQueryParameters] = None
