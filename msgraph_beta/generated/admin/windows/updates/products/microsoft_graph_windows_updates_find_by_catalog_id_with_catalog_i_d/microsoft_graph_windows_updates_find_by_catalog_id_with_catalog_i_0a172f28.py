...
class MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogI_0a172f28(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], catalog_i_d: Optional[str] = None) -> None:
        """
        Instantiates a new MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogI_0a172f28 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogI_0a172f28:
        """
        ...
        return MicrosoftGraphWindowsUpdatesFindByCatalogIdWithCatalogI_0a172f28(self.request_adapter, raw_url)
