...
class ApplicableContentRequestBuilder(BaseRequestBuilder):
    ...
    def by_applicable_content_catalog_entry_id(self,applicable_content_catalog_entry_id: str) -> ApplicableContentCatalogEntryItemRequestBuilder:
        ...
        """
        if applicable_content_catalog_entry_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ApplicableContentRequestBuilderGetQueryParameters]] = None) -> Optional[ApplicableContentCollectionResponse]:
        """
        List applicable update content to offer to Microsoft Entra groups, Windows Autopatch groups, or both.
    ...
    async def post(self,body: ApplicableContent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ApplicableContent]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ApplicableContentRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        List applicable update content to offer to Microsoft Entra groups, Windows Autopatch groups, or both.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: ApplicableContent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to applicableContent for admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/admin/windows/updates/policies/{policy%2Did}/applicableContent', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ApplicableContentRequestBuilder:
        """
    ...
    @dataclass
    class ApplicableContentRequestBuilderGetRequestConfiguration(RequestConfiguration[ApplicableContentRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ApplicableContentRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
