...
if TYPE_CHECKING:
    ...
    from .....models.windows_updates.deployment_collection_response import DeploymentCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.deployment_item_request_builder import DeploymentItemRequestBuilder
...
class DeploymentsRequestBuilder(BaseRequestBuilder):
    ...
    def by_deployment_id(self,deployment_id: str) -> DeploymentItemRequestBuilder:
        """
        Provides operations to manage the deployments property of the microsoft.graph.adminWindowsUpdates entity.
        param deployment_id: The unique identifier of deployment
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DeploymentsRequestBuilderGetQueryParameters]] = None) -> Optional[DeploymentCollectionResponse]:
        """
    ...
    async def post(self,body: Deployment, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Deployment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DeploymentsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/admin/windows/updates/deployments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: Deployment, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new deployment object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
