...
class ApplicableContentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/windows/updates/deployments/{deployment%2Did}/audience/applicableContent{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ApplicableContentRequestBuilderGetRequestConfiguration] = None) -> Optional[ApplicableContentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ApplicableContent] = None, request_configuration: Optional[ApplicableContentRequestBuilderPostRequestConfiguration] = None) -> Optional[ApplicableContent]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[ApplicableContentRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Content eligible to deploy to devices in the audience. Not nullable. Read-only.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ApplicableContent] = None, request_configuration: Optional[ApplicableContentRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to applicableContent for admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ApplicableContentRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ApplicableContentRequestBuilder.ApplicableContentRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ApplicableContentRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
