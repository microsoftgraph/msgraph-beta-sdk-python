...
class EntriesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[CatalogEntryCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[CatalogEntry] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[CatalogEntry]:
        """
    ...
    def to_post_request_information(self,body: Optional[CatalogEntry] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to entries for admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
