...
class ComplianceChangesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ComplianceChangesRequestBuilderGetRequestConfiguration] = None) -> Optional[ComplianceChangeCollectionResponse]:
        """
        Get a list of the complianceChange objects and their properties. This API is available in the following national cloud deployments.
    ...
    async def post(self,body: Optional[ComplianceChange] = None, request_configuration: Optional[ComplianceChangesRequestBuilderPostRequestConfiguration] = None) -> Optional[ComplianceChange]:
        """
        Create a new contentApproval object. This API is available in the following national cloud deployments.
    ...
    @dataclass
    class ComplianceChangesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ComplianceChangesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
