...
class ComplianceChangesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_compliance_change_id(self,compliance_change_id: str) -> ComplianceChangeItemRequestBuilder:
        """
        Provides operations to manage the complianceChanges property of the microsoft.graph.windowsUpdates.updatePolicy entity.
        param compliance_change_id: The unique identifier of complianceChange
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ComplianceChangesRequestBuilderGetQueryParameters]] = None) -> Optional[ComplianceChangeCollectionResponse]:
        """
    ...
    async def post(self,body: ComplianceChange, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ComplianceChange]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ComplianceChangesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the complianceChange objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: ComplianceChange, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new contentApproval object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/admin/windows/updates/updatePolicies/{updatePolicy%2Did}/complianceChanges', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ComplianceChangesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ComplianceChangesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ComplianceChangesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ComplianceChangesRequestBuilderGetRequestConfiguration(RequestConfiguration[ComplianceChangesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ComplianceChangesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
