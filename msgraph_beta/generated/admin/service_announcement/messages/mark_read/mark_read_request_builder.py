...
class MarkReadRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[MarkReadPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[MarkReadPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[MarkReadPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Mark a list of serviceUpdateMessages as read for the signed in user.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
