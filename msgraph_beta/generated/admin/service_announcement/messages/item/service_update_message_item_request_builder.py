...
class ServiceUpdateMessageItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[ServiceUpdateMessage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServiceUpdateMessage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ServiceUpdateMessage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property messages in admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
