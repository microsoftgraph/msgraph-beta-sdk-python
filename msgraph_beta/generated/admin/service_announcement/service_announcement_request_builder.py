...
class ServiceAnnouncementRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServiceAnnouncement]:
        """
    ...
    async def patch(self,body: Optional[ServiceAnnouncement] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServiceAnnouncement]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ServiceAnnouncement] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property serviceAnnouncement in admin
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
