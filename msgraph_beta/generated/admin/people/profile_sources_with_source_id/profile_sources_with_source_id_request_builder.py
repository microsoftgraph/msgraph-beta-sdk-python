...
class ProfileSourcesWithSourceIdRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ProfileSourcesWithSourceIdRequestBuilderGetQueryParameters]] = None) -> Optional[ProfileSource]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ProfileSourcesWithSourceIdRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        A collection of profile source settings configured by an administrator in an organization.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/admin/people/profileSources(sourceId=\'{sourceId}\'){?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> ProfileSourcesWithSourceIdRequestBuilder:
        """
        ...
        return ProfileSourcesWithSourceIdRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class ProfileSourcesWithSourceIdRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class ProfileSourcesWithSourceIdRequestBuilderGetQueryParameters():
        """
        A collection of profile source settings configured by an administrator in an organization.
        """
    ...
    @dataclass
    class ProfileSourcesWithSourceIdRequestBuilderGetRequestConfiguration(RequestConfiguration[ProfileSourcesWithSourceIdRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class ProfileSourcesWithSourceIdRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
