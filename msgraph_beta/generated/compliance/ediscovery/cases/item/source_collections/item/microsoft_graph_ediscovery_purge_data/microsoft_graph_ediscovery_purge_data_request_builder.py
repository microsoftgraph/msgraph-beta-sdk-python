...
class MicrosoftGraphEdiscoveryPurgeDataRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphEdiscoveryPurgeDataRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphEdiscoveryPurgeDataRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
