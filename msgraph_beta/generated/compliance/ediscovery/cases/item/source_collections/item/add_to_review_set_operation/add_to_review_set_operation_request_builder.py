...
class AddToReviewSetOperationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> AddToReviewSetOperationRequestBuilder:
        """
    ...
    @dataclass
    class AddToReviewSetOperationRequestBuilderGetRequestConfiguration(RequestConfiguration[AddToReviewSetOperationRequestBuilderGetQueryParameters]):
        """
