...
if TYPE_CHECKING:
    from ........models.ediscovery.noncustodial_data_source_collection_response import NoncustodialDataSourceCollectionResponse
    from ........models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.noncustodial_data_source_item_request_builder import NoncustodialDataSourceItemRequestBuilder

class NoncustodialSourcesRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/noncustodialSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_noncustodial_data_source_id(self,noncustodial_data_source_id: str) -> NoncustodialDataSourceItemRequestBuilder:
        """
        Provides operations to manage the noncustodialSources property of the microsoft.graph.ediscovery.sourceCollection entity.
        param noncustodial_data_source_id: The unique identifier of noncustodialDataSource
        ...
        if not noncustodial_data_source_id:
            raise TypeError("noncustodial_data_source_id cannot be null.")
        from .item.noncustodial_data_source_item_request_builder import NoncustodialDataSourceItemRequestBuilder
    ...
    def with_url(self,raw_url: str) -> NoncustodialSourcesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: NoncustodialSourcesRequestBuilder
        """
        warn("The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace", DeprecationWarning)
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return NoncustodialSourcesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class NoncustodialSourcesRequestBuilderGetRequestConfiguration(RequestConfiguration[NoncustodialSourcesRequestBuilderGetQueryParameters]):
        """
