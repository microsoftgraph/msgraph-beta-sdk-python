...
class LastEstimateStatisticsOperationRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[LastEstimateStatisticsOperationRequestBuilderGetQueryParameters]] = None) -> Optional[EstimateStatisticsOperation]:
        """
