...
class MicrosoftGraphEdiscoveryReleaseRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/microsoft.graph.ediscovery.release", path_parameters)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphEdiscoveryReleaseRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphEdiscoveryReleaseRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
