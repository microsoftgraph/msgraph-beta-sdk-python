...
if TYPE_CHECKING:
    ...
    from ........models.ediscovery.site_source_collection_response import SiteSourceCollectionResponse
...
class SiteSourcesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/siteSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[SiteSourcesRequestBuilderGetRequestConfiguration] = None) -> Optional[SiteSourceCollectionResponse]:
        """
        Get a list of siteSource objects and their properties. This API is available in the following national cloud deployments.
    ...
    async def post(self,body: Optional[SiteSource] = None, request_configuration: Optional[SiteSourcesRequestBuilderPostRequestConfiguration] = None) -> Optional[SiteSource]:
        """
        Create a new custodian siteSource object. This API is available in the following national cloud deployments.
