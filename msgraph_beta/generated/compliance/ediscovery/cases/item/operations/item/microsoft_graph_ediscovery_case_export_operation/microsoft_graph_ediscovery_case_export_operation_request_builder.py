...
class MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphEdiscoveryCaseExportOperationRequestBuilderGetQueryParameters]] = None) -> Optional[CaseExportOperation]:
        """
