...
class ReviewSetsRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ReviewSetsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn("The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/reviewSets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
