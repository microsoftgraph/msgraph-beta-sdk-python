...
class MicrosoftGraphEdiscoveryExportRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphEdiscoveryExportRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphEdiscoveryExportRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
