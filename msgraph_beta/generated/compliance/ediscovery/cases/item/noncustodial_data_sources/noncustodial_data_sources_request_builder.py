...
class NoncustodialDataSourcesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[NoncustodialDataSource] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[NoncustodialDataSource]:
        """
    ...
    def to_post_request_information(self,body: Optional[NoncustodialDataSource] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new noncustodialDataSource object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
