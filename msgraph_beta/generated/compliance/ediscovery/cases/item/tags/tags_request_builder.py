...
if TYPE_CHECKING:
    ...
    from .microsoft_graph_ediscovery_as_hierarchy.microsoft_graph_ediscovery_as_hierarchy_request_builder import MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder
...
class TagsRequestBuilder(BaseRequestBuilder):
    ...
    def by_tag_id(self,tag_id: str) -> TagItemRequestBuilder:
        """
        Provides operations to manage the tags property of the microsoft.graph.ediscovery.case entity.
        param tag_id: The unique identifier of tag
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TagsRequestBuilderGetQueryParameters]] = None) -> Optional[TagCollectionResponse]:
        """
    ...
    async def post(self,body: Tag, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Tag]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TagsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn("The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: Tag, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new tag for the specified case.  The tags are used in review sets while reviewing content.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def microsoft_graph_ediscovery_as_hierarchy(self) -> MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder:
        """
        Provides operations to call the asHierarchy method.
        """
        from .microsoft_graph_ediscovery_as_hierarchy.microsoft_graph_ediscovery_as_hierarchy_request_builder import MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder

        return MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder(self.request_adapter, self.path_parameters)
