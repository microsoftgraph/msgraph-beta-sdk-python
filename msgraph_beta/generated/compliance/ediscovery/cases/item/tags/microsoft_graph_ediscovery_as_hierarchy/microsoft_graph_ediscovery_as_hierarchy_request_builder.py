...
class MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphEdiscoveryAsHierarchyRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphEdiscoveryAsHierarchyRequestBuilderGetRequestConfiguration(RequestConfiguration[MicrosoftGraphEdiscoveryAsHierarchyRequestBuilderGetQueryParameters]):
        """
