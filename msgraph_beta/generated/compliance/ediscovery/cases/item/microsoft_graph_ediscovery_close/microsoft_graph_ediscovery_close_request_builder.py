...
class MicrosoftGraphEdiscoveryCloseRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphEdiscoveryCloseRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphEdiscoveryCloseRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
