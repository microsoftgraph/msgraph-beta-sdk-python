...
if TYPE_CHECKING:
    from ......models.networkaccess.remote_network_connectivity_configuration import RemoteNetworkConnectivityConfiguration
...
class ConnectivityConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ConnectivityConfigurationRequestBuilderGetRequestConfiguration] = None) -> Optional[RemoteNetworkConnectivityConfiguration]:
        """
        Get connectivityConfiguration from networkAccess
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[RemoteNetworkConnectivityConfiguration]
        """
        ...
        return await self.request_adapter.send_async(request_info, RemoteNetworkConnectivityConfiguration, error_mapping)
    
    async def patch(self,body: Optional[RemoteNetworkConnectivityConfiguration] = None, request_configuration: Optional[ConnectivityConfigurationRequestBuilderPatchRequestConfiguration] = None) -> Optional[RemoteNetworkConnectivityConfiguration]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[ConnectivityConfigurationRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[RemoteNetworkConnectivityConfiguration] = None, request_configuration: Optional[ConnectivityConfigurationRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property connectivityConfiguration in networkAccess
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/networkAccess/connectivity/remoteNetworks/{remoteNetwork%2Did}/connectivityConfiguration', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
