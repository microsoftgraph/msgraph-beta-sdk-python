...
if TYPE_CHECKING:
    ...
    from ....models.networkaccess.remote_network_collection_response import RemoteNetworkCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.remote_network_item_request_builder import RemoteNetworkItemRequestBuilder
...
class RemoteNetworksRequestBuilder(BaseRequestBuilder):
    ...
    def by_remote_network_id(self,remote_network_id: str) -> RemoteNetworkItemRequestBuilder:
        """
        Provides operations to manage the remoteNetworks property of the microsoft.graph.networkaccess.connectivity entity.
        param remote_network_id: The unique identifier of remoteNetwork
        Returns: RemoteNetworkItemRequestBuilder
        """
        if remote_network_id is None:
            raise TypeError("remote_network_id cannot be null.")
        from .item.remote_network_item_request_builder import RemoteNetworkItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RemoteNetworksRequestBuilderGetQueryParameters]] = None) -> Optional[RemoteNetworkCollectionResponse]:
        """
    ...
    async def post(self,body: RemoteNetwork, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RemoteNetwork]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RemoteNetworksRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/networkAccess/connectivity/remoteNetworks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: RemoteNetwork, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new remote network.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
