...
if TYPE_CHECKING:
    ...
    from .microsoft_graph_networkaccess_get_web_category_by_url_with_url.microsoft_graph_networkaccess_get_web_category_by_url_with_url_re_738c2fcb import MicrosoftGraphNetworkaccessGetWebCategoryByUrlWithUrlRe_738c2fcb
...
class ConnectivityRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ConnectivityRequestBuilderGetQueryParameters]] = None) -> Optional[Connectivity]:
        """
    ...
    def microsoft_graph_networkaccess_get_web_category_by_url_with_url(self,url: str) -> MicrosoftGraphNetworkaccessGetWebCategoryByUrlWithUrlRe_738c2fcb:
        """
        ...
        return MicrosoftGraphNetworkaccessGetWebCategoryByUrlWithUrlRe_738c2fcb(self.request_adapter, self.path_parameters, url)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ConnectivityRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Connectivity represents all the connectivity components in Global Secure Access.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/networkAccess/connectivity{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: Connectivity, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property connectivity in networkAccess
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ConnectivityRequestBuilder:
        """
    ...
    @dataclass
    class ConnectivityRequestBuilderGetRequestConfiguration(RequestConfiguration[ConnectivityRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class ConnectivityRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
