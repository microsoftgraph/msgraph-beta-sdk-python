...
class CountRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/networkAccess/cloudFirewallPolicies/{cloudFirewallPolicy%2Did}/policyRules/$count{?%24filter,%24search}", path_parameters)
