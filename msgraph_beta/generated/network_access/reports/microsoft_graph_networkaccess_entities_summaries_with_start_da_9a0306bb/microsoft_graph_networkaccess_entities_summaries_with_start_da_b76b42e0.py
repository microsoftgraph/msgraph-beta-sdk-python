...
class MicrosoftGraphNetworkaccessEntitiesSummariesWithStartDa_b76b42e0(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessEntitiesSummariesWithStartDa_b76b42e0 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessEntitiesSummariesWithStartDa_b76b42e0:
        """
        ...
        return MicrosoftGraphNetworkaccessEntitiesSummariesWithStartDa_b76b42e0(self.request_adapter, raw_url)
