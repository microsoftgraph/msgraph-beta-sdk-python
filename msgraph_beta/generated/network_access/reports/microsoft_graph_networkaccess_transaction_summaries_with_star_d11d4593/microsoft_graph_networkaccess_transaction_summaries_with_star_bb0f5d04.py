...
class MicrosoftGraphNetworkaccessTransactionSummariesWithStar_bb0f5d04(BaseRequestBuilder):
    """
    Provides operations to call the transactionSummaries method. Original name: MicrosoftGraphNetworkaccessTransactionSummariesWithStartDateTimeWithEndDateTimeRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessTransactionSummariesWithStar_bb0f5d04 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphNetworkaccessTransactionSummariesWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]] = None) -> Optional[TransactionSummariesWithStartDateTimeWithEndDateTimeGetResponse]:
        """
        Get the total number of transactions , including blocked transactions in Global Secure Access, grouped by traffic type.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessTransactionSummariesWithStar_bb0f5d04:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphNetworkaccessTransactionSummariesWithStar_bb0f5d04
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphNetworkaccessTransactionSummariesWithStar_bb0f5d04(self.request_adapter, raw_url)
    ...
    @dataclass
    class MicrosoftGraphNetworkaccessTransactionSummariesWithStartDateTimeWithEndDateTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[MicrosoftGraphNetworkaccessTransactionSummariesWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]):
        """
