...
class MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithSta_f8c194eb(BaseRequestBuilder):
    """
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], discovery_pivot_date_time: Optional[datetime.datetime] = None, end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithSta_f8c194eb and sets the default values.
        ...
        if isinstance(path_parameters, dict):
            path_parameters['discoveryPivotDateTime'] = discovery_pivot_date_time
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithSta_f8c194eb:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithSta_f8c194eb
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithSta_f8c194eb(self.request_adapter, raw_url)
    
    @dataclass
    class MicrosoftGraphNetworkaccessGetCrossTenantSummaryWithStartDateTimeWithEndDateTimeWithDiscoveryPivotDateTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
