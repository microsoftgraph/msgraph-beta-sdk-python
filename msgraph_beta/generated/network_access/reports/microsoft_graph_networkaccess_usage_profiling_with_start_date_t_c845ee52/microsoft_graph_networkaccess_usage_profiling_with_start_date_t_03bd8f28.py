...
if TYPE_CHECKING:
    ...
    from .usage_profiling_with_start_date_time_with_end_date_time_with_aggre_eed44b4e import UsageProfilingWithStartDateTimeWithEndDateTimeWithAggre_eed44b4e

class MicrosoftGraphNetworkaccessUsageProfilingWithStartDateT_03bd8f28(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], aggregated_by: Optional[str] = None, end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessUsageProfilingWithStartDateT_03bd8f28 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphNetworkaccessUsageProfilingWithStartDateTimeWithEndDateTimeWithAggregatedBydiscoveredApplicationSegmentIdDiscoveredApplicationSegmentIdApplicationIdApplicationIdRequestBuilderGetQueryParameters]] = None) -> Optional[UsageProfilingWithStartDateTimeWithEndDateTimeWithAggre_eed44b4e]:
        ...
        Returns: Optional[UsageProfilingWithStartDateTimeWithEndDateTimeWithAggre_eed44b4e]
        ...
        return await self.request_adapter.send_async(request_info, UsageProfilingWithStartDateTimeWithEndDateTimeWithAggre_eed44b4e, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessUsageProfilingWithStartDateT_03bd8f28:
        """
        ...
        return MicrosoftGraphNetworkaccessUsageProfilingWithStartDateT_03bd8f28(self.request_adapter, raw_url)
