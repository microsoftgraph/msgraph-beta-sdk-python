...
class MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc(BaseRequestBuilder):
    """
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], activity_pivot_date_time: Optional[datetime.datetime] = None, end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithSta_ba9070fc(self.request_adapter, raw_url)
    
    @dataclass
    class MicrosoftGraphNetworkaccessGetDeviceUsageSummaryWithStartDateTimeWithEndDateTimeWithActivityPivotDateTimeRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
