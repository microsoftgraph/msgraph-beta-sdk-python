...
if TYPE_CHECKING:
    ...
    from .get_connection_summaries_with_start_date_time_with_end_date_time_get_response import GetConnectionSummariesWithStartDateTimeWithEndDateTimeGetResponse

class MicrosoftGraphNetworkaccessGetConnectionSummariesWithStartDateTimeWithEndDateTimeRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphNetworkaccessGetConnectionSummariesWithStartDateTimeWithEndDateTimeRequestBuilderGetQueryParameters]] = None) -> Optional[GetConnectionSummariesWithStartDateTimeWithEndDateTimeGetResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetConnectionSummariesWithStartDateTimeWithEndDateTimeGetResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessGetConnectionSummariesWithStartDateTimeWithEndDateTimeRequestBuilder:
        """
        ...
        return MicrosoftGraphNetworkaccessGetConnectionSummariesWithStartDateTimeWithEndDateTimeRequestBuilder(self.request_adapter, raw_url)
