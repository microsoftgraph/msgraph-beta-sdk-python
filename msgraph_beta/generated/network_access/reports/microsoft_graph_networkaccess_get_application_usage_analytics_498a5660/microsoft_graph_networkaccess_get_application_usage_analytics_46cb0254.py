...
if TYPE_CHECKING:
    ...
    from .get_application_usage_analytics_with_start_date_time_with_end_dat_d33b4dbf import GetApplicationUsageAnalyticsWithStartDateTimeWithEndDat_d33b4dbf

class MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_46cb0254(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], aggregated_by: Optional[str] = None, end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_46cb0254 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MicrosoftGraphNetworkaccessGetApplicationUsageAnalyticsWithStartDateTimeWithEndDateTimeWithAggregatedByRequestBuilderGetQueryParameters]] = None) -> Optional[GetApplicationUsageAnalyticsWithStartDateTimeWithEndDat_d33b4dbf]:
        """
        ...
        Returns: Optional[GetApplicationUsageAnalyticsWithStartDateTimeWithEndDat_d33b4dbf]
        ...
        return await self.request_adapter.send_async(request_info, GetApplicationUsageAnalyticsWithStartDateTimeWithEndDat_d33b4dbf, error_mapping)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_46cb0254:
        """
        ...
        return MicrosoftGraphNetworkaccessGetApplicationUsageAnalytics_46cb0254(self.request_adapter, raw_url)
