...
class FilteringProfilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[FilteringProfileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[FilteringProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[FilteringProfile]:
        """
    ...
    def to_post_request_information(self,body: Optional[FilteringProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to filteringProfiles for networkAccess
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
