...
class FilteringProfilesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/networkAccess/filteringProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[FilteringProfilesRequestBuilderGetRequestConfiguration] = None) -> Optional[FilteringProfileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[FilteringProfile] = None, request_configuration: Optional[FilteringProfilesRequestBuilderPostRequestConfiguration] = None) -> Optional[FilteringProfile]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[FilteringProfilesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get a list of the filteringProfile objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[FilteringProfile] = None, request_configuration: Optional[FilteringProfilesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to filteringProfiles for networkAccess
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> FilteringProfilesRequestBuilder:
        """
    ...
    @dataclass
    class FilteringProfilesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[FilteringProfilesRequestBuilder.FilteringProfilesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class FilteringProfilesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
