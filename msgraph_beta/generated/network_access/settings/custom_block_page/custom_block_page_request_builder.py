...
if TYPE_CHECKING:
    from ....models.networkaccess.custom_block_page import CustomBlockPage
    from ....models.o_data_errors.o_data_error import ODataError

class CustomBlockPageRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/networkAccess/settings/customBlockPage", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CustomBlockPageRequestBuilderGetQueryParameters]] = None) -> Optional[CustomBlockPage]:
        ...
        return await self.request_adapter.send_async(request_info, CustomBlockPage, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CustomBlockPageRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/networkAccess/settings/customBlockPage{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> CustomBlockPageRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CustomBlockPageRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CustomBlockPageRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CustomBlockPageRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CustomBlockPageRequestBuilderGetRequestConfiguration(RequestConfiguration[CustomBlockPageRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CustomBlockPageRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
