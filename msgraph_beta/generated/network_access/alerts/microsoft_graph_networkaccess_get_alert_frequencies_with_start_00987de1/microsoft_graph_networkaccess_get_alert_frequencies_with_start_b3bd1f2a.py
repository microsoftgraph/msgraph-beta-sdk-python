...
class MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], end_date_time: Optional[datetime.datetime] = None, start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a:
        """
        ...
        return MicrosoftGraphNetworkaccessGetAlertFrequenciesWithStart_b3bd1f2a(self.request_adapter, raw_url)
