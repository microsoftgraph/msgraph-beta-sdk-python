...
class SchemaExtensionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_schema_extension_id(self,schema_extension_id: str) -> SchemaExtensionItemRequestBuilder:
        ...
        """
        if schema_extension_id is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SchemaExtensionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/schemaExtensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
