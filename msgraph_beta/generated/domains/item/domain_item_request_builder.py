...
class DomainItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Domain]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/domains/{domain%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[Domain] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/domains/{domain%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def promote_to_initial(self) -> PromoteToInitialRequestBuilder:
        """
    ...
    @property
    def shared_email_domain_invitations(self) -> SharedEmailDomainInvitationsRequestBuilder:
        """
        Provides operations to manage the sharedEmailDomainInvitations property of the microsoft.graph.domain entity.
        """
        from .shared_email_domain_invitations.shared_email_domain_invitations_request_builder import SharedEmailDomainInvitationsRequestBuilder

        return SharedEmailDomainInvitationsRequestBuilder(self.request_adapter, self.path_parameters)
