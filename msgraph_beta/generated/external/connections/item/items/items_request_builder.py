...
class ItemsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ExternalItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ExternalItem]:
        """
    ...
    def to_post_request_information(self,body: Optional[ExternalItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to items for external
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
