...
class ReferenceDefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/referenceDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def post(self,body: Optional[ReferenceDefinition] = None, request_configuration: Optional[ReferenceDefinitionsRequestBuilderPostRequestConfiguration] = None) -> Optional[ReferenceDefinition]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ReferenceDefinitionsRequestBuilder:
        """
    ...
    @dataclass
    class ReferenceDefinitionsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ReferenceDefinitionsRequestBuilder.ReferenceDefinitionsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ReferenceDefinitionsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
