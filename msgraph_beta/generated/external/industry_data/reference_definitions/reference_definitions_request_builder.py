...
if TYPE_CHECKING:
    ...
    from ....models.industry_data.reference_definition_collection_response import ReferenceDefinitionCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.reference_definition_item_request_builder import ReferenceDefinitionItemRequestBuilder

class ReferenceDefinitionsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_reference_definition_id(self,reference_definition_id: str) -> ReferenceDefinitionItemRequestBuilder:
        ...
        return ReferenceDefinitionItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ReferenceDefinitionsRequestBuilderGetQueryParameters]] = None) -> Optional[ReferenceDefinitionCollectionResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, ReferenceDefinitionCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ReferenceDefinitionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the referenceDefinition objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/external/industryData/referenceDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: ReferenceDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/external/industryData/referenceDefinitions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ReferenceDefinitionsRequestBuilder:
        """
    ...
    @dataclass
    class ReferenceDefinitionsRequestBuilderGetRequestConfiguration(RequestConfiguration[ReferenceDefinitionsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ReferenceDefinitionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
