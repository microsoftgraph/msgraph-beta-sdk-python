...
class ReferenceDefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ReferenceDefinitionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ReferenceDefinition] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ReferenceDefinition]:
        """
    ...
    def to_post_request_information(self,body: Optional[ReferenceDefinition] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to referenceDefinitions for external
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
