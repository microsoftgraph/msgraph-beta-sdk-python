...
class DataConnectorRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/inboundFlows/{inboundFlow%2Did}/dataConnector{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> DataConnectorRequestBuilder:
        """
    ...
    @dataclass
    class DataConnectorRequestBuilderGetRequestConfiguration(RequestConfiguration[DataConnectorRequestBuilderGetQueryParameters]):
        """
