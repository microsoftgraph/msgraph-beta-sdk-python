...
if TYPE_CHECKING:
    ...
    from ....models.industry_data.industry_data_connector_collection_response import IndustryDataConnectorCollectionResponse
...
class DataConnectorsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/dataConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_industry_data_connector_id(self,industry_data_connector_id: str) -> IndustryDataConnectorItemRequestBuilder:
        """
        Provides operations to manage the dataConnectors property of the microsoft.graph.industryData.industryDataRoot entity.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DataConnectorsRequestBuilderGetQueryParameters]] = None) -> Optional[IndustryDataConnectorCollectionResponse]:
        """
        ...
        Find more info here: https://learn.microsoft.com/graph/api/industrydata-azuredatalakeconnector-list?view=graph-rest-beta
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DataConnectorsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of the azureDataLakeConnector objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DataConnectorsRequestBuilder:
        """
    ...
    @dataclass
    class DataConnectorsRequestBuilderGetRequestConfiguration(RequestConfiguration[DataConnectorsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DataConnectorsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
