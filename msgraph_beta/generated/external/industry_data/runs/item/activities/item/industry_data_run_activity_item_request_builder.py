...
class IndustryDataRunActivityItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[IndustryDataRunActivityItemRequestBuilderGetQueryParameters]] = None) -> Optional[IndustryDataRunActivity]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IndustryDataRunActivityItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The set of activities performed during the run.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IndustryDataRunActivityItemRequestBuilder:
        """
    ...
    @dataclass
    class IndustryDataRunActivityItemRequestBuilderGetRequestConfiguration(RequestConfiguration[IndustryDataRunActivityItemRequestBuilderGetQueryParameters]):
        """
