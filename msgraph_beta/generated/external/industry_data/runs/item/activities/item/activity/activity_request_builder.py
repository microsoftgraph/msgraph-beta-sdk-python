...
class ActivityRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ActivityRequestBuilderGetQueryParameters]] = None) -> Optional[IndustryDataActivity]:
        """
    ...
    def with_url(self,raw_url: str) -> ActivityRequestBuilder:
        """
