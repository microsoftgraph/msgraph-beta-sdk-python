...
if TYPE_CHECKING:
    from .....models.industry_data.industry_data_run import IndustryDataRun
...
class IndustryDataRunItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[IndustryDataRunItemRequestBuilderGetQueryParameters]] = None) -> Optional[IndustryDataRun]:
        """
        Read the properties and relationships of an industryDataRun object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[IndustryDataRun]
        ...
        return await self.request_adapter.send_async(request_info, IndustryDataRun, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IndustryDataRunItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of an industryDataRun object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IndustryDataRunItemRequestBuilder:
        """
    ...
    @property
    def microsoft_graph_industry_data_get_statistics(self) -> MicrosoftGraphIndustryDataGetStatisticsRequestBuilder:
        """
    ...
    @dataclass
    class IndustryDataRunItemRequestBuilderGetRequestConfiguration(RequestConfiguration[IndustryDataRunItemRequestBuilderGetQueryParameters]):
        """
