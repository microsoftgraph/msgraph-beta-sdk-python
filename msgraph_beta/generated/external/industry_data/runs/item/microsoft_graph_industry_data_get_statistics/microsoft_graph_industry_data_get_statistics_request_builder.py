...
class MicrosoftGraphIndustryDataGetStatisticsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[IndustryDataRunStatistics]:
        """
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIndustryDataGetStatisticsRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphIndustryDataGetStatisticsRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
