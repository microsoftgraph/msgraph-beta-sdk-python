...
if TYPE_CHECKING:
    from ....models.industry_data.industry_data_run_collection_response import IndustryDataRunCollectionResponse
...
class RunsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/runs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_industry_data_run_id(self,industry_data_run_id: str) -> IndustryDataRunItemRequestBuilder:
        """
        Provides operations to manage the runs property of the microsoft.graph.industryData.industryDataRoot entity.
        param industry_data_run_id: The unique identifier of industryDataRun
        Returns: IndustryDataRunItemRequestBuilder
        """
        if not industry_data_run_id:
            raise TypeError("industry_data_run_id cannot be null.")
        from .item.industry_data_run_item_request_builder import IndustryDataRunItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["industryDataRun%2Did"] = industry_data_run_id
        return IndustryDataRunItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RunsRequestBuilderGetQueryParameters]] = None) -> Optional[IndustryDataRunCollectionResponse]:
        """
        Get a list of the industryDataRun objects and their properties.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[IndustryDataRunCollectionResponse]
        ...
        return await self.request_adapter.send_async(request_info, IndustryDataRunCollectionResponse, error_mapping)
