...
class MicrosoftGraphIndustryDataStartRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/external/industryData/runs/microsoft.graph.industryData.start", path_parameters)
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphIndustryDataStartRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphIndustryDataStartRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphIndustryDataStartRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class MicrosoftGraphIndustryDataStartRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
