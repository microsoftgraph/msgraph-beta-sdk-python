...
class AuthorizationSystemItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthorizationSystem]:
        """
    ...
    async def patch(self,body: Optional[AuthorizationSystem] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthorizationSystem]:
        """
    ...
    def to_patch_request_information(self,body: Optional[AuthorizationSystem] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property authorizationSystems in external
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
