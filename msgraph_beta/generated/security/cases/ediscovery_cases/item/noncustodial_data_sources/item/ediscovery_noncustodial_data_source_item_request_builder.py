...
class EdiscoveryNoncustodialDataSourceItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[EdiscoveryNoncustodialDataSource]:
        """
    ...
    async def patch(self,body: Optional[EdiscoveryNoncustodialDataSource] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[EdiscoveryNoncustodialDataSource]:
        """
    ...
    def to_patch_request_information(self,body: Optional[EdiscoveryNoncustodialDataSource] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property noncustodialDataSources in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
