...
if TYPE_CHECKING:
    ...
    from ........models.security.ediscovery_estimate_operation import EdiscoveryEstimateOperation

class LastEstimateStatisticsOperationRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/lastEstimateStatisticsOperation{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[LastEstimateStatisticsOperationRequestBuilderGetQueryParameters]] = None) -> Optional[EdiscoveryEstimateOperation]:
        ...
        return await self.request_adapter.send_async(request_info, EdiscoveryEstimateOperation, error_mapping)
    ...
    def with_url(self,raw_url: str) -> LastEstimateStatisticsOperationRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: LastEstimateStatisticsOperationRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class LastEstimateStatisticsOperationRequestBuilderGetRequestConfiguration(RequestConfiguration[LastEstimateStatisticsOperationRequestBuilderGetQueryParameters]):
        """
