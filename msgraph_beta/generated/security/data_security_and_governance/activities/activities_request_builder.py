...
if TYPE_CHECKING:
    ...
    from ....models.tenant_activities_container import TenantActivitiesContainer
...
class ActivitiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/dataSecurityAndGovernance/activities{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ActivitiesRequestBuilderGetQueryParameters]] = None) -> Optional[TenantActivitiesContainer]:
        """
        Get activities from security
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TenantActivitiesContainer]
        """
        ...
        return await self.request_adapter.send_async(request_info, TenantActivitiesContainer, error_mapping)
    
    async def patch(self,body: TenantActivitiesContainer, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TenantActivitiesContainer]:
        """
    ...
    def to_patch_request_information(self,body: TenantActivitiesContainer, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property activities in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
