...
class DataSecurityAndGovernanceRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/dataSecurityAndGovernance", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DataSecurityAndGovernanceRequestBuilderGetQueryParameters]] = None) -> Optional[TenantDataSecurityAndGovernance]:
        """
        Get dataSecurityAndGovernance from security
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TenantDataSecurityAndGovernance]
        """
        ...
        return await self.request_adapter.send_async(request_info, TenantDataSecurityAndGovernance, error_mapping)
    
    async def patch(self,body: TenantDataSecurityAndGovernance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TenantDataSecurityAndGovernance]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DataSecurityAndGovernanceRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/dataSecurityAndGovernance{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: TenantDataSecurityAndGovernance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property dataSecurityAndGovernance in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DataSecurityAndGovernanceRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DataSecurityAndGovernanceRequestBuilder
        """
        if raw_url is None:
    ...
    def process_content_async(self) -> ProcessContentAsyncRequestBuilder:
        ...
        return ProcessContentAsyncRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def protection_scopes(self) -> ProtectionScopesRequestBuilder:
        """
    ...
    @dataclass
    class DataSecurityAndGovernanceRequestBuilderGetRequestConfiguration(RequestConfiguration[DataSecurityAndGovernanceRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DataSecurityAndGovernanceRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
