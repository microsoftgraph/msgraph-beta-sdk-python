...
class TrainingItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Training]:
        """
    ...
    async def patch(self,body: Optional[Training] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Training]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Training] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property trainings in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
