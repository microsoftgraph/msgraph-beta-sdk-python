...
class LandingPageItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[LandingPage]:
        """
    ...
    async def patch(self,body: Optional[LandingPage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[LandingPage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[LandingPage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property landingPages in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
