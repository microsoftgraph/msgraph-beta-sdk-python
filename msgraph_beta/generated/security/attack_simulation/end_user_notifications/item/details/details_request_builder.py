...
if TYPE_CHECKING:
    from ......models.end_user_notification_detail import EndUserNotificationDetail
    from ......models.end_user_notification_detail_collection_response import EndUserNotificationDetailCollectionResponse
    from ......models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.end_user_notification_detail_item_request_builder import EndUserNotificationDetailItemRequestBuilder
...
class DetailsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/attackSimulation/endUserNotifications/{endUserNotification%2Did}/details{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_end_user_notification_detail_id(self,end_user_notification_detail_id: str) -> EndUserNotificationDetailItemRequestBuilder:
        """
        Provides operations to manage the details property of the microsoft.graph.endUserNotification entity.
        param end_user_notification_detail_id: The unique identifier of endUserNotificationDetail
        Returns: EndUserNotificationDetailItemRequestBuilder
        """
        if not end_user_notification_detail_id:
            raise TypeError("end_user_notification_detail_id cannot be null.")
        from .item.end_user_notification_detail_item_request_builder import EndUserNotificationDetailItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[EndUserNotificationDetailCollectionResponse]:
        ...
        Returns: Optional[EndUserNotificationDetailCollectionResponse]
        """
    ...
    async def post(self,body: Optional[EndUserNotificationDetail] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[EndUserNotificationDetail]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[EndUserNotificationDetail]
        """
        if not body:
