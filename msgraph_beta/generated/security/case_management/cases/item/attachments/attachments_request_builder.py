...
if TYPE_CHECKING:
    ...
    from ......models.security.case_management.attachment import Attachment
    from ......models.security.case_management.attachment_collection_response import AttachmentCollectionResponse
...
class AttachmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/caseManagement/cases/{case%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AttachmentsRequestBuilderGetQueryParameters]] = None) -> Optional[AttachmentCollectionResponse]:
        """
        Get a list of attachment objects for a case.
