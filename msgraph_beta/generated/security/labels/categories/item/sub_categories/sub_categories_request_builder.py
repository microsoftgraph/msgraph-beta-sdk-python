...
if TYPE_CHECKING:
    ...
    from ......models.security.sub_category_template import SubCategoryTemplate
    from ......models.security.sub_category_template_collection_response import SubCategoryTemplateCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.sub_category_template_item_request_builder import SubCategoryTemplateItemRequestBuilder
...
class SubCategoriesRequestBuilder(BaseRequestBuilder):
    ...
    def by_sub_category_template_id(self,sub_category_template_id: str) -> SubCategoryTemplateItemRequestBuilder:
        """
        Provides operations to manage the subCategories property of the microsoft.graph.security.categoryTemplate entity.
        param sub_category_template_id: The unique identifier of subCategoryTemplate
        Returns: SubCategoryTemplateItemRequestBuilder
        """
        if not sub_category_template_id:
            raise TypeError("sub_category_template_id cannot be null.")
        from .item.sub_category_template_item_request_builder import SubCategoryTemplateItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["subCategoryTemplate%2Did"] = sub_category_template_id
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SubCategoriesRequestBuilder:
        """
