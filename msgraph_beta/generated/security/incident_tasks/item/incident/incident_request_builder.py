...
class IncidentRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/incidentTasks/{incidentTask%2Did}/incident{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> IncidentRequestBuilder:
        """
        ...
        return IncidentRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class IncidentRequestBuilderGetRequestConfiguration(RequestConfiguration[IncidentRequestBuilderGetQueryParameters]):
        """
