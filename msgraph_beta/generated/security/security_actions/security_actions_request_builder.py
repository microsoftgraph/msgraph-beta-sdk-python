...
class SecurityActionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SecurityActionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[SecurityAction] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[SecurityAction]:
        """
    ...
    def to_post_request_information(self,body: Optional[SecurityAction] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create a new securityAction object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
