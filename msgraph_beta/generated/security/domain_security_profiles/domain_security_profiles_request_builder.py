...
class DomainSecurityProfilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DomainSecurityProfileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DomainSecurityProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DomainSecurityProfile]:
        """
    ...
    def to_post_request_information(self,body: Optional[DomainSecurityProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to domainSecurityProfiles for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
