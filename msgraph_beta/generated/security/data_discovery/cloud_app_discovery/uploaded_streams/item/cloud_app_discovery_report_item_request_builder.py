...
class CloudAppDiscoveryReportItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CloudAppDiscoveryReportItemRequestBuilderGetQueryParameters]] = None) -> Optional[CloudAppDiscoveryReport]:
        """
        A collection of streams available for generating cloud discovery report.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[CloudAppDiscoveryReport]
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CloudAppDiscoveryReportItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        A collection of streams available for generating cloud discovery report.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/dataDiscovery/cloudAppDiscovery/uploadedStreams/{cloudAppDiscoveryReport%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: CloudAppDiscoveryReport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property uploadedStreams in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> CloudAppDiscoveryReportItemRequestBuilder:
        """
        ...
        return CloudAppDiscoveryReportItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CloudAppDiscoveryReportItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CloudAppDiscoveryReportItemRequestBuilderGetQueryParameters():
        """
        A collection of streams available for generating cloud discovery report.
        """
    ...
    @dataclass
    class CloudAppDiscoveryReportItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CloudAppDiscoveryReportItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CloudAppDiscoveryReportItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
