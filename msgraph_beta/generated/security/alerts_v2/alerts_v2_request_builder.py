...
if TYPE_CHECKING:
    ...
    from .microsoft_graph_security_create_alert.microsoft_graph_security_create_alert_request_builder import MicrosoftGraphSecurityCreateAlertRequestBuilder
...
class Alerts_v2RequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[Alerts_v2RequestBuilderGetQueryParameters]] = None) -> Optional[AlertCollectionResponse]:
        """
        ...
        Find more info here: https://learn.microsoft.com/graph/api/security-list-alerts_v2?view=graph-rest-beta
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[Alerts_v2RequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of alert resources that were created to track suspicious activities in an organization. This operation lets you filter and sort through alerts to create an informed cyber security response. It exposes a collection of alerts that were flagged in your network, within the time range you specified in your environment retention policy. The most recent alerts are displayed at the top of the list.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> Alerts_v2RequestBuilder:
        """
    ...
    @property
    def microsoft_graph_security_create_alert(self) -> MicrosoftGraphSecurityCreateAlertRequestBuilder:
        """
        Provides operations to call the createAlert method.
        """
        from .microsoft_graph_security_create_alert.microsoft_graph_security_create_alert_request_builder import MicrosoftGraphSecurityCreateAlertRequestBuilder

        return MicrosoftGraphSecurityCreateAlertRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class Alerts_v2RequestBuilderGetRequestConfiguration(RequestConfiguration[Alerts_v2RequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class Alerts_v2RequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
