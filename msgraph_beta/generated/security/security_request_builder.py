...
class SecurityRequestBuilder(BaseRequestBuilder):
    ...
    def microsoft_graph_security_get_run_hunting_query_with_querytimespan_timespan_with_workspace_id(self,query: str) -> MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimespanTimespanWithWorkspaceIdRequestBuilder:
        """
        ...
        return MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimespanTimespanWithWorkspaceIdRequestBuilder(self.request_adapter, self.path_parameters, query)
