...
if TYPE_CHECKING:
    ...
    from ......models.security.environment import Environment
...
class EnvironmentItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[EnvironmentItemRequestBuilderGetQueryParameters]] = None) -> Optional[Environment]:
        """
        Collection of attached environments. Supports $expand.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[Environment]
        """
        ...
        return await self.request_adapter.send_async(request_info, Environment, error_mapping)
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/security/zones/{zone%2Did}/environments/{environment%2Did}', self.path_parameters)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[EnvironmentItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/security/zones/{zone%2Did}/environments/{environment%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    @dataclass
    class EnvironmentItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
