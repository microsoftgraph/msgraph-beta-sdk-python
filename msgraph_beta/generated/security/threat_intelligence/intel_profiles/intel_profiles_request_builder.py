...
class IntelProfilesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[IntelligenceProfileCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[IntelligenceProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[IntelligenceProfile]:
        """
    ...
    def to_post_request_information(self,body: Optional[IntelligenceProfile] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to intelProfiles for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
