...
class IntelligenceProfileIndicatorItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/intelProfiles/{intelligenceProfile%2Did}/indicators/{intelligenceProfileIndicator%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[IntelligenceProfileIndicator]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> IntelligenceProfileIndicatorItemRequestBuilder:
        ...
        return IntelligenceProfileIndicatorItemRequestBuilder(self.request_adapter, raw_url)
