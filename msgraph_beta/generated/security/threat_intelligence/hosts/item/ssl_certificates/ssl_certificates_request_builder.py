...
class SslCertificatesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/sslCertificates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_host_ssl_certificate_id(self,host_ssl_certificate_id: str) -> HostSslCertificateItemRequestBuilder:
        ...
        """
        if host_ssl_certificate_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SslCertificatesRequestBuilderGetQueryParameters]] = None) -> Optional[HostSslCertificateCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SslCertificatesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of hostSslCertificate objects from the host navigation property.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SslCertificatesRequestBuilder:
        """
    ...
    @dataclass
    class SslCertificatesRequestBuilderGetRequestConfiguration(RequestConfiguration[SslCertificatesRequestBuilderGetQueryParameters]):
        """
