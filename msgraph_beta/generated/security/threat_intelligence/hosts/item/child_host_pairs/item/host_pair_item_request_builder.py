...
class HostPairItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/childHostPairs/{hostPair%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[HostPairItemRequestBuilderGetQueryParameters]] = None) -> Optional[HostPair]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[HostPairItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The hostPairs that are resources associated with a host, where that host is the parentHost and has an outgoing pairing to a cihldHost.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> HostPairItemRequestBuilder:
        """
    ...
    @dataclass
    class HostPairItemRequestBuilderGetRequestConfiguration(RequestConfiguration[HostPairItemRequestBuilderGetQueryParameters]):
        """
