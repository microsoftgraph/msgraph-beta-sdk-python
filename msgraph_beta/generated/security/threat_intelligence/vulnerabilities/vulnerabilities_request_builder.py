...
class VulnerabilitiesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/vulnerabilities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_vulnerability_id(self,vulnerability_id: str) -> VulnerabilityItemRequestBuilder:
        """
        Provides operations to manage the vulnerabilities property of the microsoft.graph.security.threatIntelligence entity.
        param vulnerability_id: The unique identifier of vulnerability
    ...
    async def post(self,body: Optional[Vulnerability] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Vulnerability]:
        """
    ...
    def to_post_request_information(self,body: Optional[Vulnerability] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to vulnerabilities for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> VulnerabilitiesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: VulnerabilitiesRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return VulnerabilitiesRequestBuilder(self.request_adapter, raw_url)
