...
class ComponentsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[VulnerabilityComponentCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[VulnerabilityComponent] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[VulnerabilityComponent]:
        """
    ...
    def to_post_request_information(self,body: Optional[VulnerabilityComponent] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to components for security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
