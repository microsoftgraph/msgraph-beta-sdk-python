...
class ThreatIntelligenceRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ThreatIntelligence]:
        """
    ...
    async def patch(self,body: Optional[ThreatIntelligence] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ThreatIntelligence]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ThreatIntelligence] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property threatIntelligence in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
