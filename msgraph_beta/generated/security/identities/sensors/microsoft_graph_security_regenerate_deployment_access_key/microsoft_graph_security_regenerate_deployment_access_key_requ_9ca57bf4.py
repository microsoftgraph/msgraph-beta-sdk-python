...
class MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequ_9ca57bf4(BaseRequestBuilder):
    """
    Provides operations to call the regenerateDeploymentAccessKey method. Original name: MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequ_9ca57bf4 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequ_9ca57bf4:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequ_9ca57bf4
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphSecurityRegenerateDeploymentAccessKeyRequ_9ca57bf4(self.request_adapter, raw_url)
