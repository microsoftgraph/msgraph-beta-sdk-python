...
class IdentitiesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[IdentityContainer]:
        """
    ...
    async def patch(self,body: Optional[IdentityContainer] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[IdentityContainer]:
        """
    ...
    def to_patch_request_information(self,body: Optional[IdentityContainer] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property identities in security
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
