...
class SubmitTiIndicatorsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[SubmitTiIndicatorsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[SubmitTiIndicatorsPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[SubmitTiIndicatorsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Upload multiple threat intelligence (TI) indicators in one request instead of multiple requests.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SubmitTiIndicatorsRequestBuilder:
        """
