...
class MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], query: Optional[str] = None) -> None:
        """
        Instantiates a new MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4 and sets the default values.
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4:
        """
        ...
        return MicrosoftGraphSecurityGetRunHuntingQueryWithQuerytimesp_0505dfd4(self.request_adapter, raw_url)
