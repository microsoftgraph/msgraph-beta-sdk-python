...
class PrivacyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Privacy]:
        """
        Get privacy
    ...
    async def patch(self,body: Optional[Privacy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Privacy]:
        """
        Update privacy
    ...
    def to_patch_request_information(self,body: Optional[Privacy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update privacy
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PrivacyRequestBuilder:
        """
