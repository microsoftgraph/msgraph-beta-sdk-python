...
class MicrosoftGraphDeviceManagementSetPortalNotificationAsSe_e2ad4c0f(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphDeviceManagementSetPortalNotificationAsSe_e2ad4c0f:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphDeviceManagementSetPortalNotificationAsSe_e2ad4c0f
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphDeviceManagementSetPortalNotificationAsSe_e2ad4c0f(self.request_adapter, raw_url)
    
    @dataclass
    class MicrosoftGraphDeviceManagementSetPortalNotificationAsSentRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
