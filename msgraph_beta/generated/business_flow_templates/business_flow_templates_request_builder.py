...
class BusinessFlowTemplatesRequestBuilder(BaseRequestBuilder):
    ...
    def by_business_flow_template_id(self,business_flow_template_id: str) -> BusinessFlowTemplateItemRequestBuilder:
        ...
        """
        if business_flow_template_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[BusinessFlowTemplatesRequestBuilderGetQueryParameters]] = None) -> Optional[BusinessFlowTemplateCollectionResponse]:
        """
    ...
    async def post(self,body: BusinessFlowTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BusinessFlowTemplate]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[BusinessFlowTemplatesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        In the Microsoft Entra access reviews feature, list all the businessFlowTemplate objects.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/businessFlowTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: BusinessFlowTemplate, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Add new entity to businessFlowTemplates
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/businessFlowTemplates', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> BusinessFlowTemplatesRequestBuilder:
        """
    ...
    @dataclass
    class BusinessFlowTemplatesRequestBuilderGetRequestConfiguration(RequestConfiguration[BusinessFlowTemplatesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class BusinessFlowTemplatesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
