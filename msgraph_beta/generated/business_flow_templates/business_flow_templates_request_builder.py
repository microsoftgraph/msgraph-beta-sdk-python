...
class BusinessFlowTemplatesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[BusinessFlowTemplateCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[BusinessFlowTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[BusinessFlowTemplate]:
        """
    ...
    def to_post_request_information(self,body: Optional[BusinessFlowTemplate] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to businessFlowTemplates
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
