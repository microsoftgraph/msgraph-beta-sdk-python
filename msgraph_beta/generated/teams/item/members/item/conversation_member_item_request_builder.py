...
class ConversationMemberItemRequestBuilder(BaseRequestBuilder):
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/team-delete-members?view=graph-rest-beta
        """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ConversationMemberItemRequestBuilderGetQueryParameters]] = None) -> Optional[ConversationMember]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/team-get-members?view=graph-rest-beta
        """
    ...
    async def patch(self,body: ConversationMember, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ConversationMember]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[ConversationMember]
        Find more info here: https://learn.microsoft.com/graph/api/team-update-members?view=graph-rest-beta
        """
        if body is None:
