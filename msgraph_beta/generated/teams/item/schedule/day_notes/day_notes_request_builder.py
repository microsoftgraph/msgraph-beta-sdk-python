...
class DayNotesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[DayNoteCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DayNote] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DayNote]:
        """
    ...
    def to_post_request_information(self,body: Optional[DayNote] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to dayNotes for teams
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
