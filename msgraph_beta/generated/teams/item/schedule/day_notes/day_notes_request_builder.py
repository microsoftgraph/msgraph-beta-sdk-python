...
class DayNotesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teams/{team%2Did}/schedule/dayNotes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[DayNotesRequestBuilderGetRequestConfiguration] = None) -> Optional[DayNoteCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[DayNote] = None, request_configuration: Optional[DayNotesRequestBuilderPostRequestConfiguration] = None) -> Optional[DayNote]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[DayNotesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get dayNotes from teams
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[DayNote] = None, request_configuration: Optional[DayNotesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to dayNotes for teams
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DayNotesRequestBuilder:
        """
    ...
    @dataclass
    class DayNotesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[DayNotesRequestBuilder.DayNotesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class DayNotesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
