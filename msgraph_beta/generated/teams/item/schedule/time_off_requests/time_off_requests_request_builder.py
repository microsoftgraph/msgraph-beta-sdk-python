...
class TimeOffRequestsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TimeOffRequestsRequestBuilderGetQueryParameters]] = None) -> Optional[TimeOffRequestCollectionResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/timeoffrequest-list?view=graph-rest-beta
        """
    ...
    async def post(self,body: TimeOffRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimeOffRequest]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/timeoffrequest-post?view=graph-rest-beta
        """
        if body is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TimeOffRequestsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/teams/{team%2Did}/schedule/timeOffRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: TimeOffRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/teams/{team%2Did}/schedule/timeOffRequests', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
