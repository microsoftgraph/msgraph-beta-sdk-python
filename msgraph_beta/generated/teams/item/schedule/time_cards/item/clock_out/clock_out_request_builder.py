...
class ClockOutRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ClockOutPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TimeCard]:
        """
    ...
    def to_post_request_information(self,body: ClockOutPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Clock out to end an open timeCard.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ClockOutRequestBuilder:
        """
    ...
    @dataclass
    class ClockOutRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
