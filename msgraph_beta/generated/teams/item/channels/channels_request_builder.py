...
class ChannelsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChannelsRequestBuilderGetQueryParameters]] = None) -> Optional[ChannelCollectionResponse]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/channel-list?view=graph-rest-beta
        """
    ...
    async def post(self,body: Channel, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Channel]:
        ...
        Find more info here: https://learn.microsoft.com/graph/api/channel-post?view=graph-rest-beta
        """
        if body is None:
