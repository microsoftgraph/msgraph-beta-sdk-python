...
class ValidateAuthenticationConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ValidateAuthenticationConfigurationPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthenticationConfigurationValidation]:
        """
    ...
    def to_post_request_information(self,body: Optional[ValidateAuthenticationConfigurationPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action validateAuthenticationConfiguration
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
