...
class UsageRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/identity/conditionalAccess/authenticationStrengths/policies/{authenticationStrengthPolicy%2Did}/usage()", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AuthenticationStrengthUsage]:
        """
    ...
    def with_url(self,raw_url: str) -> UsageRequestBuilder:
        """
    ...
    @dataclass
    class UsageRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
