...
class AuthenticationStrengthsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[AuthenticationStrengthsRequestBuilderGetRequestConfiguration] = None) -> Optional[AuthenticationStrengthRoot]:
        """
    ...
    async def patch(self,body: Optional[AuthenticationStrengthRoot] = None, request_configuration: Optional[AuthenticationStrengthsRequestBuilderPatchRequestConfiguration] = None) -> Optional[AuthenticationStrengthRoot]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[AuthenticationStrengthsRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        """
        Delete navigation property authenticationStrengths for identity
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        """
        warn("The &apos;authenticationStrengths&apos; segment is deprecated. Please use &apos;authenticationStrength&apos; instead. as of 2023-02/AuthenticationStrengthsRemove", DeprecationWarning)
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/identity/conditionalAccess/authenticationStrengths', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[AuthenticationStrengthRoot] = None, request_configuration: Optional[AuthenticationStrengthsRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property authenticationStrengths in identity
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/identity/conditionalAccess/authenticationStrengths', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> AuthenticationStrengthsRequestBuilder:
        """
    ...
    @dataclass
    class AuthenticationStrengthsRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AuthenticationStrengthsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[AuthenticationStrengthsRequestBuilder.AuthenticationStrengthsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class AuthenticationStrengthsRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
