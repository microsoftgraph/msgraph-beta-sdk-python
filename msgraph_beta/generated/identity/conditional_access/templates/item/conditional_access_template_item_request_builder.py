...
class ConditionalAccessTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ConditionalAccessTemplate]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ConditionalAccessTemplateItemRequestBuilder:
        """
