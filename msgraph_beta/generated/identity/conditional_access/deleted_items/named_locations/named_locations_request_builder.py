...
if TYPE_CHECKING:
    ...
    from .....models.named_location_collection_response import NamedLocationCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.named_location_item_request_builder import NamedLocationItemRequestBuilder

class NamedLocationsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_named_location_id(self,named_location_id: str) -> NamedLocationItemRequestBuilder:
        ...
        """
        if named_location_id is None:
            raise TypeError("named_location_id cannot be null.")
        from .item.named_location_item_request_builder import NamedLocationItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["namedLocation%2Did"] = named_location_id
        return NamedLocationItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def post(self,body: NamedLocation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[NamedLocation]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[NamedLocationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: NamedLocation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to namedLocations for identity
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/identity/conditionalAccess/deletedItems/namedLocations', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> NamedLocationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: NamedLocationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return NamedLocationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class NamedLocationsRequestBuilderGetRequestConfiguration(RequestConfiguration[NamedLocationsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class NamedLocationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
