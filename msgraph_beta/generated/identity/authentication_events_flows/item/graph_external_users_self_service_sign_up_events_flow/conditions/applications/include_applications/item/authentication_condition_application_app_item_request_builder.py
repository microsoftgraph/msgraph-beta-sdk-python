...
class AuthenticationConditionApplicationAppItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthenticationConditionApplication]:
        """
    ...
    async def patch(self,body: Optional[AuthenticationConditionApplication] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[AuthenticationConditionApplication]:
        """
    ...
    def to_patch_request_information(self,body: Optional[AuthenticationConditionApplication] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property includeApplications in identity
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
