...
class GetOrderRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AssignmentOrder]:
        """
    ...
    def with_url(self,raw_url: str) -> GetOrderRequestBuilder:
        """
    ...
    @dataclass
    class GetOrderRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
