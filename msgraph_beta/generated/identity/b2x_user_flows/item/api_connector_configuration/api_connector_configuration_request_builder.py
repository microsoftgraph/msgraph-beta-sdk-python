...
if TYPE_CHECKING:
    ...
    from .pre_token_issuance.pre_token_issuance_request_builder import PreTokenIssuanceRequestBuilder
...
class ApiConnectorConfigurationRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def pre_token_issuance(self) -> PreTokenIssuanceRequestBuilder:
        """
        ...
        return PreTokenIssuanceRequestBuilder(self.request_adapter, self.path_parameters)
