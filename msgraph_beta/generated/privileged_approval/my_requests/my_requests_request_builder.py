...
class MyRequestsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MyRequestsRequestBuilder:
        """
    ...
    @dataclass
    class MyRequestsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[MyRequestsRequestBuilder.MyRequestsRequestBuilderGetQueryParameters] = None
