...
class PrivilegedApprovalRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedApprovalCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[PrivilegedApproval] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PrivilegedApproval]:
        """
    ...
    def to_post_request_information(self,body: Optional[PrivilegedApproval] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to privilegedApproval
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> PrivilegedApprovalRequestBuilder:
        """
