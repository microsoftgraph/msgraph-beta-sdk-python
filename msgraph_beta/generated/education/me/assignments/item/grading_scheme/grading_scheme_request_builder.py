...
class GradingSchemeRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GradingSchemeRequestBuilder:
        """
    ...
    @dataclass
    class GradingSchemeRequestBuilderGetRequestConfiguration(RequestConfiguration[GradingSchemeRequestBuilderGetQueryParameters]):
        """
