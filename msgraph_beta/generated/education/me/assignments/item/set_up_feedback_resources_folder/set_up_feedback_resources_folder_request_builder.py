...
class SetUpFeedbackResourcesFolderRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SetUpFeedbackResourcesFolderRequestBuilder:
        """
    ...
    @dataclass
    class SetUpFeedbackResourcesFolderRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
