...
class DefaultGradingSchemeRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[DefaultGradingSchemeRequestBuilderGetRequestConfiguration] = None) -> Optional[EducationGradingScheme]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[DefaultGradingSchemeRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get defaultGradingScheme from education
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> DefaultGradingSchemeRequestBuilder:
        """
    ...
    @dataclass
    class DefaultGradingSchemeRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[DefaultGradingSchemeRequestBuilder.DefaultGradingSchemeRequestBuilderGetQueryParameters] = None
