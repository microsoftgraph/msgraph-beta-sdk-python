...
class GradingSchemesRequestBuilder(BaseRequestBuilder):
    ...
    def by_education_grading_scheme_id(self,education_grading_scheme_id: str) -> EducationGradingSchemeItemRequestBuilder:
        ...
        """
        if education_grading_scheme_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GradingSchemesRequestBuilderGetQueryParameters]] = None) -> Optional[EducationGradingSchemeCollectionResponse]:
        """
    ...
    async def post(self,body: EducationGradingScheme, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[EducationGradingScheme]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GradingSchemesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of an educationGradingScheme object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/education/classes/{educationClass%2Did}/assignmentSettings/gradingSchemes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: EducationGradingScheme, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new educationGradingScheme on an educationClass. Only teachers can perform this operation.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GradingSchemesRequestBuilder:
        """
    ...
    @dataclass
    class GradingSchemesRequestBuilderGetRequestConfiguration(RequestConfiguration[GradingSchemesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class GradingSchemesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
