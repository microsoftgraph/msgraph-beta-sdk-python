...
class GradingSchemesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GradingSchemesRequestBuilderGetRequestConfiguration] = None) -> Optional[EducationGradingSchemeCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[EducationGradingScheme] = None, request_configuration: Optional[GradingSchemesRequestBuilderPostRequestConfiguration] = None) -> Optional[EducationGradingScheme]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GradingSchemesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get gradingSchemes from education
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[EducationGradingScheme] = None, request_configuration: Optional[GradingSchemesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to gradingSchemes for education
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class GradingSchemesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GradingSchemesRequestBuilder.GradingSchemesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class GradingSchemesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
