...
class DependentResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def by_education_assignment_resource_id1(self,education_assignment_resource_id1: str) -> EducationAssignmentResourceItemRequestBuilder:
        ...
        """
        if education_assignment_resource_id1 is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DependentResourcesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def with_url(self,raw_url: str) -> DependentResourcesRequestBuilder:
        """
    ...
    @dataclass
    class DependentResourcesRequestBuilderGetRequestConfiguration(RequestConfiguration[DependentResourcesRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DependentResourcesRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
