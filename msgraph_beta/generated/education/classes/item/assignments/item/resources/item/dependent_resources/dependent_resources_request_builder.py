...
class DependentResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_education_assignment_resource_id1(self,education_assignment_resource_id1: str) -> EducationAssignmentResourceItemRequestBuilder:
        """
        Provides operations to manage the dependentResources property of the microsoft.graph.educationAssignmentResource entity.
        param education_assignment_resource_id1: The unique identifier of educationAssignmentResource
        Returns: EducationAssignmentResourceItemRequestBuilder
        """
        if not education_assignment_resource_id1:
            raise TypeError("education_assignment_resource_id1 cannot be null.")
        from .item.education_assignment_resource_item_request_builder import EducationAssignmentResourceItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["educationAssignmentResource%2Did1"] = education_assignment_resource_id1
        return EducationAssignmentResourceItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[DependentResourcesRequestBuilderGetRequestConfiguration] = None) -> Optional[EducationAssignmentResourceCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[EducationAssignmentResource] = None, request_configuration: Optional[DependentResourcesRequestBuilderPostRequestConfiguration] = None) -> Optional[EducationAssignmentResource]:
        """
    ...
    def to_post_request_information(self,body: Optional[EducationAssignmentResource] = None, request_configuration: Optional[DependentResourcesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to dependentResources for education
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/resources/{educationAssignmentResource%2Did}/dependentResources', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
