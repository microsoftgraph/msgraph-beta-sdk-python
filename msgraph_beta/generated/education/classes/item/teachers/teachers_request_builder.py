...
class TeachersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/teachers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    
    def by_education_user_id(self,education_user_id: str) -> EducationUserItemRequestBuilder:
        """
        Gets an item from the msgraph_beta.generated.education.classes.item.teachers.item collection
    ...
    async def get(self,request_configuration: Optional[TeachersRequestBuilderGetRequestConfiguration] = None) -> Optional[EducationUserCollectionResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TeachersRequestBuilder:
        """
    ...
    @dataclass
    class TeachersRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
