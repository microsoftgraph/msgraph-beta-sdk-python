...
class RoleDefinitionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_governance_role_definition_id(self,governance_role_definition_id: str) -> GovernanceRoleDefinitionItemRequestBuilder:
        """
        Provides operations to manage the roleDefinitions property of the microsoft.graph.governanceResource entity.
        param governance_role_definition_id: The unique identifier of governanceRoleDefinition
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RoleDefinitionsRequestBuilderGetQueryParameters]] = None) -> Optional[GovernanceRoleDefinitionCollectionResponse]:
        """
    ...
    async def post(self,body: GovernanceRoleDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GovernanceRoleDefinition]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RoleDefinitionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn("The PIM Iteration 2 beta API is deprecated and will be removed on October 28, 2026. Please migrate to PIM Iteration 3 API. as of 2025-10/PIM_Iteration2_Deprecation on 2025-10-27 and will be removed 2026-10-28", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: GovernanceRoleDefinition, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to roleDefinitions for privilegedAccess
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleDefinitions', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> RoleDefinitionsRequestBuilder:
        """
    ...
    @dataclass
    class RoleDefinitionsRequestBuilderGetRequestConfiguration(RequestConfiguration[RoleDefinitionsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class RoleDefinitionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
