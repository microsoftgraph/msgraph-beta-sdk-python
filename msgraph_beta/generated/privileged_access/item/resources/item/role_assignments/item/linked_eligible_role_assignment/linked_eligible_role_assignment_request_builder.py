...
class LinkedEligibleRoleAssignmentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/resources/{governanceResource%2Did}/roleAssignments/{governanceRoleAssignment%2Did}/linkedEligibleRoleAssignment{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[LinkedEligibleRoleAssignmentRequestBuilderGetQueryParameters]] = None) -> Optional[GovernanceRoleAssignment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[LinkedEligibleRoleAssignmentRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read-only. If this is an active assignment and created due to activation on an eligible assignment, it represents the object of that eligible assignment; Otherwise, the value is null.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> LinkedEligibleRoleAssignmentRequestBuilder:
        """
    ...
    @dataclass
    class LinkedEligibleRoleAssignmentRequestBuilderGetRequestConfiguration(RequestConfiguration[LinkedEligibleRoleAssignmentRequestBuilderGetQueryParameters]):
        """
