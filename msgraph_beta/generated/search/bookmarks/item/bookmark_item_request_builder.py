...
class BookmarkItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Bookmark]:
        """
    ...
    async def patch(self,body: Optional[Bookmark] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Bookmark]:
        """
    ...
    def to_patch_request_information(self,body: Optional[Bookmark] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the properties of a bookmark object.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> BookmarkItemRequestBuilder:
        """
