...
if TYPE_CHECKING:
    ...
    from .get_by_user_with_user_principal_name_get_response import GetByUserWithUserPrincipalNameGetResponse

class GetByUserWithUserPrincipalNameRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], user_principal_name: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/getByUser(userPrincipalName='{userPrincipalName}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetByUserWithUserPrincipalNameRequestBuilderGetQueryParameters]] = None) -> Optional[GetByUserWithUserPrincipalNameGetResponse]:
        ...
        return await self.request_adapter.send_async(request_info, GetByUserWithUserPrincipalNameGetResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetByUserWithUserPrincipalNameRequestBuilder:
        """
        ...
        return GetByUserWithUserPrincipalNameRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetByUserWithUserPrincipalNameRequestBuilderGetRequestConfiguration(RequestConfiguration[GetByUserWithUserPrincipalNameRequestBuilderGetQueryParameters]):
        """
