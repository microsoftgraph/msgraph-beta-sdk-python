...
class DeletedContainersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> DeletedContainersRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DeletedContainersRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return DeletedContainersRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class DeletedContainersRequestBuilderGetRequestConfiguration(RequestConfiguration[DeletedContainersRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class DeletedContainersRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
