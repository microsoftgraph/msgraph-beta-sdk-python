...
class SearchWithQRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], q: Optional[str] = None) -> None:
        """
        ...
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/search(q='{q}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> SearchWithQRequestBuilder:
        """
        ...
        return SearchWithQRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class SearchWithQRequestBuilderGetRequestConfiguration(RequestConfiguration[SearchWithQRequestBuilderGetQueryParameters]):
        """
