...
class BaseTypesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/baseTypes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[BaseTypesRequestBuilderGetQueryParameters]] = None) -> Optional[ContentTypeCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[BaseTypesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The collection of content types that are ancestors of this content type.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> BaseTypesRequestBuilder:
        """
        ...
        return BaseTypesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class BaseTypesRequestBuilderGetRequestConfiguration(RequestConfiguration[BaseTypesRequestBuilderGetQueryParameters]):
        """
