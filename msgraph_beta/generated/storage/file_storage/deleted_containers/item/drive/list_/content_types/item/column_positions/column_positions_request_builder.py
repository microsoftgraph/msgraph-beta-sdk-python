...
class ColumnPositionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columnPositions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ColumnPositionsRequestBuilderGetQueryParameters]] = None) -> Optional[ColumnDefinitionCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ColumnPositionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Column order information in a content type.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ColumnPositionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ColumnPositionsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return ColumnPositionsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ColumnPositionsRequestBuilderGetRequestConfiguration(RequestConfiguration[ColumnPositionsRequestBuilderGetQueryParameters]):
        """
