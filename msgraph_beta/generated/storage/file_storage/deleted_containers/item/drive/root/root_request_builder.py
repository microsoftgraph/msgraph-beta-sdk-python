...
class RootRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/root{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RootRequestBuilderGetQueryParameters]] = None) -> Optional[DriveItem]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RootRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The root folder of the drive. Read-only.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> RootRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: RootRequestBuilder
        """
        if not raw_url:
    ...
    @dataclass
    class RootRequestBuilderGetRequestConfiguration(RequestConfiguration[RootRequestBuilderGetQueryParameters]):
        """
