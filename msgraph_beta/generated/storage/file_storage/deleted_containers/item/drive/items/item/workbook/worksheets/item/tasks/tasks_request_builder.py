...
if TYPE_CHECKING:
    ...
    from ............models.workbook_document_task_collection_response import WorkbookDocumentTaskCollectionResponse
...
class TasksRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_workbook_document_task_id(self,workbook_document_task_id: str) -> WorkbookDocumentTaskItemRequestBuilder:
        """
        Provides operations to manage the tasks property of the microsoft.graph.workbookWorksheet entity.
        ...
        url_tpl_params["workbookDocumentTask%2Did"] = workbook_document_task_id
        return WorkbookDocumentTaskItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[TasksRequestBuilderGetQueryParameters]] = None) -> Optional[WorkbookDocumentTaskCollectionResponse]:
        """
    ...
    async def post(self,body: WorkbookDocumentTask, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[WorkbookDocumentTask]:
        """
        Create new navigation property to tasks for storage
    ...
    def to_post_request_information(self,body: WorkbookDocumentTask, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to tasks for storage
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
