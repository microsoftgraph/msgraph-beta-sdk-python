...
class RangeWithAddressRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], address: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range(address='{address}')", path_parameters)
    ...
    def with_url(self,raw_url: str) -> RangeWithAddressRequestBuilder:
        """
    ...
    @dataclass
    class RangeWithAddressRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
