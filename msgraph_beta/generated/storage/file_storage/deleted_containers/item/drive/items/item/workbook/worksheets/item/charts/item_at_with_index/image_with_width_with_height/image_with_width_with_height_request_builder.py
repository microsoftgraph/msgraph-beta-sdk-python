...
class ImageWithWidthWithHeightRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], height: Optional[int] = None, width: Optional[int] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/image(width={width},height={height})", path_parameters)
    ...
    def with_url(self,raw_url: str) -> ImageWithWidthWithHeightRequestBuilder:
        """
    ...
    @dataclass
    class ImageWithWidthWithHeightRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
