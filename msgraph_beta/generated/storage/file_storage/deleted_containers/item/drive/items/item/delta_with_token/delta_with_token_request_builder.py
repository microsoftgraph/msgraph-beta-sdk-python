...
class DeltaWithTokenRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], token: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/delta(token='{token}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> DeltaWithTokenRequestBuilder:
        """
    ...
    @dataclass
    class DeltaWithTokenRequestBuilderGetRequestConfiguration(RequestConfiguration[DeltaWithTokenRequestBuilderGetQueryParameters]):
        """
