...
class ChildrenRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_drive_item_id1(self,drive_item_id1: str) -> DriveItemItemRequestBuilder:
        """
        Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        param drive_item_id1: The unique identifier of driveItem
        Returns: DriveItemItemRequestBuilder
        """
        if not drive_item_id1:
            raise TypeError("drive_item_id1 cannot be null.")
        from .item.drive_item_item_request_builder import DriveItemItemRequestBuilder
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChildrenRequestBuilderGetQueryParameters]] = None) -> Optional[DriveItemCollectionResponse]:
        """
    ...
    async def post(self,body: DriveItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DriveItem]:
        """
        Create new navigation property to children for storage
