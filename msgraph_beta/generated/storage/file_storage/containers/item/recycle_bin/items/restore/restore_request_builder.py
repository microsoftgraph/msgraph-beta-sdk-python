...
if TYPE_CHECKING:
    ...
    from .restore_post_response import RestorePostResponse
...
class RestoreRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/recycleBin/items/restore", path_parameters)
    
    async def post(self,body: RestorePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RestorePostResponse]:
        """
        Invoke action restore
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[RestorePostResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, RestorePostResponse, error_mapping)
