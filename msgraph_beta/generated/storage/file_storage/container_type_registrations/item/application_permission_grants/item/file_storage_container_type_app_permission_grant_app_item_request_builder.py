...
class FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def patch(self,body: FileStorageContainerTypeAppPermissionGrant, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[FileStorageContainerTypeAppPermissionGrant]:
        ...
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[FileStorageContainerTypeAppPermissionGrant]
        Find more info here: https://learn.microsoft.com/graph/api/filestoragecontainertypeapppermissiongrant-update?view=graph-rest-beta
        """
        if body is None:
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/storage/fileStorage/containerTypeRegistrations/{fileStorageContainerTypeRegistration%2Did}/applicationPermissionGrants/{fileStorageContainerTypeAppPermissionGrant%2DappId}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilder:
        """
        ...
        return FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilderGetRequestConfiguration(RequestConfiguration[FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class FileStorageContainerTypeAppPermissionGrantAppItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
