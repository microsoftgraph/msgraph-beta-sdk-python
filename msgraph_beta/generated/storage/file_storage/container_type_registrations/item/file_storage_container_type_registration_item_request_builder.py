...
if TYPE_CHECKING:
    ...
    from .application_permission_grants.application_permission_grants_request_builder import ApplicationPermissionGrantsRequestBuilder
...
class FileStorageContainerTypeRegistrationItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/containerTypeRegistrations/{fileStorageContainerTypeRegistration%2Did}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[FileStorageContainerTypeRegistrationItemRequestBuilderGetQueryParameters]] = None) -> Optional[FileStorageContainerTypeRegistration]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[FileStorageContainerTypeRegistrationItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read the properties and relationships of a fileStorageContainerTypeRegistration object.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/storage/fileStorage/containerTypeRegistrations/{fileStorageContainerTypeRegistration%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> FileStorageContainerTypeRegistrationItemRequestBuilder:
        """
        ...
        return FileStorageContainerTypeRegistrationItemRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def application_permission_grants(self) -> ApplicationPermissionGrantsRequestBuilder:
        """
        ...
        return ApplicationPermissionGrantsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @dataclass
    class FileStorageContainerTypeRegistrationItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class FileStorageContainerTypeRegistrationItemRequestBuilderGetQueryParameters():
        """
        Read the properties and relationships of a fileStorageContainerTypeRegistration object.
        """
    ...
    @dataclass
    class FileStorageContainerTypeRegistrationItemRequestBuilderGetRequestConfiguration(RequestConfiguration[FileStorageContainerTypeRegistrationItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class FileStorageContainerTypeRegistrationItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
