...
class TransitiveReportsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> TransitiveReportsRequestBuilder:
        """
    ...
    @dataclass
    class TransitiveReportsRequestBuilderGetRequestConfiguration(RequestConfiguration[TransitiveReportsRequestBuilderGetQueryParameters]):
        """
