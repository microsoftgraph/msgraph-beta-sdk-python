...
class AppManagementPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/appManagementPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_app_management_policy_id(self,app_management_policy_id: str) -> AppManagementPolicyItemRequestBuilder:
        ...
        """
        if app_management_policy_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AppManagementPoliciesRequestBuilderGetQueryParameters]] = None) -> Optional[AppManagementPolicyCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AppManagementPoliciesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The appManagementPolicy applied to this service principal.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AppManagementPoliciesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AppManagementPoliciesRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class AppManagementPoliciesRequestBuilderGetRequestConfiguration(RequestConfiguration[AppManagementPoliciesRequestBuilderGetQueryParameters]):
        """
