...
class ValidateCredentialsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ValidateCredentialsRequestBuilder:
        """
    ...
    @dataclass
    class ValidateCredentialsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
