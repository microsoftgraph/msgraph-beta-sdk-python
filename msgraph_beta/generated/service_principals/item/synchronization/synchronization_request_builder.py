...
if TYPE_CHECKING:
    ...
    from .ping.ping_request_builder import PingRequestBuilder
...
class SynchronizationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[Synchronization]:
        """
    ...
    async def put(self,body: Optional[Synchronization] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Synchronization]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization', self.path_parameters)
    ...
    def to_put_request_information(self,body: Optional[Synchronization] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property synchronization in servicePrincipals
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PUT, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def ping(self) -> PingRequestBuilder:
        """
        Provides operations to call the Ping method.
        """
        from .ping.ping_request_builder import PingRequestBuilder

        return PingRequestBuilder(self.request_adapter, self.path_parameters)
