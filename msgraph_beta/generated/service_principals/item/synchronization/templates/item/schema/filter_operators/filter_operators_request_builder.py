...
class FilterOperatorsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> FilterOperatorsRequestBuilder:
        """
    ...
    @dataclass
    class FilterOperatorsRequestBuilderGetRequestConfiguration(RequestConfiguration[FilterOperatorsRequestBuilderGetQueryParameters]):
        """
