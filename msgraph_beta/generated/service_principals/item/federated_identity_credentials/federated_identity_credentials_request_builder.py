...
if TYPE_CHECKING:
    ...
    from ....models.federated_identity_credential_collection_response import FederatedIdentityCredentialCollectionResponse
    from ....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.federated_identity_credential_item_request_builder import FederatedIdentityCredentialItemRequestBuilder

class FederatedIdentityCredentialsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_federated_identity_credential_id(self,federated_identity_credential_id: str) -> FederatedIdentityCredentialItemRequestBuilder:
        """
        Provides operations to manage the federatedIdentityCredentials property of the microsoft.graph.servicePrincipal entity.
        ...
        """
        if federated_identity_credential_id is None:
            raise TypeError("federated_identity_credential_id cannot be null.")
        from .item.federated_identity_credential_item_request_builder import FederatedIdentityCredentialItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["federatedIdentityCredential%2Did"] = federated_identity_credential_id
        return FederatedIdentityCredentialItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[FederatedIdentityCredentialsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/federatedIdentityCredentials{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: FederatedIdentityCredential, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/federatedIdentityCredentials', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> FederatedIdentityCredentialsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: FederatedIdentityCredentialsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return FederatedIdentityCredentialsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class FederatedIdentityCredentialsRequestBuilderGetRequestConfiguration(RequestConfiguration[FederatedIdentityCredentialsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class FederatedIdentityCredentialsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
