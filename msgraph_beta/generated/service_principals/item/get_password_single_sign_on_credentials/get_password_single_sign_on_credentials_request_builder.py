...
class GetPasswordSingleSignOnCredentialsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetPasswordSingleSignOnCredentialsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PasswordSingleSignOnCredentialSet]:
        """
    ...
    def to_post_request_information(self,body: GetPasswordSingleSignOnCredentialsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Get a list of single sign-on credentials using a password for a user or group.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
