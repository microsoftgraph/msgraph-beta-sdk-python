...
class GetPasswordSingleSignOnCredentialsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetPasswordSingleSignOnCredentialsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PasswordSingleSignOnCredentialSet]:
        """
    ...
    def to_post_request_information(self,body: Optional[GetPasswordSingleSignOnCredentialsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Get a list of single sign-on credentials using a password for a user or group.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
