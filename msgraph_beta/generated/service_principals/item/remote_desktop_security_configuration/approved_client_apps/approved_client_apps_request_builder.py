...
if TYPE_CHECKING:
    from .....models.approved_client_app import ApprovedClientApp
    from .....models.approved_client_app_collection_response import ApprovedClientAppCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.approved_client_app_item_request_builder import ApprovedClientAppItemRequestBuilder

class ApprovedClientAppsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def by_approved_client_app_id(self,approved_client_app_id: str) -> ApprovedClientAppItemRequestBuilder:
        """
        Provides operations to manage the approvedClientApps property of the microsoft.graph.remoteDesktopSecurityConfiguration entity.
        param approved_client_app_id: The unique identifier of approvedClientApp
        Returns: ApprovedClientAppItemRequestBuilder
        """
        if approved_client_app_id is None:
            raise TypeError("approved_client_app_id cannot be null.")
        from .item.approved_client_app_item_request_builder import ApprovedClientAppItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["approvedClientApp%2Did"] = approved_client_app_id
        return ApprovedClientAppItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ApprovedClientAppsRequestBuilderGetQueryParameters]] = None) -> Optional[ApprovedClientAppCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ApprovedClientAppCollectionResponse, error_mapping)
    ...
    async def post(self,body: ApprovedClientApp, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ApprovedClientApp]:
        ...
        return await self.request_adapter.send_async(request_info, ApprovedClientApp, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ApprovedClientAppsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/approvedClientApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: ApprovedClientApp, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/remoteDesktopSecurityConfiguration/approvedClientApps', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> ApprovedClientAppsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ApprovedClientAppsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ApprovedClientAppsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ApprovedClientAppsRequestBuilderGetRequestConfiguration(RequestConfiguration[ApprovedClientAppsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ApprovedClientAppsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
