...
if TYPE_CHECKING:
    ...
    from .claims_policy.claims_policy_request_builder import ClaimsPolicyRequestBuilder
...
class ServicePrincipalItemRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ServicePrincipalItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    @property
    def claims_policy(self) -> ClaimsPolicyRequestBuilder:
        """
        Provides operations to manage the claimsPolicy property of the microsoft.graph.servicePrincipal entity.
        """
        from .claims_policy.claims_policy_request_builder import ClaimsPolicyRequestBuilder

        return ClaimsPolicyRequestBuilder(self.request_adapter, self.path_parameters)
