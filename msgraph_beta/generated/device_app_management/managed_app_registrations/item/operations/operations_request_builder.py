...
class OperationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_managed_app_operation_id(self,managed_app_operation_id: str) -> ManagedAppOperationItemRequestBuilder:
        ...
        """
        if managed_app_operation_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[OperationsRequestBuilderGetQueryParameters]] = None) -> Optional[ManagedAppOperationCollectionResponse]:
        """
    ...
    async def post(self,body: ManagedAppOperation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ManagedAppOperation]:
        """
    ...
    def to_post_request_information(self,body: ManagedAppOperation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to operations for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
