...
class PolicyRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[PolicyRequestBuilderGetQueryParameters]] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicy]:
        """
