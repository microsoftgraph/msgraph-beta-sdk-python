...
class AssignPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    wdac_policy_assignments: Optional[List[WindowsDefenderApplicationControlSupplementalPolicyAssignment]] = None
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            "wdacPolicyAssignments": lambda n : setattr(self, 'wdac_policy_assignments', n.get_collection_of_object_values(WindowsDefenderApplicationControlSupplementalPolicyAssignment)),
        }
        return fields
