...
class WindowsDefenderApplicationControlSupplementalPolicyItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicy]:
        """
    ...
    async def patch(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicy]:
        """
    ...
    def to_patch_request_information(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property wdacSupplementalPolicies in deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
