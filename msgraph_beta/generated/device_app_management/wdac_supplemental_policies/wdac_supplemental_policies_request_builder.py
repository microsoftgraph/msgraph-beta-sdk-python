...
class WdacSupplementalPoliciesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[WindowsDefenderApplicationControlSupplementalPolicy]:
        """
    ...
    def to_post_request_information(self,body: Optional[WindowsDefenderApplicationControlSupplementalPolicy] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to wdacSupplementalPolicies for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> WdacSupplementalPoliciesRequestBuilder:
        """
