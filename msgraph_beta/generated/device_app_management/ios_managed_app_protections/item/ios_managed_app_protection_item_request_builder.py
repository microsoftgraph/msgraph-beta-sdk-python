...
class IosManagedAppProtectionItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> IosManagedAppProtectionItemRequestBuilder:
        """
    ...
    @dataclass
    class IosManagedAppProtectionItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class IosManagedAppProtectionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[IosManagedAppProtectionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class IosManagedAppProtectionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
