...
class DefaultManagedAppProtectionItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DefaultManagedAppProtectionItemRequestBuilder:
        """
    ...
    @dataclass
    class DefaultManagedAppProtectionItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class DefaultManagedAppProtectionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[DefaultManagedAppProtectionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DefaultManagedAppProtectionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
