...
class ManagedEBooksRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ManagedEBook, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ManagedEBook]:
        """
    ...
    def to_post_request_information(self,body: ManagedEBook, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to managedEBooks for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ManagedEBooksRequestBuilder:
        """
    ...
    @dataclass
    class ManagedEBooksRequestBuilderGetRequestConfiguration(RequestConfiguration[ManagedEBooksRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ManagedEBooksRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
