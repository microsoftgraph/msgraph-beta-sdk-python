...
class UserInstallStateSummaryItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UserInstallStateSummaryItemRequestBuilder:
        """
    ...
    @dataclass
    class UserInstallStateSummaryItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class UserInstallStateSummaryItemRequestBuilderGetRequestConfiguration(RequestConfiguration[UserInstallStateSummaryItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class UserInstallStateSummaryItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
