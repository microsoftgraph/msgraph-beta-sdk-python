...
class ConvertFromMobileAppCatalogPackageWithMobileAppCatalogP_bc00b82f(BaseRequestBuilder):
    """
    Provides operations to call the convertFromMobileAppCatalogPackage method. Original name: ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], mobile_app_catalog_package_id: Optional[str] = None) -> None:
        """
        Instantiates a new ConvertFromMobileAppCatalogPackageWithMobileAppCatalogP_bc00b82f and sets the default values.
    ...
    def with_url(self,raw_url: str) -> ConvertFromMobileAppCatalogPackageWithMobileAppCatalogP_bc00b82f:
        """
        ...
        return ConvertFromMobileAppCatalogPackageWithMobileAppCatalogP_bc00b82f(self.request_adapter, raw_url)
    
    @dataclass
    class ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
