...
if TYPE_CHECKING:
    from ....models.android_managed_store_app_collection_response import AndroidManagedStoreAppCollectionResponse
...
class GraphAndroidManagedStoreAppRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.androidManagedStoreApp{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphAndroidManagedStoreAppRequestBuilderGetQueryParameters]] = None) -> Optional[AndroidManagedStoreAppCollectionResponse]:
        """
        ...
        Returns: Optional[AndroidManagedStoreAppCollectionResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, AndroidManagedStoreAppCollectionResponse, error_mapping)
