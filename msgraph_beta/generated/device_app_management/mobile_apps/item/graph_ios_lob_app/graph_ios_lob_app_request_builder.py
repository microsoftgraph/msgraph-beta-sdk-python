...
class GraphIosLobAppRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphIosLobAppRequestBuilderGetQueryParameters]] = None) -> Optional[IosLobApp]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GraphIosLobAppRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosLobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GraphIosLobAppRequestBuilder:
        """
    ...
    @dataclass
    class GraphIosLobAppRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphIosLobAppRequestBuilderGetQueryParameters]):
        """
