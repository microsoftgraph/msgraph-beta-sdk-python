...
if TYPE_CHECKING:
    ...
    from .....models.win32_lob_app import Win32LobApp
...
class GraphWin32LobAppRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.win32LobApp{?%24select,%24expand}", path_parameters)
    
    async def get(self,request_configuration: Optional[GraphWin32LobAppRequestBuilderGetRequestConfiguration] = None) -> Optional[Win32LobApp]:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.win32LobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[Win32LobApp]
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[GraphWin32LobAppRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.win32LobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphWin32LobAppRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphWin32LobAppRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GraphWin32LobAppRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphWin32LobAppRequestBuilderGetQueryParameters():
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.win32LobApp
        """
    ...
    @dataclass
    class GraphWin32LobAppRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GraphWin32LobAppRequestBuilder.GraphWin32LobAppRequestBuilderGetQueryParameters] = None
