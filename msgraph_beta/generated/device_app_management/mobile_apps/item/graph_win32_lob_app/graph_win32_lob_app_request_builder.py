...
class GraphWin32LobAppRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphWin32LobAppRequestBuilderGetQueryParameters]] = None) -> Optional[Win32LobApp]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GraphWin32LobAppRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.win32LobApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GraphWin32LobAppRequestBuilder:
        """
    ...
    @dataclass
    class GraphWin32LobAppRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphWin32LobAppRequestBuilderGetQueryParameters]):
        """
