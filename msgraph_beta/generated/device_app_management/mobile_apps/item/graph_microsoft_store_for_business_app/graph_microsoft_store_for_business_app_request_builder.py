...
class GraphMicrosoftStoreForBusinessAppRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphMicrosoftStoreForBusinessAppRequestBuilderGetQueryParameters]] = None) -> Optional[MicrosoftStoreForBusinessApp]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GraphMicrosoftStoreForBusinessAppRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.microsoftStoreForBusinessApp
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GraphMicrosoftStoreForBusinessAppRequestBuilder:
        """
    ...
    @dataclass
    class GraphMicrosoftStoreForBusinessAppRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphMicrosoftStoreForBusinessAppRequestBuilderGetQueryParameters]):
        """
