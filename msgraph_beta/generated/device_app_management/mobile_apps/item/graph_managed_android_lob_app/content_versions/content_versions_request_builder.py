...
class ContentVersionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedAndroidLobApp/contentVersions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_mobile_app_content_id(self,mobile_app_content_id: str) -> MobileAppContentItemRequestBuilder:
        ...
        """
        if mobile_app_content_id is None:
    ...
    async def post(self,body: MobileAppContent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MobileAppContent]:
        """
    ...
    def to_post_request_information(self,body: MobileAppContent, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to contentVersions for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ContentVersionsRequestBuilder:
        """
    ...
    @dataclass
    class ContentVersionsRequestBuilderGetRequestConfiguration(RequestConfiguration[ContentVersionsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class ContentVersionsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
