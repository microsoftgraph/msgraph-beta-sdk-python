...
class GraphWindowsAppXRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsAppX{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphWindowsAppXRequestBuilderGetQueryParameters]] = None) -> Optional[WindowsAppX]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GraphWindowsAppXRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the item of type microsoft.graph.mobileApp as microsoft.graph.windowsAppX
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GraphWindowsAppXRequestBuilder:
        """
    ...
    @dataclass
    class GraphWindowsAppXRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphWindowsAppXRequestBuilderGetQueryParameters]):
        """
