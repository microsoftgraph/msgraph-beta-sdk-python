...
class EnterpriseCodeSigningCertificatesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[EnterpriseCodeSigningCertificateCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[EnterpriseCodeSigningCertificate] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[EnterpriseCodeSigningCertificate]:
        """
    ...
    def to_post_request_information(self,body: Optional[EnterpriseCodeSigningCertificate] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to enterpriseCodeSigningCertificates for deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
