...
class SyncLicensesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[VppToken]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SyncLicensesRequestBuilder:
        """
