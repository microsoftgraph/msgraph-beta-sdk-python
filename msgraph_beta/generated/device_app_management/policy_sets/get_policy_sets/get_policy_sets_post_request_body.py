...
@dataclass
class GetPolicySetsPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    policy_set_ids: Optional[List[str]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetPolicySetsPostRequestBody:
        """
