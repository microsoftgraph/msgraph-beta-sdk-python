...
class GetPolicySetsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: GetPolicySetsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[GetPolicySetsPostResponse]:
        """
    ...
    def to_post_request_information(self,body: GetPolicySetsPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invoke action getPolicySets
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetPolicySetsRequestBuilder:
        """
    ...
    @dataclass
    class GetPolicySetsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
