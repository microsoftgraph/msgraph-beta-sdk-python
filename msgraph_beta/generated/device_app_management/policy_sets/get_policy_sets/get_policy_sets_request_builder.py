...
class GetPolicySetsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[GetPolicySetsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetPolicySetsPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[GetPolicySetsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action getPolicySets
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
