...
class PolicySetItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[PolicySet]:
        """
    ...
    async def patch(self,body: Optional[PolicySet] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[PolicySet]:
        """
    ...
    def to_patch_request_information(self,body: Optional[PolicySet] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property policySets in deviceAppManagement
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
