...
class ApplicationTemplateItemRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ApplicationTemplateItemRequestBuilder:
        """
    ...
    @dataclass
    class ApplicationTemplateItemRequestBuilderGetRequestConfiguration(RequestConfiguration[ApplicationTemplateItemRequestBuilderGetQueryParameters]):
        """
