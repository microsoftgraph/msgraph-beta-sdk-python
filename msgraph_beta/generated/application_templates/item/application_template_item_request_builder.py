...
if TYPE_CHECKING:
    ...
    from .instantiate.instantiate_request_builder import InstantiateRequestBuilder

class ApplicationTemplateItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/applicationTemplates/{applicationTemplate%2Did}{?%24expand,%24select}", path_parameters)
    ...
    def instantiate(self) -> InstantiateRequestBuilder:
        ...
        return InstantiateRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class ApplicationTemplateItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ApplicationTemplateItemRequestBuilder.ApplicationTemplateItemRequestBuilderGetQueryParameters] = None
