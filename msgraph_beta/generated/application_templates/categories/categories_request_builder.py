...
class CategoriesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/applicationTemplates/categories(){?%24count,%24filter,%24search,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[CategoriesRequestBuilderGetQueryParameters]] = None) -> Optional[CategoriesGetResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, CategoriesGetResponse, error_mapping)
