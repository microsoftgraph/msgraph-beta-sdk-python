...
class IncludedGroupsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/mobilityManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_group_id(self,group_id: str) -> GroupItemRequestBuilder:
        """
        Gets an item from the msgraph_beta.generated.mobilityManagementPolicies.item.includedGroups.item collection
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[IncludedGroupsRequestBuilderGetQueryParameters]] = None) -> Optional[GroupCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IncludedGroupsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Microsoft Entra groups under the scope of the mobility management application if appliesTo is selected
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IncludedGroupsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: IncludedGroupsRequestBuilder
        """
        if raw_url is None:
    ...
    @dataclass
    class IncludedGroupsRequestBuilderGetRequestConfiguration(RequestConfiguration[IncludedGroupsRequestBuilderGetQueryParameters]):
        """
