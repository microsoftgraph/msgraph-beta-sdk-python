...
class PreviewRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OnenotePagePreview]:
        """
    ...
    @dataclass
    class PreviewRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
