...
if TYPE_CHECKING:
    ...
    from .....models.onenote_resource_collection_response import OnenoteResourceCollectionResponse
    from .....models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.onenote_resource_item_request_builder import OnenoteResourceItemRequestBuilder
...
class ResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/onenote/resources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_onenote_resource_id(self,onenote_resource_id: str) -> OnenoteResourceItemRequestBuilder:
        """
        Provides operations to manage the resources property of the microsoft.graph.onenote entity.
        param onenote_resource_id: The unique identifier of onenoteResource
        ...
        if onenote_resource_id is None:
            raise TypeError("onenote_resource_id cannot be null.")
        from .item.onenote_resource_item_request_builder import OnenoteResourceItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["onenoteResource%2Did"] = onenote_resource_id
        return OnenoteResourceItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ResourcesRequestBuilderGetQueryParameters]] = None) -> Optional[OnenoteResourceCollectionResponse]:
        """
        ...
        Returns: Optional[OnenoteResourceCollectionResponse]
        """
        warn(" as of 2024-07/PrivatePreview:copilotExportAPI", DeprecationWarning)
    ...
    async def post(self,body: OnenoteResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[OnenoteResource]:
        """
    ...
    def to_post_request_information(self,body: OnenoteResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to resources for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
