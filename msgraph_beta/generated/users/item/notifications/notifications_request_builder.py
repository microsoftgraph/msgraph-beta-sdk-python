...
if TYPE_CHECKING:
    ...
    from ....models.notification_collection_response import NotificationCollectionResponse
...
class NotificationsRequestBuilder(BaseRequestBuilder):
    ...
    def by_notification_id(self,notification_id: str) -> NotificationItemRequestBuilder:
        """
        Provides operations to manage the notifications property of the microsoft.graph.user entity.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[NotificationsRequestBuilderGetQueryParameters]] = None) -> Optional[NotificationCollectionResponse]:
        """
    ...
    async def post(self,body: Notification, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Notification]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[NotificationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        warn("The Graph Notification API is deprecated and will stop returning data on March 20, 2023. as of 2023-03/Notification_Deprecation on 2023-03-09 and will be removed 2023-03-20", DeprecationWarning)
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/notifications{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: Notification, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create new navigation property to notifications for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/users/{user%2Did}/notifications', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @dataclass
    class NotificationsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
