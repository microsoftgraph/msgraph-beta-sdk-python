...
class AppConsentRequestsForApprovalRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AppConsentRequestsForApprovalRequestBuilder:
        """
    ...
    @dataclass
    class AppConsentRequestsForApprovalRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class AppConsentRequestsForApprovalRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
