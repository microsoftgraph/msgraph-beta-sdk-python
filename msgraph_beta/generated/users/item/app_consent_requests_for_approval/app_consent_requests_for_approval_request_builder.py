...
class AppConsentRequestsForApprovalRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AppConsentRequestsForApprovalRequestBuilderGetQueryParameters]] = None) -> Optional[AppConsentRequestCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AppConsentRequestsForApprovalRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get appConsentRequestsForApproval from users
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: AppConsentRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: str) -> AppConsentRequestsForApprovalRequestBuilder:
        """
    ...
    @dataclass
    class AppConsentRequestsForApprovalRequestBuilderGetRequestConfiguration(RequestConfiguration[AppConsentRequestsForApprovalRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class AppConsentRequestsForApprovalRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
