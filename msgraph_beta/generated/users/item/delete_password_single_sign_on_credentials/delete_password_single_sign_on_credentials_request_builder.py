...
class DeletePasswordSingleSignOnCredentialsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DeletePasswordSingleSignOnCredentialsRequestBuilder:
        """
    ...
    @dataclass
    class DeletePasswordSingleSignOnCredentialsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
