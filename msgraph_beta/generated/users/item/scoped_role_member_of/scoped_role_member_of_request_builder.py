...
class ScopedRoleMemberOfRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/scopedRoleMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[ScopedRoleMemberOfRequestBuilderGetRequestConfiguration] = None) -> Optional[ScopedRoleMembershipCollectionResponse]:
        """
        Retrieve a list of scopedRoleMembership for the user. This API is available in the following national cloud deployments.
    ...
    async def post(self,body: Optional[ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMemberOfRequestBuilderPostRequestConfiguration] = None) -> Optional[ScopedRoleMembership]:
        """
    ...
    def to_post_request_information(self,body: Optional[ScopedRoleMembership] = None, request_configuration: Optional[ScopedRoleMemberOfRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to scopedRoleMemberOf for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> ScopedRoleMemberOfRequestBuilder:
        """
    ...
    @dataclass
    class ScopedRoleMemberOfRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class ScopedRoleMemberOfRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
