...
class TranslateExchangeIdsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[TranslateExchangeIdsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[TranslateExchangeIdsPostResponse]:
        """
    ...
    def to_post_request_information(self,body: Optional[TranslateExchangeIdsPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Translate identifiers of Outlook-related resources between formats.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TranslateExchangeIdsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: TranslateExchangeIdsRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return TranslateExchangeIdsRequestBuilder(self.request_adapter, raw_url)
