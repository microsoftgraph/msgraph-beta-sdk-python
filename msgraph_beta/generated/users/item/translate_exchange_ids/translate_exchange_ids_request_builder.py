...
class TranslateExchangeIdsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> TranslateExchangeIdsRequestBuilder:
        """
    ...
    @dataclass
    class TranslateExchangeIdsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
