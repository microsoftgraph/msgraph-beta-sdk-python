...
if TYPE_CHECKING:
    ...
    from ......models.teamwork_section import TeamworkSection
    from .items.items_request_builder import ItemsRequestBuilder

class TeamworkSectionItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/teamwork/sections/{teamworkSection%2Did}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[TeamworkSectionItemRequestBuilderGetQueryParameters]] = None) -> Optional[TeamworkSection]:
        ...
        return await self.request_adapter.send_async(request_info, TeamworkSection, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[TeamworkSectionItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/teamwork/sections/{teamworkSection%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> TeamworkSectionItemRequestBuilder:
        """
        ...
        return TeamworkSectionItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class TeamworkSectionItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class TeamworkSectionItemRequestBuilderGetRequestConfiguration(RequestConfiguration[TeamworkSectionItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class TeamworkSectionItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
