...
class ItemsRequestBuilder(BaseRequestBuilder):
    ...
    def by_teamwork_section_item_id(self,teamwork_section_item_id: str) -> TeamworkSectionItemItemRequestBuilder:
        """
        Provides operations to manage the items property of the microsoft.graph.teamworkSection entity.
        param teamwork_section_item_id: The unique identifier of teamworkSectionItem
        Returns: TeamworkSectionItemItemRequestBuilder
        """
        if teamwork_section_item_id is None:
            raise TypeError("teamwork_section_item_id cannot be null.")
        from .item.teamwork_section_item_item_request_builder import TeamworkSectionItemItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["teamworkSectionItem%2Did"] = teamwork_section_item_id
        return TeamworkSectionItemItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ItemsRequestBuilderGetQueryParameters]] = None) -> Optional[TeamworkSectionItemCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, TeamworkSectionItemCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ItemsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/teamwork/sections/{teamworkSection%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: TeamworkSectionItem, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/users/{user%2Did}/teamwork/sections/{teamworkSection%2Did}/items', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
