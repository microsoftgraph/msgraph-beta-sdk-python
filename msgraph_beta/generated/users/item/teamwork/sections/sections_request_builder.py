...
if TYPE_CHECKING:
    ...
    from .....models.teamwork_section_collection_response import TeamworkSectionCollectionResponse
    from .count.count_request_builder import CountRequestBuilder
    from .item.teamwork_section_item_request_builder import TeamworkSectionItemRequestBuilder
...
class SectionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_teamwork_section_id(self,teamwork_section_id: str) -> TeamworkSectionItemRequestBuilder:
        """
        Provides operations to manage the sections property of the microsoft.graph.userTeamwork entity.
        param teamwork_section_id: The unique identifier of teamworkSection
        Returns: TeamworkSectionItemRequestBuilder
        """
        if teamwork_section_id is None:
            raise TypeError("teamwork_section_id cannot be null.")
        from .item.teamwork_section_item_request_builder import TeamworkSectionItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["teamworkSection%2Did"] = teamwork_section_id
        return TeamworkSectionItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SectionsRequestBuilderGetQueryParameters]] = None) -> Optional[TeamworkSectionCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, TeamworkSectionCollectionResponse, error_mapping)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SectionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/teamwork/sections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
    ...
    def to_post_request_information(self,body: TeamworkSection, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/users/{user%2Did}/teamwork/sections', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
