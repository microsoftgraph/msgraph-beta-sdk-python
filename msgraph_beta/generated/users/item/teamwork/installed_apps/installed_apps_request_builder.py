...
class InstalledAppsRequestBuilder(BaseRequestBuilder):
    ...
    def by_user_scope_teams_app_installation_id(self,user_scope_teams_app_installation_id: str) -> UserScopeTeamsAppInstallationItemRequestBuilder:
        """
        Provides operations to manage the installedApps property of the microsoft.graph.userTeamwork entity.
        param user_scope_teams_app_installation_id: The unique identifier of userScopeTeamsAppInstallation
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[InstalledAppsRequestBuilderGetQueryParameters]] = None) -> Optional[UserScopeTeamsAppInstallationCollectionResponse]:
        """
    ...
    async def post(self,body: UserScopeTeamsAppInstallation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserScopeTeamsAppInstallation]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[InstalledAppsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/teamwork/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_post_request_information(self,body: UserScopeTeamsAppInstallation, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Install an app in the personal scope of the specified user.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.POST, '{+baseurl}/users/{user%2Did}/teamwork/installedApps', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
