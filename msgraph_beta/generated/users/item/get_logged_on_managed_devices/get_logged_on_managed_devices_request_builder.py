...
class GetLoggedOnManagedDevicesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetLoggedOnManagedDevicesRequestBuilder:
        """
    ...
    @dataclass
    class GetLoggedOnManagedDevicesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
