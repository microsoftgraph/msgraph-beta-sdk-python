...
class WipeAndBlockManagedAppsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> WipeAndBlockManagedAppsRequestBuilder:
        """
    ...
    @dataclass
    class WipeAndBlockManagedAppsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
