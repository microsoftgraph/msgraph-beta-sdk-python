...
class SponsorOfRequestBuilder(BaseRequestBuilder):
    """
    Provides operations to manage the sponsorOf property of the microsoft.graph.user entity.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new SponsorOfRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/sponsorOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SponsorOfRequestBuilderGetQueryParameters]] = None) -> Optional[DirectoryObjectCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SponsorOfRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the directory objects that a user sponsors. Sponsored objects can include users, agent users, agent blueprints, agent blueprint principals, and agent identities. Because a group can also be a sponsor, the response includes both objects the user directly sponsors and objects the user sponsors through group membership.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SponsorOfRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SponsorOfRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SponsorOfRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class SponsorOfRequestBuilderGetQueryParameters():
        """
        Get the directory objects that a user sponsors. Sponsored objects can include users, agent users, agent blueprints, agent blueprint principals, and agent identities. Because a group can also be a sponsor, the response includes both objects the user directly sponsors and objects the user sponsors through group membership.
        """
    ...
    @dataclass
    class SponsorOfRequestBuilderGetRequestConfiguration(RequestConfiguration[SponsorOfRequestBuilderGetQueryParameters]):
        """
