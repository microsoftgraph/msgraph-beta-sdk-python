...
class AnalyticsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserAnalytics]:
        """
    ...
    async def patch(self,body: Optional[UserAnalytics] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserAnalytics]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UserAnalytics] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property analytics in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
