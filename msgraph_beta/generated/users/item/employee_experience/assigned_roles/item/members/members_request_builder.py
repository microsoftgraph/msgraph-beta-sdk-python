...
if TYPE_CHECKING:
    ...
    from .......models.engagement_role_member_collection_response import EngagementRoleMemberCollectionResponse
    from .......models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.engagement_role_member_item_request_builder import EngagementRoleMemberItemRequestBuilder
...
class MembersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_engagement_role_member_id(self,engagement_role_member_id: str) -> EngagementRoleMemberItemRequestBuilder:
        """
        Provides operations to manage the members property of the microsoft.graph.engagementRole entity.
        param engagement_role_member_id: The unique identifier of engagementRoleMember
        Returns: EngagementRoleMemberItemRequestBuilder
        """
        if engagement_role_member_id is None:
            raise TypeError("engagement_role_member_id cannot be null.")
        from .item.engagement_role_member_item_request_builder import EngagementRoleMemberItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["engagementRoleMember%2Did"] = engagement_role_member_id
        return EngagementRoleMemberItemRequestBuilder(self.request_adapter, url_tpl_params)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MembersRequestBuilderGetQueryParameters]] = None) -> Optional[EngagementRoleMemberCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, EngagementRoleMemberCollectionResponse, error_mapping)
