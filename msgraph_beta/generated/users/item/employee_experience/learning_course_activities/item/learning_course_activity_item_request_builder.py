...
class LearningCourseActivityItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/employeeExperience/learningCourseActivities/{learningCourseActivity%2Did}{?%24expand,%24select}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[LearningCourseActivityItemRequestBuilderGetQueryParameters]] = None) -> Optional[LearningCourseActivity]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[LearningCourseActivityItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get the specified learningCourseActivity object using either an ID or an externalCourseActivityId of the learning provider, or a courseActivityId of a user.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> LearningCourseActivityItemRequestBuilder:
        """
    ...
    @dataclass
    class LearningCourseActivityItemRequestBuilderGetRequestConfiguration(RequestConfiguration[LearningCourseActivityItemRequestBuilderGetQueryParameters]):
        """
