...
if TYPE_CHECKING:
    ...
    from .find_room_lists.find_room_lists_request_builder import FindRoomListsRequestBuilder
    from .followed_sites.followed_sites_request_builder import FollowedSitesRequestBuilder
    from .get_effective_device_enrollment_configurations.get_effective_device_enrollment_configurations_request_builder import GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder
    from .get_logged_on_managed_devices.get_logged_on_managed_devices_request_builder import GetLoggedOnManagedDevicesRequestBuilder
    ...
    from .invalidate_all_refresh_tokens.invalidate_all_refresh_tokens_request_builder import InvalidateAllRefreshTokensRequestBuilder
    from .invited_by.invited_by_request_builder import InvitedByRequestBuilder
    from .is_managed_app_user_blocked.is_managed_app_user_blocked_request_builder import IsManagedAppUserBlockedRequestBuilder
    from .joined_groups.joined_groups_request_builder import JoinedGroupsRequestBuilder
    ...
    from .managed_app_log_collection_requests.managed_app_log_collection_requests_request_builder import ManagedAppLogCollectionRequestsRequestBuilder
    ...
    from .mobile_app_intent_and_states.mobile_app_intent_and_states_request_builder import MobileAppIntentAndStatesRequestBuilder
    ...
    from .pending_access_review_instances.pending_access_review_instances_request_builder import PendingAccessReviewInstancesRequestBuilder
    ...
    from .profile.profile_request_builder import ProfileRequestBuilder
    ...
    from .wipe_managed_app_registrations_by_azure_ad_device_id.wipe_managed_app_registrations_by_azure_ad_device_id_request_builder import WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder
...
class UserItemRequestBuilder(BaseRequestBuilder):
    ...
    def app_role_assigned_resources_with_app_id(self,app_id: str) -> AppRoleAssignedResourcesWithAppIdRequestBuilder:
        """
    ...
    def find_rooms_with_room_list(self,room_list: str) -> FindRoomsWithRoomListRequestBuilder:
        """
        ...
        return FindRoomsWithRoomListRequestBuilder(self.request_adapter, self.path_parameters, room_list)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    @property
    def app_consent_requests_for_approval(self) -> AppConsentRequestsForApprovalRequestBuilder:
        """
        Provides operations to manage the appConsentRequestsForApproval property of the microsoft.graph.user entity.
        """
        from .app_consent_requests_for_approval.app_consent_requests_for_approval_request_builder import AppConsentRequestsForApprovalRequestBuilder

        return AppConsentRequestsForApprovalRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def app_role_assigned_resources(self) -> AppRoleAssignedResourcesRequestBuilder:
        """
        Provides operations to manage the appRoleAssignedResources property of the microsoft.graph.user entity.
        """
        from .app_role_assigned_resources.app_role_assigned_resources_request_builder import AppRoleAssignedResourcesRequestBuilder

        return AppRoleAssignedResourcesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def find_room_lists(self) -> FindRoomListsRequestBuilder:
        """
        Provides operations to call the findRoomLists method.
        """
        from .find_room_lists.find_room_lists_request_builder import FindRoomListsRequestBuilder

        return FindRoomListsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def find_rooms(self) -> FindRoomsRequestBuilder:
        """
        Provides operations to call the findRooms method.
        """
        from .find_rooms.find_rooms_request_builder import FindRoomsRequestBuilder

        return FindRoomsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def get_effective_device_enrollment_configurations(self) -> GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder:
        """
        Provides operations to call the getEffectiveDeviceEnrollmentConfigurations method.
        """
        from .get_effective_device_enrollment_configurations.get_effective_device_enrollment_configurations_request_builder import GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder

        return GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def get_logged_on_managed_devices(self) -> GetLoggedOnManagedDevicesRequestBuilder:
        """
        Provides operations to call the getLoggedOnManagedDevices method.
        """
        from .get_logged_on_managed_devices.get_logged_on_managed_devices_request_builder import GetLoggedOnManagedDevicesRequestBuilder

        return GetLoggedOnManagedDevicesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def get_managed_devices_with_failed_or_pending_apps(self) -> GetManagedDevicesWithFailedOrPendingAppsRequestBuilder:
        """
        Provides operations to call the getManagedDevicesWithFailedOrPendingApps method.
        """
        from .get_managed_devices_with_failed_or_pending_apps.get_managed_devices_with_failed_or_pending_apps_request_builder import GetManagedDevicesWithFailedOrPendingAppsRequestBuilder

        return GetManagedDevicesWithFailedOrPendingAppsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def invalidate_all_refresh_tokens(self) -> InvalidateAllRefreshTokensRequestBuilder:
        """
        Provides operations to call the invalidateAllRefreshTokens method.
        """
        from .invalidate_all_refresh_tokens.invalidate_all_refresh_tokens_request_builder import InvalidateAllRefreshTokensRequestBuilder

        return InvalidateAllRefreshTokensRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def invited_by(self) -> InvitedByRequestBuilder:
        """
        Provides operations to manage the invitedBy property of the microsoft.graph.user entity.
        """
        from .invited_by.invited_by_request_builder import InvitedByRequestBuilder

        return InvitedByRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def is_managed_app_user_blocked(self) -> IsManagedAppUserBlockedRequestBuilder:
        """
        Provides operations to call the isManagedAppUserBlocked method.
        """
        from .is_managed_app_user_blocked.is_managed_app_user_blocked_request_builder import IsManagedAppUserBlockedRequestBuilder

        return IsManagedAppUserBlockedRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def joined_groups(self) -> JoinedGroupsRequestBuilder:
        """
        Provides operations to manage the joinedGroups property of the microsoft.graph.user entity.
        """
        from .joined_groups.joined_groups_request_builder import JoinedGroupsRequestBuilder

        return JoinedGroupsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def managed_app_log_collection_requests(self) -> ManagedAppLogCollectionRequestsRequestBuilder:
        """
        Provides operations to manage the managedAppLogCollectionRequests property of the microsoft.graph.user entity.
        """
        from .managed_app_log_collection_requests.managed_app_log_collection_requests_request_builder import ManagedAppLogCollectionRequestsRequestBuilder

        return ManagedAppLogCollectionRequestsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def mobile_app_intent_and_states(self) -> MobileAppIntentAndStatesRequestBuilder:
        """
        Provides operations to manage the mobileAppIntentAndStates property of the microsoft.graph.user entity.
        """
        from .mobile_app_intent_and_states.mobile_app_intent_and_states_request_builder import MobileAppIntentAndStatesRequestBuilder

        return MobileAppIntentAndStatesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def pending_access_review_instances(self) -> PendingAccessReviewInstancesRequestBuilder:
        """
        Provides operations to manage the pendingAccessReviewInstances property of the microsoft.graph.user entity.
        """
        from .pending_access_review_instances.pending_access_review_instances_request_builder import PendingAccessReviewInstancesRequestBuilder

        return PendingAccessReviewInstancesRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def profile(self) -> ProfileRequestBuilder:
        """
        Provides operations to manage the profile property of the microsoft.graph.user entity.
        """
        from .profile.profile_request_builder import ProfileRequestBuilder

        return ProfileRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def unblock_managed_apps(self) -> UnblockManagedAppsRequestBuilder:
        """
        Provides operations to call the unblockManagedApps method.
        """
        from .unblock_managed_apps.unblock_managed_apps_request_builder import UnblockManagedAppsRequestBuilder

        return UnblockManagedAppsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @property
    def wipe_and_block_managed_apps(self) -> WipeAndBlockManagedAppsRequestBuilder:
        """
        Provides operations to call the wipeAndBlockManagedApps method.
        """
        from .wipe_and_block_managed_apps.wipe_and_block_managed_apps_request_builder import WipeAndBlockManagedAppsRequestBuilder

        return WipeAndBlockManagedAppsRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def wipe_managed_app_registration_by_device_tag(self) -> WipeManagedAppRegistrationByDeviceTagRequestBuilder:
        """
        Provides operations to call the wipeManagedAppRegistrationByDeviceTag method.
        """
        from .wipe_managed_app_registration_by_device_tag.wipe_managed_app_registration_by_device_tag_request_builder import WipeManagedAppRegistrationByDeviceTagRequestBuilder

        return WipeManagedAppRegistrationByDeviceTagRequestBuilder(self.request_adapter, self.path_parameters)
    
    @property
    def wipe_managed_app_registrations_by_azure_ad_device_id(self) -> WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder:
        """
        Provides operations to call the wipeManagedAppRegistrationsByAzureAdDeviceId method.
        """
        from .wipe_managed_app_registrations_by_azure_ad_device_id.wipe_managed_app_registrations_by_azure_ad_device_id_request_builder import WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder

        return WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder(self.request_adapter, self.path_parameters)
