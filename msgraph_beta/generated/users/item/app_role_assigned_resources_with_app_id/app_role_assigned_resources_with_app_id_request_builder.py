...
class AppRoleAssignedResourcesWithAppIdRequestBuilder(BaseRequestBuilder):
    """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get appRoleAssignedResources from users
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AppRoleAssignedResourcesWithAppIdRequestBuilder:
        """
    ...
    @dataclass
    class AppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters():
        """
        Get appRoleAssignedResources from users
        """
    ...
    @dataclass
    class AppRoleAssignedResourcesWithAppIdRequestBuilderGetRequestConfiguration(RequestConfiguration[AppRoleAssignedResourcesWithAppIdRequestBuilderGetQueryParameters]):
        """
