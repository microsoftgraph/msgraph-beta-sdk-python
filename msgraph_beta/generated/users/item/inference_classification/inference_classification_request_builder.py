...
class InferenceClassificationRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[InferenceClassification]:
        """
    ...
    async def patch(self,body: Optional[InferenceClassification] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[InferenceClassification]:
        """
    ...
    def to_patch_request_information(self,body: Optional[InferenceClassification] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property inferenceClassification in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
