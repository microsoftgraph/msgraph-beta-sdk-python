...
class QuotaRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/settings/storage/quota{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[QuotaRequestBuilderGetRequestConfiguration] = None) -> Optional[UnifiedStorageQuota]:
        """
    ...
    async def patch(self,body: Optional[UnifiedStorageQuota] = None, request_configuration: Optional[QuotaRequestBuilderPatchRequestConfiguration] = None) -> Optional[UnifiedStorageQuota]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UnifiedStorageQuota] = None, request_configuration: Optional[QuotaRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property quota in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
