...
class QuotaRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[UnifiedStorageQuota] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnifiedStorageQuota]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UnifiedStorageQuota] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property quota in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
