...
class StorageRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserStorage]:
        """
    ...
    async def patch(self,body: Optional[UserStorage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UserStorage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UserStorage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property storage in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
