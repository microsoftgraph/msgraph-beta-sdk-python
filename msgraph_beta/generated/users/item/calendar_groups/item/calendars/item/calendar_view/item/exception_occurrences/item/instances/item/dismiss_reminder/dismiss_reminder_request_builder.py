...
class DismissReminderRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> DismissReminderRequestBuilder:
        """
    ...
    @dataclass
    class DismissReminderRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
