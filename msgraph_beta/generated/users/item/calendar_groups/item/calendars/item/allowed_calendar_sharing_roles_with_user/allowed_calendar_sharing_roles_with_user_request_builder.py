...
class AllowedCalendarSharingRolesWithUserRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], user: Optional[str] = None) -> None:
        """
        ...
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/allowedCalendarSharingRoles(User='{User}'){?%24count,%24filter,%24search,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> AllowedCalendarSharingRolesWithUserRequestBuilder:
        """
    ...
    @dataclass
    class AllowedCalendarSharingRolesWithUserRequestBuilderGetRequestConfiguration(RequestConfiguration[AllowedCalendarSharingRolesWithUserRequestBuilderGetQueryParameters]):
        """
