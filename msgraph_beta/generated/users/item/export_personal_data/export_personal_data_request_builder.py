...
class ExportPersonalDataRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ExportPersonalDataPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        """
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/user-exportpersonaldata?view=graph-rest-beta
        """
    ...
    def to_post_request_information(self,body: ExportPersonalDataPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Submit a data policy operation request from a company administrator or an application to export an organizational user's data. This data includes the user's data stored in OneDrive and their activity reports. For more information about exporting data while complying with regulations, see Data Subject Requests and the GDPR and CCPA.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> ExportPersonalDataRequestBuilder:
        """
    ...
    @dataclass
    class ExportPersonalDataRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
