...
class InvitedByRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> InvitedByRequestBuilder:
        """
    ...
    @dataclass
    class InvitedByRequestBuilderGetRequestConfiguration(RequestConfiguration[InvitedByRequestBuilderGetQueryParameters]):
        """
