...
class ReprocessLicenseAssignmentRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[User]:
        """
    ...
    def with_url(self,raw_url: str) -> ReprocessLicenseAssignmentRequestBuilder:
        """
    ...
    @dataclass
    class ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
