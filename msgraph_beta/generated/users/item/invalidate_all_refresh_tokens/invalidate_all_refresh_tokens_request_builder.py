...
class InvalidateAllRefreshTokensRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[InvalidateAllRefreshTokensPostResponse]:
        """
    ...
    def with_url(self,raw_url: str) -> InvalidateAllRefreshTokensRequestBuilder:
        """
    ...
    @dataclass
    class InvalidateAllRefreshTokensRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
