...
class HistoryItemsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ActivityHistoryItemCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[ActivityHistoryItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ActivityHistoryItem]:
        """
    ...
    def to_post_request_information(self,body: Optional[ActivityHistoryItem] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to historyItems for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
