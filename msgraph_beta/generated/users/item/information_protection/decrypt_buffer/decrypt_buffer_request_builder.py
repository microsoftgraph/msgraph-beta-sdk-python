...
class DecryptBufferRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[DecryptBufferPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[BufferDecryptionResult]:
        """
    ...
    def to_post_request_information(self,body: Optional[DecryptBufferPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Invoke action decryptBuffer
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
