...
class PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder:
        """
    ...
    @dataclass
    class PasswordlessMicrosoftAuthenticatorMethodsRequestBuilderGetRequestConfiguration(RequestConfiguration[PasswordlessMicrosoftAuthenticatorMethodsRequestBuilderGetQueryParameters]):
        """
