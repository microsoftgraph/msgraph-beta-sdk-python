...
class PlatformCredentialMethodsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/authentication/platformCredentialMethods{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_platform_credential_authentication_method_id(self,platform_credential_authentication_method_id: str) -> PlatformCredentialAuthenticationMethodItemRequestBuilder:
        ...
        if platform_credential_authentication_method_id is None:
    ...
    def with_url(self,raw_url: str) -> PlatformCredentialMethodsRequestBuilder:
        """
    ...
    @dataclass
    class PlatformCredentialMethodsRequestBuilderGetRequestConfiguration(RequestConfiguration[PlatformCredentialMethodsRequestBuilderGetQueryParameters]):
        """
