...
class GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEffectiveDeviceEnrollmentConfigurationsRequestBuilder:
        """
    ...
    @dataclass
    class GetEffectiveDeviceEnrollmentConfigurationsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
