...
class BulkResizeRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: BulkResizePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[BulkResizePostResponse]:
        ...
        """
        warn("The bulkResize action is deprecated and will stop supporting on September 24, 2023. Please use bulk action entity api. as of 2023-05/bulkResize on 2023-05-24 and will be removed 2023-09-24", DeprecationWarning)
        if body is None:
    ...
    def with_url(self,raw_url: str) -> BulkResizeRequestBuilder:
        """
    ...
    @dataclass
    class BulkResizeRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
