...
class RetryPartnerAgentInstallationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> RetryPartnerAgentInstallationRequestBuilder:
        """
    ...
    @dataclass
    class RetryPartnerAgentInstallationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
