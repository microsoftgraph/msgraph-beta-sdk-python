...
class GetCloudPcLaunchInfoRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/cloudPCs/{cloudPC%2Did}/getCloudPcLaunchInfo()", path_parameters)
    ...
    def with_url(self,raw_url: str) -> GetCloudPcLaunchInfoRequestBuilder:
        """
    ...
    @dataclass
    class GetCloudPcLaunchInfoRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
