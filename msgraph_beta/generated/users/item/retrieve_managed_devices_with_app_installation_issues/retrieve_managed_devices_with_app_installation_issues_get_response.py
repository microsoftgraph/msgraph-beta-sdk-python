...
@dataclass
class RetrieveManagedDevicesWithAppInstallationIssuesGetResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[ManagedDeviceSummarizedAppState]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RetrieveManagedDevicesWithAppInstallationIssuesGetResponse:
        """
        ...
        return RetrieveManagedDevicesWithAppInstallationIssuesGetResponse()
