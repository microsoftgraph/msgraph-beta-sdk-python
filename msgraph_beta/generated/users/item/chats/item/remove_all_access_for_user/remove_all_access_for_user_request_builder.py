...
class RemoveAllAccessForUserRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RemoveAllAccessForUserPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: Optional[RemoveAllAccessForUserPostRequestBody] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Remove access to a chat for a user.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
