...
if TYPE_CHECKING:
    ...
    from .start_migration_post_request_body import StartMigrationPostRequestBody

class StartMigrationRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/startMigration", path_parameters)
    ...
    async def post(self,body: StartMigrationPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        ...
        Returns: None
        Find more info here: https://learn.microsoft.com/graph/api/chat-startmigration?view=graph-rest-beta
        """
        if body is None:
    ...
    def with_url(self,raw_url: str) -> StartMigrationRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: StartMigrationRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return StartMigrationRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class StartMigrationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
