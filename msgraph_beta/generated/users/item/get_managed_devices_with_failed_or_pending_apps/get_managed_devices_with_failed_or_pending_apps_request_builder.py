...
class GetManagedDevicesWithFailedOrPendingAppsRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetManagedDevicesWithFailedOrPendingAppsRequestBuilder:
        """
    ...
    @dataclass
    class GetManagedDevicesWithFailedOrPendingAppsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
