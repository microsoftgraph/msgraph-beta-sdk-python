...
class MicrosoftGraphSecurityEvaluateRemovalRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityEvaluateRemovalRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphSecurityEvaluateRemovalRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
