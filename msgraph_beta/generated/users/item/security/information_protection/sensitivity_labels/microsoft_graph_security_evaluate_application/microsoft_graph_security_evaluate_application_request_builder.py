...
class MicrosoftGraphSecurityEvaluateApplicationRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityEvaluateApplicationRequestBuilder:
        """
    ...
    @dataclass
    class MicrosoftGraphSecurityEvaluateApplicationRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
