...
class MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MicrosoftGraphSecurityEvaluateClassificationResultsRequ_fb04bbec(self.request_adapter, raw_url)
