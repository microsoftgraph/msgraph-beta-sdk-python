...
class AttachmentBaseItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AttachmentBase]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AttachmentBaseItemRequestBuilder:
        """
