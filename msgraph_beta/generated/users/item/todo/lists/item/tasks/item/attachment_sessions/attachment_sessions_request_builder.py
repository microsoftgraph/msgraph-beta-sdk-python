...
class AttachmentSessionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[AttachmentSessionCollectionResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> AttachmentSessionsRequestBuilder:
        """
