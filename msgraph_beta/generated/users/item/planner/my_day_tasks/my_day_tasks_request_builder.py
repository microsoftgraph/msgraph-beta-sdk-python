...
class MyDayTasksRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/planner/myDayTasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MyDayTasksRequestBuilderGetQueryParameters]] = None) -> Optional[PlannerTaskCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MyDayTasksRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Read-only. Nullable. Returns the plannerTasks to be shown in the My Day view of the user.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MyDayTasksRequestBuilder:
        """
    ...
    @dataclass
    class MyDayTasksRequestBuilderGetRequestConfiguration(RequestConfiguration[MyDayTasksRequestBuilderGetQueryParameters]):
        """
