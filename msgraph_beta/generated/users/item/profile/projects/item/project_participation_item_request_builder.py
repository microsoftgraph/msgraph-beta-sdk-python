...
class ProjectParticipationItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ProjectParticipation]:
        """
    ...
    async def patch(self,body: Optional[ProjectParticipation] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ProjectParticipation]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ProjectParticipation] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the properties of a projectParticipation object in a user's profile.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
