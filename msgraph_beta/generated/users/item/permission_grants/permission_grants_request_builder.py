...
class PermissionGrantsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[ResourceSpecificPermissionGrant] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ResourceSpecificPermissionGrant]:
        """
    ...
    def to_post_request_information(self,body: Optional[ResourceSpecificPermissionGrant] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to permissionGrants for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
