...
@dataclass
class MarkAsNotJunkPostRequestBody(AdditionalDataHolder, BackedModel, Parsable):
    ...
    move_to_inbox: Optional[bool] = False
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MarkAsNotJunkPostRequestBody:
        """
