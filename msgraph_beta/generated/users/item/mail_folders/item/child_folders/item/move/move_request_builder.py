...
class MoveRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: MovePostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MailFolder]:
        """
    ...
    @dataclass
    class MoveRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
