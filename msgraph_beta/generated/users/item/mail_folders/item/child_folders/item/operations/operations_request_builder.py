...
if TYPE_CHECKING:
    from ........models.mail_folder_operation_collection_response import MailFolderOperationCollectionResponse
    from ........models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder
    from .item.mail_folder_operation_item_request_builder import MailFolderOperationItemRequestBuilder
...
class OperationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_mail_folder_operation_id(self,mail_folder_operation_id: str) -> MailFolderOperationItemRequestBuilder:
        """
        Provides operations to manage the operations property of the microsoft.graph.mailFolder entity.
        param mail_folder_operation_id: The unique identifier of mailFolderOperation
        ...
        if mail_folder_operation_id is None:
            raise TypeError("mail_folder_operation_id cannot be null.")
        from .item.mail_folder_operation_item_request_builder import MailFolderOperationItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["mailFolderOperation%2Did"] = mail_folder_operation_id
        return MailFolderOperationItemRequestBuilder(self.request_adapter, url_tpl_params)
