...
class UserConfigurationsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/userConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> UserConfigurationsRequestBuilder:
        """
    ...
    @dataclass
    class UserConfigurationsRequestBuilderGetRequestConfiguration(RequestConfiguration[UserConfigurationsRequestBuilderGetQueryParameters]):
        """
