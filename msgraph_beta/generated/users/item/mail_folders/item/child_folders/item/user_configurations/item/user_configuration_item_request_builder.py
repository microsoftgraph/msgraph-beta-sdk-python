...
class UserConfigurationItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/userConfigurations/{userConfiguration%2Did}{?%24expand,%24select}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> UserConfigurationItemRequestBuilder:
        """
    ...
    @dataclass
    class UserConfigurationItemRequestBuilderGetRequestConfiguration(RequestConfiguration[UserConfigurationItemRequestBuilderGetQueryParameters]):
        """
