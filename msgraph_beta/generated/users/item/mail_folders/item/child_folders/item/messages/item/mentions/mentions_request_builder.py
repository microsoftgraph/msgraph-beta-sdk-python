...
class MentionsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[MentionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[Mention] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[Mention]:
        """
    ...
    def to_post_request_information(self,body: Optional[Mention] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Create new navigation property to mentions for users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
