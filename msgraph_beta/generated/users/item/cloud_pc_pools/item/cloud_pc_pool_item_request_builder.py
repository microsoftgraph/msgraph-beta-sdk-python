...
class CloudPcPoolItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[CloudPcPoolItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/users/{user%2Did}/cloudPcPools/{cloudPcPool%2Did}{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    ...
    def with_url(self,raw_url: str) -> CloudPcPoolItemRequestBuilder:
        """
        ...
        return CloudPcPoolItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class CloudPcPoolItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class CloudPcPoolItemRequestBuilderGetRequestConfiguration(RequestConfiguration[CloudPcPoolItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class CloudPcPoolItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
