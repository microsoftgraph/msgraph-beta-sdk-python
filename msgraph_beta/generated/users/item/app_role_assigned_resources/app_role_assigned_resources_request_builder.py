...
class AppRoleAssignedResourcesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/appRoleAssignedResources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[AppRoleAssignedResourcesRequestBuilderGetQueryParameters]] = None) -> Optional[ServicePrincipalCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[AppRoleAssignedResourcesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get appRoleAssignedResources from users
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> AppRoleAssignedResourcesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: AppRoleAssignedResourcesRequestBuilder
        """
        warn(" as of 2024-07/PrivatePreview:copilotExportAPI", DeprecationWarning)
        if raw_url is None:
    ...
    @dataclass
    class AppRoleAssignedResourcesRequestBuilderGetRequestConfiguration(RequestConfiguration[AppRoleAssignedResourcesRequestBuilderGetQueryParameters]):
        """
