...
class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder:
        """
    ...
    @dataclass
    class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
