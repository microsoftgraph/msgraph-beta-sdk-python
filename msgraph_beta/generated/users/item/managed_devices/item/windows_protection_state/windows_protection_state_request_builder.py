...
class WindowsProtectionStateRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[WindowsProtectionStateRequestBuilderGetQueryParameters]] = None) -> Optional[WindowsProtectionState]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[WindowsProtectionStateRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        The device protection status. This property is read-only.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def with_url(self,raw_url: str) -> WindowsProtectionStateRequestBuilder:
        """
    ...
    @dataclass
    class WindowsProtectionStateRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class WindowsProtectionStateRequestBuilderGetRequestConfiguration(RequestConfiguration[WindowsProtectionStateRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WindowsProtectionStateRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
