...
class SendVirtualAppointmentSmsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/onlineMeetings(joinWebUrl='{joinWebUrl}')/sendVirtualAppointmentSms", path_parameters)
    
    async def post(self,body: Optional[SendVirtualAppointmentSmsPostRequestBody] = None, request_configuration: Optional[SendVirtualAppointmentSmsRequestBuilderPostRequestConfiguration] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: Optional[SendVirtualAppointmentSmsPostRequestBody] = None, request_configuration: Optional[SendVirtualAppointmentSmsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Send an SMS notification to external attendees when a Teams Virtual Appointment is confirmed, rescheduled, or canceled. This feature requires Teams Premium. Attendees must have a valid United States phone number to receive these SMS notifications.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class SendVirtualAppointmentSmsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
