...
class JoinedGroupsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/joinedGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[JoinedGroupsRequestBuilderGetQueryParameters]] = None) -> Optional[GroupCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[JoinedGroupsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get joinedGroups from users
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> JoinedGroupsRequestBuilder:
        """
    ...
    @dataclass
    class JoinedGroupsRequestBuilderGetRequestConfiguration(RequestConfiguration[JoinedGroupsRequestBuilderGetQueryParameters]):
        """
