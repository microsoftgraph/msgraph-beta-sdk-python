...
if TYPE_CHECKING:
    ...
    from ....models.user_data_security_and_governance import UserDataSecurityAndGovernance
...
class DataSecurityAndGovernanceRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/dataSecurityAndGovernance{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[DataSecurityAndGovernanceRequestBuilderGetQueryParameters]] = None) -> Optional[UserDataSecurityAndGovernance]:
        ...
        return await self.request_adapter.send_async(request_info, UserDataSecurityAndGovernance, error_mapping)
    
    async def patch(self,body: UserDataSecurityAndGovernance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserDataSecurityAndGovernance]:
        """
    ...
    def to_patch_request_information(self,body: UserDataSecurityAndGovernance, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property dataSecurityAndGovernance in users
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
