...
class SupportedTimeZonesWithTimeZoneStandardRequestBuilder(BaseRequestBuilder):
    ...
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], time_zone_standard: Optional[str] = None) -> None:
        """
    ...
    def with_url(self,raw_url: str) -> SupportedTimeZonesWithTimeZoneStandardRequestBuilder:
        """
    ...
    @dataclass
    class SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetRequestConfiguration(RequestConfiguration[SupportedTimeZonesWithTimeZoneStandardRequestBuilderGetQueryParameters]):
        """
