...
class SupportedLanguagesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SupportedLanguagesGetResponse]:
        """
        ...
        Find more info here: https://learn.microsoft.com/graph/api/outlookuser-supportedlanguages?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SupportedLanguagesRequestBuilder:
        """
