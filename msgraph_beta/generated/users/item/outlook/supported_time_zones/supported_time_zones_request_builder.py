...
class SupportedTimeZonesRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> SupportedTimeZonesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SupportedTimeZonesRequestBuilder
        """
        warn(" as of 2024-07/PrivatePreview:copilotExportAPI", DeprecationWarning)
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SupportedTimeZonesRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class SupportedTimeZonesRequestBuilderGetRequestConfiguration(RequestConfiguration[SupportedTimeZonesRequestBuilderGetQueryParameters]):
        """
