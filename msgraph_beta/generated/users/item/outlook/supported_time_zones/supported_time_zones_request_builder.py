...
class SupportedTimeZonesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[SupportedTimeZonesGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SupportedTimeZonesRequestBuilder:
        """
