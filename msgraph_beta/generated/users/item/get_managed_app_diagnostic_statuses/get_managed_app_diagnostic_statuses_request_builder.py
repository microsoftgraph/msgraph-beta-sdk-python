...
class GetManagedAppDiagnosticStatusesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[GetManagedAppDiagnosticStatusesGetResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetManagedAppDiagnosticStatusesRequestBuilder:
        """
