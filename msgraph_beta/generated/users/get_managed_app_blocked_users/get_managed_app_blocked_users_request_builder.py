...
class GetManagedAppBlockedUsersRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetManagedAppBlockedUsersRequestBuilder:
        """
    ...
    @dataclass
    class GetManagedAppBlockedUsersRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
