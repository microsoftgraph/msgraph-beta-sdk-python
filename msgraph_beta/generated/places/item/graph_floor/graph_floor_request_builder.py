...
class GraphFloorRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.floor{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphFloorRequestBuilderGetQueryParameters]] = None) -> Optional[Floor]:
        ...
        return await self.request_adapter.send_async(request_info, Floor, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GraphFloorRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphFloorRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GraphFloorRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphFloorRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphFloorRequestBuilderGetQueryParameters]):
        """
