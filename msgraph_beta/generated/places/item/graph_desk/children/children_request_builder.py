...
if TYPE_CHECKING:
    ...
    from .....models.place_collection_response import PlaceCollectionResponse
...
class ChildrenRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.desk/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_place_id1(self,place_id1: str) -> PlaceItemRequestBuilder:
        """
        Provides operations to manage the children property of the microsoft.graph.place entity.
        param place_id1: The unique identifier of place
        Returns: PlaceItemRequestBuilder
        """
        if place_id1 is None:
            raise TypeError("place_id1 cannot be null.")
        from .item.place_item_request_builder import PlaceItemRequestBuilder

        url_tpl_params = get_path_parameters(self.path_parameters)
        url_tpl_params["place%2Did1"] = place_id1
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ChildrenRequestBuilderGetQueryParameters]] = None) -> Optional[PlaceCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, PlaceCollectionResponse, error_mapping)
