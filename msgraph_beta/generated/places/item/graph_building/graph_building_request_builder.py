...
class GraphBuildingRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/{place%2Did}/graph.building{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphBuildingRequestBuilderGetQueryParameters]] = None) -> Optional[Building]:
        ...
        return await self.request_adapter.send_async(request_info, Building, error_mapping)
