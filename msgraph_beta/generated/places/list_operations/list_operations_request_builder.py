...
if TYPE_CHECKING:
    ...
    from .list_operations_get_response import ListOperationsGetResponse

class ListOperationsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/listOperations(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ListOperationsRequestBuilderGetQueryParameters]] = None) -> Optional[ListOperationsGetResponse]:
        ...
        return await self.request_adapter.send_async(request_info, ListOperationsGetResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> ListOperationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: ListOperationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return ListOperationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class ListOperationsRequestBuilderGetRequestConfiguration(RequestConfiguration[ListOperationsRequestBuilderGetQueryParameters]):
        """
