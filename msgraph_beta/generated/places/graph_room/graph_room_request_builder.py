...
class GraphRoomRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[RoomCollectionResponse]:
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GraphRoomRequestBuilder:
        """
