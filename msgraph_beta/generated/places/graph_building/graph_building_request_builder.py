...
if TYPE_CHECKING:
    from ...models.building_collection_response import BuildingCollectionResponse
    from ...models.o_data_errors.o_data_error import ODataError
    from .count.count_request_builder import CountRequestBuilder

class GraphBuildingRequestBuilder(BaseRequestBuilder):
    """
    Casts the previous resource to building.
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new GraphBuildingRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/graph.building{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphBuildingRequestBuilderGetQueryParameters]] = None) -> Optional[BuildingCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, BuildingCollectionResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GraphBuildingRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GraphBuildingRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GraphBuildingRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class GraphBuildingRequestBuilderGetRequestConfiguration(RequestConfiguration[GraphBuildingRequestBuilderGetQueryParameters]):
        """
