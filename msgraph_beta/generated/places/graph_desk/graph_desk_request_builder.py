...
if TYPE_CHECKING:
    from ...models.desk_collection_response import DeskCollectionResponse
...
class GraphDeskRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/places/graph.desk{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GraphDeskRequestBuilderGetQueryParameters]] = None) -> Optional[DeskCollectionResponse]:
        ...
        return await self.request_adapter.send_async(request_info, DeskCollectionResponse, error_mapping)
