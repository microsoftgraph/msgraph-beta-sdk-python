...
class GetOperationWithIdRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], id: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/places/getOperation(id='{id}')", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PlaceOperation]:
        ...
        return await self.request_adapter.send_async(request_info, PlaceOperation, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetOperationWithIdRequestBuilder:
        """
        ...
        return GetOperationWithIdRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class GetOperationWithIdRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
