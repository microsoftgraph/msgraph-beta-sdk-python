...
class EnabledAppsRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/enabledApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    def by_teams_app_id(self,teams_app_id: str) -> TeamsAppItemRequestBuilder:
        """
        Provides operations to manage the enabledApps property of the microsoft.graph.channel entity.
        param teams_app_id: The unique identifier of teamsApp
    ...
    def with_url(self,raw_url: str) -> EnabledAppsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: EnabledAppsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return EnabledAppsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class EnabledAppsRequestBuilderGetRequestConfiguration(RequestConfiguration[EnabledAppsRequestBuilderGetQueryParameters]):
        """
