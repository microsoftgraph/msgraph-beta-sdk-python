...
class TeamTemplateDefinitionRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_team_template_definition_id(self,team_template_definition_id: str) -> TeamTemplateDefinitionItemRequestBuilder:
        ...
        """
        if not team_template_definition_id:
    ...
    async def get(self,request_configuration: Optional[TeamTemplateDefinitionRequestBuilderGetRequestConfiguration] = None) -> Optional[TeamTemplateDefinitionCollectionResponse]:
        """
    ...
    async def post(self,body: Optional[TeamTemplateDefinition] = None, request_configuration: Optional[TeamTemplateDefinitionRequestBuilderPostRequestConfiguration] = None) -> Optional[TeamTemplateDefinition]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[TeamTemplateDefinitionRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Get entities from teamTemplateDefinition
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[TeamTemplateDefinition] = None, request_configuration: Optional[TeamTemplateDefinitionRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Add new entity to teamTemplateDefinition
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TeamTemplateDefinitionRequestBuilder:
        """
    ...
    @dataclass
    class TeamTemplateDefinitionRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[TeamTemplateDefinitionRequestBuilder.TeamTemplateDefinitionRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class TeamTemplateDefinitionRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
