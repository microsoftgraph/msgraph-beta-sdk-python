...
class GetEmailActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEmailActivityUserDetailWithPeriodRequestBuilder:
        """
        ...
        return GetEmailActivityUserDetailWithPeriodRequestBuilder(self.request_adapter, raw_url)
