...
class GetEmailActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetEmailActivityUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetEmailActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
