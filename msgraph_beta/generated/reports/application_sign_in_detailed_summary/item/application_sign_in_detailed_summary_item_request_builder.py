...
class ApplicationSignInDetailedSummaryItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ApplicationSignInDetailedSummary]:
        """
    ...
    async def patch(self,body: Optional[ApplicationSignInDetailedSummary] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ApplicationSignInDetailedSummary]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ApplicationSignInDetailedSummary] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property applicationSignInDetailedSummary in reports
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
