...
class GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: str) -> GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0(self.request_adapter, raw_url)
