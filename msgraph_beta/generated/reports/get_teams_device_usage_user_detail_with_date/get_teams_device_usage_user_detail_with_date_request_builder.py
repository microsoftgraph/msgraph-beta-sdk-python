...
class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], date: Optional[datetime.date] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getTeamsDeviceUsageUserDetail(date={date})", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetTeamsDeviceUsageUserDetailWithDateRequestBuilder:
        """
        ...
        return GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(self.request_adapter, raw_url)
