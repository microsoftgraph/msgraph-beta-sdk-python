...
class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetTeamsDeviceUsageUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetTeamsDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
