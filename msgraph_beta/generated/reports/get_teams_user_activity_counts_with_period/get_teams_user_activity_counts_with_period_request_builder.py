...
class GetTeamsUserActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetTeamsUserActivityCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetTeamsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
