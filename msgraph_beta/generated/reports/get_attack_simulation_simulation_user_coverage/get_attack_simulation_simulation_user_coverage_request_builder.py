...
class GetAttackSimulationSimulationUserCoverageRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/getAttackSimulationSimulationUserCoverage(){?%24top,%24skip,%24search,%24filter,%24count}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetAttackSimulationSimulationUserCoverageRequestBuilder:
        ...
        Returns: GetAttackSimulationSimulationUserCoverageRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetAttackSimulationSimulationUserCoverageRequestBuilder(self.request_adapter, raw_url)
