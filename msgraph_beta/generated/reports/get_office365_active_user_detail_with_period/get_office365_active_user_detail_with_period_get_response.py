...
@dataclass
class GetOffice365ActiveUserDetailWithPeriodGetResponse(BaseCollectionPaginationCountResponse, Parsable):
    # The value property
    value: Optional[list[Office365ActiveUserDetail]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> GetOffice365ActiveUserDetailWithPeriodGetResponse:
        """
