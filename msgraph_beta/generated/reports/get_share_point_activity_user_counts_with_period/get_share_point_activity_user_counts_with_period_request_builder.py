...
class GetSharePointActivityUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointActivityUserCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
