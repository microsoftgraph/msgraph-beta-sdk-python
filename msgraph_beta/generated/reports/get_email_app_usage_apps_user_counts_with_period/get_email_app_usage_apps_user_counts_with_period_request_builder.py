...
class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder:
        """
        ...
        return GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
