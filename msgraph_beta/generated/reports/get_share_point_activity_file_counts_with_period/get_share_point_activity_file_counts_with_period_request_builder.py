...
class GetSharePointActivityFileCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointActivityFileCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
