...
class GetOffice365GroupsActivityDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetOffice365GroupsActivityDetailWithDateRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getOffice365GroupsActivityDetail
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetOffice365GroupsActivityDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[GetOffice365GroupsActivityDetailWithDateRequestBuilderGetQueryParameters]):
        """
