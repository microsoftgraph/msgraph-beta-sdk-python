...
class GetSharePointActivityPagesWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetSharePointActivityPagesWithPeriodRequestBuilder:
        """
        ...
        return GetSharePointActivityPagesWithPeriodRequestBuilder(self.request_adapter, raw_url)
