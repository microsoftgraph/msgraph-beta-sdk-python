...
class GetSharePointActivityPagesWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointActivityPagesWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointActivityPagesWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
