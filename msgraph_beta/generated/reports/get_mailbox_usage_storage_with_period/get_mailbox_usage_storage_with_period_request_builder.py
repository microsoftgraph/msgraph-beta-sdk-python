...
class GetMailboxUsageStorageWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetMailboxUsageStorageWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetMailboxUsageStorageWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
