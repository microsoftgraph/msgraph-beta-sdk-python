...
if TYPE_CHECKING:
    from ...models.health_monitoring.health_monitoring_root import HealthMonitoringRoot
...
class HealthMonitoringRequestBuilder(BaseRequestBuilder):
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[HealthMonitoringRequestBuilderGetQueryParameters]] = None) -> Optional[HealthMonitoringRoot]:
        ...
        return await self.request_adapter.send_async(request_info, HealthMonitoringRoot, error_mapping)
    
    async def patch(self,body: HealthMonitoringRoot, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[HealthMonitoringRoot]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[HealthMonitoringRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        Returns: RequestInformation
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/reports/healthMonitoring{?%24expand,%24select}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        return request_info
    
    def to_patch_request_information(self,body: HealthMonitoringRoot, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update the navigation property healthMonitoring in reports
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> HealthMonitoringRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: HealthMonitoringRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return HealthMonitoringRequestBuilder(self.request_adapter, raw_url)
    ...
    def alert_configurations(self) -> AlertConfigurationsRequestBuilder:
        ...
        return AlertConfigurationsRequestBuilder(self.request_adapter, self.path_parameters)
    ...
    @dataclass
    class HealthMonitoringRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
    ...
    @dataclass
    class HealthMonitoringRequestBuilderGetRequestConfiguration(RequestConfiguration[HealthMonitoringRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class HealthMonitoringRequestBuilderPatchRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
