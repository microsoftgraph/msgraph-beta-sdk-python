...
class GetBrowserUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetBrowserUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetBrowserUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
