...
class InactiveUsersByApplicationRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/userInsights/daily/inactiveUsersByApplication{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", path_parameters)
    ...
    def by_daily_inactive_users_by_application_metric_id(self,daily_inactive_users_by_application_metric_id: str) -> DailyInactiveUsersByApplicationMetricItemRequestBuilder:
        ...
        """
        if not daily_inactive_users_by_application_metric_id:
    ...
    async def get(self,request_configuration: Optional[InactiveUsersByApplicationRequestBuilderGetRequestConfiguration] = None) -> Optional[DailyInactiveUsersByApplicationMetricCollectionResponse]:
        """
