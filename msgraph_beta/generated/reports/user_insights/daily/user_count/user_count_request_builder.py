...
class UserCountRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/userInsights/daily/userCount{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_user_count_metric_id(self,user_count_metric_id: str) -> UserCountMetricItemRequestBuilder:
        ...
        """
        if user_count_metric_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[UserCountRequestBuilderGetQueryParameters]] = None) -> Optional[UserCountMetricCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[UserCountRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get a list of daily user count on apps registered in your tenant configured for Microsoft Entra External ID for customers.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> UserCountRequestBuilder:
        """
    ...
    @dataclass
    class UserCountRequestBuilderGetRequestConfiguration(RequestConfiguration[UserCountRequestBuilderGetQueryParameters]):
        """
