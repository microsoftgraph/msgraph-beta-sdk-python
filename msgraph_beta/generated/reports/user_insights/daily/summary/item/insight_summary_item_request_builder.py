...
class InsightSummaryItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/userInsights/daily/summary/{insightSummary%2Did}{?%24select,%24expand}", path_parameters)
    ...
    @dataclass
    class InsightSummaryItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[InsightSummaryItemRequestBuilder.InsightSummaryItemRequestBuilderGetQueryParameters] = None
