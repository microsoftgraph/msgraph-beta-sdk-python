...
class InactiveUsersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/userInsights/monthly/inactiveUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    ...
    def by_monthly_inactive_users_metric_id(self,monthly_inactive_users_metric_id: str) -> MonthlyInactiveUsersMetricItemRequestBuilder:
        ...
        """
        if monthly_inactive_users_metric_id is None:
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[InactiveUsersRequestBuilderGetQueryParameters]] = None) -> Optional[MonthlyInactiveUsersMetricCollectionResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[InactiveUsersRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get inactiveUsers from reports
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> InactiveUsersRequestBuilder:
        """
    ...
    @dataclass
    class InactiveUsersRequestBuilderGetRequestConfiguration(RequestConfiguration[InactiveUsersRequestBuilderGetQueryParameters]):
        """
