...
class InactiveUsersByApplicationRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[InactiveUsersByApplicationRequestBuilderGetQueryParameters]] = None) -> Optional[MonthlyInactiveUsersByApplicationMetricCollectionResponse]:
        """
