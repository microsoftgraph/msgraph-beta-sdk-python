...
class GetTeamsTeamActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetTeamsTeamActivityCountsWithPeriodRequestBuilder:
        """
