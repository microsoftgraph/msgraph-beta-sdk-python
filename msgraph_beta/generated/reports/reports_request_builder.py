...
if TYPE_CHECKING:
    ...
    from .get_api_usageservice_area_service_area_period_period_app_id_app_id.get_api_usageservice_area_service_area_period_period_app_id_app_id_0ddf95d0 import GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0
    ...
    from .get_teams_device_usage_distribution_total_user_counts_with_period.get_teams_device_usage_distribution_total_user_counts_with_perio_64dc85bf import GetTeamsDeviceUsageDistributionTotalUserCountsWithPerio_64dc85bf
    ...
    from .get_teams_user_activity_distribution_total_user_counts_with_period.get_teams_user_activity_distribution_total_user_counts_with_peri_19f19a77 import GetTeamsUserActivityDistributionTotalUserCountsWithPeri_19f19a77
    from .get_teams_user_activity_distribution_user_counts_with_period.get_teams_user_activity_distribution_user_counts_with_period_req_ac9a26dd import GetTeamsUserActivityDistributionUserCountsWithPeriodReq_ac9a26dd
    ...
    from .get_teams_user_activity_total_distribution_counts_with_period.get_teams_user_activity_total_distribution_counts_with_period_re_5022666f import GetTeamsUserActivityTotalDistributionCountsWithPeriodRe_5022666f
    ...
    from .managed_device_enrollment_abandonment_details_with_skip_with_to_3cc2b7d1.managed_device_enrollment_abandonment_details_with_skip_with_to_f10df1d0 import ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTo_f10df1d0
    from .managed_device_enrollment_abandonment_summary_with_skip_with_to_60b80d5d.managed_device_enrollment_abandonment_summary_with_skip_with_to_47ff20b7 import ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTo_47ff20b7
...
class ReportsRequestBuilder(BaseRequestBuilder):
    ...
    def get_teams_device_usage_distribution_total_user_counts_with_period(self,period: str) -> GetTeamsDeviceUsageDistributionTotalUserCountsWithPerio_64dc85bf:
        """
        ...
        return GetTeamsDeviceUsageDistributionTotalUserCountsWithPerio_64dc85bf(self.request_adapter, self.path_parameters, period)
    ...
    def get_teams_user_activity_distribution_total_user_counts_with_period(self,period: str) -> GetTeamsUserActivityDistributionTotalUserCountsWithPeri_19f19a77:
        """
        Provides operations to call the getTeamsUserActivityDistributionTotalUserCounts method.
        param period: Usage: period='{period}'
        Returns: GetTeamsUserActivityDistributionTotalUserCountsWithPeri_19f19a77
        """
        if period is None:
            raise TypeError("period cannot be null.")
        from .get_teams_user_activity_distribution_total_user_counts_with_period.get_teams_user_activity_distribution_total_user_counts_with_peri_19f19a77 import GetTeamsUserActivityDistributionTotalUserCountsWithPeri_19f19a77

        return GetTeamsUserActivityDistributionTotalUserCountsWithPeri_19f19a77(self.request_adapter, self.path_parameters, period)
    
    def get_teams_user_activity_distribution_user_counts_with_period(self,period: str) -> GetTeamsUserActivityDistributionUserCountsWithPeriodReq_ac9a26dd:
        """
        ...
        return GetTeamsUserActivityDistributionUserCountsWithPeriodReq_ac9a26dd(self.request_adapter, self.path_parameters, period)
    ...
    def get_teams_user_activity_total_distribution_counts_with_period(self,period: str) -> GetTeamsUserActivityTotalDistributionCountsWithPeriodRe_5022666f:
        """
        Provides operations to call the getTeamsUserActivityTotalDistributionCounts method.
        param period: Usage: period='{period}'
        Returns: GetTeamsUserActivityTotalDistributionCountsWithPeriodRe_5022666f
        """
        if period is None:
            raise TypeError("period cannot be null.")
        from .get_teams_user_activity_total_distribution_counts_with_period.get_teams_user_activity_total_distribution_counts_with_period_re_5022666f import GetTeamsUserActivityTotalDistributionCountsWithPeriodRe_5022666f

        return GetTeamsUserActivityTotalDistributionCountsWithPeriodRe_5022666f(self.request_adapter, self.path_parameters, period)
    ...
    def managed_device_enrollment_abandonment_details_with_skip_with_top_with_filter_with_skip_token(self,filter: str, skip: int, skip_token: str, top: int) -> ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTo_f10df1d0:
        """
        ...
        return ManagedDeviceEnrollmentAbandonmentDetailsWithSkipWithTo_f10df1d0(self.request_adapter, self.path_parameters, filter, skip, skip_token, top)
    
    def managed_device_enrollment_abandonment_summary_with_skip_with_top_with_filter_with_skip_token(self,filter: str, skip: int, skip_token: str, top: int) -> ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTo_47ff20b7:
        """
        ...
        return ManagedDeviceEnrollmentAbandonmentSummaryWithSkipWithTo_47ff20b7(self.request_adapter, self.path_parameters, filter, skip, skip_token, top)
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[ReportsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.GET, '{+baseurl}/reports{?%24expand,%24select}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: ReportRoot, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        ...
        if body is None:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/reports', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
    ...
    @property
    def get_api_usageservice_area_service_area_period_period_app_id_app_id(self) -> GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0:
        """
        Provides operations to call the getApiUsage method.
        """
        from .get_api_usageservice_area_service_area_period_period_app_id_app_id.get_api_usageservice_area_service_area_period_period_app_id_app_id_0ddf95d0 import GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0

        return GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId_0ddf95d0(self.request_adapter, self.path_parameters)
