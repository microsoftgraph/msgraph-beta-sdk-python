...
class GetTeamsUserActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetTeamsUserActivityUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetTeamsUserActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
