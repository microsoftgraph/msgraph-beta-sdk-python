...
class GetOffice365ActiveUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], date: Optional[datetime.date] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(date={date}){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters]] = None) -> Optional[GetOffice365ActiveUserDetailWithDateGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getOffice365ActiveUserDetail
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetOffice365ActiveUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters]):
        """
