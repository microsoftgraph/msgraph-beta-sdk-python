...
class GetOffice365ActiveUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetOffice365ActiveUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[GetOffice365ActiveUserDetailWithDateRequestBuilder.GetOffice365ActiveUserDetailWithDateRequestBuilderGetQueryParameters] = None
