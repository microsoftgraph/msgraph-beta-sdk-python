...
class GetAttackSimulationRepeatOffendersRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/getAttackSimulationRepeatOffenders(){?%24count,%24filter,%24search,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAttackSimulationRepeatOffendersRequestBuilderGetQueryParameters]] = None) -> Optional[GetAttackSimulationRepeatOffendersGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetAttackSimulationRepeatOffendersRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        List the users of a tenant who have yielded to attacks more than once in attack simulation and training campaigns. This function supports @odata.nextLink for pagination.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetAttackSimulationRepeatOffendersRequestBuilder:
        """
    ...
    @dataclass
    class GetAttackSimulationRepeatOffendersRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAttackSimulationRepeatOffendersRequestBuilderGetQueryParameters]):
        """
