...
class GetOneDriveActivityUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOneDriveActivityUserCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetOneDriveActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
