...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_private_app_users_blocked_by_conne_2d4e1079 import GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_2d4e1079

class GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_ba1d4d98(BaseRequestBuilder):
    """
    Provides operations to call the getMetricsForNetworkAccessPrivateAppUsersBlockedByConnector method. Original name: GetMetricsForNetworkAccessPrivateAppUsersBlockedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_ba1d4d98 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessPrivateAppUsersBlockedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_2d4e1079]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_2d4e1079]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_2d4e1079, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_ba1d4d98:
        """
        ...
        return GetMetricsForNetworkAccessPrivateAppUsersBlockedByConne_ba1d4d98(self.request_adapter, raw_url)
    
    @dataclass
    class GetMetricsForNetworkAccessPrivateAppUsersBlockedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters():
        """
        Retrieve the number of users' private application access attempts that were blocked due to connector unavailability using Global Secure Access client. Microsoft Entra Private Access traffic could not reach the private application because the connector was either down or unreachable due to network connectivity issues.
        """
