...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_remote_network_branches_b_g_p_disco_b1706942 import GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942

class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a(BaseRequestBuilder):
    """
    Provides operations to call the getMetricsForNetworkAccessRemoteNetworkBranchesBGPDisconnected method. Original name: GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisconnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisconnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_b1706942, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a:
        """
        ...
        return GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisco_a53b337a(self.request_adapter, raw_url)
    
    @dataclass
    class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPDisconnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters():
        """
        Retrieve the number of remote networks which are disconnected due to BGP being down. A remote network represents a location such as a branch office where customer premises equipment (CPE) is connected to the nearest deployment of Global Secure Access service through IPsec tunnels.
        """
