...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_visio_web_with_inclusive_interval_sta_3f8dd486 import GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_3f8dd486

class GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_8d24e942(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_8d24e942 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForVisioWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_3f8dd486]:
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_3f8dd486, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_8d24e942:
        """
        ...
        return GetActiveUserMetricsForVisioWebWithInclusiveIntervalSta_8d24e942(self.request_adapter, raw_url)
