...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_conditional_access_blocked_sign_in_with_inclusiv_e9894b18 import GetMetricsForConditionalAccessBlockedSignInWithInclusiv_e9894b18

class GetMetricsForConditionalAccessBlockedSignInWithInclusiv_d21ec3fa(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForConditionalAccessBlockedSignInWithInclusiv_d21ec3fa and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForConditionalAccessBlockedSignInWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForConditionalAccessBlockedSignInWithInclusiv_e9894b18]:
        ...
        Returns: Optional[GetMetricsForConditionalAccessBlockedSignInWithInclusiv_e9894b18]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForConditionalAccessBlockedSignInWithInclusiv_e9894b18, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForConditionalAccessBlockedSignInWithInclusiv_d21ec3fa:
        """
        ...
        return GetMetricsForConditionalAccessBlockedSignInWithInclusiv_d21ec3fa(self.request_adapter, raw_url)
