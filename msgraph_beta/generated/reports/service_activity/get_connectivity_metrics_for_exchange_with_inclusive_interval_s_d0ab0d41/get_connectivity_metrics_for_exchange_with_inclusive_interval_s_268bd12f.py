...
if TYPE_CHECKING:
    ...
    from .get_connectivity_metrics_for_exchange_with_inclusive_interval_s_a6927f62 import GetConnectivityMetricsForExchangeWithInclusiveIntervalS_a6927f62

class GetConnectivityMetricsForExchangeWithInclusiveIntervalS_268bd12f(BaseRequestBuilder):
    """
    Provides operations to call the getConnectivityMetricsForExchange method. Original name: GetConnectivityMetricsForExchangeWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetConnectivityMetricsForExchangeWithInclusiveIntervalS_268bd12f and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetConnectivityMetricsForExchangeWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetConnectivityMetricsForExchangeWithInclusiveIntervalS_a6927f62]:
        ...
        Returns: Optional[GetConnectivityMetricsForExchangeWithInclusiveIntervalS_a6927f62]
        ...
        return await self.request_adapter.send_async(request_info, GetConnectivityMetricsForExchangeWithInclusiveIntervalS_a6927f62, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetConnectivityMetricsForExchangeWithInclusiveIntervalS_268bd12f:
        """
        ...
        return GetConnectivityMetricsForExchangeWithInclusiveIntervalS_268bd12f(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetConnectivityMetricsForExchangeWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetConnectivityMetricsForExchangeWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]):
        """
