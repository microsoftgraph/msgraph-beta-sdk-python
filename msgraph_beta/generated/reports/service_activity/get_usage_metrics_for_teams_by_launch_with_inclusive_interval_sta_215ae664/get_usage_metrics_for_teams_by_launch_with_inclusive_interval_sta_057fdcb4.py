...
if TYPE_CHECKING:
    ...
    from .get_usage_metrics_for_teams_by_launch_with_inclusive_interval_sta_86934c7d import GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_86934c7d

class GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_057fdcb4(BaseRequestBuilder):
    """
    Provides operations to call the getUsageMetricsForTeamsByLaunch method. Original name: GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_057fdcb4 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_86934c7d]:
        ...
        return await self.request_adapter.send_async(request_info, GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_86934c7d, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_057fdcb4:
        """
        ...
        return GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalSta_057fdcb4(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetUsageMetricsForTeamsByLaunchWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]):
        """
