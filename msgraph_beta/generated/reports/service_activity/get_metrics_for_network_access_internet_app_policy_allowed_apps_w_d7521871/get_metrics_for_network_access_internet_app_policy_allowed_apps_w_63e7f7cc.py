...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_internet_app_policy_allowed_apps_w_80e33009 import GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009

class GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_80e33009, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc:
        """
        ...
        return GetMetricsForNetworkAccessInternetAppPolicyAllowedAppsW_63e7f7cc(self.request_adapter, raw_url)
