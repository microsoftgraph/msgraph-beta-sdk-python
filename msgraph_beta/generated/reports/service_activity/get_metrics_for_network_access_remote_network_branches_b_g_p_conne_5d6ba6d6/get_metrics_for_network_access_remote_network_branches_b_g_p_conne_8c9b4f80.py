...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_remote_network_branches_b_g_p_conne_23a58248 import GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_23a58248

class GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_8c9b4f80(BaseRequestBuilder):
    """
    Provides operations to call the getMetricsForNetworkAccessRemoteNetworkBranchesBGPConnected method. Original name: GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_8c9b4f80 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_23a58248]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_23a58248]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_23a58248, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_8c9b4f80:
        """
        ...
        return GetMetricsForNetworkAccessRemoteNetworkBranchesBGPConne_8c9b4f80(self.request_adapter, raw_url)
