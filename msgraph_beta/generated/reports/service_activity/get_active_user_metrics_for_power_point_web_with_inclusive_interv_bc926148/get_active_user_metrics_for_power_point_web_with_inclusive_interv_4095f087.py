...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_power_point_web_with_inclusive_interv_9932d2b3 import GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_9932d2b3

class GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_4095f087(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_4095f087 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForPowerPointWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_9932d2b3]:
        ...
        Returns: Optional[GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_9932d2b3]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_9932d2b3, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_4095f087:
        """
        ...
        return GetActiveUserMetricsForPowerPointWebWithInclusiveInterv_4095f087(self.request_adapter, raw_url)
