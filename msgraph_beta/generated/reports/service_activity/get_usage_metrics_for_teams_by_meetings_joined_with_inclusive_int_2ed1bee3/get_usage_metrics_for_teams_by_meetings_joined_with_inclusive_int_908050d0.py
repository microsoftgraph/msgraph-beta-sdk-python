...
if TYPE_CHECKING:
    ...
    from .get_usage_metrics_for_teams_by_meetings_joined_with_inclusive_int_c815fd29 import GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_c815fd29

class GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_908050d0(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_908050d0 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_c815fd29]:
        ...
        return await self.request_adapter.send_async(request_info, GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_c815fd29, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_908050d0:
        """
        ...
        return GetUsageMetricsForTeamsByMeetingsJoinedWithInclusiveInt_908050d0(self.request_adapter, raw_url)
