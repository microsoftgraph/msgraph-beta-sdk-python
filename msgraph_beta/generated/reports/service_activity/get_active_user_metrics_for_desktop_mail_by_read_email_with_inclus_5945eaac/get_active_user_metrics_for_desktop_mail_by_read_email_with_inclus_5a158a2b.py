...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_desktop_mail_by_read_email_with_inclus_854c2ff9 import GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_854c2ff9

class GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_5a158a2b(BaseRequestBuilder):
    """
    Provides operations to call the getActiveUserMetricsForDesktopMailByReadEmail method. Original name: GetActiveUserMetricsForDesktopMailByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_5a158a2b and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForDesktopMailByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_854c2ff9]:
        ...
        Returns: Optional[GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_854c2ff9]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_854c2ff9, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_5a158a2b:
        """
        ...
        return GetActiveUserMetricsForDesktopMailByReadEmailWithInclus_5a158a2b(self.request_adapter, raw_url)
