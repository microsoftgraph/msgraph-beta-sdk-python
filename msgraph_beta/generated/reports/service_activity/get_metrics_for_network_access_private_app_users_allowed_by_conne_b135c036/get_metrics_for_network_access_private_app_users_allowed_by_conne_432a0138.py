...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_private_app_users_allowed_by_conne_0db9b5d6 import GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6

class GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessPrivateAppUsersAllowedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_0db9b5d6, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138:
        """
        ...
        return GetMetricsForNetworkAccessPrivateAppUsersAllowedByConne_432a0138(self.request_adapter, raw_url)
