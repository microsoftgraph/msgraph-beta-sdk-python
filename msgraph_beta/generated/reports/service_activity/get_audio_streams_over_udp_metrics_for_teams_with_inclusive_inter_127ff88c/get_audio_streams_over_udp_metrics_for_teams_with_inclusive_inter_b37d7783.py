...
if TYPE_CHECKING:
    ...
    from .get_audio_streams_over_udp_metrics_for_teams_with_inclusive_inter_f4808fe1 import GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_f4808fe1

class GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_b37d7783(BaseRequestBuilder):
    """
    Provides operations to call the getAudioStreamsOverUdpMetricsForTeams method. Original name: GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_b37d7783 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_f4808fe1]:
        ...
        Returns: Optional[GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_f4808fe1]
        ...
        return await self.request_adapter.send_async(request_info, GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_f4808fe1, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_b37d7783:
        """
        ...
        return GetAudioStreamsOverUdpMetricsForTeamsWithInclusiveInter_b37d7783(self.request_adapter, raw_url)
