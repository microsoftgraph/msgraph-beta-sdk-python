...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_word_web_with_inclusive_interval_star_dc195952 import GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_dc195952

class GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_0b97a62b(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_0b97a62b and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForWordWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_dc195952]:
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_dc195952, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_0b97a62b:
        """
        ...
        return GetActiveUserMetricsForWordWebWithInclusiveIntervalStar_0b97a62b(self.request_adapter, raw_url)
