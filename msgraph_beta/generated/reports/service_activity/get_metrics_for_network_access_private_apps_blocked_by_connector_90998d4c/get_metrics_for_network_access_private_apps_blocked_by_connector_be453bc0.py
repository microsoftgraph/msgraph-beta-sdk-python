...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_private_apps_blocked_by_connector_d710a48f import GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f

class GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessPrivateAppsBlockedByConnectorWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_d710a48f, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0:
        """
        ...
        return GetMetricsForNetworkAccessPrivateAppsBlockedByConnector_be453bc0(self.request_adapter, raw_url)
