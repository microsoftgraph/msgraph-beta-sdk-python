...
if TYPE_CHECKING:
    ...
    from .get_audio_stream_qo_e_metrics_for_teams_with_inclusive_interval_st_eb5dc363 import GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_eb5dc363

class GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_f3e1e602(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_f3e1e602 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_eb5dc363]:
        ...
        Returns: Optional[GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_eb5dc363]
        ...
        return await self.request_adapter.send_async(request_info, GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_eb5dc363, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_f3e1e602:
        """
        ...
        return GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalSt_f3e1e602(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAudioStreamQoEMetricsForTeamsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]):
        """
