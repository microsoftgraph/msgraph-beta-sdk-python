...
if TYPE_CHECKING:
    ...
    from .get_message_volume_metrics_for_teams_chat_with_inclusive_interva_c2edcf19 import GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_c2edcf19

class GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_3372dced(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_3372dced and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMessageVolumeMetricsForTeamsChatWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_c2edcf19]:
        ...
        return await self.request_adapter.send_async(request_info, GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_c2edcf19, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_3372dced:
        """
        ...
        return GetMessageVolumeMetricsForTeamsChatWithInclusiveInterva_3372dced(self.request_adapter, raw_url)
