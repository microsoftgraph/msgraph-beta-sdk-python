...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_conditional_access_compliant_devices_sign_in_suc_6ffaabb9 import GetMetricsForConditionalAccessCompliantDevicesSignInSuc_6ffaabb9

class GetMetricsForConditionalAccessCompliantDevicesSignInSuc_2b8eee05(BaseRequestBuilder):
    """
    Provides operations to call the getMetricsForConditionalAccessCompliantDevicesSignInSuccess method. Original name: GetMetricsForConditionalAccessCompliantDevicesSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForConditionalAccessCompliantDevicesSignInSuc_2b8eee05 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForConditionalAccessCompliantDevicesSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForConditionalAccessCompliantDevicesSignInSuc_6ffaabb9]:
        ...
        Returns: Optional[GetMetricsForConditionalAccessCompliantDevicesSignInSuc_6ffaabb9]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForConditionalAccessCompliantDevicesSignInSuc_6ffaabb9, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForConditionalAccessCompliantDevicesSignInSuc_2b8eee05:
        """
        ...
        return GetMetricsForConditionalAccessCompliantDevicesSignInSuc_2b8eee05(self.request_adapter, raw_url)
