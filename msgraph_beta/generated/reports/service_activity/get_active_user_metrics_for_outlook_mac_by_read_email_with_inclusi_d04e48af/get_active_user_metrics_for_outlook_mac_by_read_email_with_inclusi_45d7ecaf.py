...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_outlook_mac_by_read_email_with_inclusi_8339501f import GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_8339501f

class GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_45d7ecaf(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_45d7ecaf and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_8339501f]:
        ...
        Returns: Optional[GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_8339501f]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_8339501f, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get all the active usage based on the number of users who successfully read emails using Outlook for Mac.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_45d7ecaf:
        """
        ...
        return GetActiveUserMetricsForOutlookMacByReadEmailWithInclusi_45d7ecaf(self.request_adapter, raw_url)
    
    @dataclass
    class GetActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters():
        """
        Get all the active usage based on the number of users who successfully read emails using Outlook for Mac.
        """
    ...
    @dataclass
    class GetActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetActiveUserMetricsForOutlookMacByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]):
        """
