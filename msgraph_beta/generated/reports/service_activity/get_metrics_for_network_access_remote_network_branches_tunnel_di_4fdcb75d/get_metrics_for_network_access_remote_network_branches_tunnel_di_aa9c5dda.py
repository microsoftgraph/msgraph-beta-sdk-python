...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_remote_network_branches_tunnel_di_01b3ffd4 import GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_01b3ffd4

class GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_aa9c5dda(BaseRequestBuilder):
    """
    Provides operations to call the getMetricsForNetworkAccessRemoteNetworkBranchesTunnelDisconnected method. Original name: GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDisconnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_aa9c5dda and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDisconnectedWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_01b3ffd4]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_01b3ffd4]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_01b3ffd4, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_aa9c5dda:
        """
        ...
        return GetMetricsForNetworkAccessRemoteNetworkBranchesTunnelDi_aa9c5dda(self.request_adapter, raw_url)
