...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_outlook_mobile_by_read_email_with_incl_751f20bd import GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_751f20bd

class GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_84dc1e81(BaseRequestBuilder):
    """
    Provides operations to call the getActiveUserMetricsForOutlookMobileByReadEmail method. Original name: GetActiveUserMetricsForOutlookMobileByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_84dc1e81 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOutlookMobileByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_751f20bd]:
        ...
        Returns: Optional[GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_751f20bd]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_751f20bd, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_84dc1e81:
        """
        ...
        return GetActiveUserMetricsForOutlookMobileByReadEmailWithIncl_84dc1e81(self.request_adapter, raw_url)
