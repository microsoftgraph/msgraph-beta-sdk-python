...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_outlook_web_by_app_opening_with_inclus_e12d5bd9 import GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9

class GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOutlookWebByAppOpeningWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9]:
        ...
        Returns: Optional[GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_e12d5bd9, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39:
        """
        ...
        return GetActiveUserMetricsForOutlookWebByAppOpeningWithInclus_3ca5bf39(self.request_adapter, raw_url)
