...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_one_note_web_with_inclusive_interval_s_8644052e import GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_8644052e

class GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_07fd4aec(BaseRequestBuilder):
    """
    Provides operations to call the getActiveUserMetricsForOneNoteWeb method. Original name: GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_07fd4aec and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_8644052e]:
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_8644052e, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Get all the active usage based on the number of active users who open or save OneNote for the web.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_07fd4aec:
        """
        ...
        return GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalS_07fd4aec(self.request_adapter, raw_url)
    ...
    @dataclass
    class GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetRequestConfiguration(RequestConfiguration[GetActiveUserMetricsForOneNoteWebWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]):
        """
