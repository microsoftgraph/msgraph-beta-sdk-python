...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_network_access_internet_app_policy_blocked_apps_w_ea24e610 import GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_ea24e610

class GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_8fa4c5ed(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_8fa4c5ed and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_ea24e610]:
        ...
        Returns: Optional[GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_ea24e610]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_ea24e610, error_mapping)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve the number of internet applications that were blocked due to web content filtering policies applied to specific FQDNs using Global Secure Access client. Microsoft Entra Internet Access traffic may be restricted when these policies are enforced.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_8fa4c5ed:
        """
        ...
        return GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsW_8fa4c5ed(self.request_adapter, raw_url)
    
    @dataclass
    class GetMetricsForNetworkAccessInternetAppPolicyBlockedAppsWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters():
        """
        Retrieve the number of internet applications that were blocked due to web content filtering policies applied to specific FQDNs using Global Secure Access client. Microsoft Entra Internet Access traffic may be restricted when these policies are enforced.
        """
