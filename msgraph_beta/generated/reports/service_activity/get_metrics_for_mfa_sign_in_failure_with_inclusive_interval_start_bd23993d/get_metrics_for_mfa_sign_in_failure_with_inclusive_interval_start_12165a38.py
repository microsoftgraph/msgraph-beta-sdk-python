...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_mfa_sign_in_failure_with_inclusive_interval_start_8bd00152 import GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152

class GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForMfaSignInFailureWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152]:
        ...
        Returns: Optional[GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_8bd00152, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38:
        """
        ...
        return GetMetricsForMfaSignInFailureWithInclusiveIntervalStart_12165a38(self.request_adapter, raw_url)
