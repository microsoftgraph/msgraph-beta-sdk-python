...
if TYPE_CHECKING:
    ...
    from .get_metrics_for_conditional_access_managed_devices_sign_in_succe_2d1b7e95 import GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95

class GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetMetricsForConditionalAccessManagedDevicesSignInSuccessWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95]:
        ...
        Returns: Optional[GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95]
        ...
        return await self.request_adapter.send_async(request_info, GetMetricsForConditionalAccessManagedDevicesSignInSucce_2d1b7e95, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856:
        """
        ...
        return GetMetricsForConditionalAccessManagedDevicesSignInSucce_c8f9e856(self.request_adapter, raw_url)
