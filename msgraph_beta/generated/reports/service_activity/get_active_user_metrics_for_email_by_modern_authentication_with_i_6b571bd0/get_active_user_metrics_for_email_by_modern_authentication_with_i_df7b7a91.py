...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_for_email_by_modern_authentication_with_i_956742cf import GetActiveUserMetricsForEmailByModernAuthenticationWithI_956742cf

class GetActiveUserMetricsForEmailByModernAuthenticationWithI_df7b7a91(BaseRequestBuilder):
    """
    Provides operations to call the getActiveUserMetricsForEmailByModernAuthentication method. Original name: GetActiveUserMetricsForEmailByModernAuthenticationWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilder
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForEmailByModernAuthenticationWithI_df7b7a91 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForEmailByModernAuthenticationWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForEmailByModernAuthenticationWithI_956742cf]:
        ...
        Returns: Optional[GetActiveUserMetricsForEmailByModernAuthenticationWithI_956742cf]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForEmailByModernAuthenticationWithI_956742cf, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForEmailByModernAuthenticationWithI_df7b7a91:
        """
        ...
        return GetActiveUserMetricsForEmailByModernAuthenticationWithI_df7b7a91(self.request_adapter, raw_url)
