...
if TYPE_CHECKING:
    ...
    from .get_active_user_metrics_fori_o_s_or_android_mail_by_read_email_with_i_f27e9cba import GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_f27e9cba

class GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_0211beb0(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]], exclusive_interval_end_date_time: Optional[datetime.datetime] = None, inclusive_interval_start_date_time: Optional[datetime.datetime] = None) -> None:
        """
        Instantiates a new GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_0211beb0 and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRequestBuilderGetQueryParameters]] = None) -> Optional[GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_f27e9cba]:
        ...
        Returns: Optional[GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_f27e9cba]
        ...
        return await self.request_adapter.send_async(request_info, GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_f27e9cba, error_mapping)
    ...
    def with_url(self,raw_url: str) -> GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_0211beb0:
        """
        ...
        return GetActiveUserMetricsForiOSOrAndroidMailByReadEmailWithI_0211beb0(self.request_adapter, raw_url)
