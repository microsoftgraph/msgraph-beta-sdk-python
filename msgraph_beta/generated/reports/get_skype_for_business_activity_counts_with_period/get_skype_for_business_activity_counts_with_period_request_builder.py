...
class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder:
        """
