...
class UnbilledRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/partners/billing/usage/unbilled{?%24expand,%24select}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnbilledUsage]:
        """
    ...
    async def patch(self,body: Optional[UnbilledUsage] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[UnbilledUsage]:
        """
    ...
    def to_patch_request_information(self,body: Optional[UnbilledUsage] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property unbilled in reports
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
