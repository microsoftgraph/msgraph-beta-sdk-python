...
class MicrosoftGraphPartnersBillingExportRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/reports/partners/billing/usage/unbilled/microsoft.graph.partners.billing.export", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> MicrosoftGraphPartnersBillingExportRequestBuilder:
        """
