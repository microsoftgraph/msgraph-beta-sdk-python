...
class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder:
        """
        ...
        return GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
