...
class GetYammerActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getYammerActivityUserDetail(period='{period}')", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetYammerActivityUserDetailWithPeriodRequestBuilder:
        """
        ...
        return GetYammerActivityUserDetailWithPeriodRequestBuilder(self.request_adapter, raw_url)
