...
class GetM365AppUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetM365AppUserCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetM365AppUserCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
