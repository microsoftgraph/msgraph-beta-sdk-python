...
class GetFormsUserActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetFormsUserActivityUserDetailWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetFormsUserActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
