...
class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getAzureADApplicationSignInSummary(period='{period}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetQueryParameters]] = None) -> Optional[GetAzureADApplicationSignInSummaryWithPeriodGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieve applicationSigninSummary objects within either the last seven or 30 days.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetAzureADApplicationSignInSummaryWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[GetAzureADApplicationSignInSummaryWithPeriodRequestBuilderGetQueryParameters]):
        """
