...
class GetOneDriveUsageAccountDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetOneDriveUsageAccountDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetOneDriveUsageAccountDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
