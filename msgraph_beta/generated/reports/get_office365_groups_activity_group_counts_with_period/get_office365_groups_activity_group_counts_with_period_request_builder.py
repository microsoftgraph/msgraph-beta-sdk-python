...
class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getOffice365GroupsActivityGroupCounts(period='{period}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilderGetQueryParameters]] = None) -> Optional[GetOffice365GroupsActivityGroupCountsWithPeriodGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getOffice365GroupsActivityGroupCounts
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilderGetQueryParameters]):
        """
