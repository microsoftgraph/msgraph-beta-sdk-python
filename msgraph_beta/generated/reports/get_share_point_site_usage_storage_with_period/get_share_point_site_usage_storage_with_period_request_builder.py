...
class GetSharePointSiteUsageStorageWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSharePointSiteUsageStorageWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetSharePointSiteUsageStorageWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
