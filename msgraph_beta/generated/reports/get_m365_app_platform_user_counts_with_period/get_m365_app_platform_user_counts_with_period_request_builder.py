...
class GetM365AppPlatformUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[GetM365AppPlatformUserCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> bytes:
        ...
        Returns: bytes
        Find more info here: https://learn.microsoft.com/graph/api/reportroot-getm365appplatformusercounts?view=graph-rest-beta
        """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetM365AppPlatformUserCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetM365AppPlatformUserCountsWithPeriodRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
