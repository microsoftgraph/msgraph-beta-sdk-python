...
class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder:
        """
