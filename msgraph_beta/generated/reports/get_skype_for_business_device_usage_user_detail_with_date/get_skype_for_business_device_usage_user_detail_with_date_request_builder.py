...
class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
