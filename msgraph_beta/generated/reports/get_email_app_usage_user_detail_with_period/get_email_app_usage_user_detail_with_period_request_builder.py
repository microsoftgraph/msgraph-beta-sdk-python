...
class GetEmailAppUsageUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEmailAppUsageUserDetailWithPeriodRequestBuilder:
        """
        ...
        return GetEmailAppUsageUserDetailWithPeriodRequestBuilder(self.request_adapter, raw_url)
