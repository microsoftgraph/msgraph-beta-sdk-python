...
class GetEmailActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetEmailActivityCountsWithPeriodRequestBuilder:
        """
        ...
        return GetEmailActivityCountsWithPeriodRequestBuilder(self.request_adapter, raw_url)
