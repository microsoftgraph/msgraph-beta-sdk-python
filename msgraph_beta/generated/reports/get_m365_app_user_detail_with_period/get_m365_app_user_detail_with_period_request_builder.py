...
class GetM365AppUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetM365AppUserDetailWithPeriodRequestBuilder:
        """
        ...
        return GetM365AppUserDetailWithPeriodRequestBuilder(self.request_adapter, raw_url)
