...
class GetFormsUserActivityUserDetailWithDateRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetFormsUserActivityUserDetailWithDateRequestBuilder:
        """
    ...
    @dataclass
    class GetFormsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
