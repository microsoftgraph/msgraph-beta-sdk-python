...
class GetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetTeamsUserActivityTotalUserCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
