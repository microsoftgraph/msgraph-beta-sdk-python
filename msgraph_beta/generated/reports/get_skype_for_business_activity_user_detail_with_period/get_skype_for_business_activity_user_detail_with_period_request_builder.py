...
class GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]], period: Optional[str] = None) -> None:
        ...
        super().__init__(request_adapter, "{+baseurl}/reports/getSkypeForBusinessActivityUserDetail(period='{period}')", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder:
        """
        ...
        return GetSkypeForBusinessActivityUserDetailWithPeriodRequestBuilder(self.request_adapter, raw_url)
