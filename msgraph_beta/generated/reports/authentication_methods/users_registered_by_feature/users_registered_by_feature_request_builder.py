...
class UsersRegisteredByFeatureRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> UsersRegisteredByFeatureRequestBuilder:
        """
    ...
    @dataclass
    class UsersRegisteredByFeatureRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
