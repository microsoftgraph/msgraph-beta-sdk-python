...
class GetOffice365ActivationsUserDetailRequestBuilder(BaseRequestBuilder):
    """
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetOffice365ActivationsUserDetailRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: GetOffice365ActivationsUserDetailRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return GetOffice365ActivationsUserDetailRequestBuilder(self.request_adapter, raw_url)
