...
class GetFormsUserActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None, period: Optional[str] = None) -> None:
        """
        Instantiates a new GetFormsUserActivityCountsWithPeriodRequestBuilder and sets the default values.
    ...
    def to_get_request_information(self,request_configuration: Optional[GetFormsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Invoke function getFormsUserActivityCounts
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> GetFormsUserActivityCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetFormsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
