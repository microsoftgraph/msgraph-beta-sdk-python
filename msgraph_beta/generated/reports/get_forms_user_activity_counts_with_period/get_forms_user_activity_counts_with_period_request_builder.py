...
class GetFormsUserActivityCountsWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> GetFormsUserActivityCountsWithPeriodRequestBuilder:
        """
    ...
    @dataclass
    class GetFormsUserActivityCountsWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
