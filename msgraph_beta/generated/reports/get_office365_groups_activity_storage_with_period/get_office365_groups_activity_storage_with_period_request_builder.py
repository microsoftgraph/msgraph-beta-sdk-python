...
class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters]] = None) -> Optional[GetOffice365GroupsActivityStorageWithPeriodGetResponse]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Invoke function getOffice365GroupsActivityStorage
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration(RequestConfiguration[GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetQueryParameters]):
        """
