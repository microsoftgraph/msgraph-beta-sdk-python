...
class LastMessagePreviewRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration] = None) -> Optional[ChatMessageInfo]:
        """
    ...
    async def patch(self,body: Optional[ChatMessageInfo] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ChatMessageInfo]:
        """
    ...
    def to_patch_request_information(self,body: Optional[ChatMessageInfo] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update the navigation property lastMessagePreview in chats
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> LastMessagePreviewRequestBuilder:
        """
