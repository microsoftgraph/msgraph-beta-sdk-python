...
class RemoveAllAccessForUserRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: Optional[RemoveAllAccessForUserPostRequestBody] = None, request_configuration: Optional[RemoveAllAccessForUserRequestBuilderPostRequestConfiguration] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: Optional[RemoveAllAccessForUserPostRequestBody] = None, request_configuration: Optional[RemoveAllAccessForUserRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Remove access to a chat for a user.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: Optional[str] = None) -> RemoveAllAccessForUserRequestBuilder:
        """
    ...
    @dataclass
    class RemoveAllAccessForUserRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
