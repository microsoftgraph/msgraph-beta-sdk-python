...
if TYPE_CHECKING:
    ...
    from .create_device_from_template_post_request_body import CreateDeviceFromTemplatePostRequestBody

class CreateDeviceFromTemplateRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/templates/deviceTemplates/{deviceTemplate%2Did}/createDeviceFromTemplate", path_parameters)
    ...
    def with_url(self,raw_url: str) -> CreateDeviceFromTemplateRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CreateDeviceFromTemplateRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CreateDeviceFromTemplateRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CreateDeviceFromTemplateRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
