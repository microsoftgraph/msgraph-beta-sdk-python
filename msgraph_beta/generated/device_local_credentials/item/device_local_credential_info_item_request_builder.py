...
class DeviceLocalCredentialInfoItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[DeviceLocalCredentialInfo] = None, request_configuration: Optional[DeviceLocalCredentialInfoItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[DeviceLocalCredentialInfo]:
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[DeviceLocalCredentialInfoItemRequestBuilderDeleteRequestConfiguration] = None) -> RequestInformation:
        ...
        """
        request_info = RequestInformation(Method.DELETE, '{+baseurl}/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}', self.path_parameters)
    ...
    def to_patch_request_information(self,body: Optional[DeviceLocalCredentialInfo] = None, request_configuration: Optional[DeviceLocalCredentialInfoItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        ...
        if not body:
            raise TypeError("body cannot be null.")
        request_info = RequestInformation(Method.PATCH, '{+baseurl}/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}', self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info
    
    def with_url(self,raw_url: Optional[str] = None) -> DeviceLocalCredentialInfoItemRequestBuilder:
        """
    ...
    @dataclass
    class DeviceLocalCredentialInfoItemRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class DeviceLocalCredentialInfoItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class DeviceLocalCredentialInfoItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
