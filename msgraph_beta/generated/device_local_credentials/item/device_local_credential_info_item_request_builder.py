...
class DeviceLocalCredentialInfoItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[DeviceLocalCredentialInfo] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[DeviceLocalCredentialInfo]:
        """
    ...
    def to_patch_request_information(self,body: Optional[DeviceLocalCredentialInfo] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Update entity in deviceLocalCredentials
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
